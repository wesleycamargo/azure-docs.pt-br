...
Contribuir com o código aberto é mais do que apenas as atualizações, mas também nos informar quando há um problema. Para obter mais informações, leia nossas [Diretrizes de contribuição](.github/CONTRIBUTING.md).
