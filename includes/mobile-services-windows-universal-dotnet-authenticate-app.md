...
8.  No arquivo de projeto App.xaml.cs, adicione o seguinte código:
    ...
    Se o método **OnActivated** já existe, apenas adicione bloco de código `#if...#endif`.
