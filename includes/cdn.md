...
Os benefícios do uso da CDN para armazenar dados do Windows Azure em cache incluem:
...
Os clientes atuais da CDN agora podem usar a CDN do Windows Azure no [Portal de Gerenciamento do Windows Azure]. A CDN é um recurso suplementar à sua assinatura e tem um [plano de faturamento] separado.

<a id="Step1"> </a>
<h2>Etapa 1: Criar uma conta de armazenamento</h2>

Use o procedimento a seguir para criar uma nova conta de armazenamento para uma assinatura do Windows Azure. A conta de armazenamento dá acesso aos serviços de armazenamento do Windows Azure. A conta de armazenamento representa o mais alto nível do namespace para acessar cada um dos componentes do serviço de armazenamento do Windows Azure: serviços Blob, serviços Fila e serviços Tabela. Para obter mais informações sobre os serviços de armazenamento do Windows Azure, consulte [Usando os serviços de armazenamento do Windows Azure].
...
<p>Para obter informações sobre como executar esta operação usando a API de Gerenciamento de Serviços do Windows Azure, consulte o tópico de referência <a href="http://msdn.microsoft.com/pt-br/library/windowsazure/hh264518.aspx">Criar conta de armazenamento</a>.</p>
</div>

**Para criar uma conta de armazenamento para uma assinatura do Windows Azure**
...
4. No campo **URL**, digite um nome de subdomínio. Essa entrada pode conter de 3 a 24 letras minúsculas e números.
    ...
    **Importante:** o rótulo da URL forma o subdomínio do URI da conta de armazenamento e deve ser exclusivo entre todos os serviços hospedados no Windows Azure.

	Esse valor também é usado como o nome dessa conta de armazenamento no portal ou ao acessar essa conta programaticamente.

5.  Na lista suspensa **Região/Grupo de Afinidade**, selecione uma localização geográfica para a conta de armazenamento. Como alternativa, use um grupo de afinidade. Para obter instruções sobre como criar um grupo de afinidade, consulte [Como criar um grupo de afinidade no Windows Azure].
...
1. No [Portal de Gerenciamento do Windows Azure], no painel de navegação, clique em **CDN**.
...
Se não desejar mais armazenar em cache um objeto na CDN (Rede de Distribuição de Conteúdo) do Windows Azure, você poderá executar uma das seguintes etapas:

-   Para um blob do Windows Azure, você pode excluir o blob do contêiner público.
...
Nenhuma ferramenta explícita de "limpeza" está disponível atualmente para a CDN do Windows Azure.

## Recursos adicionais

-   [Como criar um Grupo de Afinidade no Windows Azure]
-   [Como gerenciar contas de armazenamento para uma assinatura do Windows Azure]
...
-   [Como mapear o conteúdo CDN para um domínio personalizado]
  ...
  [Locais de nós da CDN do Windows Azure]: http://msdn.microsoft.com/pt-br/library/windowsazure/gg680302.aspx
  ...
  [Usando os Serviços de Armazenamento do Windows Azure (a página pode estar em inglês)]: http://msdn.microsoft.com/pt-br/library/windowsazure/ee924681.aspx
  [Como registrar um nome de subdomínio personalizado para acessar Blobs no Windows Azure (a página pode estar em inglês)]: http://msdn.microsoft.com/pt-br/library/windowsazure/ee795179.aspx
  [Como criar um grupo de afinidade no Windows Azure]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh531560.aspx
  [Visão geral da CDN do Windows Azure]: http://msdn.microsoft.com/pt-br/library/windowsazure/ff919703.aspx
  [Como gerenciar contas de armazenamento para uma assinatura do Windows Azure]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh531567.aspx
