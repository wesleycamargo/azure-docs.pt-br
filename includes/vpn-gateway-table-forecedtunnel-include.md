...
|-----------------------|----------------|--------------|------------|
| **Clássico** | Não | Não | [Artigo](../articles/vpn-gateway/vpn-gateway-about-forced-tunneling.md) |
| **Gerenciador de Recursos** | Não | Não | [Artigo](../articles/vpn-gateway/vpn-gateway-forced-tunneling-rm.md) |
