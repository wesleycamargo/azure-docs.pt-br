...
2. Clique em **Novo**. ![Novo][button-new]
3. Selecione **Repositório**. ![Repositório][button-store]
4. Selecione MongoLab. Você pode nos encontrar na categoria **Serviço de Aplicativo**, bem como em **Todos**. ![MongoLab][entry-mongolab]
5. Clique em **Próximo**. ![Avançar][button-next] A entrada do repositório do MongoLab será exibida. ![NewMongoLab][screen-newmongolab]
...
9. Clique em **Próximo**. ![Avançar][button-next]
10. Reveja as suas informações de compra no repositório e, em seguida, clique em **Comprar** para confirmar. ![Avançar][button-purchase]  
11. O botão de andamento da barra de ferramentas fornece o status de provisionamento. ![ProgressButton][button-progress] Uma mensagem de êxito é exibida quando o provisionamento é concluído. ![SuccessMessage][message-success]
