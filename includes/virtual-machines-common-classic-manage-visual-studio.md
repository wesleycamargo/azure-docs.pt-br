...
3. Na página **Escolher uma assinatura**, selecione uma assinatura a ser usada ao criar uma máquina virtual e clique em **Próximo**.
...
4. Na página **Selecionar uma imagem de máquina Virtual**, selecione um tipo de imagem na caixa de listagem suspensa **Tipo de imagem** e selecione imagens de máquinas virtuais na caixa de listagem **Nome da imagem**. Quando terminar, clique em **Próximo**.
