...
2. Clique na plataforma **Android**. Na seção **Introdução**, expanda o item **Criar um novo aplicativo Android**. 
...
4. Clique em **Download** em **Baixar e publicar o serviço na nuvem**.
