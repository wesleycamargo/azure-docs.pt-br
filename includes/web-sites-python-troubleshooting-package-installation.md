...
Com o lançamento recente do compilador [Microsoft Visual C++ para Python 2.7][Microsoft Visual C++ para Python 2.7], agora é mais fácil criar pacotes que têm código nativo para o Python 2.7.
