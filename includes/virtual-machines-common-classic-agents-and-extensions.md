...
-   Quando você cria uma instância de uma Máquina Virtual usando o método de **Criação rápida** no portal clássico do Azure ou usando o método de **Criação personalizada** no portal clássico do Azure e verificando se a caixa de seleção **Instalar o Agente de VM** está marcada (como mostrado na imagem abaixo). Para saber mais, consulte [Como criar uma máquina virtual personalizada](../articles/virtual-machines/virtual-machines-windows-classic-createportal.md).
