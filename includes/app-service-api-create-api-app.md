...
Crie um aplicativo no `myAppServicePlan` plano do Serviço de Aplicativo com o comando [az webapp create](/cli/azure/webapp?view=azure-cli-latest#az_webapp_create). 
