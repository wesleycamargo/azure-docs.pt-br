...
3. Na caixa de pesquisa do Catálogo do Microsoft Update, insira o número da KB (base de dados de conhecimento) do hotfix que deseja baixar, por exemplo, **3186843**, e clique em **Pesquisar**.
...
9. Repita as etapas 3 a 5 para instalar o hotfix de firmware e o driver LSI **KB3186859**. Após a instalação do hotfix, use o cmdlet `Get-HcsSystem`. A versão de LSI deve ser:

	- `Lsisas2Version: 2.0.78.00`
	
10. Repita as etapas 3 a 5 para instalar a atualização de Storport e Spaceport **KB3121261**.


11. Se estiver atualizando da Atualização 2 ou de uma versão anterior, você precisará também baixar:
