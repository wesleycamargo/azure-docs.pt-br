> [!IMPORTANT]
> O suporte do Azure PowerShell para gerenciar os recursos do HDInsight usando o ASM (Gerenciador de Serviços do Azure) está **preterido** e será removido em 1º de janeiro de 2017. As etapas neste documento usam os novos cmdlets do HDInsight que funcionam com o ARM (Azure Resource Manager).
> 
