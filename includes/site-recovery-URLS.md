``*.accesscontrol.windows.net``. Usado para controle de acesso e gerenciamento de identidades. (A autenticação baseada em ACS será preterida em dezembro de 2017) <br/>
