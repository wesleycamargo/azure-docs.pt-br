...
3. Na página **Visão geral** do banco de dados, examine o nome totalmente qualificado do servidor, como mostrado na imagem a seguir. Passe o mouse sobre o nome do servidor para abrir a opção **Clique para copiar**.  
