...
Se houver uma alteração no padrão de uso dos dados, você também poderá alternar entre as camadas de acesso a qualquer momento. A alteração da camada de acesso pode resultar em cobranças adicionais. Confira [Preços e cobrança para contas de Armazenamento de Blobs](../articles/storage/common/storage-account-options.md#pricing-and-billing) para obter mais detalhes.
