...
| Distribuição | Driver |
| --- | --- | 
| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>CentOS 7.3 | NVIDIA GRID 5.0, ramificação do driver R384|
...
| Distribuição | Driver |
| --- | --- | 
| Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> CentOS 7.3 | NVIDIA CUDA 9.0, ramificação do driver R384 |
