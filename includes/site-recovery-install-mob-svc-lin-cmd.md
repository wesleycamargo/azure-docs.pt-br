...
|-v|Obrigatório|Especifica a plataforma onde o Serviço de Mobilidade está sendo instalado </br> </br>- **VMware: use esse valor se você estiver instalando o serviço de mobilidade em uma VM em execução no *VMware vSphere ESXi Hosts*, *Hyper-V Hosts e *Servidores Físicos* </br> - **Azure: use esse valor se você estiver instalando o agente em uma VM IaaS do Azure| VMware </br> As tabelas|
