...
| Endereços IP privados por interface de rede |50 |entre em contato com o suporte |
| Fluxos TCP ou UDP simultâneos por NIC de uma máquina virtual ou instância de função |500K |500K |
...
| Balanceadores de Carga (internos e voltados para a Internet) |100 |entre em contato com o suporte |
| Regras do Load Balancer por balanceador de carga |150 |150 |
| Regras do Load Balancer por configuração IP |299 |299 |
| IP público front-end por Load Balancer |10 |30 |
| IP privado front-end por Load Balancer |10 |entre em contato com o suporte |
