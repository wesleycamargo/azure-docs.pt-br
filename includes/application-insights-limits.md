...
| Tamanho dos nomes de propriedade e métrica | 150 | confira os comentários abaixo para obter mais informações
| Tamanho da cadeia de caracteres do valor da propriedade | 8.192 | confira os comentários abaixo para obter mais informações
| Comprimento da mensagem de rastreamento e de exceção | 10.000 | confira os comentários abaixo para obter mais informações
...
Para obter informações sobre os campos de dados, confira limites [por tipos de esquemas](https://github.com/Microsoft/ApplicationInsights-Home/blob/master/EndpointSpecs/Schemas/Docs/)
