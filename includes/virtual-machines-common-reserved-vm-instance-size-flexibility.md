...
Para obter mais informações, consulte [Tamanhos das máquinas virtuais para uso geral](../articles/virtual-machines/windows/sizes-general.md#dv2-series).
...
Para obter mais informações, consulte [Tamanhos de máquinas virtuais otimizados para memória](../articles/virtual-machines/windows/sizes-memory.md#dsv2-series-11-15).
...
Para obter mais informações, consulte [Tamanhos das máquinas virtuais para uso geral](../articles/virtual-machines/windows/sizes-general.md#dsv3-series-sup1sup).
...
Para obter mais informações, consulte [Tamanhos de máquinas virtuais otimizados para memória](../articles/virtual-machines/windows/sizes-memory.md#dv2-series-11-15).
...
Para obter mais informações, consulte [Tamanhos das máquinas virtuais para uso geral](../articles/virtual-machines/windows/sizes-general.md#dv3-series-sup1sup).
...
Para obter mais informações, veja [Compute optimized virtual machine sizes](../articles/virtual-machines/windows/sizes-compute.md#f-series) (Tamanhos de máquinas virtuais com computação otimizada).
...
Para obter mais informações, veja [Compute optimized virtual machine sizes](../articles/virtual-machines/windows/sizes-compute.md#fs-series-sup1sup) (Tamanhos de máquinas virtuais com computação otimizada).
...
Para obter mais informações, veja [Compute optimized virtual machine sizes](../articles/virtual-machines/windows/sizes-compute.md#fsv2-series-sup1sup) (Tamanhos de máquinas virtuais com computação otimizada).
