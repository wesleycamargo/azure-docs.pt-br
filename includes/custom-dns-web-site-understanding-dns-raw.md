...
> [!NOTE]
> O endereço IP do seu aplicativo Web será alterado se você excluir e recriar seu aplicativo Web, ou então se alterar o modo de plano de Serviço de Aplicativo para **Gratuito** depois de ele ter sido definido como **Básico**, **Compartilhado** ou **Padrão**.
> 
> 
...
3. Na folha **Domínios personalizados**, você verá o endereço IP virtual. Salve essas informações, pois elas serão utilizadas na criação de registros DNS
   ...
   > [!NOTE]
   > Você não pode usar nomes de domínio personalizados com um aplicativo Web **Gratuito**, e deve atualizar o plano de Serviço de Aplicativo para a camada **Shared**, **Basic**, **Standard** ou **Premium**. Para obter mais informações sobre as camadas de preços de plano do Serviço de Aplicativo, inclusive sobre como alterar o tipo de preço do seu aplicativo Web, consulte [Como dimensionar aplicativos Web](../articles/app-service-web/web-sites-scale.md).
   > 
   > 
