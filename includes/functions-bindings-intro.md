...
* [Crie sua primeira função](../articles/azure-functions/functions-create-first-azure-function.md).
* [Referência do desenvolvedor do Azure Functions](../articles/azure-functions/functions-reference.md).
* Referência de recurso [C#](../articles/azure-functions/functions-reference-csharp.md), [F#](../articles/azure-functions/functions-reference-fsharp.md), [Node](../articles/azure-functions/functions-reference-node.md) ou [Java](..\articles\azure-functions\functions-reference-java.md).
