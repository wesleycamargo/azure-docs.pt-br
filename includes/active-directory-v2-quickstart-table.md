...
|<img width="40" role="presentation" alt="Windows Desktop" src="~/articles/active-directory/develop/media/index/logo_windows.svg" /><br/>[Entrar e adquirir um token de um aplicativo da Área de Trabalho do Windows](~/articles/active-directory/develop/quickstart-v2-windows-desktop.md) | <img width="40" role="presentation" alt=".NET Core" src="~/articles/active-directory/develop/media/index/logo_netcore.svg" /><br/> [Adicionar entrada a um aplicativo Web do ASP.NET Core](~/articles/active-directory/develop/quickstart-v2-aspnet-core-webapp.md) | |
