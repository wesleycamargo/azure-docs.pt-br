...
| -------- | --- | --- | --- | --- | --- | --- |
| Serviço (SLA) contrato de nível<sup>3</sup>  |Não  |sim |sim |sim |sim |Sim |
...
<sup>1</sup>basic tem uma partição fixa. Nesse nível, as unidades de pesquisa adicional são usadas para alocar mais réplicas para cargas de trabalho de consulta maior.
