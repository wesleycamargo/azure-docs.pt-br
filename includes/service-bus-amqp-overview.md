...
Para saber mais sobre como obter e usar essas bibliotecas com o Barramento de Serviço, consulte o [Guia do desenvolvedor do Barramento de Serviço do AMQP][Guia do desenvolvedor do Barramento de Serviço do AMQP]. Consulte a seção "Referências" abaixo para obter mais informações.
