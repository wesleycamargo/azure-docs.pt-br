...
|-----------|---------------------------------------------------|
| Java      | Cliente do Apache Qpid Java Message Service (JMS) 
              Cliente Java IIT Software SwiftMQ                 |
...
-   [Como usar os tópicos AMQP 1.0 com o Service Bus .NET API][Como usar os tópicos AMQP 1.0 com o Service Bus .NET API]
-   [Como usar a API do Serviço de Mensagem Java (JMS) com Service Bus e AMQP 1.0][Como usar a API do Serviço de Mensagem Java (JMS) com Service Bus e AMQP 1.0]
