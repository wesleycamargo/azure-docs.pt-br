...
O JSON a seguir mostra o resultado de uma solicitação de status de treinamento bem-sucedida. Cada modelID é uma intenção. Cada intenção deve ser treinada em todos os enunciados para identificar corretamente os enunciados que pertencem à intenção, bem como aqueles que não pertencem. 
