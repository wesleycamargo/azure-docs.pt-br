...
5. Na caixa de diálogo **Criar Serviço Móvel**, selecione sua **Assinatura**, o back-end **.NET Framework** no **Tempo de execução** e uma **Região** para o serviço móvel e, em seguida, digite um **Nome** para o seu serviço móvel.
