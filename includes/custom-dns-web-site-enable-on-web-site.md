...
6. Clique na marca de seleção no canto inferior direito para salvar a configuração do nome de domínio.
	...
	Quando a configuração estiver concluída, o nome de domínio personalizado será listado na seção **nomes de domínio** da folha **Domínios personalizados e SSL** para seu aplicativo Web.
