...
1. Em Gerenciador de Servidores, expanda **Serviços Móveis do Azure**, clique com o botão direito do mouse no serviço móvel, clique em **Criar Tabela** e, em seguida, digite `TodoItem` no **Nome da Tabela**.
