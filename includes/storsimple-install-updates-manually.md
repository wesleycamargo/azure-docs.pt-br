<properties
   pageTitle="Instalar atualizações manualmente"
   description="Explica como usar o recurso de atualização do StorSimple e o Portal de Gerenciamento para instalar manualmente as atualizações."
   services="storsimple"
...
4. Você verá uma mensagem se as atualizações de software estiverem disponíveis. Clique em **Instalar Atualizações** para começar a atualização do dispositivo.
    ...
    Você será notificado quando a atualização for instalada com êxito. <!--HONumber=52-->
