A qualquer momento após a configuração de um banco de dados de MongoLab, você pode acessar a web MongoLab da interface do usuário para o gerenciamento de banco de dados. Oferecemos acesso a logon único (SSO) conveniente por meio do Portal de Gerenciamento do Azure.

Você pode usar o MongoLab UI para executar a maioria das tarefas de banco de dados, como inserção e consultar documentos, obter estatísticas de banco de dados e executando comandos úteis de banco de dados. Para saber mais sobre a MongoLab UI, visite nosso [página de suporte][] e [blog][]
