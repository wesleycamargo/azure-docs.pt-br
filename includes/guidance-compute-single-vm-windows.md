...
- **Grupo de recursos.** Um [_grupo de recursos_][resource-manager-overview] é um contêiner que mantém os recursos relacionados. Crie um grupo de recursos para armazenar os recursos desta VM.
