...
6. Na folha **Configurações** do novo back-end do Aplicativo Móvel, role para baixo até Celular e clique em **Introdução** > sua plataforma de aplicativo cliente > **Conectar um banco de dados**.
