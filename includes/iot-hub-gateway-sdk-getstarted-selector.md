...
* **Conceitos**: uma visão geral conceitual dos componentes que formam qualquer gateway criado com o SDK do Gateway IoT.  
...
## <a name="azure-iot-gateway-sdk-concepts"></a>Conceitos do SDK do Gateway IoT do Azure
Antes de examinar o código de exemplo ou criar seu próprio gateway de campo usando o SDK do Gateway IoT, é necessário entender os principais conceitos nos quais se baseia arquitetura do SDK.
...
![Camada de abstração do SDK do Gateway de IoT do Azure][2]
