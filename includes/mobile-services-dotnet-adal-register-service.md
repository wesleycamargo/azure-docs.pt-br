...
1.  Registre seu aplicativo com seu Active Directory do Azure seguindo o tópico [Como registrar-se com o Active Directory do Azure][Como registrar-se com o Active Directory do Azure].

2.  No [Portal de Gerenciamento do Azure][Portal de Gerenciamento do Azure], retorne à extensão do Active Directory do Azure e clique no seu diretório ativo
