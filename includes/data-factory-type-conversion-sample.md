...
Em seguida, você definirá o conjunto de dados do SQL Azure da seguinte maneira. 

> [!NOTE]
> Você não precisa especificar a seção **estrutura** com as informações de tipo, pois o tipo de informação já está especificado no armazenamento de dados subjacente.
