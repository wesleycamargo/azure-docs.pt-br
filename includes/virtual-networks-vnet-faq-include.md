## <a name="virtual-network-basics"></a>Noções básicas sobre rede virtual
...
### <a name="how-do-i-know-if-i-need-a-virtual-network"></a>Como saber se preciso de uma rede virtual?
...
### <a name="what-services-can-i-use-with-vnets"></a>Quais serviços posso usar com redes virtuais?
...
### <a name="is-there-a-limit-to-the-number-of-subnets-in-my-virtual-network"></a>Há um limite para o número de sub-redes na minha rede virtual?
...
Sim. Você pode criar comunicação rede virtual para rede virtual usando APIs REST ou o Windows PowerShell. Você também pode conectar redes virtuais por meio do Emparelhamento VNet. Veja mais detalhes sobre o emparelhamento [aqui.](../articles/virtual-network/virtual-network-peering-overview.md)
...
> [!NOTE]
> No momento, existe uma limitação para os primeiros 100 serviços de nuvem na rede virtual para resolução de nome entre locatários usando DNS fornecido pelo Azure. Se você estiver usando seu próprio servidor DNS, essa limitação não se aplicará.
> 
> 
...
## <a name="vnets-and-vms"></a>redes virtuais e VMs
### <a name="can-i-deploy-vms-to-a-vnet"></a>Posso implantar VMs em uma rede virtual?
Sim.

### <a name="can-i-deploy-linux-vms-to-a-vnet"></a>Posso implantar VMs do Linux em uma rede virtual?
...
### <a name="what-ip-address-will-my-vm-receive"></a>Qual endereço IP minha VM receberá?
...
### <a name="can-i-reserve-an-internal-ip-address-for-a-vm-that-i-will-create-at-a-later-time"></a>Posso reservar um endereço IP interno para uma VM que criarei posteriormente?
...
### <a name="do-internal-ip-addresses-change-for-vms-in-a-vnet"></a>Os endereços IP internos mudam para VMs em uma rede virtual?
...
### <a name="can-i-manually-assign-ip-addresses-to-nics-in-vms"></a>Posso atribuir manualmente os endereços IP a NICs em VMs?
...
### <a name="what-happens-to-my-ip-addresses-if-i-shut-down-a-vm"></a>O que acontece com meus endereços IP se eu desligar uma VM?
Nada. Os endereços IP (VIP público e endereço IP interno) permanecerão com seu serviço de nuvem ou máquina virtual.

> [!NOTE]
> Se você deseja simplesmente desligar a VM, não use o Portal de Gerenciamento para fazer isso. Atualmente, o botão de desligamento desaloca a máquina virtual.
> 
> 
...
Sim, o endereço MAC permanecerá o mesmo para uma VM, mesmo que a VM tenha sido parada (desalocada) e reinicializada.
...
## <a name="vnets-and-services"></a>redes virtuais e serviços
### <a name="what-services-can-i-use-with-vnets"></a>Quais serviços posso usar com redes virtuais?
...
### <a name="can-i-use-web-apps-with-virtual-network"></a>Posso usar Aplicativos Web com Rede Virtual?
...
### <a name="how-do-i-deploy-paas-roles-to-a-vnet"></a>Como implanto funções PaaS em uma rede virtual?
...
## <a name="vnets-and-security"></a>redes virtuais e segurança
...
### <a name="can-i-define-acls-or-nsgs-on-my-vnets"></a>Posso definir ACLs ou NSGs em minhas redes virtuais?
...
### <a name="is-there-a-vnet-security-whitepaper"></a>Existe um white paper sobre segurança da rede virtual?
