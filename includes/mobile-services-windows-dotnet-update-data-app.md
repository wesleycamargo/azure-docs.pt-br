...
1. No arquivo MainPage.cs, adicione ou remova o comentário dos seguintes usando instruções:

		using Microsoft.WindowsAzure.MobileServices;


4. Remova o comentário ou exclua a linha que define a coleção de itens existentes e remova os comentários ou adicione as linhas a seguir, substituindo _&lt;yourClient&gt;_ pelo campo `MobileServiceClient` adicionado ao arquivo App.xaml.cs quando você conecta seu projeto ao serviço móvel:
