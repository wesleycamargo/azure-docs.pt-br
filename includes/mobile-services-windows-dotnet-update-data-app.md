...
3. Em MainPage.xaml.cs, remova o comentário ou exclua a linha que define a coleção de itens existentes e remova os comentários ou adicione as linhas a seguir, substituindo _&lt;yourClient&gt;_ pelo campo `MobileServiceClient` adicionado ao arquivo App.xaml.cs quando você conecta seu projeto ao serviço móvel:
