...
2. Na caixa de diálogo Gerenciador de Serviços, clique em **Criar serviço...**, selecione **&lt;Gerenciar...&gt;** da **Assinatura** na caixa de diálogo Criar Serviço Móvel.  
...
5. Novamente na caixa de diálogo **Criar serviço móvel**, selecione sua **assinatura**, o back-end do **JavaScript** em **Tempo de execução** e uma **região** para seu serviço móvel, e digite um **nome** para o serviço móvel.

	>[WACOM.NOTE]Os nomes de serviço móvel devem ser exclusivos. Um X vermelho é exibido ao lado de **Nome** quando o nome fornecido não está disponível. 

6. No **Banco de dados**, selecione **&lt;Criar um Banco de Dados SQL gratuito&gt;**, forneça o **Nome de usuário do servidor**, a **Senha do servidor**, a **Confirmação de senha do servidor** e, em seguida, clique em **Criar**.
