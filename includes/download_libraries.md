...
Dentro do elemento `<version>`, substituir *n.n.n* com um número de versão válida, que pode ser obtido com o [Repositório de bibliotecas do Azure no Maven](http://go.microsoft.com/fwlink/?LinkID=286274).
