...
### Etapa 1: verificar a versão do xplat-cli

Para usar o xplat-cli para comandos imperativos e modelos do ARM, é necessário ter pelo menos a versão 0.8.17. Para verificar a sua versão, digite `azure --version`. Você deve ver algo como:

    $ azure --version
    0.8.17 (node: 0.10.25)
    
Se você precisar de atualizar a sua versão do xplat-cli, consulte [xplat-cli](https://github.com/Azure/azure-xplat-cli).
