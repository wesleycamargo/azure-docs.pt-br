...
6. Na janela **Configurar o Aplicativo Web do Microsoft Azure**, selecione uma assinatura e, na lista **Plano do Serviço de Aplicativo**, execute uma destas ações:
