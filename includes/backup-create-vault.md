...
### <a name="azure-backup---storage-redundancy-options"></a>Backup do Azure - Opções de redundância de armazenamento
> [!IMPORTANT]
...
#### <a name="geo-redundant-storage-grs"></a>Armazenamento com redundância geográfica (GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>Armazenamento com redundância local (LRS)
