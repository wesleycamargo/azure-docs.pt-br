...
6. Na janela **Segurança do Windows**, digite as credenciais de uma conta na máquina virtual e clique em **OK**.
	...
	**VM Ingressada no Domínio** - se a VM pertencer um domínio, digite o nome de usuário no formato *Domínio*&#92;*Nome de usuário*. A conta precisa estar no grupo Administradores ou ter privilégios de acesso remoto concedidos à VM.
