Você pode verificar uma conexão VPN no portal do Azure, navegando até **Gateways da rede virtual** **>** ***e clique no nome do gateway*** **>** **Configurações** **>** **Conexões**. Ao selecionar o nome da conexão, você pode exibir mais informações sobre a conexão. No exemplo abaixo, a conexão não está conectada, e assim os dados não fluem.
