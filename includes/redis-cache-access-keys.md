...
![Chaves do Cache Redis](media/redis-cache-access-keys/redis-cache-keys.png)

Para recuperar o nome de host, portas, clique em **Propriedades**.

![Propriedades de cache Redis](media/redis-cache-access-keys/redis-cache-hostname-ports.png)
