...
3.  Substitua a função **InsertTodoItem** pelo seguinte código:
...
4.  Substitua a função **RefreshTodoItems** pelo seguinte código:
...
5.  Substitua a função **UpdateCheckedTodoItem** pelo seguinte código:
