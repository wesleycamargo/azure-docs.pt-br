...
1. Usando suas credenciais de conta da Microsoft, faça logon no portal do Azure na seguinte URL: [http://azure.microsoft.com/](http://azure.microsoft.com/).

2. No portal do Azure, clique em **Novo** > **Serviços de Dados** > **StorSimple Manager** > **Criação Rápida**.
