...
3. Observe que a conexão foi criada e agora você pode continuar com as outras etapas no seu aplicativo lógico: ![Etapa 3 do Mashup SQL](./media/connectors-create-api-mashupsql/mashupsql-3.png)
