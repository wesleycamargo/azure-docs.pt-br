...
1. Se ainda não o fez, conclua as etapas do tópico [Registrar seus aplicativos para fazer logon no Twitter com os Serviços Móveis](../articles/mobile-services/mobile-services-how-to-register-twitter-authentication.md). 
...
2. Navegue até o site [Desenvolvedores do Twitter](http://go.microsoft.com/fwlink/p/?LinkId=268300), entre usando suas credenciais de conta do Twitter e selecione seu aplicativo do Twitter.
...
4. Faça logon no [portal clássico do Azure](https://manage.windowsazure.com/), clique em **Serviços Móveis** e clique em seu serviço móvel.
...
6. Clique na guia **Configurar**, role para baixo até **Configurações do aplicativo** e digite um par de **Nome** e **Valor** para cada uma das opções a seguir que você obteve no site do Twitter e clique em **Salvar**.
