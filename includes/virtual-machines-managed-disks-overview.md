...
ms.locfileid: "51264263"
---
# <a name="azure-managed-disks-overview"></a>Visão geral do Azure Managed Disks

O Azure Managed Disks simplifica o gerenciamento de discos para VMs IaaS do Azure por meio do gerenciamento de [contas de armazenamento](../articles/storage/common/storage-introduction.md) associadas aos discos de VM. Você só precisa especificar o tipo ([HDD Standard](../articles/virtual-machines/windows/standard-storage.md) [SSD Standard](../articles/virtual-machines/windows/disks-standard-ssd.md), ou [SSD Premium](../articles/virtual-machines/windows/premium-storage.md)) e o tamanho do disco que você precisa, e o Azure cria e gerencia o disco para você.
...
**Tipo de armazenamento:** o Managed Disks oferece 3 níveis de desempenho: [HDD Standard](../articles/virtual-machines/windows/standard-storage.md), [SSD Standard](../articles/virtual-machines/windows/disks-standard-ssd.md), e [Premium](../articles/virtual-machines/windows/premium-storage.md). A cobrança de um disco gerenciado depende de qual tipo de armazenamento você selecionou para o disco.
...
Aqui estão os tamanhos de disco disponíveis para um disco gerenciado premium, os tamanhos denotados com um asterisco estão atualmente em visualização:

| **SSD Premium gerenciado <br>tipo de Disk** | **P4** | **P6** | **P10** | **P15** | **P20** | **P30** | **P40** | **P50** | **P60*** | **P70*** | **P80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
