...
6. Se você pretende usar a biblioteca de conexão PHP, copie a cadeia de caracteres rotulada **PHP**.

	![Copie a cadeia de conexão PHP do banco de dados][3-get-connection-string]
