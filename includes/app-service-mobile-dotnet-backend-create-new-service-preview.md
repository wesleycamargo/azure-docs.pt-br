...
1. Faça logon no [Portal do Azure]. Na parte inferior esquerda da janela, clique em **+NOVO**. Role até ver o item **Aplicativo Móvel**.
   ...
   Isso exibe a lâmina **Novo Aplicativo Móvel**.
...
9. Clique no botão **Criar** na parte inferior da lâmina e você verá essa lâmina iniciar a implantação na janela de notificações.
