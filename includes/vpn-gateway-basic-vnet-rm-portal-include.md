Para criar uma rede virtual usando o Portal do Azure, execute as etapas abaixo. Observe que as capturas de tela são fornecidas como exemplos. Substitua os valores pelos seus próprios.
