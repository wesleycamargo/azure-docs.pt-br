...
5.  Abra o console do Firewall do Windows e crie uma nova regra de porta para permitir conexões à porta. Para obter mais informações sobre como criar uma nova regra de porta do Firewall do Windows, consulte [Como adicionar uma nova regra de porta do Firewall do Windows][Como adicionar uma nova regra de porta do Firewall do Windows].
