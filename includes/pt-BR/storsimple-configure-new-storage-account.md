...
#### <a name="to-add-a-new-storage-account-in-storsimple-release-version-ga"></a>Para adicionar uma nova conta de armazenamento na versão de lançamento do StorSimple (GA)
