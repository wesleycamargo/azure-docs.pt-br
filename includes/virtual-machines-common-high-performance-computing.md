...
* **Soluções de Big Compute como serviço**
    ...
    * Use um [supercomputador cray](https://www.cray.com/solutions/supercomputing-as-a-service/cray-in-azure) como um serviço hospedado no Microsoft Azure.
* **Soluções do Marketplace**
    * Use a escala de [aplicativos HPC](#hpc-applications) e [soluções](#marketplace-solutions) oferecidas no [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/). 
...
* [HPC baseada em CentOS RogueWave](https://azuremarketplace.microsoft.com/marketplace/apps/RogueWave.CentOSbased74HPC?tab=Overview)
...
* [Aplicativos de renderização](../articles/batch/batch-rendering-service.md) no Lote do Azure, incluindo o Autodesk Maya, o 3ds Max e o Arnold, o Chaos Group V-Ray e o Blender
...
Gerencie facilmente cargas de trabalho comuns com eficiência ao criar e otimizar clusters de HPC em VMs do Azure com o [Azure CycleCloud](https://docs.microsoft.com/azure/cyclecloud/overview).
...
* [Pacote de HPC da Microsoft](https://docs.microsoft.com/powershell/high-performance-computing/overview) 

## <a name="hpc-storage"></a>Armazenamento HPC

Cargas de trabalho do Lote e de HPC em larga escala têm exigências de armazenamento e acesso a dados que excedem os recursos de sistemas de arquivos em nuvem tradicionais. 

Saiba mais:

* [Avere vFXT para Azure](../articles/avere-vfxt/avere-vfxt-overview.md) 
* [Sistemas de arquivos virtuais paralelos no Azure](https://azure.microsoft.com/resources/parallel-virtual-file-systems-on-microsoft-azure/), incluindo [Lustre](http://lustre.org/) e [BeeGFS](http://www.beegfs.com/content/).
...
* [Serviço do Machine Learning](../articles/machine-learning/service/overview-what-is-azure-ml.md)
...
* [Instâncias de Contêiner](../articles/container-instances/container-instances-overview.md)

## <a name="customer-stories"></a>Relatos de clientes

Exemplos de clientes que solucionaram problemas de negócios com soluções de HPC do Azure:
...
* Saiba mais sobre as soluções do Azure para [computação de alto desempenho](https://azure.microsoft.com/solutions/high-performance-computing/), [renderização](https://azure.microsoft.com/solutions/big-compute/rendering/), [bancos e mercados de capitais](https://finance.azure.com/) e [genômica](https://enterprise.microsoft.com/industries/health/genomics/).

* Saiba mais sobre [arquiteturas de solução de Big Compute](https://azure.microsoft.com/solutions/architecture/?solution=high-performance-computing) no Azure.
