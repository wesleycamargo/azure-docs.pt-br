...
A maneira mais fácil de conectar o emulador de armazenamento do seu aplicativo é configurar uma cadeia de conexão de dentro do arquivo de configuração do aplicativo que referencia o atalho `UseDevelopmentStorage=true`. Segue um exemplo de uma cadeia de conexão para o emulador de armazenamento em um arquivo app.config:
