...
O tutorial presume que você tenha um conhecimento básico de como trabalhar com a [API Web 2](http://www.asp.net/web-api/overview/getting-started-with-aspnet-web-api/tutorial-your-first-web-api) ASP.NET e o [MVC 5](http://www.asp.net/mvc/overview/getting-started/introduction/getting-started) no Visual Studio.
...
Você não precisa ter conhecimentos prévios de como trabalhar com o Microsoft Azure, mas precisa de uma conta do Azure para concluir o tutorial. Você pode:
