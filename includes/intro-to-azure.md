...
<h2><a id="networking"></a>Sistema de rede</h2>
...
Devido a como o Azure cresceu ao longo do tempo, as Filas de Armazenamento do Azure e Filas do Barramento de Serviço fornecem serviços de enfileiramento similares. Os motivos pelos quais você desejaria utilizar um no lugar do outro são explicadas num folheto bastante técnico [<LINK>](http://msdn.microsoft.com/library/azure/hh767287.aspx "Azure Queues and Service Bus Queues - Compared and Contrasted").  Na maioria dos cenários, qualquer uma dessas opções funcionará. 
...
###Computação de Alto Desempenho) - Computação de Grande Porte###
...
Para obter um panorama mais visual do funcionamento dos Serviços de Mídia, baixe o [Cartaz dos Serviços de Mídia do Azure][Cartaz dos Serviços de Mídia do Azure].
...
Agora que você tem a visão geral, a próxima etapa é escrever seu primeiro aplicativo do Azure. Escolha o idioma, [obtenha o SDK adequado](/pt-br/downloads/) e vá em frente. Computação em nuvem é o novo padrão: comece agora.
