...
3.  No arquivo ToDoActivity.java, adicione a seguinte definição ao método `cacheUserToken`.
    ...
    > [WACOM.NOTE]Você pode proteger ainda mais o token com criptografia se o acesso do token a seus dados for considerado altamente confidencial e alguém puder acessar o dispositivo. No entanto, uma solução completamente segura está além do escopo deste tutorial e depende dos seus requisitos de segurança.

4.  No arquivo ToDoActivity.java, adicione a seguinte definição ao método `cacheUserToken`.
