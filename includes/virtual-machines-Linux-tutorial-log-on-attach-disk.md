...
8.  Você deve criar o sistema de arquivos na nova partição. Como exemplo, digite o seguinte comando para criar o sistema de arquivo e, em seguida, digite a senha da conta:
    ...
    > [WACOM.NOTE] Observe que, nos sistemas SUSE Linux Enterprise 11, há apenas acesso somente leitura para sistemas de arquivos ext4. Para esses sistemas, é recomendável formatar o novo sistema de arquivos como ext3 em vez de ext4.
...
11. Adicione a nova unidade ao /etc/fstab:
  ...
  [Sobre discos e imagens no Azure]: http://msdn.microsoft.com/pt-br/library/jj672979.aspx
