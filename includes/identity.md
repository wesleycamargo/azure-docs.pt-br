...
- [Executando Windows Server Active Directory em máquinas virtuais](#adinvm)
...
## <a name="adinvm"></a>Executando Windows Server Active Directory em máquinas virtuais

Executar o AD do Windows Server em VMs do Azure é muito semelhante a executá-lo localmente. [A Figura 1](#fig1) mostra um exemplo típico de como isso acontece.
