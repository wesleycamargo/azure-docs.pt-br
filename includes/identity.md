...
-   [Executando o Active Directory do Windows Server em VMs][Executando o Active Directory do Windows Server em VMs]

-   [Usando o Active Directory do Azure][Usando o Active Directory do Azure]

-   [Usando o Controle de Acesso do Active Directory do Azure][Usando o Controle de Acesso do Active Directory do Azure]

## <a name="adinvm"></a>Executando o Active Directory do Windows Server em VMs

Executar o AD do Windows Server em VMs do Azure é muito semelhante a executá-lo localmente. A [Figura 1][Figura 1] mostra um exemplo típico de como isso acontece.

![Active Directory do Azure na Máquina Virtual][Active Directory do Azure na Máquina Virtual]
...
A [Figura 2][Figura 2] ilustra a primeira dessas duas opções, na qual o Active Directory do Azure é tudo que é necessário.
...
![Active Directory do Azure na Máquina Virtual][3]
...
David Chappell é diretor da Chappell & Associates [www.davidchappell.com][www.davidchappell.com] em São Francisco, Califórnia. Por meio de sua fala, escrita e consultoria,
  ...
  [clique aqui]: http://msdn.microsoft.com/pt-br/library/windowsazure/jj156090.aspx
  [Figura 2]: #fig2
