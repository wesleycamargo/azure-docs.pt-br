<properties 
   pageTitle="Obtenha o IQN do host do Windows"
   description="Explica como obter o iSCSI IQN (nome qualificado) de um computador executando o Windows Server 2012."
   services="storsimple"
