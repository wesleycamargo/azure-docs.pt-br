...
> [AZURE.IMPORTANT] Se você estiver usando o Kit de Ferramentas do Azure para o IntelliJ no Windows, o kit de ferramentas requererá a instalação do SDK do Azure 2.7 ou posterior. Você tem duas opções para instalar o SDK do Azure:
> 
