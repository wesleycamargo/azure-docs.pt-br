...
Este artigo não fornece uma visão geral conceitual do Azure Data Factory. Para obter uma visão geral conceitual do serviço, confira [Introdução ao Azure Data Factory](../articles/data-factory/data-factory-introduction.md).
...
![Exibição de diagrama no tutorial do Data Factory](./media/data-factory-tutorial-prerequisites/data-factory-tutorial-diagram-view.png)
...
1. Carregue o arquivo de consulta do Hive (HQL) na pasta **script** do contêiner **adfgetstarted**.
2. Carregue o arquivo de entrada na pasta **script** do contêiner **adfgetstarted**.
...
1. Como preparar o armazenamento do Azure para o tutorial:
   
   1. Baixe a [versão mais recente do **AzCopy**](http://aka.ms/downloadazcopy) ou a [versão de visualização mais recente](http://aka.ms/downloadazcopypr). Consulte o artigo [Como usar o AzCopy](../articles/storage/storage-use-azcopy.md) para obter instruções sobre o uso do utilitário.
   2. Adicione o local do AzCopy ao caminho do sistema, executando o seguinte comando no prompt de comando.
   ...
   3. Navegue até a pasta c:\\adfgetstarted e execute o comando a seguir. Este comando carrega o arquivo **input.log** para a conta de armazenamento (contêiner **adfgetstarted** e pasta **inputdata**). Substitua **StorageAccountName** pelo nome da sua conta de armazenamento e **Storage Key** pela chave de armazenamento da conta.
      ...
      > 
      > 
   4. Depois que o arquivo tiver sido carregado com êxito, você verá a saída semelhante à seguinte do AzCopy.
   ...
   5. Execute o comando a seguir para carregar o arquivo **partitionweblogs.hql** para a pasta **script** do contêiner **adfgetstarted**. Veja o código:
