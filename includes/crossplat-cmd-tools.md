...
Saiba como usar as ferramentas de linha de comando do Windows Azure para Mac e Linux para criar e gerenciar serviços no Windows Azure. Os cenários abordados incluem **instalar as ferramentas**, **importar as configurações de publicação**, **criação e gerenciamento dos sites do Windows Azure** e **criação e gerenciamento das Máquinas Virtuais do Windows Azure** Para obter documentação de referência abrangente, consulte [Ferramenta de linha de comando do Windows Azure para Mac e a documentação do Linux][reference-docs] 

##Sumário
* [Quais são as ferramentas de linha de comando do Windows Azure para Mac e Linux](#Overview)
* [Como instalar as ferramentas de linha de comando do Windows Azure para Mac e Linux](#Download)
* [Criar uma conta do Windows Azure](#CreateAccount)
* [Como baixar e importar as configurações de publicação](#Account)
* [Como criar e gerenciar um site do Windows Azure](#WebSites)
* [Como criar e gerenciar uma Máquina Virtual do Windows Azure](#VMs)


<h2><a id="Overview"></a>Quais são as ferramentas de linha de comando do Windows Azure para Mac e Linux</h2>

As ferramentas de linha de comando do Windows Azure para Mac e Linux são um conjunto de ferramentas de linha de comando para implantar e gerenciar os serviços do Windows Azure.
 
As tarefas suportadas incluem o seguinte:

* Importar configurações de publicação.
* Criar e gerenciar sites do Windows Azure.
* Criar e gerenciar Máquinas Virtuais do Windows Azure.
...
<h2><a id="Download">Como instalar as ferramentas de linha de comando do Windows Azure para Mac e Linux</a></h2>
...
* **Mac**: baixe o [SDK do instalador do Windows Azure][mac-installer]. Abra o arquivo .pkg baixado e conclua as etapas de instalação quando for solicitado.
...
* **Windows**: executar o instalador do Windows (arquivo .msi), que está disponível aqui: [Ferramentas de linha de comando do Windows Azure][windows-installer].
...
<h2><a id="CreateAccount"></a>Criar uma conta do Windows Azure</h2>

Para usar as ferramentas de comando do Windows Azure para Mac e Linux, você precisará de uma conta no Windows Azure.
...
![Site do Windows Azure][Windows Azure Web Site]
...
Agora você está pronto para começar a criação e o gerenciamento dos sites do Windows Azure e da Máquinas Virtuais do Windows Azure.  

<h2><a id="WebSites"></a>Como criar e gerenciar um site do Windows Azure</h2>

###Criar um site

Para criar um site do Windows Azure, primeiro crie um diretório vazio chamado 'MySite' e acesse esse diretório.
...
Em seguida, você pode adicionar conteúdo para o diretório do seu site. Usam o fluxo de git regular ('adicionar git', 'confirmação de git') para confirmar seu conteúdo. Use o seguinte comando git para transferir o conteúdo do site para o Windows Azure: 
...
As configurações de aplicativo são pares de valor chave que estão disponíveis para seu aplicativo em tempo de execução. Quando definido para um site do Windows Azure, os valores de configuração de aplicativo substituirão as configurações com a mesma chave definida no arquivo Web.config do seu site. Para aplicativos Node.js e PHP, as configurações do aplicativo estão disponíveis como variáveis de ambiente. O exemplo a seguir mostra como definir um par de valor chave:
...
<h2><a id="VMs"></a>Como criar e gerenciar uma Máquina Virtual do Windows Azure</h2>

Uma Máquina Virtual do Windows Azure é criada a partir de uma imagem de máquina virtual (um arquivo .vhd) fornecida por você ou que está disponível na Galeria de imagens. Para ver as imagens que estão disponíveis, use o comando 'vm image list':
...
Em vez de criar uma imagem de um .vhd local, você pode criar uma imagem de um .vhd armazenado no armazenamento de blob do Windows Azure. Você pode fazer isso com o parâmetro 'blob-url':
