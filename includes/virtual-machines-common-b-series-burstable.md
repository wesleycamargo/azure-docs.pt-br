...
### <a name="q-my-remaining-credit-are-set-to-0-after-a-redepoy-or-a-stopstart"></a>P: Meus créditos restantes estão definidos como 0 depois uma reimplantação ou uma parada/inicio.
