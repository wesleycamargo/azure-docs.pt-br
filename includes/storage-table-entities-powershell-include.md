...
Há três etapas para a atualização de entidades. Primeiro, recupere a entidade para alterar. Em segundo lugar, faça a alteração. Em terceiro lugar, confirme a alteração usando **Update-AzureStorageTableRow**.
