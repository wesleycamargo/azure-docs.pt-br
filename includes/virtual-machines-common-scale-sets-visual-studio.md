...
Implantações de Grupo de Recursos do Azure são uma maneira de agrupar e publicar um conjunto de recursos relacionados do Azure em uma única operação de implantação. Saiba mais sobre eles aqui: [Criando e implantando grupos de recursos do Azure por meio do Visual Studio](../articles/vs-azure-tools-resource-groups-deployment-projects-create-deploy.md).
...
4. Em seguida, selecione o botão **Editar Parâmetros** para inserir parâmetros que serão transmitidos para o Modelo; alguns valores como o nome de usuário e a senha para o SO são necessários para criar a implantação.
