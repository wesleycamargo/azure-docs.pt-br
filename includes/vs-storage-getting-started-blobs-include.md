...
Existem outras maneiras de listar o conteúdo de um contêiner de blob. Consulte [Como usar o Armazenamento de Blob do .NET](../articles/storage/storage-dotnet-how-to-use-blobs.md/#list-blob) para obter mais informações.
...
Existem outras maneiras de salvar blobs como arquivos. Consulte [Como usar o Armazenamento de Blob do .NET](../articles/storage/storage-dotnet-how-to-use-blobs.md/#download-blobs) para obter mais informações.
