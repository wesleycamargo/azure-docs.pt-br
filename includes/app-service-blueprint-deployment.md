* [Implantando um Aplicativo de Serviço de Aplicativo do Azure](../app-service-web/web-sites-deploy.md)
* [Configurando o controle do código-fonte e a integração contínua](../app-service-web/web-sites-publish-source-control.md)
* [Preparando implantações com slots de implantação](../app-service-web/web-sites-staged-publishing.md)
