...
1. No Eclipse, clique em **Janela** e em **Gerenciador do SDK do Android**. Se você não tiver instalado a versão mais recente da plataforma do SDK, clique para instalá-la. Anote o número da versão.
