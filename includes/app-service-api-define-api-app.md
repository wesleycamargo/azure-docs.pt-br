...
2. Navegue até a página do Swagger adicionando `/swagger` ao final da URL base.
   
   ![](./media/app-service-api-define-api-app/swaggerhome.png)
3. Clique em **Contatos > Obter > Experimentar** e você verá que a API está funcionando e retorna o resultado esperado.
   
    ![](./media/app-service-api-define-api-app/swaggertry.png)
4. No Visual Studio, clique em **Depurar > Parar Depuração**.
