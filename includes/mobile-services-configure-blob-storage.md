...
1. Se você ainda não criou sua conta de armazenamento, consulte [Como criar uma conta de armazenamento](../articles/storage/storage-create-storage-account.md).
2. No [portal clássico do Azure](https://manage.windowsazure.com/), clique em **Armazenamento**, na conta de armazenamento e em **Gerenciar Chaves**.
3. Anote o **Nome da Conta de Armazenamento** e a **Chave de Acesso**.
   
       ![](./media/mobile-services-configure-blob-storage/mobile-blob-storage-account-keys.png)
4. No seu serviço móvel, clique na guia **Configurar**, role para baixo até **Configurações do aplicativo** e digite um par de **Nome** e **Valor** para cada uma das opções a seguir que você adquiriu da conta de armazenamento e clique em **Salvar**.
...
5. Na guia Configurar, verifique se [Esquema dinâmico](http://msdn.microsoft.com/library/windowsazure/b6bb7d2d-35ae-47eb-a03f-6ee393e170f7)está habilitado. Você precisa do esquema dinâmico habilitado para poder adicionar novas colunas à tabela TodoItem. O esquema dinâmico não deve ser habilitado em qualquer serviço de produção.
6. Clique na guia **Dados** e, em seguida, clique na tabela **TodoItem**.
7. Em **todoitem**, clique na guia **Script** e selecione **Inserir**. Substitua a função de inserção pelo código a seguir e clique em **Salvar**:
   ...
   > [!NOTE]
   > Esse código cria uma SAS para um BLOB individual. Se precisar carregar vários blobs em um contêiner usando a mesma SAS, você poderá chamar o método [generateSharedAccessSignature](http://go.microsoft.com/fwlink/?LinkId=390455)</a> com um nome de recurso de blob vazio, como este:
   > 
