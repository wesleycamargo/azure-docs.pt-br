...
2. Clique em **Parâmetros**. No painel **Parâmetros**, insira novos valores, selecione os valores permitidos ou aceite os valores padrão e clique em **OK**.
...
Ao executar o comando **azure group deployment create** , será solicitado que você insira os valores para os parâmetros no modelo. Dependendo do modelo, pode levar algum tempo para que o Azure implante os recursos.
