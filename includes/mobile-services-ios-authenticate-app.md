...
<p>Se voc&ecirc; estiver usando um provedor de identidade diferente do Facebook, altere o valor passado para <strong>loginWithProvider</strong> acima para um dos seguintes: <em>microsoftaccount</em>, <em>facebook</em>, <em>twitter</em>, <em>google</em> ou <em>windowsazureactivedirectory</em>.</p>
</div>
