...
| &nbsp; |[Vertical (Beta)](../articles/data-factory/connector-vertica.md) |✓ | |✓ |✓  |
...
> [!NOTE]
> Um conector marcado como *Beta* significa que você pode experimentá-lo e nos enviar comentários. Se você quiser uma dependência de conectores Beta em sua solução, entre em contato com [suporte do Azure](https://azure.microsoft.com/support/).