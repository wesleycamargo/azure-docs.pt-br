...
1. A caixa de diálogo **Anexar disco vazio** é exibida.
...
1. Após o disco de dados ser criado e anexado, ele é listado no painel da VM.
   
   ![Disco de dados vazio anexado com êxito](./media/howto-attach-disk-windows-linux/AttachEmptySuccess.png)

> [!NOTE]
> Depois de adicionar um novo disco de dados, você precisará fazer logon na VM e inicializar o disco para que ele possa ser usado.
> 
> 
...
1. Selecione o disco de dados e, em seguida, clique na marca de seleção para anexar o disco de dados.
   
    ![Insira os detalhes do disco de dados](./media/howto-attach-disk-windows-linux/AttachExistingDetail.png)
2. Após o disco de dados ser anexado, ele é listado no painel da VM.
