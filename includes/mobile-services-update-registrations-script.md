...
1. No Portal de Gerenciamento, clique na guia **Dados** e, em seguida, clique na tabela **Registro**. 
...
Isso exibirá a função invocada quando ocorrer uma inserção na tabela **Registros**.
