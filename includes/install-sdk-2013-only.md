<h2><a name="setupdevenv"></a>Configurar o ambiente de desenvolvimento</h2>

Para começar, configure o ambiente de desenvolvimento instalando o [SDK do Azure para Visual Studio 2013][].
