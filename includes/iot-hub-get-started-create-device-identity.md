...
Nesta seção, você use uma ferramenta do Node.js chamada [Gerenciador do Hub IoT][iot-hub-explorer] para criar uma identidade de dispositivo para este tutorial.
