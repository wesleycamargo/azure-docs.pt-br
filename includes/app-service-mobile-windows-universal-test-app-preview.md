...
Volte ao Visual Studio e selecione o projeto de aplicativo de cliente de código compartilhado (ele é nomeado como '<NomeDoSeuAplicativo>.Compartilhado')
...
2. No aplicativo, digite um texto significativo como *Complete the tutorial* na caixa de texto **Inserir um TodoItem** e, em seguida, clique em **Salvar**.
...
3. Interrompa a depuração e altere a projeto de inicialização padrão na solução universal do Windows para o aplicativo da Loja do Windows Phone clique com botão direito do mouse no projeto `<NomeDoSeuAplicativo>.WindowsPhone`, clique em **Definir como projeto de inicialização**) e pressione F5 novamente.
