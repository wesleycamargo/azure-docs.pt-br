...
2.  Abra o arquivo MainPage.xaml e substitua o elemento **StackPanel** diretamente após o primeiro elemento **Task** com o código a seguir:
...
3.  Substitua o elemento **StackPanel** no **DataTemplate** pelo código a seguir:
...
4.  Abra o arquivo de projeto MainPage.xaml.cs e adicione as seguintes instruções **using**:
...
5.  Na classe TodoItem, adicione as propriedades a seguir:
...
6.  Na classe MainPage, adicione este código:
...
7.  Substitua o método `InsertTodoItem` existente por este código:
