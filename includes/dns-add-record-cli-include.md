...
Para criar conjunto de registros, use `azure network dns record-set create`. Especifique o grupo de recursos, o nome da zona, o nome relativo do conjunto de registros, o tipo de registro e a TTL (vida útil).
...
Se você estiver criando um registro SRV na raiz da zona, poderá especificar “\_service” e “\_protocol” no nome do registro. Não é necessário incluir também '.@' no nome do registro.
