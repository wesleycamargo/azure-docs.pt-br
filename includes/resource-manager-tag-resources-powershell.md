...
A versão de agosto de 2016 do Azure PowerShell inclui alterações significativas no trabalho com marcações. Antes de continuar, verifique a versão do módulo AzureRm.Resources.
