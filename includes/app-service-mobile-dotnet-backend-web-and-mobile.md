# Criar um aplicativo com um dispositivo móvel e cliente da Web no Serviço de Aplicativo do Azure
...
4. Em seguida, iremos obter a cadeia de conexão do aplicativo móvel por meio do Portal do Azure:
    ...
    - Em **Cadeias de conexão**, clique em **Mostrar cadeias de conexão**. Copie o valor da configuração **MS_TableConnectionString**. Esta é a cadeia de conexão usada pelo aplicativo móvel para conectar-se ao banco de dados SQL.
...
3. No assistente **Publicar Web**, selecione **Aplicativo Web do Azure** como o destino de publicação e crie um novo aplicativo Web, sem um banco de dados. 
...
Neste exemplo, mostramos como usar o mesmo banco de dados subjacente para um aplicativo que tenha tanto um site quanto um cliente móvel. Nesse caso não existia nenhuma lógica de negócios no back-end que desejávamos reutilizar entre os dois clientes, portanto, ele foi suficiente para simplesmente compartilhar o mesmo banco de dados. Em um tutorial futuro, você aprenderá como adicionar lógica de negócios à sua API da Web e reutilizar essa lógica em seu código de back-end do aplicativo móvel.
