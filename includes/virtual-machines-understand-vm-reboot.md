...
- [Como agendar a manutenção planejada em VMs do Azure](../articles/virtual-machines/windows/planned-maintenance-schedule.md)
...
### Ações de reinicialização ou desligamento iniciado pelo usuário
...
### Central de Segurança do Azure e Windows Update
