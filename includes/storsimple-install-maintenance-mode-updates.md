...
9. Depois que ambos os controladores estiverem atualizados, saia do modo de Manutenção. Consulte [Etapa 4: Sair do modo de manutenção](../articles/storsimple/storsimple-update-device.md#step4) para obter instruções.
