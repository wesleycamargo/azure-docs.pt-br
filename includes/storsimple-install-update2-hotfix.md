...
8. Repita as etapas de 3 a 5 para instalar os hotfixes restantes do modo normal.
...
3. Monitore o andamento da instalação usando o comando `Get-HcsUpdateStatus`. A atualização é concluída quando `RunInProgress` muda para `False`.
