...
>[WACOM.NOTE]Os métodos abaixo devem ter o **RequiresAuthorizationAttribute** aplicado no **Usuário** **Authorizationlevel**. Isso restringe o acesso de tabela apenas a usuários autenticados.

1. No Visual Studio 2013, abra o projeto de serviço móvel, expanda a pasta DataObjects e abra o arquivo de projeto TodoItem.cs.
...
4. Localize o método **PostTodoItem** e adicione o seguinte código ao final antes da instrução **return**:
