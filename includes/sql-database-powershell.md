...
Primeiro, você deve ter o [Azure PowerShell](https://msdn.microsoft.com/library/mt619274\(v=azure.300\).aspx) mais recente instalado e em execução. Para obter informações detalhadas, confira [Como instalar e configurar o PowerShell do Azure](../articles/powershell-install-configure.md).
