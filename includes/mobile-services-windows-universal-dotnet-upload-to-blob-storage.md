...
4. Substitua o elemento **StackPanel** no **DataTemplate** pelo código a seguir:
...
5. No projeto de aplicativo do Windows Phone, abra o arquivo MainPage.xaml e substitua o elemento **ButtonSave** pelo código a seguir:
...
6. Substitua o elemento **StackPanel** no **DataTemplate** pelo código a seguir:
...
7. Na pasta compartilhada DataModel, abra o arquivo de projeto TodoItem.cs e adicione as seguintes propriedades à classe TodoItem:
...
8. Abra o arquivo de projeto compartilhado MainPage.cs e adicione as seguintes instruções **using**:
...
9. Adicione o seguinte código à classe MainPage:
...
10. Substitua o método `InsertTodoItem` pelo código a seguir:
...
7. Toque em Visualizar para tirar uma foto e clique em **Carregar** para inserir o novo item e carregar a imagem.
