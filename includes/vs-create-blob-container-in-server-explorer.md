Você pode criar contêineres de blob usando o **Gerenciador de Servidores** do Visual Studio.
...
3. Selecione o nó **Blobs** e escolha**Criar Contêiner de Blob** no menu de contexto.
