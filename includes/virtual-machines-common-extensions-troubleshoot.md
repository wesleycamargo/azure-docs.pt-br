...
Veja [Criando modelos de extensão](../articles/virtual-machines/windows/template-description.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) para saber mais sobre como criar modelos para usar as extensões.
