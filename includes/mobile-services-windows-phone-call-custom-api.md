...
1. No Visual Studio 2012 Express para Windows Phone, abra o arquivo MainPage.xaml em seu projeto de quickstart, localize o elemento **Botão** chamado  `ButtonRefresh` e substitua-o pelo seguinte código XAML: 
...
4. Toque no botão **Tudo Concluído**.
	...
	É exibida uma caixa de mensagem que indica o número de itens marcados como concluídos, e a consulta filtrada é executada novamente, o que limpa todos os itens da lista.<!--HONumber=42-->
