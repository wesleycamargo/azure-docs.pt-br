> [WACOM.NOTE] **Este artigo é para Sites do Azure**; para Serviços de Nuvem, consulte <a href="/pt-br/develop/net/common-tasks/custom-dns/">Configurando um nome de domínio personalizado no Azure</a>.
>
