...
### <a name="provides-costeffective-availability-for-cold-data"></a>Fornece disponibilidade econômica para dados frios
...
### <a name="streamlines-onpremises-data-maintenance"></a>Simplifica a manutenção de dados locais
