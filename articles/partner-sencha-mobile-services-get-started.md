...
<p>Este tutorial mostra como usar os Servi&ccedil;os M&oacute;veis do Azure no aplicativo Sencha Touch. Voc&ecirc; criar&aacute; um aplicativo simples de Lista de Tarefas Pendentes usando o Sencha Touch, que usa um servi&ccedil;o m&oacute;vel definido por meio do Portal de Gerenciamento. Este tutorial destina-se a desenvolvedores de aplicativos web intermedi&aacute;rios a avan&ccedil;ados que tenham um bom entendimento do JavaScript e que estejam familiarizados com a estrutura do Sencha Touch. </p>
<p>Se voc&ecirc; preferir assistir a um v&iacute;deo, o clipe &agrave; direita segue as mesmas etapas deste tutorial. No v&iacute;deo, Arthur Kay explicar&aacute; como criar um aplicativo do Sencha Touch usando um back-end dos Servi&ccedil;os M&oacute;veis do Azure.</p>
</div>

<div class="dev-onpage-video-wrapper"><a href="http://go.microsoft.com/fwlink/?LinkId=392574" target="_blank" class="label">assista ao tutorial</a> <a style="background-image: url('/media/partner-sencha-mobile-services-get-started/mobile-sencha-get-started-180x120.png') !important;" href="http://go.microsoft.com/fwlink/?LinkId=392574" target="_blank" class="dev-onpage-video"><span class="icon">Reproduzir o v&iacute;deo</span></a> <span class="time">14:37</span></div>
...
Após a criação do seu serviço móvel, será possível seguir as etapas de um início rápido e fácil no Portal de Gerenciamento para criar uma nova
tabela do banco de dados para usar em seu serviço móvel.
...
<p>N&Atilde;O baixe o aplicativo HTML do Portal de Gerenciamento. Em vez disso, criaremos manualmente um aplicativo do Sencha Touch na se&ccedil;&atilde;o abaixo.</p></div>
...
<div class="dev-callout"> 
    <b>Observa&ccedil;&atilde;o</b> 
    <p>Voc&ecirc; s&oacute; pode usar este m&eacute;todo quando seu aplicativo tiver sido gerado com o uso do comando <code data-inline="1">sencha generate app</code>.</p></div>
...
2.  Usando o Sencha Cmd, execute os comandos a seguir:
    ...
    -   *sencha app refresh*: Este comando instruirá o Sencha Cmd a localizar todas as dependências do aplicativo
         e baixar os pacotes necessários (por exemplo, [Extensões do Sencha Touch para o Azure][aqui]).
...
<!-- images -->
  ...
  [assista ao tutorial]: http://go.microsoft.com/fwlink/?LinkId=392574
  ...
  [aqui]: https://market.sencha.com/extensions/sencha-touch-extensions-for-windows-azure
  [Pacotes do Sencha Cmd]: http://docs.sencha.com/cmd/3.1.2/#!/guide/command_packages
  [Introdução ao Azure]: http://senchaazuredocs.azurewebsites.net/#!/guide/getting_started
  ...
  [Baixe]: https://github.com/arthurakay/sencha-touch-azure-example
  [walkthrough]: http://docs.sencha.com/touch-azure/1.0.0/#!/guide/data_filters
  [Fóruns do Sencha]: http://www.sencha.com/forum
  [Documentação do Sencha]: http://docs.sencha.com/
  [(Vídeo)]: http://channel9.msdn.com/Shows/Cloud+Cover/Episode-126-Using-Sencha-With-Windows-Azure-Mobile-Services
  [Baixe o Sencha Touch]: http://pages.sencha.com/touch-for-azure.html
  [guias]: http://docs.sencha.com/touch/#!/guide
