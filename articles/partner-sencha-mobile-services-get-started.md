<properties linkid="develop-mobile-tutorials-get-started-sencha" urlDisplayName="Introdução" pageTitle="Introdução aos Serviços Móveis do Azure e ao Sencha" metaKeywords="" description="Siga este tutorial para começar a desenvolver os Serviços Móveis e a estrutura de aplicativos para dispositivos móveis Sencha HTML5. " metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="" documentationCenter="Mobile" title="Introdução aos Serviços Móveis e ao Sencha Touch" authors="sencha" solutions="" manager="" editor="" />
...
<div class="dev-center-tutorial-selector sublanding">
	...
	<a href="/pt-br/documentation/articles/partner-sencha-mobile-services-get-started/" title="Sencha" class="current">Sencha</a>
...
<!--<div class="dev-center-tutorial-subselector">
	<a href="/pt-br/documentation/articles/partner-sencha-mobile-services-dotnet-backend-get-started/" title="Back-end do .NET">Back-end do .NET</a> | 
	<a href="/pt-br/documentation/articles/partner-sencha-mobile-services-get-started/"  title="Back-end do JavaScript" class="current">Back-end do JavaScript</a>
</div>-->
...
Depois de criar seu serviço móvel, você poderá seguir as etapas de um início rápido e fácil no Portal de Gerenciamento para criar uma nova tabela do banco de dados para usar em seu serviço móvel.
...
2. Na guia de início rápido, clique em **HTML** em **Escolher plataforma** e expanda **Criar um novo aplicativo HTML**.
    ...
    ![html de início rápido de dispositivos móveis](./media/partner-sencha-mobile-services-get-started/mobile-portal-quickstart-html.png)

    Isso exibirá as três etapas fáceis para a criação e a hospedagem de um aplicativo HTML conectado ao seu serviço móvel.

    ![html de início rápido de dispositivos móveis](./media/partner-sencha-mobile-services-get-started/mobile-quickstart-steps-html.png)
...
Seu aplicativo do Touch irá se comunicar com o serviço móvel por meio de um proxy de dados. O proxy faz todo o trabalho de enviar solicitações e receber dados do serviço móvel. Utilizado em combinação com um modelo de dados e armazenamento do Touch, o trabalho pesado de processar dados remotos e colocá-los em seu aplicativo é removido e manipulado pelo próprio Touch.
...
###Criar modo de exibição primário
...
O estágio final deste tutorial consiste em hospedar e executar seu novo aplicativo no computador local.
  ...
  2. Usando o Sencha Cmd, execute os seguintes comandos:
