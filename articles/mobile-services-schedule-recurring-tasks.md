<properties linkid="develop-mobile-tutorials-schedule-backend-tasks" urlDisplayName="Agendar tarefas de back-end" pageTitle="Agendar tarefas de back-end com o Agendador - Serviços Móveis" metaKeywords="" description="Usar o Agendador dos Serviços Móveis do Azure para agendar trabalhos para seu aplicativo móvel." metaCanonical="" services="" documentationCenter="Mobile" title="Agendar trabalhos recorrentes nos Serviços Móveis" authors="glenga" solutions="" manager="" editor="" />

# Agendar trabalhos recorrentes nos Serviços Móveis 

<!--<div class="dev-center-tutorial-subselector">
	<a href="/pt-br/documentation/articles/articles/mobile-services-dotnet-backend-schedule-recurring-tasks/" title="Back-end do .NET">Back-end do .NET</a> | <a href="/pt-br/documentation/articles/articles/mobile-services-schedule-recurring-tasks/"  title="Back-end do JavaScript" class="current">Back-end do JavaScript</a>
</div>-->
...
+ [Criar a nova tabela Atualizações]
+ [Criar um novo trabalho agendado]

##<a name="get-oauth-credentials"></a>Registrar-se para acesso às APIs do Twitter v.1.1 e armazenar as credenciais
...
[Criar a nova tabela Atualizações]: #create-table
...
[Registrar seus aplicativos para logon no Twitter com os Serviços Móveis]: /pt-br/develop/mobile/how-to-guides/register-for-twitter-authentication
