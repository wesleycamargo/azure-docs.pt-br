<properties pageTitle="Adicionar paginação aos dados (Windows Phone) | Mobile Dev Center" metaKeywords="" description="Saiba como usar paginação para gerenciar a quantidade de dados retornada a seu aplicativo Windows Phone dos Serviços Móveis" metaCanonical="" services="" documentationCenter="Mobile" title="Refinas as consultas dos Serviços Móveis com paginação" authors="glenga" solutions="" manager="" editor="" />
