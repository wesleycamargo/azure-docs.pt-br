<properties pageTitle="Introdução aos Serviços Móveis com PhoneGap | Mobile Dev Center" metaKeywords="" description="Siga este tutorial para obter uma introdução aos Serviços Móveis do Azure para desenvolvimento em PhoneGap para iOS, Android e Windows Phone." metaCanonical="" services="mobile" documentationCenter="Mobile" title="Introdução aos Serviços Móveis" authors="glenga" solutions="" manager="" editor="" />
...
<div class="dev-center-tutorial-selector sublanding">
	...
	<a href="/pt-br/documentation/articles/mobile-services-javascript-backend-phonegap-get-started/" title="PhoneGap" class="current">PhoneGap</a>
</div>

<!--<div class="dev-center-tutorial-subselector">
	<a href="/pt-br/documentation/articles/mobile-services-dotnet-backend-phonegap-get-started/" title="Back-end do .NET">Back-end do .NET</a> | <a href="/pt-br/documentation/articles/mobile-services-javascript-backend-phonegap-get-started/"  title="Back-end do JavaScript" class="current">Back-end do JavaScript</a>
</div>-->
...
- Android: instale as [Android Developer Tools][Android SDK]
...
<h2><span class="short-header">Criar um novo aplicativo</span>Criar um novo aplicativo PhoneGap</h2>
...
2.	Abra e execute o projeto de acordo com as instruções abaixo para cada plataforma.
	...
	+ **Android**
		...
		2. Clique em **Procurar**, navegue até o local dos arquivos do projeto expandido, clique em **OK**, verifique se o projeto TodoActivity está marcado e clique em **Concluir**. <p>Isso importa os arquivos de projeto no espaço de trabalho atual.</p>
