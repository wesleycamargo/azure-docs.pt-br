...
<div class="dev-center-tutorial-selector sublanding"> 
        <a href="/pt-br/documentation/articles/notification-hubs-windows-store-dotnet-send-localized-breaking-news/" title="Windows Store C#" class="current">Windows Store C#</a><a href="/pt-br/documentation/articles/notification-hubs-ios-send-localized-breaking-news/" title="iOS">iOS</a>
</div>
...
3.  [Criando o aplicativo cliente da Windows Store][Criando o aplicativo cliente da Windows Store]
...
## <a name="building-client"></a><span class="building app">Interface de usuário do aplicativo</span>Criando o aplicativo cliente da Windows Store
...
4.  Finalmente, no seu arquivo App.xaml.cs, certifique-se de atualizar sua chamada ao
