...
- **Descrição**: Forneça os detalhes do banco de dados SQL do Azure para pelo menos um componente, para usar as configurações personalizadas para os metastores do Hive e do Oozie.   
...
- **Descrição**: O nome de usuário do cluster é inválido. Verifique se o nome do usuário contém caracteres especiais ou espaços.  
