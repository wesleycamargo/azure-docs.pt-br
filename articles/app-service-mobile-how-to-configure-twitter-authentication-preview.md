...
2. Digite os valores de **Nome**, **Descrição** e **Site** para seu aplicativo.  Em seguida, em **Callback URL**, digite a URL do seu gateway anexada ao caminho, _/signin-twitter_.  Por exemplo, `https://contosogateway.azurewebsites.net/signin-twitter`.  Certifique-se de estar usando o esquema HTTPS.
...
7. Em **Configurações**, escolha **Identidade**e, em seguida, selecione **Twitter**.  Cole os valores de ID do Aplicativo e Segredo do Aplicativo que você obteve anteriormente.  Em seguida, clique em **Salvar**.
