...
![Codificação estática](./media/media-services-dynamic-packaging/media-services-static-packaging.png)

O diagrama a seguir mostra o fluxo de trabalho de empacotamento dinâmico.

![Codificação dinâmica](./media/media-services-dynamic-packaging/media-services-dynamic-packaging.png)
...
- Arquivos smooth Dolby digital plus. <!--HONumber=52-->
