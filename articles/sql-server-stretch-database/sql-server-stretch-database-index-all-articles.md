...
description: Tabela de todos os tópicos existentes para o serviço do Azure nomeado SQL Server Stretch Database existente em http://azure.microsoft.com/documentation/articles/, Título e descrição.
