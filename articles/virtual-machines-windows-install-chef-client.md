...
Chef é um sistema cliente/servidor. Para saber as opções sobre como usar um servidor do Chef, consulte [Escolher a instalação](http://www.getchef.com/chef/choose-your-version/). Você precisará de informações sobre o servidor do Chef para configurar o cliente. 

Para instalar o cliente do Chef em uma máquina virtual do Azure, você tem estas opções:

- Use o Portal de Gerenciamento do Azure para instalar o cliente do Chef ao criar uma máquina virtual na qual o Windows Server 2012 ou o Windows Server 2012 R2 está em execução. Para obter instruções, consulte [Microsoft Azure Portal](https://docs.chef.io/azure_portal.html).
- Use o PowerShell do Azure para instalar o cliente do Chef em uma máquina virtual existente. Um [script](https://gist.github.com/kaustubh-d/cea1aa75baebd3615609) de exemplo está disponível no Github.
