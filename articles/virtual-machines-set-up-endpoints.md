<properties urlDisplayName="Set up endpoints" pageTitle="Configurar pontos de extremidade em uma m&aacute;quina virtual no Azure" metaKeywords="Azure config setup, configuring vm connection" description="Saiba como configurar a comunica&ccedil;&atilde;o com uma m&aacute;quina virtual no Azure." metaCanonical="" services="virtual-machines" documentationCenter="" title="" authors="timlt" solutions="" manager="timlt" editor="" />
