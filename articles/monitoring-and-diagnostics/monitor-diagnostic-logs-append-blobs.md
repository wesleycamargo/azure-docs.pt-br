...
> [!WARNING]
> Se você estiver enviando [métricas ou logs de diagnóstico de recurso do Azure para uma conta de armazenamento usando as configurações de diagnóstico de recurso](./monitoring-archive-diagnostic-logs.md) ou [logs de atividades para uma conta de armazenamento usando perfis de log](./monitoring-archive-activity-log.md), o formato dos dados na conta de armazenamento será alterado para Linhas JSON em 1º de novembro de 2018. As instruções abaixo descrevem o impacto e como atualizar suas ferramentas para manipular o novo formato. 
>
> 
...
![Folha Configurações de Diagnóstico do Azure Monitor](./media/monitor-diagnostic-logs-append-blobs\portal-diag-settings.png)
...
![Conta de armazenamento habilitada](./media/monitor-diagnostic-logs-append-blobs\portal-storage-enabled.png)
...
* Saiba mais sobre como [arquivar logs de diagnóstico de recurso em uma conta de armazenamento](./monitoring-archive-diagnostic-logs.md)
* Saiba mais sobre como [arquivar dados de log de atividades em uma conta de armazenamento](./monitoring-archive-activity-log.md)
