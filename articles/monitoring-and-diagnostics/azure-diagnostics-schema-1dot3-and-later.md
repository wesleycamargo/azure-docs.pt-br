---
title: "Esquema de Configuração do Diagnóstico do Azure 1.3, 1.4, 1.5, 1.6, 1.7 | Microsoft Docs"
description: "A versão de esquema 1.3 e posterior do Diagnóstico do Azure é fornecida como parte do SDK do Microsoft Azure."
...
Este é o equivalente em JSON do arquivo de configuração XML anterior.  
```json
{
    "WadCfg": {
        "DiagnosticMonitorConfiguration": {
