...
1.  Defina a condição de alerta usando o link **Selecionar Recurso** e especificando o destino, ao selecionar um recurso. Filtre, escolhendo a *Assinatura*, o *Tipo de Recurso* e finalmente selecionando o *Recurso* necessário.
...
1. O **Painel de Alertas** é exibido, contendo todos os alertas do Azure unificados e exibidos em um painel singular ![Painel de Alerta](./media/monitoring-alerts-unified-usage/alerts-preview-overview.png)
