...
Este artigo pressupõe que você tenha um aplicativo Web configurado com o Application Insights. Se ainda não tiver um, você poderá [configurar o Application Insights para seu site do ASP.NET][1]
