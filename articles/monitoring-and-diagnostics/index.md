        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre os recursos de monitoramento e diagnóstico do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Central de vídeo do Azure Monitor</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Crie alertas para os serviços do Azure usando o Portal do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Crie alertas para os serviços do Azure usando a CLI da plataforma</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Crie alertas para os serviços do Azure usando o PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar um alerta de métrica com um modelo do Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Monitoramento</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">Lista de métricas com suporte</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">Fontes de dados de monitoramento</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Diagnostics</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Histórico de versões de extensão do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Esquema de extensão do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Esquema de extensão 1.0 do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Esquema de extensão 1.2 do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Esquema de extensão do Diagnóstico do Azure 1.3 e superior</a></p>
                    </div>
                </div>
            </div>
        </div>
