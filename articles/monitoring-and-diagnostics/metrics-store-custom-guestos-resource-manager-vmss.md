...
Em **extensionProfile**, adicione uma nova extensão ao modelo, como mostrado na **seção VMSS-WAD-extension**.  Essa seção é a extensão MSI (Identidade de Serviço Gerenciada) que faz com que as métricas emitidas sejam aceitas pelo Azure Monitor. O campo **nome** pode conter qualquer nome. 
