...
1. Para alertas do **Nagios** e **Zabbix**, [configure esses servidores](https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-linux-agents) para enviar alertas para o Log Analytics.
