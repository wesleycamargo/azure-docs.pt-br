...
[!code-azurecli[main](../../../cli_scripts/virtual-network/route-traffic-through-nva/route-traffic-through-nva.sh "Rotear o tráfego por meio de uma solução de virtualização de rede")]
