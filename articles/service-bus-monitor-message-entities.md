...
Este tópico descreve como gerenciar e monitorar suas entidades do Barramento de Serviço usando o [Portal de Gerenciamento do Azure][Portal de Gerenciamento do Azure]. Com o portal, você obtém uma visão abrangente do status de suas filas e tópicos. Você também pode monitorar seu uso.
