<properties pageTitle="Autorização do lado do serviço (iOS) | Centro de Desenvolvimento Móvel" metaKeywords ="" description="Saiba como autorizar usuários no back-end JavaScript dos Serviços Móveis do Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="krisragh" solutions="" manager="dwrede" editor="" />
