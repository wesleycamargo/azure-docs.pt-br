...
Esta seção fornece detalhes sobre como criar e configurar os componentes a seguir do balanceador de carga:
  ...
  - uma investigação de integridade que determina a integridade das instâncias VM de back-end.
...
Criar uma rede virtual chamado *myVnet* com uma sub-rede chamada *mySubnet* no *myResourceGroup* usando [az network vnet create](https://docs.microsoft.com/cli/azure/network/vnet#create).
