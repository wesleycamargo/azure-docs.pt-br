...
Saiba como [executar estas etapas usando o modelo do Resource Manager](load-balancer-get-started-ilb-arm-cli.md).
...
**-t** – nome da sub-rede (mesma sub-rede das máquinas virtuais que você adicionará ao balanceador de carga interno)<BR>
...
**-r** – protocolo de investigação<BR>
**-e** – intervalo de investigação em segundos<BR>
