...
---
# <a name="create-a-public-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Criar um balanceador de carga público para balancear cargas de VMs usando a CLI 2.0 do Azure
