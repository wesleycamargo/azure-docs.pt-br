<properties
    pageTitle="Criar um balanceador de carga para a Internet com IPv6 usando o PowerShell para Resource Manager | Microsoft Azure"
...
# Introdução à criação de um balanceador de carga para a Internet com IPv6 usando o PowerShell para Resource Manager
...
## Implantar a solução usando o Azure PowerShell
...
## Criar configurações de IP de front-end e um pool de endereços de back-end
...
2. Crie um teste de integridade. Há duas maneiras de configurar uma investigação:
    ...
    Para este exemplo, vamos usar a investigação TCP.
...
## Crie NICs para as VMs de back-end
...
3. Crie NICs e associe-os às regras NAT e ao pool de endereços de back-end.

        $backendnic1= New-AzureRmNetworkInterface -ResourceGroupName NRP-RG -Name lb-nic1-be -Location 'West US' -PrivateIpAddress 10.0.2.6 -Subnet $backendSubnet -LoadBalancerBackendAddressPool $nrplb.BackendAddressPools[0] -LoadBalancerInboundNatRule $nrplb.InboundNatRules[0]

## Crie máquinas virtuais e atribua os NICs recém-criados

Para obter mais informações sobre como criar uma VM, consulte [Criar e pré-configurar uma máquina virtual do Windows com o Gerenciador de Recursos e o Azure PowerShell](..\virtual-machines\virtual-machines-windows-ps-create.md)
