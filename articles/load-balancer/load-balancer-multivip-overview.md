<properties
   pageTitle="Múltiplos VIPs para o Azure Load Balancer | Microsoft Azure"
...
>[AZURE.IMPORTANT] A configuração das interfaces de lógica é executada no sistema operacional convidado. Essa configuração não é executada ou gerenciada pelo Azure. Sem essa configuração, as regras não funcionarão. As definições de investigação de integridade usam o DIP da VM em vez do VIP lógico. Portanto, o serviço deve fornecer respostas de investigação em uma porta DIP que refletem o status do serviço oferecido no VIP lógico.
