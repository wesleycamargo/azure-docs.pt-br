---
title: Criar um Load Balancer Standard público com frontend de endereço IP público de zona usando a CLI do Azure | Microsoft Docs
description: Saiba como criar um Load Balancer Standard público com frontend de endereço IP público de zona usando a CLI do Azure
...
Crie um endereço IP público com [New-AzureRmPublicIpAddress](/powershell/module/azurerm.network/new-azurermpublicipaddress). O exemplo a seguir cria um endereço IP público zonal chamado *myPublicIP* no grupo de recursos *myResourceGroupLoadBalancer* na zona 1.
