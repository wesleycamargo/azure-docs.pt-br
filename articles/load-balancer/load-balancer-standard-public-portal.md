---
title: Criar um balanceador de carga padrão – Portal do Azure | Microsoft Docs
description: Saiba como criar um balanceador de carga padrão usando o Portal do Azure.
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-the-azure-portal"></a>Criar um balanceador de carga padrão para VMs usando o Portal do Azure
...
3. Insira esses valores para a regra de segurança de entrada denominada *myHTTPRule* para permitir conexões de entrada HTTP usando a porta 80:
    ...
    - *80* – para **Intervalos da porta de destino**
    - *TCP* – para **Protocolo**
    - *Allow* – para **Ação**
    - *100* – para **Prioridade**
...
5. Repita as etapas 2 a 4 para criar outra regra denominada *myRDPRule* para permitir uma conexão de RDP de entrada usando a porta 3389 com os seguintes valores:
    - *Service Tag* – para **Fonte**.
    - *Internet* – para **Marca de serviço de fonte**
    - *3389* – para **Intervalos da porta de destino**
    - *TCP* – para **Protocolo**
    - *Allow* – para **Ação**
    - *200* – para **Prioridade**
    - *myRDPRule* – para nome
...
2. Em **Configurações**, clique em **Pools de back-end**, depois clique em **Adicionar**.
...
1. Clique em **Todos os recursos** no menu esquerdo e depois clique em **myLoadBalancer** na lista de recursos.
2. Em **Configurações**, clique em **Investigação de integridade**, depois clique em **Adicionar**.
3. Use esses valores para criar a investigação de integridade:
...
1. Clique em **Todos os recursos** no menu esquerdo e depois clique em **myLoadBalancer** na lista de recursos.
2. Em **Configurações**, clique em **Regras de balanceamento de carga**, depois em **Adicionar**.
...
1. Localize o endereço IP público para o balanceador de carga na tela **Visão geral**. Clique em **Todos os recursos**, depois clique em **myPublicIP**.
...
Quando não for mais necessário, exclua o grupo de recursos, o balanceador de carga e todos os recursos relacionados. Para isso, selecione o grupo de recursos que contém o balanceador de carga e clique em **Excluir**.
