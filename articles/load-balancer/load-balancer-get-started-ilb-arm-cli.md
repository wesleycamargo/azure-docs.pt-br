...
1. Se você nunca tiver usado a CLI do Azure, consulte [Instalar e configurar a CLI do Azure](../../articles/xplat-cli-install.md). Siga as instruções até o ponto onde você seleciona a conta e a assinatura do Azure.
...
1. Criar um balanceador de carga interno
    ...
    >[AZURE.NOTE] Todos os recursos de balanceadores de carga internos, como redes virtuais e sub-redes da rede virtual, devem estar no mesmo grupo de recursos e na mesma região.
