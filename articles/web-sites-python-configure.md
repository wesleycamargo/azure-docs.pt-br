<properties urlDisplayName="Configuring Python with Azure Websites" pageTitle="Configurar o Python com os Sites do Azure" metaKeywords="" description="Este tutorial descreve opções para criar e configurar um aplicativo Phyton compatível com Web server Gateway Interface (WSGI) básica nos sites do Azure." metaCanonical="" services="web-sites" documentationCenter="Python" title="Configuring Python with Azure Websites" authors="huvalo" solutions="" manager="wpickett" editor="" />
