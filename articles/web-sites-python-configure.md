...
Abaixo está o código para o manipulador WSGI básico. É semelhante ao sugerido pela especificação [PEP 3333][PEP 3333] como ponto de partida para um aplicativo compatível com WSGI. Salvamos o conteúdo em um arquivo chamado ConfigurePython.py criado em uma pasta ConfigurePython na raiz do site:
...
-   *iniciar\_resposta*: callable fornecido pelo servidor web para transferência do cabeçalho de status e resposta HTTP
...
> Isto irá informar o Python onde procurar o código do aplicativo. o D:\\home\\site\\wwwroot também é usado aqui como o caminho absoluto para o site.

2.2. Configurar a variável WSGI\_HANDLER.
...
![][5]
  ...
  [0]: http://www.windowsazure.com/pt-br/develop/python/tutorials/web-sites-with-django
  [PEP 3333]: http://www.python.org/dev/peps/pep-3333/
  [1]: http://www.windowsazure.com/pt-br/manage/services/web-sites/how-to-create-websites
