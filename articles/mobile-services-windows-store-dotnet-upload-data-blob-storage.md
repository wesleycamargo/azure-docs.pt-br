<properties pageTitle="Usar os serviços móveis para carregar imagens no armazenamento de blob (Windows Store) | Serviços móveis" metaKeywords ="" description="Aprenda como usar os Serviços Móveis para carregar imagens no armazenamento de Blob do Azure e acessar as imagens do seu aplicativo da Windows Store." metaCanonical="" services="mobile-services,storage" documentationCenter="Mobile" title="Upload images to Azure Storage by using Mobile Services" authors="glenga" solutions="mobile" manager="dwrede" editor="" />
