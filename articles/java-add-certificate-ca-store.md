<properties linkid="develop-java-how-to-add-a-certificate" urlDisplayName="Adicionar um certificado ao armazenamento de CA" pageTitle="Adicionar um certificado ao armazenamento de CA Java - Azure" metaKeywords="Azure Twilio Java, Certificado Twilio Java, Certificado do Azure Service Bus" description="Aprenda a adicionar uma autoridade de certificado (CA) ao repositório de certificados de CA Java (cacerts) para serviço Twilio ou Service Bus do Azure." metaCanonical="" services="" documentationCenter="Java" title="Adicione um certificado no armazenamento de certificados de autoridade de certificação Java" authors=""  solutions="" writer="waltpo" manager="bjsmith" editor="mollybos"  />
...
Para obter mais informações sobre a keytool, consulte <http://docs.oracle.com/javase/7/docs/technotes/tools/windows/keytool.html>.

# Certificados Raiz do Azure
...
Para obter mais informações sobre os certificados raiz usados pelo Azure, consulte [Migração de certificados de raiz do Azure](http://blogs.msdn.com/b/windowsazure/archive/2013/03/15/windows-azure-root-certificate-migration.aspx).
