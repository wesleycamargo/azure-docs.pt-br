...
|nome do parâmetro de consulta|O nome do parâmetro de consulta que contém o token.|`header-name` ou `query-parameter-name` deve ser especificado; mas não ambos.|N/D|  
