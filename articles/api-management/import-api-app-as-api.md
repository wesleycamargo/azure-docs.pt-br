...
+ Verifique se há um aplicativo de API em sua assinatura. Para saber mais informações, consulte [Limitações do Serviço de Aplicativo][https://docs.microsoft.com/azure/app-service/]
