...
* [Políticas de restrição de acesso][Políticas de restrição de acesso]
  ...
  * [Definir a cota de uso por assinatura][Definir a cota de uso por assinatura] - Permite que você aplique uma cota renovável ou permanente de volume de chamada e/ou largura de banda, baseado em assinatura.
...
* [Políticas de transformação][Políticas de transformação]
  ...
  * [Mascarar URLs no conteúdo][Mascarar URLs no conteúdo] – Reescreve (mascara) os links no corpo da resposta, para que eles apontem para o link equivalente por meio do gateway.
  * [Definir o serviço de back-end][Definir o serviço de back-end] - Altera o serviço de back-end para uma solicitação de entrada.
  * [Definir corpo][Definir corpo] - Define o corpo da mensagem para solicitações de entrada e saída.
