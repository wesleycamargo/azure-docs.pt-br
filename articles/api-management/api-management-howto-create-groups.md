...
Para criar um novo desenvolvedor, clique em **Gerenciar** no Portal do Azure do seu serviço de Gerenciamento de API. Isso levará você ao portal do editor de Gerenciamento de API.
