...
---
> [!WARNING]
> A integração do Azure Active Directory B2C está disponível somente nas camadas [Desenvolvedor, Standard e Premium](https://azure.microsoft.com/en-us/pricing/details/api-management/).
