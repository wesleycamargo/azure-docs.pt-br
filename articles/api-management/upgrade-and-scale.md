...
*[Como implantar uma instância de serviço de Gerenciamento de API do Azure em várias regiões do Azure](api-management-howto-deploy-multi-region.md)
*[Como dimensionar automaticamente uma instância de serviço de Gerenciamento de API do Azure](api-management-howto-autoscale.md)