...
+ Verifique se há um aplicativo lógico em sua assinatura. Para obter mais informações, [Criar seu primeiro aplicativo lógico](../logic-apps/logic-apps-create-a-logic-app.md)
