...
O **[cliente do Docker]**  é uma solução de software livre que ajuda os desenvolvedores a automatizar a implantação, a colocação em escala e o gerenciamento de seus aplicativos que estão sendo executados em contêineres.
...
* A ferramenta de build [Maven] do Apache (Versão 3).
* Um cliente [Git].
...
[cliente do Docker]: https://www.docker.com/
