---
title: "Guia de início rápido - cluster do Docker Swarm do Azure para Linux"
...
Crie um cluster do Docker Swarm no Serviço de Contêiner do Azure com o comando [az acs create](/cli/azure/acs#az_acs_create). 
