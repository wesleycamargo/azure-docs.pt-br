...
1. No **Gerenciador de Soluções**, clique com o botão direito do mouse no nó do projeto e selecione **Python** e, em seguida, selecione **Django Migrate**. Em seguida, selecione **Criar Superusuário do Django**.
