...
---
# <a name="deploy-an-aspnet-web-app-to-azure-app-service-using-visual-studio"></a>Implantar um aplicativo Web ASP.NET no Serviço de Aplicativo do Azure usando o Visual Studio
