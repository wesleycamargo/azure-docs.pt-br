...
2. Na guia **Perfil** da caixa de diálogo **Publicar Web**, clique em **Aplicativo Web do Azure**.  
	![Caixa de diálogo Publicar na Web](./media/web-sites-dotnet-deploy-aspnet-webforms-app-membership-oauth-sql-database/SecureWebForms06.png)
...
6. No **Gerenciador de Soluções**, clique com botão direito do mouse em *projeto* e, em seguida, selecione **Adicionar** -> **Novo Item de Scaffold**.  
...
O Visual Studio exibirá uma opção para que você possa evitar avisos do SSL.  
