...
6. Na folha **Configurações de Firewall**, adicione uma regra de firewall com **IP inicial** e **IP final** definido como o endereço IP público de sua máquina de desenvolvimento. Clique em **Salvar**.
