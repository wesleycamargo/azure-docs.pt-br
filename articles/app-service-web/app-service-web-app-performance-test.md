...
*	Você precisará de uma conta do [Visual Studio Online (VSO)][WhatIsVSO] para manter o histórico de seus testes de desempenho. Crie sua nova conta quando você configura o teste de desempenho ou, se você é o proprietário da conta, use uma conta existente. [O que mais posso fazer com uma conta do Visual Studio Online?](#VSOAccount)
...
0.	Entre no [Portal de Visualização do Azure][AzurePortal]. Para usar uma conta do Visual Studio Online que você possui, entre como o proprietário da conta.
...
0.	Agora você precisará de uma conta do [VSO (Visual Studio Online)][WhatIsVSO] para manter o histórico de seus testes de desempenho.

	Se você tem uma conta VSO para usar, selecione essa conta. Se não tem, crie uma nova conta.

	![Selecione a conta de VSO existente ou crie uma nova conta][ExistingNewVSOAccount]
