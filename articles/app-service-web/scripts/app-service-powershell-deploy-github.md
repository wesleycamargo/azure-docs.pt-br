...
Antes de executar esse script, confira se foi criada uma conexão com o Azure usando o cmdlet `Login-AzureRmAccount`, e se você tem a URL de um repositório GitHub para implantar.
