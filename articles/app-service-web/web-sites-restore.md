...
4. Em seguida, especifique o destino para a restauração de aplicativo em **Destino de restauração**.
	...
	>[AZURE.WARNING] Se você escolher **Substituir**, todos os dados existentes em seu aplicativo atual serão apagados. Antes de clicar em **OK**, certifique-se de que isso é exatamente o que você deseja fazer.
