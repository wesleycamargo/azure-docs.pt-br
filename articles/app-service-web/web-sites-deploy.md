...
## <a name="a-nameftpadeploy-manually-by-uploading-files-with-ftp"></a><a name="ftp"></a>Implantar manualmente ao carregar arquivos com FTP
...
### <a name="a-namehowtoftpahow-to-upload-files-with-ftp"></a><a name="howtoftp"></a>Como carregar arquivos com o FTP
...
### <a name="a-nameautomatehowahow-to-automate-deployment-with-command-line-tools"></a><a name="automatehow"></a>Como automatizar a implantação com ferramentas de linha de comando
