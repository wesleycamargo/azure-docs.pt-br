---
title: Implante seu primeiro aplicativo Web HTML no Azure em cinco minutos | Microsoft Docs
...
4. Altere para um diretório de trabalho (`CD`) e clone o site HTML de exemplo desta forma:
