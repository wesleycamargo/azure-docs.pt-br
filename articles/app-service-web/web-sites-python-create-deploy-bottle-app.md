<properties 
	pageTitle="Websites Python com Bottle - Tutorial do Azure" 
...
Você criará um aplicativo usando a estrutura da Web Bottle (consulte versões alternativas deste tutorial para [Django](web-sites-python-create-deploy-django-app.md) e [Flask](web-sites-python-create-deploy-flask-app.md)).  Você vai criar o site na Galeria do Azure, configurar a implantação do Git e clonar o repositório localmente.  Em seguida, você vai executar o aplicativo localmente, fazer alterações, confirmá-las e enviá-las por push para o Azure.  O tutorial mostra como fazer isso por meio do Windows ou Mac/Linux.
...
Uma janela será exibida, listando os aplicativos disponíveis na galeria. Clique na categoria **ESTRUTURAS DE APLICATIVO** à esquerda e selecione **Bottle**.
...
O site será rapidamente configurado. Você pode clicar no botão **PROCURAR** da barra de ferramentas inferior e então verá o novo aplicativo Bottle em execução no Azure.
...
Siga esses links para saber mais sobre o Bottle e Python Tools para o Visual Studio: 
...
<!--Link references-->
[Bottle e MongoDB no Azure com Python Tools 2.1 for Visual Studio]: web-sites-python-ptvs-bottle-table-storage.md
