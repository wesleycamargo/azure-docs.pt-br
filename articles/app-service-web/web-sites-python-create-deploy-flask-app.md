...
- [Flask e Armazenamento de Tabela do Azure no Azure com Python Tools 2.1 para Visual Studio]
...
<!--Link references-->
[Flask e MongoDB no Azure com Python Tools 2.1 para Visual Studio]: web-sites-python-ptvs-flask-mongodb.md
[Flask e Armazenamento de Tabela do Azure no Azure com Python Tools 2.1 para Visual Studio]: web-sites-python-ptvs-flask-table-storage.md
