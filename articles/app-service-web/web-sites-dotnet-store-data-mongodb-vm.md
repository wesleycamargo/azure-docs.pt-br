...
* O driver do C# para MongoDB. Para saber mais sobre como desenvolver aplicativos em C# no MongoDB, confira a [Central de linguagem CSharp][MongoC#LangCenter] do MongoDB. 
...
* Azure. Você pode começar a leitura em [Azure][WindowsAzure].
...
* Para criar uma máquina virtual do Windows e instalar o MongoDB, veja [Instalar o MongoDB em uma VM do Windows][InstallMongoOnWindowsVM].
...
Substitua `<vm-dns-name>` pelo nome DNS da máquina virtual que executa o MongoDB criada na etapa [Criar uma máquina virtual e instalar MongoDB][Criar uma máquina virtual e instalar MongoDB] deste tutorial.  Para encontrar o nome DNS da máquina virtual, vá até o portal do Azure, escolha **Máquinas Virtuais** e localize **Nome DNS**.
...
Para saber mais sobre cadeias de conexão de MongoDB, veja [Connections][MongoConnectionStrings] (Conexões).
...
Para saber mais sobre como desenvolver aplicativos em C# no MongoDB, confira a [Central de linguagem CSharp][MongoC#LangCenter]. 
...
[Criar e executar o aplicativo Minha Lista de Tarefas ASP.NET no computador de desenvolvimento]: #createapp
[Criar um site do Azure]: #createwebsite
[Implantar o aplicativo ASP.NET no site usando Git]: #deployapp
