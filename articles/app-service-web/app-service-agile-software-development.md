...
5. Quando solicitado, digite o nome de usuário desejado e a senha para acesso ao banco de dados.
   ...
   > [!TIP]
   > Dê uma olhada em *&lt;raiz\_do\_repositório>*\\ARMTemplates\\Deploy.ps1 para ver como ele gera recursos com IDs exclusivas. Você pode usar a mesma abordagem para criar clones da mesma implantação sem se preocupar com conflitos entre os nomes de recursos.
   > 
   > 
