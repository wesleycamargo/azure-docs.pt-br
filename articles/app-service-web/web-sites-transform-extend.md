...
## <a name="a-idtransformaadvanced-configuration-through-applicationhostconfig"></a><a id="transform"></a>Configuração avançada por meio de ApplicationHost.config
...
## <a name="a-idextenda-extend-your-web-app"></a><a id="extend"></a> Estender seu aplicativo Web
### <a name="a-idoverviewa-overview-of-private-web-app-extensions"></a><a id="overview"></a> Visão geral das extensões privadas de aplicativo Web
...
### <a name="a-idsitesamplea-web-app-extension-example-php-manager"></a><a id="SiteSample"></a> Exemplo de extensão de aplicativo Web: Gerenciador de PHP
...
#### <a name="a-idphpwebappa-the-php-manager-web-application"></a><a id="PHPwebapp"></a> O aplicativo Web do Gerenciador de PHP
...
#### <a name="a-idxdta-the-applicationhostxdt-file"></a><a id="XDT"></a> O arquivo applicationHost.xdt
...
### <a name="a-iddeploya-web-app-extension-deployment"></a><a id="deploy"></a> Implantação de extensão de aplicativo Web
