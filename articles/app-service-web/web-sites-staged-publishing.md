...
> [!NOTE] 
> Para comandos da [CLI 2.0 do Azure (Visualização)](https://github.com/Azure/azure-cli) para slots de implantação, consulte [slot de implantação da Web do az appservice](/cli/azure/appservice/web/deployment/slot).
