...
Se você estiver usando FTP, obtenha o nome de host e o nome de usuário do FTP na folha do aplicativo Web no [Portal de visualização do Azure](https://portal.azure.com). Em seguida, use qualquer cliente FTP para carregar os arquivos do Drupal na pasta **/site/wwwroot** do site remoto.
...
- [Sites, Serviços de Nuvem e VMs do Microsoft Azure: quando usar o quê?][]
...
* Para obter um guia sobre a alteração do portal para o portal de visualização, confira: [Referência para navegar no portal de visualização](http://go.microsoft.com/fwlink/?LinkId=529715)
  ...
  [Criar um aplicativo Web PHP-MySQL no Serviço de Aplicativo do Azure e implantar usando Git]: /develop/php/tutorials/website-w-mysql-and-git/
  ...
  [Sites, Serviços de Nuvem e VMs do Microsoft Azure: quando usar o quê?]: http://go.microsoft.com/fwlink/?LinkId=310123
