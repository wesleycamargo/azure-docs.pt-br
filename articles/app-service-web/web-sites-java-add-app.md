...
Após inicializar seu aplicativo Web Java no [Serviço de Aplicativo do Azure][Serviço de Aplicativo do Azure] conforme documentado em [Criar um aplicativo Web Java no Serviço de Aplicativo do Azure](web-sites-java-get-started.md), você poderá carregar o aplicativo colocando o WAR na pasta **webapps**.
