...
Para saber mais sobre o serviço Aplicativos Web do Serviço de Aplicativo do Azure, acesse [http://aka.ms/enterprisewebsites](/services/websites/enterprise/), onde mais informações podem ser obtidas, e se inscreva para uma versão de avaliação hoje mesmo em [http://aka.ms/azuretrial](/pricing/free-trial/) para avaliar o serviço e descobrir os benefícios para sua empresa.
