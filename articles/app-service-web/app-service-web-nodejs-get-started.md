...
1. Mude para o modo ASM e faça logon no Azure (é necessário ter a [CLI do Azure](#prereq)):
...
4. Abra ./package.json e adicione a propriedade `engines` a [especificar a versão desejada do Node.js](#version).
