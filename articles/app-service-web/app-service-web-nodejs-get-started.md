...
- Yeoman. As instruções de instalação estão [aqui](http://yeoman.io/).
...
1. Abra o terminal da linha de comando de sua escolha e instale o [gerador Express para Yeoman](https://github.com/petecoop/generator-express).
