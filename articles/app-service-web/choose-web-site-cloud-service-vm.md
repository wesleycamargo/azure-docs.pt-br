---
title: Comparação de Serviço de Aplicativo, Máquinas Virtuais, Service Fabric e Serviços de Nuvem do Azure| Microsoft Docs
...
| Suporte para ASP.NET, classic ASP, Node.js, PHP, Python |X |X |X |X |O Service Fabric permite a criação de um front-end da Web usando o [ASP.NET 5](../service-fabric/service-fabric-add-a-web-frontend.md), ou você pode implantar qualquer tipo de aplicativo (Node.js, Java, etc.) como um [executável convidado](../service-fabric/service-fabric-deploy-existing-app.md). |
...
* Trabalhar com idiomas populares como [.Net][dotnet], [PHP][PHP], [Node.js][nodejs] e [Python][Python].
* Selecione três níveis diferentes de dimensionamento para aumentar proporcionalmente capacidades muito altas.
* Integração com outros serviços do Azure, como [Banco de Dados SQL][sqldatabase], [barramento de serviço][servicebus] e [armazenamento][armazenamento], ou ofertas de parceiro do [Azure Store][azurestore], como MySQL and MongoDB.
...
* Use vários idiomas open source populares como [.NET][dotnet], [PHP][PHP], [Node.js][nodejs] e [Python][Python].
...
* Crie rapidamente um [aplicativo móvel](../app-service-mobile/app-service-mobile-value-prop.md) ou um [aplicativo de API](../app-service-api/app-service-api-apps-why-best-platform.md) para hospedar o serviço Web HTTP em um dos datacenters globalmente distribuídos do Azure.
