---
title: Implante seu primeiro aplicativo Web .NET no Azure em cinco minutos | Microsoft Docs
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Implante seu primeiro aplicativo Web .NET no Azure em cinco minutos
Este tutorial o ajuda a implantar um aplicativo Web .NET simples para o [Serviço de Aplicativo do Azure](../app-service/app-service-value-prop-what-is.md).
...
4. Altere para um diretório de trabalho (`CD`) e clone o aplicativo de exemplo.
