...
4. No menu à esquerda, clique em **Serviços de Aplicativos** > **&lt;nome_do_aplicativo>** > **Ferramentas**.
    ...
    >[AZURE.TIP] Se clicar em **Configurações** em vez de **Ferramentas**, você poderá acessar a folha **Configurações de Aplicativo** 
...
4. Selecione **Composer** in the **folha** [Escolher extensão](../azure-portal-overview.md) (*Escolher extensão*: uma página do portal que é aberta horizontalmente).
