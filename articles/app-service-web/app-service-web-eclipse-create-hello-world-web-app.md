...
* O [Kit de Ferramentas do Azure para Eclipse]. Para saber informações sobre a instalação do Kit de ferramentas do Azure para, veja [Instalando o Kit de ferramentas do Azure para Eclipse].
