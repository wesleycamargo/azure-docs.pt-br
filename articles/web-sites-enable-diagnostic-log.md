<properties 
	pageTitle="Habilitar o log de diagnóstico - Websites do Azure" 
...
Os sites do Azure fornecem funcionalidade de diagnóstico para informações de registro em log tanto para o servidor Web, como para o aplicativo Web. Estes estão logicamente separados em **diagnóstico de site** e **diagnóstico de aplicativo**.
...
O diagnóstico pode ser habilitado ao acessar a página **Configurar** no site do Azure no [Portal de Gerenciamento do Azure](https://manage.microsoft.com). Na página **Configurar**, use as seções **diagnóstico de aplicativo** e **diagnóstico de site** para habilitar o log.
...
* **Sistema de arquivos** - armazena as informações de diagnóstico de aplicativo no sistema de arquivos do site. Estes arquivos podem ser acessados por FTP ou baixados como um arquivo Zip usando o PowerShell do Azure ou as Ferramentas de Linha de Comando do Microsoft Azure.
...
* **Logs de aplicativo** - /LogFiles/Application/. Essa pasta contém um ou mais arquivos de texto que contêm informações produzidas pelo log do aplicativo.
...
Ao desenvolver um aplicativo, é sempre útil visualizar informações de registro em log em tempo quase real. Isto pode ser feito ao transmitir informações de log para seu ambiente de desenvolvimento usando o PowerShell do Azure ou as Ferramentas de Linha de Comando do Azure.
...
<td style="border:1px solid black;vertical-align:top">A ID de evento deste evento<br>O padrão é 0 se nenhum especificado</td>
</tr>
<tr>
...
> [AZURE.NOTE] Os logs produzidos pelos Websites do Azure não oferecem suporte a __s-computername__, __s-ip__, ou campos __cs-version__.
