<properties urlDisplayName="Service Bus Topics" pageTitle="Como usar tópicos de Barramento de Serviço (Node. js) - Azure" metaKeywords="Introdução a tópicos de barramento de serviço do Azure, Introdução a tópicos de Barramento de Serviço, publicar mensagens de assinar do Azure, tópicos de mensagens e assinatura do Azure, tópico de Barramento de Serviço Node. js" description="Learn how to use Service Bus topics and subscriptions in Azure. Code samples are written for Node.js applications." metaCanonical="" services="service-bus" documentationCenter="nodejs" title="How to Use Service Bus Topics/Subscriptions" authors="larryfr" solutions="" manager="wpickett" editor="" />
