...
- [Criar um aplicativo de linha de negócios do ASP.NET MVC, em sites do Azure, que autentica com o Active Directory do Azure](../web-sites-dotnet-lob-application-azure-ad/)
