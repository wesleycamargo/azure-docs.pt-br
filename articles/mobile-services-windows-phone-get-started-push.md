...
<div class="dev-center-tutorial-selector sublanding">
    <a href="/pt-br/documentation/articles/mobile-services-windows-store-dotnet-get-started-push" title="Windows Store C#" >Windows Store C#</a>
...
Este tutorial baseia-se no Guia de início rápido dos Serviços Móveis. Antes de iniciar este tutorial, você deve primeiro concluir a [Introdução aos Serviços Móveis]. 
   ...
   >[AZURE.NOTE]Quando você envia mais de 500 mensagens por usuário por dia, você deve usar os Hubs de notificação. Para obter mais informações, consulte <a href="/pt-br/manage/services/notification-hubs/getting-started-windows-dotnet/">Introdução aos Hubs de Notificação</a>.
...
[Notificações por push para usuários do aplicativo]: /pt-br/develop/mobile/tutorials/push-notifications-to-users-wp8
