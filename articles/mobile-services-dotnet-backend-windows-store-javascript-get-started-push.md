<properties 
	...
	description="Saiba como usar serviços móveis de tempo de execução do .Net do Azure e Hubs de notificação para enviar notificações por push para seu aplicativo JavaScript da Windows Store." 
...
Este tutorial baseia-se no guia se início rápido dos Serviços Móveis. Antes de iniciar este tutorial, você deve primeiro concluir a [Introdução aos Serviços Móveis] ou a [Introdução aos dados] para conectar seu projeto ao serviço móvel. Quando um serviço móvel não é conectado, o assistente Adicionar Notificação por Push cria essa conexão para você. 
