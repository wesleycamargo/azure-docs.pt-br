<properties 
	pageTitle="Tutorial: Configurar a proteção entre um site VMM local e o Azure" 
...
# Tutorial: Configurar a proteção entre um site VMM local e o Azure
...
<LI><a href="#download">Etapa 2: Instalar o aplicativo do Provedor no servidor do VMM</a>- Gere uma chave de registro no cofre e baixe o arquivo de configuração do Provedor. Execute a instalação do servidor VMM para instalar o Provedor e registrar o servidor do VMM no cofre.</LI>
<LI><a href="#storage">Etapa 3: Adicionar uma conta de armazenamento do Azure.</a>- Se você não tiver uma conta, crie uma. </LI>
...
<LI><a href="#clouds">Etapa 5: Configurar a proteção de nuvem</a>- Configure a proteção para nuvens do VMM.</LI>
...
<LI><a href="#virtualmachines">Etapa 7: Habilitar a proteção para máquinas virtuais</a>- Habilite a proteção para máquinas virtuais localizadas nas nuvens do VMM protegido.</LI>
<LI><a href="#test">Etapa 8: Testar a implantação</a>- Você pode executar um failover de teste para uma única máquina virtual, ou você pode criar um plano de recuperação e executar um teste de failover para o plano para verificar se ele está funcionando.</LI>
</UL>
...
<P>Verifique a barra de status para confirmar que o cofre foi criado com sucesso. O cofre será listado como <b>Ativo</b> na página de Serviços de Recuperação.</P>
 ...
 <a name="download"></a> <h3>Etapa 2: Gerar uma chave de registro e instalar o Provedor de Recuperação de Site do Azure</h3>
...
<h3><a id="storage"></a>Etapa 3: Criar uma conta de Armazenamento do Azure</h3>
...
<h3><a id="agent"></a>Etapa 4: Instalar o Agente de Serviços de Recuperação do Azure em hosts Hyper-V</h3>
...
<h3><a id="networkmapping"></a>Etapa 6: Configurar o mapeamento de rede</h3>
...
<h3><a id="virtualmachines"></a>Etapa 7: Habilitar a proteção para máquinas virtuais</h3>
...
<h3><a id="test"></a>Etapa 8: Testar a implantação</h3>
...
<LI>Para dúvidas, visite o <a href="http://go.microsoft.com/fwlink/?LinkId=313628">Fórum de Serviços de Recuperação do Microsoft Azure</a>.</LI> 
</UL>
