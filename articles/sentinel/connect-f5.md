...
Neste documento, você aprendeu como conectar dispositivos de F5 para Azure Sentinel. Para saber mais sobre Azure Sentinel, consulte os seguintes artigos:
