---
title: Coletar dados DNS na visualização do Azure Sentinel | Microsoft Docs
description: Saiba como coletar dados DNS no Azure Sentinel.
services: sentinel
...
Quando você habilita a coleta de log DNS, você pode:
...
Coleção de DNS é realizada ao instalar um agente no computador do DNS. O agente recebe eventos do DNS e os passa para o Log Analytics.

## <a name="connect-your-dns-appliance"></a>Conectar seu dispositivo de DNS

1. No portal do Azure Sentinel, selecione **coleta de dados** e escolha o **DNS** lado a lado.
...
Neste documento, você aprendeu como conectar dispositivos de locais DNS ao Azure Sentinel. Para saber mais sobre Azure Sentinel, consulte os seguintes artigos:
