---
title: Coletar dados de Fortinet na visualização do Azure Sentinel | Microsoft Docs
description: Saiba como coletar dados Fortinet no Azure Sentinel.
services: sentinel
