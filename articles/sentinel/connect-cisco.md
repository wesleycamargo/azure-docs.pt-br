---
title: Coletar dados de Cisco na visualização do Azure Sentinel | Microsoft Docs
description: Saiba como coletar dados de Cisco no Azure Sentinel.
services: sentinel
...
Neste documento, você aprendeu como conectar dispositivos Cisco ASA ao Azure Sentinel. Para saber mais sobre Azure Sentinel, consulte os seguintes artigos:
