<properties 
   pageTitle="Mobile Engagement do Azure - Interface do usuário - Se" 
   description="Visão geral da interface de usuário para a seção de segmentos do Mobile Engagement do Azure" 
...
- [Documentação da API - API de segmentos][Link 4], [Guia solução de problemas - Análise][Link 2]

Você pode criar um segmento com base em até 10 critérios em um período específico de até 60 dias passados na seção de análise. 
...
**Segmentos de exemplos, que você pode criar com base nos elementos principais do Mobile Engagement do Azure:**
...
**Exemplo: Crie um segmento simples com base nas informações de "Sessão".**
