<properties 
	pageTitle="Configurar um nome de domínio Dotster para um site do Azure" 
	description="Saiba como configurar um site do Azure para usar um nome de domínio registrado com o Dotster" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
Este artigo fornece instruções sobre como usar um nome de domínio personalizado adquirido do [Dotster.com](https://dotster.com) com os Websites do Azure.
...
5. Em seguida, especifique os campos **Host** e **Aponta para** do registro. Ao concluir, clique no botão **Adicionar**.
    ...
    * Ao adicionar um registro CNAME, você deve definir o campo **Host** como o subdomínio que deseja usar. Por exemplo, **www**. Você deve definir o campo **Apontar para** como o nome do domínio **.azurewebsites.net** do Website do Azure. Por exemplo, **contoso.azurwebsites.net**.
