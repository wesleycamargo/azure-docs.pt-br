<properties urlDisplayName="Service Bus Queues" pageTitle="Como usar filas do Barramento de Serviço (Java) - Azure" metaKeywords="filas do Barramento de Serviço do Azure, filas do Azure, sistema de mensagens do Azure, filas do Azure em Java" description="Learn how to use Service Bus queues in Azure. Code samples written in Java." metaCanonical="" services="service-bus" documentationCenter="Java" title="How to Use Service Bus Queues" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" videoId="" scriptId="" />
