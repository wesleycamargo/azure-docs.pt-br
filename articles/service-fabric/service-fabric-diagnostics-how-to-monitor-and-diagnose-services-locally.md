...
## Próximas etapas
O mesmo código de rastreamento que você adicionou ao seu aplicativo acima para diagnóstico local funcionará com ferramentas que você pode usar para exibir os eventos ao executar seu aplicativo em um cluster do Azure. Confira esses artigos que abordam as diferentes opções para as ferramentas e descrevem como você pode configurá-las. * [Coletando logs de um cluster do Service Fabric no Azure usando WAD (Diagnóstico do Windows Azure) e Insights Operacionais](service-fabric-diagnostics-how-to-setup-wad-operational-insights.md) * [Usando ElasticSearch como um repositório de rastreamento de aplicativo do Service Fabric](service-fabric-diagnostic-how-to-use-elasticsearch.md)
