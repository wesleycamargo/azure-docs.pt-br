...
* [CLI do Azure 2.0 e acima][azure-CLI]
...
Para se usar um cofre de chaves existente, o cofre de chaves deverá estar [habilitado para implantação](../key-vault/key-vault-manage-with-cli2.md#bkmk_KVperCLI) a fim de permitir que o provedor de recursos de computação obtenha certificados e os instale em nós de cluster.
