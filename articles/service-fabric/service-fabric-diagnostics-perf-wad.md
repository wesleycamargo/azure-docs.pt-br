...
* Visite o [construtor WadCfg](http://azure.github.io/azure-diagnostics-tools/config-builder/) para criar um modelo a partir do zero e verifique se sua sintaxe está correta.