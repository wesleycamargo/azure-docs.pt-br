...
5. Você pode criar qualquer tipo de aplicativo do Service Fabric na próxima caixa de diálogo. Para este guia de início rápido, escolha **.Net Core 2.0** > **Serviço com Estado**.
