...
> [!NOTE]
> A versão 6.4.571.9494 do plug-in de volume dos Arquivos do Azure é uma versão prévia que está disponível com este documento. Como uma versão prévia, **não** tem suporte para uso em ambientes de produção.
>
