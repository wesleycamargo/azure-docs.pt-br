---
title: Atualizar uma SKU de VMs do cluster do Azure Service Fabric ou SO | Microsoft Docs
description: Saiba como atualizar as máquinas virtuais no tipo de nó primário de um cluster do Service Fabric.
