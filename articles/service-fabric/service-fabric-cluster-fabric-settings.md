...
|GatewayAuthCredentialType |cadeia de caracteres, o padrão é "None" |Static| Indica o tipo de credenciais de segurança para usar nos ponto de extremidade do gateway do aplicativo Os valores válidos são “None/ X509. |
...
| **Parâmetro** | **Valores permitidos** | **Política de Atualização** | **Diretrizes ou descrição resumida** |
| --- | --- | --- | --- |
|Ativado |Bool, o padrão é false |Static|O sinalizador Enabled para ImageStoreService. Padrão: false |
