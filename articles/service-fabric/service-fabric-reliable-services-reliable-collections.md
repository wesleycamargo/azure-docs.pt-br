...
> [!NOTE]
> A adição de outro valor de ponto de verificação aprimora o desempenho recuperação em casos comuns. Isso ocorre porque os pontos de verificação contêm somente as versões mais recentes.
> 
> 
