...
# <a name="servicefabricservicemodelxsd-schema-documentation"></a>Documentação do esquema ServiceFabricServiceModel.xsd
Este artigo documenta o arquivo de esquema ServiceFabricServiceModel.xsd instalado com o SDK do Service Fabric.
...
Lista delimitada por uma vírgula de comandos para o contêiner.
...
|---|---|
|Tipo|complexType anonymous|
|conteúdo|6 elementos, 1 atributo|
|Nome|NodeType|
|maxOccurs|não associado|
...
Nome de usuário ou Nome da conta de serviço (ou seja,: MeuComputador\ViniciusMonte ou John.Doe@department.contoso.com).
|Atributo|Valor|
|---|---|
|Nome|AccountName|
|uso|opcional|
...
#### <a name="manifestid"></a>ManifestId
O identificador do manifesto do aplicativo, uma cadeia de caracteres não estruturada.
|Atributo|Valor|
|---|---|
|Nome|ManifestId|
|padrão||
...
A versão do manifesto do serviço que está sendo referenciada. A versão deve corresponder à versão declarada no manifesto do serviço.
|Atributo|Valor|
|---|---|
