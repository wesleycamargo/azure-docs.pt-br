...
|Nenhum|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Resumo do componente 
Os seguintes componentes são definidos no namespace http://schemas.microsoft.com/2011/01/fabric em ServiceFabricServiceModel.xsd:
