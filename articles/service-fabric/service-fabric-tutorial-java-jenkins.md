---
title: Configurar CI/CD para um aplicativo Java do Azure Service Fabric | Microsoft Docs
...
6. Se você acessar **http://\<Host-IP>:8080**, verá que o aplicativo Voting com funcionalidade total está agora em execução. 
    ...
    ![Local do aplicativo Voting](./media/service-fabric-tutorial-java-jenkins/votingv2.png)
