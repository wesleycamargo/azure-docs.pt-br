...
O repositório e a imagem no https://hub.docker.com ou o Registro de Contêiner do Azure.
|Atributo|Valor|
|---|---|
|Nome|ImageName|
|Tipo|xs:string|
...
Especifica limites de recurso para pacote de códigos.
|Atributo|Valor|
|---|---|
...
#### <a name="placementconstraints"></a>PlacementConstraints
Usado para controlar em quais nós no cluster um serviço pode ser executado. Um par de chave/valor que descreve o nome da propriedade do nó e os requisitos do serviço para o valor. Instruções individuais podem ser agrupadas com lógica booliana simples para criar a restrição necessária. Por exemplo, "(FirmwareVersion>12  && InDMZ == True)".
|Atributo|Valor|
|---|---|
|Nome|PlacementConstraints|
|Tipo|xs:string|
