...
## <a name="choose-the-node-typevm-scale-set-to-scale"></a>Escolher o tipo de nó/conjunto de escala de VM a ser escalado
...
## <a name="set-auto-scale-rules-for-the-node-typevm-scale-set"></a>Definir regras de escala automática para o tipo de nó/conjunto de escala de VM
...
## <a name="manually-add-vms-to-a-node-typevm-scale-set"></a>Adicione as VMs manualmente a um tipo de nó/conjunto de escala de VM
...
## <a name="manually-remove-vms-from-the-primary-node-typevm-scale-set"></a>Remova as VMs manualmente do tipo de nó/conjunto de escala de VM
> [!NOTE]
...
## <a name="manually-remove-vms-from-the-non-primary-node-typevm-scale-set"></a>Remova as VMs manualmente do tipo de nó não primário/conjunto de escala de VM
> [!NOTE]
