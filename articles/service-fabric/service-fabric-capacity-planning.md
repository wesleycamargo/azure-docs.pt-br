...
A declaração acima supõe a existência de um único serviço com estado. Se você tiver mais de um serviço com estado, também será necessário adicionar o tamanho do banco de dados associado a outros serviços na equação, ou calcular o número de nós separadamente para cada serviço com estado. O serviço pode ter réplicas ou partições que não estão equilibradas (por exemplo, algumas partições podem ter mais dados do que outras. Confira o artigo sobre particionamento para conhecer as práticas recomendadas). No entanto, a equação acima é independente do número de partições ou réplicas, pois o Service Fabric garantirá que as réplicas sejam distribuídas entre os nós de uma forma otimizada.
