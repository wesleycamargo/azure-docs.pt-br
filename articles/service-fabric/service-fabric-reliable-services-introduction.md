...
Assista a este vídeo da Microsoft Virtual Academy para ter uma visão geral dos Reliable Services: <center><a target="_blank" href="https://mva.microsoft.com/en-US/training-courses/building-microservices-applications-on-azure-service-fabric-16747?l=HhD9566yC_4106218965">  
...
* **Consistência** – é possível garantir que todas as informações armazenadas nesse serviço são consistentes (isso se aplica somente aos serviços com estado; veja mais sobre isso adiante)
...
Quando o serviço está sendo desligado (para ser excluído, atualizado ou movido), a ordem de chamada é espelhada: primeiro, o token de cancelamento mantido por `RunAsync()` é cancelado; em seguida, `CloseAsync()` é chamado nos ouvintes de comunicação.
...
> [!NOTE]
> *Recursos disponíveis na disponibilidade geral do SDK.
> 
> 
