...
# Usando a CLI do Azure para interagir com um Cluster do Service Fabric
...
## Usando a CLI do Azure para se conectar a um Cluster do Service Fabric
...
### A cópia do pacote de aplicativos não é bem-sucedida
...
Se o problema persistir, tente desabilitar o PAM para ssh alterando o arquivo **sshd\_config** usando os seguintes comandos:
