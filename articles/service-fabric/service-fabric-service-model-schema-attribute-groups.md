...
O nome do manifesto do serviço. O nome deve corresponder ao nome declarado no elemento ServiceManifest do manifesto do serviço.
|Atributo|Valor|
|---|---|
...
A versão do manifesto do serviço. A versão deve corresponder à versão declarada no manifesto do serviço.
|Atributo|Valor|
|---|---|
