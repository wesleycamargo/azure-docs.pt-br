...
1. Verifique se `apiversion` está definido como `10-2017` no arquivo de configuração do cluster e, se não estiver, atualize-o conforme mostrado no trecho a seguir:
