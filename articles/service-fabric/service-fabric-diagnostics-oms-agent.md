...
> [!NOTE]
> Este artigo pressupõe que você já tenha o workspace do Log Analytics do Azure configurado. Se você não fizer isso, vá até [configurar logs do Azure Monitor](service-fabric-diagnostics-oms-setup.md)
