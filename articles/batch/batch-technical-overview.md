...
Embora não sejam necessárias para compilar soluções usando o Lote, essas ferramentas podem ser consideradas essenciais ao se compilar e depurar aplicativos e serviços do Lote.
