...
O Lote dá suporte a cenários de desenvolvedor diferentes para ajudá-lo a configurar e executar suas cargas de trabalho paralelas em larga escala com o serviço de Lot. Esses cenários aproveitam APIs para criar e gerenciar pools de VMs (nós de computação) e agendar os trabalhos e tarefas executadas neles. Consulte [Noções básicas de API do Lote do Azure](batch-api-basics.md) para obter mais informações sobre os conceitos do Lote.
...
>[AZURE.IMPORTANT]Azure oferecerá apenas a API de aplicativos do Lote no formulário de visualização. Você só deve desenvolver com ele para projetos de teste ou prova de conceito. Recursos dos aplicativos essenciais do Lote serão integrados à API do Lote em futuras versões do serviço.
...
2.	Crie um arquivo zip do **assembly em nuvem** que invocará e expedirá suas cargas de trabalho para o serviço Batch. Ele contém dois componentes:
