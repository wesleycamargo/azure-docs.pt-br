...
> [!NOTE]
> O Azure apresenta regularmente novos serviços que podem ser úteis para seu cenário. Se você tiver dúvidas, entre em contato com um [parceiro do Azure](https://pinpoint.microsoft.com/pt-BR/search?keyword=azure) ou envie um email para *bigcompute@microsoft.com*.
> 
> 
