...
O [HPC Pack](https://technet.microsoft.com/library/jj899572.aspx) é o gerenciador de cluster gratuito da Microsoft e a solução de agendamento de trabalhos para HPC em nuvem, híbrido e local.
