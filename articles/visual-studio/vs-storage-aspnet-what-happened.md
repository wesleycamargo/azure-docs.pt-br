...
description: Descreve o que acontece após a adição de armazenamento do Azure para um projeto do ASP.NET usando o Visual Studio serviços conectados
services: storage
author: ghogen
manager: douge
