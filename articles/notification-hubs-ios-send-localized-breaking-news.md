<properties linkid="develop-notificationhubs-tutorials-send-localized-breaking-news-iOS" urlDisplayName="Últimas notícias localizadas" pageTitle="Tutorial de últimas notícias localizadas dos Hubs de Notificação par iOS" metaKeywords="" description="Saiba como usar os Hubs de Notificação de Barramento de Serviço do Azure para enviar notificações de últimas Notícias (iOS)." metaCanonical="" services="mobile-services,notification-hubs" documentationCenter="" title="Usar Hubs de Notificação para enviar últimas notícias localizadas para dispositivos iOS" authors="ricksal" solutions="" manager="" editor="" />
# Usar Hubs de Notificação para enviar últimas notícias localizadas para dispositivos iOS

<div class="dev-center-tutorial-selector sublanding"> 
    	<a href="/pt-br/manage/services/notification-hubs/breaking-news-localized-dotnet" title="Windows Store C#">Windows Store C#</a><a href="/pt-br/manage/services/notification-hubs/breaking-news-localized-ios" title="iOS" class="current">iOS</a>
</div>
...
Os modelos são um recurso muito avançado sobre o qual você pode aprender em nosso artigo [Diretrizes dos Hubs de Notificação]. Uma referência à linguagem de expressão do modelo é incluída em [Como usar os Hubs de Notificação do Barramento de Serviço (aplicativos iOS)].
...
<h2><a name="building-client"></a><span class="building app"></span>Criando o aplicativo iOS</h2>
...
3. Agora que modificamos nossa classe Notifications, precisamos ter certeza de que nosso ViewController usará o novo UISegmentControl. Adicione a seguinte linha ao método *viewDidLoad* método para ter certeza de mostrar o locale que está selecionado no momento:

		self.Locale.selectedSegmentIndex = [notifications retrieveLocale];
		
	Em seguida, no método *subscribe*, altere sua chamada para o *storeCategoriesAndSubscribe* para o seguinte:
...
4. Finalmente, você precisa atualizar o método *didRegisterForRemoteNotificationsWithDeviceToken* no AppDelegate.m, de forma que seja possível atualizar corretamente seu registro quando o aplicativo for iniciado. Altere sua chamada para o método *subscribe* de notificações com o seguinte:
...
<!-- URLs. -->
[Como usar os Hubs de Notificação do Barramento de Serviço (aplicativos iOS)]: http://msdn.microsoft.com/pt-br/library/jj927168.aspx
...
[Get started with Mobile Services]: /pt-br/develop/mobile/tutorials/get-started/#create-new-service
...
[JavaScript e HTML]: /pt-br/develop/mobile/tutorials/get-started-with-push-js.md

[Portal de Gerenciamento do Azure]: https://manage.windowsazure.com/
[Etapas de registro do Windows Developer Preview nos Serviços Móveis]: ../HowTo/mobile-services-windows-developer-preview-registration.md
