---
title: Habilitar o serviço ASC para IoT na Versão Prévia do Hub IoT | Microsoft Docs
description: Saiba como habilitar o serviço ASC para IoT em seu Hub IoT.
services: ascforiot
...
Este artigo fornece uma explicação de como habilitar o serviço de versão prévia da ASC para IoT em seu Hub IoT.  

> [!NOTE]
> A ASC para IoT atualmente dá suporte apenas à camada standard e superior de Hubs IoT.
>A ASC para IoT é uma solução de hub único. Se você precisar de vários hubs, várias soluções serão necessárias. 

## <a name="prerequisites-for-enabling-the-service"></a>Pré-requisitos para habilitar o serviço

- Workspace do Log Analytics
  - Dois tipos de informação são armazenados por padrão em seu espaço de trabalho do Log Analytics pela ASC para IoT; **alertas de segurança** e **recomendações**. 
