...
1. [Criar um módulo de segurança ascforiot](quickstart-create-security-twin.md) para seus dispositivos. 
...
1. [Implantar um ASC para agente de segurança de IoT](tutorial-deploy-linux-cs.md) em seu dispositivo IoT ou nova VM.
...
1. Verifique se ASC para alertas de IoT em resposta ao ataque simulado na etapa anterior. 
    - Iniciar verificação de cinco minutos após a execução do script.
1. Explore [alertas](concept-security-alerts.md), [recomendações](concept-recommendations.md), e [usando o Log Analytics de aprofundamento](how-to-security-data-access.md) usando o IoT Hub. 
