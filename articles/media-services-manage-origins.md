...
3.  Especificar a configuração para autenticação do cabeçalho de assinatura do Akamai.
  ...
  [Dimensionando os Serviços de Mídia (a página pode estar em inglês)]: http://go.microsoft.com/fwlink/?LinkID=275847&clcid=0x409/
