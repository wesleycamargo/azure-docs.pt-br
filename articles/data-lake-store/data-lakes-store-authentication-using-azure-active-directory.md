...
O Azure Data Lake Storage Gen1 usa o Azure Active Directory para autenticação. Antes de criar um aplicativo que funcione com o Azure Data Lake Storage Gen1, você precisa decidir como deseja autenticar seu aplicativo no Azure AD (Azure Active Directory).
