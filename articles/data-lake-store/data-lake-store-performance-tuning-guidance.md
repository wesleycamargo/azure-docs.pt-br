---
title: Diretrizes de ajuste de desempenho do Data Lake Store | Microsoft Docs
description: Diretrizes de ajuste de desempenho do Data Lake Store
...
3. **Comece definindo o número de tarefas para o número de simultaneidade que você tem** – agora, você já definiu o tamanho do contêiner adequadamente para obter o máximo de simultaneidade. Agora, você deve definir o número de tarefas para usar todos os contêineres. Há diferentes nomes para tarefas em cada carga de trabalho.
    ...
    |--------------------|------------------------------------------------------------------------------------|
    | Spark no HDInisight       | <ul><li>Num-executors</li><li>Executor-memory</li><li>Executor-cores</li></ul> |
    | Hive no HDInsight    | hive.tez.container.size         |
    | MapReduce no HDInsight            | <ul><li>Mapreduce.map.memory</li><li>Mapreduce.job.maps</li><li>Mapreduce.reduce.memory</li><li>Mapreduce.job.reduces</li></ul> |
    | Storm no HDInsight| <ul><li>Número de processos de trabalho</li><li>Número de instâncias de spout executor</li><li>Número de instâncias de bolt executor </li><li>Número de tarefas de spout</li><li>Número de tarefas de bolt</li></ul>|
