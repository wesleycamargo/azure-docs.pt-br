...
* Crie um aplicativo do AAD (Azure Active Directory) e recupere a **ID do Cliente** e o **URI de Resposta**. Para obter mais informações sobre os aplicativos do AAD e instruções sobre como obter uma ID do cliente, veja [Criar o aplicativo do Active Directory e a entidade de serviço usando o portal](../resource-group-create-service-principal-portal.md). O URI de Resposta também estará disponível no portal depois que o aplicativo for criado.
...
7. Abra **Program.cs** e substitua o bloco de códigos existente pelo seguinte código. Além disso, forneça valores para os parâmetros chamados no trecho de código, como **\_adlsAccountName**, **\_resourceGroupName** e substitua os espaços reservados por **APPLICATION-CLIENT-ID**, **APPLICATION-REPLY-URI** e **SUBSCRIPTION-ID**.
