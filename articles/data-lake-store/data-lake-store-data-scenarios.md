...
| Blob de Armazenamento do Azure |<ul> <li>[Fábrica de dados do Azure](../data-factory/connector-azure-data-lake-store.md)</li> <li>[Ferramenta AdlCopy](data-lake-store-copy-data-azure-storage-blob.md)</li><li>[DistCp em execução no cluster do HDInsight](data-lake-store-copy-data-wasb-distcp.md)</li> </ul> |
...
* [Fábrica de dados do Azure](../data-factory/copy-activity-overview.md)
...
* [Fábrica de dados do Azure](../data-factory/connector-azure-data-lake-store.md)
...
| --- | --- | --- | --- |
| Usar o ADF (Azure Data Factory) para copiar dados diretamente de clusters Hadoop para o Azure Data Lake Storage Gen1 |[ADF dá suporte ao HDFS como uma fonte de dados](../data-factory/connector-hdfs.md) |O ADF fornece suporte nativo para HDFS e gerenciamento e monitoramento de primeira classe completo |Ele exige que um gateway de gerenciamento de dados seja implantado localmente ou em um cluster da IaaS |
| Exporte os dados do Hadoop como arquivos. Em seguida, copie os arquivos no Azure Data Lake Storage Gen1 usando o mecanismo apropriado. |Você pode copiar os arquivos no Azure Data Lake Storage Gen1 usando: <ul><li>[O Azure PowerShell para o sistema operacional do Windows](data-lake-store-get-started-powershell.md)</li><li>[CLI do Azure](data-lake-store-get-started-cli-2.0.md)</li><li>Aplicativo personalizado usando qualquer SDK do Data Lake Storage Gen1</li></ul> |Início rápido. Pode realizar carregamentos personalizados |Processo de várias etapas que envolve várias tecnologias. O monitoramento e o gerenciamento aumentarão a serão um desafio ao longo do tempo devido à natureza personalizada das ferramentas |
| Use Distcp para copiar dados do Hadoop para o Armazenamento do Azure. Em seguida, copie os dados no Armazenamento do Azure para o Data Lake Storage Gen1 usando o mecanismo apropriado. |Você pode copiar dados do Armazenamento do Azure para o Data Lake Storage Gen1 usando: <ul><li>[Fábrica de dados do Azure](../data-factory/copy-activity-overview.md)</li><li>[Ferramenta AdlCopy](data-lake-store-copy-data-azure-storage-blob.md)</li><li>[Apache DistCp em execução em clusters do HDInsight](data-lake-store-copy-data-wasb-distcp.md)</li></ul> |Você pode usar ferramentas de software livre. |Processo de várias etapas que envolve várias tecnologias |
...
* [Criar um cluster HDInsight com Data Lake armazenamento Gen1 como armazenamento](data-lake-store-hdinsight-hadoop-use-portal.md)
