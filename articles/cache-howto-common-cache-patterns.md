...
- [Como usar o Estado de Sessão ASP.NET com Sites do Azure](web-sites-dotnet-session-state-caching.md): Este tópico explica como usar o Serviço de Cache Redis do Azure para o estado de sessão.
