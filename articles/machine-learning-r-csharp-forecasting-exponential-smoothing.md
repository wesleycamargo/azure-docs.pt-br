<properties title="Forecasting-Exponential Smoothing" pageTitle="Ajuste exponencial de previsão | Azure" description="Web service: Forecasting-Exponential Smoothing" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />

<tags ms.service="machine-learning" ms.workload="data-services" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/08/2014" ms.author="jaymathe" /> 


#Ajuste exponencial de previsão 
...
Há várias maneiras de consumir o serviço de forma automática (aplicativos de exemplo estão [aqui](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx)).
...
De dentro do AM do Azure, um novo teste em branco foi criado. Dados de entrada de amostra foram carregados com um esquema de dados predefinido. Vinculado ao esquema de dados está um módulo de "Script de R de Executar" que gera o modelo de previsão ARIMA usando as funções 'ets' e 'previsão' de R. 
