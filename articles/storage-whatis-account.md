<properties 
	pageTitle="Sobre contas de Armazenamento do Azure | Microsoft Azure" 
	description="Aprenda sobre como trabalhar com contas de armazenamento do Azure." 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="adinah" 
...
Por exemplo, se a sua conta de armazenamento se chamar  *mystorageaccount*, então os pontos de extremidade padrão para a conta de armazenamento são: 
...
> [AZURE.WARNING] Não é possível restaurar o conteúdo de uma conta de armazenamento excluída. Faça 
	backup de todas as informações que você deseja salvar antes de excluir a conta. <br />
