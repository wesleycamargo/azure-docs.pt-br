<properties urlDisplayName="Call a custom API from the client" pageTitle="Chamar uma API personalizada de um cliente do Windows Phone - Serviços Móveis" metaKeywords ="" description="Saiba como definir um API personalizado e, em seguida, chamá-lo a partir de um aplicativo do Windows Phone que usa os Serviços Móveis do Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Call a custom API from the client" authors="glenga" solutions="" manager="dwrede" editor="" />
...
Você adicionará essa funcionalidade ao aplicativo que você criou após concluir [Adicionar os Serviços Móveis em um aplicativo existente](/pt-br/documentation/articles/mobile-services-windows-phone-get-started-data/) tutorial. Para fazer isso, você executará as seguintes etapas:

1. [Definir a API personalizada]
2. [Atualizar o aplicativo para chamar a API personalizada]
3. [Testar o aplicativo]

Este tutorial é baseado no exemplo GetStartedWithData, um aplicativo TodoList simples. Antes de iniciar este tutorial, você deve primeiro [Adicionar os Serviços Móveis em um aplicativo existente](/pt-br/documentation/articles/mobile-services-windows-phone-get-started-data/).
