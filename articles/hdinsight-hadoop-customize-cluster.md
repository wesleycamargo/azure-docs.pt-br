...
- **Instalar Solr**. [Instalar e usar o Solr em clusters HDInsight](hdinsight-hadoop-solr-install.md)
- **Instalar Giraph**. [Instalar e usar o Giraph em clusters HDInsight](hdinsight-hadoop-giraph-install.md)
