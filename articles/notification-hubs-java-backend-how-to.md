...
Além disso, se desejar, é possível usar o código da [amostra de wrapper do REST do Java] e ir diretamente para a seção [Concluir o tutorial](#complete-tutorial).
...
[Exemplo de wrapper REST Java]: https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-java
