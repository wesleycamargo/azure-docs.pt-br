...
-   Siga o [Tutorial de introdução][Tutorial de introdução] para sua plataforma móvel de escolha, implementando a parte sobre back-end no Java.
...
Você pode encontrar todos os códigos disponíveis na [amostra de wrapper do REST do Java][amostra de wrapper do REST do Java].
...
Além disso, se quiser, pode usar o código da [amostra de weapper do REST do Java][amostra de wrapper do REST do Java] e ir diretamente para a seção [Concluir o tutorial][Concluir o tutorial].

Todos os detalhes para implementar um wrapper completo do REST podem ser encontrados em [MSDN][MSDN]. Nesta seção, descreveremos a implementação do Java das principais etapas necessárias para acessar os pontos de extremidade de REST dos Hubs de Notificação:
...
Executar o código Java agora deve produzir uma notificação que aparece no dispositivo de destino.
...
-   Baixar a [amostra do wrapper de REST do Java][amostra de wrapper do REST do Java] completa, que contém todos os códigos acima, além do gerenciamento de registros.
...
-   Aprender sobre como enviar notificações por push para usuários individuais no [tutorial Notificação de Usuários]
  ...
  [amostra de wrapper do REST do Java]: https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-java
