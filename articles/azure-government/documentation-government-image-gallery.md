...
| OpenLogic |6.7 baseado em CentOS |
...
O recursos abaixo devem fornecer mais informações sobre como implantar da galeria de imagens ou criar seu próprio VHD.  Consulte o [Guia para desenvolvedor do Azure Government](documentation-government-developer-guide.md) para descobrir diferenças programáticas com pontos de extremidade ao trabalhar com o Azure Government.
