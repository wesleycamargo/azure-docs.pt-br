...
### <a name="<a-name="overview"></a>encryption-at-rest"></a><a name="Overview"></a>Criptografia em repouso
...
### <a name="<a-name="overview"></a>storage-service-encryption"></a><a name="Overview"></a>Criptografia do Serviço de Armazenamento
...
### <a name="<a-name="overview"></a>client-side-encryption"></a><a name="Overview"></a>Criptografia do cliente
...
### <a name="<a-name="overview"></a>encryption-in-transit"></a><a name="Overview"></a>Criptografia em trânsito
...
### <a name="<a-name="overview"></a>best-practices-for-encryption"></a><a name="Overview"></a>Práticas recomendadas para criptografia
...
### <a name="<a-name="overview"></a>best-practices-for-managing-secrets"></a><a name="Overview"></a>Práticas recomendadas para gerenciamento de segredos
...
### <a name="<a-name="overview"></a>environment-isolation"></a><a name="Overview"></a>Isolamento de ambiente
...
#### <a name="<a-name="overview"></a>per-customer-isolation"></a><a name="Overview"></a>Isolamento por cliente
