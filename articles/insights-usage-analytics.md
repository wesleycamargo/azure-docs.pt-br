<properties title="How to use end user analytics in Azure" pageTitle="Como usar análises do usuário final" description="End user analytics for Microsoft Azure websites." authors="awills" manager="kamrani" />
