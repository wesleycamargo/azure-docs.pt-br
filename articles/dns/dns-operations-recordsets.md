...
# <a name="manage-dns-records-in-azure-dns-using-azure-powershell"></a>Gerenciar registros DNS na DNS do Azure usando o Azure PowerShell
...
Para criar um conjunto de registros no ‘ápice’ de uma zona (neste caso, ‘contoso.com’), use o nome do conjunto de registros "@" (incluindo as aspas):
...
Neste exemplo, usamos o nome do conjunto de registros "@" para criar um registro MX no vértice da zona (nesse caso, "contoso.com").
