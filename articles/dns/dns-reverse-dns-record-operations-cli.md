---
title: Como gerenciar registros DNS reversos para seus serviços usando a CLI do Azure no Gerenciador de Recursos | Microsoft Docs
...
[!INCLUDE [PERGUNTAS FREQUENTES](../../includes/dns-reverse-dns-record-operations-faq-arm-include.md)]
