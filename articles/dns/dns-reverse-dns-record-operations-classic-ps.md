...
* O encaminhamento de FQDN do DNS reverso é resolvido no nome ou IP do Serviço de Nuvem para o qual foi especificado, ou como qualquer nome ou IP do Serviço de Nuvem contido na mesma assinatura; por exemplo, o DNS reverso é "app1.contoso.com." que é um alias de CName para contosoapp1.cloudapp.net.
