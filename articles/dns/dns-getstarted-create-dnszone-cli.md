---
title: Criar uma zona DNS usando a CLI| Microsoft Docs
...
---
# <a name="create-an-azure-dns-zone-using-cli"></a>Criar uma zona do Azure DNS usando a CLI
...
## <a name="step-1-set-up-azure-cli"></a>Etapa 1: configurar a CLI do Azure
...
Para exibir esses registros, use `azure network dns-record-set show`.<BR>
*Uso: network dns record-set show <grupo-de-recursos> <nome-da-zona-dns> <name> <type>*
