...
description: "Saiba como criar zonas DNS no DNS do Azure. Este é uma guia passo a passo para criar e gerenciar sua primeira zona DNS usando a CLI do Azure."
services: dns
