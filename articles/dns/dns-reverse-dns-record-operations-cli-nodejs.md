---
title: "Gerenciar registros DNS reversos para seus serviços do Azure usando a CLI do Azure 1.0 | Microsoft Docs"
description: "Como gerenciar registros DNS reversos ou registros PTR para os serviços do Azure usando a CLI do Azure 1.0 no Gerenciador de Recursos"
services: DNS
...
---
# <a name="how-to-manage-reverse-dns-records-for-your-azure-services-using-the-azure-cli-10"></a>Como gerenciar registros DNS reversos para seus serviços do Azure usando a CLI do Azure 1.0
