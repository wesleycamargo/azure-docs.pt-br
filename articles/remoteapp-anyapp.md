...
3. Agora, você precisa criar uma [conta de armazenamento](storage/storage-create-storage-account.md) do Azure. Nomeamos o nosso "accessstorage", então escolha um nome que seja significativo para você (pode haver apenas um "accessstorage"). ![Nossa conta de armazenamento do Azure](./media/remoteapp-anyapp/ra-anyappazurestorage.png)
