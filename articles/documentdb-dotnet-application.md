...
1. No Visual Studio, no menu **Arquivo**, aponte para **Novo** e clique em **Projeto**.
   ...
   A caixa de diálogo **Novo Projeto** aparecerá. 2. No painel **Tipos de projeto**, expanda **Modelos**, **Visual C\#**, **Web** e selecione **Aplicativo Web ASP.NET**.
...
4. Recupere os valores de **URI** e da **CHAVE PRIMÁRIA** ou da **CHAVE SECUNDÁRIA** da folha **Chaves** de sua conta do Banco de Dados de Documentos no [Portal do Azure](https://portal.azure.com/).
	...
	![Captura de tela do Portal do Azure mostrando uma conta do Banco de Dados de Documentos com o hub ATIVO realçado, o botão Chaves realçado na folha da conta do Banco de Dados de Documentos e os valores de URI, de CHAVE PRIMÁRIA e de CHAVE SECUNDÁRIA realçados na folha Chaves](../includes/media/documentdb-keys/keys.png)
