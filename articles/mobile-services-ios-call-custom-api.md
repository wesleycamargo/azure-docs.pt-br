<properties pageTitle="Chamar uma API personalizada em um aplicativo iOS | Serviços Móveis" metaKeywords="" description="Saiba como definir uma API personalizada e chamá-la em um aplicativo iOS que usa os Serviços Móveis do Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Chamar uma API personalizada no cliente" authors="krisragh"  solutions="" writer="krisragh" manager="" editor=""  />
