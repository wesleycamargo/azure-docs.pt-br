...
ms.locfileid: "47045547"
---
# New-AzureRmFrontDoorCustomRuleObject
Criar o objeto CustomRule para a criação de política de WAF
...
### -Action
Tipo de ações.
Os valores possíveis são: “Allow”, “Block” e “Log”
...
Duração do limite de taxa. Padrão – 1 minuto
...
### -RuleType
Tipo da regra.
Os valores possíveis são: “MatchRule” e “RateLimitRule”
