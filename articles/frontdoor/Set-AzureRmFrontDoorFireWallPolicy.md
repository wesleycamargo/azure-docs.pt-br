...
ms.locfileid: "47045533"
---
# Set-AzureRmFrontDoorFireWallPolicy
atualizar a política do WAF
...
## Descrição
O cmdlet **Set-AzureRmFrontDoor** atualiza uma política existente do WAF. Se os parâmetros de entrada não forem fornecidos, os antigos parâmetros da política do WAF existente serão usados.
...
### -EnabledState
Se a política está nos estados habilitado ou desabilitado.
Os valores possíveis são: “Disabled” e “Enabled”
...
Os valores possíveis são: “Prevention” e “Detection”
...
### -Name
O nome da FireWallPolicy a ser atualizada.
...
### -ResourceGroupName
O grupo de recursos ao qual a FireWallPolicy pertence.
...
### -ResourceId
A ID do recurso da FireWallPolicy a ser atualizada
