...
## Descrição
O cmdlet **Set-AzureRmFrontDoor** atualiza um balanceador de carga do Front Door. Se os parâmetros de entrada não forem fornecidos, os antigos parâmetros do Front Door existente serão usados.
