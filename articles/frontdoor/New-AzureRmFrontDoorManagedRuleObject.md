...
ms.locfileid: "47045480"
---
# New-AzureRmFrontDoorManagedRuleObject
Criar um objeto ManagedRule para a criação de política de WAF
...
### -RuleGroupOverride
Lista de configurações de substituição do provedor gerenciado pelo Azure
