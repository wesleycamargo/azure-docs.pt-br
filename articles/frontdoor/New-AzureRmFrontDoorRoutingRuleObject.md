...
### Exemplo 1: Criar um PSRoutingRuleObject para a criação do Front Door
```powershell
...
### -CustomForwardingPath
O caminho personalizado usado para regravar caminhos de recurso correspondidos por essa regra.
...
### -DynamicCompression
Se deseja habilitar a compactação dinâmica de conteúdo armazenado em cache quando o cache está habilitado.
...
### -EnabledState
Se deseja habilitar o uso dessa regra.
O valor padrão é Enabled
...
O tratamento dos termos da consulta de URL ao formar a chave de cache.
