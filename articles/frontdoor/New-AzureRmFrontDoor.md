...
ms.locfileid: "47045682"
---
# New-AzureRmFrontDoor

Criar um novo balanceador de carga do Azure Front Door
...
## Descrição
O cmdlet **New-AzureRmFrontDoor** cria um novo balanceador de carga do Azure Front Door no grupo de recursos especificado na assinatura atual

## EXEMPLOS

### Exemplo 1: Crie um Front Door com base em parâmetros determinados.
```powershell
...
Crie um Front Door com base em parâmetros determinados.
...
### -EnabledState
EnabledState do balanceador de carga do Front Door.
...
### -ResourceGroupName
O nome do grupo de recursos em que o Front Door será criado.
