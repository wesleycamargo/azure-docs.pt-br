...
ms.locfileid: "47045703"
---
# Get-AzureRmFrontDoorFireWallPolicy

Obter a política do WAF
...
## Descrição
O cmdlet **Get-AzureRmFrontDoorFireWallPolicy** obtém a política de WAF em um grupo de recursos na assinatura atual

## EXEMPLOS

### Exemplo 1: obter uma política de WAF chamada $Name em $resourceGroup
```powershell
...
Obter uma política de WAF chamada $Name em $resourceGroup

### Exemplo 2: remover todas as políticas de WAF em $resourceGroup
```powershell
...
Obter todas as políticas de WAF em $resourceGroup
