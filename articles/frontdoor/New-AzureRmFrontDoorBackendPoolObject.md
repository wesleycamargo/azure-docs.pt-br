...
ms.locfileid: "47045475"
---
# New-AzureRmFrontDoorBackendPoolObject

Criar um objeto PSBackendPool para a criação do Front Door
...
### -Backend
O conjunto de back-ends deste pool.
...
O nome das configurações de investigação de integridade deste pool de back-end
...
O nome das configurações de balanceamento de carga deste pool de back-end
