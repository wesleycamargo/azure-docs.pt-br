...
ms.locfileid: "47045531"
---
# Remove-AzureRmFrontDoorFireWallPolicy
Remover a política do WAF
...
## Descrição
O cmdlet **Remove-AzureRmFrontDoor** remove uma política do WAF na assinatura atual
...
Remova a política do WAF chamada $name em $resourceGroup.
...
Remova todas as políticas do WAF em $resourceGroup.
...
### -InputObject
O objeto da política do WAF a ser excluído.
...
### -Name
O nome da política do WAF a ser excluído.
...
### -ResourceGroupName
O grupo de recursos ao qual a política do WAF pertence.
...
### -ResourceId
A ID do recurso da política do WAF a ser excluída
