<properties 
	pageTitle="Visão geral de fragmentação" 
	description="Descreve os motivos para a fragmentação: dimensionar os recursos de banco de dados para aumentar a disponibilidade ou o desempenho." 
