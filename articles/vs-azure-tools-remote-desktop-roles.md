...
2. Na parte inferior da página **Configurações de Publicação do Microsoft Azure** do assistente, selecione a caixa de seleção **Habilitar Área de Trabalho Remota** para todas as funções.
...
4. Na lista suspensa, escolha **&lt;Criar>,** ou escolha na lista um já existente.
