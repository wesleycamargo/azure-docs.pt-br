<properties linkid="manage-services-how-to-manage-a-cloud-service" urlDisplayName="Como gerenciar" pageTitle="Como gerenciar um Serviço de Nuvem - Azure" metaKeywords="gerenciar serviços de nuvem do Azure, Portal de Gerenciamento Azure serviços de nuvem" description="Saiba como gerenciar os serviços de nuvem no Portal de Gerenciamento do Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Como gerenciar serviços de nuvem" authors=""  solutions="" writer="ryanwi" manager="" editor=""  />
...
* [Como atualizar uma função ou implantação de Serviço de Nuvem](#updaterole)
* [Como permutar implantações para promover a implantação de preparo para produção](#swap)
...
<h2><a id="updaterole"></a>Como atualizar uma função ou implantação de Serviço de Nuvem</h2>
...
1. No [Portal de Gerenciamento do Azure](https://manage.windowsazure.com/), no painel, página **Serviços de Nuvem** ou página **Instâncias**, clique em **Atualizar**.

	**Atualizar implantação** é exibido.

	![Atualizar Implantação](./media/cloud-services-how-to-manage/CloudServices_UpdateDeployment.png)
...
<h2><a id="swap"></a>Como permutar implantações para promover a implantação de preparo para produção</h2>
...
6. Para concluir a configuração do banco de dados, siga instruções da ajuda para a área **Bancos de Dados SQL** do Portal de Gerenciamento.
	...
	Quando o vínculo estiver concluído, você poderá monitorar o status do recurso vinculado no painel do Serviço de Nuvem. Para obter informações sobre o dimensionamento de um Banco de Dados SQL vinculado, consulte [Como dimensionar um Serviço de Nuvem e os recursos vinculados](../how-to-scale-a-cloud-service/).
...
2. Selecione o Serviço de Nuvem e clique em **Excluir**. (Para selecionar um Serviço de Nuvem sem abrir o painel, clique em qualquer lugar exceto no nome na entrada do Serviço de Nuvem.)
	...
	![Menu Excluir](./media/cloud-services-how-to-manage/CloudServices_DeleteMenu.png)
...
> [WACOM.NOTE]
> Se o monitoramento detalhado estiver configurado para seu Serviço de Nuvem, o Azure não excluirá os dados de monitoramento de sua conta de armazenamento quando você excluir o Serviço de Nuvem. Você precisará excluir manualmente os dados. Para obter informações sobre onde encontrar as tabelas de métricas, consulte "Como acessar os dados do monitoramento detalhado fora do Portal de Gerenciamento" em <a href="https://www.windowsazure.com/pt-br/manage/services/cloud-services/how-to-monitor-a-cloud-service/">Como monitorar serviços de nuvem (a página pode estar em inglês)</a>.
