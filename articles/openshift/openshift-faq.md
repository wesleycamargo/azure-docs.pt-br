...
Sim. Quando você cria um cluster, você pode implantar um cluster do Azure Red Hat OpenShift em uma rede virtual existente. Consulte a [conectar-se a rede virtual de um cluster para uma rede virtual existente ](tutorial-create-cluster.md#optional-connect-the-clusters-virtual-network-to-an-existing-virtual-network) para obter detalhes.
