<properties urlDisplayName="Validate and Modify Data" pageTitle="Usar o back-end do .NET para validar e modificar dados (Windows Phone 8) | Mobile Dev Center" metaKeywords="" description="Saiba como validar, modificar e aumentar dados para seu aplicativo do Windows Phone com serviços móveis do Microsoft Azure com back-end do .Net." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using the .Net backend" authors="wesmc" solutions="" manager="dwrede" editor="" />
...
3. No arquivo MainPage.xaml.cs, substitua a classe **TodoItem** existente pela seguinte definição, que inclui a nova propriedade **CompleteDate** como um tipo que permite valor nulo.
