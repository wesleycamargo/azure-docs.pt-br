<properties 
	pageTitle="Scripts de servidor do usuário para validar e modificar dados (Windows Store) | Centro de desenvolvimento de serviços móveis" 
	description="Saiba como usar scripts de servidor para validar, modificar e aumentar dados para seu aplicativo da Windows Store com serviços móveis do Azure." 
...
Este tutorial se baseia nas etapas e o aplicativo de exemplo do tutorial anterior, [Introdução aos dados]. Antes de começar este tutorial, você deve primeiro concluir a [Introdução aos dados].  
