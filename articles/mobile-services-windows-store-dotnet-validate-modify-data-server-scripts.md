...
<div class="dev-center-tutorial-selector sublanding"><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-dotnet" title="C# da Windows Store" class="current">C# da Windows Store</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-js" title="JavaScript da Windows Store">JavaScript da Windows Store</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-wp8" title="Windows Phone">Windows Phone</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-ios" title="iOS">iOS</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-android" title="Android">Android</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-html" title="HTML">HTML</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-ios" title="Xamarin.iOS">Xamarin.iOS</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-android" title="Xamarin.Android">Xamarin.Android</a></div>

<div class="dev-center-tutorial-subselector">
    <a href="/pt-br/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-validate-modify-data/" title="Back-end do .NET">Back-end do .NET</a> | 
    <a href="/pt-br/documentation/articles/mobile-services-windows-store-dotnet-validate-modify-data-server-scripts/"  title="Back-end do JavaScript" class="current">Back-end do JavaScript</a>
</div>

<div class="dev-onpage-video-clear clearfix">
<div class="dev-onpage-left-content">
<p>Este t&oacute;pico mostra como utilizar scripts de servidor nos Servi&ccedil;os M&oacute;veis do Azure. Os scripts de servidor s&atilde;o registrados em um servi&ccedil;o m&oacute;vel e podem ser usados para executar um grande intervalo de opera&ccedil;&otilde;es nos dados que est&atilde;o sendo inseridos e atualizados, incluindo valida&ccedil;&atilde;o e modifica&ccedil;&atilde;o de dados. Neste tutorial, voc&ecirc; ir&aacute; definir e registrar scripts de servidor que validam e modificam dados. Como o comportamento de scripts do lado do servidor geralmente afeta o cliente, voc&ecirc; tamb&eacute;m ir&aacute; atualizar o aplicativo da Windows Store para tirar proveito desses novos comportamentos.</p>
</div>

<div class="dev-onpage-video-wrapper"><a href="http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Validate-and-Modify-Data-with-Server-Scripts-in-Windows-Azure-Mobile-Services" target="_blank" class="label">assista ao tutorial</a> <a style="background-image: url('/media/devcenter/mobile/videos/validate-data-windows-store-180x120.png') !important;" href="http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Validate-and-Modify-Data-with-Server-Scripts-in-Windows-Azure-Mobile-Services" target="_blank" class="dev-onpage-video"><span class="icon">Reproduzir o v&iacute;deo</span></a> <span class="time">09:54:00</span></div>
...
3.  Abra o arquivo MainPage.xaml.cs e adicione a seguinte instrução **using**:

        using Windows.UI.Popups;

4.  Substitua o método **InsertTodoItem** existente pelo seguinte:
    ...
    Essa versão do método inclui tratamento de erro para a **MobileServiceInvalidOperationException** que exibe a resposta de erro em uma pop-up.
...
<p>A propriedade de carimbo de data/hora <b>createdAt</b> demonstrada aqui agora &eacute; redundante. Os Servi&ccedil;os M&oacute;veis criam automaticamente uma propriedade do sistema <b>__createdAt</b> para cada tabela. Voc&ecirc; pode usar essa propriedade do sistema em seu aplicativo bastando adicionar o seguinte membro &agrave; classe TodoItem</p>
<pre><code>
...
1.  No Visual Studio, abra o arquivo MainPage.xaml.cs e substitua a classe **TodoItem** existente pela definição a seguir:
    ...
    <div class="dev-callout"><b>Observa&ccedil;&atilde;o</b>
<p>O <code data-inline="1">DataMemberAttribute</code> informa ao cliente para mapear a nova propriedade <code data-inline="1">CreatedAt</code> no aplicativo para a coluna <code data-inline="1">createdAt</code> definida na tabela TodoItem, que tem mai&uacute;sculas e min&uacute;sculas diferentes. Usando esse atributo, seu aplicativo pode ter nomes de propriedades em objetos que s&atilde;o diferentes dos nomes das colunas no Banco de Dados SQL. Sem esse atributo, ocorre um erro devido &agrave;s diferen&ccedil;as de mai&uacute;sculas e min&uacute;sculas.</p>
</div>
...
4.  Substitua o método **RefreshTodoItems** existente pelo código a seguir:
...
-   [Autorizar usuários com scripts][Autorizar usuários com scripts]<br/>
...
-   [Referência conceitual do tutorial do .NET de Serviços Móveis][Referência conceitual do tutorial do .NET de Serviços Móveis]<br/>
  ...
  [Back-end do .NET]: /pt-br/documentation/articles/mobile-services-dotnet-backend-windows-store-dotnet-validate-modify-data/ "Back-end do .NET"
  [Back-end do JavaScript]: /pt-br/documentation/articles/mobile-services-windows-store-dotnet-validate-modify-data-server-scripts/ "Back-end do JavaScript"
  [assista ao tutorial]: http://channel9.msdn.com/Series/Windows-Azure-Mobile-Services/Windows-Store-app-Validate-and-Modify-Data-with-Server-Scripts-in-Windows-Azure-Mobile-Services
  ...
  [Introdução a dados]: /pt-br/develop/mobile/tutorials/get-started-with-data-dotnet
