<properties urlDisplayName="Validate and Modify Data" pageTitle="Scripts de servidor do usuário para validar e modificar dados (Windows Store) | Centro de desenvolvimento móvel"metaKeywords ="" description="Saiba como usar scripts de servidor para validar, modificar e aumentar dados para seu aplicativo da Windows Store com serviços móveis do Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using server scripts" authors="glenga" solutions="" manager="dwrede" editor="" />
