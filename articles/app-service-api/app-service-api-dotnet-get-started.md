...
8. Localize a propriedade `kind` e altere-a de "api" para "WebApp".
	...
	![Propriedade kind para instância do Serviço de Aplicativo](./media/app-service-api-dotnet-get-started/resexp.png)
