...
## Pré-requisitos
1. [Java Developer's Kit 8](ou posterior.md)
2. O [Maven] instalado na máquina de desenvolvimento
3. O [Git] instalado na máquina de desenvolvimento
...
9. Use o [Postman] para fazer uma solicitação ao método de API "obter contato específico", localizado em http://localhost:8080/api/contacts/2.
