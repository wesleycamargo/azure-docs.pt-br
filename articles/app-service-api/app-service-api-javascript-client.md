...
A configuração de aplicativo **MS\_CrossDomainOrigins** é descrita detalhadamente na postagem de blog [Atualizações do .NET do Serviço Móvel do Azure](https://azure.microsoft.com/blog/2014/07/28/azure-mobile-services-net-updates/), por isso verifique esta postagem para obter mais detalhes sobre os detalhes da configuração.
