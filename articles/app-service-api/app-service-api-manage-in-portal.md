...
Você usa a folha **Host de aplicativo de API** para todas as tarefas que você realizaria para qualquer aplicativo da Web. Para obter mais informações, consulte [Gerenciar aplicativos Web no portal](../app-service-web/web-sites-manage.md).
...
Você usa a folha **Host de gateway** para todas as tarefas que você realizaria para qualquer aplicativo da Web. Para obter mais informações, consulte [Gerenciar aplicativos Web no portal](../app-service-web/web-sites-manage.md).
