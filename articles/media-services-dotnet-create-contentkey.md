...
Quando você fornece ativos para seus clientes, você pode [configurar para que os ativos sejam criptografados dinamicamente](../media-services-dotnet-configure-asset-delivery-policy) com uma das duas criptografias seguintes: **DynamicEnvelopeEncryption** ou **DynamicCommonEncryption**.
