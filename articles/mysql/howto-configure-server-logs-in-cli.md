...
Com o comando [az mysql server-logs download](/cli/azure/mysql/server-logs#az_mysql_server_logs_download), você pode baixar arquivos de log individuais para o seu servidor. 
