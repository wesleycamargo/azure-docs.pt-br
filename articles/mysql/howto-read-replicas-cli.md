...
> [!NOTE]
> CLI do Azure ainda não dá suporte criando réplicas em uma região diferente do servidor mestre. Para criar uma réplica entre regiões, use o [portal do Azure]( howto-read-replicas-portal.md) em vez disso.
