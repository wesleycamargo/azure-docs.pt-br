...
[!code-azurecli-interactive[main](../../../cli_scripts/mysql/change-server-configurations/change-server-configurations.sh?highlight=15-16 "Listar e atualizar as configurações do Banco de Dados do Azure para MySQL.")]

## <a name="clean-up-deployment"></a>Limpar implantação
Após executar o exemplo de script, o comando a seguir pode ser usado para remover o grupo de recursos e todos os recursos associados a ele.
[!code-azurecli-interactive[principal](../../../cli_scripts/mysql/change-server-configurations/delete-mysql.sh  "Excluir o grupo de recursos.")]
