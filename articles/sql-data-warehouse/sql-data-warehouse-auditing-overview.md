...
> [!NOTE]
> O módulo do [Azure Resource Manager](https://msdn.microsoft.com/library/dn654592.aspx) está no modo de visualização. Ele pode não fornecer os mesmos recursos de gerenciamento que o módulo do Azure.
> 
> 
