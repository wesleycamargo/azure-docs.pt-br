...
| ![Looker][7] |**Looker BI**<br>A Looker proporciona a cada indivíduo de sua empresa a capacidade de explorar e entender os dados que impulsionam seus negócios, ao mesmo tempo que proporciona aos analistas de dados uma camada de modelagem flexível e reutilizável para controlar e tratar esses dados. As empresas têm transformado fundamentalmente sua cultura usando a Looker como um catalisador. | [Marketplace][looker_marketplace]<br>[Site][looker_website]<br>[Folha de dados][looker_datasheet]<br>[Twitter][looker_twitter]<br>[YouTube][looker_youtube] | [![vídeo de looker](./media/sql-data-warehouse-integrate-solution-partners/looker_video.jpg)](https://www.youtube.com/watch?v=WwO4ADK8ZfA) |
