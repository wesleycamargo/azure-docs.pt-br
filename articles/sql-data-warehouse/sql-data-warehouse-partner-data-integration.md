...
| ![Informatica][4] | **Informatica Cloud**<br>O portfólio de integração da Informatica Cloud permite que você se conecte facilmente a várias fontes de dados em nuvem, no local, móveis e sociais. Você pode usar a Informatica Cloud para compartilhar com eficiência suas informações de negócios relevantes e confiáveis. Oferecemos o mais completo pacote de integração de nuvem para padrões de lote e em tempo real, gerenciamento de dados de teste de nuvem, qualidade de dados de nuvem e aplicativos de gerenciamento de dados mestre de nuvem. | [Marketplace][informatica_Cloud_Services_marketplace]<br>[Avaliação Gratuita][informatica_cloud_free_trial]<br>[Guia de Configuração][informatica_cloud_services_config]<br>[Site da Web][informatica_Cloud_Services_website]<br>[Folha de Dados][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
