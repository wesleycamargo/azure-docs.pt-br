...
Para projetar seu processo de carregamento, consulte [Práticas recomendadas para carregar dados no SQL Data Warehouse do Azure](guidance-for-loading-data.md).  
