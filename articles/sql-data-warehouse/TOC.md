...
## [Criar e conectar - portal](create-data-warehouse-portal.md)
...
# Conceitos
## Recursos de serviço
### [Arquitetura MPP](massively-parallel-processing-mpp-architecture.md)
### [Níveis de desempenho](performance-tiers.md)
### [Unidades do data warehouse](what-is-a-data-warehouse-unit-dwu-cdwu.md)
### [Backups do data warehouse](sql-data-warehouse-backups.md)
...
## Migrar para SQL Data Warehouse
...
### [Consulta elástica do Banco de Dados SQL](how-to-use-elastic-query-with-sql-data-warehouse.md)


## Monitorar e ajustar
### [Diretrizes](resource-classes-for-workload-management.md)
...
## Desenvolver data warehouses
### [Visão geral](sql-data-warehouse-overview-develop.md)
### [Componentes do data warehouse](sql-data-warehouse-overview-workload.md)
...
# Guias de instruções
## Recursos de serviço
### [Restaurar um data warehouse - portal](sql-data-warehouse-restore-database-portal.md)
### [Restaurar um data warehouse - PowerShell](sql-data-warehouse-restore-database-powershell.md)
### [Restaurar um data warehouse - API REST](sql-data-warehouse-restore-database-rest-api.md)

## Segurança
### [Habilitar criptografia - portal](sql-data-warehouse-encryption-tde.md)
### [Habilitar criptografia - T-SQL](sql-data-warehouse-encryption-tde-tsql.md)
...
## Integração
### [Configurar consulta elástica do Banco de Dados SQL](tutorial-elastic-query-with-sql-datababase-and-sql-data-warehouse.md)
### [Adicionar um trabalho do Azure Stream Analytics](sql-data-warehouse-integrate-azure-stream-analytics.md)
### [Usar o aprendizado de máquina](sql-data-warehouse-get-started-analyze-with-azure-machine-learning.md)
...
## Expansão
### [Gerenciar computação - portal](sql-data-warehouse-manage-compute-portal.md)
### [Gerenciar computação - PowerShell](sql-data-warehouse-manage-compute-powershell.md)
...
### [Elementos da linguagem SQL DW](sql-data-warehouse-reference-tsql-language-elements.md)
