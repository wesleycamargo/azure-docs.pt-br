...
Diversas tarefas de administração do SQL Data Warehouse podem ser gerenciadas usando APIs REST ou cmdlets do Azure PowerShell.  Abaixo estão alguns exemplos de como usar comandos do PowerShell para automatizar tarefas comuns no SQL Data Warehouse.  Para alguns bons exemplos REST, consulte o artigo [Gerenciar escalabilidade com REST][Gerenciar escalabilidade com REST].
...
```
Uma variação, esse exemplo canaliza o objeto recuperado para [Suspend-AzureRmSqlDatabase][Suspend-AzureRmSqlDatabase].  Como resultado, o banco de dados é pausado. O comando final mostra os resultados.
...
* [Criar um SQL Data Warehouse usando o PowerShell][Criar um SQL Data Warehouse usando o PowerShell]
* [Restauração do banco de dados][Restauração do banco de dados]

Para obter uma lista de todas as tarefas que podem ser automatizadas com o PowerShell, consulte [Cmdlets do Banco de Dados SQL do Azure][Cmdlets do Banco de Dados SQL do Azure].  Para obter uma lista de tarefas que podem ser automatizadas com REST, consulte [Operações para Banco de Dados SQL do Azure][Operações para Banco de Dados SQL do Azure].
