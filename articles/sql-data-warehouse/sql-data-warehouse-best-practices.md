...
Consulte também [Pausar os recursos de computação][Pausar os recursos de computação], [Retomar os recursos de computação][Retomar os recursos de computação], [Dimensionar os recursos de computação][Dimensionar os recursos de computação]
...
Confira também [Compreendendo as transações][Compreendendo as transações], [Otimizando as transações][Otimizando as transações]
...
Confira também [Gerenciar as estatísticas da tabela][Gerenciar as estatísticas da tabela], [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS]
...
Consulte também [Carregar dados][Carregar dados], [Guia para usar o PolyBase][Guia para usar o PolyBase], [Padrões e estratégias de carregamento do Azure SQL Data Warehouse][Padrões e estratégias de carregamento do Azure SQL Data Warehouse], [Carregar os Dados com o Azure Data Factory][Carregar os Dados com o Azure Data Factory], [Mover dados com o Azure Data Factory][Mover dados com o Azure Data Factory], [CREATE EXTERNAL FILE FORMAT][CREATE EXTERNAL FILE FORMAT], [Create table as select (CTAS)][Create table as select (CTAS)]
...
Confira também [Guia para usar o PolyBase][Guia para usar o PolyBase]
...
Confira também [Visão geral das tabelas][Visão geral das tabelas], [Distribuição de tabelas][Distribuição de tabelas], [Selecionando a distribuição de tabelas][Selecionando a distribuição de tabelas], [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT]
...
Confira também [Noções básicas sobre transações][Noções básicas sobre transações], [Otimização de transações][Otimização de transações], [Particionamento de tabelas][Particionamento de tabelas], [TRUNCATE TABLE][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [CTAS (Create table as select)][CTAS (Create table as select)]
...
Confira também [Visão geral das tabelas][Visão geral das tabelas], [Tipos de dados da tabela][Tipos de dados da tabela], [CREATE TABLE][CREATE TABLE]
...
Confira também [Tabelas temporárias][Tabelas temporárias], [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT]
...
Confira também [Índices de tabela][Índices de tabela], [Guia dos índices columnstore][Guia dos índices columnstore] e [Recriando índices columnstore][Recriando índices columnstore]
...
Confira também [Gerenciamento de simultaneidade e carga de trabalho][Gerenciamento de simultaneidade e carga de trabalho]
...
Confira também [Gerenciamento de simultaneidade e carga de trabalho][Gerenciamento de simultaneidade e carga de trabalho], [sys.dm\_pdw\_waits][sys.dm\_pdw\_waits]
...
[CTAS (Create table as select)]: ./sql-data-warehouse-develop-ctas.md
[Create table as select (CTAS)]: ./sql-data-warehouse-develop-ctas.md
[Visão geral das tabelas]: ./sql-data-warehouse-tables-overview.md
...
[Compreendendo as transações]: ./sql-data-warehouse-develop-transactions.md
[Noções básicas sobre transações]: ./sql-data-warehouse-develop-transactions.md
[Otimizando as transações]: ./sql-data-warehouse-develop-best-practices-transactions.md
