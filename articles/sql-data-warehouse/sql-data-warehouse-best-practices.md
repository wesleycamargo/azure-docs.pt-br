...
Confira também [Visão geral da tabela][], [Distribuição de tabelas][], [Selecionando a distribuição de tabelas][], [CREATE TABLE][], [CREATE TABLE AS SELECT][]
...
Consulte também [Particionamento da tabela][]
...
Confira também [Compreendendo as transações][], [Otimizando as transações][], [Particionamento da tabela][], [TRUNCATE TABLE][], [ALTER TABLE][], [Create table as select (CTAS)][]
...
Confira também [Visão geral da tabela][], [Tipos de dados da tabela][], [CREATE TABLE][]
