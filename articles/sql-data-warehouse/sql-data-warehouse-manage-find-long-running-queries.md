<properties
   pageTitle="Encontrar consultas de usuário com execução longa no SQL Data Warehouse do Azure| Microsoft Azure"
   description="Saiba como monitorar sua carga de trabalho e localizar consultas com execução longa no SQL Data Warehouse do Azure ao usar DMVs (exibições de gerenciamento dinâmico)."
...
# Encontrar consultas com execução longa
