---
title: "Otimizações de memória – índices columnstore no SQL Data Warehouse do Azure | Microsoft Docs"
...
- Para aumentar as DWUs, consulte [Como faço para escalar o desempenho?](sql-data-warehouse-manage-compute-overview.md#scale-performance)
