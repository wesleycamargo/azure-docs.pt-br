...
## Exibições do catálogo do Banco de dados SQL

- [dbo.server\_quotas (Azure SQL Database)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth\_usage (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database\_connection\_stats (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database\_firewall\_rules (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database\_usage (Banco de dados SQL do Azure)](https://msdn.microsoft.com/library/dn270020.aspx)
- [sys.event\_log (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules (Banco de Dados SQL do Azure)](https://msdn.microsoft.com/library/dn269980.aspx)
- [sys.resource\_stats (Banco de Dados SQL do Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- [sys.resource\_usage (Banco de Dados SQL do Azure)](https://msdn.microsoft.com/library/dn270016.aspx)
...
## Lista de DMVs do SQL Server disponíveis no SQL Data Warehouse
...
É por isso cada um desses DMV tem uma coluna específica, chamada pdw\_node\_id. Este é o identificador para o Nó de computação. No PDW, o nó Computação é um conceito mais forte para a arquitetura. No SQL Data Warehouse, a arquitetura depende mais intensamente das distribuições.

>[AZURE.NOTE] Para usar esses exibição, insira 'pdw\_nodes\_' no nome, conforme mostrado na tabela a seguir.
...
| sys.dm\_pdw\_nodes\_exec\_sessions | [sys.dm\_exec\_sessions (Transact-SQL)](https://msdn.microsoft.com/pt-BR/library/ms176013.aspx) |
...
| sys.dm\_pdw\_nodes\_os\_dispatchers | A documentação do Transact-SQL não está disponível. |
...
| sys.dm\_pdw\_nodes\_os\_memory\_node\_access\_stats | A documentação do Transact-SQL não está disponível. |
...
| sys.dm\_pdw\_nodes\_os\_spinlock\_stats | A documentação do Transact-SQL não está disponível. |
...
| sys.dm\_pdw\_nodes\_tran\_commit\_table | A documentação do Transact-SQL não está disponível. |
...
## DMVs do Banco de dados SQL disponíveis no SQL Data Warehouse
...
## Informações do SQL Server\_exibições do esquema

Esses são links para as exibições do Esquema de Informações do SQL Server disponíveis no SQL Server PDW. Todas as exibições INFORMATION\_SCHEMA que você esperaria ver no SQL Server estão disponíveis no SQL Server PDW.
...
- [RESTRIÇÃO DO USO DA COLUNA (Transact-SQL)](http://msdn.microsoft.com/library/ms174431.aspx)
- [CONSTRAINT\_TABLE\_USAGE (Transact-SQL)](http://msdn.microsoft.com/library/ms179883.aspx)
- [DOMÍNIOS (Transact-SQL)](http://msdn.microsoft.com/library/ms190371.aspx)
- [KEY\_COLUMN\_USAGE (Transact-SQL)](http://msdn.microsoft.com/library/ms189789.aspx)
- [PARÂMETROS (Transact-SQL)](http://msdn.microsoft.com/library/ms173796.aspx)
- [RESTRIÇÕES REFERENCIAIS (Transact-SQL)](http://msdn.microsoft.com/library/ms179987.aspx)
- [COLUNAS DE ROTINA (Transact-SQL)](http://msdn.microsoft.com/library/ms187350.aspx)
- [ROTINAS (Transact-SQL)](http://msdn.microsoft.com/library/ms188757.aspx)
- [ESQUEMAS (Transact-SQL)](http://msdn.microsoft.com/library/ms182642.aspx)
- [RESTRIÇÕES DE TABELA (Transact-SQL)](http://msdn.microsoft.com/library/ms181757.aspx)
- [PRIVILÉGIOS DE TABELA (Transact-SQL)](http://msdn.microsoft.com/library/ms186233.aspx)
- [TABELAS (Transact-SQL)](http://msdn.microsoft.com/library/ms186224.aspx)
- [EXIBIR USO DA COLUNA (Transact-SQL)](http://msdn.microsoft.com/library/ms190492.aspx)
- [EXIBIR USO DA TABELA (Transact-SQL)](http://msdn.microsoft.com/library/ms173869.aspx)
