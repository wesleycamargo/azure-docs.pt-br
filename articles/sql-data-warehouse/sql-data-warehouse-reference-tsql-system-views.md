...
- [sys.bandwidth_usage (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules (Banco de Dados SQL do Azure)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats (Banco de Dados SQL do Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage (Banco de Dados SQL do Azure)
...
>[AZURE.NOTE]Para usar esses exibição, insira 'pdw_nodes_' no nome, conforme mostrado na tabela a seguir.
...
| sys.dm_pdw_nodes_tran_commit_table | A documentação do Transact-SQL não está disponível. |
...
## Informações do SQL Server_exibições do esquema

Esses são links para as exibições do Esquema de Informações do SQL Server disponíveis no SQL Server PDW. Todas as exibições INFORMATION_SCHEMA que você esperaria ver no SQL Server estão disponíveis no SQL Server PDW.
