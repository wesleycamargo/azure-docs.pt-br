...
- [sys.database\_usage (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event\_log (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules (Banco de dados SQL do Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules (Banco de Dados SQL do Azure)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource\_stats (Banco de Dados SQL do Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource\_usage (Banco de Dados SQL do Azure)
