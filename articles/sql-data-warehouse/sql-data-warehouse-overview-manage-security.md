...
Para criar um usuário Autenticado do SQL Server, conecte-se ao banco de dados **mestre** no servidor com o logon de administrador de servidor e crie um novo logon de servidor.
...
Você também pode habilitar a Transparent Data Encryption nas configurações de banco de dados no [Portal do Azure][]. Para obter mais informações, consulte [Introdução à TDE (Transparent Data Encryption)][].
