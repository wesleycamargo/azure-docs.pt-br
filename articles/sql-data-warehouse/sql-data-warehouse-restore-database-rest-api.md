<properties
   pageTitle="Restaurar um banco de dados no SQL Data Warehouse do Azure (API REST) | Microsoft Azure"
...
# Restaurar um banco de dados no SQL Data Warehouse do Azure (API REST)
...
Tarefas da API REST para restaurar um banco de dados dinâmico, excluído ou inacessível no SQL Data Warehouse do Azure.
