...
4. Envie a consulta a seguir para criar uma definição de tabela externa que aponta para o **OrderInformation** tabela na instância do data warehouse.
