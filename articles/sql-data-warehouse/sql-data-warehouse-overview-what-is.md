...
## Otimizado para cargas de trabalho do data warehouse
...
* Talvez determinados elementos de linguagem T-SQL que são menos comuns para cargas de trabalho de armazenamento de dados, ou que são mais recentes para o SQL Server, não estejam disponíveis no momento. Para obter mais informações, consulte a [Documentação de migração][Documentação de migração].
...
**Ferramentas de terceiros:** vários provedores de ferramenta de terceiros têm integração certificada de suas ferramentas com o SQL Data Warehouse. Para obter uma lista completa, consulte [Parceiros de solução do SQL Data Warehouse][Parceiros de solução do SQL Data Warehouse].
...
## Próximas etapas
Agora que você sabe um pouco sobre o SQL Data Warehouse, saiba como [criar um Data Warehouse SQL][criar um Data Warehouse SQL] e [carregar dados de amostra][carregar dados de amostra] rapidamente. Se você for novo no Azure, você pode encontrar o [Glossário do Azure][Glossário do Azure] úteis à medida que encontrar nova terminologia. Ou, dê uma olhada em alguns desses outros recursos do SQL Data Warehouse.
