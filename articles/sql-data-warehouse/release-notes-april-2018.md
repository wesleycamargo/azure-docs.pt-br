...
### <a name="dbcc-commands-do-not-consume-concurrency-slots"></a>Comandos DBCC não consomem slots de simultaneidade
...
### <a name="updated-error-message-for-excessive-literals"></a>Mensagem de erro para literais excessivos atualizada
...
### <a name="removed-the-syspdwdatabasemappings-view"></a>Exibição SYS.PDW_DATABASE_MAPPINGS removida
