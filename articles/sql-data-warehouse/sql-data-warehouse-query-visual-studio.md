<properties
   pageTitle="Consultar o SQL Data Warehouse do Azure (Visual Studio) | Microsoft Azure"
...
+ Um SQL Data Warehouse existente. Para criar um, confira [Criar um SQL Data Warehouse][].
+ SSDT para Visual Studio. Se você tiver o Visual Studio, provavelmente já terá isso. Para obter instruções e opções de instalação, consulte [Instalar o Visual Studio e o SSDT][].
+ O nome de servidor SQL totalmente qualificado. Para encontrar isso, confira[Conectar-se ao SQL Data Warehouse][].
...
Para configurar seu ambiente para a autenticação do Azure Active Directory, confira [Autenticar no SQL Data Warehouse][].
