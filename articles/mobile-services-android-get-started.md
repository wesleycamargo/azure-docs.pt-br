...
<p>Este tutorial mostra como adicionar um serviço de back-end baseado em nuvem a um aplicativo Android usando os Serviços Móveis do Azure. Neste tutorial, você criará um novo serviço móvel e um simples aplicativo <em>To do list</em> que armazena dados de aplicativo no novo serviço móvel.</p>
...
5. Baixe agora o seu aplicativo:
	...
	- Uma versão mais antiga usa a versão anterior do SDK. Para usá-la, em **Baixar e executar o aplicativo**, clique em **Baixar**. Isso baixa o projeto para o aplicativo de amostra _To do list_ conectado ao seu serviço móvel. Os arquivos de projeto estão compactados, então navegue até sua localização e descompacte os arquivos em seu computador.
...
5. No aplicativo, digite um texto significativo, como _Complete the tutorial_e, em seguida, clique em **Adicionar**.
