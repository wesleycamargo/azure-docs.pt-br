<properties urlDisplayName="Tomcat on Virtual Machine" pageTitle="Tomcat em uma máquina virtual - tutoria do Azure" metaKeywords="Azure vm, creating vm Tomcat, configuring vm Tomcat" description="Saia como criar uma máquina virtual Windows e configurá-la para executar um servidor de aplicativos Apache Tomcat." metaCanonical="" services="virtual-machines" documentationCenter="Java" title="How to run a Java application server on a virtual machine" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
...
Neste ponto, o site do Tomcat deve ser visível de um navegador externo usando uma URL no formato **http://*your\_DNS\_name*.cloudapp.net**, where ***your\_DNS\_name*** é o nome DNS que você especificou ao criar a máquina virtual.
