<properties linkid="dev-java-vm-application-server" urlDisplayName="Tomcat na máquina virtual" pageTitle="Tomcat em uma máquina virtual - Tutorial do Azure" metaKeywords="VM do Azure, criando Tomcat em VM, configurando Tomcat em VM" description="Aprenda a criar uma máquina virtual do Windows e configurar o computador para executar um servidor de aplicativos do Apache Tomcat." metaCanonical="" services="virtual-machines" documentationCenter="Java" title="Como executar um servidor de aplicativos Java em uma máquina virtual" authors="waltpo" solutions="" manager="" editor="" />
...
6. Na próxima caixa de diálogo <strong>Configuração da máquina virtual</strong>:
    ...
    4. Clique em **Avançar**.
7. Na caixa de diálogo <strong>Configuração da máquina virtual</strong>:
...
6. Na caixa de diálogo **Adicionar ponto de extremidade**, verifique se a opção **Adicionar ponto de extremidade autônomo** está marcada e clique em **Avançar**.
...
2. Clique em **Inicialização do Windows**.
3. Clique em **Painel de Controle**.
4. Clique em **Sistema e Segurança**, em **Firewall do Windows** e em **Configurações Avançadas**.
5. Clique em **Regras de Entrada** e em **Nova Regra**.

 ![Nova regra de entrada][NewIBRule]

6. Para a nova regra, selecione **Porta** para o **Tipo de regra** e clique em **Avançar**.
...
8. Escolha **Permitir a conexão** e clique em **Avançar**.

 ![Nova ação de regra de entrada][NewRuleAction]

9. Verifique se **Domínio**, **Particular** e **Público** estão marcados para o perfil e clique em **Avançar**.
...
A esta altura, o site do Tomcat deve ser visível em um navegador externo usando uma URL no formato **http://*your\_DNS\_name*.cloudapp.net**, em que ***your\_DNS\_name***, é o nome DNS que você especificou ao criar a máquina virtual.
