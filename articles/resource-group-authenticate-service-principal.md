...
4. Crie uma entidade de serviço para seu aplicativo passando a id do aplicativo do Active Directory.
        ...
        New-AzureRmADServicePrincipal -ApplicationId $app.ApplicationId
5. Conceda à entidade de serviço permissões em sua assinatura. Neste exemplo, você adiciona a entidade de serviço à função **Leitor**, que concede permissão para ler todos os recursos na assinatura. Para ver outras funções, consulte [RBAC: funções internas](active-directory/role-based-access-built-in-roles.md). Para ver o parâmetro **ServicePrincipalName**, forneça a **ApplicationId** que você usou ao criar o aplicativo.
