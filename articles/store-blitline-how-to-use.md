<properties linkid="develop-net-how-to-guides-blitline-image-processing-service" urlDisplayName="Serviço de processamento de imagens Blitline" pageTitle="Como usar o Blitline para o processamento de imagens - guia de recursos do Azure " metaKeywords="" description="Aprenda a usar o serviço Blitline para processar imagens em um aplicativo do Azure." metaCanonical="" services="" documentationCenter=".NET" title="Como usar o Blitline com o Azure e o Armazenamento do Azure" authors="pennij" solutions="" manager="" editor="" />
...
## <a id="whatisnot"></a>O que o Blitline NÃO...
...
Você pode encontrar mais informações sobre as *funções* com suporte aqui: <http://http://www.blitline.com/docs/functions> (a página pode estar em inglês).

Também pode encontrar documentação sobre as opções de trabalho aqui: <http://www.blitline.com/docs/api> (a página pode estar em inglês).
...
* Biblioteca de Nuget de terceiros <http://nuget.org/packages/Blitline.Net>
  ...
  [O que o Blitline NÃO]: #whatisnot
