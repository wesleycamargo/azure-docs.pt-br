...
O Visual Studio pode publicar um aplicativo diretamente no Azure, com suporte para ambientes de preparo e produção de um serviço de nuvem. Ao publicar, você deve selecionar o ambiente de implantação e uma conta de armazenamento usada temporariamente para o pacote de implantação.
