...
# Usar o Portal do Azure para criar alertas para os serviços do Azure
...
## Criar uma regra de alerta em uma métrica com o Portal do Azure
...
4. Dê um **Nome** para o alerta de regra e, em seguida, escolha uma **Descrição**, que também mostra os emails de notificação.
