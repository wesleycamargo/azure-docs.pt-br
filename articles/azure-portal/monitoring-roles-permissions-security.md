...
* Consultar métricas usando a [API REST do Azure Monitor](https://msdn.microsoft.com/library/azure/dn931930.aspx), [os cmdlets do PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md) ou a [CLI de plataforma cruzada](../monitoring-and-diagnostics/insights-cli-samples.md).
...
* Exibir o [perfil de log](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles) para uma assinatura.
...
* Definir o [perfil de log](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles) para uma assinatura.*
...
* [Leia a visão geral do monitoramento no Azure](../monitoring-and-diagnostics/monitoring-overview.md)
