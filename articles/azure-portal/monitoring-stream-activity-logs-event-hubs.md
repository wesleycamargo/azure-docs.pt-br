...
[**Os Logs de Atividade do Azure**](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md) podem ser transmitidos quase em tempo real a qualquer aplicativo usando a opção interna "Exportar" no Portal, ou habilitando a Id da Regra de Barramento de Serviço em um Perfil de Log por meio de Cmdlets do Azure PowerShell ou da CLI do Azure.
...
[O esquema para o Log de Atividades está disponível aqui](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md). Cada evento é uma matriz de blobs JSON chamada "registros".

## Próximas etapas
* [Arquivar o Log de atividade em uma conta de armazenamento](../monitoring-and-diagnostics/monitoring-archive-activity-log.md)
* [Leia a visão geral do Log de Atividades do Azure](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md)
* [Configurar um alerta com base em um evento do Log de Atividades](../monitoring-and-diagnostics/insights-auditlog-to-webhook-email.md)
