...
Você também pode configurar um alerta para publicar no URI de um webhook usando os [Cmdlets do Azure PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md#create-alert-rules), [CLI entre plataformas](../monitoring-and-diagnostics/insights-cli-samples.md#work-with-alerts) ou [API REST do Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
...
> [!NOTE]
> O campo de propriedades só pode ser definido usando a [API REST do Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
> 
> 
