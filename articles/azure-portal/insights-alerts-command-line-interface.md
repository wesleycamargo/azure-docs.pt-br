---
title: Usar a CLI (Interface de linha de comando) de plataforma cruzada a fim de criar alertas para serviços do Azure | Microsoft Docs
...
1. Conclua os pré-requisitos e entre no Azure. Confira [Exemplos da CLI do Azure Insights](../monitoring-and-diagnostics/insights-cli-samples.md). Em resumo, instale a CLI e execute os comandos. Eles conectam você, mostram qual assinatura está usando e se preparam para executar comandos do Insights.
