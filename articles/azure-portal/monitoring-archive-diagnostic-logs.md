...
---
# Arquivar Logs de Diagnóstico do Azure
Neste artigo, mostraremos como você pode usar o Portal do Azure, os cmdlets do PowerShell, CLI ou API REST para arquivar seu [Log de Diagnósticos do Azure](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md) em uma conta de armazenamento. Essa opção será útil se você quiser manter seu Log de Diagnósticos com uma política de retenção opcional para auditoria, análise estática ou backup.
...
## Arquivar Logs de Diagnóstico por meio de cmdlets do PowerShell
```
...
## Arquivar o Log de Atividades por meio da CLI de plataforma cruzada
```
...
## Arquivar Logs de Diagnóstico por meio da API REST
[Confira este documento](https://msdn.microsoft.com/library/azure/dn931931.aspx) para saber mais sobre como definir uma configuração de diagnóstico usando a API REST do Insights.

## Esquema de Logs de Diagnóstico na conta de armazenamento
...
* [Saiba mais sobre Logs de Diagnóstico](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)
