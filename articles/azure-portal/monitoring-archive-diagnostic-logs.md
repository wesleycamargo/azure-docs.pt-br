<properties
	pageTitle="Arquivar Logs de Diagnóstico do Azure | Microsoft Azure"
...
| RetentionInDays | Não | Número de dias durante os quais os eventos devem ser mantidos. Um valor de zero armazena os logs indefinidamente. |
