...
**[Os Logs de Diagnóstico do Azure](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)** podem ser transmitidos em tempo real a qualquer aplicativo usando a opção interna "Exportar para Hubs de Eventos" no Portal, ou habilitando a ID da Regra de Barramento de Serviço em uma Configuração de Diagnóstico por meio de Cmdlets do Azure PowerShell ou da CLI do Azure.
...
Para habilitar o streaming por meio de [Cmdlets do Azure PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md), use o cmdlet `Set-AzureRmDiagnosticSetting` com estes parâmetros:
...
### Via CLI do Azure
Para habilitar o streaming por meio da [CLI do Azure](../monitoring-and-diagnostics/insights-cli-samples.md), use o comando `insights diagnostic set` da seguinte forma:
...
Veja uma lista de todos os provedores de recursos que oferecem suporte a streaming para o Hub de Eventos [aqui](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md).
