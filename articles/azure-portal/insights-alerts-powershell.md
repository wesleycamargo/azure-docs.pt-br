...
# Usar o PowerShell para criar alertas para os serviços do Azure 
...
## Criar regras de alerta no PowerShell
...
7. Para criar um alerta disparado em uma condição específica no log de atividades, use comandos da seguinte forma
...
8. Verifique se os alertas foram criados corretamente examinando regras individuais.
...
9. Excluir seus alertas. Esses comandos excluem as regras criadas anteriormente neste artigo.
