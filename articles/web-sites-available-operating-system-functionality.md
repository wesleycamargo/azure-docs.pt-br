<properties linkid="manage-services-storage-net-shared-access-signature-part-2" urlDisplayName="Assinatura de Acesso Compartilhado parte 2" pageTitle="Assinaturas de acesso compartilhado, parte 2: criar e usar uma SAS com o serviço Blob" metaKeywords="" description="Saiba como gerar e usar assinaturas de acesso compartilhado com o serviço Blob do Azure. Os exemplos são escritos em C# e usam a Biblioteca cliente de armazenamento do Azure do .NET." metaCanonical="" services="storage" documentationCenter=".NET" title="Funcionalidade do sistema operacional disponível para aplicativos em Sites do Azure" authors="timamm"  solutions="" writer="timamm" manager="" editor=""  />
