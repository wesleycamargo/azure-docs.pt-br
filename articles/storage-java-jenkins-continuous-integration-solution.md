<properties urlDisplayName="Jenkins Continuous Integration" pageTitle="Usando o Armazenamento do Azure com uma solu&ccedil;&atilde;o de integra&ccedil;&atilde;o cont&iacute;nua Jenkins | Microsoft Azure" metaKeywords="" description="Este tutorial mostra como usar o servi&ccedil;o Blob do Azure como um reposit&oacute;rio para artefatos de compila&ccedil;&atilde;o criados por uma solu&ccedil;&atilde;o de integra&ccedil;&atilde;o cont&iacute;nua Jenkins." metaCanonical="" services="storage" documentationCenter="Java" title="Usando o Armazenamento do Azure com uma solu&ccedil;&atilde;o de Integra&ccedil;&atilde;o Cont&iacute;nua Jenkins" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
...
## <a name="prerequisites"></a><span class="short header">Pré-requisitos</span>Pré-requisitos
...
-   Uma solução de Integração Contínua Jenkins.
    ...
    3.  In your browser, open `http://localhost:8080/`. Isso abrirá o painel da Jenkins, que você usará para instalar e configurar o plug-in do Armazenamento do Azure.
...
## <a name="howtouse"></a><span class="short header">Como usar o serviço Blob</span>Como usar o serviço Blob com a CI Jenkins
...
## <a name="howtoinstall"></a><span class="short header">Como instalar</span>Como instalar o plug-in Armazenamento do Azure
...
## <a name="howtoconfigure"></a><span class="short header">Como configurar</span>Como configurar o plug-in Armazenamento do Azure para usar sua conta de armazenamento
...
## <a name="howtocreatepostbuild"></a><span class="short header">Como criar uma ação pós-compilação</span>Como criar uma ação pós-compilação que carrega os artefatos de compilação na sua conta de armazenamento
...
## <a name="components"></a><span class="short header">Componentes do serviço Blob</span>Componentes usados pelo serviço Blob
...
-   **Formato de URL**: Os blobs são endereçáveis usando o seguinte formato de URL:
  ...
  [Noções gerais sobre blobs de blocos e blobs de páginas (a página pode estar em inglês)]: http://msdn.microsoft.com/pt-br/library/windowsazure/ee691964.aspx
