---
title: Criar e localizar as âncoras usando âncoras espacial do Azure no C + + c++ /CLI NDK | Microsoft Docs
...
ms.locfileid: "57857378"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-cndk"></a>Criar e localizar as âncoras usando âncoras espacial do Azure no C + + c++ /CLI NDK
...
Âncoras Espaciais do Azure permitem que você compartilhe âncoras no mundo entre diferentes dispositivos. Ele dá suporte a vários ambientes de desenvolvimento. Neste artigo, vamos nos aprofundar em como fazer isso no C + + c++ /CLI NDK.
