---
title: Criar e localizar as âncoras usando âncoras espacial do Azure no C + + c++ /CLI WinRT | Microsoft Docs
...
ms.locfileid: "57875491"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-cwinrt"></a>Criar e localizar as âncoras usando âncoras espacial do Azure no C + + c++ /CLI WinRT
...
Âncoras Espaciais do Azure permitem que você compartilhe âncoras no mundo entre diferentes dispositivos. Ele dá suporte a vários ambientes de desenvolvimento. Neste artigo, vamos nos aprofundar em como fazer isso no C + + c++ /CLI WinRT.
...
Saiba mais sobre o [ProcessFrame](https://docs.microsoft.com/cpp/api/spatial-anchors/winrt/cloudspatialanchorsession#processframe) método.
