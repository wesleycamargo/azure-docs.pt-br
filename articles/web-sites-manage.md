...
No [Portal do Azure](https://portal.azure.com), gerencie seus aplicativos Web por meio de uma série de *blades*, que são contêineres para os diferentes componentes. (Para obter uma visão geral do Portal do Azure, consulte o guia para alterações do [Portal](http://go.microsoft.com/fwlink/?LinkId=529715).) 

Para exibir a lâmina de seu aplicativo Web, clique em **Página inicial** e em seguida no nome do aplicativo, ou então clique em **Procurar** para ver todos os seus recursos do Azure.

![](./media/web-sites-manage/manage01.png)

A parte superior da lâmina tem controles para algumas ações comuns:
...
Abaixo de **Informações gerais** há várias partes que você pode usar para monitorar, gerenciar e implantar seu aplicativo. Para personalizar o layout da lâmina, clique com botão direito do mouse e selecione **Personalizar** ou **Adicionar partes**. O restante deste tópico descreve as partes no layout padrão.
...
- **Faixa de preço** permite que você altere a faixa de preço.
...
- **Logs de streaming** (A). Clique para exibir logs de aplicativo. Para habilitar logs, vá para **Configurações** e abra a lâmina **Logs de diagnóstico**. 
...
- [Backups de aplicativos Web do Azure](web-sites-backup.md) e [restauração](web-sites-restore.md)
