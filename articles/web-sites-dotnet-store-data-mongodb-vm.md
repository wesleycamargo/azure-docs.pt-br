<properties linkid="develop-dotnet-website-with-mongodb-vm" urlDisplayName="Site com máquina virtual com MongoDB" pageTitle="Site do .NET com o MongoDB em uma máquina virtual - Azure" metaKeywords="Azure Git ASP.NET MongoDB, Git .NET, Git MongoDB, ASP.NET MongoDB, Azure MongoDB, Azure ASP.NET, tutorial do Azure" description="Um tutorial que ensina a usar o Git para implantar um aplicativo do ASP.NET em um site do Azure conectado ao MongoDB em uma máquina virtual." metaCanonical="" services="web-sites,virtual-machines" documentationCenter=".NET" title="Criar um site do Azure que se conecte ao MongoDB em execução em uma máquina virtual no Azure" authors="" solutions="" manager="" editor="" />
...
![Aplicativo do MVC do ASP.NET padrão][VS2013DefaultMVCApplication]
...
###Adicionar um modelo###
No **Gerenciador de Soluções**, clique com botão direito do mouse na pasta *Modelos*, clique em **Adicionar** uma nova **Classe** e nomeie-a como *TaskModel.cs*.  Em *TaskModel.cs*, substitua o código existente pelo seguinte código:
...
###Adicionar a camada de acesso a dados###
No **Gerenciador de Soluções**, clique com o botão direito do mouse no projeto *MyTaskListApp* e clique em **Adicionar** uma **Nova Pasta** chamada *DAL*.  Clique com botão direito do mouse na pasta *DAL* e clique em **Adicionar** uma nova **Classe**. Nomeie o arquivo de classe *Dal.cs*.  Em *Dal.cs*, substitua o código existente pelo seguinte código:
...
###Definir a cadeia de conexão de MongoDB###
...
<h2><span class="short-header">Implantar o aplicativo em um site do Azure</span>Implantar o aplicativo do ASP.NET em um site do Azure</h2>
...
![Criar um novo site][WAWSCreateWebSite]
...
Nesta seção, você implantará o aplicativo Minha Lista de Tarefas usando Git.

1. Clique no nome do site em **Sites** e em **Painel**.  No lado direito, em Visão Rápida, clique em **Configurar implantação com base no controle de origem**.
...
3. O repositório Git deve ser criado rapidamente. Observe as instruções na página resultante à medida que serão usadas na próxima seção.
	...
	![O repositório Git está pronto][Image9]
...
4. Em **Enviar meus arquivos locais por push para o Azure** existem instruções sobre como enviar o código para o Azure por push. As instruções serão semelhantes às seguintes:
	...
	![Enviar arquivos locais por push para o Azure][Image10]
