...
## Etapa 1: Criar as filas do Barramento de Serviço
...
## Etapa 2: Criar e implantar o acordo entre parceiros comerciais
...
4. Criar o contrato de recebimento entre a Contoso e a Northwind. Esse contrato determina como a Contoso recebe a confirmação da Northwind.
   ...
   3. Na guia **Protocolo**, na seção **Esquemas**, carregue o esquema **EFACT\_4.1\_CONTRL.xsd**. Esse esquema está disponível com o pacote de exemplo.
...
## Etapa 3: Criar e implantar o projeto dos Serviços BizTalk
...
* **EFACT\_D93A\_INVOIC. XSD** – Esquema da fatura EDIFACT padrão.
* **EFACT\_4.1\_CONTRL. XSD** – Esquema da confirmação EDIFACT que Northwind envia para a Contoso.
* **INHOUSEINVOICE\_to\_D93AINVOIC. TRFM** – A transformação que mapeia o esquema de fatura interna para o esquema de fatura EDIFACT padrão.

### Criar o projeto dos Serviços BizTalk
...
8. Atualize o arquivo EDIBridge.config para incluir detalhes de configuração
   ...
   * Em *<comportamentos>*, forneça o namespace do ACS e a chave associada à assinatura dos Serviços BizTalk.
   * Em *<cliente>*, forneça o ponto de extremidade no qual o contrato de envio EDI está implantado.
...
## Etapa 5 (opcional): Enviar fatura EDIFACT em lotes
