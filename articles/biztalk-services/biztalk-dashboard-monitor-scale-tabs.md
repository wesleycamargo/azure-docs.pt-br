...
## <a name="a-namemetricsaavailable-metrics"></a><a name="Metrics"></a>Métricas disponíveis
...
## <a name="a-namehybridconnectionsahybrid-connections"></a><a name="HybridConnections"></a>Conexões Híbridas
