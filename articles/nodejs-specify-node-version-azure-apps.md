<properties linkid="develop-nodejs-common-tasks-specifying-a-node-version" urlDisplayName="Especificando uma versão do Node.js" pageTitle="Especificando uma versão do Node.js" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="Node.js" title="Especificando uma versão do Node.js em um aplicativo do Azure" authors="larryfr" solutions="" manager="paulettm" editor="mollybos" />





# Especificando uma versão do Node.js em um aplicativo do Azure
...
[Ferramentas de linha de comando do Azure]: /pt-br/develop/nodejs/how-to-guides/command-line-tools/
[trabalhar com módulos]: /pt-br/develop/nodejs/common-tasks/working-with-node-modules/
[criar e implantar um Site no Node.js]: /pt-br/develop/nodejs/tutorials/create-a-website-(mac)/
