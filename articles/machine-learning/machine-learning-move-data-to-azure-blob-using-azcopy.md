...
AzCopy é um utilitário de linha de comando projetado para upload, download e cópia de dados de alto desempenho do e para o armazenamento de blob, arquivo e tabela do Microsoft Azure.
...
Este documento pressupõe que você tenha uma assinatura, uma conta de armazenamento do Azure e as chaves de armazenamento correspondentes dessa conta. Antes de carregar/baixar os dados, você deve conhecer o nome e a chave da sua conta do Armazenamento do Azure.
