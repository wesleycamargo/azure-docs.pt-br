...
5. Escolha se deseja publicar seu conteúdo publicamente ou se ele pode ser acessado somente por pessoas com o link.
   ...
   > [!TIP]
   > Para verificar se a documentação está correta antes de lançá-la publicamente, publique primeiro como não listada e alterne para Público na página do item.
   > 
   > 
...
> [!TIP]
> Para fazer alterações no teste que tiver publicado, vá para o teste no estúdio AM do Azure, faça alterações e publique novamente. Por padrão, ele atualizará o conteúdo publicado existente e não criará um novo.
> 
> 
