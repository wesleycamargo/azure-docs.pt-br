...
Estas APIs podem detectar os seguintes tipos de padrões anômalos nos dados de série temporal:
...
|ProcessedData|Um dos seguintes: <ul><li>Série temporal ajustada periodicamente, caso uma sazonalidade significativa tenha sido detectada e a opção sem sazonalidade foi selecionada;</li><li>séries temporais sem tendência e ajustadas periodicamente, caso uma sazonalidade significativa tenha sido detectada e a opção sem sazonalidade e tendência foi selecionada</li><li>, do contrário, será igual a OriginalData</li>|
