...
>[AZURE.NOTE] Os procedimentos neste artigo são relevantes para serviços Web clássicos do Azure Machine Learning. Para obter informações sobre como gerenciar serviços Web no portal de serviços Web do Machine Learning, veja [Gerenciar um serviço Web usando o portal de serviços Web do Azure Machine Learning](machine-learning-manage-new-webservice.md).
...
> [AZURE.TIP] No Azure Machine Learning Studio, na guia **SERVIÇOS WEB**, você pode adicionar, atualizar ou excluir um serviço Web do Machine Learning.
