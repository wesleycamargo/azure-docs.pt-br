<properties
	pageTitle="Readaptar um serviço Web Clássico | Microsoft Azure"
...
# Readaptar um serviço Web Clássico
...
3. Programaticamente
1. Use o portal dos Serviços do BizTalk do Microsoft Azure
2. Use o portal clássico do Azure

### Adicionar um ponto de extremidade programaticamente
...
### Usar o portal dos Serviços Web do Microsoft Azure para adicionar um ponto de extremidade
...
4. Digite um nome e uma descrição para o novo ponto de extremidade. Selecione o nível de log e se os dados de exemplo estão habilitados. Para obter mais informações sobre registro em log, consulte [Habilitar o log de serviços Web de Machine Learning](machine-learning-web-services-logging.md).

### Use o Portal Clássico do Azure para adicionar um ponto de extremidade
