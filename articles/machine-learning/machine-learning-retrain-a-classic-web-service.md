...
>[AZURE.NOTE] As etapas neste passo a passo presumem que você tenha criado o serviço Web usando as etapas descritas em [Readaptar os modelos de Aprendizado de Máquina de forma programática](machine-learning-retrain-models-programmatically.md).
