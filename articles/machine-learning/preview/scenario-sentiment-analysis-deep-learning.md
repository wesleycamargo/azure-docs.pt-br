...
4.  Na caixa de pesquisa **Pesquisar modelos de projeto**, digite "Análise de Sentimento com aprendizado profundo" e selecione o modelo
5.  Clique em **Criar**

## <a name="data-description"></a>Descrição dos dados

O conjunto de dados usado para este exemplo é um conjunto de dados artesanal pequeno e está localizado na pasta Dados do [repositório do Github](https://github.com/Azure/MachineLearningSamples-SentimentAnalysis/Data).
...
1. Código: contém todo o código relacionado à análise de sentimento usando o AMLWorkbench  
2. Dados: contém o conjunto de dados usado na solução  
3. Laboratórios: contém todos os laboratórios práticos  
...
Portanto, essa solução apresenta o uso do Aprendizado profundo para realizar análise de sentimento com o Azure Machine Learning Workbench. A solução apresentada é flexível para usar o CNTK/Tensorflow como back-end com o Keras. Além disso, operacionalizamos usando modelos HDF5.
