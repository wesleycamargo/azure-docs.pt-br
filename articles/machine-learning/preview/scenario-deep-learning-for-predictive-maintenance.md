...
A Galeria de Inteligência do Cortana para o tutorial PM é um repositório de GitHub público ([https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance](https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance)) onde você pode reportar problemas e fazer contribuições.
...
* [Cenários do mundo real de manutenção preditiva](https://docs.microsoft.com/en-us/azure/machine-learning/preview/scenario-predictive-maintenance)
