...
A Galeria do Cortana Intelligence para o tutorial de PM é um repositório GitHub público ([https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance](https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance)) no qual você pode relatar problemas e dar contribuições.
...
* Uma cópia instalada do [Azure Machine Learning Workbench](./overview-what-is-azure-ml.md). Siga o [Guia de instalação de Início Rápido](./quickstart-installation.md) para instalar o programa e criar um espaço de trabalho.
...
* [Aprendizado profundo para manutenção preditiva](https://docs.microsoft.com/en-us/azure/machine-learning/preview/scenario-deep-learning-for-predictive-maintenance)
