...
1.  Clique na guia **Estúdio** na parte superior da janela.
1.	Clique em **+NOVO** na parte inferior da janela.
1.	Selecione **CONJUNTO DE DADOS**.
1.	Selecione **DO ARQUIVO LOCAL**.
1.	No diálogo **Fazer upload de um novo conjunto de dados**, clique em **Pesquisar** e localize o arquivo **german.csv** criado.
1.	Insira um nome para o conjunto de dados. Para este passo a passo, vamos chamá-lo de "Dados do cartão de crédito alemão UCI".
1.	Para tipo de dados, selecione **Arquivo CSV genérico sem cabeçalho (.nh.csv)**.
1.	Inclua uma descrição se desejar.
1.	Clique em **OK**.
...
> [AZURE.TIP] Para gerenciar conjuntos de dados que você carregou no Estúdio, clique na guia **CONJUNTOS DE DADOS** à esquerda da janela do Estúdio.
