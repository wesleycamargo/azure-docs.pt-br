...
Estes são os quatro tipos de regra com suporte: <strong>BlockList</strong> - BlockList permite fornecer uma lista de itens que você não deseja que sejam retornados nos resultados de recomendação.
