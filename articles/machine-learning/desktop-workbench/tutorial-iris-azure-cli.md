...
- Aplicativo Azure Machine Learning Workbench instalado, conforme descrito em [Início Rápido: instalar e iniciar os serviços de Aprendizado de Máquina do Azure](../service/quickstart-installation.md). 
