...
Após o recarregamento do Visual Studio, a extensão será ativada. [Saiba mais sobre como localizar extensões](h https://docs.microsoft.com/visualstudio/ide/finding-and-using-visual-studio-extensions).
