...
Neste artigo, aprenda como usar o Pacote de Aprendizado de Máquina do Azure para Visão de Computador (AMLPCV) para treinar, testar e implantar um modelo de classificação de imagem. Para uma visão geral deste pacote e sua documentação de referência detalhada, [veja aqui](https://aka.ms/aml-packages/vision).
