...
## <a name="optional-alternative-create-a-real-time-web-service-by-using-separate-commands"></a>[Alternativa opcional] Criar um serviço Web em tempo real usando comandos separados
