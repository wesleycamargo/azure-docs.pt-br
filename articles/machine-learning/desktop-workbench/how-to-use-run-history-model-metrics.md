...
Se você ainda não tiver um projeto, poderá criar um em [Criar e instalar Quickstart](../service/quickstart-installation.md). No **Painel Projeto**, você pode abrir o script **iris_sklearn.py** ( conforme mostrado).
