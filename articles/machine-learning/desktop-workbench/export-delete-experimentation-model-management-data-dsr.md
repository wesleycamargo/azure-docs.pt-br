...
>[!Note]
>**Este artigo está obsoleto.** Suporte para versões anteriores desse serviço será encerrado incrementalmente. [Exibir linha do tempo de suporte](../service/overview-what-happened-to-workbench.md#timeline). Leia o [artigo mais recente](../service/how-to-export-delete-data.md) sobre esse tópico.
