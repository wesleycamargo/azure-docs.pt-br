<properties
    pageTitle="Manage a Web service using the Azure Machine Learning Web Services portal | Microsoft Azure"
...
> [AZURE.NOTE] Os procedimentos nesta seção são relevantes para o gerenciamento de serviços Web clássicos no portal de Serviços Web do Azure Machine Learning. Para saber mais sobre como gerenciar serviços Web clássicos por meio do Machine Learning Studio e o Portal Clássico do Azure, veja [Gerenciar um espaço de trabalho de Azure Machine Learning](machine-learning-manage-workspace.md).
