<properties
	pageTitle="Como um modelo de Aprendizado de Máquina evolui de um experimento para um serviço Web operacionalizado | Microsoft Azure"
	description="Visão geral sobre a mecânica de como seu modelo de Aprendizado de Máquina do Azure evolui de um experimento de desenvolvimento para um serviço Web operacionalizado."
...
## Desenvolvimento e implantação de um serviço Web preditivo
...
| ------------------- | --------------- | ---------------------- |
|tela de experimento do Estúdio|**Navegar até o serviço Web**|configuração de serviço Web no Estúdio|
|configuração de serviço Web no Estúdio|**Exibir mais recente**|tela de experimento do Estúdio|
|configuração de serviço Web no Estúdio|**Gerenciar pontos de extremidade...**|gerenciamento de ponto de extremidade no portal do Azure|
|gerenciamento de ponto de extremidade no portal do Azure|**Editar no Estúdio**|tela de experimento do Estúdio|
...
|Teste de treinamento|**Configurar Serviço Web**|Fornece duas opções|
|&nbsp;|- **Atualizar Experimento Preditivo**|Atualiza o teste preditivo associado com as alterações feitas no teste de treinamento|
|&nbsp;|- **Treinando novamente o Serviço Web**|Converte o teste de treinamento em um teste de novo treinamento (consulte a seção "Atualizando" abaixo)|
...
|Experimento preditivo|**Implantar Serviço Web**|Implanta o experimento preditivo como um serviço Web|

**O experimento *não* contém um modelo preditivo**

Se o experimento não treinar nem pontuar um modelo preditivo, os botões do serviço Web serão mais simples:
...
1.  **Treinar novamente o modelo enquanto o serviço Web está em execução** -se você quiser treinar novamente seu modelo enquanto o serviço Web preditivo estiver em execução, poderá fazer isso fazendo algumas modificações no teste de treinamento para transformá-lo em um ***teste de novo treinamento*** e poderá implantá-lo como um ***serviço Web de novo treinamento***. Para saber mais sobre como fazer isso, consulte [Treinar novamente os modelos de Aprendizado de Máquina programaticamente](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-retrain-models-programmatically/).
...
-   convertendo o teste - [Converter um experimento de teste do Aprendizado de Máquina em um teste preditivo](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-convert-training-experiment-to-scoring-experiment/)

-   implantando o serviço Web - [Implantar um serviço Web de Aprendizado de Máquina do Azure](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-publish-a-machine-learning-web-service/).

-   treinando novamente o modelo - [Treinar novamente os modelos de Aprendizado de Máquina programaticamente](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-retrain-models-programmatically/)

Para obter exemplos do processo inteiro, consulte:

-   [Tutorial de aprendizado de máquina: Crie sua primeira experiência no Studio de Aprendizado de Máquina do Azure](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-create-experiment/)

-   [Passo a passo: Desenvolver uma solução de análise preditiva para avaliação de risco de crédito no Aprendizado de Máquina do Azure](https://azure.microsoft.com/pt-BR/documentation/articles/machine-learning-walkthrough-develop-predictive-solution/)
