<properties 
	pageTitle="Dados de exemplo nas tabelas Hive do Azure HDInsight | Azure" 
...
Se o conjunto de dados que você deseja analisar for grande, geralmente é uma boa ideia reduzir a amostra de dados para reduzi-la a um tamanho menor, porém representativo e mais gerenciável.  Isso facilita a compreensão de dados, exploração e engenharia de recursos.  Sua função no Processo de Ciência de Dados é habilitar a rápida criação de protótipos de funções de processamento de dados e modelos de aprendizado de máquina.
...
Aqui, `<taxa de amostragem, 0-1 >` especifica a proporção de registros que os usuários desejam como amostra. 
