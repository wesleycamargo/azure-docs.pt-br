...
## [O que há de novo?](machine-learning-whats-new.md)
...
#### [Usar VM do Linux](machine-learning-data-science-linux-dsvm-walkthrough.md)
### Gerenciar um espaço de trabalho
#### [Criar](machine-learning-create-workspace.md)
#### [Gerenciar](machine-learning-manage-workspace.md)
...
### [Identificar seu cenário](machine-learning-data-science-plan-sample-scenarios.md)

## Adquirir e entender os dados
...
#### [Carregar a partir das tabelas de partição do SQL](machine-learning-data-science-parallel-load-sql-partitioned-tables.md)
...
#### [Usar o SQL local](machine-learning-use-data-from-an-on-premises-sql-server.md)
...
#### [Usar Pandas](machine-learning-data-science-create-features-blob.md)
...
#### [Seleção de recursos do TDSP](machine-learning-data-science-select-features.md)
### Criar e treinar modelos
#### [Gerenciamento de ciclo de vida do experimento](machine-learning-version-control.md)
...
#### [Preparar para a implantação](machine-learning-convert-training-experiment-to-scoring-experiment.md)
#### [Usar dados externos](machine-learning-web-services-that-use-import-export-modules.md)
...
### Consumir modelos
#### [Visão geral](machine-learning-consume-web-services.md)
...
#### [Criar pool do Lote](machine-learning-dedicated-capacity-for-bes-jobs.md)
...
## [Exemplos de código](https://azure.microsoft.com/en-us/resources/samples/?service=machine-learning)
## [Módulo do PowerShell (Novo)](/powershell/module/azurerm.machinelearning)
...
## [Referência da API REST](/rest/api/machinelearning)
## [Códigos de erro do serviço da Web](machine-learning-web-service-error-codes.md)
...
## Soluções de Parceiros do Cortana Intelligence
### [Guia de publicação do Cortana Intelligence](cortana-intelligence-appsource-publishing-guide.md)
### [Ferramenta de avaliação da solução do Cortana Intelligence](cortana-intelligence-appsource-evaluation-tool.md)

## Cortana Analytics
### APIs
#### [Detecção de anomalias](machine-learning-apps-anomaly-detection-api.md)
#### [Serviços Cognitivos](https://azure.microsoft.com/services/cognitive-services/)
#### Manutenção preditiva
##### [Visão geral](cortana-analytics-playbook-predictive-maintenance.md)
