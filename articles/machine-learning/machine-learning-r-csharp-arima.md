<properties 
	pageTitle="ARIMA (Forecasting-AutoRegressive Integrated Moving Average, média móvel integrada de previsão-autorregressão) | Microsoft Azure" 
...
Este serviço aceita quatro argumentos e calcula as previsões ARIMA. Os argumentos de entrada são:
