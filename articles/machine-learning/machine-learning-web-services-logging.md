...
-	Como habilitar o log em Serviços Web:   
	-	Faça logon no [Portal de Gerenciamento do Azure](https://manage.windowsazure.com/)
...
-	Qual é o efeito de habilitar o registro em log:  
	-	Quando o Registro em Log estiver habilitado, todos os diagnósticos/erros do ponto de extremidade selecionado serão registrados na Conta de Armazenamento do Azure vinculada ao espaço de trabalho do usuário. Você pode ver essa conta de armazenamento no modo de exibição Painel do portal do Azure (parte inferior da seção Visão Rápida) do seu espaço de trabalho.  
-	Como exibir os logs:  
