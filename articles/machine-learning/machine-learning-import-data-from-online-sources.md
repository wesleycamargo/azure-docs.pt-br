---
title: Importar dados para o Estúdio de Aprendizado de Máquina de fontes de dados online | Microsoft Docs
...
> [!NOTE]
> Este artigo fornece informações gerais sobre o módulo [Import Data][import-data] \(Importar Dados). Para obter informações mais detalhadas sobre os tipos de dados que você pode acessar, formatos, parâmetros e respostas a perguntas comuns, consulte o tópico de referência do módulo [Importar Dados][import-data].
> 
> 
