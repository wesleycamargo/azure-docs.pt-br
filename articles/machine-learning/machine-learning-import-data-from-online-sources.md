...
> [AZURE.NOTE] Este artigo fornece informações gerais sobre o módulo [Importar Dados][import-data]. Para saber mais sobre os tipos de dados que você pode acessar, formatos, parâmetros e respostas para perguntas comuns, consulte o tópico de referência do módulo [Importar Dados][import-data].
...
O módulo **Importar Dados** do Aprendizado de Máquina dá suporte às seguintes fontes de dados:
