<properties 
	pageTitle="Personalizar clusters Hadoop para o Processo de Ciência de Dados de Equipe | Microsoft Azure" 
...
O menu abaixo vincula-se ao tópicos que descrevem como configurar os diversos ambientes de ciência de dados usados pelo TDSP (Processo de Ciência de Dados de Equipe).
...
>[AZURE.NOTE] O nome de usuário e senha para o acesso remoto não são os mesmos usados ao criar o cluster do Hadoop. Eles são um conjunto separado de credenciais. Além disso, a data de validade do acesso remoto deve estar dentro de 7 dias a partir da data atual.
