...
## <a name="a-nameshutdownashutdown-and-de-allocate-virtual-machine-when-not-in-use"></a><a name="shutdown"></a>Desligar e desalocar a máquina virtual quando ela não estiver em uso
