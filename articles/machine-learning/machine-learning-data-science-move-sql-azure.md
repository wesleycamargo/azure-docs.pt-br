...
<b>FONTE</b> |<b>DESTINO: Banco de dados SQL Azure</b> |
-------------- |--------------------------------|
<b>Arquivo simples (CSV ou TSV formatado)</b> |<a href="#bulk-insert-sql-query">Consulta SQL de inserção em massa |
<b>SQL Server local no local</b> | 1\. <a href="#export-flat-file">Exportar para arquivo simples<br> 2. <a href="#insert-tables-bcp">Assistente de Migração de Banco de Dados SQL<br> 3. <a href="#db-migration">Backup e restauração de banco de dados<br> 4. <a href="#adf">Azure Data Factory |
...
* Acesso a um **Banco de dados SQL do Azure**. Se você deve configurar um banco de dados do SQL Azure, o [Guia de Introdução ao Banco de Dados SQL do Microsoft Azure](sql-database-get-started.md) fornece informações sobre como provisionar uma nova instância de um banco de dados do SQL Azure.
...
O procedimento para mover dados para um banco de dados SQL do Azure com o Azure Data Factory (ADF) é fornecido no tópico [Mover dados de um SQL Server local para o SQL Azure com o Azure Data Factory](machine-learning-data-science-move-sql-azure-adf.md). Este tópico mostra como mover dados de um banco de dados do SQL Server local para um banco de dados SQL do Azure por meio do armazenamento de blob do Azure usando o ADF.
