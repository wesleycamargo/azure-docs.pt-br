...
> [!NOTE]
> Este guia destina-se à versão 1 da API. Para a versão 2, [**confira este documento**](../cognitive-services/cognitive-services-text-analytics-quick-start.md). A versão 2 agora é a versão preferencial desta API.
> 
> 
