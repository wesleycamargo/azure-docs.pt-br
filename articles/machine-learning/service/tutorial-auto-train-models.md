...
Para sua conveniência, este tutorial está disponível como um [Jupyter Notebook](https://aka.ms/aml-notebook-tut-03). Execute o Notebook `03.auto-train-models.ipynb` em Azure Notebooks ou em seu próprio servidor de Jupyter Notebook.
