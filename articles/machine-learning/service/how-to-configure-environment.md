...
* **Baixe o arquivo**: No [portal do Azure](https://ms.portal.azure.com), selecione **baixar config** do **visão geral** seção do seu espaço de trabalho.
