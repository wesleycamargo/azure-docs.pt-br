...
Use o [portal do Azure](https://portal.azure.com) para começar a usar o Azure Notebooks.  Abra seu espaço de trabalho e para o **visão geral** seção, selecione **Introdução ao Azure Notebooks**.
