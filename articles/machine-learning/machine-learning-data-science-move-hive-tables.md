...
Você também pode usar o console de consulta (Editor de Hive) digitando uma URL do formulário *nome do cluster https://&#60;Hadoop>.azurehdinsight.net/Home/HiveEditor* em um navegador da Web. Você precisa estar conectado ao console, de forma que precisa de suas credenciais do cluster do Hadoop aqui.
