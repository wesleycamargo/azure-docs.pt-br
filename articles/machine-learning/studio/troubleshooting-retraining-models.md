---
title: Solução de problemas ao treinar novamente um serviço Web clássico do Machine Learning Studio
titleSuffix: Azure Machine Learning Studio
description: Identifique e corrija os problemas comuns encontrados quando você está readaptando o modelo para um serviço Web do Azure Machine Learning Studio.
