...
A **Página de dicas úteis do algoritmo para Microsoft Azure Machine Learning Studio** ajuda a escolher o melhor algoritmo de aprendizado de máquina para suas soluções de análise preditiva na biblioteca de algoritmos do Azure Machine Learning Studio.
...
| [rede neural](https://msdn.microsoft.com/library/azure/dn905947.aspx) |● | | |9 |[A personalização adicional é possível](https://go.microsoft.com/fwlink/?LinkId=402867) |
...
| [rede neural](https://msdn.microsoft.com/library/azure/dn906030.aspx) |● | | |9 |[A personalização adicional é possível](https://go.microsoft.com/fwlink/?LinkId=402867) |
...
| [rede neural](https://msdn.microsoft.com/library/azure/dn905924.aspx) |● | | |9 |[A personalização adicional é possível](https://go.microsoft.com/fwlink/?LinkId=402867) |
...
E para as pessoas brilhantes que desejam [especificar sua própria estrutura de rede](https://go.microsoft.com/fwlink/?LinkId=402867), as possibilidades são inesgotáveis.
...
Os métodos Bayesianos possuem uma qualidade altamente desejável: eles evitam o superajuste. Eles fazem isso fazendo algumas suposições com antecedência sobre a distribuição provável da resposta. Outro subproduto dessa abordagem é que eles têm muito poucos parâmetros. O Azure Machine Learning Studio tem dois algoritmos Bayesianos para classificação ([computador do ponto de Bayes de duas classes](https://msdn.microsoft.com/library/azure/dn905930.aspx)) e regressão ([regressão linear Bayesiana](https://msdn.microsoft.com/library/azure/dn906022.aspx)).
...
O Azure Machine Learning Studio também inclui acesso a uma poderosa estrutura de aprendizado de máquina sob o título de [Vowpal Wabbit](https://msdn.microsoft.com/library/azure/8383eb49-c0a3-45db-95c8-eb56a1fef5bf).
