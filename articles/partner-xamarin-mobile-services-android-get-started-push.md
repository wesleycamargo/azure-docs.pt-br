...
* [Introdução à autenticação](partner-xamarin-mobile-services-android-get-started-users.md) <br/>Saiba como autenticar usuários de seu aplicativo com diferentes tipos de contas usando os Serviços Móveis.
...
<!-- URLs. -->
[Introdução aos Serviços Móveis]: partner-xamarin-mobile-services-ios-get-started.md
[Adicionar os Serviços Móveis a um aplicativo existente]: partner-xamarin-mobile-services-android-get-started-data.md
