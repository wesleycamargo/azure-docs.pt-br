...
5.  Acesse a página de configuração Hudson: Clique no **Gerenciar o Hudson** e, em seguida, clique em **Configurar sistema**.
6.  Configure o JDK conforme mostrado abaixo:

    ![Configuração do Hudson][Configuração do Hudson]
...
Para obter informações adicionais sobre o Hudson, consulte <http://hudson-ci.org></a>.
...
Para obter mais informações sobre o Liferay, consulte [][1]<http://www.liferay.com></a>.

  [Introdução aos sites do Azure e ao Java]: ../web-sites-java-get-started
