...
![Listar recursos do Blockchain Workbench](media/blockchain-workbench-database-firewall/list-database-resources.png)
...
3. Para criar uma regra para a sua organização:
   ...
   * Insira um endereço IP para o **IP FINAL** do intervalo de endereços
   ...
   ![Criar uma regra de firewall](media/blockchain-workbench-database-firewall/create-firewall-rule.png)
