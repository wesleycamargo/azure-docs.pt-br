...
![Falhas, contagens de solicitação e resposta do servidor](./media/app-insights-java-track-http-requests/5-results.png)
 

Clique em qualquer gráfico para ver métricas mais detalhadas.

![Contagens de solicitação por nome](./media/app-insights-java-track-http-requests/6-barchart.png)
...
![Todos os rastreamentos para esta solicitação](./media/app-insights-java-track-http-requests/7-instance.png)
...
![Sessões, usuários e modos de exibição de página](./media/appinsights/appinsights-47usage-2.png)
...
![Exemplo de teste da Web](./media/appinsights/appinsights-10webtestresult.png)
