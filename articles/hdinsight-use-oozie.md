<properties linkid="hdinsight-use-oozie-with-hdinsight" urlDisplayName="Usar o Oozie com o HDInsight" pageTitle="Usar o Oozie com o HDInsight | Azure" metaKeywords="" description="Usar o Oozie com o HDInsight, uma solução big data. Saiba como definir um fluxo de trabalho Oozie e enviar um trabalho Oozie." metaCanonical="" services="hdinsight" documentationCenter="" title="Usar o Oozie com o HDInsight" authors="jgao" solutions="" manager="paulettm" editor="cgronlun" />
...
> [WACOM.NOTE] Este tutorial funciona na versão 2.1 e 3.0. do cluster HDInsight. Este artigo ainda não foi testado no emulador do HDInsight.
...
1. Crie um arquivo de texto com o seguinte conteúdo:
	...
	<tr><td>${jobTracker}</td><td>Especifique o URL do controlador do trabalho do hadoop. Use <strong>jobtrackerhost:9010</strong> no cluster HDInsight versão 2.0 e 3.0.</td></tr>
	<tr><td>${nameNode}</td><td>Especifique o URL do namenode do hadoop. Use o endereço WASB do sistema de arquivos padrão. Por exemplo, <i>wasb: //&lt;containerName&gt;@&lt;storageAccountName&gt;.blob.core.windows.net</i>.</td></tr>
...
- Copie o armazenamento de Blob do Azure do script HiveQL (useoozie.hql), wasb:///tutorials/useoozie/useoozie.hql.
...
3. Copie o seguinte script no painel de script e, em seguida, defina as primeiras dez (ignore a 6ª, $storageUri). 
...
5. Acrescente o seguinte ao script. Esta parte cria e inicia um trabalho do Oozie:	
