...
Depois de criar uma máquina virtual, anexe um disco de dados. O disco fornece o armazenamento de dados necessário quando você instala o MySQL. Consulte [Como anexar um disco de dados para uma máquina virtual do Windows](http://azure.microsoft.com/pt-br/documentation/articles/storage-windows-attach-disk/) e siga as instruções para anexar um disco vazio.
