...
Inserir um novo item em uma tabela de dados. Um id (um GUID da cadeia de caracteres do tipo) é criada automaticamente como a chave primária para a nova linha. Chame o método [done][done] no objeto [Promise][done] retornado para obter uma cópia do objeto inserido e manipular os erros.
...
Atualizar uma linha em uma tabela de dados. Neste código, o item será removido da lista quando o serviço móvel responder. Chame o método [done][done] no objeto [Promise][done] retornado para obter uma cópia do objeto inserido e manipular os erros.
...
Exclua uma linha em uma tabela de dados usando o método **del**. Chame o método [done][done] no objeto [Promise][done] retornado para obter uma cópia do objeto inserido e manipular os erros.
