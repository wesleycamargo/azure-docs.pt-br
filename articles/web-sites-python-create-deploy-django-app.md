<properties linkid="develop-python-web-site-with-django" urlDisplayName="Sites com Django" pageTitle="Sites Python com Django - tutorial do Azure" metaKeywords="django do Azure, site django" description="Um tutorial que apresenta a execução de um site Python no Azure." metaCanonical="" services="web-sites" documentationCenter="Python" title="Criando Sites com Django" authors=""  solutions="" writer="" manager="" editor=""  />
...
**Observação**: os Sites do Azure agora têm o Python 2.7 e o manipulador wfastcgi já instalados.  No entanto, as estruturas da web, como Django, não estão incluídas.  Se preferir, você ainda pode usar um intérprete de Python diferente.  Basta incluí-lo no repositório Git e configurar o site para usar esse intérprete em vez do intérprete Python 2.7 já instalado.
...
**Observação**: publicação do TFS atualmente não é suportada em projetos de Python.
...
A primeira etapa na criação de seu aplicativo é criar o site através do Portal de Gerenciamento do Azure.  Para fazer isso, você precisará fazer logon no portal e clicar no botão NOVO no canto inferior esquerdo. Uma janela será exibida. Clique em **Criação Rápida**, digite um URL e selecione **Criar Site**
...
Agora que você criou seu repositório Git no Azure, você começará a preenchê-lo com o site do computador local.  A primeira etapa é clonar o site vazio existente utilizando o url fornecido:
...
1.  Incluir a biblioteca de Django e outras bibliotecas que você usará para executar o site.
...
Depois de fazer o envio, você verá a atualização do portal do Azure e exibirá a implantação ativa:
...
Seu aplicativo pode ter dependências além de Python e Django.  Se você instalou o Python usando o instalador em [http://www.windowsazure.com/pt-br/develop/python/](http://www.windowsazure.com/pt-br/develop/python/), você já terá PIP instalado e pode usá-lo para adicionar rapidamente novas dependências.  Por exemplo, para instalar o Kit de ferramentas de linguagem Natural e todas as suas dependências, digite:
...
Depois de copiar os arquivos, execute o comando **status git** para ver os arquivos recentemente adicionados, e **adicionar git** seguido de **confirmar git** para confirmar as alterações no repo.  Por fim, você pode fazer um **envio git**, que implementa o site atualizado no Azure.
