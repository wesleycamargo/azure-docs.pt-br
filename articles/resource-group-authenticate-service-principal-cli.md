...
1. Crie uma entidade de serviço para seu aplicativo. Forneça um nome de exibição, URI para uma página que descreve o aplicativo, URIs que identificam seu aplicativo e senha para a identidade do aplicativo. Este comando cria o aplicativo do AD e a entidade de serviço.
...
2. Conceda à entidade de serviço permissões em sua assinatura. Neste exemplo, você adiciona a entidade de serviço à função **Leitor**, que concede permissão para ler todos os recursos na assinatura. Para ver outras funções, consulte [RBAC: funções internas](./active-directory/role-based-access-built-in-roles.md). Para ver o parâmetro **ServicePrincipalName**, forneça o **ObjectId** que você usou ao criar o aplicativo.
...
1. Crie uma entidade de serviço para seu aplicativo. Forneça um nome de exibição, URI para uma página que descreve o aplicativo, URIs que identificam seu aplicativo e dados do certificado copiados. Este comando cria o aplicativo do AD e a entidade de serviço.
