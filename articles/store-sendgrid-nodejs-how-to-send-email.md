...
Algumas propriedades de email podem ser substituídas usando **set*Property*** ou acrescentado usando **add*Property***. Por exemplo, você pode adicionar destinatários adicionais ao usar
