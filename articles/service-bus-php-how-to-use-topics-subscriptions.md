...
-   [Como: Criar uma assinatura][Como: Criar uma assinatura]
...
## <span id="ConfigureApp"></span></a>Configurar seu aplicativo para usar o Service Bus
...
## <span id="CreateTopic"></span></a>Como: Criar um tópico

Você pode executar operações de gerenciamento de tópicos do Service Bus por meio da classe
**ServiceBusRestProxy**. Um objeto **ServiceBusRestProxy** é
...
## <span id="CreateSubscription"></span></a>Como: Criar uma assinatura
...
O exemplo abaixo cria uma assinatura denominada 'HighMessages' com um **SqlFilter** que seleciona apenas as mensagens que tenham uma propriedade **MessageNumber** personalizada maior que 3 (consulte [Como: enviar mensagens para um tópico][Como: enviar mensagens para um tópico] para obter mais informações sobre adicionar propriedades a mensagens):
...
De maneira semelhante, o exemplo a seguir cria uma assinatura denominada "LowMessages" com um SqlFilter que seleciona apenas as mensagens que tenham uma propriedadeMessageNumber menor ou igual a 3:
...
## <span id="SendMessage"></span></a>Como: enviar mensagens para um tópico

Para enviar uma mensagem a um tópico de Service Bus, seu aplicativo chamará o método **ServiceBusRestProxy-\>sendTopicMessage**. O código abaixo demonstra como enviar uma mensagem ao tópico `mytopic` que criamos acima no namespace de serviço
`MySBNamespace`.
...
## <span id="ReceiveMessages"></span></a>Como: Receber mensagens de uma assinatura
...
## <span id="DeleteTopicsAndSubscriptions"></span></a>Como excluir tópicos e assinaturas
