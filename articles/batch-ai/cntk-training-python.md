---
title: Treinar um modelo do CNTK com IA do Lote do Azure - Python | Microsoft Docs
description: Treinar uma rede neural do Microsoft Cognitive Toolkit (CNTK) com a IA do Lote do Azure usando o SDK do Python
services: batch-ai
...
Este artigo mostra como usar o SDK do Python do Azure para treinar um modelo do Microsoft Cognitive Toolkit (CNTK) de exemplo usando o serviço IA do Lote.
...
Os trabalhos e os clusters da IA do Lote são recursos do Azure e devem ser colocados em um grupo de recursos do Azure. O snippet a seguir cria um grupo de recursos:
...
Para saber mais sobre como usar a IA do Lote com estruturas diferentes, confira as [receitas de treinamento](https://github.com/Azure/BatchAI).