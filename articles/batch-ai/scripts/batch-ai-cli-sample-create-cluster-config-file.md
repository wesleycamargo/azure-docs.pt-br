...
ms.locfileid: "53407806"
---
# <a name="cli-example-create-a-batch-ai-cluster-using-a-cluster-configuration-file"></a>Exemplo de CLI: Criar um cluster de IA do Lote usando um arquivo de configuração do cluster
