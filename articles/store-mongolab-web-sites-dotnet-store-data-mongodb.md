<properties linkid="develop-net-tutorials-website-with-mongodb-mongolab" urlDisplayName="Site com MongoDB no MongoLab" pageTitle="Criar um site que usa o MongoDB no MongoLab (.NET)" metaKeywords="" description="Saiba como criar um site do Azure que armazena dados no MongoDB hospedado pelo MongoLab." metaCanonical="" services="web-sites" documentationCenter=".NET" title="Criar um aplicativo C# ASP.NET no Azure com o MongoDB usando o complemento MongoLab" authors="" solutions="" manager="" editor="" />
...
1. [Criar o aplicativo][create] - será um aplicativo simples C# ASP.NET MVC para fazer anotações.
1. [Implantar o aplicativo][deploy] - Com a associação de alguns ganchos de configuração, o envio por push do nosso código será moleza.
...
Para obter mais informações sobre como utilizar o driver C# do MongoDB, verifique o [CSharp Driver QuickStart](http://www.mongodb.org/display/DOCS/CSharp+Driver+Quickstart "CSharp Driver Quickstart") em mongodb.org.
...
### Criar um novo site e obter o arquivo de configurações de publicação
...
![Publicar][dialog-mongolab-vspublish]
