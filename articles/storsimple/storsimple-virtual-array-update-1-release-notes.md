...
| 4 |Atualização| Houve um problema com a atualização na versão anterior que resultava em falhas de backup no local do cliente. Esse problema foi corrigido nesta versão.|
