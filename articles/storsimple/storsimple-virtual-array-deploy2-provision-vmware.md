---
title: "Implantar a Matriz Virtual do Microsoft Azure StorSimple - Provisão no VMware | Microsoft Docs"
...
Este tutorial descreve como provisionar e conectar-se a uma StorSimple Virtual Array em um sistema de host que executa VMware ESXi 5.5 e superior. Este artigo se aplica à implantação de Matrizes Virtuais StorSimple no portal do Azure, bem como na Nuvem de Governo do Microsoft Azure.
...
Os pré-requisitos para provisionar um dispositivo virtual em um sistema de host que executa o VMware ESXi 5.5 e posterior, são os seguintes.
...
* Você revisou os requisitos de rede para implantar um dispositivo virtual StorSimple e configurou a rede de datacenter de acordo com os requisitos. Para obter mais informações, veja [Requisitos do sistema da Matriz Virtual StorSimple](storsimple-virtual-array-system-requirements.md).
...
18. Na página **Versão da Máquina Virtual**, selecione **Versão da Máquina Virtual: 8**. Todas as versões de 8 a 11 têm suporte.
