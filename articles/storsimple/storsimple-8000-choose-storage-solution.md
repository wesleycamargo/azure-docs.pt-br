...
Este documento fornece uma visão geral das opções de transferência de dados no local para o Azure, comparando: Série Data Box Edge vs Sincronização de Arquivos do Azure (AFS) vs StorSimple série 8000.
...
|Preços          |[Preço do StorSimple](https://azure.microsoft.com/pricing/details/storsimple/) |[Preço do AFS](https://azure.microsoft.com/pricing/details/storage/files/)  |[Preços do Azure Data Box Edge](https://azure.microsoft.com/pricing/details/storage/databox/edge/)  |

## <a name="next-steps"></a>Próximas etapas

- Saiba mais sobre [Azure Data Box Edge](/azure/databox-online/data-box-edge-overview.md) e [Gateway de Caixa de Dados do Azure](/azure/databox-online/data-box-gateway-overview.md)
- Saiba mais sobre a [Sincronização de arquivos do Azure](/azure/storage/files/storage-sync-files-deployment-guide.md)