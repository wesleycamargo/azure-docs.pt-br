...
#### [Failover e DR](storsimple-ova-failover-dr.md)
#### [Desativar e excluir](storsimple-ova-deactivate-and-delete-device.md)
#### [Monitorar o painel de serviço](storsimple-ova-service-dashboard.md)
#### [Alterar a senha de dispositivo](storsimple-ova-change-device-admin-password.md)
#### [Gerenciar ACRs](storsimple-ova-manage-acrs.md)
#### [Gerenciar contas de armazenamento](storsimple-ova-manage-storage-accounts.md)
#### [Gerenciar trabalhos](storsimple-ova-manage-jobs.md)
#### [Configurar o MPIO no host do Windows Server](storsimple-ova-configure-mpio-windows-server.md)
### [Configurar via Interface de usuário da Web local](storsimple-ova-web-ui-admin.md)

## Notas de versão
### [Atualização 0.3 – atual](storsimple-ova-update-03-release-notes.md)
...
### [Considerações de segurança](storsimple-security.md)
...
#### [Usar o Windows PowerShell for StorSimple](storsimple-windows-powershell-administration.md)
...
#### [Instalar a Atualização 2.2](storsimple-install-update-21.md)
#### [Instalar a Atualização 2](storsimple-install-update-2.md)
#### [Instalar a Atualização 1.2](storsimple-install-update-1.md)
...
## Referência
### [Referência de cmdlet do Azure PowerShell](https://msdn.microsoft.com/en-us/library/azure/dn920427)
### [Referência de cmdlet do Windows PowerShell for StorSimple](https://technet.microsoft.com/library/dn688168.aspx)

# [StorSimple 5000-7000 Series](http://onlinehelp.storsimple.com)

# Recursos
## [Blog do Azure](https://azure.microsoft.com/blog/)
## [Fóruns](https://social.msdn.microsoft.com/Forums/azure/home?forum=StorSimple)
