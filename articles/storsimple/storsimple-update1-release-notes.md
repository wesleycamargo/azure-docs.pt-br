...
| 2 |Redefinição de fábrica |Em alguns casos, quando você executou uma redefinição de fábrica, o dispositivo StorSimple travava e exibia esta mensagem: **Redefinição de fábrica está em andamento (fase 8)**. Isso acontecia se você pressionasse CTRL+C enquanto o cmdlet estava em andamento. Agora esse bug foi corrigido. |Atualização 1 |Sim |Não  |
