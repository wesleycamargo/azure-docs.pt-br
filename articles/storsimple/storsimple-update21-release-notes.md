...
A Atualização 2.1 pode ser aplicada a qualquer dispositivo do StorSimple que executa a Versão (GA) ou a Atualização 0.1 à 2. A versão do dispositivo associada à Atualização 2.1 é 6.3.9600.17704.
