<properties 
   pageTitle="Use o serviço StorSimple Manager para administrar o seu dispositivo StorSimple"
   description="Gerencie seu dispositivo StorSimple usando o serviço StorSimple Manager no Portal de Gerenciamento do Azure."
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
...
|Configurar o gerenciamento remoto|Serviço StorSimple Manager → Dispositivos → Configurar|[Conectar remotamente ao seu dispositivo StorSimple](https://msdn.microsoft.com/library/azure/dn772393.aspx)|
