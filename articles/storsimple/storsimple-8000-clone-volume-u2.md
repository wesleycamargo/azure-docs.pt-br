...
4. Navegue de volta para o **Catálogo de Backup** e selecione um volume em um conjunto de backup. Clique com botão direito do mouse e, no menu de contexto, selecione **Clonar**.
