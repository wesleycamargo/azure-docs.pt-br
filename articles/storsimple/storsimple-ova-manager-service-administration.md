---
title: Administração da Matriz Virtual do StorSimple Manager | Microsoft Docs
...
---
# <a name="use-the-storsimple-manager-service-to-administer-your-storsimple-virtual-array"></a>Usar o serviço StorSimple Manager para administrar o StorSimple Virtual Array
...
## <a name="connect-to-the-storsimple-manager-service"></a>Conectar-se ao serviço StorSimple Manager
...
## <a name="navigate-the-storsimple-manager-service-ui"></a>Navegue para a interface do usuário do serviço StorSimple Manager
...
## <a name="use-the-storsimple-manager-service-to-perform-management-tasks"></a>Usar o serviço StorSimple Manager para executar tarefas de gerenciamento
...
| --- | --- | --- |
| Criar um serviço</br>Excluir um serviço</br>Obtenha a chave de registro do serviço</br>Regenerar a chave de registro do serviço |Serviço StorSimple Manager |[Implantar o serviço StorSimple Manager](storsimple-ova-manage-service.md) |
...
| Instalar as atualizações do software |Serviço StorSimple Manager → Dispositivos → Manutenção |[Atualizar a Matriz Virtual](storsimple-ova-install-update-01.md) |
