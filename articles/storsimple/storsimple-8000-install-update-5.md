...
> * É altamente recomendável que, ao atualizar um dispositivo executando versões anteriores à Atualização 3, você instala as atualizações usando o método de hotfix. Para ajudar o Suporte a orientá-lo durante a atualização, [registre um tíquete de suporte](storsimple-8000-contact-microsoft-support.md).
