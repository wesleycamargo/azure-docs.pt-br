...
> [AZURE.NOTE]Os IPs de controladores fixos precisarão ser reconfigurados por meio da página Configurar do dispositivo StorSimple no Portal de Gerenciamento do Azure. Para obter mais informações, vá para [Modificar a interface de rede por meio da página Configurar (dispositivo)](storsimple-modify-device-config.md#modify-network-interfaces).
