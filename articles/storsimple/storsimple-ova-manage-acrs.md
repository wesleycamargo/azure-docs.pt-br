...
---
# <a name="use-storsimple-manager-to-manage-access-control-records-for-storsimple-virtual-array"></a>Usar o StorSimple Manager para gerenciar os registros de controle de acesso para o StorSimple Virtual Array
