...
## <a name="what-is-disaster-recovery"></a>O que é recuperação de desastre?
...
### <a name="dr-prechecks"></a>Pré-verificações para recuperação de desastre
...
2. Na página **Dispositivos**, selecione o dispositivo de origem para o failover e clique em **Desativar**. 
