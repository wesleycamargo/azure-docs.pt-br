...
3. Defina uma **Agenda de Largura de Banda**. Para criar uma agenda:
   ...
   4. Na lista suspensa, selecione uma **Hora de Término**. Essa é a hora em que a agenda será encerrada.
      ...
      > [!NOTE]
      > Os agendamentos sobrepostos não são permitidos. Se as horas de início e término resultarem em um agendamento sobreposto, você verá uma mensagem de erro sobre isso.
      > 
      > 
