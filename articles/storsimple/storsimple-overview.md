...
Leia a [Visão geral das soluções StorSimple](http://www.microsoft.com/pt-br/server-cloud/products/storsimple/resources.aspx) e veja a [explicação sobre o StorSimple](http://www.microsoft.com/pt-br/server-cloud/products/storsimple/Features.aspx).
