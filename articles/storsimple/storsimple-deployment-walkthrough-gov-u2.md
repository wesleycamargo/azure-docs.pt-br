...
| [Etapa 3: Configurar e registrar o dispositivo por meio do Windows PowerShell para StorSimple](step 3-configure-and-register-the-device-through-windows-powershell-for-storsimple.md) |Conecte o dispositivo à sua rede e registre-o com o Azure para concluir a instalação usando o serviço de gerenciamento. |
...
[!INCLUDE [Use o PuTTY para conectar-se ao console serial do dispositivo](../../includes/storsimple-use-putty.md)]
...
[!INCLUDE [Criar um backup manual](../../includes/storsimple-get-iqn.md)]
...
[!INCLUDE [Criar um backup manual](../../includes/storsimple-create-manual-backup-gov.md)]
