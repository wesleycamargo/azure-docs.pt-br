<properties urlDisplayName="HDInsight Hadoop Version" pageTitle="O que há de novo nas versões de cluster Hadoop do HDInsight? | Azure" metaKeywords="hdinsight, hadoop, hdinsight hadoop, hadoop azure" description="O HDInsight dá suporte a várias versões de cluster Hadoop implantáveis a qualquer momento. Consulte as versões de distribuição com suporte do Hadoop e do HortonWorks Data Platform (HDP)." services="hdinsight" umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" title="What's new in the cluster versions provided by HDInsight?" authors="bradsev" />
...
Consulte [Notas de versão do HDInsight](http://azure.microsoft.com/pt-br/documentation/articles/hdinsight-release-notes/) para ver as notas de versão adicionais sobre as versões mais recentes do HDInsight.
...
- **Suporte à Rede Virtual**:Os clusters do HDInsight podem ser usados com a Rede Virtual do Azure para dar suporte ao isolamento de recursos de nuvem ou a cenários híbridos que vinculam os recursos de nuvem àqueles em seu datacenter.
...
* Depois que o suporte expirar para uma determinada versão, ele poderá não estar disponível pelo portal de gerenciamento do Azure. A tabela a seguir indica quais versões estão disponíveis no portal de gerenciamento do Azure. As versões dos clusters continuarão disponíveis ao usar o parâmetro `Version` no comando [New-AzureHDInsightCluster](http://msdn.microsoft.com/pt-br/library/dn593744.aspx) do PowerShell e no SDK do .NET até a data de reprovação. 
...
<tr><td>HDI 3.0</td><td>HDP 2.0</td><td>Sim</td><td>11/2/2014</td><td>Sim</td><td>17/9/2014</td><td>30/6/2015</td></tr>
<tr><td>HDI 2.1</td><td>HDP 1.3</td><td>Sim</td><td>28/10/2013</td><td>Não</td><td>12/5/2014</td><td>31/5/2015</td></tr>
<tr><td>HDI 1.6</td><td>HDP 1.1</td><td>Não</td><td>28/10/2013</td><td>Não</td><td>26/4/2014</td><td>31/5/2015</td></tr>
</table><br>
...
> [WACOM.NOTE] Os clusters do HDInsight 2.1 e do 3.0 são executados em sistemas operacionais convidados do Azure da [família 4],(http://msdn.microsoft.com/pt-br/library/azure/ee924680.aspx#explanation) que usam a versão de 64 bits do Windows Server 2012 R2 e dão suporte ao .NET Framework 4.0, 4.5. e 4.5.1. 

## Notas de versão da Hortonworks associadas a versões do HDInsight
...
[wa-forums]: http://azure.microsoft.com/pt-br/support/forums/
