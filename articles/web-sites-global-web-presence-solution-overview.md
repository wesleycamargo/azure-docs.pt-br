<properties urlDisplayName="Create a Global Web Presence on Azure Websites" pageTitle="Crie uma presença Global na Web em Sites Azure" metaKeywords="" description="Este guia fornece uma visão geral técnica de como hospedar o site da sua organização (.COM) em sites do Azure. Isso inclui implantação, domínios personalizados, SSL e monitoramento." metaCanonical="http://www.windowsazure.com/pt-br/documentation/articles/web-sites-global-web-presence-solution-overview/" services="" documentationCenter="" title="Create a Global Web Presence on Azure Websites" authors="jroth" solutions="" manager="wpickett" editor="mollybos" />
