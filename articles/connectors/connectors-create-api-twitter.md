...
> [!INCLUDE [Etapas para criar uma conexão com o Twitter](../../includes/connectors-create-api-twitter.md)]
> 
> 
...
3. Selecione o controle **Escolher um valor**. Nesse controle, é possível selecionar uma ou mais propriedades de quaisquer ações ou gatilhos anteriores como o valor cuja condição será avaliada como verdadeira ou falsa.  
...
8. Digite 50 como o operando para o operador *é maior que*. Agora a condição está adicionada. Salve seu trabalho usando o link **Salvar** no menu acima.  
