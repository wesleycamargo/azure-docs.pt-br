...
As informações sobre como criar uma API que permita a assinatura de webhook podem ser encontradas [neste artigo sobre como criar conectores de Aplicativo Lógico](../logic-apps/logic-apps-create-api-app.md).
