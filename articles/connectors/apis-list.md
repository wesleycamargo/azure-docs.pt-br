...
| Conectores |  |  |  |
| --- | --- | --- | --- |
|[![API Icon][API/Web-Appicon]<br/>**API/Aplicativo Web**][API/Web-Appdoc]|![Ícone de API][appFiguresicon]<br/>**appFigures**|![Ícone de API][Asanaicon]<br/>**Asana**|![Ícone de API][Azure-DocumentDBicon]<br/>**Azure DocumentDB**|
|![Ícone de API][Azure-MLicon]<br/>**Azure ML**|[![API Icon][Azure~Functionsicon]<br/>**Azure<br/>Functions**][Azure~Functionsdoc]|[![API Icon][AzureBlobStorageicon]<br/>**Armazenamento de Blobs<br/>do Azure**][AzureBlobStoragedoc]|![Ícone de API][Basecamp-3icon]<br/>**Basecamp 3**|
...
|![Ícone de API][Campfireicon]<br/>**Campfire**|![Ícone de API][Cognitive-Services~Text-Analyticsicon]<br/>**Serviços Cognitivos<br/>Análise de Texto**|![Ícone de API][Common-Data~Serviceicon]<br/>**Common Data<br/>Service**|[![API Icon][DB2icon]<br/>**DB2**][db2doc]|
|[![API Icon][Delayicon]<br/>**Atraso**][Delaydoc]|[![API Icon][Dropboxicon]<br/>**Dropbox**][dropboxdoc]|[![API Icon][Dynamics-365icon]<br/>**Dynamics 365**][Dynamics-365doc]|![Ícone de API][Dynamics-365~for-Financialsicon]<br/>**Dynamics 365<br/>para Finanças**|
|![Ícone de API][Dynamics-365~for-Operationsicon]<br/>**Dynamics 365<br/>para Operações**|![Ícone de API][Easy-Redmineicon]<br/>**Easy Redmine**|[![API Icon][Facebookicon]<br/>**Facebook**][Facebookdoc]|[![API Icon][FTPicon]<br/>**FTP**][FTPdoc]|
|![Ícone de API][GitHubicon]<br/>**GitHub**|![Ícone de API][Google-Calendaricon]<br/>**Google Agenda**|[![API Icon][Google-Driveicon]<br/>**Google Drive**][Google-Drivedoc]|![Ícone de API][Google-Sheetsicon]<br/>**Google Sheets**|
|![Ícone de API][Google-Tasksicon]<br/>**Google Tasks**|![Ícone de API][HideKeyicon]<br/>**HideKey**|![Ícone de API][HipChaticon]<br/>**HipChat**|[![API Icon][HTTPicon]<br/>**HTTP**][HTTPdoc]|
|[![API Icon][HTTP-Swaggericon]<br/>**HTTP Swagger**][http-swaggerdoc]|[![API Icon][HTTP~Requesticon]<br/>**Solicitação<br/>HTTP**][HTTP~Requestdoc]|[![API Icon][HTTP~Responseicon]<br/>**Resposta<br/>HTTP**][HTTP~Responsedoc]|[![API Icon][Informixicon]<br/>**Informix**][Informixdoc]|
...
|[![API Icon][MailChimpicon]<br/>**MailChimp**][MailChimpdoc]|![Ícone de API][Mandrillicon]<br/>**Mandrill**|[![API Icon][Microsoft-Translatoricon]<br/>**Microsoft<br/>Translator**][Microsoft-Translatordoc]|![Ícone de API][MQicon]<br/>**MQ**|
|[![API Icon][Nested~Logic-Appicon]<br/>**Aplicativo<br/>lógico aninhado**][Nested~Logic-Appdoc]|[![API Icon][Office-365~Outlookicon]<br/>**Office 365<br/>Outlook**][office365-outlookdoc]|[![API Icon][Office-365~Usersicon]][office365-usersdoc]<br/>**Office 365<br/>Usuários**|[![API Icon][Office-365~Videoicon]<br/>**Office 365<br/>Vídeo**][office365-videodoc]|
|[![API Icon][OneDriveicon]<br/>**OneDrive**][OneDrivedoc]|[![API Icon][OneDrive-for~Businessicon]<br/>**OneDrive for<br/>Business**][OneDrive-for~Businessdoc]|[![API Icon][Outlook.comicon]<br/>**Outlook.com**][Outlook.comdoc]|![Ícone de API][PagerDutyicon]<br/>**PagerDuty**|
|![Ícone de API][Pinteresticon]<br/>**Pinterest**|[![API Icon][Project-Onlineicon]<br/>**Project Online**][Project-Onlinedoc]|[![API Icon][Queryicon]<br/>**Consulta**][Querydoc]|[![API Icon][Recurrenceicon]<br/>**Recorrência**][Recurrencedoc]|
...
|[![API Icon][Service-Busicon]<br/>**Barramento de Serviço**][Service-Busdoc]|[![API Icon][SFTPicon]<br/>**SFTP**][SFTPdoc]|[![API Icon][SharePointicon]<br/>**SharePoint**][SharePointdoc]|[![API Icon][Slackicon]<br/>**Slack**][Slackdoc]|
...
## <a name="enterprise-integration-pack-eip-connectors"></a>Conectores do EIP (Enterprise Integration Pack)
Use os conectores do EIP para criar aplicativos Lógicos para cenários B2B que incluem EAI e EDI.  

| Conectores EIP |  |  |  |
| --- | --- | --- | --- |
| [![API Icon][xmlvalidateicon]<br/>**Validação de <br/>XML**][xmlvalidatedoc] |[![API Icon][xmltransformicon]<br/>**Transformação de<br/> XML**][xmltransformdoc] |[![API Icon][flatfileicon]<br/>**Codificação de</br>arquivo simples**][flatfiledoc] |[![API Icon][flatfiledecodeicon]<br/>**Decodificação de</br>arquivo simples**][flatfiledecodedoc] |
| [![API Icon][as2icon]<br/>**Decodificação de</br>AS2**][as2decode] |[![API Icon][as2icon]<br/>**Codificação de</br>AS2**][as2encode] |[![API Icon][x12icon]<br/>**Decodificação de</br>X12**][x12decode] |[![API Icon][x12icon]<br/>**Codificação de</br>X12**][x12encode] |
| [![API Icon][x12icon]<br/>**Decodificação de</br>EDIFACT**][EDIFACTdecode] |[![API Icon][x12icon]<br/>**Codificação de</br>EDIFACT**][EDIFACTencode] | | |
...
[azureblobstoragedoc]: ./connectors-create-api-azureblobstorage.md "Conecte-se ao Blob do Azure para gerenciar arquivos em seu contêiner de blob."
...
[db2doc]: ./connectors-create-api-db2.md "Conecte-se ao IBM DB2 local ou na nuvem para atualizar uma linha, obter uma tabela e muito mais."
...
[informixdoc]: ./connectors-create-api-informix.md "Conecte-se ao Informix local ou na nuvem para ler uma linha, listar as tabelas e muito mais."
...
[outlook.comdoc]: ./connectors-create-api-outlook.md "Conecte-se à sua caixa de correio do Outlook e acesse seu email e muito mais."
[project-onlinedoc]: ./connectors-create-api-projectonline.md "Conecta o Microsoft Project Online."
[rssdoc]: ./connectors-create-api-rss.md "O conector RSS permite que os usuários publiquem e recuperem itens de feed. Também permite que os usuários disparem operações quando um novo item é publicado no feed."
...
[slackdoc]: ./connectors-create-api-slack.md "Conecte-se ao Slack e poste mensagens nos canais do Slack."
[sftpdoc]: ./connectors-create-api-sftp.md "Conecta-se ao SFTP e pode carregar, obter, excluir arquivos e muito mais."
[githubdoc]: ./connectors-create-api-github.md "Conecta-se o GitHub e pode acompanhar os problemas."
...
[sql-serverdoc]: ./connectors-create-api-sqlazure.md "Conecta-se a um Banco de Dados SQL do Azure. Você pode criar, atualizar, obter e excluir entradas em uma tabela de Banco de Dados SQL."
...
[twiliodoc]: ./connectors-create-api-twilio.md "Conecta-se ao Twilio e pode enviar e receber mensagens, obter os números disponíveis, gerenciar de números de telefone de entrada e muito mais."
[twitterdoc]: ./connectors-create-api-twitter.md "Conecta-se ao Twitter e obtém cronogramas, posta tweets e muito mais."
...
[azure~functionsdoc]: ../app-service-logic/app-service-logic-azure-functions.md "Integre aplicativos lógicos ao Azure Functions."
