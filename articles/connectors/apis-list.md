...
> [!TIP]
> Neste tópico, a [lista completa de A-Z](#az) lista todos os conectores disponíveis para você usar em seus aplicativos lógicos. [Conectores swagger](/connectors/) lista os detalhes do swagger de cada conector.
