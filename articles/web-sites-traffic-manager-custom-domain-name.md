<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a custom domain name" pageTitle="Configure um nome de domínio personalizado para um site do Azure que usa o Gerenciador de Tráfego"metaKeywords ="Microsoft Azure, sites do Microsoft Azure, nome de domínio" description="" services="web-sites" documentationCenter="" authors="larryfr, jroth" manager="wpickett" />
