<properties linkid="develop-java-how-to-guides-service-bus-amqp" urlDisplayName="AMQP no Service Bus" pageTitle="Como usar o AMQP 1.0 com a API do Service Bus do Java - Azure" metaKeywords="AMQP do Java Messsage, AMQP no Service Bus, Baixe a biblioteca do JMS para o AMQP" description="Saiba como usar o Java Message Service (JMS) com o Service Bus do Azure e o AMQP 1.0." metaCanonical="" services="service-bus" documentationCenter="Java" title="Como usar a API do Java Message Service (JMS) com o Service Bus e AMQP 1.0" authors=""  solutions="" writer="sethm" manager="dwrede" editor="mattshel"  />
...
* Inicie a amostra do aplicativo .NET sem nenhum argumento de linha de comando.
...
* Inicie a amostra do aplicativo .NET com o argumento de linha de comando "sendonly". Nesse modo, o aplicativo não receberá mensagens da fila; ele somente as enviará.
