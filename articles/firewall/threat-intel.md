...
Ameaças a filtragem baseada em inteligência pode ser habilitado para o seu firewall de alerta e negar o tráfego de/para endereços IP mal-intencionados e domínios conhecidos. Os endereços IP e os domínios são originados de inteligência de ameaças da Microsoft do feed. [Gráfico de segurança inteligente](https://www.microsoft.com/en-us/security/operations/intelligence) impulsiona a inteligência contra ameaças da Microsoft e é usado por vários serviços, incluindo a Central de segurança do Azure.
