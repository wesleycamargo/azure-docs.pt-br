<properties urlDisplayName="SQL Database Management" pageTitle="Gerenciar um Banco de Dados SQL com o SSMS - Azure" metaKeywords ="SQL Server Management Studio SSMS do Azure  " description="Learn how to use SQL Server Management Studio to manage SQL Database servers and databases." metaCanonical="" services="sql-database" documentationCenter=".NET" title="" authors="jeffreyg" solutions="" manager="jeffreyg" editor="tysonn" />
