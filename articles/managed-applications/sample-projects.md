...
| [Aplicativo Web gerenciado (IaaS) com os serviços de gerenciamento do Azure e o Key Vault](https://github.com/Azure/azure-managedapp-samples/tree/master/samples/201-managed-web-app-using-keyvault) | Implanta uma máquina virtual que hospeda um aplicativo Web. Ele faz referência a um cofre de chaves para a senha de administrador. |
