...
* Para saber mais sobre como publicar aplicativos gerenciados para o Azure Marketplace, consulte [Aplicativos Gerenciados no Marketplace](publish-marketplace-app.md).