<properties 
	pageTitle="" 
	description="Usar os serviços móveis em projetos Cordova" 
...
1. Em seu projeto Cordova da Visualização do Visual Studio 2015, abra o config. XML e na guia **Plug-ins**, habilite o plug-in **Serviços Móveis do Microsoft Azure**.<br/> ![][1]

2. Em index.html, exclua as linhas que fazem referência a **MobileServices.Web-1.2.2.min.js**.<br/>
