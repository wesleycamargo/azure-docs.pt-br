<properties linkid="develop-media-services-tutorials-smooth-streaming-windows-store-app" urlDisplayName="Aplicativo Smooth Streaming da Windows Store" pageTitle="Aplicativo Smooth Streaming da Windows Store - Tutoriais .NET do Azure" metaKeywords="" description="Saiba como usar os Serviços de Mídia do Azure para criar um aplicativo C# da Windows Store com um controle XML MediaElement para reprodução de conteúdo de Smooth Streaming." metaCanonical="" services="media-services" documentationCenter="" title="Como criar uma aplicativo de Smooth Streaming da Windows Store" authors="" solutions="" manager="" editor="" />



#Como criar uma aplicativo de Smooth Streaming da Windows Store

O SDK do Smooth Streaming Client para Windows 8 permite que os desenvolvedores criem aplicativos da Windows Store que podem reproduzir conteúdo de Smooth Streaming sob demanda e ao vivo. Além da reprodução básica de conteúdo do Smooth Streaming, o SDK também fornece recursos avançados, como proteção do Microsoft PlayReady, restrição de nível de qualidade, Live DVR, alternância de fluxo de áudio, escuta de atualizações de status (como alterações no nível da qualidade), eventos de erros e assim por diante. Para obter mais informações sobre os recursos suportados, consulte as [notas da versão (a página pode estar em inglês)](http://www.iis.net/learn/media/smooth-streaming/smooth-streaming-client-sdk-for-windows-8-release-notes).

Este tutorial aborda as APIs. Para o desenvolvimento do player, a Microsoft recomenda usar o [Player Framework para Windows 8 (a página pode estar em inglês)](http://playerframework.codeplex.com/) O Player Framework facilita a criação de aplicativos e fornece muitos recursos adicionais. 

Este tutorial contém quatro lições:

1. Criar um aplicativo básico de Smooth Streaming para a Store
...
#Pré-requisitos
- Windows 8 de 32 ou de 64 bits Você pode obter o [Windows 8 Enterprise Evaluation (a página pode estar em inglês)](http://msdn.microsoft.com/pt-br/evalcenter/jj554510.aspx) no MSDN.
- Visual Studio 2012 ou Visual Studio Express 2012 para Windows 8 instalado no Windows 8. Você pode obter a versão de avaliação [aqui (a página pode estar em inglês)](http://www.microsoft.com/visualstudio/11/pt-br/downloads).
...
A solução completa para cada lição pode ser baixada em Exemplos de Código do MSDN Developer (Galeria de Códigos): [Lição 1](http://code.msdn.microsoft.com/Smooth-Streaming-Client-0bb1471f "Um Smooth Streaming Media Player simples do Windows 8 (a página pode estar em inglês)"), [Lição 2](http://code.msdn.microsoft.com/A-simple-Windows-8-Smooth-ee98f63a "Um Smooth Streaming Media Player simples do Windows 8 com um controle de barra de deslizante (a página pode estar em inglês)"), [Lição 3](http://code.msdn.microsoft.com/A-Windows-8-Smooth-883c3b44 "Um Smooth Streaming Media Player do Windows 8 com seleção de fluxo (a página pode estar em inglês)") e [Lição 4](http://code.msdn.microsoft.com/A-Windows-8-Smooth-aa9e4907 "Um Smooth Streaming Media Player do Windows 8 com seleção de faixa (a página pode estar em inglês)").
...
Na Lição 1, você criou um aplicativo da Windows Store com um controle XAML MediaElement para reproduzir conteúdo de mídia de Smooth Streaming.  Ele vem com algumas funções básicas de mídia, como iniciar, parar e pausar.  Nesta lição, você irá adicionar um controle de barra deslizante ao aplicativo.
...
2.	Adicionar os manipuladores de eventos no nível do gerenciador de origens adaptáveis
3.	Adicionar os manipuladores de eventos de origens adaptáveis
...
**Para registrar o manipulador de fluxo de bytes de Smooth Streaming e passar o propertyset**
...
3.	No final do construtor **MainPage**, adicione o seguinte código para inscrever-se nos eventos:
...
5.	No final da classe **MainPage**, adicione o código a seguir:
		...
		// A hora de início e de término do controle deslizante devem ser atualizadas no caso de conteúdo ao vivo
...
#Lição 3: Selecionar fluxos de Smooth Streaming
...
1. No Gerenciador de Soluções, clique com o botão direito do mouse em **MainPage.xaml** e, em seguida, clique em **Designer de Modo de Exibição**.
...
3. Dentro das marcas &lt;Grid&gt;&lt;/Grid&gt;, adicione o seguinte código para definir um controle de caixa de listagem, para que os usuários possam ver a lista de fluxos disponíveis e selecionar fluxos:
...
3.	Na parte superior do aplicativo, use a URL do Smooth Streaming padrão ou digite outra URL. 
4.	Clique em **Definir Origem**. 
5.	O idioma padrão é áudio_eng. Tente alternar entre áudio_eng e áudio_es. Toda vez que selecionar um novo fluxo, você deverá clicar no botão Enviar.

Você concluiu a Lição 3. Nesta lição, você adicionará a funcionalidade de escolher fluxos.

#Lição 4: Selecionar faixas de Smooth Streaming
...
1. No Gerenciador de Soluções, clique com o botão direito do mouse em **MainPage.xaml** e, em seguida, clique em **Designer de Modo de Exibição**.
2. Localize a marca &lt;Grid&gt; com o nome **gridStreamAndBitrateSelection** e acrescente o seguinte código no final da marca:
