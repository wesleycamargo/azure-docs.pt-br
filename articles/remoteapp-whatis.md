...
Continue lendo para obter mais informações sobre o RemoteApp, ou, se nós já o convencemos, [experimente-o agora](http://azure.microsoft.com/pt-br/services/remoteapp/).

Tem dúvidas sobre o Azure RemoteApp? Confira nossas [Perguntas mais frequentes](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-faq/).
...
A [coleção de RemoteApp na nuvem](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-create-cloud-deployment/) oferece uma maneira independente para hospedar aplicativos na nuvem. Uma coleção na nuvem existe apenas na nuvem do Azure, em vez de se conectar à sua rede local.
...
- [Como criar uma coleção na nuvem do RemoteApp](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-create-cloud-deployment/)
- [Como criar uma coleção híbrida do RemoteApp](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-create-hybrid-deployment/)
- [Como o licenciamento funciona no RemoteApp?](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-licensing/)
- [Práticas recomendadas para usar o RemoteApp do Azure](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-bestpractices/)
- [Perguntas frequentes sobre o RemoteApp do Azure](http://azure.microsoft.com/pt-br/documentation/articles/remoteapp-faq/)
