...
* [Hubs de Eventos do Azure](../active-directory-domain-services/index.md). Esse serviço fornece a ingestão de grandes volumes de evento para a nuvem. Confira a [Comparação do Hub IoT do Azure e Hubs de Eventos do Azure](../iot-hub/iot-hub-compare-event-hubs.md).
