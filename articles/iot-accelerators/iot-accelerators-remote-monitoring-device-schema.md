...
Para saber mais sobre o arquivo JavaScript que atualiza o objeto de estado do dispositivo, consulte [Compreender o comportamento do modelo do dispositivo](iot-accelerators-remote-monitoring-device-behavior.md).
