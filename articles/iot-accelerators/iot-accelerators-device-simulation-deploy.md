...
1. Clique em **Criar Solução** para iniciar o processo de provisionamento. Este processo normalmente leva vários minutos para ser executado:
    ...
    ![Detalhes da solução de simulação de dispositivo](./media/iot-accelerators-device-simulation-deploy/createsolution.png)
...
1. Na página **Soluções provisionadas**, clique em **Iniciar** na nova solução de simulação de dispositivo:
    ...
    ![Escolher a nova solução](./media/iot-accelerators-device-simulation-deploy/newsolution.png)
...
Agora que você implantou a solução de simulação de dispositivo, a próxima etapa será [explorar os recursos da solução de simulação de dispositivo](iot-accelerators-device-simulation-explore.md).
