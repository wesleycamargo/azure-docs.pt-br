...
A seção de [Simulação](iot-accelerators-remote-monitoring-device-schema.md#simulation) do esquema de modelo do dispositivo define o estado interno de um dispositivo simulado:
...
A seção [CloudToDeviceMethods](iot-accelerators-remote-monitoring-device-schema.md#cloudtodevicemethods) do esquema de modelo do dispositivo define os métodos que um dispositivo simulado responde.
...
O artigo [Criar um dispositivo simulado](iot-accelerators-remote-monitoring-test.md) artigo mostra como executar o serviço de simulação do dispositivo localmente. Executar o serviço localmente torna mais fácil depurar seus dispositivos simulados antes de implantá-los à nuvem.
