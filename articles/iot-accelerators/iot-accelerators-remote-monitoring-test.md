...
![Exibir a lista de simulações disponíveis](./media/iot-accelerators-remote-monitoring-test/devicesmodellist.png)

Você pode exibir a telemetria do dispositivo simulado:

![Exibir telemetria da lâmpada](./media/iot-accelerators-remote-monitoring-test/devicestelemetry.png)

Você pode chamar os métodos **SwitchOn** e **SwitchOff** em seu dispositivo:

![Chamar métodos da lâmpada](./media/iot-accelerators-remote-monitoring-test/devicesmethods.png)
...
![Adicionar Resfriador atualizado](./media/iot-accelerators-remote-monitoring-test/devicesupdatedchiller.png)
