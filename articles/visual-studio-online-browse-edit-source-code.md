<properties urlDisplayName="Browse and Edit Your Source Code" pageTitle="Procurar e editar seu código-fonte | Azure"metaKeywords="Visual Studio Online, VSO, git, tfvc, editar, código, confirmação" description="Saiba como editar seu código-fonte." metaCanonical="" services="visual-studio-online" documentationCenter="" title="Browse and Edit Your Source Code" authors="ehollow" solutions="" manager="kamrani" editor="" />
