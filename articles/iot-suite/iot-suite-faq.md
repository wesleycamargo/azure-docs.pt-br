...
Consulte também, as [Perguntas frequentes específicas de Fábrica Conectada ](iot-suite-faq-cf.md) e as [Perguntas frequentes específicas de monitoramento remoto](iot-suite-faq-rm-v2.md) .
