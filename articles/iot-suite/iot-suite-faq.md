...
### <a name="what-sdks-can-i-use-to-develop-device-clients-for-the-preconfigured-solutions"></a>Quais SDKs posso usar para desenvolver clientes de dispositivos para as soluções pré-configuradas?
