...
2. No painel esquerdo, clique em Grupos de recursos
    ...
    ![Navegação no painel lateral](media/iot-suite-remote-monitoring-powerbi/side_panel.png)
...
5. No painel à esquerda, clique na seção "Chaves" e anote os seguintes valores para uso no Power BI:
    ...
    ![chaves](media/iot-suite-remote-monitoring-powerbi/keys.png)
...
4. Selecione todas as tabelas a serem importados no Power BI. Essa ação iniciará o carregamento dos dados. Quanto mais tempo sua solução estiver em execução, mais tempo levará para carregar os dados (até algumas horas). 
    ...
    ![Importar tabelas](media/iot-suite-remote-monitoring-powerbi/import_tables.png)
...
Após a conexão do fluxo, você estará pronto para criar seus painéis personalizados! O painel abaixo é um exemplo de como obter a telemetria que está sendo imitada por nossos dispositivos simulados e mostrar dinâmicas diferentes com relação a ela, por exemplo: 

* Local do dispositivo em um mapa (à direita)
* Dispositivos com seu status e gravidade. (lado superior esquerdo)
* Dispositivos com as regras em vigor, e se há algum alarme disparado para eles (lado inferior esquerdo)
