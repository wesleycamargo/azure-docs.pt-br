...
Os três trabalhos de Stream Analytics e sua sintaxe são descritos em detalhes na [Passo a passo da solução pré-configurada de monitoramento remoto](iot-suite-v1-remote-monitoring-sample-walkthrough.md). 
...
Para obter um guia passo a passo para adicionar dispositivos, consulte o artigo [Dispositivos de Conexão do Iot Suite](iot-suite-v1-connecting-devices.md) e o [Exemplo de SDK para o monitoramento remoto em C](https://github.com/Azure/azure-iot-sdk-c/tree/master/serializer/samples/remote_monitoring). Este exemplo é projetado para trabalhar com a solução pré-configurada de monitoramento remoto.
...
### <a name="time-period-of-telemetry-graph"></a>Período do grafo de telemetria
