...
1. Faça logon no [azureiotsuite.com](https://www.azureiotsuite.com) usando as credenciais da sua conta do Azure e clique em **+** para criar uma solução.

1. Clique em **Selecionar** no bloco **Monitoramento remoto**.
...
1. Selecione uma implantação do tipo **Básico** ou **Enterprise**. Se você estiver implantando a solução para saber como ela funciona ou para executar uma demonstração, escolha a opção **Básico** para minimizar os custos.
