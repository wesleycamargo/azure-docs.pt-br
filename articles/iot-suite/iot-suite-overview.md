...
* O principal serviço do Azure IoT Suite é o serviço [Hub IoT do Azure][lnk-iot-hub]. Esse serviço fornece os recursos de mensagens do dispositivo para a nuvem e da nuvem para o dispositivo e age como o gateway para a nuvem e para outros serviços importantes do Pacote IoT. O serviço permite que você receba mensagens de seus dispositivos em escala e envie comandos para seus dispositivos.
...
Para obter uma visão geral da arquitetura de uma solução de IoT típica, veja [Microsoft Azure e a IoT (Internet das Coisas)][iot-suite-what-is-azure-iot].
