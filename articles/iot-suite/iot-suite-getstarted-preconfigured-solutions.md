...
As soluções pré-configuradas do Azure IoT Suite conectam uma quantidade dos serviços Azure IoT para exemplificar uma solução de ponta a ponta que atende um cenário de negócios da Internet das Coisas.
...
1.  Faça logon <https://azureiotsuite.com> e clique em **+** para criar uma nova solução.
...
## Exibição da lista de dispositivo

1.  Clique em **Dispositivos** no menu à esquerda para navegar para a lista de dispositivo para essa solução.
...
2.  Selecione **PingDevice** no menu suspenso de comando.
...
1.  Observe o **Histórico de Alarme** na tabela no **Painel de Solução.**
...
4.  Depois do provisionamento, você verá 1 regra já habilitada.

5.  Clique em **regra** na lista de regras para exibir as propriedades de regra associada.

6.  Clique em **Editar** no painel de propriedades da regra.

7.  Altere o **limite** para 30 e mantenha todas as outras propriedades do mesmo.
