...
2. Vá para <https://github.com/Azure/azure-iot-remote-monitoring>. Para saber mais sobre implantações de nuvem, consulte [Implantação de nuvem][lnk-wiki-clouddeployment].
