...
description: "Escolha como implementar sua solução do Azure IoT usando IoT Suite, a Central da IoT ou o Hub IoT."
services: 
suite: iot-suite
author: dominicbetts
manager: timlt
...
* O [Azure IoT Suite](index.md) é uma coleção de nível empresarial de [soluções pré-configuradas](iot-suite-what-are-preconfigured-solutions.md) criada na plataforma como serviço do Azure e que permite acelerar o desenvolvimento de soluções personalizadas de IoT.

* A [Central da IoT da Microsoft](https://www.microsoft.com/internet-of-things/iot-central-saas-solutions) é uma solução de SaaS que usa uma abordagem baseada em modelo para permitir que você crie soluções de IoT de nível empresarial sem a necessidade de experiência em desenvolvimento de solução de nuvem.

## <a name="azure-iot-hub"></a>Hub IoT do Azure

O Hub IoT do Azure é a principal plataforma como serviço do Azure usada pela Central da IoT e pelo IoT Suite. O Hub IoT permite comunicações bidirecionais confiáveis e seguras entre milhões de dispositivos IoT e uma solução de nuvem. O Hub IoT ajuda a solucionar os desafios de implementação de IoT como:
...
## <a name="compare-iot-suite-and-iot-central"></a>Comparar IoT Suite e Central da IoT

Escolher seu produto do Azure IoT é uma parte essencial do planejamento da sua solução de IoT. O Hub IoT é um serviço individual do Azure que, por si só, não fornece uma solução de IoT de ponta a ponta. O Hub IoT pode ser usado como um ponto de partida para qualquer solução de IoT, e você não precisa do Azure IoT Suite ou da Central da IoT da Microsoft para usá-lo. O IoT Suite e a Central da IoT usam Hub IoT junto com outros serviços do Azure. A tabela a seguir resume as principais diferenças entre o IoT Suite e a Central da IoT para ajudá-lo a escolher a opção correta para seus requisitos:

|                        | IoT Suite | Central da IoT |
| ---------------------- | --------- | ----------- |
...
| Experiência para começar | Soluções pré-configuradas implementam cenários comuns de IoT. Podem ser implantados em minutos. | Os modelos fornecem modelos predefinidos. Podem ser implantados em minutos. |
...
* **Central da IoT**: [Central da IoT da Microsoft](https://www.microsoft.com/internet-of-things/iot-central-saas-solutions).
