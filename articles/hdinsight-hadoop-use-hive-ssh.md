...
Neste artigo, você aprenderá como usar o SSH para se conectar a um Hadoop no cluster HDInsight e enviar interativamente consultas Hive usando a Interface de Linha de Comando (CLI) do Hive.
...
2. Uma vez conectado, inicie a Interface de Linha de Comando (CLI) do Hive usando o comando a seguir.
