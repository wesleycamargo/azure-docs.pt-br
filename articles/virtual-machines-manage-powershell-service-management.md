<properties
   pageTitle="Tarefas comuns de VM usando o modo de Gerenciamento de Serviços no PowerShell do Azure"
   description="Fornece comandos para tarefas comuns de VM usando o modo de Gerenciamento de Serviços no PowerShell do Azure"
...
# Tarefas comuns de VM usando o PowerShell do Azure no modo de Gerenciamento de Serviços
...
Muitas tarefas realizadas diariamente para gerenciar suas VMs podem ser automatizadas usando cmdlets do PowerShell do Azure no modo de Gerenciamento de Serviços. Este artigo fornece comandos de exemplo para tarefas mais simples e links para artigos que mostram os comandos para tarefas mais complexas.
