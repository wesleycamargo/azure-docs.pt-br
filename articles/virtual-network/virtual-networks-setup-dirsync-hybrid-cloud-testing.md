...
##Fase 2: Configurar a avaliação do Office 365 FastTrack
...
Em seguida, inscreva-se para uma nova conta da Microsoft. Vá para **http://outlook.com** e crie uma conta com um endereço de email como user123@outlook.com. Você se inscreverá para uma avaliação do Office 365 FastTrack usando essa conta.
...
2.	Abra o Internet Explorer e vá para **http://fasttrack.office.com**.
...
2.	Abra a pasta **Downloads**, clique com o botão direito no arquivo **dirsync** e clique em **Executar como administrador**.
3.	Na página de boas-vindas do Assistente de Instalação da Sincronização do Active Directory, clique em **Avançar**. 
4.	Na página Termos de Licença, clique em **Aceito** e clique em **Avançar**.
...
1.	Em CLIENT1, na página **Centro de Administração do Office 365**, no painel esquerdo, clique em **Usuários** e, em seguida, em **Usuários Ativos**.
...
6.	Execute o Internet Explorer e vá para **http://portal.microsoftonline.com**. 
...
[Implantar a Sincronização de Diretórios (DirSync) do Office 365 no Microsoft Azure](http://technet.microsoft.com/library/dn635310.aspx)
