...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]Este artigo aborda o modelo de implantação clássico. Você também pode [DIGITAR A AÇÃO PARA ARM AQUI](armToken).

[AZURE.INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

O exemplo de comando do Azure PowerShell abaixo espera um ambiente simples já criado com base no cenário acima. Se você quiser executar os comandos da forma como eles aparecem neste documento, crie o ambiente descrito em [criar uma VNet (clássica) usando o PowerShell](virtual-networks-create-vnet-classic-ps.md).
...
5. Execute o cmdlet **`Set-AzureSubnetRouteTable`** para associar a tabela de rotas criada acima à sub-rede de **BackEnd**.
		...
		Set-AzureSubnetRouteTable -VirtualNetworkName TestVNet `
			...
			-RouteTableName UDR-FrontEnd
		```
## Habilitar o encaminhamento de IP na VM FW1
