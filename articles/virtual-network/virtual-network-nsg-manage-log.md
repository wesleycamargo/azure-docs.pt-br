...
Você pode usar o [Portal do Azure](#azure-portal), ou [PowerShell](#powershell)para habilitar o log de diagnóstico.

### <a name="azure-portal"></a>Portal do Azure

1. Faça logon no [portal](https://portal.azure.com).
