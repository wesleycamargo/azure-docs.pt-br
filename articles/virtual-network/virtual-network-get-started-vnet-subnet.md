...
1. Faça logon no [Portal do Azure](<https://portal.azure.com>). Se você ainda não tiver uma conta, poderá se inscrever para obter uma [avaliação gratuita de um mês](https://azure.microsoft.com/free). 
...
2. Digite *Grupos de recursos* na caixa que contém a palavra *Filtro*. Clique em **Grupos de recursos** quando o vir na lista filtrada.
