...
1. Instale e configure a CLI do Azure 1.0 seguindo as etapas do artigo [Instalar e configurar a CLI do Azure](../xplat-cli-install.md) e faça logon em sua conta do Azure com o comando `azure-login`.

2. Registre-se para obter a prévia executando os seguintes comandos do PowerShell (não é possível registrar usando a CLI) após o logon e selecione a assinatura apropriada:
