<properties 
   pageTitle="Como definir um IP privado estático no modo clássico usando o Portal de Visualização | Microsoft Azure"
   description="Noções básicas sobre IPs privados estáticos (DIPs) e como gerenciá-los no modo clássico usando o portal"
...
# Como definir um endereço IP privado estático (clássico) no portal de visualização
...
2. Clique em **NOVO** > **Computação** > **Windows Server 2012 R2 Datacenter**, observe que a lista **Selecionar um modelo de implantação** já mostra **Clássico** e, em seguida, clique em **Criar**.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure01.png)

3. Na folha **Criar VM**, insira o nome da VM a ser criada (*DNS01* em nosso cenário), a conta de administrador local e a senha.

	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure02.png)
...
4. Clique em **Configuração opcional** > **Rede** > **Rede Virtual**, e, em seguida, clique em **TestVNet**. Se **TestVNet** não estiver disponível, verifique se você está usando o *Centro dos EUA* como local e que você criou o ambiente de teste descrito no início deste artigo.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure03.png)
...
5. Na folha **Rede**, certifique-se de que a sub-rede selecionada atualmente é *FrontEnd*, em seguida, clique em **Endereços IP**, em **Atribuição de endereço IP** clique em **Estático**, e, em seguida, digite *192.168.1.101* para **Endereço IP** conforme mostrado abaixo.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure04.png)
...
7. Na folha **Criar VM**, clique em **Criar**. Observe o bloco abaixo exibido no painel.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure05.png)
...
1. No portal de visualização do Azure, clique em **PROCURAR TUDO** > **Máquinas virtuais (clássico)** > **DNS01** > **Todas as configurações** > **Endereços IP** e observe o endereço IP e a atribuição de endereço IP, conforme mostrado abaixo.

	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure06.png)
...
1. Na folha **Endereços IP** mostrada acima, clique em **Dinâmico** à direita da **Atribuição de endereço IP**, em seguida, clique em **Salvar**, e, em seguida, clique em **Sim**.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-classic-pportal/figure07.png)
