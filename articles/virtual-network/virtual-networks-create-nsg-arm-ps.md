---
title: Criar NSGs usando o PowerShell | Microsoft Docs
description: Como criar NSGs usando o PowerShell | Gerenciador de Recursos.
...
---
# <a name="create-nsgs-using-powershell"></a>Criar NSGs usando o PowerShell
