...
- Criar um adaptador de rede usando o [PowerShell](powershell-samples.md), os scripts de exemplo da [CLI do Azure](cli-samples.md) ou os modelos do [Azure Resource Manager](template-samples.md)
