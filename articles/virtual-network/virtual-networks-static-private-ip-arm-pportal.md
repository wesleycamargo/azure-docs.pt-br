<properties 
   pageTitle="Como definir um IP privado estático no modo ARM usando o Portal de Visualização | Microsoft Azure"
   description="Noções básicas sobre IPs privados (DIPs) e como gerenciá-los no modo ARM usando o portal de visualização"
...
# Como definir um endereço IP privado estático no portal de visualização
...
Você não pode definir um endereço IP privado estático durante a criação de uma VM no modo de implantação do Gerenciador de recursos usando o portal de visualização. Você deve criar a VM primeiro e, em seguida, definir seu IP privado como estático.
...
2. Clique em **NOVO** > **Computação** > **Windows Server 2012 R2 Datacenter**, observe que a lista **Selecionar um modelo de implantação** já mostra **Gerenciador de recursos** e, em seguida, clique em **Criar**, conforme visto na figura abaixo.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-arm-pportal/figure01.png)
...
7. Na folha **Resumo**, clique em **OK**. Observe o bloco abaixo exibido no painel.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-arm-pportal/figure06.png)
...
1. No portal de visualização do Azure, clique em **PROCURAR TUDO** > **Máquinas virtuais** > **DNS01** > **Todas as configurações** > **Interfaces de rede** e, em seguida, clique na interface de rede listada.
...
2. Digite *192.168.1.101* para **Endereço IP**, e, em seguida, clique em **Salvar**.
	...
	![Criar VM no portal de visualização](./media/virtual-networks-static-ip-arm-pportal/figure09.png)
