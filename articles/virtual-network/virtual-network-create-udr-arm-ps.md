---
title: Controlar o roteamento e usar dispositivos virtuais no Gerenciador de Recursos usando o PowerShell | Microsoft Docs
...
2. Crie uma tabela de rotas chamada **UDR-FrontEnd** na região **westus** que contém a rota criada acima.
...
1. Salve a nova configuração de sub-rede no Azure.
