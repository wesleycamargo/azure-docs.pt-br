...
## [Roteamento](virtual-networks-udr-overview.md)
...
#### [PowerShell do Azure](tutorial-restrict-network-access-to-resources-powershell.md)
...
#### Criar VM - rede acelerada
##### [PowerShell do Azure](create-vm-accelerated-networking-powershell.md)
