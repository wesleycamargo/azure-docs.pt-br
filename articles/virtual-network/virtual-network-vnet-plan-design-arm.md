<properties
   pageTitle="Guia de Design e planejamento de Rede Virtual do Azure (VNet) | Microsoft Azure"
...
- Você pode conectar redes virtuais à sua rede local usando uma das [opções de conectividade](../vpn-gateway/vpn-gateway-cross-premises-options.md) disponíveis no Azure. 
- Recursos diferentes podem ser agrupados em [grupos de recursos](../resource-group-overview.md#resource-groups), facilitando o gerenciamento de recursos como uma unidade. Um grupo de recursos pode conter recursos de várias regiões, desde que os recursos pertençam à mesma assinatura.
...
### Entender as propriedades de rede virtual e sub-rede
...
|**networkSecurityGroup**|NSG aplicado à sub-rede|veja [NSGs](resource-groups-networking.md#Network-Security-Group)|
|**routeTable**|Tabela de rotas aplicada à sub-rede|veja [UDR](resource-groups-networking.md#Route-table)|
|**ipConfigurations**|Coleção de objetos de configuração IP usada pelas NICs conectadas à sub-rede|consulte [configuração de IP](../resource-groups-networking.md#IP-configurations)|

### Resolução de nomes

Por padrão, sua rede virtual usa a [Resolução de nomes fornecida pelo Azure](virtual-networks-name-resolution-for-vms-and-role-instances.md#Azure-provided-name-resolution) para resolver nomes dentro da rede virtual e na Internet pública. No entanto, se você conectar suas redes virtuais aos seus centros de dados local, você precisa fornecer [seu próprio servidor DNS](virtual-networks-name-resolution-for-vms-and-role-instances.md#Name-resolution-using-your-own-DNS-server) para resolver nomes entre suas redes.

### Limites

Exiba todos os [limites relacionados aos serviços de rede no Azure](../azure-subscription-service-limits#networking-limits) antes de projetar sua solução. Alguns limites podem ser aumentados abrindo um tíquete de suporte.
...
- **Evitar os limites de plataforma**. Como visto na seção [limites](#Limits), você não pode ter mais de 2048 VMs em uma rede virtual única. 
...
### Assinatura e padrões de design de rede virtual
...
|---|---|---|---|
|Assinatura única, duas redes virtuais por aplicativo|![Assinatura única](./media/virtual-network-vnet-plan-design-arm/figure1.png)|Somente uma assinatura para gerenciar.|Máximo de 25 aplicativos por região do Azure. Você precisa de mais inscrições depois disso.|
...
|Uma assinatura por unidade de negócios, duas redes virtuais por aplicativo.|![Assinatura única](./media/virtual-network-vnet-plan-design-arm/figure3.png)|Equilíbrio entre o número de assinaturas e as redes virtuais.|Máximo de 25 aplicativos por unidade de negócios (assinatura).|
...
- **Conectividade híbrida**. Você pode usar gateways de VPN e circuitos de Rota Expressa para [conectar](../vpn-gateway/vpn-gateway-cross-premises-options.md) suas redes virtuais entre si e seu(s) datacenter(s) local(is). Gateways de VPN e circuitos de Rota Expressa exigem a criação de uma sub-rede própria.
...
### Padrões de design de sub-rede e NSG
...
|Uma sub-rede por camada de aplicativo, NSGs por aplicativo.|![Sub-rede por camada](./media/virtual-network-vnet-plan-design-arm/figure7.png)|Equilíbrio entre o número de sub-redes e de NSGs.|Máximo de 100 NSGs. 50 aplicativos se cada aplicativo requer 2 NSGs distintos.|
