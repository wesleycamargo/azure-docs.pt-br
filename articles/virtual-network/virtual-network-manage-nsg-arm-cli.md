---
title: Gerenciar NSGs usando a CLI do Azure no Resource Manager | Microsoft Docs
...
> [!NOTE]
> O parâmetro **-quiet** garante que você não precisa confirmar a exclusão.
> 
> 
...
> [!NOTE]
> Observe o valor "" (vazio) do parâmetro **network-security-group-id**. É assim que se remove uma associação de um NSG. Não é possível fazer o mesmo com o parâmetro **network-security-group-name**.
> 
> 
