---
title: Gerenciar NSGs usando o portal de visualização no Resource Manager | Microsoft Docs
...
1. Verifique a lista de NSGs na folha **Grupos de segurança de rede**.
...
1. Na lista de recursos, procure itens que exibam o ícone do NSG, conforme mostrado na folha **Recursos** abaixo.
...
1. A folha **Regras de segurança de entrada** é exibida como mostrado abaixo.

![Portal do Azure - NSGs](./media/virtual-network-manage-nsg-arm-portal/figure6.png)

1. Na guia **Configurações**, clique em **Regras de segurança de saída** para ver as regras de saída.
...
1. Na guia **Configurações**, clique em **Interfaces de rede** para ver quais NICs estão associadas ao NSG.
...
1. Depois de alguns segundos, observe a nova regra na folha **Regras de segurança de entrada**.
...
1. Na folha **FrontEnd**, clique em **Salvar**.
