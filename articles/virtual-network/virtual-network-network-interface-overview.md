...
description: "Saiba mais sobre adaptadores de rede do Azure e como eles são usados com máquinas virtuais."
...
---
# <a name="what-are-network-interfaces"></a>O que são adaptadores de rede?
...
7. Pode ter um ou mais recursos de endereços IP públicos associados a ele. Leia a documentação [Vários endereços IP por NIC](virtual-network-multiple-ip-addresses-portal.md) para obter mais informações.
