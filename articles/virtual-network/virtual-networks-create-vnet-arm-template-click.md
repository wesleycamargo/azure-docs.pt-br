<properties
   pageTitle="Criar uma rede virtual usando um modelo ARM | Microsoft Azure"
...
Este documento aborda a criação de uma Rede Virtual usando o modelo de implantação do Gerenciador de Recursos. Você também pode [criar uma rede virtual no modelo de implantação clássica](virtual-networks-create-vnet-classic-pportal.md).
...
Se você estiver implantando simplesmente o modelo ARM diretamente do GitHub, sem nenhuma alteração, vá para [implantar um modelo do github](#deploy-the-arm-template-by-using-click-to-deploy).
