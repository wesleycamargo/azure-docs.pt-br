---
title: Implantar VMs com várias NICs usando um modelo no Gerenciador de Recursos | Microsoft Docs
...
1. Execute o cmdlet **`New-AzureRmResourceGroup`** para criar um grupo de recursos usando o modelo.
