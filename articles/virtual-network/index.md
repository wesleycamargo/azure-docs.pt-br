...
Uma rede virtual do Azure (VNet) é uma representação lógica da sua própria rede na nuvem.  Com a VNet, você pode ter o controle total sobre elementos da rede e segmentar sua VNet em sub-redes e usá-la para iniciar os serviços de nuvem ou as máquinas virtuais do Azure.  Além disso, você pode conectar a VNet à sua rede local usando uma das opções de conectividade disponíveis no Azure, expandindo sua rede para a nuvem enquanto mantém controle sobre os recursos.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre rede virtual</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos da Rede Virtual</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à Rede Virtual usando o Portal do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à rede virtual usando o PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à rede virtual usando a CLI do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>CLI do Azure</h3>
                        <p>CLI da rede virtual do Azure</p>
                    </div>
                </div>
            </div>
        </div>
