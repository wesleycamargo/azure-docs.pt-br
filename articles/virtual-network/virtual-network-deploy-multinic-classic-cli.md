---
title: Implantar VMs com várias NICs usando a CLI do Azure no modelo de implantação clássico | Microsoft Docs
...
Saiba como [executar estas etapas usando o modelo do Resource Manager](virtual-network-deploy-multinic-arm-cli.md).
