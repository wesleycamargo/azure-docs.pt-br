---
title: Controlar o roteamento e usar dispositivos virtuais no Gerenciador de Recursos usando a CLI do Azure | Microsoft Docs
...
Este artigo aborda o modelo de implantação do Gerenciador de Recursos. Você também pode [criar UDRs no modelo de implantação clássica](virtual-network-create-udr-classic-cli.md).
...
1. Execute o comando **`azure network route-table create`** para criar uma tabela de rotas para a sub-rede de front-end.
...
2. Execute o comando **`azure network route-table route create`** para criar uma rota na tabela de rotas criada acima para enviar todo o tráfego destinado à sub-rede de back-end (192.168.2.0/24) para a VM **FW1** (192.168.0.4).
...
3. Execute o comando **`azure network vnet subnet set`** para associar a tabela de rotas criada acima à sub-rede de **FrontEnd**.
...
2. Execute o comando **`azure network route-table route create`** para criar uma rota na tabela de rotas criada acima para enviar todo o tráfego destinado à sub-rede de front-end (192.168.1.0/24) para a VM **FW1** (192.168.0.4).
   
        azure network route-table route create -g TestRG -r UDR-BackEnd -n RouteToFrontEnd -a 192.168.1.0/24 -y VirtualAppliance -p 192.168.0.4
3. Execute o comando **`azure network vnet subnet set`** para associar a tabela de rotas criada acima à sub-rede de **BackEnd**.
