...
- **[Azure Key Vault](../key-vault/key-vault-overview-vnet-service-endpoints.md)**: Disponível ao público em geral em todas as regiões de nuvem pública do Azure.
