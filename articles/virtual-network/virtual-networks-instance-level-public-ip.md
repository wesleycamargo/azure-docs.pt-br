---
title: IP Público em Nível de Instância (ILPIP) | Microsoft Docs
...
Saiba como [executar estas etapas usando o modelo do Resource Manager](virtual-network-ip-addresses-overview-arm.md).
