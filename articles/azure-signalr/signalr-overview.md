...
Este artigo fornece uma visão geral do Serviço Azure SignalR. Para começar, acesse o [Início rápido do ASP.NET Core](signalr-quickstart-dotnet-core.md).

## <a name="what-is-signalr-service-used-for"></a>Qual é a função do Serviço SignalR? 

Há muitos tipos de aplicativos que exigem atualizações de conteúdo em tempo real. Os tipos de aplicativos destacados abaixo são bons exemplos para o uso do Serviço Azure SignalR:
