...
3. [Testar conflitos de gravação no banco de dados no aplicativo]
...
<h2><a name="test-app"></a>Testar conflitos de gravação no banco de dados no aplicativo</h2>
...
5. Execute o aplicativo **todolist** nas duas máquinas. Alterar o TodoItem `text` para o último item na instância 2. Em seguida, clique em outra caixa de texto para que o manipulador de eventos `LostFocus` atualize o banco de dados.
...
[Testar conflitos de gravação no banco de dados no aplicativo]: #test-app
