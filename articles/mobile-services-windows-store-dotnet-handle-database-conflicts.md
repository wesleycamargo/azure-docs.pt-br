<properties linkid="develop-mobile-tutorials-optimistic-concurrent-data-dotnet" urlDisplayName="Simultaneidade otimista" pageTitle="Tratar conflitos de gravação do banco de dados com simultaneidade otimista (Windows Store) | Mobile Dev Center" metaKeywords="" description="Saiba como tratar conflitos de gravação do banco de dados no servidor e em seu aplicativo da Windows Store." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Tratando de conflitos de gravação do banco de dados" authors="" />

# Tratando conflitos de gravação do banco de dados

<div class="dev-center-tutorial-selector sublanding">
<a href="/pt-br/develop/mobile/tutorials/handle-database-write-conflicts-dotnet/" title="C# da Windows Store" class="current">C# da Windows Store</a>
<a href="/pt-br/develop/mobile/tutorials/handle-database-write-conflicts-javascript/" title="JavaScript da Windows Store">JavaScript da Windows Store</a>
...
Neste tutorial, você adicionará funcionalidade ao aplicativo quickstart para tratar contenções que ocorrem ao atualizar o banco de dados TodoItem. Este tutorial apresenta e explica as seguintes etapas básicas:
...
+ Microsoft Visual Studio 2012 Express for Windows ou posterior.
...
4. No Gerenciador de Soluções do Visual Studio, abra MainPage.xaml.cs. Adicione o manipulador de eventos à MainPage para o evento `LostFocus` da TextBox, conforme mostrado abaixo.
...
4. No MainPage.xaml.cs, adicione a definição do método `UpdateToDoItem()` da MainPage referenciado no manipulador de eventos, conforme mostrado abaixo.
...
<h2><a name="enableOC"></a><span class="short-header">Habilitar a simultaneidade otimista</span>Habilitar a detecção de conflitos em seu aplicativo</h2>
...
1. No MainPage.xaml.cs, atualize a definição da classe **TodoItem** com o código a seguir para incluir a classe a propriedade do sistema **__version** ativando o suporte à detecção de conflitos de gravação.
...
6. Na instância 1 do aplicativo, atualize o texto do último item para **Test Write 1**, clique em outra caixa de texto para que o manipulador de eventos `LostFocus` atualize o banco de dados. A captura de tela abaixo mostra um exemplo.
...
<h2><a name="scriptsexample"></a><span class="short-header">Tratando conflitos com scripts</span>Tratando a resolução de conflitos automaticamente em scripts de servidor</h2>
...
5. Execute o aplicativo **todolist** nas duas máquinas. Altere o `text` do TodoItem para o último item na instância 2. Em seguida, clique em outra caixa de texto para que o manipulador de eventos `LostFocus` atualize o banco de dados.
...
6. Na instância 1 do aplicativo, insira um valor diferente para a propriedade do último texto. Em seguida, clique em outra caixa de texto para que o manipulador de eventos `LostFocus` tente atualizar o banco de dados com uma propriedade `_version` incorreta.
...
* [Introdução às notificações por push] 
  <br/>Saiba como enviar uma notificação por push muito básica a seu aplicativo com os Serviços Móveis.
...
[Site de exemplos de código para desenvolvedores]:  http://go.microsoft.com/fwlink/p/?LinkId=271146
