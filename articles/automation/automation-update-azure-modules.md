...
* Somente os módulos `Azure` e `AzureRM.*` são compatíveis no momento. Os novos [módulos do Az do Azure PowerShell](/powershell/azure/new-azureps-module-az) ainda não são compatíveis.
