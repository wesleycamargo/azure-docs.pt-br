...
* O servidor de pull do DSC do PowerShell tradicional espera que os zips do módulo sejam colocados no servidor de pull no formato **NomeMódulo_Versão.zip"**. A Automação do Azure espera que módulos do PowerShell sejam importados com nomes no formato **ModuleName.zip**. Consulte [esta postagem de blog](https://azure.microsoft.com/blog/2014/12/15/authoring-integration-modules-for-azure-automation/) para obter mais informações sobre o formato do Módulo de Integração necessário para importar o módulo para a Automação do Azure. 
