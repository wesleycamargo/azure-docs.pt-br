...
3. Na folha Contas de Automação, clique em **Adicionar**.<br>![Adicionar Conta de Automação](media/automation-sec-configure-azure-runas-account/create-automation-account-properties-b.png)
   ...
   > [!NOTE]
   > Se você vir o seguinte aviso na folha **Adicionar Conta de Automação**, sua conta não será um membro da função Administradores de Assinatura e coadministrador da assinatura.<br>![Aviso Adicionar Conta de Automação](media/automation-sec-configure-azure-runas-account/create-account-without-perms.png)
   > 
   > 
