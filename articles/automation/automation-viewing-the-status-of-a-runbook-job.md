<properties 
   pageTitle="Exibindo o status de um trabalho de runbook na Automação do Azure"
   description="Quando você inicia um runbook na Automação do Azure, um trabalho é criado. Este artigo fornece informações sobre como controlar cada trabalho e exibir seu status atual."
   services="automation"
   documentationCenter=""
   authors="bwren"
   manager="stevenka"
...
# Exibindo o status de um trabalho de runbook na Automação do Azure


Quando você inicia um runbook na Automação do Azure, um trabalho é criado. Um trabalho é uma instância única de execução de um runbook. Um único runbook pode ter vários trabalhos, cada um com seu próprio conjunto de valores para parâmetros de runbook. Há várias maneiras de verificar o status de um trabalho específico e todos os trabalhos para um ou mais runbooks.
