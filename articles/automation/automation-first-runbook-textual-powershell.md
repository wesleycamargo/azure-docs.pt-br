...
5.	Clique em **Iniciar** para iniciar o teste. Quando ele for concluído, você receberá uma saída contendo o Ambiente e a ID da assinatura da sua conta. Isso confirma que a credencial é válida.
...
1.	Depois de *Add-AzureRmAccount*, digite *Start-AzureRmVM -Name 'VMName' -ResourceGroupName 'NameofResourceGroup'* fornecendo o nome e o nome do grupo de recursos da máquina virtual para iniciar.  
...
6.	Clique em **Iniciar** para iniciar o runbook. Digite o **VMName** e o **ResourceGroupName** da máquina virtual que você iniciará.![Passar parâmetro](media/automation-first-runbook-textual-powershell/automation-pass-params.png)  
