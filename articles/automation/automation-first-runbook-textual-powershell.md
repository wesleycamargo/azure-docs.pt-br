...
1.	Após *Add-AzureAccount*, digite *Start-AzureVM -Name 'NomeDaVM' -ServiceName 'NomeDoServiçoDaVM'*, fornecendo o nome e o nome do serviço da máquina virtual a ser iniciada.  
