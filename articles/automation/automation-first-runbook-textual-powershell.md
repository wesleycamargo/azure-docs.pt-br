...
4.	Quando o trabalho do runbook é concluído, sua saída é exibida. Em nosso caso, deveremos ver *Olá mundo*.![Saída do painel de teste](media/automation-first-runbook-textual-powershell/automation-testpane-output.png)  
...
9.	Clique em **Todos os Logs** para abrir o painel Fluxos do trabalho do runbook. Devemos ver apenas *Olá mundo* no fluxo de saída, mas isso pode mostrar outros fluxos de um trabalho do runbook como Detalhado e Erro se o runbook gravar neles. ![Todos os logs](media/automation-first-runbook-textual-powershell/automation-alllogs.png)  
...
1.	Após *Add-AzureAccount*, digite *Start-AzureVM -Name 'NomeDaVM' -ServiceName 'NomeDoServiçoDaVM'*, fornecendo o nome e o nome do serviço da máquina virtual a ser iniciada. ![StartVM](media/automation-first-runbook-textual-powershell/automation-startvm.png)  
...
1.	Adicione parâmetros a *NomeDaVM* e *NomeDoServiçoDaVM* para o runbook e use essas variáveis com o cmdlet **Start-AzureVM** como na imagem a seguir. ![Adicionar parâmetro](media/automation-first-runbook-textual-powershell/automation-add-parameter.png)  
...
6.	Clique em **Iniciar** para iniciar o runbook. Digite o **NomeDaVM** e o **NomeDoServiçoDaVM** da máquina virtual que você iniciará.![Passar parâmetro](media/automation-first-runbook-textual-powershell/automation-pass-parameter.png)  
