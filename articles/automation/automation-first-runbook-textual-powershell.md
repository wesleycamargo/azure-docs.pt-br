...
1.	Adicione parâmetros a *NomeDaVM* e *NomeDoServiçoDaVM* para o runbook e use essas variáveis com o cmdlet **Start-AzureVM** como na imagem a seguir.
...
6.	Clique em **Iniciar** para iniciar o runbook. Digite o **NomeDaVM** e o **NomeDoServiçoDaVM** da máquina virtual que você iniciará.
