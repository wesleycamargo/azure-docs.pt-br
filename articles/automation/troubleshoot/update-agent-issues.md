...
Os resultados são mostrados na página quando estão prontos. As [seções de cheques](#prerequisiste-checks) mostram o que está incluído em cada cheque.
