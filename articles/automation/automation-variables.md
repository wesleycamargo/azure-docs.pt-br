...
2. Clique em **Adicionar Configuração** na parte inferior da tela.
3. Clique em **Adicionar Variável**.
4. Conclua o assistente e clique na caixa de seleção para salvar a nova variável.

### Para criar uma nova variável com o portal do Azure
1. Na sua conta de automação, clique na parte de **Ativos** para abrir a folha de **Ativos**.
2. Clique na parte de **Variáveis** para abrir a folha de **Variáveis**.
3. Clique em **Adicionar uma variável** na parte superior da folha.
4. Preencha o formulário e clique em **Criar** para salvar a nova variável.
