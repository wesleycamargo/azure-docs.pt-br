---
title: Criar contas Executar como da Automação do Azure
...
* Você cria uma conta de Automação, mas não cria a conta Executar como.
...
* Sua conta de usuário do AD deve ser adicionada a uma função com permissões equivalentes à função de Colaborador para recursos Microsoft.Automation conforme descrito no artigo [Controle de acesso baseado em função na Automação do Azure](automation-role-based-access-control.md#contributor).  
...
![Colaboradores de assinatura](media/automation-create-runas-account/automation-account-remove-subscription.png)
