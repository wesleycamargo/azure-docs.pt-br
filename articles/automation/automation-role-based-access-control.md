...
---
# <a name="rolebased-access-control-in-azure-automation"></a>Controle de acesso com base em função na Automação do Azure
## <a name="rolebased-access-control"></a>Controle de acesso baseado em função
