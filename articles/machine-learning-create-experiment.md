...
1.  Inicie um novo experimento clicando em **+NOVO** na parte inferior da janela do Estúdio AM e selecionando **EXPERIMENTO**. Renomeie o experimento de "Untitled" para algo significativo, como "Previsão de preço de automóvel".
...
2.  Selecione o módulo **Colunas do Projeto** e clique em **Ativar seletor de coluna** no painel de propriedades.
...
2.  Clique em **Ativar seletor de coluna** no painel de propriedades.
...
1.  Divida os dados em conjuntos de treinamento e teste. Selecione e arraste o módulo **Dividir** até a tela do experimento e conecte-o à porta de saída do último módulo **Colunas do Projeto**. Configure **Fração de linhas no primeiro conjunto de dados de saída** para 0,75. Desta forma, usaremos 75% dos dados para treinar o modelo e manteremos 25% para teste.
    ...
    > **Dica** - Ao alterar o parâmetro **Random seed**, é possível produzir amostras aleatórias diferentes para treinamento e teste. Esse parâmetro controla a alimentação do gerador de número pseudo-aleatório.
...
4.  Execute o experimento e visualize a saída do módulo **Avaliar Modelo** (clique duas vezes na porta de saída e selecione **exibir**). As estatísticas a seguir são mostradas para nosso modelo.
...
<!-- Images -->
  ...
  [Pesquisa de paleta]: ./media/machine-learning-create-experiment/screen1a.png
  [Conjunto de dados]: ./media/machine-learning-create-experiment/screen1.png
  [Visualização de conjunto de dados]: ./media/machine-learning-create-experiment/screen1b.png
  [Selecionar colunas]: ./media/machine-learning-create-experiment/screen3.png
  [Propriedades de Colunas do Projeto]: ./media/machine-learning-create-experiment/screen4.png
  [Propriedades do Programa de Limpeza de Valores Ausentes]: ./media/machine-learning-create-experiment/screen4a.png
  [Primeira execução do experimento]: ./media/machine-learning-create-experiment/screen5.png
  [1]: ./media/machine-learning-create-experiment/screen6.png
  [Selecione a coluna “preço"]: ./media/machine-learning-create-experiment/screen7.png
  [Aplicando o algoritmo de aprendizado]: ./media/machine-learning-create-experiment/screen8.png
