<properties title="Detalhes da configura&ccedil;&atilde;o do Farm do SharePoint Server" pageTitle="Detalhes da configura&ccedil;&atilde;o do Farm do SharePoint Server" description="Descreve a configura&ccedil;&atilde;o padr&atilde;o dos farms do SharePoint" metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="josephd" videoId="" scriptId="" manager="timlt"/>
...
Para obter informações adicionais, consulte [Farm do SharePoint Server][Farm do SharePoint Server].
