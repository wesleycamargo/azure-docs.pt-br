...
![Exibir resultados](./media/custom-event-quickstart/view-result.png)
...
![Exibição do evento de assinatura](./media/custom-event-quickstart/view-subscription-event.png)
