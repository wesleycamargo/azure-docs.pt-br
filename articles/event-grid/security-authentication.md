...
#### <a name="install-and-login-to-azure-cli"></a>Instalar e fazer logon na CLI do Azure
...
#### <a name="assign-the-role-to-a-user"></a>Atribuir a função a um usuário
