...
description: Exemplos da CLI do Azure para Grade de Eventos
services: event-grid
author: tfitzmac
manager: timlt
...
| [Inscrever-se em uma assinatura do Azure](scripts/event-grid-cli-azure-subscription.md)| Inscreve-se em eventos de uma assinatura do Azure. |
