...
Confira [Como usar o Azure PowerShell com o Azure Resource Manager](/powershell/azureps-cmdlets-docs) para obter instruções sobre como instalar e usar o Azure PowerShell.
