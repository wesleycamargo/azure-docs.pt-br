...
No exemplo a seguir, substitua <app-name> por um nome do aplicativo exclusivo.
...
Agora você vai reimplantar o aplicativo. Substitua `<app-name>` pelo seu aplicativo.
