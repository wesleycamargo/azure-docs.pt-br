...
7. Em **Login do Facebook**, clique em **Configurar** e escolha **Configurações** no painel de navegação esquerdo em **Login do Facebook**.
8. Adicione o **URI de Redirecionamento** do aplicativo aos **URIs de redirecionamento OAuth válidos**, em seguida, clique em **Salvar Alterações**.
   ...
   > 
   > 
7. No painel de navegação esquerdo, clique em **Configurações** > **Básico**. No campo **Segredo do Aplicativo**, clique em **Mostrar**, forneça sua senha se solicitado e anote os valores do **ID do aplicativo** e do **Segredo do Aplicativo**. Você os utilizará mais tarde para configurar seu aplicativo no Azure.
