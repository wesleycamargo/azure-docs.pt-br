...
- [Banco de Dados do Azure para MySQL)](https://azure.microsoft.com/en-us/services/mysql)
- [Banco de Dados do Azure para PostgreSQL](https://azure.microsoft.com/en-us/services/postgres)
