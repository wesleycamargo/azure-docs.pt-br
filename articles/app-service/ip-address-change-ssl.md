...
Este artigo explicou como se preparar para uma alteração de endereço IP que foi iniciada pelo Azure. Para obter mais informações sobre endereços IP no Serviço de Aplicativo do Azure, consulte [SSL e endereços IP SSL no Serviço de Aplicativo do Azure](app-service-ip-addresses.md).
