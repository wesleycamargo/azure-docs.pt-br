---
title: Amostra de script da CLI do Azure – Associar um certificado SSL personalizado a um aplicativo | Microsoft Docs
description: Amostra de script da CLI do Azure – Associar um certificado SSL personalizado a um aplicativo
