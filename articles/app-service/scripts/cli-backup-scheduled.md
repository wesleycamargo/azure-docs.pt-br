---
title: Amostra de script da CLI do Azure – Criar um backup agendado para um aplicativo | Microsoft Docs
description: Amostra de script da CLI do Azure – Criar um backup agendado para um aplicativo
