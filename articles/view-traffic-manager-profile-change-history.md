<properties
   pageTitle="Exibir histórico de alterações de perfil do Gerenciador de Tráfego"
   description="Este artigo o ajudará a exibir seu histórico de alterações para o perfil do Gerenciador de Tráfego."
...
[Sobre métodos de balanceamento de carga do Gerenciador de Tráfego](../about-traffic-manager-balancing-methods)
