<properties 
   pageTitle="Adicionando Serviços Móveis usando os serviços conectados no Visual Studio"
...
1. Na caixa de diálogo **Adicionar Serviço Conectado**, escolha **Serviços Móveis do Azure** e escolha o botão **Configurar**. Caso ainda não tenha entrado no Azure, talvez seja solicitado que você faça isso agora.

    ![Adicionando um Serviço Móvel do Azure](./media/vs-azure-tools-connected-services-add-mobile-services/IC797636.png)

1. Na caixa de diálogo Serviços Móveis do Azure, escolha um serviço móvel existente, caso tenha um. Se precisar criar um serviço móvel do Azure, siga o procedimento abaixo. Caso contrário, avance para a próxima etapa.
    ...
    2. Na caixa de diálogo **Criar Serviço Móvel**, você pode escolher um serviço móvel back-end JavaScript ou um serviço móvel back-end .NET na lista suspensa **Tempo de Execução**. 
  
        ![Criando um serviço móvel](./media/vs-azure-tools-connected-services-add-mobile-services/IC797638.png)

        Um serviço back-end JavaScript é simples e potente. Se você criar um serviço móvel back-end JavaScript, o código JavaScript do servidor será armazenado na nuvem, mas você pode editar scripts de servidor usando o Gerenciador de Servidores ou o portal de gerenciamento do Azure.
    ...
    1. Depois que tiver inserido todas as informações necessárias, escolha o botão **Criar** para criar o serviço móvel.
    2. O novo serviço móvel deve aparecer na lista de serviços da caixa de diálogo **Serviços Móveis do Azure**. Escolha o novo serviço móvel na lista e escolha o botão **Adicionar** para adicionar o serviço ao seu projeto.
