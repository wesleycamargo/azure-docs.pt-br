...
| Nome | Tipo | Obrigatório | Valores permitidos | Descrição |
| ------- | ---- | ---------------- | -------- | ----------- |
| level | enum | Sim | **CannotDelete** <br /> **ReadOnly** | O tipo de bloqueio a ser aplicado ao escopo. CanNotDelete permite a modificação, mas impede a exclusão, enquanto que ReadOnly impede a modificação ou exclusão. |
...
O próximo exemplo aplica um bloqueio somente leitura ao grupo de recursos.
