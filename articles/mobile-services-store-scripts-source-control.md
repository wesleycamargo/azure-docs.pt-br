<properties urlDisplayName="Store JavaScript project code in source control" pageTitle="Armazenar código de projeto no controle do código-fonte - Serviços Móveis do Azure" metaKeywords="" description="Learn how to store your server script files and modules in a local Git repo on your computer." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Store project code in source control" authors="glenga" solutions="" manager="dwrede" editor="" />

<tags ms.service="mobile-services" ms.workload="mobile" ms.tgt_pltfrm="mobile-multiple" ms.devlang="multiple" ms.topic="article" ms.date="11/21/2014" ms.author="glenga" />

<div class="dev-center-tutorial-subselector">
	<a href="/pt-br/documentation/articles/mobile-services-dotnet-backend-store-code-source-control/" title=".NET backend">Back-end do .NET</a> | <a href="/pt-br/documentation/articles/mobile-services-store-scripts-source-control/"  title="JavaScript backend" class="current">Back-end do JavaScript</a>
</div>
...
1. [Habilitar controle do código-fonte no serviço móvel].
...
Para concluir este tutorial, você já deverá ter criado um serviço móvel, concluindo o tutorial [Introdução aos Serviços Móveis Services] ou [Adicionar Serviços Móveis a um aplicativo existente] .
...
3. Na linha de comando, altere para o diretório no qual você armazenará seus scripts. For example, `cd SourceControl`.
...
##<a name="use-npm"></a>Aproveitar o código compartilhado e módulos do Node. js em seus scripts de servidor
...
3. Localize o  
	...
	<p>Quando <code>node_modules</code> já existe na hierarquia de diretórios, NPM criará aí o subdiretório <code>\node-uuid</code> em vez de criar um novo <code>node_modules</code> no repositório. Nesse caso, simplesmente exclua o diretório <code>node_modules</code> existente.</p>
	</div>
