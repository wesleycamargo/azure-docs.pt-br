<properties linkid="develop-php-how-to-guides-web-sso" urlDisplayName="SSO da Web" pageTitle="Logon único com o Active Diretory do Azure (PHP)" metaKeywords="aplicativo web PHP do Azure, logon único do Azure, Active Directory PHP do Azure" description="Saiba como criar um aplicativo web PHP que usa um logon único com o Active Directory do Azure." metaCanonical="" services="active-directory" documentationCenter="PHP" title="Logon único da web com o PHP e o Active Directory do Azure" authors="waltpo" solutions="" manager="bjsmith" editor="mollybos" videoId="" scriptId="" />
...
##<a name="createapp"></a>Etapa 1: Criar um aplicativo PHP
...
7. Abra **Gerenciador do Serviços de Informações da Internet (IIS)** digitando *inetmgr* no prompt Executar e pressione Enter.

8. No Gerenciador do IIS, expanda a pasta **Sites** no menu à esquerda, clique com o botão direito do mouse em **Site Padrão** e clique em **Adicionar Aplicativo...**.

9. Na caixa de diálogo **Adicionar aplicativo**, defina o valor de **Alias** como *phpSample* e o **Caminho físico** para o caminho do arquivo onde você criou o projeto PHP.
...
##<a name="protectapp"></a>Etapa 3: Proteger o aplicativo usando o Web Services Federation para entrada de funcionários
...
1. No Eclipse, clique com o botão direito do mouse no projeto **phpSample**, clique em **Novo** e, em seguida, clique em **Arquivo**. 
...
4. No Eclipse, clique com o botão direito do mouse no projeto **phpSample**, clique em **Novo** e, em seguida, clique em **Arquivo PHP**. 
...
7. Abra a página **index.php** e atualize seu conteúdo para proteger a página e salve-a:
