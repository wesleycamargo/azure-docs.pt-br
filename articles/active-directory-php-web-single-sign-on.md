...
-   [Código de exemplo de PHP para o Active Directory do Azure][Código de exemplo de PHP para o Active Directory do Azure]
...
-   [Etapa 1: Criar um aplicativo PHP][Etapa 1: Criar um aplicativo PHP]
...
Um exemplo que mostra como usar o Active Directory do Azure e o logon único para sites PHP está disponível em <https://github.com/WindowsAzure/azure-sdk-for-php-samples/tree/master/WAAD.WebSSO.PHP>.
