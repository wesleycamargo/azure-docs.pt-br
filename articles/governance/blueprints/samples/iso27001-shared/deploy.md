...
1. Insira as informações _Básicas_ do exemplo de blueprint:
   ...
   - **Nome do blueprint**: Forneça um nome para a sua cópia do exemplo de plano gráfico de serviços compartilhados do ISO 27001.
...
|Tipos de recursos permitidos|Atribuição de política|Tipos de recursos permitidos|Lista de tipos de recursos permitidos para ser implantado. Essa lista é composta de todos os tipos de recursos implantados em serviços compartilhados.|
|SKUs de contas de armazenamento permitidas|Atribuição de política|Permitido SKUs de armazenamento|Lista de diagnóstico registra permitidos de SKUs de conta de armazenamento. Valor padrão é _["Standard_LRS"]_.|
|SKUs de máquinas virtuais permitidas|Atribuição de política|Lista de SKUs de máquina virtual pode ser implantado. Default value is _["Standard_DS1_v2", "Standard_DS2_v2"]_.|
...
|Grupo de recursos do Jumpbox|Grupo de recursos|Local padrão|**Bloqueado** -usa o parâmetro de especificações técnicas.|
...
|Grupo de recursos do Active Directory Domain Services|Grupo de recursos|Local padrão|**Bloqueado** -usa o parâmetro de especificações técnicas.|
