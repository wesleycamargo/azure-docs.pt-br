---
title: Consultas do Gráfico de Recurso do Azure Inicial
description: Use o Gráfico de Recurso do Azure para executar algumas consultas iniciais.
...
ms.locfileid: "46965544"
---
# <a name="starter-resource-graph-queries"></a>Consultas do Microsoft Azure Active Directory Graph

A primeira etapa para consultas de reconhecimento com o Microsoft Azure Active Directory Graph é uma compreensão básica da [Linguagem de Consulta](../concepts/query-language.md). Se você já não estiver familiarizado com KQL, é recomendável revisar os conceitos básicos para entender como compor solicitações para os recursos que está procurando.
