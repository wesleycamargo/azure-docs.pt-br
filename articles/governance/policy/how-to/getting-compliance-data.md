...
O exame dá suporte à avaliação de recursos em uma assinatura ou em um grupo de recursos. Inicie um exame para o escopo desejado com um comando **POST** da API REST usando as seguintes estruturas de URI:
