---
title: Exemplo do Azure Policy – negar camadas de acesso esporádico para contas de armazenamento
description: Essa política de exemplo proíbe o uso de camadas de acesso esporádico para contas de armazenamento de blobs.
