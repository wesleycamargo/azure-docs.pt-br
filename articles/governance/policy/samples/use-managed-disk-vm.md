---
title: Exemplo de Azure Policy – Criar VM usando disco gerenciado
description: Essa política de exemplo exige que as máquinas virtuais usem discos gerenciados.
...
- Examine mais amostras em [Exemplos do Azure Policy](index.md)