---
title: Exemplo de política do Azure - local de peering permitido para o Express Route
description: Essa política requer que os Express Routes usem locais de emparelhamentos especificados.
...
ms.locfileid: "46946911"
---
# <a name="allowed-peering-location-for-express-route"></a>Local de emparelhamento permitido para Express Route

Essa política requer que os Express Routes usem locais de emparelhamentos especificados. Especifique uma matriz de locais de emparelhamentos permitidos.
...
- Examine mais amostras no [exemplos do Azure Policy](index.md)