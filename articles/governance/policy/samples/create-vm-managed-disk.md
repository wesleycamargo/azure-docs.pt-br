---
title: Exemplo – auditar VM não usando disco gerenciado
description: Esta definição de exemplo JSON audita quando uma máquina virtual que não usa discos gerenciados é criada.
...
ms.locfileid: "57537721"
---
# <a name="sample---audit-when-vm-does-not-use-managed-disk"></a>Amostra – Auditar quando a VM não usar disco gerenciado
