---
title: Exemplo do Azure Policy – tipos de recurso não permitidos
description: Essa política de exemplo proíbe a implantação dos tipos de recursos especificados.
