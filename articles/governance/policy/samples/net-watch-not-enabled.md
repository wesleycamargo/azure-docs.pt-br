---
title: Exemplo de Azure Policy – Auditar se o Observador de Rede não está habilitado para a região
description: Esta política de exemplo audita se o Observador de Rede não está habilitado para uma região especificada
...
ms.locfileid: "46971290"
---
# <a name="audit-if-network-watcher-is-not-enabled-for-region"></a>Auditar se o Observador de Rede não está habilitado para a região
