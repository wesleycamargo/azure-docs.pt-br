<properties pageTitle="Autorização no lado do serviço (Windows Phone) | Centro de desenvolvimento móvel" metaKeywords="" description="Saiba como autorizar usuários no back-end .NET dos Serviços Móveis do Azure." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="glenga" solutions="" manager="dwrede" editor="" />
