...
<div class="dev-center-tutorial-selector sublanding">
    ...
    <a href="/en-us/documentation/articles/mobile-services-windows-store-javascript-get-started-push" title="Windows Store JavaScript" class="current">JavaScript da Windows Store</a>
...
[Introdução aos dados]: /en-us/develop/mobile/tutorials/get-started-with-data-js/
...
[Referência conceitual do tutorial HTML/JavaScript de Serviços Móveis]: /en-us/develop/mobile/how-to-guides/work-with-html-js-client/
