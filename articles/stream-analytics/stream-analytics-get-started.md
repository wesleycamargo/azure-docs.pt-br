---
title: "Introdução ao Stream Analytics: detecção de fraudes em tempo real | Microsoft Docs"
...
## <a name="create-an-azure-event-hubs-input-and-consumer-group"></a>Criar uma entrada de Hubs de Eventos do Azure e um Grupo de Consumidores
...
## <a name="configure-and-start-event-generator-application"></a>Configurar e iniciar o aplicativo gerador de evento
...
2. Substitua os valores Microsoft.ServiceBus.ConnectionString e EventHubName em **telcodatagen.exe.config** pela cadeia de conexão e pelo nome do Hub de Eventos.
   ...
   **Observação**: a cadeia de conexão copiada do Portal do Azure coloca o nome da conexão no final. Remova ";EntityPath =<value>" de add key= field.
...
## <a name="create-stream-analytics-job"></a>Criar um trabalho de Stream Analytics
...
1. No trabalho do Stream Analytics, clique em **Entradas** na parte superior da página e clique em **Adicionar Entrada**. A caixa de diálogo que se abre orientará você por algumas etapas para configurar sua entrada.
...
#### <a name="passthrough-query"></a>Consulta de passagem
