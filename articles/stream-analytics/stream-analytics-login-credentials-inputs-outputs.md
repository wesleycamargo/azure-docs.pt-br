...
2. ![elementográfico35][graphic35]
3. Você obterá a seguinte confirmação:  
4. ![elementográfico36][graphic36]
5. Clique no comando Salvar e confirme o salvamento das alterações:   
   ![elementográfico37][graphic37]
6. Um teste de conexão será automaticamente iniciado quando você salvar as alterações, verifique se ele é aprovado.
7. Prossiga para a Parte 4.
