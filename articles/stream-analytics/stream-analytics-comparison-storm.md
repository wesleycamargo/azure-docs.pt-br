...
<table border="1" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            ...
            <td width="204" valign="top">
                <p>
Nº O Stream Analytics do Azure é uma oferta de propriedade da Microsoft.
                </p>
            </td>
            <td width="246" valign="top">
                <p>
...
Sim. O Stream Analytics fornece uma linguagem SQL para criar transformações.
            ...
            <td width="246" valign="top">
                <p>
Nº Os usuários devem escrever código em Java ou C# ou então usar APIs do Trident.
                </p>
            </td>
        </tr>
        <tr>
