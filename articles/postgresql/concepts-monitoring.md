---
title: Monitoramento no Banco de Dados do Azure para PostgreSQL | Microsoft Docs
description: "Este artigo descreve as métricas para monitoramento e alertas para Banco de Dados do Azure para PostgreSQL, incluindo CPU, limites, armazenamento e estatísticas de conexão."
services: postgresql
author: rachel-msft
ms.author: raagyema
manager: jhubbard
