...
description: Descreve como extrair um banco de dados PostgreSQL para um arquivo de despejo e restaurar de um arquivo criado por pg_dump no banco de dados do Azure para PostgreSQL – servidor único.
author: rachel-msft
ms.author: raagyema
