...
description: Este artigo descreve os tipos de preço no Banco de Dados do Azure para PostgreSQL.
services: postgresql
author: jan-eng
ms.author: janeng
manager: kfile
