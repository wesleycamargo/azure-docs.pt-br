...
Quando você estiver pronto para obter uma conta do Twilio, inscreva-se em [Experimentar o Twilio][Experimentar o Twilio]. Você pode começar com uma conta gratuita e atualizá-la depois.
...
Um aplicativo PHP que usa o serviço da Twilio e está em execução no Azure não é diferente de qualquer outro aplicativo PHP que usa o serviço da Twilio. Embora os serviços da Twilio sejam baseados em REST e possam ser chamados no PHP de várias maneiras, este artigo se concentra em como usar os serviços da Twilio com a [Biblioteca da Twilio para PHP no Github][Biblioteca da Twilio para PHP no Github]. Para obter mais informações sobre como usar a biblioteca da Twilio para PHP, consulte [][]<http://readthedocs.org/docs/twilio-php/en/latest/index.html></a>.
...
Para obter mais informações, consulte [][1]<https://github.com/twilio/twilio-php/blob/master/README.md></a>.
...
-   **Observação**: Para solucionar problemas de erros de validação do certificado SSL, consulte [][2]<http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html></a>
...
Quando o aplicativo inicia uma chamada para a API da Twilio, a Twilio enviará a solicitação a uma URL que deve retornar uma resposta TwiML. O exemplo acima usa a URL fornecida pela Twilio [][3]<http://twimlets.com/message></a>. (Embora o TwiML tenha sido criado para uso da Twilio, você pode exibi-lo em seu navegador. Por exemplo, clique em [][3]<http://twimlets.com/message></a> para ver um elemento `<Response>` vazio; como outro exemplo, clique em [][4]<http://twimlets.com/message?Message%5B0%5D=Hello%20World></a> para ver um elemento `<Response>` que contém um `<Say>`.)
...
Para obter mais informações sobre TwiML, consulte [][5]<https://www.twilio.com/docs/api/twiml></a>.
...
-   [Código de exemplo e guias de procedimentos do Twilio][Código de exemplo e guias de procedimentos do Twilio]
...
-   [Fale com o suporte do Twilio][Fale com o suporte do Twilio]
  ...
  [Experimentar o Twilio]: https://www.twilio.com/try-twilio
  ...
  [Como fazer uma chamada telefônica usando a Twilio em um aplicativo PHP no Azure]: http://windowsazure.com/pt-br/documentation/articles/partner-twilio-php-make-phone-call
  ...
  [Código de exemplo e guias de procedimentos do Twilio]: http://www.twilio.com/docs/howto
