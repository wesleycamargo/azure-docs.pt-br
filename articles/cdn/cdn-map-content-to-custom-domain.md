...
- Em seu navegador, navegue até o endereço do blob usando o domínio personalizado. Por exemplo, se seu domínio personalizado for **cdn.meudominio.com**, a URL para um blob armazenado em cache será semelhante à seguinte URL:  
