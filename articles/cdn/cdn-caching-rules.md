...
> [!NOTE] 
> As regras de cache estão disponíveis apenas para **CDN Standard do Azure do Verizon** e **CDN Standard do Azure da Akamai**. Para **CDN Premium do Azure da Verizon**, é possível usar o [mecanismo de regras da CDN do Azure](cdn-rules-engine.md) no portal **Gerenciar** para uma funcionalidade semelhante.
