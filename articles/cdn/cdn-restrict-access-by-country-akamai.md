...
> [!IMPORTANT]
> Os produtos Verizon e Akamai fornecem a mesma funcionalidade de filtragem geográfica, mas a interface do usuário é diferente. Este documento descreve a interface para a **CDN Standard do Azure da Akamai**. Para filtragem geográfica com a **CDN Standard/Premium do Azure da Verizon**, consulte [Restringir o acesso ao seu conteúdo por país – Verizon](cdn-restrict-access-by-country.md).
> 
> 
...
Selecione os países que você deseja bloquear ou permitir para o caminho. Para obter mais informações, confira [Azure CDN from Akamai Country Codes](https://msdn.microsoft.com/library/mt761717.aspx) (CDN do Azure nos Códigos de país Akamai).
...
O recurso **Filtragem geográfica** usa códigos de país para definir os países nos quais uma solicitação será permitida ou bloqueada para um diretório protegido. Você encontrará os códigos de país na [Azure CDN from Akamai Country Codes](https://msdn.microsoft.com/library/mt761717.aspx) (CDN do Azure nos Códigos de país Akamai). 

## <a name="a-idconsiderationsaconsiderations"></a><a id="considerations"></a>Considerações
* Pode levar alguns minutos para que as alterações em sua configuração de filtragem do país entrem em vigor.
