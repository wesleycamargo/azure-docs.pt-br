---
title: Alertas em tempo real da CDN do Azure | Microsoft Docs
...
7. Na lista suspensa **Tipo de Mídia**, selecione **Objeto Grande HTTP**.
   ...
   > [!IMPORTANT]
   > Você deve selecionar **Objeto Grande HTTP** como o **Tipo de Mídia**. As outras opções não são usadas pela **CDN do Azure da Verizon**. Se **Objeto Grande HTTP** não for selecionado, isso fará com que o alerta nunca seja disparado.
   > 
   > 
