...
> * [Standard da Akamai](cdn-restrict-access-by-country-akamai.md)
> 
> 
...
> [!IMPORTANT]
> Os produtos Verizon e Akamai fornecem a mesma funcionalidade de filtragem geográfica, mas a interface do usuário é diferente. Este documento descreve a interface para a **CDN Standard do Azure do Verizon** e a **CDN Premium do Azure da Verizon**. Para filtragem geográfica com a **CDN Standard do Azure do Akamai**, consulte [Restringir o acesso ao seu conteúdo por país – Akamai](cdn-restrict-access-by-country-akamai.md).
> 
> 
...
O recurso **Filtragem geográfica** usa códigos de país para definir os países nos quais uma solicitação será permitida ou bloqueada para um diretório protegido. Você encontrará os códigos do país na [CDN do Azure a partir dos Códigos do País Verizon](https://msdn.microsoft.com/library/mt761717.aspx). Se você especificar "UE" (Europa) ou "AP" (Ásia/Pacífico), um subconjunto de endereços IP originados de qualquer país dessas regiões será bloqueado ou permitido.
