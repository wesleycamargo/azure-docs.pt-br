...
Use essa API para obter recomendações para compra de instâncias reservadas de VM. As recomendações são projetadas para permitir que os clientes analisem a economia de custos esperada e os valores de compra. 
