...
Se você tiver uma assinatura do Office 365, use sua conta do Office 365 para criar uma assinatura do Azure. Você pode entrar no [portal do Azure](https://portal.azure.com/) sem uma assinatura do Azure usando seu nome de usuário do Office 365 e a senha. Mas se você desejar configurar máquinas virtuais ou usar outros serviços do Azure, deverá criar uma assinatura do Azure para sua conta. Se você faz parte de uma organização que deseja usar os serviços do Azure, adicione outras pessoas de sua organização à assinatura após sua criação.  
...
## <a name="get-an-azure-subscription-by-using-your-office-365-account"></a>Obter uma assinatura do Azure usando sua conta do Office 365

Para inscrever-se no Azure, use o link gratuito do Azure e inscreva-se no Azure usando seu nome de usuário e a senha do Office 365. 

1. Acesse [Azure.com](https://azure.microsoft.com/). 
2. Clique em **Iniciar gratuitamente**.
3. Conecte-se usando seu nome de usuário e a senha do Office 365. A conta usada não precisa ter permissões de administrador. Se você tiver mais de uma conta do Office 365, lembre-se de usar as credenciais da conta do Office 365 que você deseja associar à sua assinatura do Azure. 
...
4. Insira as informações necessárias e conclua o processo de inscrição.
