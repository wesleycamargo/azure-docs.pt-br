...
Certifique-se de fazer efetuar logon como o administrador correto. Um Administrador da Conta pode acessar apenas o Centro de Contas. Os SAs (Administradores de Serviços) e CAs (Coadministradores) têm permissão de acesso apenas ao Portal do Azure ou ao Portal clássico do Azure.
