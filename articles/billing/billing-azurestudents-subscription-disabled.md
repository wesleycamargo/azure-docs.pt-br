...
O crédito do Azure for Students expira no final de 12 meses. Quando seu crédito expirar, o Azure desabilitará sua assinatura. Para continuar usando os serviços do Azure, você deve atualizar sua assinatura para uma assinatura Pré-paga entrando em contato com o [suporte do Azure](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade) e fornecendo as informações de cartão de crédito. Depois do upgrade, o Azure cobra tarifas pré-pagas pelos serviços que você está usando.


## <a name="you-have-accidentally-canceled-your-subscription"></a>Você cancelou acidentalmente sua assinatura

Se tiver cancelado acidentalmente a assinatura do Azure for Students, você pode reativá-la entrando em contato com o [suporte do Azure](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade). Após a reativação, você ainda terá acesso ao crédito restante e aos serviços gratuitos por 12 meses a contar da sua data de inscrição.
