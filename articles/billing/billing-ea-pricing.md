---
title: Exiba os preços do Azure para sua empresa|Microsoft Docs
description: Saiba como exibir e baixar os preços ou estimar custos com os preços do Contrato Enterprise.
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "53090849"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>Ver os preços do Contrato do Azure Enterprise da sua organização 

Os clientes do Azure com um Contrato Enterprise (EA) podem visualizar e fazer o download de preços do EA no portal do Azure. Você também pode usar os preços de EA da organização para estimar custos usando a calculadora de preços do Azure.
...
## <a name="estimate-costs-with-ea-pricing"></a>Estimar os custos com o preço de EA
...
- [Entenda sua fatura para clientes do Azure com um Contrato Enterprise](billing-understand-your-bill-ea.md)
