...
1. Entre no [Centro de Contas do Azure](https://account.windowsazure.com/) como o administrador da conta e clique em **Perfil**. 
...
Saiba como atualizar suas informações de cobrança em [Alterar o cartão de crédito usado para pagar uma assinatura do Azure](billing-how-to-change-credit-card.md).
