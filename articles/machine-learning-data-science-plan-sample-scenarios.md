<properties
	pageTitle="Passo a passo do Processo de Ciência de Dados na Nuvem | Azure" 
	description="Passo a passo do Processo de Ciência de Dados na Nuvem" 
	metaKeywords="" 
...
# Processo de Ciência de Dados na Nuvem para o Aprendizado de Máquina do Azure

Este artigo percorre o mapa do Processo de Ciência de Dados na Nuvem e alguns cenários de exemplo de origem e destino de dados. Ele ilustra algumas das opções e sequências de processamento com base nas características dos dados, local de origem e repositórios de destino no Azure. O fluxo do Processo de Ciência de Dados na Nuvem para os cenários de exemplo é resumido na última seção.

[AZURE.INCLUDE [machine-learning-free-trial](../includes/machine-learning-free-trial.md)]

**Para todos os cenários, será necessário:**
...
- [Cenário 1: conjunto de dados tabular pequeno a médio em arquivos locais](#smalllocal)
- [Cenário 2: conjunto de dados pequeno a médio em arquivos locais, que exige processamento](#smalllocalprocess)
- [Cenário 3: conjunto de dados grande em arquivos locais, com blobs do Azure como destino](#largelocal)
- [Cenário 4: conjunto de dados pequeno a médio em arquivos locais, com o SQL Server na VM do Azure como destino](#smalllocaltodb)
- [Cenário 5: conjunto de dados grande em arquivos locais, com o SQL Server na VM do Azure](#largelocaltodb)
- [Cenário 6: conjunto de dados grande em um banco de dados do SQL Server local, com o SQL Server na VM do Azure como destino](#largedbtodb)
- [Cenário 7: Big Data em arquivos locais, com um banco de dados Hive em clusters Hadoop do Azure HDInsight como destino](#largedbtohive)
...
Resumo dos cenários de exemplo
------------------------

O diagrama a seguir resume os cenários descritos acima e as opções de Processo de Ciência de Dados na Nuvem selecionadas em cada cenário. Observe que o processamento de dados, exploração, engenharia de recursos e amostragem podem ocorrer em um ou mais métodos/ambientes – no ambiente de origem, intermediário e/ou de destino - e podem continuar iterativamente conforme necessário. O diagrama serve somente como ilustração de alguns dos possíveis fluxos.
