...
ms.locfileid: "23069096"
---
<div class="content">
   <h1>Docker no Azure</h1>   
    <div class="introHolder" style="justify-content: space-between;">
    <div class="intro" style="min-width: 200px">O 
     <img src="media/Docker.png" align="right" alt="Docker Logo"> Docker é uma plataforma popular de geração de imagens e gerenciamento de contêineres que permite que você trabalhe rapidamente com contêineres no Linux (e também no Windows).  Saiba como aproveitar o Docker no Azure com nossos guias de início rápido e tutoriais.
    </div>
    </div>
...
<ol>
  ...
  <li><a href="/azure/container-service/container-service-docker-swarm-mode-setup-ci-cd-acs-engine">CI/CD com Docker Swarm e Visual Studio Team Services</a></li>
