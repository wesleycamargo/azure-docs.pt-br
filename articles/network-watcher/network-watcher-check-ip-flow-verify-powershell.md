...
Execute o cmdlet `Test-AzureRmNetworkWatcherIPFlow` para testar o tráfego. Neste exemplo, é usado o primeiro endereço IP no primeiro adaptador de rede.
