...
Localizar se determinado tráfego é permitido dentro ou fora de sua VM visitando [Verificar o fluxo de IP](diagnose-vm-network-traffic-filtering-problem.md)
