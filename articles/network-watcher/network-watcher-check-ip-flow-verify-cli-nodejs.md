...
O endereço IP de um adaptador de rede na máquina virtual é necessário. Recupere os adaptadores de rede de uma máquina virtual com o comando a seguir. Se você já souber o endereço IP que você deseja testar na máquina virtual, você pode ignorar esta etapa.
...
Execute o cmdlet `network watcher ip-flow-verify` para testar o tráfego. Neste exemplo, é usado o primeiro endereço IP do primeiro adaptador de rede:
