...
## [Visualizar os logs de fluxo no Azure usando Graylog](network-watcher-analyze-nsg-flow-logs-graylog.md)
...
## [Analisar logs de fluxo usando o Observador de Rede e Grafana](network-watcher-nsg-grafana.md)
# Referência
