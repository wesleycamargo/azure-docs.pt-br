<properties linkid="develop-media-services-how-to-guides-encode-an-asset" urlDisplayName="Como codificar um ativo" pageTitle="Como codificar um ativo dos Serviços de Mídia - Azure" metaKeywords="" description="Saiba como usar o Codificador de Mídia do Azure para codificar conteúdo de mídia nos Serviços de Mídia. Os exemplos de código são escritos em C# e usam o SDK dos Serviços de Mídia para .NET." metaCanonical="" services="media-services" documentationCenter="" title="Como codificar um ativo" authors="migree" solutions="" manager="" editor="" />


#Como codificar um ativo
Este artigo faz parte de uma série de introdução à programação dos Serviços de Mídia do Azure. O tópico anterior foi [Como obter um processador de mídia](http://go.microsoft.com/fwlink/?LinkID=301732&ampclcid=0x409).
...
O método a seguir carrega um único ativo e cria um trabalho para codificar o ativo para MP4 usando a predefinição "H264 Broadband 720p" que irá criar um único MP4 usando codificação H264 em resolução 720p:
<pre><code>
...
##Próximas etapas
Agora que você sabe como criar um trabalho para codificar um ativo, vá para o tópico [Como verificar o andamento do trabalho com os Serviços de Mídia](http://go.microsoft.com/fwlink/?LinkID=301737&ampclcid=0x409).
