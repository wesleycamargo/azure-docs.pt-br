...
>[AZURE.NOTE] Ambas as arquiteturas exigem um controlador de domínio. No entanto, com o espelhamento de banco de dados, é possível usar certificados de servidor para eliminar a necessidade de um controlador de domínio.
