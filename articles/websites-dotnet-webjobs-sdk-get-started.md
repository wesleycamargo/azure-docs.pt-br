<properties pageTitle="Introdução ao SDK de Trabalhos Web do Azure" metaKeywords="tutorial do Azure, tutorial de Trabalhos Web do Azure, tutorial de várias camadas do Azure, tutorial de MVC, tutorial de blobs do Azure, tutorial de filas do Azure, tutorial de armazenamento do Azure" description="Saiba como criar um aplicativo de múltiplas camadas usando ASP.NET MVC e o Azure. O front-end é executado em um site e o back-end é executado como um trabalho de Web. O aplicativo usa o Entity Framework, banco de dados SQL e filas do armazenamento do Azure e blobs." metaCanonical="" services="web-sites,storage" documentationCenter=".NET" title="Get Started with the Azure WebJobs SDK" authors="tdykstra" solutions="" manager="wpickett" editor="mollybos" />
