<properties linkid="manage-services-hdinsight-connect-excel-with-hive-ODBC" urlDisplayName="Conectar o Excel ao HDInsight" pageTitle="Conectar o Excel ao HDInsight com o driver ODBC do Hive | Azure" metaKeywords="" description="Saiba como configurar e usar o driver ODBC do Microsoft Hive para Excel para consultar dados em um cluster HDInsight." metaCanonical="" services="hdinsight" documentationCenter="" title="Conectar o Excel ao HDInsight com o driver ODBC do Microsoft Hive" authors="bradsev" solutions="" manager="paulettm" editor="cgronlun" />
...
3. [Importar dados no Excel de um cluster HDInsight](#ImportData)
...
5. Digite ou selecione os valores a seguir:
	...
	<tr><td>Host</td><td>Digite <HDInsightClusterName>.azurehdinsight.net. Por exemplo, myHDICluster.azurehdinsight.net</td></tr>
	...
	<tr><td>Mecanismo</td><td>Selecione <strong>Serviço do HDInsight do Azure</strong></td></tr>
	<tr><td>Caminho HTTP</td><td>Deixe em branco.</td></tr>
	<tr><td>Nome de Usuário</td><td>Insira o nome do usuário do cluster HDInsight. Esse é o nome de usuário criado durante o processo de provisionamento do cluster. Se você tiver usado a opção de criação rápida, o nome de usuário padrão será <strong>admin</strong>.</td></tr>
	<tr><td>Senha</td><td>Digite a senha do usuário do cluster HDInsight.</td></tr>
	</table>

	Há alguns parâmetros importantes a serem lembrados ao clicar em **Opções Avançadas**.

	<table border="1">
	<tr><td>Usar Consulta Nativa</td><td>Quando estiver selecionada, o driver ODBC NÃO tentará converter TSQL em HiveQL. Você deverá usar essa opção somente se estiver 100% certo de que está enviando instruções HiveQL puras. Ao conectar-se ao SQL Server ou ao Banco de Dados SQL Azure, deixe-a desmarcada.</td></tr>
	...
	<tr><td>Comprimento da coluna de cadeia de caracteres padrão, <br/>
			Comprimento da coluna binária,  <br/>
			Escala da coluna decimal</td><td>Os comprimentos e as precisões dos tipos de dados podem afetar a maneira como os dados são retornados. Eles farão com que informações incorretas sejam retornadas devido à perda de precisão e/ou truncamento.</td></tr>
	</table>
...
4. Em Fontes de dados ODBC, selecione o nome da fonte de dados que você criou na etapa anterior e, em seguida, clique em **Avançar**.
5. Digite novamente a senha do cluster no assistente e, em seguida, clique em **Testar** para verificar a configuração
6. Clique em **OK** para fechar a caixa de diálogo de teste.
...
8. Selecione a tabela que deseja importar e clique em **Avançar**. A *hivesampletable* é uma tabela hive de exemplo que é fornecida com os clusters HDInsight.  Você pode escolhê-la se ainda não tiver criado uma. Para obter mais informações sobre como executar consultas Hive e criar tabelas Hive, consulte [Usar o Hive com o HDInsight][hdinsight-hive].
