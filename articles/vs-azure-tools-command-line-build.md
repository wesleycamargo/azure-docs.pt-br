...
A maneira mais simples de criar um pacote é executar o MSBuild com a opção `/t:Publish` . Por padrão, esse comando cria um diretório com relação à pasta raiz do projeto, como o ProjectDir\bin\Configuration\app.publish\. Ao criar um projeto do Azure, você gera dois arquivos, o arquivo de pacote e o arquivo de configuração que o acompanha:
