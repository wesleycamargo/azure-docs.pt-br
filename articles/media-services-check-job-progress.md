<properties linkid="develop-media-services-how-to-guides-check-job-progress" urlDisplayName="Verificar o andamento do trabalho" pageTitle="Como verificar o andamento do trabalho nos Serviços de Mídia - Azure" metaKeywords="" description="Saiba como usar o código do manipulador de eventos para acompanhar o andamento do trabalho e enviar atualizações de status. Os exemplos de código são escritos em C# e usam o SDK dos Serviços de Mídia para .NET." metaCanonical="" services="media-services" documentationCenter="" title="Como verificar o andamento do trabalho" authors="migree" solutions="" manager="" editor="" />
...
Este artigo faz parte de uma série de introdução à programação dos Serviços de Mídia do Azure. O tópico anterior foi [Como codificar um ativo (a página pode estar em inglês)](http://go.microsoft.com/fwlink/?LinkID=301753&clcid=0x409).
