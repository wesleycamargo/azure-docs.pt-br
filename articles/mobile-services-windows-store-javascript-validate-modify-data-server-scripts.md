<properties linkid="develop-mobile-tutorials-validate-modify-and-augment-data-js" urlDisplayName="Validar dados" pageTitle="Usar scripts de servidor para validar e modificar os dados (JavaScript) | Mobile Dev Center" metaKeywords="" description="Saiba como validar e modificar os dados enviados usando scripts de servidor em seu aplicativo JavaScript da Windows Store." metaCanonical="http://www.windowsazure.com/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-dotnet/" services="" documentationCenter="Mobile" title="Validar e modificar dados em Serviços Móveis usando scripts de servidor" authors="" solutions="" manager="" editor="" />
...
<a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-js" title="JavaScript da Windows Store" class="current">JavaScript da Windows Store</a>
<a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-wp8" title="Windows Phone">Windows Phone</a><a href="/pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-ios" title="iOS">iOS</a>
...
<div class="dev-center-tutorial-subselector">
	<a href="/pt-br/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-validate-modify-data/" title="Back-end do .NET">Back-end do .NET</a> | 
	<a href="pt-br/documentation/articles/mobile-services-windows-store-javascript-validate-modify-data-server-scripts/"  title="Back-end do JavaScript" class="current">Back-end do JavaScript</a>
</div>
...
7. Abra o arquivo default.js e substitua o método **RefreshTodoItems** existente pelo seguinte código.
...
[Introdução à notificações por push]: /pt-br/develop/mobile/tutorials/get-started-with-push-js
