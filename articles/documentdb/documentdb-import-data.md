...
Se estiver importando dados para um banco de dados da API para MongoDB, siga as instruções em [Migrar dados para o DocumentDB com suporte de protocolo para o MongoDB](documentdb-mongodb-migrate.md).
