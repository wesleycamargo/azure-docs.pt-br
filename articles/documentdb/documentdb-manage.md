<properties 
	pageTitle="Gerenciar a capacidade do Banco de Dados de Documentos | Azure" 
...
##<a name="DBaccount"></a>Conta do banco de dados e recursos administrativos
...
Você pode criar qualquer número de coleções para atender aos requisitos de escala de armazenamento e taxa de transferência dos seus aplicativos. As coleções podem ser criadas por meio do portal de visualização do Azure ou de qualquer um dos SDKs do Banco de Dados de Documentos.
...
Para obter instruções sobre como alterar o nível de consistência no portal de visualização do Azure, consulte Como: gerenciar Configurações de Consistência do Banco de Dados de Documentos em [Como Gerenciar uma Conta do Banco de Dados de Documentos](documentdb-manage-account.md).
