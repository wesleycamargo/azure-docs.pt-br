...
6. Agora, o painel central mostra uma coluna de coordenadas do tipo **Lista**. Como mostrado no início do tutorial, os dados GeoJSON neste tutorial são do tipo Ponto com valores de Latitude e Longitude gravados na matriz de coordenadas.
	...
	O elemento coordinates[0] representa a Longitude, enquanto que coordinates[1] representa a Latitude. ![Tutorial do Power BI para conector do Power BI do Banco de Dados de Documentos — lista de coordenadas](./media/documentdb-powerbi-visualize/power_bi_connector_pbiresultflattenlist.png)
...
## Criar um painel no PowerBI.com
...
## Atualizar dados no Power BI.com
...
1. Clique em **Agendar Atualização** na lista de ações. ![Captura de tela da Atualização de Agenda no PowerBI.com](./media/documentdb-powerbi-visualize/azure-documentdb-power-bi-schedule-refresh.png)
