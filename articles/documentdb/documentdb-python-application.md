---
title: Tutorial do aplicativo Web do Python Flask do Azure DocumentDB | Microsoft Docs
...
---
# <a name="build-a-python-flask-web-application-using-documentdb"></a>Criar um aplicativo Python Flask usando o DocumentDB
