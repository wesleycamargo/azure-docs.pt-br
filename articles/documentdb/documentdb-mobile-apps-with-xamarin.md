...
![Funcionalidades do Azure Cosmos DB para aplicativos móveis](media/documentdb-mobile-apps-with-xamarin/documentdb-for-mobile.png)
...
* Taxa de transferência rápida. É necessário apenas alguns milissegundos para ler e gravar documentos com o Azure Cosmos DB. Os desenvolvedores podem especificar a produtividade de que precisam e o Azure Cosmos DB a respeitará com SLAs de 99,99%.
* Escala ilimitada. Suas coleções do Azure Cosmos DB [aumentam conforme seu aplicativo cresce](documentdb-partition-data.md). Você pode iniciar com tamanho de dados pequeno e taxa de transferência de centenas de solicitações por segundo. As coleções podem crescer até petabytes de dados e uma taxa de transferência arbitrariamente grande com centenas de milhões de solicitações por segundo.
* Distribuído globalmente. Os usuários de aplicativos móveis costumam ser em outro lugar, em todo o mundo. O Azure Cosmos DB é um [banco de dados distribuído globalmente](documentdb-distribute-data-globally.md). Clique no mapa para disponibilizar os dados para seus usuários.
...
![Início rápido do Azure Cosmos DB para aplicativos móveis](media/documentdb-mobile-apps-with-xamarin/documentdb-quickstart.png)
...
![Agente de usuários e permissões do Azure Cosmos DB](media/documentdb-mobile-apps-with-xamarin/documentdb-resource-token-broker.png)
...
![Produtividade de escala do Azure Cosmos DB sob demanda](media/documentdb-mobile-apps-with-xamarin/documentdb-scale.png)
...
![Escala do Azure Cosmos DB entre regiões geográficas](media/documentdb-mobile-apps-with-xamarin/documentdb-replicate-globally.png)
...
* Saiba mais sobre o [suporte geoespacial no Azure Cosmos DB](documentdb-geospatial.md).
