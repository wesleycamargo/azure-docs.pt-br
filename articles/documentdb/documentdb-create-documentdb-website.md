...
Este tutorial mostra como usar um modelo do Azure Resource Manager para implantar e integrar o [Microsoft Azure DocumentDB](https://azure.microsoft.com/services/documentdb/), um aplicativo Web do [Serviço de Aplicativo do Azure](http://go.microsoft.com/fwlink/?LinkId=529714) e um aplicativo Web de exemplo.
...
> [!TIP]
> O modelo não valida se o nome do aplicativo Web e o nome da conta do Banco de Dados de Documentos inseridos abaixo são a)válidos e b)disponíveis.  É altamente recomendável que você verifique a disponibilidade dos nomes que planeja fornecer antes de enviar a implantação.
> 
> 
...
7. Quando a implantação for concluída, a folha do Grupo de recursos será aberta.
   ![Captura de tela da folha Grupo de recursos](./media/documentdb-create-documentdb-website/TemplateDeployment7.png)  
...
9. Vá em frente e crie algumas tarefas no aplicativo Web. Clique no recurso de conta do DocumentDB na lista de Recursos e, em seguida, clique em **Gerenciador de Consultas**.
    ![Captura de tela da lente de Resumo com o aplicativo Web myotherdocumentdbwebapp realçado](./media/documentdb-create-documentdb-website/TemplateDeployment8.png)  
