---
title: Usar o MongoChef com uma conta do Banco de Dados de Documentos com suporte de protocolo para MongoDB | Microsoft Docs
...
5. Na janela **Nova Conexão**, na guia **SSL**, marque a caixa de seleção **Usar protocolo SSL para se conectar** e o botão de opção **Aceitar certificados SSL autoassinados**.
