...
2. Na janela **Nova Conexão**, na guia **Servidor**, insira o HOST (FQDN) da conta do DocumentDB com suporte de protocolo para o MongoDB e o PORT.
...
3. Na janela **Nova Conexão**, na guia **Autenticação**, escolha o Padrão do Modo de Autenticação **(MONGODB-CR ou SCARM-SHA-1)** e insira USERNAME e PASSWORD.  Aceite o banco de dados de autenticação padrão (admin) ou forneça seu próprio valor.
