...
Este artigo é uma introdução ao funcionamento da indexação automática no Banco de Dados de Documentos e foi retirado do documento “Indexação agnóstica do esquema com o Banco de Dados de Documentos do Azure”, que será apresentado na [Conferência VLDB de 2015](http://www.vldb.org/2015/). Depois de ler este artigo, você poderá responder às seguintes perguntas:
...
##<a id="HowDocumentDBIndexingWorks"></a> Como funciona a indexação do Banco de Dados de Documentos
...
- No exemplo acima, a propriedade JSON `{"headquarters": "Belgium"}` corresponde ao caminho /headquarters/Belgium.
...
- Agora que você viu como a indexação funciona, saiba como [Consultar com o SQL do Banco de Dados de Documentos](documentdb-sql-query.md)
