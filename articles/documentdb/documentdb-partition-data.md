...
O Azure Cosmos DB adicionou suporte ao particionamento automático na [API REST versão 2015-12-16](https://msdn.microsoft.com/library/azure/dn781481.aspx). Para criar contêineres particionados, você deve baixar versões do SDK 1.6.0 ou mais novas em uma das plataformas do SDK com suporte (.NET, Node.js, Java, Python, MongoDB). 
...
* Executar testes de desempenho e escala com o DB Cosmos. Consulte [Teste de desempenho e escala com o DB Cosmos do Azure](documentdb-performance-testing.md) para obter um exemplo.
...
* Saiba mais sobre a [produtividade provisionada no DB Cosmos do Azure](documentdb-request-units.md)
