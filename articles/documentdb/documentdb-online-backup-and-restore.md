...
![Backups completos periódicos de todas as entidades do Cosmos DB no Armazenamento do Azure GRS](./media/documentdb-online-backup-and-restore/azure-documentdb-nosql-database-automatic-backup.png)
...
Para replicar o banco de dados em vários data centers, consulte [Distribuir os dados globalmente com o Cosmos DB](documentdb-distribute-data-globally.md). 
