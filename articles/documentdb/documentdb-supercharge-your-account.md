---
title: Incremente sua conta S1 de Banco de Dados de Documentos | Microsoft Docs
...
2. Clique em **Procurar** -> **DocumentDB(NoSQL)** e selecione a conta do DocumentDB a ser modificada.
...
4. Na folha **Coleção**, clique em **Mais** e, em seguida, clique em **Configurações**.
...
6. De volta na folha **Configurações**, o **Tipo de Preço** foi alterado para **Standard** e a caixa **Produtividade (RU/s)** é exibida com um valor padrão de 400. Clique em **OK** para salvar as alterações.
   
   > [!NOTE]
   > Você pode definir a taxa de transferência entre 400 e 10.000 [unidades de solicitação](documentdb-request-units.md)/segundo (RUS/s). O **Resumo de Preços** na parte inferior da página é atualizado automaticamente para fornecer uma estimativa do custo mensal.
   > 
   > 
