...
Saiba como trabalhar com chaves e níveis de consistência. Além disso, saiba como excluir uma conta no Portal do Azure.
...
Observe que a folha **Chaves** também inclui cadeias de conexão primárias e secundárias que podem ser usadas para se conectar à sua conta na [Ferramenta de Migração de Dados](documentdb-import-data.md).
