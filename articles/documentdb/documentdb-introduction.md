...
-	**Taxa de transferência e armazenamento elasticamente escalonável:** escale ou reduza verticalmente o banco de dados JSON Banco de Dados de Documentos facilmente para atender às necessidades do seu aplicativo. A escala é realizada através de unidades refinadas (coleções) de armazenamento com suporte de SSD reservado e taxa de transmissão. Você pode escalar elasticamente o Banco de Dados de Documentos com desempenho previsível criando mais unidades, à medida que seu aplicativo cresce.
