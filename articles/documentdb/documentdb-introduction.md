---
title: Introdução ao Banco de Dados de Documentos, um banco de dados JSON | Microsoft Docs
...
## Quais são os principais recursos oferecidos pelo DocumentDB?
