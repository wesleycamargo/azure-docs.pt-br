...
Além dos tipos básicos, muitos aplicativos precisam do tipo [DateTime](https://msdn.microsoft.com/library/system.datetime(v=vs.110).aspx) para representar datas e carimbos de data/hora. Este artigo descreve como os desenvolvedores podem armazenar, recuperar e consultar datas no Cosmos DB usando o SDK do .NET.
...
* Essa abordagem pode aproveitar o índice do Cosmos DB para um desempenho rápido de consulta.
...
Esse documento é armazenado no Cosmos DB da seguinte maneira:
...
Saiba mais sobre como configurar as políticas de indexação em [Políticas de indexação do Cosmos DB](documentdb-indexing-policies.md).
...
Saiba mais sobre a linguagem de consulta SQL do Cosmos DB e o provedor LINQ em [Consultando o Cosmos DB](documentdb-sql-query.md).

Neste artigo, analisamos como armazenar, indexar e consultar DateTimes no Cosmos DB.
