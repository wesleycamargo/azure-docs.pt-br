...
* [Provisionamento de taxa de transferência e armazenamento para uma coleção][throughputandstorage]
* [APIs de hospedagem múltipla via SDKs para REST, .NET, Java, Python e Node][developingwithmultipleregions]
* [Níveis de consistência no DocumentDB][consistency]
* [SLAs de disponibilidade][sla]
* [Gerenciando conta de banco de dados][manageaccount]
