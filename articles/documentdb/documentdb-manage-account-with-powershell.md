...
* `<default-consistency-level>` O nível de consistência padrão da conta do Azure Cosmos DB. Para obter mais informações, consulte [Níveis de consistência no Azure Cosmos DB](documentdb-consistency-levels.md).
