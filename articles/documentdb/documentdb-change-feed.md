...
![Usando o feed de alterações do Azure Cosmos DB para capacitar a análise em tempo real e cenários de computação orientada a eventos](./media/documentdb-change-feed/changefeed.png)
...
![Pipeline lambda baseado no Azure Cosmos DB para ingestão e consulta](./media/documentdb-change-feed/lambda.png)
...
![Usando o host do processador do feed de alterações do Azure Cosmos DB](./media/documentdb-change-feed/changefeedprocessor.png)
...
* Saiba mais sobre o [modelo e a hierarquia de recursos do Azure Cosmos DB](documentdb-resources.md)
