---
title: Conectando o Banco de Dados de Documentos à Pesquisa do Azure usando indexadores | Microsoft Docs
...
> [!NOTE]
> Para coleções particionadas, a chave do documento padrão é a propriedade `_rid` do Banco de Dados de Documentos, que é renomeada para `rid` na Pesquisa do Azure. Além disso, os valores `_rid` do Banco de Dados de Documentos contêm caracteres que são inválidos nas chaves de Pesquisa do Azure; portanto, os valores `_rid` são codificados na Base64.
> 
> 
