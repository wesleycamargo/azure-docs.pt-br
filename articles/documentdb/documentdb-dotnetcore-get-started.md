...
---
# <a name="nosql-tutorial-build-a-documentdb-c-console-application-on-net-core"></a>Tutorial do NoSQL: criar um aplicativo de console em C# do DocumentDB no .NET Core
...
Bem-vindo ao tutorial do NoSQL para o SDK do .NET Core do DocumentDB do Azure! Após seguir este tutorial, você terá um aplicativo de console que cria e consulta recursos de Banco de Dados de Documentos.
...
* [Visual Studio 2015 Atualização 3](https://go.microsoft.com/fwlink/?LinkId=691129) e [.NET Core 1.0.1 - VS 2015 Tooling Preview 2](https://go.microsoft.com/fwlink/?LinkID=827546)
