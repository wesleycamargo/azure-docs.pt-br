---
title: Failovers regionais no Azure Cosmos DB | Microsoft Docs
description: "Saiba mais sobre como os failovers manuais e automáticos funcionam com o Azure Cosmos DB."
services: cosmosdb
documentationcenter: 
author: arramac
manager: jhubbard
...
---
# <a name="automatic-regional-failovers-for-business-continuity-in-azure-cosmos-db"></a>Failovers regionais automáticos para a continuidade dos negócios no Azure Cosmos DB
O Azure Cosmos DB simplifica a distribuição global de dados oferecendo [contas de banco de dados em várias regiões](documentdb-distribute-data-globally.md) totalmente gerenciadas que fornecem claras compensações entre consistência, disponibilidade e desempenho, tudo com garantias correspondentes. As contas do Cosmos DB oferecem alta disponibilidade, latências de milissegundos de digito único, [níveis bem definidos de consistência](documentdb-consistency-levels.md), failover regional transparente com APIs de hospedagem múltipla e a capacidade de dimensionar de forma elástica a produtividade e o armazenamento no mundo todo. 
...
![Implantação de aplicativos globalmente distribuídos com o Azure Cosmos DB](./media/documentdb-regional-failovers/app-deployment.png)
...
![Falhas de região de leitura no Azure Cosmos DB](./media/documentdb-regional-failovers/read-region-failures.png)
...
![Prioridades de failover para o Azure Cosmos DB](./media/documentdb-regional-failovers/failover-priorities.png)
...
![Falhas de região de gravação no Azure Cosmos DB](./media/documentdb-regional-failovers/write-region-failures.png)
...
![Failovers manuais no Azure Cosmos DB](./media/documentdb-regional-failovers/manual-failovers.png)
...
* Saiba mais sobre como o Cosmos DB dá suporte à [distribuição global](documentdb-distribute-data-globally.md)
