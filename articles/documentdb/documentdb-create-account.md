...
Para usar o Banco de Dados de Documentos do Microsoft Azure, você precisará criar uma conta de banco de dados do Banco de Dados de Documentos usando o Portal do Azure.
