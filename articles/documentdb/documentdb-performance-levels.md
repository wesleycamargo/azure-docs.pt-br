...
2.    [Preços do Cosmos DB](https://azure.microsoft.com/pricing/details/documentdb/). Saiba mais sobre o custo de provisionar a taxa de transferência e consumir o armazenamento.
