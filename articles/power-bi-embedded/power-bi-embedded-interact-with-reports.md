<properties
   pageTitle="Interagir com relatórios usando a API JavaScript | Microsoft Azure"
...
# Interagir com relatórios do Power BI usando a API JavaScript

A API JavaScript do Power BI permite que você insira relatórios do Power BI com facilidade em seus aplicativos. Com a API, seus aplicativos podem interagir programaticamente com elementos de relatório diferente como páginas e filtros. Essa interatividade faz com que os relatórios do Power BI sejam uma parte mais integrada do seu aplicativo.
...
O iframe torna o processo de incorporação muito mais fácil, mas sem a API JavaScript o relatório e o seu aplicativo não podem interagir entre si. Essa falta de interação pode fazer parecer que o relatório não faz realmente parte do aplicativo. O relatório e o aplicativo realmente precisam se comunicar, como na imagem a seguir.
...
## O que você pode fazer com a API JavaScript do Power BI?
...
### Navegar pelas páginas de um relatório
