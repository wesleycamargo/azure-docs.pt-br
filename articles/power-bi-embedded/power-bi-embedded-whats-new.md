<properties
   pageTitle="Novidades no Power BI Embedded"
...
# Novidades no Power BI Embedded
...
-    SDKs de JavaScript e .NET foram atualizados para **v 1.0**.
...
-    Atualizado o aplicativo de exemplo para todas as chamadas à API da **versão 1.0**.
