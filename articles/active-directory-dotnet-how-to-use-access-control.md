<properties linkid="dev-net-how-to-access-control" urlDisplayName="Access Control" pageTitle="Como usar o Access Control (.NET) - guia de recursos do Azure" metaKeywords="Autenticação do Access Control Service Azure C#" description="Aprender a usar o Access Control Service (ACS) em seu aplicativo do Azure para autenticar os usuários quando eles tentarem obter acesso a uma aplicativo da Web." metaCanonical="" services="active-directory" documentationCenter=".NET" title="Como autenticar usuários da Web com o Access Control do Active Directory do Azure" authors=""  solutions="" writer="juneb" manager="" editor=""  />
...
<h2><span class="short-header">Índice</span>índice</h2>
...
-   [Exibir declarações enviadas pelo ACS][vcsb]
-   [Exibir o aplicativo no Portal de Gerenciamento do ACS][vpp]
-   [Adicionar um provedor de identidade][]
-   [E agora?][]

<h2><span class="short-header">O que é ACS?</span>o que é ACS?</h2>
...
-   Um serviço de gerenciamento baseado em Open Data Protocol (OData) 
     que fornece acesso programático para configurações do ACS.
...
<h2><span class="short-header">Conceitos</span>Conceitos</h2>
...
2.  Como a solicitação ainda não foi autenticada, o RP redireciona o usuário para a autoridade que ele confia, que é o ACS. O ACS apresenta 
    ao usuário a opção de IPs que foram especificados para essa RP. O 
    usuário seleciona o IP apropriado.
3.  O cliente vai para a página de autenticação do IP e solicita ao 
   usuário para fazer logon.
4.  Depois que o cliente é autenticado (por exemplo, a identidade 
   que credenciais foram inseridas), o IP emite um token de segurança.
...
<h2><span class="short-header">Pré-requisitos</span>Pré-requisitos</h2>
...
-	Identidade e ferramenta de acesso para o Visual Studio 2012 (para baixar, consulte [Ferramenta de Identidade e Acesso][]


<h2><span class="short-header">Criar um Namespace do Access Control</span>Criar um Namespace do Access Control</h2>
...
<h2><span class="short-header">Integrar seu aplicativo da Web com o ACS</span>integrar seu aplicativo da Web com o ACS</h2>
...
<h2><span class="short-header">Testar a integração com o ACS</span>Testar a integração com o ACS</h2>
...
<h2><a name="bkmk_viewClaims"></a>Exibir declarações enviadas pelo ACS</h2>
...
1. Abra o arquivo *Controllers\HomeController.cs*. Adicione uma declaração **using** para **System.Threading**

 	using System.Threading;

1. Na classe HomeController, adicione o método *Claims*:
...
1. Clique com o botão direito do mouse no método *Claims* e selecione **Adicionar Exibição**.
...
1. Execute o aplicativo e navegue para o método *Claims*:

![][666]

Para obter mais informações sobre o uso de declarações em seu aplicativo, consulte [Biblioteca Windows Identity Foundation](http://msdn.microsoft.com/pt-br/library/hh377151.aspx)

<h2><a name="bkmk_VP"></a>Exibir o aplicativo no Portal de Gerenciamento do ACS</h2>
...
<h2><span class="short-header">Adicionar um provedor de identidade</span>Adicionar um provedor de identidade</h2>
...
2.	Clique em **Google** e em **Avançar**. A caixa de seleção do aplicativo MvcACS está marcada por padrão. 
...
<h2><span class="short-header">E agora</span>E agora</h2>
...
Para explorar melhor a funcionalidade do ACS e experimentar mais cenários, consulte [Access Control Service 2.0].
  ...
  [Exibir o aplicativo no Portal de Gerenciamento do ACS]: acs-portal
