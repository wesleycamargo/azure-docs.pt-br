<properties linkid="" urlDisplayName="" pageTitle="" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="Logon único da Web com o .NET e o Active Directory do Azure" authors="" solutions="" manager="" editor="" />
...
Este tutorial mostra como utilizar o Active Directory do Azure para habilitar logon único para usuários clientes do Office 365. Você saberá como:
...
19. Depois de entrar usando suas credenciais, você será redirecionado para a página Índice do seu controlador de Página Inicial, onde as declarações de sua conta são exibidas. Isso demonstra uma autenticação bem-sucedida do usuário no aplicativo usando o logon único fornecido pelo Active Directory do Azure.

<h2><a name="summary"></a>Resumo</h2>
Este tutorial mostrou como criar e configurar um aplicativo de locatário único que usa os recursos de logon único do Active Directory do Azure. Você também pode criar aplicativos multilocatários para o Active Directory do Azure lendo o tutorial a seguir: [Desenvolvendo aplicativos de nuvem multilocatários com o Active Directory do Azure].
...
[Resumo]: #summary
[Desenvolvendo aplicativos de nuvem multilocatários com o Active Directory do Azure]: http://g.microsoftonline.com/0AX00en/121
