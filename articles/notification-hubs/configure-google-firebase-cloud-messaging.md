...
3. Clique em **Salvar**. 
   ...
   ![Captura de tela que mostra como configurar os Hubs de notificação para FCM do Google](./media/notification-hubs-android-push-notification-google-fcm-get-started/fcm-server-key.png)
