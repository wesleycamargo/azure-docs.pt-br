...
Para obter uma lista de opções válidas de **TargetName**, de **NotificationClass** e de cabeçalho, confira a página [Notificações por push de um servidor](https://msdn.microsoft.com/library/hh221551.aspx).
