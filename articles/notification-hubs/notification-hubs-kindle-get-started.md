<properties
	pageTitle="Introdução aos Hubs de Notificação do Azure para aplicativos do Kindle | Microsoft Azure"
...
# Introdução aos Hubs de Notificação para aplicativos do Kindle
