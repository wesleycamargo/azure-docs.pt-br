---
title: "Tutorial de últimas notícias localizadas dos Hubs de Notificação"
...
## <a name="building-the-windows-store-client-app"></a>Criando o aplicativo cliente da Windows Store
