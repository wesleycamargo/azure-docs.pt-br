...
2. Adicione uma classe denominada **Notificações** ao projeto. Adicione o modificador **público** à definição de classe. Em seguida, adicione o seguinte **usando** instruções para o novo arquivo de código:
    ...
    ```
1. Copie o seguinte código para a nova classe **Notificações** :
...
2. Em MainPage.xaml.cs, adicione a seguinte linha:
    ...
    ```
1. No arquivo de projeto MainPage.xaml.cs, adicione o seguinte método:
