...
+ SDK para Android (presumimos que você estará usando o Eclipse), que pode ser baixado <a href="http://go.microsoft.com/fwlink/?LinkId=389797">aqui</a>
...
8. Após a criação bem-sucedida, você verá uma página com o **AppID**, **Chave API** e **Chave secreta**. Anote a **Chave API** a e a **Chave secreta** que usaremos mais tarde.
...
Você verá **保存成功！Mensagem (Salvo com êxito!)**.
...
8. Anote o **DefaultListenSharedAccessSignature** e **DefaultFullSharedAccessSignature** a partir da janela de informações de conexão de acesso.
...
9. Adicione a seguinte configuração dentro do elemento de aplicativo após o elemento de atividade .MainActivity substituindo yourprojectname, por exemplo, *yourprojectname*, por exemplo, **com.example.BaiduTest**:
...
e adicione as seguintes instruções de importação na parte superior: importar com.baidu.android.pushservice.PushConstants; importar com.baidu.android.pushservice.PushManager;
