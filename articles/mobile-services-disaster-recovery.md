<properties linkid="mobile-services-recovery-disaster" urlDisplayName="Recuperar o serviço móvel em caso de desastre" pageTitle="Recuperar o serviço móvel em caso de desastre - Serviços Móveis do Azure" metaKeywords="" description="Saiba como recuperar o serviço móvel em caso de desastre." metaCanonical="" services="" documentationCenter="Mobile" title="Recuperar o serviço móvel em caso de desastre" authors="yavorg" solutions="" manager="" editor="" />
...
<h2><a name="prepare"></a><span class="short-header">Preparar-se</span>Preparar-se para possíveis desastres</h2>
...
<h2><a name="watch"></a><span class="short-header">Observar</span>Observar os sinais de um problema</h2>
...
<h2><a name="recover"></a><span class="short-header">Recuperação</span>Recuperação de um desastre</h2>
...
6. Verifique se o serviço recuperado está se comunicando com o Banco de Dados SQL do Azure. O comando recover recupera o serviço móvel, mas mantém a conexão com o banco de dados original. Se o problema na região primária do Azure também afetar o banco de dados, o serviço recuperado ainda poderá não ser executado corretamente. Você pode usar o Painel de Serviços do Azure para examinar o status do banco de dados de uma determinada região. Se o banco de dados original não estiver funcionando, você poderá recuperá-lo:
	+ Recupere o Banco de Dados SQL do Azure para a região do Azure onde você recuperou o serviço móvel, conforme descrito em [Diretrizes para a continuidade dos negócios para o Banco de Dados SQL].
...
[Automatizar serviços móveis com ferramentas de linha de comando]: http://www.windowsazure.com/pt-br/develop/mobile/tutorials/command-line-administration/
