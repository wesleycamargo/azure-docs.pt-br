<properties linkid="develop-mobile-tutorials-add-paging-to-data-ios" urlDisplayName="Adicionar paginação aos dados" pageTitle="Adicionar paginação aos dados (iOS) | Mobile Dev Center" metaKeywords="" description="Saiba como usar paginação para gerenciar a quantidade de dados retornada para seu aplicativo iOS dos Serviços Móveis." metaCanonical="" services="" documentationCenter="Mobile" title="Refinar as consultas dos Serviços Móveis com paginação" authors="" solutions="" manager="" editor="" />
...
- [(C# da Windows Store | .NET)](mobile-services-dotnet-backend-windows-store-dotnet-add-paging-data.md)
- [(C# da Windows Store | JavaScript)](mobile-services-windows-store-dotnet-add-paging-data.md)
...
7. Atualize o método **refreshDataOnSuccess** mais uma vez localizando a seguinte linha de código:
   	...
   	Desta vez, defina o valor de **query.fetchOffset** como 3. 
...
Isso conclui o grupo de tutoriais que demonstram os conceitos básicos sobre como trabalhar com Serviços Móveis. Considere a possibilidade de obter mais informações sobre o seguinte tópico dos Serviços Móveis:
