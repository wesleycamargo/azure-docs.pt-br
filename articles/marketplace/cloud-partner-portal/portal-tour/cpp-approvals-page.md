---
title: Página de aprovações para o Azure Marketplace | Microsoft Docs
description: .
...
O próximo item de barra de menus de navegação exibe uma página[Todos os publicadores](./cpp-all-publishers-page.md), que lista todos os publicadores registrados.
