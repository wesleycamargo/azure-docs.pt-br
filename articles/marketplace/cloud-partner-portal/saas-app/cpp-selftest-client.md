---
title: Realizar o autoteste do cliente para pré-validar um aplicativo SaaS do Azure | Microsoft Docs
description: Como criar um cliente de autoteste para pré-validar um aplicativo SaaS do Azure.
...
---
# <a name="create-a-self-test-client-to-pre-validate-an-azure-saas-application"></a>Criar um cliente de autoteste para pré-validar um aplicativo SaaS do Azure
...
A API tem a estrutura a seguir.
...
|          DNSName          |         O Nome DNS da VM que você pretende testar.          |
|          Usuário          |          Nome de usuário para se conectar à máquina virtual e entrar nela.         |
|           Senha         |         A senha para se conectar à máquina virtual e entrar nela.          |
|          SO          |         O sistema operacional da VM, “Linux” ou “Windows”.          |
|         PortNo           |         O número da porta aberta para se conectar à VM. O número da porta é geralmente “22” para o Linux e “5986” para o Windows.          |
...
A captura de tela a seguir mostra um exemplo dos resultados do teste em JSON exibidos em um visualizador JSON online.
...
Para chamar a API com o cURL, siga estas etapas:
...
3. Na barra de navegação à esquerda, selecione **Todos os serviços** e, em seguida, **Azure Active Directory**.
   ...
   Nas etapas a seguir, talvez você precise do nome do locatário (ou nome do diretório) ou da ID de locatário (ou ID de diretório).
...
3. Em **Criar**, forneça as informações necessárias para os seguintes campos:
   ...
   - **URL de Logon** – digite "https://isvapp.azurewebsites.net/selftest"
...
20. Crie uma chave secreta selecionando a caixa de texto **DESCRIÇÃO** da chave. Configure os seguintes campos:
    ...
    - Em **VALOR**, copie a chave.
     ...
     >[!Important]
     >Você não poderá ver o valor da chave depois de sair do formulário Chaves.
...
Depois de testar seu aplicativo SaaS do Azure com êxito, você poderá [Publicar a oferta](./cpp-publish-offer.md)