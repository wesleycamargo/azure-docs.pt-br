---
title: Configuração do Azure SaaS aplicativo oferta vitrine | O Azure Marketplace
...
A tabela a seguir descreve os Detalhes da vitrine eletrônica onde é possível disponibilizar a oferta. Os campos obrigatórios são indicados por um asterisco (*).
...
| **Sugerido categorias (máx. 3)\*** | Selecione as categorias às quais sua oferta está mais alinhada. Você pode selecionar um máximo de três categorias. |
