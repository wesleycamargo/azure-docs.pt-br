---
title: Guia de SKUs de máquina virtual no Portal do Cloud Partner para Azure Marketplace
...
* Microsoft classifica alguns países/regiões como *imposto remetido da países*.  Em tais países/regiões, a Microsoft coleta os impostos dos clientes e paga (envia) taxas ao governo.  Em outros países/regiões, os parceiros são normalmente responsáveis por coletar impostos de seus clientes e pagar impostos ao governo. Se você optar por vender em países/regiões a última opção, você deve ter a capacidade de calcular e pagar impostos locais.  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
...
Opcionalmente, você especificará [Test-Drive](./cpp-test-drive-tab.md) informações se você estiver dando suporte a esse recurso; caso contrário, você fornecer [marketplace](./cpp-marketplace-tab.md) dados para sua oferta.
