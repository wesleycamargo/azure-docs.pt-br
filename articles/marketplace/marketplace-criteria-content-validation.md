---
title: Validação de conteúdo dos critérios do Marketplace – Azure | Microsoft Docs
...
| 3 | Logotipo | O logotipo é exibido corretamente | O logotipo é exibido corretamente e inclui uma [imagem hero](https://cloudpartner.azure.com/#documentation/publish-solution-template), que é a imagem de formato grande no Portal do Azure |
...
| 3 | Test drive | Selecionar: Sim ou Não | O cliente pode entender facilmente quais são as próximas etapas disponíveis: <br>1. Experimentar a avaliação gratuita <br>2. Comprar agora <br>3. Entre em contato por email ou número de telefone para providenciar a Prova de Conceito, Avaliação ou Resumo. |
...
| 7 | Artefatos de marketing | Logotipos exibidos corretamente | <br>• O logotipo inclui a “imagem hero”, que é a imagem em formato grande no Portal do Azure <br>•  Logotipos: pequeno (48x48) e grande (216x216) são requisitos <br>•   Requisitos da imagem hero: https://cloudpartner.azure.com/#documentation/publish-solution-template <br>•  Captura de tela (máx. 5): o CPP requer uma imagem .png com resolução 1280 x 720. |
...
| 9 | Gerenciamento de leads | Selecione o sistema no qual seus clientes potenciais serão armazenados. Saiba como conectar seu sistema CRM [aqui](https://aka.ms/cppdocs/get-customer-leads/how-to-connect-your-crm-system-with-the-cloud-partner-portal) |  |
...
| 3 | Artefatos do Marketplace | Logotipos exibidos corretamente |<br>• O logotipo inclui a “imagem hero”, que é a imagem em formato grande no Portal do Azure <br>• Logotipos: pequeno (48x48) e grande (216x216) são requisitos <br>• Requisitos da imagem hero: https://cloudpartner.azure.com/#documentation/publish-solution-template<br>• Captura de tela (máx. 5): o CPP requer uma imagem .png com resolução 1280 x 720.|
| 4 | Gerenciamento de leads |<br>•    Gerenciamento de cliente potencial: selecione o sistema no qual seus clientes potenciais serão armazenados. <br>•   Saiba como conectar seu sistema CRM [aqui](https://aka.ms/cppdocs/get-customer-leads/how-to-connect-your-crm-system-with-the-cloud-partner-portal) | |
...
|  | Elemento de listagem | Requisitos básicos | Requisitos ideais |
|:--- |:--- |:--- |:--- |
| 1 | Título da oferta  |  <br>•  Precisa listar claramente o tipo e a duração do serviço no formato a seguir: NOME : TIPO DURAÇÃO. (ou seja, “Participação da oferta – prova de conceito de 1 semana”)  | <br>• Não repete o nome do editor <br>•  Espelha o estilo de título já disponível na descrição – não quer títulos longos. | 
