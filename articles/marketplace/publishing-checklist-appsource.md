---
title: Lista de verificação para publicação para AppSource | Azure
...
Os seguintes artefatos são necessários para publicar seu aplicativo no AppSource.  
