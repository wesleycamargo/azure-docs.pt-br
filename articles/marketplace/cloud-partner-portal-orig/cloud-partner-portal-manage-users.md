---
title: Gerenciando usuários no portal de parceiros de nuvem
...
ms.locfileid: "60777064"
---
<a name="managing-users-on-cloud-partner-portal"></a>Gerenciando usuários no portal de parceiros de nuvem
======================================

O Portal do Cloud Partner permite que você adicione usuários com acesso baseado em função às ofertas de máquinas virtuais. Isso ajuda a gerenciar o acesso e as permissões enquanto várias pessoas estão trabalhando em ofertas.
...
Atualmente, apenas proprietários podem acessar as guias Pagamentos e Cliente Azure no Insights.
...
Se você precisar remover um usuário que foi adicionado, localize o email do usuário na guia Usuários e, em seguida, pressione o botão Excluir no lado direito.
