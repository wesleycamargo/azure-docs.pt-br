...
ms.locfileid: "49079288"
---
<a name="saas-sell-through-azure---apis"></a>Venda de SaaS por meio do Azure – APIs
==============================

Este artigo explica como criar uma oferta de SaaS com APIs. As APIs são necessárias para permitir assinaturas para sua oferta de SaaS se você tem a opção Venda por meio do Azure selecionada. Se você quiser criar uma listagem de SaaS regular sem comércio habilitado, confira [Guia técnico de publicação de aplicativo SaaS]./cloud-partner-portal-saas-offers-tech-publishing-guide.md).
