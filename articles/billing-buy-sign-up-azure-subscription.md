...
Este tópico ajudará você nas seguintes tarefas:
...
3. Na seção **Sobre você**, digite suas informações pessoais. Observe que o País não poderá ser alterado depois de especificado. ![A captura de tela de informações pessoais](./media/billing-buy-sign-up-azure-subscription/AboutYou.png)
...
2. Escolha a assinatura e então selecione **Atualizar**.</br>![billpage](./media/billing-buy-sign-up-azure-subscription/billpage.png)
3. Selecione **Sim**, e, em seguida, selecione **Atualizar agora**. </br>![atualizar](./media/billing-buy-sign-up-azure-subscription/Upgrade.png)
...
2. Insira a chave do produto e marque a primeira opção de contrato (e também a segunda opção se você quiser receber ofertas especiais) para ativar a assinatura.</br>![CHAVE OSA](./media/billing-buy-sign-up-azure-subscription/OSAkey.png)
3. Selecione **Ativar**.
