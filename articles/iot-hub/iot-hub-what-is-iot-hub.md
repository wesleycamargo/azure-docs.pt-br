<properties
 ...
 description="Uma visão geral do serviço Hub IoT do Azure, incluindo a arquitetura da Internet das coisas, a conectividade do dispositivo, os padrões de comunicação e o padrão de comunicação assistida de serviço"
 services="iot-hub"
 documentationCenter=""
...
Bem-vindo ao Hub IoT do Azure. Este artigo fornece uma visão geral do Hub IoT do Azure e descreve o motivo pelo qual você deve usar esse serviço ao implementar uma solução IoT (Internet das Coisas).
