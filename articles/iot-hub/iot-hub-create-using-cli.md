<properties
    pageTitle="Criar um Hub IoT usando a CLI| Microsoft Azure"
...
> [AZURE.NOTE] O Azure tem dois modelos de implantação diferentes para criar e trabalhar com recursos: [Gerenciador de Recursos e clássico](../resource-manager-deployment-model.md). A CLI do Azure deve estar no modo Azure Resource Manager:
```
...
> [AZURE.NOTE] Este comando de CLI cria um Hub IoT Standard S1 pelo qual você será cobrado. Você pode excluir o hub IoT **exampleIoTHubName** usando o seguinte comando 
```
