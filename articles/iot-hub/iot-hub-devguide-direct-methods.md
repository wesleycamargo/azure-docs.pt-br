...
Invocar métodos diretos usando uma ID do módulo tem suporte no SDK do C# (disponível [aqui](https://www.nuget.org/packages/Microsoft.Azure.Devices/)).
