---
title: Gêmeos do gerenciamento de dispositivo Hub IoT | Microsoft Docs
...
---
# Tutorial: Como usar o dispositivo gêmeo com Node.js (visualização)
...
3. Execute `node jobClient_devicePropertyReadWrite.js`.
...
1. Leitura superficial: imprime as propriedades de dispositivo `BatteryLevel` e `Timezone` no dispositivo gêmeo.
2. Leitura profunda: ler a propriedade de dispositivo `Timezone` do dispositivo físico.
3. Leitura superficial: imprime as propriedades de dispositivo `BatteryLevel` e `Timezone` no dispositivo gêmeo.
4. Gravação profunda: gravar a propriedade de dispositivo **Fuso horário** no dispositivo físico.
5. Leitura profunda: ler a propriedade de dispositivo **Fuso horário** por meio do dispositivo físico para ver se foi alterada.
6. Leitura superficial: imprime as propriedades de dispositivo `BatteryLevel` e `Timezone` no dispositivo gêmeo.
