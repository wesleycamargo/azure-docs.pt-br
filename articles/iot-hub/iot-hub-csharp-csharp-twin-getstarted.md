...
* controlar dispositivos interativamente (assim como ativar uma ventoinha de um aplicativo controlado pelo usuário) com o tutorial [Uso de métodos diretos](quickstart-control-device-node.md).
