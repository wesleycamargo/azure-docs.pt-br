...
---
# <a name="comparison-of-iot-hub-and-event-hubs"></a>Comparação do Hub IoT com os Hubs de Eventos
Um dos principais casos de uso do Hub IoT do Azure é coletar a telemetria dos dispositivos. Por esse motivo, o Hub IoT muitas vezes é comparado aos [Hubs de Eventos do Azure][Hubs de Eventos do Azure]. Assim como o Hub IoT, o Hubs de Eventos do Azure é um serviço de processamento de eventos que permite a entrada em grande escala de telemetria e de eventos na nuvem, com baixa latência e alta confiabilidade.
...
| Escala |É otimizada para dar suporte a milhões de dispositivos conectados simultaneamente. |Os Hubs de Eventos podem dar suporte a uma quantidade mais limitada de conexões simultâneas: até 5.000 conexões AMQP, de acordo com as [Cotas do Barramento de Serviço do Azure][Cotas do Barramento de Serviço do Azure]. Por outro lado, os Hubs de Eventos permitem que você especifique a partição de cada mensagem enviada. |
| SDKs de dispositivo |Fornece [SDKs de dispositivo][SDKs do Hub IoT do Azure] para uma grande variedade de plataformas e linguagens. |Eles têm suporte em .NET e em C e fornecem interfaces de envio AMQP e HTTP. |
...
Para saber mais sobre como planejar sua implantação do Hub IoT, consulte [Escala, alta disponibilidade e recuperação de desastre][lnk-scaling].
...
[Hub de Eventos - segurança]: ../event-hubs/event-hubs-authentication-and-security-model-overview.md
[Políticas do publicador do Hub de Eventos]: ../event-hubs/event-hubs-overview.md#common-publisher-tasks
[Cotas do Barramento de Serviço do Azure]: ../service-bus-messaging/service-bus-quotas.md
[SDKs do Hub IoT do Azure]: https://github.com/Azure/azure-iot-sdks/blob/master/readme.md
