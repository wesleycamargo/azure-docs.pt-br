...
* **Percurso da rede**. O protocolo AMQP padrão usa a porta 5671 e o MQTT escuta na porta 8883. O uso dessas portas pode causar problemas em redes que estão fechadas para protocolos não HTTP. Use MQTT por WebSockets, AMQP, AMQP por WebSockets ou HTTP nesse cenário.
