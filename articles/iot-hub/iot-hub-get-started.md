...
## <a name="setup-your-device-connect-iot-device-or-gateway-to-azure-iot-hub"></a>Configure seu dispositivo: conectar o dispositivo IoT ou gateway ao Hub IoT do Azure
