...
# Introdução ao Kit de Início do Gateway IoT com um dispositivo simulado
...
### Criar um Hub IoT e registrar seu dispositivo
...
## Lição 3: Receber mensagens do dispositivo simulado e ler mensagens de seu Hub IoT
...
### Configurar e executar um dispositivo simulado
...
### Criar um aplicativo de funções do Azure e uma conta de armazenamento do Azure
