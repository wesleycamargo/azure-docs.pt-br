...
1. Abra `Functions\DevKitTranslatorFunction.cs` e atualize as seguintes linhas de código com o nome do dispositivo e a chave de serviço de fala que você anotou.
   ```csharp
