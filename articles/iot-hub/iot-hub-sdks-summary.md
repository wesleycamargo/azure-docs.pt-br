---
title: Lista dos SDKs do Hub IoT do Azure | Microsoft Docs
...
---
# SDKs do Hub IoT
Este artigo fornece informações sobre os vários [SDKs da Microsoft Azure IoT][SDKs da Microsoft Azure IoT] junto com links para recursos adicionais.
...
* [Dispositivo SDK do dispositivo IoT do Azure para C][Dispositivo SDK do dispositivo IoT do Azure para C] gravado em ANSI C (C99) para portabilidade e compatibilidade ampla da plataforma.
* [SDK do dispositivo IoT do Azure para .NET][SDK do dispositivo IoT do Azure para .NET]
* [SDK do dispositivo IoT do Azure para Java][SDK do dispositivo IoT do Azure para Java]
* [SDK do dispositivo IoT do Azure para Node.js][SDK do dispositivo IoT do Azure para Node.js]
* [SDK do dispositivo IoT do Microsoft Azure para Python 2.7][SDK do dispositivo IoT do Microsoft Azure para Python 2.7]
...
* [Programa Microsoft Azure Certified para IoT][Programa Microsoft Azure Certified para IoT].
...
* [SDK do serviço IoT do Azure para Node.js][SDK do serviço IoT do Azure para Node.js]
* [SDK do serviço IoT do Azure para Java][SDK do serviço IoT do Azure para Java]
...
Você pode baixar o [SDK de Gateway do Azure IoT][SDK de Gateway do Azure IoT] do GitHub.
...
* [Internet das Coisas (IoT) .NET][Internet das Coisas (IoT) .NET]
* [REST do Hub IoT][REST do Hub IoT]
* [SDK do dispositivo IoT do Microsoft Azure para C][SDK do dispositivo IoT do Microsoft Azure para C]
* [SDK do dispositivo IoT do Microsoft Azure para Java][SDK do dispositivo IoT do Microsoft Azure para Java]
* [SDK do serviço IoT do Microsoft Azure para Java][SDK do serviço IoT do Microsoft Azure para Java]
* [SDK do dispositivo IoT do Microsoft Azure para Node.js][SDK do dispositivo IoT do Microsoft Azure para Node.js]
* [SDK do serviço IoT do Microsoft Azure para Node.js][SDK do serviço IoT do Microsoft Azure para Node.js]
* [SDK de gateway do Microsoft Azure IoT][SDK de gateway do Microsoft Azure IoT]
...
[SDK do dispositivo IoT do Microsoft Azure para Node.js]: http://azure.github.io/azure-iot-sdks/node/api_reference/azure-iot-device/1.0.14/index.html
...
[SDK do serviço IoT do Microsoft Azure para Node.js]: http://azure.github.io/azure-iot-sdks/node/api_reference/azure-iothub/1.0.16/index.html
