...
Este tutorial se baseia na [Introdução ao Hub IoT] e mostra como enviar mensagens da nuvem para o dispositivo (*comentários*) do Hub IoT e recebê-lo do seu black-end da nuvem do aplicativo.
...
+ Uma conta ativa do Azure. <br/>Se você não tiver uma conta, poderá criar uma conta de avaliação gratuita em apenas alguns minutos Para obter detalhes, consulte [Avaliação Gratuita do Azure](http://azure.microsoft.com/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fpt-BR%2Fdevelop%2Fiot%2Ftutorials%2Fc2d%2F target="\_blank").
