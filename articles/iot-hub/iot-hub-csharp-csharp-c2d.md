...
Esse tutorial se baseia [Começar com ao Hub IoT]. Ele mostra como enviar mensagens da nuvem para o dispositivo para um único dispositivo, como solicitar a confirmação de entrega (*feedback*) do Hub IoT e recebê-la de seu back-end da nuvem do aplicativo.
...
Nesta seção, você modificará o aplicativo do dispositivo simulado criado na [Introdução ao Hub IoT] para receber mensagens da nuvem para o dispositivo a partir do hub IoT.
...
5. Adicione os seguintes campos à classe **Program**. Substitua o valor de espaço reservado pela cadeia de conexão do Hub IoT a partir da [Introdução ao Hub IoT]\:
