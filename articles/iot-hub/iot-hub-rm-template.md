...
* Para obter a sintaxe JSON e as propriedades a serem usadas nos modelos, confira [Tipos de recurso de Microsoft.Devices](/azure/templates/microsoft.devices/iothub-allversions).
