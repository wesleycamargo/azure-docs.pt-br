...
- De um cliente SSH que é executado em seu computador host. Recomenda-se o PuTTY no Windows. O Linux e o macOS já vêm com um cliente SSH.
...
O aplicativo BLE (Bluetooth de Baixa Energia) de exemplo é fornecido pelo SDK do gateway IoT do Azure. O aplicativo de exemplo coleta dados da conexão BLE e os envia ao Hub IoT. Para executar o aplicativo de exemplo, você precisa:
...
[Usar o gateway IoT para transformação dos dados do sensor com o SDK do Gateway do Azure IoT](iot-hub-gateway-kit-c-use-iot-gateway-for-data-conversion.md)
