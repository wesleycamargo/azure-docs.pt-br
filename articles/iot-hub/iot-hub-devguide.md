...
description: "Guia do desenvolvedor do Hub IoT do Azure que inclui pontos de extremidade do Hub IoT, segurança, registro de identidade, gerenciamento do dispositivo e mensagens"
services: iot-hub
...
O Hub IoT do Azure é um serviço totalmente gerenciado que ajuda a permitir comunicações bidirecionais confiáveis e seguras entre milhões de dispositivos e um back-end de aplicativo.
...
* Um armazenamento que podem ser consultado com informações de estado por dispositivo e metadados.
...
* [Enviar e receber mensagens com o Hub IoT][devguide-messaging] descreve os recursos de sistema de mensagens (do dispositivo para a nuvem e da nuvem para o dispositivo) expostos pelo Hub IoT. O artigo também inclui informações sobre tópicos como formatos de mensagem e os protocolos de comunicação com suporte, além dos números de porta que eles usam.
...
* [Orientação de comunicação da nuvem para o dispositivo][lnk-c2d-guidance] ajuda você a escolher entre direto métodos, propriedades reportadas do dispositivo gêmeo e mensagens da nuvem para o dispositivo.
...
* [Referência - Pontos de extremidade do Hub IoT][devguide-endpoints] descreve os vários pontos de extremidade que cada Hub IoT expõe para operações de tempo de execução e de gerenciamento. O artigo também descreve como você pode usar um gateway de campo para permitir que alguns dispositivos se conectem a seus pontos de extremidade do Hub IoT.
...
* [Referência - preços] [devguide-pricing] fornece informações gerais sobre os diferentes SKUs e preços para o Hub IoT e detalhes adicionais sobre como as várias funcionalidades do Hub IoT são medidas como mensagens pelo Hub IoT.
* [Referência - SDKs de dispositivo e serviço][devguide-sdks] lista os SDKs do Azure IoT que você pode usar no desenvolvimento de aplicativos de dispositivo e de serviço que interagem com o Hub IoT. O artigo inclui links para documentação online da API.
