---
title: Tópicos do guia do desenvolvedor para Hub IoT | Microsoft Docs
...
> [!NOTE]
> Para obter mais detalhes sobre o protocolo HTTP e os SDKs que podem ser usados para interagir com o registro de identidade do dispositivo, veja [APIs e SDKs do Hub IoT][lnk-sdks].
> 
> 
...
> [!IMPORTANT]
> A única maneira de recuperar todas as identidades em um registro de identidade do hub é usar a funcionalidade [Exportar](#importexport).
> 
> 
...
> [!NOTE]
> O provedor de recursos do Hub IoT do Azure é protegido por meio de sua assinatura do Azure, assim como todos os provedores no [Gerenciador de Recursos do Azure][lnk-azure-resource-manager].
> 
> 
...
> [!NOTE]
> Os [SDKs do Hub IoT do Azure ][lnk-sdks] geram tokens automaticamente durante a conexão com o serviço. Em alguns casos, os SDKs não dão suporte a todos os protocolos ou a todos os métodos de autenticação.
> 
> 
...
> [!IMPORTANT]
> Cada fila de dispositivo pode conter no máximo 50 mensagens da nuvem para o dispositivo. Tentar enviar mais mensagens para o mesmo dispositivo resultará em um erro.
> 
> [!NOTE]
...
> [!NOTE]
> Os [SDKs do Hub IoT do Azure][lnk-sdks] tratam automaticamente da recuperação do URI de SAS, do upload do arquivo e da notificação do Hub IoT de um upload concluído.
> 
> 
...
> 
> [!IMPORTANT]
> As operações de registro de identidade são destinadas ao uso no tempo de execução em cenários de provisionamento e gerenciamento de dispositivos. Há suporte para leitura ou atualização de grandes números de identidades de dispositivo por meio de [trabalhos de importação/exportação](#importexport).
> 
> 
