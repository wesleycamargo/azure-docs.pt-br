<properties title="Using Elastic Scale with Entity Framework" pageTitle="Usando a ﻿Escala Elástica com o Entity Framework" description="A escala elástica facilita a escala. O Entity Framework é fácil de usar para codificar os bancos de dados " metaKeywords="Using Elastic Scale with Entity Framework, Azure SQL Database sharding, elastic scale, Entity Framework and Elastic Scale" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
