...
title: "Formato do arquivo de registro do serviço de Importação-Exportação | Microsoft Docs"
...
---
# <a name="import-export-service-log-file-format"></a>Formato de Arquivo de Log de Serviço de Importação-Exportação
...
-   O log detalhado não é habilitado por padrão, mas pode ser habilitado configurando a propriedade `EnableVerboseLog` em um [Trabalho Put Job](/rest/api/storageservices/importexport/Put-Job) ou em uma operação de [Atualização de Propriedades do Trabalho](/rest/api/storageservices/importexport/Update-Job-Properties).  
...
Você pode recuperar a URL de erro e logs detalhados chamando a operação [Obter Trabalho](/rest/api/storageservices/importexport/Get-Job3). Os logs estão disponíveis após a conclusão do processamento da unidade.  
