...
Agora, vamos cluster HDInsight Hadoop no Linux como um exemplo. Para usar a CLI do HDFS, primeiro você precisa estabelecer [acesso remoto aos serviços](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-hadoop-linux-information#remote-access-to-services). Se você escolher [SSH](https://docs.microsoft.com/en-us/azure/hdinsight/hdinsight-hadoop-linux-use-ssh-unix) o código de exemplo do PowerShell seria semelhante ao seguinte:
```PowerShell
