...
Para saber mais sobre os tipos de contas de armazenamento, consulte [Opções de conta de Armazenamento do Azure](../common/storage-account-options.md).
...
Para fazer isso: usando o Cloud Shell ou um shell local, insira o comando a seguir para fazer isso: `az extension add --name storage-preview`
...
* [Mover dados de e para o Armazenamento de Blobs do Azure usando o AzCopy](https://docs.microsoft.com/en-us/azure/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azcopy)