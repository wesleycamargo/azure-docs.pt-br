...
4. Em **Local/Grupo de afinidade**, selecione um local para a conta de armazenamento que esteja perto de você ou seus clientes. Se os dados na conta de armazenamento forem ser acessados de outro serviço do Azure, como uma máquina virtual ou serviço de nuvem do Azure, você pode desejar selecionar um grupo de afinidade na lista para agrupar sua conta no mesmo data center que outros serviços do Azure que você está usando para melhorar o desempenho e reduzir os custos.
	...
	Vale lembrar que você deve selecionar um grupo de afinidades durante a criação de sua conta de armazenamento. Não é possível mover uma conta existente para um grupo de afinidades. Para obter mais informações sobre grupos de afinidades, confira abaixo [Colocalização de serviços com um grupo de afinidades](#service-co-location-with-an-affinity-group).
	...
	>
	>Além disso, confira [Regiões do Azure](https://azure.microsoft.com/pt-BR/regions/#services) para saber mais sobre quais serviços estão disponíveis em uma região específica.
...
> [AZURE.NOTE]Para criar um grupo de afinidade, abra a área <b>Configurações</b> do portal do Azure, clique em <b>Grupos de Afinidade</b> e em <b>Adicionar um grupo de afinidade</b> ou no botão <b>Adicionar</b>. Você também pode criar e gerenciar os grupos de afinidades usando a API de Gerenciamento de Serviços do Azure. Confira <a href="http://msdn.microsoft.com/library/azure/ee460798.aspx">Operações em grupos de afinidade</a> para saber mais.
...
- Para saber mais sobre o Armazenamento do Azure, consulte a documentação do Armazenamento do Azure em [Azure.com](http://azure.microsoft.com/documentation/services/storage/) e no [MSDN](http://msdn.microsoft.com/library/azure/gg433040.aspx).
