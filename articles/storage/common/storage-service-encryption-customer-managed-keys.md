...
Se você não tiver um cofre de chaves, você pode criá-lo no portal, Powershell ou CLI:
...
Se você estiver usando um cofre de chaves existente, você precisa habilitar exclusão reversível e não limpar em seu cofre, executando os seguintes comandos do PowerShell ou CLI do Azure:
...
Você precisa ter um cofre de chaves e uma chave no cofre de chaves. Para especificar a chave de um cofre de chaves, siga estas etapas:
