...
R: não. Se você precisar arquivar os dados de métrica para a conta de armazenamento, você pode usar [Configuração de diagnóstico no Azure Monitor](https://azure.microsoft.com/blog/azure-monitor-multiple-diagnostic-settings/)
