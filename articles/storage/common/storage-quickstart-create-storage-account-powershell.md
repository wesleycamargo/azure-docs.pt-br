...
Use [New-AzureRmStorageAccount](/powershell/module/azurerm.storage/New-AzureRmStorageAccount) para criar uma conta de armazenamento de uso geral que pode ser usada para os quatro serviços. Atribua o nome de *contosomvcstandard* à conta de armazenamento e configure-a para ter o Armazenamento com Redundância de Local e criptografia de blob habilitadas.
