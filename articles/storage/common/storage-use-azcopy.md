...
### <a name="import-entities-to-table-using-blobs"></a>Importar entidades na tabela usando blobs
...
Para a propriedade "AzureStorageUseV1MD5" • True – valor padrão, o AzCopy usa a implementação MD5 do .NET.
• False – o AzCopy usa o algoritmo MD5 compatível com FIPS.
