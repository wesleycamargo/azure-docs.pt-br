---
title: "Criando um trabalho de exportação para o serviço de Importação/Exportação do Azure | Microsoft Docs"
...
# <a name="creating-an-export-job"></a>Criando um trabalho de exportação
