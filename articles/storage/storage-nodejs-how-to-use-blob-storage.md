...
Para obter um exemplo de como definir as variáveis de ambiente no [portal do Azure](https://portal.azure.com) para um aplicativo Web do Azure, consulte [Aplicativo Web Node.js com o Serviço Tabela do Azure].
