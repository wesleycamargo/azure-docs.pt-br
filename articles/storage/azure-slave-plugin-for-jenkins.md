...
## Para instalar o plug-in subordinado do Azure
...
## Para configurar o plug-in subordinado do Azure com seu perfil de assinatura
...
Eles podem ser encontrados em seu perfil de assinatura. Se não tiver uma cópia do seu perfil de assinatura, você pode baixá-lo [no site de assinatura](https://manage.windowsazure.com/publishsettings/Index?SchemaVersion=2.0). Veja a seguir um exemplo de perfil de assinatura.
...
## Para configurar um modelo de máquina virtual para o plug-in subordinado do Azure
...
## Para criar um trabalho do Jenkins executado em um nó subordinado no Azure
