...
<properties 
  pageTitle="Replicação de armazenamento do Azure | Microsoft Azure" 
...
- [Armazenamento com redundância local](#locally-redundant-storage)
- [Armazenamento com redundância de zona](#zone-redundant-storage)
- [Armazenamento com redundância geográfica](#geo-redundant-storage)
- [Armazenamento com redundância geográfica com acesso de leitura](#read-access-geo-redundant-storage)
