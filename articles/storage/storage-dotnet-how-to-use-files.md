...
### <a name="mount-the-file-share-from-an-onpremises-client-running-windows"></a>Montar o compartilhamento de arquivos a partir de um cliente local que executa o Windows
