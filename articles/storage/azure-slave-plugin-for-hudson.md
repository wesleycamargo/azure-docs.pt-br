...
4. Clique em **Add new cloud > Microsoft Azure**.
	...
	![adicionar nova nuvem](./media/azure-slave-plugin-for-hudson/hudson-setup-addcloud.png)
...
4. Dentro da seção **Cloud**, encontre **Add Azure Virtual Machine Template** e clique no botão **Add**.
	...
	![adicionar modelo de vm](./media/azure-slave-plugin-for-hudson/hudson-setup-addnewvmtemplate.png)
...
12. Em **Usage**, selecione a condição apropriada quando esse nó subordinado será usado. Por enquanto, selecione **Utilize this node as much as possible**.
	...
	![configuração de modelo](./media/azure-slave-plugin-for-hudson/hudson-setup-templateconfig1-withdata.png)
