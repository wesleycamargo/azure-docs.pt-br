...
Os padrões a seguir na seção [Padrões de design de tabela](#table-design-patterns) abordam a otimização do desempenho ou as operações de inserção, atualização e exclusão:  
