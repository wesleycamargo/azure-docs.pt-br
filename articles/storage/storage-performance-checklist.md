...
## <a name="a-nameallservicesaall-services"></a><a name="allservices"></a>Todos os serviços
...
### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>Metas de escalabilidade
...
#### <a name="a-namesub1bandwidthabandwidth-scalability-target-for-all-services"></a><a name="sub1bandwidth"></a>Meta de escalabilidade de largura de banda para todos os serviços
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>Convenção de nomenclatura de partição
...
##### <a name="a-namesubheading2athroughput"></a><a name="subheading2"></a>Produtividade
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>Qualidade do vínculo
...
##### <a name="useful-resources"></a>Recursos úteis
Para saber mais sobre os tamanhos de máquina virtual e sobre a largura de banda alocada, veja [Tamanhos de VM do Windows](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) ou [Tamanhos de VM do Linux](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>Local
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>Distribuição de conteúdo
...
### <a name="a-namesubheading6ausing-sas-and-cors"></a><a name="subheading6"></a>Usando SAS e CORS
...
#### <a name="a-namesubheading7agetting-data"></a><a name="subheading7"></a>Obtenção de dados
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>Carregamento de dados em lotes
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>Aumentar o limite de conexão padrão
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>Aumentar o mínimo dos Threads de ThreadPool, caso esteja usando código síncrono com tarefas assíncronas
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>Aproveitar a coleta de lixo do .NET 4.5
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>Paralelismo não associado
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>Ferramentas e bibliotecas cliente para armazenamento
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>Limitação/Servidor ocupado
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>Erros sem nova tentativa
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>Vários clientes que acessam um único objeto simultaneamente
...
#### <a name="a-namesubheading16abandwidth-and-operations-per-blob"></a><a name="subheading16"></a>Largura de banda e operações por blob
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>Copiar blob
...
#### <a name="a-namesubheading18ause-azcopy"></a><a name="subheading18"></a>Usar AzCopy
...
#### <a name="a-namesubheading19aazure-importexport-service"></a><a name="subheading19"></a>Serviço de importação/exportação do Azure
...
### <a name="a-namesubheading20ause-metadata"></a><a name="subheading20"></a>Uso de metadados
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>Carregamento rápido de um blob grande
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>Carregamento rápido de diversos blobs
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>Escolhendo o tipo de blob certo
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>Metas de escalabilidade específicas da tabela
...
#### <a name="a-namesubheading25ause-json"></a><a name="subheading25"></a>Usar JSON
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Desativação do Nagle
...
#### <a name="a-namesubheading27atables-and-partitions"></a><a name="subheading27"></a>Tabelas e partições
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>Padrões somente anexar e somente incluir
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>Dados de tráfego intenso
...
##### <a name="a-namesubheading30aquery-scope"></a><a name="subheading30"></a>Escopo de consulta
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>Densidade de consulta
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>Filtragem
...
###### <a name="a-namesubheading33aprojection"></a><a name="subheading33"></a>Projeção
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>Desnormalização
...
##### <a name="a-namesubheading35abatching"></a><a name="subheading35"></a>Envio em lote
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>Armazenamento de séries de dados em uma única entidade
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>Armazenando dados estruturados em blobs
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>Limites de escalabilidade
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Desativação do Nagle
...
### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>Tamanho da mensagem
...
### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>Recuperação de lote
...
### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>Intervalo de sondagem de fila
...
### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>Arquitetura do aplicativo
