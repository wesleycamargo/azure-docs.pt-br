...
| | Configuração de .NET todos os serviços | [Você configurou o cliente para usar um número suficiente de conexões simultâneas?](#subheading9)
| | Configuração de todos os serviços .NET | [Você configurou .NET para usar um número suficiente de threads?](#subheading10)
| | Configuração de todos os serviços .NET | [Estiver usando o .NET 4.5 ou posterior, que melhorou a coleta de lixo?](#subheading11)
