...
![Azure Databricks com o Data Lake Storage Gen2 e o SQL Data Warehouse](./media/data-lake-storage-handle-data-using-databricks/databricks-extract-transform-load-sql-datawarehouse.png "Azure Databricks com o Data Lake Storage Gen2 e o SQL Data Warehouse")
...
* [Criar uma conta do Azure Data Lake Storage Gen2](data-lake-storage-quickstart-create-account.md)
...
2. No painel esquerdo, escolha **Workspace**. Na lista suspensa **Workspace**, selecione **Criar** > **Notebook**.
    ...
    ![Criar bloco de notas em Databricks](./media/data-lake-storage-handle-data-using-databricks/databricks-create-notebook.png "Criar bloco de notas em Databricks")
...
3. Na caixa de diálogo **Criar Bloco de Anotações**, digite um nome para o bloco de anotações. Selecione **Scala** como linguagem e selecione o cluster Spark criado anteriormente.
    ...
    ![Criar bloco de notas em Databricks](./media/data-lake-storage-handle-data-using-databricks/databricks-notebook-details.png "Criar bloco de notas em Databricks")

    Selecione **Criar**.

4. Insira o código a seguir na primeira célula e execute o código. Lembre-se de substituir os espaços reservados mostrados entre colchetes no exemplo pelos seus próprios valores:
...
5. Pressione **SHIFT + ENTER** para executar a célula de código.
...
> [!NOTE]
> Se você ainda não tiver uma conta do Data Lake Storage Gen2 funcional, siga o [início rápido para criar uma](./data-lake-storage-quickstart-create-account.md).
...
6. Conecte-se ao banco de dados SQL e verifique se você consegue ver uma **SampleTable**.
    ...
    ![Verificar tabela de exemplo](./media/data-lake-storage-handle-data-using-databricks/verify-sample-table.png "Verificar tabela de exemplo")
...
7. Execute uma consulta select para verificar o conteúdo da tabela. Ela deve ter os mesmos dados que o dataframe **renamedColumnsDF**.
    ...
    ![Verificar conteúdo da tabela de exemplo](./media/data-lake-storage-handle-data-using-databricks/verify-sample-table-content.png "Verificar conteúdo da tabela de exemplo")
