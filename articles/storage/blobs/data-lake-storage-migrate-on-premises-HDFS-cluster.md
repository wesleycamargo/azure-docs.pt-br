...
2. Na conta de armazenamento de acesso e a caixa de diálogo dados de carregamento, copie o **ponto de extremidade de serviço Blob** e o **chave de conta de armazenamento**. Do ponto de extremidade de serviço blob, omita o `https://` e a barra à direita.
    ...
    Nesse caso, é o ponto de extremidade: `https://mystorageaccount.blob.mydataboxno.microsoftdatabox.com/`. A parte de host do URI que você usará é: `mystorageaccount.blob.mydataboxno.microsoftdatabox.com`. Por exemplo, consulte como [conectar ao REST sobre http](/azure/databox/data-box-deploy-copy-data-via-rest.md). 
