...
* Baixe e instale o [SDK do Azure Storage Blob para Go](https://github.com/azure/azure-storage-blob-go/) usando `go get -u github.com/Azure/azure-storage-blob-go/azblob`. 
