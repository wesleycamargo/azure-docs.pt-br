...
Serviços como o HDInsight e Azure Data Factory ainda não se integram com autenticação de token de portador OAuth do Azure Active Directory (Azure AD).
