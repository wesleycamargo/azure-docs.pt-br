<properties 
   pageTitle="Exemplos de Armazenamento do Azure | Microsoft Azure"
   description="Exibir, baixar e testar exemplos do Armazenamento do Azure. Descubra os exemplos de introdução aos blobs, filas, tabelas e arquivos usando as bibliotecas do cliente de armazenamento do .NET, Java, Node.js e C++."
   services="storage"
...
## Visão geral
Use os links abaixo para exibir e baixar exemplos de como trabalhar com o Armazenamento do Azure.

## Amostras do .NET

Para explorar os exemplos do .NET, baixe a [Biblioteca do Cliente de Armazenamento do .NET](https://www.nuget.org/packages/WindowsAzure.Storage/) do NuGet. A Biblioteca do Cliente de Armazenamento do .NET também está disponível no [SDK do Azure para .NET](http://azure.microsoft.com/downloads/).
...
* [Introdução aos blobs](https://github.com/Azure/azure-storage-java/tree/master/microsoft-azure-storage-samples/src/com/microsoft/azure/storage/blob/gettingstarted)
* [Introdução às tabelas](https://github.com/Azure/azure-storage-java/tree/master/microsoft-azure-storage-samples/src/com/microsoft/azure/storage/table/gettingtstarted)
* [Introdução às filas](https://github.com/Azure/azure-storage-java/tree/master/microsoft-azure-storage-samples/src/com/microsoft/azure/storage/queue/gettingstarted)
...
- [Código-fonte para a Biblioteca do Cliente de Armazenamento do .NET](https://github.com/Azure/azure-storage-net)
- [Referência da Biblioteca do Cliente do .NET](https://msdn.microsoft.com/library/azure/dn261237.aspx)

### Recursos do Java

- [Código-fonte para a Biblioteca do Cliente de Armazenamento do Java](https://github.com/azure/azure-storage-java)
- [Referência da Biblioteca do Cliente do Java](http://dl.windowsazure.com/storage/javadoc/)

### Recursos do Node.js

- [Código fonte para a Biblioteca do Cliente de Armazenamento do Node.js](https://github.com/Azure/azure-storage-node)
- [Referência da Biblioteca do Cliente do Node.js](http://dl.windowsazure.com/nodestoragedocs/index.html)

### Recursos do C++

- [Código fonte para a Biblioteca do Cliente de Armazenamento do C++](https://github.com/Azure/azure-storage-cpp)
