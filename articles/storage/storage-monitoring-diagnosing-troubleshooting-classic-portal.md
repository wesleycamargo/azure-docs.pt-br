...
A figura abaixo da ferramenta de monitoramento do Portal Clássico do Azure mostra um exemplo em que **AverageE2ELatency** é significantemente mais alta que a **AverageServerLatency**.
