<properties 
	pageTitle="Introdução aos serviços conectados de armazenamento de fila do Azure e Visual Studio (projetos de Serviço de Nuvem)" 
...
## Usar padrão Async-Await com APIs comuns de fila do Azure
