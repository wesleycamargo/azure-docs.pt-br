---
title: Como usar o armazenamento de Tabela do Azure por meio do Node.js | Microsoft Docs
...
* Repositório do [SDK do Armazenamento do Azure para Node][SDK do Armazenamento do Azure para Node] no GitHub.
