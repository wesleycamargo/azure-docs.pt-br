<properties
	pageTitle="Introdução ao armazenamento de tabela do Azure e serviços conectados do Visual Studio"
	description="Introdução ao uso do armazenamento de tabela do Azure em um projeto de serviço de nuvem no Visual Studio."
	services="storage"
	documentationCenter=""
	authors="patshea123"
	manager="douge"
...
Para criar a tabela do Azure, basta adicionar uma chamada a `CreateIfNotExistsAsync` após obter um objeto `CloudTable` como descrito na seção "Acessar tabelas no código".
