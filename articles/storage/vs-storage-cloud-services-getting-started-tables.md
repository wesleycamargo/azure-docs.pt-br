...
Para criar a tabela do Azure, basta adicionar uma chamada para `CreateIfNotExistsAsync` após obter um objeto `CloudTable` conforme descrito na seção "Acessar tabelas em código".
