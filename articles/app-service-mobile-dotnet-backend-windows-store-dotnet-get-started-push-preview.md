...
5. [Testar notificações por push em seu aplicativo](#test)
...
2. No Serviço de Notificação do Windows, insira seu **Segredo do cliente** e **Identificador de segurança (SID) do pacote** e salve.
