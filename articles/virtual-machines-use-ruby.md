...
Para listar os discos para sua assinatura do Azure, use o método **list\_virtual\_machine\_disks**. Isso retornará uma matriz de objetos **Azure::VirtualMachineImageManagement::VirtualMachineDisk**.
