---
title: "Migrar circuitos ExpressRoute e redes virtuais associadas do clássico para o Resource Manager: Azure | Microsoft Docs"
description: "Esta página descreve como migrar um circuito clássico e redes virtuais associadas ao Resource Manager."
...
---
# <a name="migrate-expressroute-circuits-and-associated-virtual-networks-from-the-classic-to-the-resource-manager-deployment-model"></a>Migrar circuitos de ExpressRoute e redes virtuais associadas do modelo de implantação clássico para o Resource Manager

Este artigo explica como migrar circuitos de Azure ExpressRoute e redes virtuais associadas do modelo de implantação clássico para o modelo de implantação do Azure Resource Manager. 
...
* Examine a documentação de migração de recurso a seguir:
    ...
    * [Erros comuns durante a migração do clássico para o Azure Resource Manager](../virtual-machines/virtual-machines-migration-errors.md)

## <a name="supported-and-unsupported-scenarios"></a>Cenários com e sem suporte

* Um circuito de ExpressRoute pode ser migrado do ambiente clássico para o do Resource Manager sem nenhum tempo de inatividade. É possível mover um circuito de ExpressRoute do ambiente clássico para o do Resource Manager sem nenhum tempo de inatividade. Siga as instruções para [mover os circuitos de ExpressRoute do modelo de implantação clássico para o do Resource Manager usando o PowerShell](expressroute-howto-move-arm.md). Este é um pré-requisito para mover recursos conectados à rede virtual.
