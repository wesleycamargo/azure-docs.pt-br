...
# Pré-requisitos para Rota Expressa do Azure  

Para se conectar aos serviços de nuvem da Microsoft usando a Rota Expressa, você precisará verificar se os seguintes pré-requisitos foram atendidos.
...
- Se você deseja usar um provedor de serviços de rede e seu provedor de serviços de rede não está na lista de provedores com suporte, você ainda pode criar uma conexão com o Azure.
	- Verifique com seu provedor de rede para ver se eles estão presentes em qualquer um dos locais do Exchange que aparecem na lista de provedores com suporte.
...
- Conectividade para a infraestrutura do provedor de serviços. Você deve atender aos critérios para pelo menos um dos itens a seguir:
...
- Endereços IP e números AS para configuração de roteamento.
	- Você pode usar números AS privados para se conectar a um domínio de roteamento de emparelhamento privado do Azure. Se você optar por fazer isso, ele deve ser > 65.000. Para obter mais informações sobre números AS, consulte [Números AS (Sistema Autônomo)](http://www.iana.org/assignments/as-numbers/as-numbers.xhtml).
