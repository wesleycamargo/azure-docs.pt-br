...
A Rota Expressa do Microsoft Azure permite a criação de conexões privadas entre os datacenters da Microsoft e a infraestrutura no seu local ou em um ambiente de colocalização. Com a Rota Expressa, você pode estabelecer conexões com serviços em nuvem da Microsoft, como o Microsoft Azure e o Office 365, em uma instalação de locação conjunta com parceiro da Rota Expressa. Ou você pode conectar-se diretamente da sua rede WAN existente usando, por exemplo, uma VPN MPLS fornecida por um provedor de serviços de rede.
...
|**Provedores de conectividade**|[Provedores do Exchange](expressroute-locations.md)|[Provedores de serviço de rede](expressroute-locations.md)|
...
- Você pode trabalhar com provedores como Level 3 para instalar circuitos de Ethernet entre seus datacenters e a Microsoft. 
...
Para obter mais informações sobre a configuração e para ver exemplos do mundo real, você pode seguir este guia passo a passo: [Configurar uma conexão de Rota Expressa por meio de um provedor do Exchange](expressroute-configuring-exps.md).
...
Para obter mais informações sobre a configuração e para ver exemplos do mundo real, você pode seguir este guia passo a passo: [Configurar uma conexão de Rota Expressa por meio de um provedor de serviços de rede](expressroute-configuring-nsps.md).

## Emparelhamentos da Rota Expressa
...
Se você optar por ter todas as três sessões de emparelhamento, você deve ter três pares de sessões BGP (um par para cada tipo de emparelhamento). Os pares de sessões BGP fornecem um link altamente disponível. Se você estiver se conectando por meio de EXPs, você será responsável por configurar e gerenciar o roteamento (a menos que o EXP se ofereça para gerenciar o roteamento para você). Se optar por se conectar por meio de NSPs, você pode usar o NSP para gerenciar o roteamento para você. Você pode aprender mais examinando os fluxos de trabalho para configuração da Rota Expressa
