...
Esse artigo explica as etapas para criar e gerenciar a configuração de roteamento de um circuito da Rota Expressa usando o PowerShell e o modelo de implantação do Azure Resource Manager.  As etapas abaixo também mostram como verificar o status, atualizar ou excluir e desprovisionar emparelhamentos de um circuito do ExpressRoute. 

## <a name="configuration-prerequisites"></a>Pré-requisitos de configuração

* Você precisará da versão mais recente dos cmdlets do PowerShell do Azure Resource Manager. Para saber mais, consulte [Como instalar e configurar o Azure PowerShell](/powershell/azure/overview): 
...
3. Verifique se o circuito da Rota Expressa foi provisionado.
  ...
  Primeiro, verifique se o circuito da Rota Expressa está Provisionado e Habilitado. Veja os exemplos a seguir:
...
4. Configure o emparelhamento privado do Azure para o circuito.
  ...
  * Um Hash MD5, se você optar por usar um. **Isso é opcional**.
  ...
  Você pode executar o cmdlet a seguir para configurar o emparelhamento privado do Azure para seu circuito:
  ...
  Você pode usar o cmdlet a seguir se você optar por usar um hash MD5:
...
Você pode atualizar qualquer parte da configuração usando o cmdlet a seguir. No exemplo a seguir, a ID de VLAN do circuito está sendo atualizada de 100 para 500:
...
Você pode executar o cmdlet a seguir a fim de configurar o emparelhamento público do Azure para seu circuito:
  ...
  Você pode usar o exemplo a seguir se você optar por usar um hash MD5:
