...
### <a name="how-can-i-use-expressroute-to-connect-to-microsoft-if-i-don’t-have-partnerships-with-one-of-the-expressroute-carrier-partners?"></a>Como posso usar a Rota Expressa para conexão à Microsoft se eu não tenho parcerias com uma das operadoras parceiras da Rota Expressa?
...
### <a name="after-i-advertise-the-default-route-(0.0.0.0/0)-to-my-virtual-networks,-i-can't-activate-windows-running-on-my-azure-vms.-how-to-i-fix-this?"></a>Após anunciar a rota padrão (0.0.0.0/0) para minhas redes virtuais, eu não posso ativar o Windows sendo executado em minhas VMs do Azure. Como posso corrigir isso?
