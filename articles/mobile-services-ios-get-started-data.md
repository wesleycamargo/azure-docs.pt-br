...
+ [SDK do iOS para Serviços Móveis] e [XCode 4.5][Install Xcode] e iOS 5.0 ou versões posteriores.
...
1. Baixar o [aplicativo de exemplo][GitHub] GetStartedWithData.
