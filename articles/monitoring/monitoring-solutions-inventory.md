...
| [Integridade do Agente](monitoring-solution-agenthealth.md) | Windows e Linux | &#8226; | &#8226; | | | &#8226; | 1 minuto |
...
| **Solução de gerenciamento** | **Plataforma** | **Microsoft Monitoring Agent** | **Agente do Operations Manager** | **Armazenamento do Azure** | **O Operations Manager é necessário?** | **Dados do agente do Operations Manager enviados por meio do grupo de gerenciamento** | **Frequência de coleta** |
| [Análise do Grupo de Segurança de Rede do Azure (preterido)](../log-analytics/log-analytics-azure-networking-analytics.md) | Azure |  |  |  |  |  | após a notificação |
...
| [Controle de alterações](../automation/automation-change-tracking.md) |Windows |&#8226; |&#8226; | | |&#8226; |por hora |
| [Controle de alterações](../automation/automation-change-tracking.md) |Linux |&#8226; | | | | |por hora |
...
| [Análise do Office 365 (versão prévia)](monitoring-solution-office-365.md) |Windows | | | | | |após a notificação |
| **Solução de gerenciamento** | **Plataforma** | **Microsoft Monitoring Agent** | **Agente do Operations Manager** | **Armazenamento do Azure** | **O Operations Manager é necessário?** | **Dados do agente do Operations Manager enviados por meio do grupo de gerenciamento** | **Frequência de coleta** |
| [Análise do Service Fabric](../service-fabric/service-fabric-diagnostics-oms-setup.md) |Windows | | |&#8226; | | |5 minutos |
| [Mapa do Serviço](monitoring-service-map.md) | Windows e Linux | &#8226; | &#8226; |  |  |  | 15 s |
...
| [Monitoramento do VMware (preterido)](../log-analytics/log-analytics-vmware.md) | Linux | &#8226; |  |  |  |  | 3 minutos |
