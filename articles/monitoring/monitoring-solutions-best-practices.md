...
Este artigo apresenta as práticas recomendadas para a [criação de um arquivo de solução de gerenciamento](monitoring-solutions-solution-file.md) no Azure.  Essas informações serão atualizadas à medida que práticas recomendadas adicionais forem identificadas.
...
- Configure a solução para [conter](monitoring-solutions-solution-file.md#solution-resource) a exibição, de modo que ela seja removida caso a solução seja removida.
...
- Configure a solução para [fazer referência](monitoring-solutions-solution-file.md#solution-resource) a regras de alerta, de modo que os usuários possam alterar a configuração delas.  Talvez eles queiram modificar a lista de destinatários, mudar o limite do alerta ou desabilitar a regra de alerta. 


## <a name="next-steps"></a>Próximas etapas
* Veja o passo a passo do processo básico de [projetar e criar uma solução gerenciada](monitoring-solutions-creating.md).
* Saiba como [criar um arquivo de solução](monitoring-solutions-solution-file.md).
