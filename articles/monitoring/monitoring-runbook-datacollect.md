...
![Editar runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Publicar runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Log e rastreamento](media/monitoring-runbook-datacollect/logging.png)
...
![Trabalhos](media/monitoring-runbook-datacollect/jobs.png)
...
5. Role para baixo para localizar uma entrada semelhante à imagem a seguir.<br>![Detalhado](media/monitoring-runbook-datacollect/verbose.png)
...
- Empacotar seu runbook em um [solução de gerenciamento](monitoring-solutions-creating.md) para distribuir para os clientes.
