...
As [Soluções de gerenciamento](monitoring-solutions.md) normalmente incluem uma ou mais exibições para visualizar dados.  Este artigo descreve como exportar uma exibição criada pelo [Designer de Exibição](../log-analytics/log-analytics-view-designer.md) e incluí-la em uma solução de gerenciamento.  
...
* Conheça os detalhes completos de criação das [soluções de gerenciamento](monitoring-solutions-creating.md).
* Incluir os [runbooks de automação na solução de gerenciamento](monitoring-solutions-resources-automation.md).
