...
Para instalar a nova versão do agente, siga as etapas descritas no artigo [Monitoramento Onboard](monitoring-container-insights-onboard.md?toc=%2fazure%2fmonitoring%2ftoc.json#enable-monitoring-using-azure-cli) usando a CLI do Azure para concluir esse processo.  
...
Se você tiver problemas ao atualizar o agente, revise o [guia de solução de problemas](monitoring-container-insights-troubleshoot.md) para obter suporte.