...
![Logotipo do Office 365](media/monitoring-solution-office-365/icon.png)
...
- Execute a solução de problemas operacionais usando [ a Pesquisa do OMS sobre os dados de atividade](../log-analytics/log-analytics-queries.md) do Office 365 da sua organização.
...
Comece adicionando a [solução do Office 365 à sua assinatura](monitoring-solutions.md#install-a-management-solution). Depois, execute as etapas de configuração desta seção para conceder acesso à sua assinatura do Office 365.
...
1. Clique em **Novo registro de aplicativo**.
    ...
    ![Adicionar registro do aplicativo](media/monitoring-solution-office-365/add-app-registration.png)
1. Insira um **Nome** de aplicativo e **URL de Logon**.  O nome deve ser descritivo.  Use _http://localhost_ para a URL, e mantenha _Aplicativo Web/API_ como o **Tipo de aplicativo**
    ...
    ![Criar aplicativo](media/monitoring-solution-office-365/create-application.png)
1. Clique em **Criar** e valide as informações do aplicativo.

    ![Aplicativo registrado](media/monitoring-solution-office-365/registered-app.png)
...
1. Selecione **Propriedades**. Altere **Multilocatário** para _Sim_.
    ...
    ![Configurações de multilocatário](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Você verá uma janela semelhante à mostrada abaixo. Clique em **Aceitar**.
    ...
    ![Consentimento do administrador](media/monitoring-solution-office-365/admin-consent.png)
...
![Bloco de Resumo do Office 365](media/monitoring-solution-office-365/tile.png)  

Clique no bloco **Office 365** para abrir o painel **Office 365**.

![Painel do Office 365](media/monitoring-solution-office-365/dashboard.png)  
...
* Use Pesquisas de Log no [Log Analytics](../log-analytics/log-analytics-queries.md) para exibir dados detalhados das atualizações.
...
* [Crie alertas](../monitoring-and-diagnostics/monitoring-overview-unified-alerts.md) para ser notificado proativamente das atividades importantes do Office 365.  
