...
![Clique em Novo, Serviços de Desenvolvedor, Application Insights](./media/app-insights-asp-net/01-new-asp.png)
...
![Clique em Propriedades, selecione a chave e pressione ctrl + C](./media/app-insights-asp-net/02-props-asp.png)
