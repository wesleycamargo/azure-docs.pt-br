...
# Se não for possível se inscrever no Azure
...
## Não estou recebendo mensagens de texto ou chamadas durante a verificação da conta ao tentar me inscrever
...
>[AZURE.NOTE] Você pode alterar o número de telefone preferencial posteriormente [atualizando as informações de seu perfil](billing-how-to-change-azure-account-profile.md).
...
Para causas comuns dos problemas de inscrição usando um cartão de crédito ou débito, consulte o artigo [Meu cartão de crédito não é aprovado quando tento me inscrever no Azure](billing-credit-card-fails-during-azure-sign-up.md).
...
## Não é possível ativar uma Avaliação Gratuita do Azure
