<properties urlDisplayName="Scale mobile services backed by Azure SQL Database" pageTitle="Escalar serviços móveis com suporte pelo Banco de Dados SQL do Azure - Serviços Móveis do Azure" metaKeywords="" description="Learn how to diagnose and fix scalability issues in your mobile services backed by SQL Database" metaCanonical="" services="" documentationCenter="Mobile" title="Scale mobile services backed by Azure SQL Database" authors="donnam" solutions="" manager="dwrede" editor="mollybos" />
