...
7. Na folha da conta da Análise Data Lake, clique em **Gerenciador de Dados** na parte superior.
...
8. Na folha da conta padrão do Repositório Data Lake, clique em **Exemplos** para expandir a pasta e clique em **Dados** para expandir a pasta. Você deverá ver os seguintes arquivos e pastas:
...
4. Insira o **Nome do Trabalho** e o seguinte script U-SQL:
...
5. Clique em **Enviar Trabalho** na parte superior. Um novo painel Detalhes do Trabalho é aberto. Na barra de título, ele mostra o status do trabalho.
6. Aguarde até que o status do trabalho seja alterado para **Êxito**. Após a conclusão do trabalho, o portal abrirá os detalhes do trabalho em uma nova folha:
...
7. Na parte inferior da folha **Detalhes do Trabalho**, clique no nome do trabalho em **SearchLog-from-Data-Lake.csv**. Você pode visualizar, baixar, renomear e excluir o arquivo de saída.
...
8. Clique em **Visualização** para ver o arquivo de saída.
