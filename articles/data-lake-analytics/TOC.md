...
## Gerenciar o Data Lake Analytics
...
#### [Operadores definidos pelo usuário](data-lake-analytics-u-sql-develop-user-defined-operators.md)
#### [Extensões do Python](data-lake-analytics-u-sql-python-extensions.md)
#### [Extensões de R](data-lake-analytics-u-sql-r-extensions.md)
...
## Agendar trabalhos U-SQL
### [Agendar trabalhos usando o SSIS](data-lake-analytics-schedule-jobs-ssis.md)

## Integração e implantação contínuas
### [Visão geral](data-lake-analytics-cicd-overview.md)
### [Registro do assembly](data-lake-analytics-cicd-manage-assemblies.md)
