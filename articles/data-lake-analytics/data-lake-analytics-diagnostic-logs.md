...
2. Dentro desses contêineres, os logs são armazenados na estrutura a seguir.
   ...
   > [!NOTE]
   > As entradas do `##` no caminho contêm o ano, o mês, o dia e a hora em que o log foi criado. O Data Lake Analytics cria um arquivo a cada hora e, portanto, o `m=` sempre conterá um valor `00`.
   > 
   > 
