---
title: Gerenciar a Análise do Azure Data Lake usando o Portal do Azure | Microsoft Docs
...
A exclusão de uma conta da Análise não excluirá a conta dependente do Repositório Data Lake. Para obter instruções sobre como excluir contas do Repositório Data Lake, consulte [Excluir conta do Repositório Data Lake](../data-lake-store/data-lake-store-get-started-portal.md#delete-azure-data-lake-store-account).
