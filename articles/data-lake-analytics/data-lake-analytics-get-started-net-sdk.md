...
6. Pressione **F5** para executar o aplicativo. A saída se parece com a seguinte:
...
7. Verifique o arquivo de saída. O nome de arquivo e caminho padrão são c:\\Temp\\SearchLog-from-Data-Lake.csv.
