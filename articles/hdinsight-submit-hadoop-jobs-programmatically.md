<properties linkid="manage-services-hdinsight-submit-hadoop-jobs-programmatically" urlDisplayName="Administração do HDInsight" pageTitle="Enviar trabalhos Hadoop de forma programática | Azure" metaKeywords="hdinsight, administração do hdinsight, azure administração do hdinsight, hive, mapreduce, HDInsight .NET SDK, powershell, enviar trabalhos mapreduce, enviar trabalhos do hive, desenvolvimento, hadoop, apache" description="Saiba como enviar de forma programática trabalhos Hadoop ao HDInsight do Azure." umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" services="hdinsight" documentationCenter="" title="Enviar trabalhos Hadoop de forma programática" authors="jgao" />
...
* Um cluster Azure HDInsight. Para obter instruções, consulte [Introdução ao HDInsight][hdinsight-getting-started] ou [Provisionar clusters HDInsight][hdinsight-provision].
...
##<a id="mapreduce-powershell"></a> Enviar trabalhos MapReduce usando o PowerShell do Azure
...
3. Defina estas duas variáveis executando os seguintes comandos do PowerShell:
...
7. Execute o seguinte comando para verificar a conclusão do trabalho MapReduce:
...
##<a id="hive-powershell"></a> Enviar trabalhos de Hive usando o PowerShell
O Apache [Hive][apache-hive] fornece um meio de executar o trabalho MapReduce por meio de uma linguagem de script semelhante ao SQL, chamada *HiveQL*, que pode ser aplicada para sumarização, consultas e análise de grandes volumes de dados. 
...
Para obter mais informações sobre o Hive, consulte [Usar o Hive com o HDInsight][hdinsight-hive].

##<a id=""></a>Enviar trabalhos Sqoop usando o PowerShell

Consulte [Usar o Sqoop com o HDInsight][hdinsight-sqoop].
...
13. Na função Main(), acrescente o seguinte código para executar o trabalho e aguarde até que o trabalho seja concluído:
...
##<a id="hive-sdk"></a> Enviar trabalhos de Hive usando o SDK do .NET do HDInsight
Os clusters HDInsight são fornecidos com um exemplo de tabela Hive chamada *hivesampletable*. Nesta seção, você criará um aplicativo .NET para executar um trabalho Hive para listar as tabelas Hive criadas no cluster HDInsight. Para obter mais informações sobre como usar o Hive, consulte [Usar o Hive com o HDInsight][hdinsight-hive].
...
[azure-certificate]: http://msdn.microsoft.com/pt-br/library/windowsazure/gg551722.aspx
