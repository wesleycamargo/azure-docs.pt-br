...
Este tutorial requer a CLI do Azure, versão 2.0.4 ou posterior. Para saber qual é a versão, execute `az --version`. Se você precisar atualizar, consulte [Instalar a CLI do Azure]( /cli/azure/install-azure-cli).
