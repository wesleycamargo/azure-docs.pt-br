...
O serviço de Armazenamento do Azure dá suporte para as três estratégias, embora seja distinto em sua capacidade de fornecer suporte completo para a simultaneidade otimista e pessimista, pois foi projetado para englobar um modelo de coerência forte, o qual garante que quando o serviço de Armazenamento confirma uma operação de atualização ou inserção de dados, todos os acessos adicionais a tais dados possam ver a atualização mais recente. As plataformas de armazenamento que usam um modelo de consistência eventual apresentam um retardo entre o momento em que uma gravação é realizada por um usuário e o momento em que os dados atualizados podem ser visualizados por outros usuários, o que complica o desenvolvimento de aplicativos cliente para evitar que as inconsistências afetem os usuários finais.  
...
Observe que as operações **Insert or Replace Entity** e **Insert or Merge Entity**  *not* realizam todas as verificações de simultaneidade, pois não enviam um valor de ETag para o serviço Tabela.  
...
- [Gerenciando a simultaneidade usando o Armazenamento do Azure - Aplicativo de exemplo](http://code.msdn.microsoft.com/windowsazure/Managing-Concurrency-using-56018114)  
