...
| Operação REST                                         | Método .NET                                      | Permissão com acesso de leitura público completo | Permissão de acesso de leitura público apenas para blobs |
|--------------------------------------------------------|--------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| Listar contêineres                                        | ListContainers                                   | Somente proprietário                              | Somente proprietário                                        |
| Create Container                                       | Criar                                           | Somente proprietário                              | Somente proprietário                                        |
| Get Container Properties                               | Propriedades                                       | Todos                                     | Somente proprietário                                        |
| Get Container Metadata                                 | Metadados                                         | Todos                                     | Somente proprietário                                        |
| Set Container Metadata                                 | Metadados                                         | Somente proprietário                              | Somente proprietário                                        |
| Get Container ACL                                      | BlobContainerPermissions                         | Somente proprietário                              | Somente proprietário                                        |
| Set Container ACL                                      | BlobContainerPermissions                         | Somente proprietário                              | Somente proprietário                                        |
| Delete Container                                       | Excluir                                           | Somente proprietário                              | Somente proprietário                                        |
| Listar Blobs                                             | ListBlobs                                        | Todos                                     | Somente proprietário                                        |
| Put Blob                                               | Criar método de CloudPageBlob ou CloudBlockBlob | Somente proprietário                              | Somente proprietário                                        |
| Get Blob                                               | DownloadByteArray e outros                     | Todos                                     | Todos                                               |
| Get Blob Properties                                    | Propriedades                                       | Todos                                     | Todos                                               |
| Set Blob Properties                                    | SetProperties                                    | Somente proprietário                              | Somente proprietário                                        |
| Get Blob Metadata                                      | Metadados                                         | Todos                                     | Todos                                               |
| Set Blob Metadata                                      | Metadados                                         | Somente proprietário                              | Somente proprietário                                        |
| Put Block                                              | PutBlock                                         | Somente proprietário                              | Somente proprietário                                        |
| Obter lista de blocos (somente blocos confirmados)                 | DownloadBlockList                                | Todos                                     | Todos                                               |
| Obter lista de blocos (somente blocos não confirmados ou todos os blocos) | DownloadBlockList                                | Somente proprietário                              | Somente proprietário                                        |
| Put Block List                                         | PutBlockList                                     | Somente proprietário                              | Somente proprietário                                        |
| Delete Blob                                            | Excluir                                           | Somente proprietário                              | Somente proprietário                                        |
| Copiar blob                                              | CopyFromBlob                                     | Somente proprietário                              | Somente proprietário                                        |
| Blob de instantâneo                                          | CreateSnapshot                                   | Somente proprietário                              | Somente proprietário                                        |
| Lease Blob                                             | Concessão                                            | Somente proprietário                              | Somente proprietário                                        |
| Put Page                                               | WritePages                                       | Somente proprietário                              | Somente proprietário                                        |
| Get Page Ranges                                        | GetPageRanges                                    | Todos                                     |                                                   |
...
>[AZURE.NOTE]Para uma visão geral conceitual e um tutorial detalhado sobre assinaturas de acesso compartilhado, consulte [Assinaturas de Acesso Compartilhado](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/).

Operações suportadas para o uso de assinaturas de acesso compartilhado incluem:

- Ler e gravar o conteúdo de blob de página de bloqueio, listas de bloqueio, propriedades e metadados
...
Um cliente que recebe uma assinatura de acesso compartilhado pode usá-la no seu código para construir um objeto do tipo [StorageCredentials](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.auth.storagecredentials.aspx). Essas credenciais podem ser usadas para construir um objeto [CloudStorageAccount](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.cloudstorageaccount.aspx) ou [CloudBlobClient](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.blob.cloudblobclient.aspx) para trabalhar com o recurso, como mostrado neste exemplo:
