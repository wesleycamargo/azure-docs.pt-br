...
As anotações e as diretrizes a seguir são para desenvolvedores que trabalham com a biblioteca .NET/C# do Cofre de Chaves do Azure. Na mudança da versão 1.0 para a versão 2.0, diversas atualizações feitas exigirão o trabalho de migração em seu código para que você se beneficie de aprimoramentos funcionais e adições de recurso, como suporte a certificados de Cofre de Chaves.
