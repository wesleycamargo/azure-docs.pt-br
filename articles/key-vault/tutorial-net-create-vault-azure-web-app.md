...
Neste tutorial, você aprenderá a criar um aplicativo Web do Azure que possa ler informações do Azure Key Vault. O processo usa identidades gerenciadas para recursos do Azure. Para obter mais informações sobre aplicativos Web do Azure, confira [Aplicativos Web do Azure](../app-service/app-service-web-overview.md).
...
>[Guia do Desenvolvedor do Azure Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/key-vault-developers-guide)
