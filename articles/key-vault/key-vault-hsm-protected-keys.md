---
title: Como gerar e transferir chaves protegidas por HSM para o Cofre da Chave do Azure | Microsoft Docs
...
| Um Cofre da Chave do Azure que dá suporte a HSMs |Para obter mais informações sobre os recursos e as camadas de serviço para o Cofre da Chave do Azure, consulte o site [Preços do Cofre da Chave do Azure](https://azure.microsoft.com/pricing/details/key-vault/) . |
...
### <a name="step-1.1:-install-azure-powershell"></a>Etapa 1.1: Instalar o Azure PowerShell
...
### <a name="step-1.2:-get-your-azure-subscription-id"></a>Etapa 1.2: Obter a sua ID da assinatura do Azure
...
### <a name="step-1.3:-download-the-byok-toolset-for-azure-key-vault"></a>Etapa 1.3: Baixe o conjunto de ferramentas BYOK para o Cofre da Chave do Azure
...
### <a name="step-2.1:-prepare-the-disconnected-workstation-with-thales-hsm"></a>Etapa 2.1: Preparar a estação de trabalho desconectada com HSM da Thales
...
### <a name="step-2.2:-install-the-byok-toolset-on-the-disconnected-workstation"></a>Etapa 2.2: Instalar o conjunto de ferramentas BYOK na estação de trabalho desconectada
...
### <a name="step-3.1:-create-a-security-world"></a>Etapa 3.1: Criar um Universo de segurança
...
### <a name="step-3.2:-validate-the-downloaded-package"></a>Etapa 3.2: Validar o pacote baixado
...
### <a name="step-3.3:-create-a-new-key"></a>Etapa 3.3: Criar uma nova chave
...
### <a name="step-4.1:-create-a-copy-of-your-key-with-reduced-permissions"></a>Etapa 4.1: Criar uma cópia da chave com permissões reduzidas
...
### <a name="step-4.2:-inspect-the-new-copy-of-the-key"></a>Etapa 4.2: Inspecione a nova cópia da chave
...
### <a name="step-4.3:-encrypt-your-key-by-using-microsoft’s-key-exchange-key"></a>Etapa 4.3: Criptografar a chave usando a Chave de Troca de Chaves da Microsoft
...
### <a name="step-4.4:-copy-your-key-transfer-package-to-the-internet-connected-workstation"></a>Etapa 4.4: Copie o pacote de transferência de chave para a estação de trabalho conectada à Internet
...
Para essa etapa final, na estação de trabalho conectada à Internet, use o cmdlet [Add-AzureKeyVaultKey](https://msdn.microsoft.com/library/azure/dn868048\(v=azure.300\).aspx).aspx) para carregar o pacote de transferência de chave que você copiou da estação de trabalho desconectada para o HSM do Cofre de Chaves do Azure:
