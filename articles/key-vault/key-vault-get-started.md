---
title: Introdução ao Cofre da Chave do Azure | Microsoft Docs
...
## <a name="<a-id="connect"></a>connect-to-your-subscriptions"></a><a id="connect"></a>Conectar-se a suas assinaturas
...
## <a name="<a-id="resource"></a>create-a-new-resource-group"></a><a id="resource"></a>Criar um novo grupo de recursos
...
## <a name="<a-id="vault"></a>create-a-key-vault"></a><a id="vault"></a>Criar um cofre de chave
...
## <a name="<a-id="add"></a>add-a-key-or-secret-to-the-key-vault"></a><a id="add"></a>Adicionar uma chave ou segredo ao cofre de chave
...
## <a name="<a-id="register"></a>register-an-application-with-azure-active-directory"></a><a id="register"></a>Registrar um aplicativo com o Active Directory do Azure
...
## <a name="<a-id="authorize"></a>authorize-the-application-to-use-the-key-or-secret"></a><a id="authorize"></a>Autorizar o aplicativo a usar a chave ou segredo
...
## <a name="<a-id="hsm"></a>if-you-want-to-use-a-hardware-security-module-(hsm)"></a><a id="HSM"></a>Se quiser usar um HSM (módulo de segurança de hardware)
...
## <a name="<a-id="delete"></a>delete-the-key-vault-and-associated-keys-and-secrets"></a><a id="delete"></a>Excluir o cofre de chave e as chaves e segredos associados
...
## <a name="<a-id="other"></a>other-azure-powershell-cmdlets"></a><a id="other"></a>Outros cmdlets do PowerShell do Azure
...
## <a name="<a-id="next"></a>next-steps"></a><a id="next"></a>Próximas etapas
