...
Esta é a quinta etapa do passo a passo: [Desenvolvendo uma Solução Preditiva com o AM do Azure][Desenvolvendo uma Solução Preditiva com o AM do Azure]:
...
1.  Clique em **Salvar como**, abaixo das telas.
...
![Lista de testes][Lista de testes]
...
1.  Excluir a **Máquina de vetor de suporte de duas classes**
2.  Excluir os módulos **Treinar modelo** e **Modelo de pontuação** que foram conectados a ela
...
2.  Conecte esse módulo à saída do módulo **Editor de metadados** Todas as colunas (agora que os módulos **Divisão** e **Executar script R** foram removidos)
...
![Pontuando o modelo treinado][Pontuando o modelo treinado]
...
![Promovendo o serviço para o ambiente ativo][Promovendo o serviço para o ambiente ativo]

------------------------------------------------------------------------

**Avançar: [Acessar o serviço Web][Acessar o serviço Web]**
  ...
  [Lista de testes]: ./media/machine-learning-walkthrough-5-publish-web-service/publish1.png
  [Pontuando o modelo treinado]: ./media/machine-learning-walkthrough-5-publish-web-service/publish2.png
  [Promovendo o serviço para o ambiente ativo]: ./media/machine-learning-walkthrough-5-publish-web-service/publish3.png
