<properties urlDisplayName="Set Up Computer for Media Services" pageTitle="Como configurar o computador para Serviços de Mídia - Azure" metaKeywords="" description="Conheça os pré-requisitos para os Serviços de Mídia usando o SDK dos Serviços de Mídia para .NET. Saiba também como criar um aplicativo do Visual Studio." metaCanonical="" services="media-services" documentationCenter="" title="Setting up your computer for Media Services development" authors="juliako" solutions="" manager="dwrede" editor="" />
