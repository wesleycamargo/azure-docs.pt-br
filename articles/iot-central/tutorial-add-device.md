...
ms.locfileid: "34201924"
---
# <a name="add-a-real-device-to-your-azure-iot-central-application"></a>Adicionar um dispositivo real ao aplicativo Azure IoT Central
...
1. Em seguida, como um desenvolvedor do dispositivo, você aprenderá sobre o código em seu dispositivo real. Você pode adicionar a cadeia de conexão desde a primeira parte para o exemplo de código.
...
> * Configurar o código do cliente para um dispositivo real
...
1. Para começar a conectar um dispositivo real de ar-condicionado conectado, escolha **Novo**, em seguida, **Real**:

    ![Comece adicionando um novo dispositivo real de ar-condicionado conectado](media/tutorial-add-device/newreal.png)

1. Opcionalmente, você pode renomear o novo dispositivo escolhendo o nome do dispositivo e editando o valor:
...
1. Na página **Propriedades** do seu novo dispositivo real de ar-condicionado conectado, defina o **Número de série** para **rcac0010** e **versão de Firmware** para 9.75. Depois escolha **Salvar**:

    ![Definir as propriedades de um dispositivo real](media/tutorial-add-device/setproperties.png)

1. Como um construtor, você pode visualizar as páginas de **Medidas**, **Regras** e **Painel** para o seu dispositivo real.
...
Um desenvolvedor de dispositivo precisa inserir a _cadeia de conexão_ para seu dispositivo real no código que é executado no dispositivo. A cadeia de conexão permite que o dispositivo se conecte com segurança ao seu aplicativo Azure IoT Central. Cada instância de dispositivo possui uma cadeia de conexão exclusiva. As etapas a seguir mostram como localizar a cadeia de conexão para uma instância de dispositivo no seu aplicativo:
...
1. Na página **Conectar**, copie a **Cadeia de conexão primária**e salve-a. Você pode usar esse valor na segunda metade deste tutorial. Um desenvolvedor de dispositivo usa esse valor no aplicativo cliente que é executado no dispositivo:
...
## <a name="configure-client-code-for-real-device"></a>Configurar o código do cliente para um dispositivo real
...
1. Substitua `{your device connection string}` pela cadeia de conexão do dispositivo real. Você fez uma nota da cadeia de conexão no final da seção "Obter a cadeia de conexão para um dispositivo real a partir do aplicativo".
