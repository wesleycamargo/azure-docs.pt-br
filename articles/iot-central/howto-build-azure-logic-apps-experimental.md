...
1. Comece [criando uma regra na IoT Central](howto-create-telemetry-rules-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json). Depois de salvar as condições de regra, clique no bloco **Aplicativos Lógicos do Azure** como uma nova ação. Clique em **Criar no portal do Azure**. Você será levado ao portal do Azure para criar um novo aplicativo lógico. Talvez você precise entrar em sua conta do Azure.
...
1. Insira as informações necessárias para criar um novo aplicativo lógico. Você pode escolher uma assinatura do Azure na qual provisionar seu novo aplicativo lógico. Não precisa ser a mesma assinatura em que seu aplicativo IoT Central foi criado. Clique em **Criar**.
    ...
    ![Criar aplicativo lógico no portal do Azure](./media/howto-build-azure-logic-apps-experimental/createinazureportal.png)
...
1. Depois que seu aplicativo lógico foi criado com êxito, você será direcionado automaticamente para o Designer de Aplicativos Lógicos. Clique em **Aplicativo Lógico em Branco**. 
    ...
    ![Criar um aplicativo lógico em branco](./media/howto-build-azure-logic-apps-experimental/blanklogicapp.png)
...
1. No designer, pesquise "iot central" e escolha o gatilho **Quando uma regra for disparada**. Entrar no conector com a conta usada para entrar no aplicativo IoT Central. 
    ...
    ![Entrar no conector do IoT Central](./media/howto-build-azure-logic-apps-experimental/addtrigger.png)

1. Depois de entrar com êxito, você deverá ver campos. Selecione **Aplicativo** e **Regra** nas listas suspensas.

    ![Escolher o aplicativo e a regra](./media/howto-build-azure-logic-apps-experimental/pickappandrule.png)
...
1. Na ação, escolha a **Equipe** e o **Canal**. Preencha o campo **Mensagem** com o que você deseja que cada mensagem diga. Você pode incluir *conteúdo dinâmico* da regra da IoT Central, passando informações importantes como o nome do dispositivo e o carimbo de data/hora para a notificação.
    ...
    ![Ação de edição do aplicativo lógico com o painel dinâmico aberto](./media/howto-build-azure-logic-apps-experimental/buildworkflow.png)
...
![ID do dispositivo do Device Explorer IoT Central](./media/howto-build-azure-logic-apps-experimental/iotcdeviceid.png)
