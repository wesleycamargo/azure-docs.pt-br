...
Para configurar um dispositivo físico do Windows 10 IoT Core, você precisará primeiro ter um dispositivo executando o Windows 10 IoT Core. Saiba como configurar um dispositivo do Windows 10 IoT Core [aqui](https://docs.microsoft.com/windows/iot-core/tutorials/quickstarter/devicesetup).
