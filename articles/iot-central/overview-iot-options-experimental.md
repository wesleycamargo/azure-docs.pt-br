...
* **Aceleradores de solução IoT**: [O que são os aceleradores de solução IoT do Azure?](../iot-accelerators/iot-accelerators-what-are-solution-accelerators.md).
* **Hub IoT**: [Visão geral do serviço Hub IoT do Azure](https://docs.microsoft.com/azure/iot-hub/iot-hub-what-is-iot-hub).