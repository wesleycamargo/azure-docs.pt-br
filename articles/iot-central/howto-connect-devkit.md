...
1. Obter os detalhes de conexão, como **chave primária, ID do dispositivo e ID do escopo** para o dispositivo adicionado selecionando **Connect** na página do dispositivo.
