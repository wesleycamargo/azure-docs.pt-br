...
Agora que você aprendeu como conectar um dispositivo DevKit ao seu aplicativo do Azure IoT Central, a próxima etapa sugerida é [preparar e conectar um Raspberry Pi](howto-connect-raspberry-pi-python.md).
