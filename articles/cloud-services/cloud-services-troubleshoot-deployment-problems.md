...
Quando você implanta um pacote de aplicativos do Serviço de Nuvem no Azure, é possível obter informações sobre a implantação no painel **Propriedades** no Portal de Gerenciamento. É possível usar os detalhes nesse painel para ajudá-lo a solucionar problemas com o serviço de nuvem, e você pode fornecer essas informações para o suporte do Azure ao abrir uma nova solicitação de suporte.
...
1. No Portal de Gerenciamento, clique na implantação do serviço de nuvem.
2. No painel **Propriedades** do Portal de Gerenciamento, verifique as portas para as instâncias de função (em Pontos de Extremidade de Entrada).
...
1. No Portal de Gerenciamento, clique na implantação do serviço de nuvem.
2. No painel **Propriedades** do Portal de Gerenciamento, examine as informações e determine se a recuperação de serviço ocorreu durante o tempo em que você observou a reinicialização das funções.

As funções também serão reiniciadas aproximadamente uma vez por mês durante as atualizações do SO Host e do SO Convidado. Para obter mais informações, veja a postagem no blog [A instância de função é reinicializada devido às atualizações do SO](http://blogs.msdn.com/b/jarrettr/archive/2012/09/19/role-instance-restarts-due-to-os-upgrades.aspx)
...
1. No Portal de Gerenciamento, clique na implantação do serviço de nuvem.
2. No painel **Propriedades** do Portal de Gerenciamento, observe o valor de **Status**. Se ele estiver **Pronto**, verifique a **Última operação** para ver se ocorreu uma operação recentemente que possa impedir a permuta de VIP.
...
1. No Portal de Gerenciamento, clique na instância de função.
2. No painel **Propriedades** do Portal de Gerenciamento, considere as seguintes condições para resolver o problema:
