...
3. Adicione o script a seguir ao arquivo **install.cmd**:
	...
	```
	> [AZURE.IMPORTANT]Atualize o valor da variável *netfx* no script para que ele corresponda à versão do Framework que você deseja instalar. Para instalar o .NET 4.5.2, a variável *netfx* deverá ser definida como *"NDP452"* e para instalar o .NET 4.6, a variável *netfx* deverá ser definida como *"NDP46"*
