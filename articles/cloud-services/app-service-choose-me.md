<properties 
	pageTitle="O Serviço de Aplicativo no Azure é a opção de computação desejada?" 
...
# Devo escolher o Serviço de Aplicativo?

A Azure fornece diferentes modelos de hospedagem para executar aplicativos. Cada um deles fornece um conjunto de serviços diferente, portanto, qual deles você escolhe depende exatamente do que você está tentando fazer. O Serviço de Aplicativo é uma opção para você?
