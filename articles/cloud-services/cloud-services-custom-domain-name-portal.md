...
1. Use um dos seguintes métodos para localizar o nome de domínio **.cloudapp.net** atribuído ao seu serviço de nuvem.
    ...
    * Faça logon no [Portal de Visualização do Azure], selecione seu serviço de nuvem, examine a seção **Essentials** e, em seguida, localize a entrada da **URL do Site**.
...
1. Use um dos seguintes métodos para obter o endereço IP do seu serviço de nuvem.
    ...
    * Faça logon no [Portal de Visualização do Azure], selecione seu serviço de nuvem, examine a seção **Essentials** e, em seguida, localize a entrada **endereços IP públicos**.
