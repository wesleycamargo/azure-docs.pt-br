...
3. No Gerenciador de Soluções, abra um arquivo e altere-o. Por exemplo, altere o arquivo \_Layout.cshtml na pasta Views\\Shared em uma função Web do MVC.<br/> ![][17]
