...
Não deixe de examinar o [preço](pricing/details/cloud-services/) de cada tamanho do Serviço de Nuvem.
...
| Tamanho (id) | Núcleos | Ram | Tamanho total do disco |
| --------------- | :-------: | ------: | ------: |
| ExtraSmall | 1 | 0,75 GB | 19 GB |
| Pequena | 1 | 1,75 GB | 224 GB |
| Média | 2 | 3,5 GB | 489 GB |
...
Disponível em data centers seletos. Máquinas virtuais A8 e A9 têm [processadores Intel® Xeon® E5](http://www.intel.com/content/www/us/en/processors/xeon/xeon-processor-e5-family.html). Adiciona uma rede **InfiniBand** de 32 Gbits/s com a tecnologia RDMA (acesso de memória direto remoto). Ideal para os aplicativos de MPI (interface de passagem de mensagem), clusters de alto desempenho, modelagem e simulações, codificação de vídeo e outros cenários com uso intensivo de computação ou rede.
...
Disponível em data centers seletos. Máquinas virtuais A10 e A11 têm [processadores Intel® Xeon® E5](http://www.intel.com/content/www/us/en/processors/xeon/xeon-processor-e5-family.html). Para clusters de alto desempenho, modelagem e simulações, codificação de vídeo e outros cenários com uso intensivo de computação ou rede. Similar à configuração de instância A8 e A9 sem a rede InfiniBand e a tecnologia RDMA.
