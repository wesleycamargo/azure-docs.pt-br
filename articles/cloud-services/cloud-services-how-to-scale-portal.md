...
> [!WARNING]
> A colocação em escala automática funciona apenas com Contas Clássicas de Armazenamento do Azure. Ele não funciona com Contas de Armazenamento do Azure Resource Manager.
