...
1.  [Registrar seu aplicativo com os WNS e configurar os Serviços Móveis][]
2.  [Atualizar o aplicativo para registrar-se para notificações][]
3.  [Atualizar o servidor para enviar notificações por push][]
4.  [Habilitar notificações por push para teste local][]
5.  [Inserir dados para receber notificações por push][]
...
> [WACOM.NOTE]Este tópico oferece suporte para os aplicativos da Windows Phone Store 8.1. Para adicionar notificações por push a um aplicativo Windows Phone 8 ou Windows Phone Silverlight 8.1, consulte esta versão de [Introdução à autenticação dos Serviços Móveis][].
