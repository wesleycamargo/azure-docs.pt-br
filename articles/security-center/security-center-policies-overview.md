...
- **Política de segurança**: determina que controles a Central de Segurança monitora e recomenda. Você pode editar a [política de segurança](security-center-azure-policy.md) na Central de Segurança. Também é possível usar o [Azure Policy](security-center-azure-policy.md) para criar novas definições, definir políticas adicionais e atribuir políticas entre grupos de gerenciamento. 
