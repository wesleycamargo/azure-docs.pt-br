...
![Integridade dos recursos](./media/security-center-monitoring/security-center-monitoring-fig1-new4.png)
...
![Atualizações de sistema ausentes](./media/security-center-monitoring/security-center-monitoring-fig5-ga.png)
...
No exemplo acima, uma VM tem uma recomendação crítica relacionada à proteção do ponto de extremidade. Para obter mais informações sobre a VM, clique nela. É aberta uma nova folha que representa essa VM, conforme mostrado abaixo.

![Detalhes de segurança da VM](./media/security-center-monitoring/security-center-monitoring-fig8-ga.png)
...
Para ver uma explicação mais detalhada sobre essa recomendação, clique em Atualizar **Versão do sistema operacional**, na coluna **DESCRIÇÃO**. A folha **Atualizar versão do sistema operacional (Visualização)** será aberta com mais detalhes.
...
![Restringir ponto de extremidade](./media/security-center-monitoring/security-center-monitoring-fig9-ga.png)

Neste exemplo, a folha **Configurar Grupos de Segurança da Rede Ausentes para Sub-redes** tem uma lista de sub-redes e máquinas virtuais sem a proteção NSG. Se você clicar na sub-rede à qual deseja aplicar o NSG, outra folha será aberta.
...
![Integridade de recursos do SQL](./media/security-center-monitoring/security-center-monitoring-fig14-ga.png)
...
![Integridade de recursos do SQL](./media/security-center-monitoring/security-center-monitoring-fig15-ga.png)
...
![Aplicativos](./media/security-center-monitoring/security-center-monitoring-fig17-ga.png)

Esta folha terá uma lista de todas as recomendações para este aplicativo. Quando você clicar na recomendação **Adicionar um firewall de aplicativo Web**, a folha **Adicionar um Firewall do Aplicativo Web** será aberta com opções para instalar um WAF (firewall do aplicativo Web) de terceiros, como mostrado abaixo.
