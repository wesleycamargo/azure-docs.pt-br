...
|[Habilitar Grupos de Segurança de Rede em interfaces de rede/sub-redes](security-center-enable-network-security-groups.md)|Recomenda que você habilite NSGs (grupos de segurança de rede) em sub-redes e em interfaces de rede.|
...
1. Na folha **Recomendações**, selecione **Habilitar Antimalware**. ![Selecionar Habilitar antimalware][5]
...
5. Insira as configurações necessárias na folha **Adicionar Extensão** e selecione **OK**. ![Instalar antimalware][6]
