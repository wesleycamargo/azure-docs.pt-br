...
1. Na folha **Recomendações**, selecione **Habilitar Auditoria em servidores SQL**. Isso abre a folha **Habilitar Auditoria em servidores SQL**. ![][1]

2. Selecione um servidor SQL onde deseja habilitar a auditoria. Isso abre a folha **Configurações de Auditoria**. ![][2]
3. Na folha **Configurações de Auditoria**, selecione **ATIVAR** em **Auditoria**. ![][3]
