<properties urlDisplayName="Replica domain controller" pageTitle="Instalar um controlador de domínio de réplica no Azure" metaKeywords="" description="Um tutorial que ensina como instalar um controlador de domínio de sua floresta do Corp Active Directory na máquina virtual do Azure." metaCanonical="" services="virtual-network" documentationCenter="" title="Install a Replica Active Directory Domain Controller in Azure Virtual Networks" authors="Justinha" solutions="" writer="Justinha" manager="TerryLan" editor="LisaToft" />
