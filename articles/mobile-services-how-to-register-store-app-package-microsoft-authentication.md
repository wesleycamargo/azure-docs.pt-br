...
>[AZURE.NOTE]O Visual Studio 2013 facilita o registro de seu pacote do aplicativo da Windows Store com os Serviços Móveis. Para saber mais, confira <a href="http://go.microsoft.com/fwlink/p/?LinkId=309101">Início rápido: Adicionando notificações por push para um serviço móvel</a> no Centro de Desenvolvimento do Windows.
