...
> [WACOM.NOTE] Se você for novo no Hadoop e em Big Data, talvez você queira ler mais sobre os termos [Apache Hadoop][Apache Hadoop], [MapReduce][MapReduce], [HDFS][HDFS] e [Hive][Hive].
