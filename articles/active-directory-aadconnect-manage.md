...
<a href="/pt-br/documentation/articles/active-directory-aadconnect/" title="O que é?" class="current">O que é?</a> <a href="/pt-br/documentation/articles/active-directory-aadconnect-how-it-works/" title="Como funciona">Como funciona</a> <a href="/pt-br/documentation/articles/active-directory-aadconnect-get-started/" title="Introdução">Introdução</a> <a href="/pt-br/documentation/articles/active-directory-aadconnect-get-manage/" title="">titleGerenciartitleGerenciar</a></div></center>


Os tópicos são tópicos operacionais avançados que permitem que você personalize o Azure Active Directory Connect para atender às necessidades e aos requisitos de sua organização.
...
* [Usar sua infraestrutura de identidade local na nuvem](active-directory-aadconnect-whatis.md)
* [Como o Azure AD Connect funciona](active-directory-aadconnect-howitworks.md)
