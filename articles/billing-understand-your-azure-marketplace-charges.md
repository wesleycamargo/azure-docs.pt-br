...
2. Selecione a forma de pagamento para a qual você deseja alterar. A opção **Pagar com** permite que você selecione seu cartão de crédito. A opção **Adicionar uma nova maneira de pagar** permite que você adicione um novo cartão de crédito. ![Alterar forma de pagamento](./media/billing-understand-your-azure-marketplace-charges/change-payment-method.jpg)

## Gerenciamento de pedidos
Na página de visão geral de resumo, você verá o link **Gerenciar Pedidos**. Esse link o levará a seu portal, em que você poderá ver todos os seus pedidos no Marketplace, exibir a integridade do serviço e solicitar suporte. ![Portal](./media/billing-understand-your-azure-marketplace-charges/portal.jpg)

Para solicitar suporte, clique no bloco **Ajuda + suporte**. Isso abrirá a página de **Ajuda + suporte** a seguir, em que você pode fazer o seguinte: - Abrir uma nova solicitação de suporte. - Gerenciar solicitações de suporte existentes. - Gerenciar a integridade do recurso.
...
Se você estiver interessado em exibir os encargos reais, clique em **Exibir Encargos**. Você será redirecionado para um portal diferente, no qual poderá exibir todos os encargos, incluindo os impostos. Se você estiver usando uma ID de organização, o botão **Exibir Encargos** não será habilitado e será preciso enviar um tíquete de suporte para solicitar um resumo dos encargos. ![Histórico de cobrança](./media/billing-understand-your-azure-marketplace-charges/billing-history.png)
