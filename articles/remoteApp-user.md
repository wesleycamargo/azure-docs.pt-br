...
Antes que os usuários possam ver e usar os aplicativos no RemoteApp, você precisa conceder acesso a eles. Essa é a parte fácil: na guia **Acesso de usuário**, insira as informações da conta para o usuário para conceder acesso a este serviço.
...
O Azure RemoteApp tem dois métodos de implantação: híbrido e nuvem. Cada um dá suporte ao uso de identidades diferentes de usuário para acesso de usuário aos aplicativos.
...
|Azure de terceiros com suporte a provedores de identidade (por exemplo, Ping) |Sim |Não|	
