...
3. Em seguida, selecione a ID do aplicativo para o aplicativo Introdução aos Serviços Móveis na lista suspensa **ID do Aplicativo** e clique em **Continuar**.
...
<h2><a name="connecting-app"></a>Conectando o seu aplicativo ao Hub de Notificação</h2>

### Criar um novo projeto

1. No Xamarin Studio, crie um novo projeto do iOS e selecione o modelo **API Unificada > - Aplicativo de Visualização Única**.

   	![][31]

2. Primeiro, adicione uma referência ao componente de Mensagens do Azure.  No modo de exibição Solução, clique com botão direito na pasta **Componentes** de seu projeto e escolha **Obter Mais Componentes**.  Pesquise o componente **Mensagens do Azure** e adicione o componente ao seu projeto.

3. Em **AppDelegate.cs**, adicione a seguinte instrução usando:
...
Você pode enviar notificações usando Hubs de Notificação de qualquer back-end usando nossa <a href="http://msdn.microsoft.com/library/windowsazure/dn223264.aspx">interface REST</a>.  Neste tutorial, você enviará notificações com um aplicativo de console .NET e com um Serviço Móvel usando um script de nó.
