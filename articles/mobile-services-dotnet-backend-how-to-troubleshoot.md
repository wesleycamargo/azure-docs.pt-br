<properties urlDisplayName="Troubleshoot the Mobile Services .NET Backend" pageTitle="Solucionar problemas de back-end do .NET dos Serviços Móveis - Serviços Móveis do Azure" metaKeywords="" description="Saiba como diagnosticar e corrigir problemas com os serviços móveis usando o back-end do .NET" metaCanonical="" services="" documentationCenter="Mobile" title="Troubleshoot the Mobile Services .NET Backend" authors="mahender" solutions="" manager="dwrede" editor="mollybos" />
