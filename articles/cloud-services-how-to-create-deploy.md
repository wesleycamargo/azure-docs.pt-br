...
Se você é nos serviços de nuvem, pode baixar um pacote de serviço de nuvem (.cspkg) de exemplo e o arquivo de configuração de serviço (.cscfg) para trabalhar dos [exemplos de código do Azure][exemplos de código do Azure].
...
1.  No [Portal de Gerenciamento][Portal de Gerenciamento], clique em **Novo**, **Computar**, **Serviço de Nuvem** e em **Criação Rápida**.
...
1.  Se você não instalou o SDK do Azure, clique em **Instalar SDK do Azure** para abrir a[página de Downloads do Azure][downloads de Azure] e baixar o SDK para o idioma em que você preferir desenvolver seu código.
