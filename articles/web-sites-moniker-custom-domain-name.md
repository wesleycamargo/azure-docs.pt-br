<properties 
	pageTitle="Configurar um nome de domínio Moniker para um site do Azure" 
	description="Saiba como configurar um site do Azure para usar um nome de domínio registrado com o Moniker" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
5. Em seguida, crie um registro DNS selecionando primeiro o **Tipo de Registro**. Em seguida, preencha o **Nome do Host** e o **Endereço**. 
    ...
    * Ao adicionar um registro CNAME, você deve definir o campo **Nome do Host** como o subdomínio que deseja usar. Por exemplo, **www**. Você deve definir o campo **Endereço** para o nome do domínio **.azurewebsites.net** do Website do Azure. Por exemplo, **contoso.azurwebsites.net**.

    * Ao adicionar um registro A, você deve definir o campo **Nome do Host** como **@** (isso representa o nome de domínio raiz, como contoso.com**contoso.com**) ou o subdomínio que você deseja usar (por exemplo, **www**). Você deve definir o campo **Endereço** como o endereço IP do seu site do Azure.
		...
		> 
		> * Um valor de **Hostname** de **www** com um valor de **Endereço** de **&lt;yourwebsitename&gt;.azurewebsites.net**.
		> 
		> OU
		> 
		> * A **Hostname** valor **awverify.www** com um **endereço** valor **awverify.&lt;yourwebsitename&gt;.azurewebsites.net**.
		> 
