<properties title="Saiba como configurar um site do Azure para usar um nome de domínio registrado junto a Moniker" pageTitle="Configurar um nome de domínio Dotster para um site do Azure" metaKeywords="Azure, sites do Azure, nome de domínio" description="Saiba como configurar um site do Azure para usar um nome de domínio registrado junto a Moniker" services="web-sites" documentationCenter="" authors="larryfr,jroth" />
...
<div class="dev-center-tutorial-subselector"><a href="/pt-br/documentation/articles/web-sites-moniker-custom-domain-name/" title="Sites" class="current">Site</a> | <a href="/pt-br/documentation/articles/web-sites-moniker-traffic-manager-custom-domain-name/" title="Site usando o Gerenciador de Tráfego">Site usando o Gerenciador de Tráfego</a></div>

[WACOM.INCLUDE [intro](../includes/custom-dns-web-site-intro.md)]

Este artigo fornece instruções sobre como usar um nome de domínio personalizado comprado junto a [Moniker.com](https://moniker.com) com sites do Azure.
...
5. Em seguida, crie um registro DNS selecionando primeiro o **Tipo de Registro**. Em seguida, preencha o **Nome do Host** e o **Endereço**. 
    ...
    * Ao adicionar um registro A, você deve definir o campo **Nome do Host** como **@** (isso representa o nome de domínio raiz, como **contoso.com**) ou o subdomínio que você deseja usar (por exemplo, **www**). Você deve definir o campo **Endereço** como o endereço IP do seu site do Azure.
		...
		> 
		> * Um valor de **Nome do Host** de **www** com um valor de **Endereço** de **&lt;yourwebsitename&gt;.azurewebsites.net**.
		> 
		> OU
		> 
		> * Um valor de **Nome do Host** de **awverify.www** com um valor de **Endereço** de **awverify.&lt;yourwebsitename&gt;.azurewebsites.net**.
		> 
