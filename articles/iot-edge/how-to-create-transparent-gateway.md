...
Por padrão, os scripts de exemplo não definem uma senha para a chave privada do dispositivo. Se você definir uma senha, adicione o seguinte parâmetro: `--device-ca-passphrase {passphrase}`.
