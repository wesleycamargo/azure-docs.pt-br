...
4. No Gerenciador de dispositivos de Hub IoT do Azure, clique com botão direito a uma ID de dispositivo do IoT Edge e, em seguida, selecione **criar implantação para dispositivo único**. 
