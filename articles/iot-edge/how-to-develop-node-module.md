...
1. No VS Code, navegue até o arquivo `deployment.template.json`. Substitua o createOptions do módulo Node.js em **deployment.template.json** com o conteúdo abaixo e salve o arquivo: 
    ```json
