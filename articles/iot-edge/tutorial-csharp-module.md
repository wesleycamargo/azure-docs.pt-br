...
8. O método **Init** declara um protocolo de comunicação para o módulo usar. Substitua as configurações de MQTT pelas configurações de AMPQ. 
