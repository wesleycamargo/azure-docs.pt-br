...
5. **Controlar os custos**
   ...
   | [Excluir todas as VMs do laboratório usando um script do PowerShell](devtest-lab-faq.md#how-can-i-automate-the-process-of-deleting-all-the-vms-in-my-lab) |Exclua todos os laboratórios em uma única operação quando o desenvolvimento for concluído.|
