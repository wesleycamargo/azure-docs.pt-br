...
* [Azure AzCopy](../storage/common/storage-use-azcopy.md#blob-upload) pode ser usado para copiar ou carregar arquivos VHD na conta de armazenamento associada ao laboratório.
...
Veja [How to diagnose artifact failures in DevTest Labs](devtest-lab-troubleshoot-artifact-failure.md) (Como diagnosticar falhas de artefato no DevTest Labs) para saber como obter logs relacionados ao artefato com falha.
