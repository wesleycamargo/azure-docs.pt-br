...
### [Criar e gerenciar VMs requisitáveis](devtest-lab-add-claimable-vm.md)
### [Criar e gerenciar VMs com a CLI do Azure](devtest-lab-vmcli.md)
### [Criar uma VM usando um modelo do Resource Manager](devtest-lab-use-resource-manager-template.md)
...
### [Notificação de postagem em um laboratório](devtest-lab-announcements.md)
...
## Gerenciar discos de dados
### [Anexar e desanexar discos de dados](devtest-lab-attach-detach-data-disk.md)

## [Dimensionar seu laboratório](devtest-lab-scale-lab.md)

## Integrar com CI/CD
### [Integrar laboratórios em seu pipeline VSTS CI/CD](devtest-lab-integrate-ci-cd-vsts.md)
...
# Recursos
## [Roteiro do Azure](https://azure.microsoft.com/roadmap/?category=developer-tools)
