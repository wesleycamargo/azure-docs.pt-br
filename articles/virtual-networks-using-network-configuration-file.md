...
Você pode importar definições de configuração de rede exportadas contidas no arquivo de configuração de rede usando o PowerShell ou o Portal de gerenciamento. As instruções a seguir ajudarão você a exportar e importar usando o Portal de gerenciamento. 
...
3. Na página **Importar o arquivo de configuração de rede**, navegue até o arquivo de configuração de rede e, em seguida, clique na seta **Próximo**.
4. Na página **Criar sua rede**, você verá informações na tela mostrando quais seções da sua configuração de rede serão alteradas ou criadas. Se as alterações estiverem corretas para você, clique na marca de seleção para continuar para atualizar ou criar sua rede virtual. 


## Recursos adicionais
Para obter mais informações sobre a rede virtual, consulte:

-  [Visão geral da Rede Virtual](http://msdn.microsoft.com/library/windowsazure/jj156007.aspx)
...
-  [Configurar uma VPN de multissite](https://msdn.microsoft.com/library/azure/dn690124.aspx)
-  [Configurar uma conexão VNet a VNet](https://msdn.microsoft.com/library/azure/dn690122.aspx)
