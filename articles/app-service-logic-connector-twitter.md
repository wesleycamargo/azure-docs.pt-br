<properties 
   pageTitle="Aplicativo de API Conector do Twitter" 
...
- As ações do Conector do Twitter permitem que você publique tweets, pesquise tweets, retweet, obtenha a linha do tempo dos usuários e assim por diante.  Essas ações obtêm uma resposta e a disponibilizam para uso pelas ações no fluxo.
...
1. Navegue até "Web e Dispositivos Móveis > Aplicativos de API" e pesquise "Conector do Twitter".
