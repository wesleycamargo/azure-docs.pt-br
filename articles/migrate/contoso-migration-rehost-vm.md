...
Artigo 5: Hospedar novamente um aplicativo em VMs do Azure | A Contoso migra suas VMs de aplicativos do SmartHotel360 para VMs do Azure usando o serviço de recuperação de sites. | Este artigo
