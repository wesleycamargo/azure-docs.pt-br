...
> [!NOTE]
> A API do ARM (Azure Resource Manager) para o Gerenciador de Tráfego usa uma terminologia diferente da API do ASM (Azure Service Management). Essa alteração foi introduzida após comentários de clientes para aumentar a clareza e reduzir equívocos comuns. Nesta página, usaremos a terminologia do ARM. As diferenças são:
> 
