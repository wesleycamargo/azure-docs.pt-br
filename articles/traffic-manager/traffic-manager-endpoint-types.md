...
* **Pontos de extremidade externos** são usados para endereços IPv4/IPv6, FQDNs, ou para serviços hospedados fora do Azure que pode ser local ou com um provedor de hospedagem diferente.
