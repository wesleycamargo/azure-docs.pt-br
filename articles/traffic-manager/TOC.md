...
## [Medições de Usuários Reais](traffic-manager-rum-overview.md)
## [Exibição do Tráfego](traffic-manager-traffic-view-overview.md)
...
## Enviar as medidas do usuário para o Gerenciador de Tráfego 
### [Usando o SDK do Visual Studio](traffic-manager-create-rum-visual-studio.md)
### [Usando páginas da Web](traffic-manager-create-rum-web-pages.md)
...
## [Usar o Azure PowerShell para gerenciar o Gerenciador de Tráfego](traffic-manager-powershell-arm.md)
...
## [PowerShell do Azure](/powershell/module/azurerm.trafficmanager)
