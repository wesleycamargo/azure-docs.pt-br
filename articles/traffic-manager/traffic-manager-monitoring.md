...
>[AZURE.NOTE] O Gerenciador de Tráfego só considerará um ponto de extremidade como online se a mensagem de retorno for 200 OK. Um ponto de extremidade não está íntegro quando qualquer um dos seguintes eventos ocorrem:
