...
5. Em **Configurações do método de balanceamento de carga**, verifique se o método de balanceamento de carga é **Round Robin**. Se não for, clique em **Round Robin** na lista suspensa.
