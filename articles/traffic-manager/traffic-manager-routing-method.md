...
- **Round Robin**: selecione Round Robin quando desejar distribuir a carga entre um conjunto de pontos de extremidade no mesmo datacenter ou em datacenters diferentes. Para obter mais informações, consulte [Método de balanceamento de carga Round Robin](#round-robin-load-balancing-method).
...
![Balanceamento de carga ponderada Round Robin](./media/traffic-manager-load-balancing-methods/IC750594.png)
