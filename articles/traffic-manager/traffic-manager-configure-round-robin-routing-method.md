...
> [!NOTE]
> Os sites do Azure já fornecem funcionalidade de balanceamento de carga round robin para sites em um data center (também conhecido como região). O Gerenciador de Tráfego permite que você especifique o método de roteamento de tráfego de round robin para sites em datacenters diferentes.
> 
> 
