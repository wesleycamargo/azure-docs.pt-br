...
## O que é um Provedor de Autenticação Multifator do Azure?
...
## Criar um Provedor de Autenticação Multifator
...
7. Preencha os seguintes campos e selecione **Criar**.
   ...
   3. **Diretório** – o locatário do Azure Active Directory ao qual o Provedor de Autenticação Multifator está associado. Esteja ciente do seguinte:
      * Não é necessário um diretório do AD do Azure para criar um Provedor da Autenticação Multifator. Deixe a caixa em branco se você só estiver planejando usar o Servidor de Autenticação Multifator do Azure ou o SDK.
