---
title: Documentação da Autenticação Multifator do Azure - Tutoriais, Referência de API | Microsoft Docs
...
ms.locfileid: "26630811"
---
# <a name="multi-factor-authentication-documentation"></a>Documentação de Autenticação Multifator

Saiba mais sobre como implantar e gerenciar a Autenticação Multifator do Azure, um sistema de verificação de identidade em duas etapas. Os tutoriais, um SDK e outras documentações mostram como fornecer autenticação forte com uma variedade de métodos de verificação, fornecendo um processo de entrada simples.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre a Autenticação Multifator do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos da Autenticação Multifator do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução às opções de implantação da Autenticação Multifator do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à Autenticação Multifator do Azure na nuvem</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à Autenticação Multifator do Azure local</h3>
                    </div>
                </div>
            </div>
        </div>
