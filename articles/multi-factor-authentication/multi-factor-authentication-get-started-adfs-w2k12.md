...
- Para saber mais sobre como instalar o SDK do Serviço Web com o portal do usuário, confira [Implantação do portal do usuário para o Servidor Multi-Factor Authentication.](multi-factor-authentication-get-started-portal.md)
...
11. Agora que o adaptador foi instalado, ele deve ser registrado no AD FS. Abra o Windows PowerShell e execute o seguinte: C:\\Program Files\\Multi-Factor Authentication Server\\Register-MultiFactorAuthenticationAdfsAdapter.ps1
