---
title: "Introdução ao Servidor Azure Multi-Factor Authentication"
...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Introdução ao Servidor Azure Multi-Factor Authentication
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Baixar o Servidor Azure Multi-Factor Authentication
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Para baixar o Servidor Azure Multi-Factor Authentication
- - -
...
6. Acima de **Gerar Credenciais de Ativação**, clique em **Download.**
   ![Download](./media/multi-factor-authentication-get-started-server/download4.png)
7. Salve o download.

### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Para baixar o Servidor do Azure Multi-Factor Authentication por meio das configurações de serviço
1. Entre no Portal do Azure como Administrador.
2. Selecione Active Directory à esquerda.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Instalar e configurar o Servidor Azure Multi-Factor Authentication
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Requisitos de firewall do Servidor Azure Multi-Factor Authentication
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Para instalar e configurar o Servidor Azure Multi-Factor Authentication
- - -
...
### <a name="configuring-email-and-email-templates"></a>Configurando o email e os modelos de email
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Como o Servidor Azure Multi-Factor Authentication lida com os dados do usuário
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Configurações avançadas do Servidor Azure Multi-Factor Authentication
