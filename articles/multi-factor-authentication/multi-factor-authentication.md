<properties
    pageTitle="Visão geral do Azure MFA | Microsoft Azure"
...
>[AZURE.NOTE] Esta tabela de comparação aborda os recursos que fazem parte de cada assinatura. Se você tiver o AD do Azure Premium ou o Enterprise Mobility Suite, alguns recursos podem não estar disponíveis caso você use [MFA na nuvem ou MFA no local](multi-factor-authentication-get-started.md).
