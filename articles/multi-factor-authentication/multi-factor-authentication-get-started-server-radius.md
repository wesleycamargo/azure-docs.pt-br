---
title: "Servidor Azure Multi-Factor Authentication e autenticação RADIUS"
...
---
# <a name="radius-authentication-and-azure-multifactor-authentication-server"></a>Servidor Azure Multi-Factor Authentication e autenticação RADIUS
...
> [!NOTE]
> O servidor MFA só dá suporte a PAP (protocolo de autenticação de senha) e o MSCHAPv2 (Microsoft’s Challenge Handshake Authentication Protocol) de protocolos de RADIUS agindo como um servidor RADIUS.  Outros protocolos, como o EAP (protocolo de autenticação extensível) podem ser usados quando o servidor MFA atua como um proxy RADIUS para outro servidor RADIUS que dá suporte a esse protocolo, como Microsoft NPS.
> </br>
>  Ao usar outros protocolos nessa configuração, os tokens SMS e OATH unidirecionais não funcionarão, pois o servidor MFA não é capaz de iniciar uma resposta bem-sucedida de Challenge RADIUS usando esse protocolo.
> 
> 
...
14. Configure o servidor para o qual o servidor enviará as solicitações RADIUS por proxy clicando em Adicionar… .
