...
#### [Usar o portal do phonefactor](multi-factor-authentication-whats-next-pfweb.md)
...
### Implantar MFA local
#### [Instalar portal do usuário](multi-factor-authentication-get-started-portal.md)
