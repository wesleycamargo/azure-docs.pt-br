...
Se você não usar autenticação multifator com o Office 365 que tenha uma assinatura do Azure, convém criar senhas de aplicativo por meio do portal do myapps.
...
<li>Clique no nome do usuário e selecione Verificação de Segurança Adicional.</li>
<li>Na parte superior da página de prova, selecione as senhas de aplicativo</li>
<li>Clique em **Criar**</li>

![Nuvem](./media/multi-factor-authentication-end-user-app-passwords-create-myapps/apppassword.png)
