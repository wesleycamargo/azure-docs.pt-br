...
> [!TIP]
> Uma sincronização completa deve ser executada após a remoção de itens de sincronização.  Uma sincronização completa deve ser executada após a ordenação dos itens de sincronização.  Clique no botão Sincronizar Agora para executar uma sincronização completa.
> 
> 

## <a name="multifactor-auth-servers"></a>Servidores de autenticação multifator
