...
---
# <a name="getting-started-with-azure-multifactor-authentication-in-the-cloud"></a>Introdução ao Servidor Azure Multi-Factor Authentication na nuvem
...
## <a name="turn-on-twostep-verification-for-users"></a>Ativar a verificação em duas etapas para usuários
...
### <a name="to-turn-on-multifactor-authentication"></a>Para ativar o Multi-Factor Authentication
...
## <a name="use-powershell-to-automate-turning-on-twostep-verification"></a>Usar o PowerShell para automatizar a ativação da verificação em duas etapas
