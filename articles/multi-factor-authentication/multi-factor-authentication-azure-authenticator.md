...
> [AZURE.NOTE]Não tem certeza de como obter o código QR? Contate o administrador para obter ajuda.
> 
> Não é possível ativar sua conta com o novo aplicativo? Contate o administrador.
>
...
![Nuvem](./media/multi-factor-authentication-azure-authenticator/addaccount.png)
...
![Nuvem](./media/multi-factor-authentication-azure-authenticator/remove.png)

**Recursos adicionais**

* [Azure Multi-Factor Authentication no MSDN](https://msdn.microsoft.com/library/azure/dn249471.aspx) 
* Aplicativo Azure Authenticator para [Windows Phone](http://www.windowsphone.com/en-us/store/app/azure-authenticator/03a5b2bf-6066-418f-b569-e8aecbc06e50), [Android](https://play.google.com/store/apps/details?id=com.azure.authenticator) e [IOS](https://itunes.apple.com/us/app/azure-authenticator/id983156458).
