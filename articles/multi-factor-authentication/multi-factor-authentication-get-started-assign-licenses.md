---
title: Atribuir Licenças para a Microsoft Azure Multi-Factor Authentication
...
8. **Clique** no ícone da marca de seleção para salvar as alterações. ![Atribuir licenças](./media/multi-factor-authentication-get-started-assign-licenses/assign4.png)
9. Você deverá ver uma mensagem informando quantas licenças foram atribuídas e quantas podem ter falhado. Clique em **Ok**. ![Atribuir licenças](./media/multi-factor-authentication-get-started-assign-licenses/assign5.png)
