...
description: Essa é a página Autenticação Multifator do Azure que auxiliará na implantação de autenticação LDAP e do Servidor de Autenticação Multifator do Azure.
