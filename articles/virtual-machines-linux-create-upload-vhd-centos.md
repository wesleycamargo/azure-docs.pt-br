<properties urlDisplayName="Upload a CentOS-based VHD" pageTitle="Criar e carregar um VHD Linux baseado em CentOS no Azure" metaKeywords="Azure VHD, uploading Linux VHD, CentOS" description="Saiba como criar e carregar um VHD (disco r&iacute;gido virtual) do Azure que contenha um sistema operacional Linux baseado em CentOS." metaCanonical="" services="virtual-machines" documentationCenter="" title="Criando e carregando um disco r&iacute;gido virtual que cont&eacute;m um sistema operacional Linux baseado em CentOS" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Preparar uma máquina virtual CentOS 6.x para o Azure][Preparar uma máquina virtual CentOS 6.x para o Azure]
-   [Preparar uma máquina virtual CentOS 7.0 ou posterior para o Azure][Preparar uma máquina virtual CentOS 7.0 ou posterior para o Azure]
...
8.  **Somente para CentOS 6.3**: Instale os drivers dos Serviços de Integração Linux
    ...
    **Importante: Essa etapa só é válida para o CentOS 6.3 e versões anteriores.** Os serviços de integração do Linux nas versões 6.4 ou posteriores do CentOS *já estão disponíveis no kernel*.
    ...
    a) Obtenha o arquivo .iso que contém os drivers dos Serviços de Integração Linux do [Centro de Download da Microsoft][Centro de Download da Microsoft].
...
10. Se quiser usar os espelhos OpenLogic hospedados em datacenters Azure, substitua o arquivo /etc/yum.repos.d/CentOS-Base.repo com os repositórios mencionados a seguir. Essa ação adiciona o repositório **[openlogic]** que inclui pacotes para o agente Linux do Azure:
    ...
    **Observação:** O restante deste guia parte do pressuposto de que você esta usando, no mínimo, o repositório [openlogic], que será usado para instalar o agente Linux do Azure posteriormente.
...
## <span id="centos7"></span> </a>CentOS 7.0 ou posterior
...
11. Depois de editar "/etc/default/grub" como mostramos acimo, execute o comando a seguir para recompor a configuração do grub:
...
16. Clique em **Ação -\> Desligar** no Gerenciador do Hyper-V. Agora, seu VHD Linux está pronto para ser carregado no Azure.
  ...
  [Centro de Download da Microsoft]: http://www.microsoft.com/pt-br/download/details.aspx?id=41554
