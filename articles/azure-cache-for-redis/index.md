...
ms.locfileid: "53020252"
---
# <a name="azure-cache-for-redis-documentation"></a>Documentação do Cache Redis do Azure

Saiba como usar o Cache Redis do Azure, um cache de dados seguro e o agente de mensagens que fornece aos aplicativos uma alta taxa de transferência e acesso de baixa latência aos dados. Os tutoriais, as referências de API e outras documentações mostram como usar o Cache Redis do Azure a partir de qualquer aplicativo no Azure.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre a camada Premium do Cache Redis do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de Vídeos do Cache Redis do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Cache Redis do Azure usando .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Cache Redis do Azure usando ASP.NET MVC</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Cache Redis do Azure usando Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Cache Redis do Azure usando Java</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Cache Redis do Azure usando Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Trabalhe com dados variáveis e parciais em um Cache Redis do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/redis">CLI do Azure 2.0 (Visualização)</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="http://redis.io/commands#">Comandos do Redis</a></p>
                   </div>
                </div>
            </div>
        </div>
