<properties 
	...
	description="Saiba como enviar notificações por push para específicos" 
...
##<a name="register"></a>Atualizar o serviço para solicitar autenticação de registro
