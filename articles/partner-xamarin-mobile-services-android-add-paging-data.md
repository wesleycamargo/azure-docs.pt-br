<properties 
	pageTitle="Adicionar paginação aos dados (Xamarin Android) | Centro de desenvolvimento móvel" 
	description="Saiba como usar paginação para gerenciar a quantidade de dados retornados para seu aplicativo Android Xamarin dos serviços móveis." 
...
2. Clique em **Run** para iniciar o aplicativo, digite texto na caixa de texto e clique no botão **Add**.
