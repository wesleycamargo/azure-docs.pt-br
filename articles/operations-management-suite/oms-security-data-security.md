<properties
   pageTitle="Segurança de Dados de Solução de Segurança e Auditoria do Operations Management Suite | Microsoft Azure"
...
> [AZURE.NOTE] O local dos dados é configurado no nível do espaço de trabalho do OMS, durante a criação do espaço de trabalho, que faz parte do processo de configuração inicial de Segurança e Auditoria do OMS.
