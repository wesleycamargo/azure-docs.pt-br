<properties
   pageTitle="Configuração do ADM (Monitor da Dependência de Aplicativos) no OMS (Operations Management Suite) | Microsoft Azure"
...
>[AZURE.NOTE]No momento, o Monitor da Dependência de Aplicativos está em modo de visualização privada.  Você pode solicitar acesso à visualização privada do ADM em [https://aka.ms/getadm](https://aka.ms/getadm).
>
