<properties
   pageTitle="Visão geral do OMS (Operations Management Suite) | Microsoft Azure"
...
- A [solução de Antimalware](log-analytics-malware.md ) relata o status de proteção antimalware nos sistemas gerenciados.  
