<properties
   pageTitle="ADM (Monitor da Dependência de Aplicativos) no OMS (Operations Management Suite) | Microsoft Azure"
...
- Saiba mais sobre [pesquisas de log](../log-analytics/log-analytics-log-searches.md] in Log Analytics to retrieve data collected by Application Dependency Monitor.)
