<properties
    pageTitle="Atualizar solução de gerenciamento no OMS | Microsoft Azure"
...
-   Os agentes do Windows devem ser configurados para se comunicar com um servidor WSUS (Windows Server Update Services) ou ter acesso ao Microsoft Update.  
    ...
    >[AZURE.NOTE] O agente do Windows não pode ser gerenciado simultaneamente pelo System Center Configuration Manager.  
