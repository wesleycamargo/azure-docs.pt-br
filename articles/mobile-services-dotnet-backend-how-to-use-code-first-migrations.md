<properties pageTitle="Como usar back-end do .NET das Migrações Code First (Serviços Móveis)" metaKeywords="" description="" metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="How to make data model changes to a .NET backend mobile service" authors="glenga" solutions="mobile" writer="glenga" manager="dwrede" editor="" />
...
5. Expanda a pasta App_Start, abra o arquivo de projeto WebApiConfig.cs e adicione as seguintes instruções **using**:
	...
	No código acima, você deve substituir a cadeia de caracteres _todolistService_ pelo namespace de seu projeto que, para o projeto de início rápido baixado, é <em>mobile&#95;service&#95;name</em>Service.  
...
7.  Pressione F5 para iniciar o projeto do serviço móvel no computador local.
	...
	Nesse ponto, o banco de dados está em sincronia com o modelo de dados. Se você forneceu dados semente, poderá verificá-los clicando em **Experimentar**, **OBTER tabelas/todoitem**, em seguida, **Experimentar** e **Enviar**. Para obter mais informações, consulte [Propagando dados em migrações].
...
Esse código chama o método de extensão auxiliar [AddOrUpdate] para adicionar dados de semente à nova coluna UserId. Usando o [AddOrUpdate], linhas duplicadas não são criadas.
...
<!-- URLs -->
[DropCreateDatabaseIfModelChanges]: http://msdn.microsoft.com/pt-br/library/gg679604(v=vs.113).aspx
