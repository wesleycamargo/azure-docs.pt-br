<properties
 pageTitle="Gravar dados no Power BI do Apache Storm"
 description="Um exemplo de como gravar dados no Power BI em uma topologia C# em execução em um Apache Storm no cluster HDInsight. Depois de gravar os dados, você aprenderá como criar um relatório e um painel em tempo real usando o Power BI."
 services="hdinsight"
 documentationCenter=""
 authors="Blackmist"
 manager="paulettm"
