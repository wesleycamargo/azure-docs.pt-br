...
- Você deve ter uma conta do Azure. Para opções de como inscrever-se em uma conta, consulte a página [Testar o Azure gratuitamente](http://azure.microsoft.com/pricing/free-trial/).
