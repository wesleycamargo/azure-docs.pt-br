<properties
 pageTitle="Exemplo de topologias do Storm para o Apache Storm no HDInsight"
 description="Uma lista das topologias de exemplo do Storm que foram criadas e testadas com o Apache Storm no HDInsight."
 services="hdinsight"
 documentationCenter=""
 authors="Blackmist"
 manager="paulettm"
