...
> [AZURE.NOTE]Esse artigo se baseia em informações e exemplos publicados por Michael Noll em [http://www.michael-noll.com/tutorials/writing-an-hadoop-mapreduce-program-in-python/] (Escrevendo um programa MapReduce do Hadoop em Python).
