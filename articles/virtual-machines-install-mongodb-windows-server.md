...
Para obter instruções sobre como inicializar o disco, consulte "Como: Inicializar um novo disco de dados no Windows Server" em [Como anexar um disco de dados a uma Máquina Virtual do Windows](http://azure.microsoft.com/documentation/articles/storage-windows-attach-disk/).
