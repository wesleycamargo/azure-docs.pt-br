...
* [Criar recursos de sites do Azure e do banco de dados SQL ao criar um novo projeto Web ou ao publicar um projeto Web](web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database.md).
...
* [Bibliotecas de cliente](http://go.microsoft.com/fwlink/?LinkId=510472). 
	...
	**Modelos de projeto que incluem bibliotecas de clientes.** Somente modelos de projeto do [Serviço de Nuvem do Azure](cloud-services-dotnet-get-started.md) e do [Serviço Móvel do Azure](mobile-services-dotnet-backend-windows-store-dotnet-leaderboard.md) incluem automaticamente algumas bibliotecas de clientes. Para outras bibliotecas ou outros modelos, instale os [pacotes NuGet de bibliotecas de clientes](http://go.microsoft.com/fwlink/?LinkId=510472) de que você precisa.
