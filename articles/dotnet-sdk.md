...
## <a name="a-idincludedawhats-included-in-the-azure-sdk-for-net"></a><a id="included"></a>O que está incluído no SDK do Azure para .NET
...
### <a name="a-idstgemulatoramicrosoft-azure-storage-emulator"></a><a id="stgemulator"></a>Emulador de Armazenamento do Microsoft Azure
...
### <a name="a-idstgtoolsamicrosoft-azure-storage-tools"></a><a id="stgtools"></a>Ferramentas de Armazenamento do Microsoft Azure
...
### <a name="a-idauthamicrosoft-azure-authoring-tools"></a><a id="auth"></a>Ferramentas de criação do Microsoft Azure
...
### <a name="a-idemulatoramicrosoft-azure-emulator"></a><a id="emulator"></a>Emulador do Microsoft Azure
...
### <a name="a-idhdinsightahdinsight-tools-for-visual-studio-and-microsoft-hive-odbc-driver"></a><a id="hdinsight"></a>Ferramentas do HDInsight para Visual Studio e Driver ODBC do Microsoft Hive
...
### <a name="a-idlibrariesamicrosoft-azure-libraries-for-net"></a><a id="libraries"></a>Bibliotecas do Microsoft Azure para .NET
Incluem os itens a seguir:
...
### <a name="a-idmobileamicrosoft-azure-mobile-app-sdk"></a><a id="mobile"></a>SDK para Aplicativo Móvel do Microsoft Azure
...
### <a name="a-idpsamicrosoft-azure-powershell"></a><a id="ps"></a>PowerShell do Microsoft Azure
...
### <a name="a-idtoolsamicrosoft-azure-tools-for-microsoft-visual-studio"></a><a id="tools"></a>Ferramentas do Microsoft Azure para Microsoft Visual Studio
...
### <a name="a-idwteamicrosoft-app-service-tools-for-visual-studio"></a><a id="wte"></a>Ferramentas de Serviço de Aplicativo da Microsoft para Visual Studio
...
## <a name="a-iddatalakeamicrosoft-azure-data-lake-tools-for-visual-studio"></a><a id="datalake"></a>Ferramentas do Microsoft Azure Data Lake para Visual Studio
...
## <a name="a-idnotincludedawhats-not-included-when-you-install-the-azure-sdk-for-net"></a><a id="notincluded"></a>O que não está incluído quando você instala o SDK do Azure para .NET
...
## <a name="a-idfaqafrequently-asked-questions"></a><a id="faq"></a>Perguntas frequentes
...
### <a name="a-idazinvsamany-azure-features-are-already-in-visual-studio-do-i-need-to-install-the-azure-sdk-for-net"></a><a id="azinvs"></a>Muitos recursos do Azure já estão no Visual Studio. Preciso instalar o SDK do Azure para .NET?
...
### <a name="a-idclientlibai-want-a-client-library-do-i-have-to-install-the-azure-sdk-for-net-to-get-it"></a><a id="clientlib"></a>Quero uma biblioteca de cliente. Preciso instalar o SDK do Azure para .NET para obtê-la?
...
### <a name="a-idolderversionsawhere-can-i-find-older-versions-of-the-azure-sdk-for-net"></a><a id="olderversions"></a>Onde posso encontrar versões mais antigas do SDK do Azure para .NET?
...
### <a name="a-idlifecycleawhats-the-lifecycle-policy-for-versions-of-the-azure-sdk-for-net"></a><a id="lifecycle"></a>Qual é a política de ciclo de vida para versões do SDK do Azure para .NET?
...
### <a name="a-idguestosawhich-guest-os-versions-is-the-azure-sdk-for-net-compatible-with"></a><a id="guestos"></a>Com quais versões de sistemas operacionais convidados o SDK do Azure para .NET é compatível?
...
### <a name="a-iduninstallahow-do-i-uninstall-the-azure-sdk-for-net"></a><a id="uninstall"></a>Como desinstalo o SDK do Azure para .NET?
...
## <a name="a-idversionsaversions"></a><a id="versions"></a>Versões
