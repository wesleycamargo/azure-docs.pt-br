...
Essa seção inclui os seguintes tópicos:
...
### Conceitos
[Usando o Azure AD para autenticação](https://msdn.microsoft.com/library/azure/dn385718.aspx) [Exemplos de código do Active Directory](active-directory-code-samples.md)
