<properties 
	pageTitle="Como monitorar sites - Gerenciamento de serviço do Azure" 
	description="Saiba como monitorar sites do Azure usando a página de monitoramento no portal de gerenciamento." 
	services="web-sites" 
	documentationCenter="" 
	authors="cephalin" 
	manager="wpickett" 
...
1. No [Portal de Gerenciamento do Azure](http://manage.windowsazure.com/), nas páginas de gerenciamento de site, clique na guia **Monitoramento** para exibir a página de gerenciamento **Monitoramento**. Por padrão, o gráfico na página **Monitoramento** exibe as mesmas métricas do gráfico na página **Painel**. 
...
> [AZURE.NOTE] Log de aplicativo para o armazenamento de tabela ou blob só tem suporte para aplicativos .NET.
...
> 
> **.NET** [Habilitar o registro em log de diagnóstico para Sites do Azure](/pt-br/develop/net/common-tasks/diagnostics-logging-and-instrumentation/)
> **Node.js** - [Como depurar um aplicativo Node.js nos Sites do Azure](/pt-br/develop/nodejs/how-to-guides/Debug-Website/)
> 
> Log de aplicativo para o armazenamento de tabela ou blob só tem suporte para aplicativos .NET.
...
> [AZURE.IMPORTANT] Log e rastreamento representam exigências significativas para um site. É recomendável desativar o registro e o rastreamento depois de reproduzir o(s) problema(s) que você está solucionando.
...
11.	Em **Tipo de Serviço**, selecione **Site**, e depois selecione o site para o qual configurou o ponto de extremidade anteriormente. Clique em **Próximo**.
