...
##<a name="howtoviewusage"></a>Como: Exibir cotas de uso de um aplicativo Web
...
> [AZURE.NOTE] O diagnóstico também pode ser habilitado no PowerShell do Azure usando o cmdlet **Set-AzureWebsite**.
> 
