<properties pageTitle="Logs de streaming e console" description="Logs de streaming e visão geral do console" title="Streaming logs and console" authors="adamab" manager="wpickett" />
