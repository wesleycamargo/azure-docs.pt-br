...
* Instalação dos componentes de serviço do trabalho de banco de dados elástico. Consulte [Instalando o serviço do trabalho de banco de dados elástico](vsql-database-elastic-jobs-service-installation.md).
