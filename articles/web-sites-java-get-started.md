...
3. Clique na lâmina **Web + Móvel**.
4. Clique em **Azure Marketplace** na parte inferior da lâmina **Web + Móvel**.
5. Clique em **Web**.
...
Em poucos instantes, o aplicativo Web será criado. Para exibir o aplicativo Web, no Portal de Gerenciamento do Azure, na lâmina **Aplicativos Web**, clique em seu aplicativo Web criado recentemente e, em seguida, clique na URL para o aplicativo Web.
...
14. As opções para o contêiner da Web, por exemplo, Tomcat e Jetty, são exibidas. Selecione o **Contêiner da Web** desejado. 
15. Clique em **Salvar**. 
