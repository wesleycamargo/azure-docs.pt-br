...
Para atualizar a chave de acesso primária ou secundária dos Serviços de Mídia, use [New-AzureMediaServicesKey](https://msdn.microsoft.com/library/azure/dn495215.aspx). 
Você precisa fornecer o nome da conta e especificar qual chave deseja gerar novamente (primária ou secundária). 
