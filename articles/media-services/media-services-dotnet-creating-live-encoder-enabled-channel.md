...
4. Crie um ativo que será usado para armazenar seu conteúdo. As políticas de entrega de ativos devem ser configuradas, assim, como mostrado neste exemplo.
...
2. Adicione o SDK dos Serviços de Mídia para .NET a seu aplicativo de console usando o pacote do NuGet dos Serviços de Mídia.
...
> [!NOTE]
> Para localizar os valores de Nome e Chave, vá para o Portal Clássico do Azure, selecione sua conta de Serviço de Mídia e clique no ícone “GERENCIAR CHAVES” na parte inferior da janela do portal. Clicando no ícone ao lado de cada caixa de texto, o valor é copiado para a área de transferência do sistema.
> 
> 
