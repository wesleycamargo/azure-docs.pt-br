...
DetectRegions|(opcional) Uma matriz de objetos DetectRegion especificando regiões dentro do quadro de vídeo para detectar o texto.<br/>Um objeto DetectRegion é composto pelos quatro valores inteiros a seguir:<br/>Left: pixels da margem esquerda<br/>Top: pixels da margem superior<br/>Width: largura da região em pixels<br/>Height: altura da região em pixels

####Exemplo de predefinição JSON
...
##Arquivos de saída de OCR

A saída do processador de mídia de OCR é um arquivo JSON.

###Elementos do arquivo JSON de saída
...
1. Criar um trabalho com um arquivo de configuração/predefinição de OCR.
