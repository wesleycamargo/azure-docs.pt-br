...
1. Clique em **Criar Canal**.![Elementares](./media/media-services-elemental-live-encoder/media-services-elemental12.png)
...
> [!IMPORTANT]
> Antes de clicar em **Iniciar** na interface Web do Elemental Live, é **necessário** verificar se o Canal está pronto. Além disso, lembre-se de não deixar o Canal em um estado pronto sem um evento por mais de 15 minutos.
> 
> 
