...
<properties 
	pageTitle="Gerenciamento de entidades de serviços de mídia com API REST" 
...
Consultar e listar entidades é simples e envolve apenas uma solicitação HTTP GET e operações OData opcionais. O exemplo a seguir recupera uma lista de todas as entidades MediaProcessor.
