...
## <a id="vod_scenarios"></a>Veiculando mídia sob demanda com os Serviços de Mídia do Azure: cenários e tarefas comuns
...
## <a id="live_scenarios"></a>Veiculando eventos de Live Streaming com os Serviços de Mídia do Azure
...
## Processadores de mídia com suporte

|Nome|Status|Data centers
|---|---|---|
...
|Indexador de Mídia v2|Visualização|Todos, exceto regiões da China e do Governo Federal|
