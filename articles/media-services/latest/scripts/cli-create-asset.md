---
title: Exemplo de Script de CLI do Azure – Criar um ativo dos Serviços de Mídia do Azure | Microsoft Docs
...
ms.locfileid: "51612654"
---
# <a name="cli-example-create-an-asset"></a>Exemplo da CLI: criar um ativo
