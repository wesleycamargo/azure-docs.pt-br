...
---
#  <a name="use-azure-media-encoder-standard-to-auto-generate-a-bitrate-ladder"></a>Usar o Azure Media Encoder Standard para gerar automaticamente uma escada de taxa de bits
