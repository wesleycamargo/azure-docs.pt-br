...
Você pode encontrar esses exemplos [neste site de demonstração](http://aka.ms/poc#22), com o certificado correspondente do aplicativo hospedado em um aplicativo Web do Azure.
