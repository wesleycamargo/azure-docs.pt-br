...
ms.locfileid: "55984215"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Carregar arquivos em uma conta dos Serviços de Mídia usando o .NET (herdado)
