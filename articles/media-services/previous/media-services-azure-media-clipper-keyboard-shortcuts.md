...
O exemplo JSON a seguir ilustra os atalhos de teclado padrão. Você pode personalizar essas configurações alterando os campos de chave e passando o parâmetro ao inicializar o recorte.
