...
| --- | --- | --- |
| conteúdo |Cadeia de caracteres codificada em Base64 |A solicitação de licença enviada por um cliente. |
...
| provedor |cadeia de caracteres |Usado para pesquisar as políticas e chaves de conteúdo. Se a distribuição de chaves da Microsoft é usada para entrega de licença do Widevine, esse parâmetro é ignorado. |
...
| policy_overrides. renewal_server_url |cadeia de caracteres |Todas as solicitações de pulsação (renovação) para esta licença são direcionadas à URL especificada. Este campo só será usado se can_renew for true. |
