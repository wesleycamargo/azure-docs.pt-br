---
title: "Conectando-se a conta dos serviços de mídia usando o .NET"
...
---
# <a name="connecting-to-media-services-account-using-media-services-sdk-for-net"></a>Conectando-se a conta dos serviços de mídia usando o SDK dos serviços de mídia para .NET
...
## <a name="connecting-to-media-services"></a>Conectando aos Serviços de Mídia
...
> [!NOTE]
> A classe **CloudMediaContext** não é thread-safe. Você deve criar um novo CloudMediaContext por thread ou por conjunto de operações.
> 
> 
...
## <a name="connecting-to-a-media-services-account-located-in-the-north-china-region"></a>Conectando-se a uma conta de serviços de mídia localizada na região Norte da China
