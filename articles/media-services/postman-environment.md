 ---
título: Importar o ambiente Postman para chamadas REST dos Serviços de Mídia do Azure descrição: Este tópico fornece uma definição do ambiente Postman para chamadas REST dos Serviços de Mídia do Azure.
