...
1. Crie um player usando a [API do Azure Media Player](http://amp.azure.net/libs/amp/latest/docs/). [API ProtectionInfo do Azure Media Player](http://amp.azure.net/libs/amp/latest/docs/) permite que você especifique qual tecnologia DRM usar em diferentes plataformas DRM.
1. Matriz de teste:
...
1.  Um usuário está conectado ao AD do Azure no aplicativo Web (confira [Navegador da Web para o aplicativo Web](active-directory-authentication-scenarios.md#web-browser-to-web-application)).
