...
# Como:
## Gerenciar
### [Gerenciar pontos de extremidade de streaming no portal](media-services-portal-manage-streaming-endpoints.md)
### Gerenciar entidades
#### [.NET](media-services-dotnet-manage-entities.md)
#### [REST](media-services-rest-manage-entities.md)
### [Gerenciar contas com o PowerShell](media-services-manage-with-powershell.md)
### [Cortar vídeos com o Media Encoder Standard](media-services-crop-video.md)
### [Como: atualizar os Serviços de Mídia após implantar chaves de acesso de armazenamento](media-services-roll-storage-access-keys.md)
### [Cotas e limitações](media-services-quotas-and-limitations.md)
### Filtros
#### [Criando filtros com o SDK do .NET dos Serviços de Mídia do Azure](media-services-dotnet-dynamic-manifest.md)
#### [Como codificar um ativo usando o Media Encoder Standard](media-services-rest-encode-asset.md)
...
#### Codificar um ativo usando o Media Encoder Standard
...
#### Codificadores herdados
##### [Usando o Empacotador de mídia do Azure](media-services-static-packaging.md)

### [Transmissões ao vivo](media-services-manage-channels-overview.md)
#### [Codificadores locais](media-services-live-streaming-with-onprem-encoders.md)
#### Tutoriais do codificador local
##### [Portal](media-services-portal-live-passthrough-get-started.md)
##### [.NET](media-services-dotnet-live-encode-with-onpremises-encoders.md)
...
### Configurar codificadores para um live stream de taxa de bits única
...
### [Usando o Axinom para fornecer licenças Widevine para os Serviços de Mídia do Azure ](media-services-axinom-integration.md)
### [Usando o castLabs para fornecer licenças Widevine para os Serviços de Mídia do Azure](media-services-castlabs-integration.md)
...
### [Armazenamento de filas para monitorar notificações de trabalho](media-services-dotnet-check-job-progress-with-queues.md)
