<properties 
	pageTitle="Implementando o cenário de streaming de failover | Microsoft Azure" 
...
>[AZURE.NOTE]Considere o uso da [Ferramenta Replicadora](http://replicator.codeplex.com/) dos Serviços de Mídia como uma alternativa à implementação manual de um cenário de streaming de failover. Essa ferramenta permite que você replique ativos entre duas contas dos Serviços de Mídia.

##Pré-requisitos
 
- Duas contas dos Serviços de Mídia em uma assinatura nova ou existente do Azure. Consulte [Como criar uma conta dos Serviços de Mídia](media-services-create-account.md).
...
##Adicione o código que manipula a redundância para streaming Sob Demanda.
...
1. Substitua a definição padrão do método Main pela seguinte:
...
1. Veja abaixo as definições de método chamadas a partir de Main.
		                                        ...
		                                        bool autoRedirect = true)
		{
		    ...
		    if (startTime != DateTime.MinValue)
		        sb.Append(", "StartTime" : "" + startTime.ToString("G", CultureInfo.CreateSpecificCulture("pt-BR")) + """);
