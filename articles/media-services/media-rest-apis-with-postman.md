...
1. Crie um arquivo. JSON contendo as variáveis de ambiente usadas nos tutoriais AMS. Nomeie o arquivo **AzureMediaServices.postman_environment.json**. Abra o arquivo e cole o código que define o ambiente do Postman nesta [listagem de código](postman-environment.md). 
...
1. Crie um arquivo. JSON contendo a coleção do **Postman** com todas as operações que são necessárias para carregar um arquivo nos serviços de mídia. Nomeie o arquivo **AzureMediaServicesOperations.postman_collection.json**. Abra o arquivo e cole o código que define a coleção do **Postman** nesta [listagem de código](postman-collection.md).
