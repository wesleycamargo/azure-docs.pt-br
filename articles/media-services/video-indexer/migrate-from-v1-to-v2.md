---
title: Migrar da API v1 para a API v2 do Video Indexer do Azure
...
As definições da API do Video Indexer foram atualizadas adequadamente e estão disponíveis para download no [Portal do Desenvolvedor do Video Indexer](https://api-portal.videoindexer.ai/docs/services/authorization/operations/Get-Account-Access-Token).
