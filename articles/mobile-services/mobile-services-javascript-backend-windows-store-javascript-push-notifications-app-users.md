<properties 
	...
	description="Aprenda a enviar notificações por push dos Serviços Móveis do Azure para usuários específicos do seu aplicativo universal JavaScript do Windows." 
