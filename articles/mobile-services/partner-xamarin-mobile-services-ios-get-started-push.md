---
title: Adicionar notificações por push ao seu aplicativo de Serviços Móveis (Xamarin.iOS) - Serviços Móveis
...
> [!IMPORTANT]
> Devido aos requisitos de APNS, você deve implantar e testar as notificações por push em um dispositivo compatível com o iOS (iPhone ou iPad), em vez de no emulador.
> 
> 
...
3. Substitua a função de inserção com o seguinte código e **Salvar**:
   ...
   > [!NOTE]
   > Esse script atrasa o envio da notificação para que você tenha tempo de fechar o aplicativo para receber uma notificação do sistema.
   > 
   > 
