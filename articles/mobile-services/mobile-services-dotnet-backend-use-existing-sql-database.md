---
title: Compilar um serviço usando um banco de dados SQL existente com o back-end do .NET dos Serviços Móveis | Microsoft Docs
...
5. As propriedades do sistema simplesmente adicionam alguns comportamentos integrados (por exemplo, a atualização automática de criados/atualizados em) que ocorrem de maneira transparente nas operações de banco de dados. Para habilitar esses comportamentos, precisamos fazer uma mudança em **ExistingContext.cs**. Na parte superior do arquivo, adicione o seguinte:
   
        using System.Data.Entity.ModelConfiguration.Conventions;
        using Microsoft.WindowsAzure.Mobile.Service.Tables;
        using System.Linq;
6. No corpo de **ExistingContext**, substitua [**OnModelCreating**](http://msdn.microsoft.com/library/system.data.entity.dbcontext.onmodelcreating.aspx):
...
7. Vamos preencher o banco de dados com alguns dados de exemplo. Abra o arquivo **WebApiConfig.cs**. Crie um novo [**IDatabaseInitializer**](http://msdn.microsoft.com/library/gg696323.aspx) e configure-o no método do **Registro** como mostrado abaixo.
