<properties 
	pageTitle="O que acontece quando você adiciona os Serviços Móveis a um aplicativo do Javascript usando os Serviços Conectados do Visual Studio | Microsoft Azure" 
