---
title: Dimensionar serviços móveis com suporte pelo Banco de Dados SQL do Azure | Microsoft Docs
...
Para obter mais informações sobre os índices, consulte [Anotações de índice no Entity Framework][Anotações de índice no Entity Framework]. Para obter dicas adicionais sobre como otimizar os índices, consulte [Indexação avançada](#AdvancedIndexing) na parte inferior deste documento.
...
Para obter mais informações, consulte [Monitorando o Banco de Dados SQL usando a Exibição de Gerenciamento Dinâmico][Monitorando o Banco de Dados SQL usando a Exibição de Gerenciamento Dinâmico] e [Exibições de gerenciamento dinâmico de índice ausente][Exibições de gerenciamento dinâmico de índice ausente].
...
Para obter mais informações, consulte [Monitorando o Banco de Dados SQL usando a Exibição de Gerenciamento Dinâmico (a página pode estar em inglês)][Monitorando o Banco de Dados SQL usando a Exibição de Gerenciamento Dinâmico (a página pode estar em inglês)]. Além de executar a consulta, o **Portal de Gerenciamento do Banco de Dados SQL** fornece um bom atalho para ver esses dados, ao selecionar **Resumo** para seu banco de dados e **Desempenho da Consulta**:
...
* [Restrições de chave primária e estrangeira][Restrições de chave primária e estrangeira]
* [Quanto custa essa chave?][Quanto custa essa chave?]
