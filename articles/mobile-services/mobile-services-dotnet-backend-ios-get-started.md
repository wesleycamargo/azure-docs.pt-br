---
title: Introdução aos Serviços Móveis do Azure para aplicativos iOS
...
3. Em seu Mac, clique em **Baixar**, em **Baixar e executar seu aplicativo**. Isso baixa o projeto para o aplicativo de exemplo *To do list* que está conectado ao serviço móvel, juntamente com o SDK do iOS dos Serviços Móveis. Salve o arquivo de projeto compactado em seu computador local e anote onde ele foi salvo.
