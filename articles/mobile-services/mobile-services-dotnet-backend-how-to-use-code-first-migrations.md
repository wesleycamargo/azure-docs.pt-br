---
title: Como fazer alterações no modelo de dados para um serviço móvel de back-end do .NET
...
> [!IMPORTANT]
> Ao desenvolver e testar seu projeto de serviço móvel em serviços ativos do Azure, você sempre deve usar uma instância de serviço móvel dedicada para teste. Você nunca deve desenvolver ou testar em um serviço móvel que esteja em produção ou sendo usado por aplicativos cliente.
> 
> 
...
5. Expanda a pasta App\_Start, abra o arquivo do projeto WebApiConfig.cs e adicione as seguintes instruções **using**:
    ...
    No código acima, você deve substituir a cadeia de caracteres *todolistService* pelo namespace do seu projeto que, para o projeto de início rápido baixado é <em>mobile&#95;service&#95;name</em>Service.
...
11. (Opcional) No [portal clássico do Azure], selecione o serviço móvel e clique em **Configurar** > **Banco de dados SQL**. Isso navega para a página Banco de Dados SQL do banco de dados do serviço móvel.
