---
title: Criar um serviço móvel de back-end .NET que usa o armazenamento de tabela | Microsoft Docs
...
1. Modifique o tipo de dados **TodoItem** para extrair de **StorageData** em vez de **EntityData**, da maneira descrita a seguir.
   ...
   > [!NOTE]
   > O tipo **StorageData** tem uma propriedade de Id que exige uma chave composta que é uma cadeia de caracteres no formato *partitionId*,*rowValue*.
   > 
   > 
...
4. Substitua o método **GetAllTodoItems** existente pelo código a seguir.
...
2. Execute o aplicativo cliente de início rápido conectado ao seu serviço móvel.
...
3. Adicione novos itens para gerar alterações do banco de dados.
