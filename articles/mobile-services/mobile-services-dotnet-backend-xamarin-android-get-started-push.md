...
Você já deve ter instalado os componentes do Xamarin.Android e dos [Serviços Móveis do Azure][Azure Mobile Services Component] em seu projeto quando concluiu a [Introdução aos Serviços Móveis].
