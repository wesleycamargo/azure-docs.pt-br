---
title: Adicionar autenticação ao seu aplicativo HTML/JavaScript | Microsoft Docs
...
> [!NOTE]
> Como o logon é realizado em um pop-up, você deve invocar o método **login** em um evento de clique do botão. Caso contrário, muitos navegadores suprimirão a janela de logon.
> 
> 
...
2. No arquivo page.js, localize a linha de código na parte inferior do arquivo que chama a função refreshTodoItems e substitua-o pelo código a seguir:
   ...
   > [!IMPORTANT]
   > Em um aplicativo do PhoneGap, você deve também adicionar os seguintes plug-ins ao projeto:
   > 
