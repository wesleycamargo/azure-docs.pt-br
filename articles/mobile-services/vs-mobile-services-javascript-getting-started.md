---
title: Introdução com um aplicativo móvel Javascript depois de adicionar os Serviços Móveis usando os Serviços Conectados do Visual Studio | Microsoft Docs
