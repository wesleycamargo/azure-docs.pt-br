...
4. Com o botão **Experimentar agora** na página inicial ou usando um aplicativo cliente conectado ao seu serviço móvel, invoque algumas operações que geram alterações de banco de dados.
