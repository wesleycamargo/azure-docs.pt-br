---
title: Usar os Serviços Móveis para carregar imagens no armazenamento de blob (Android) | Microsoft Docs
...
* Uma [conta do Armazenamento do Azure](../storage/storage-create-storage-account.md)
...
2. Adicione este código para iniciar o aplicativo de câmera do Android. Depois, você pode tirar fotos e quando gostar de uma foto, pressione **Salvar**, o que fará com que ela seja armazenada no arquivo que você acabou de criar.
