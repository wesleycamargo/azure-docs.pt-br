---
title: Adicione a sincronização de dados Offline para seu aplicativo de Serviços Móveis Android | Microsoft Docs
...
> Para a versão de aplicativos móveis equivalente deste tópico, consulte [Habilitar sincronização offline para seu aplicativo móvel Android](../app-service-mobile/app-service-mobile-android-get-started-offline-data.md).
> 
> 
...
3. Exiba o conteúdo da tabela *TodoItem* do Azure. Confirme que os novos itens *não* tenham sido sincronizados com o servidor:
