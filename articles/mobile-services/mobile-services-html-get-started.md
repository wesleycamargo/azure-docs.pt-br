---
title: Introdução aos Serviços Móveis do Azure para aplicativos HTML/JavaScript | Microsoft Docs
...
3. No aplicativo, digite um texto significativo, como *Concluir o tutorial*, em **Inserir nova tarefa** e clique em **Adicionar**.
   ...
   > [!NOTE]
   > Você poderá examinar o código que acessa o seu serviço móvel para consultar e inserir dados, que estão localizados no arquivo page.js.
   > 
   > 
