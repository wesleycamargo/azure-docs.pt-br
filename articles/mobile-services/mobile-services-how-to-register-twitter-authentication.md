...
2. Digite os valores de **Nome**, **Descrição**, e **Site** para seu aplicativo, em seguida, digite um dos seguintes formatos de URL em **URL de Retorno de Chamada**.
