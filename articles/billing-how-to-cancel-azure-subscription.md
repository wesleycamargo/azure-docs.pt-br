---
title: Como cancelar sua assinatura do Azure | Microsoft Docs
...
5. Clique em ![checkbutton](./media/billing-how-to-cancel-azure-subscription/checkbutton.png) para fechar a janela de diálogo e retornar à página da assinatura.
   ...
   > [!NOTE]
   > Se você cancelou sua assinatura pré-paga acidentalmente, siga as instruções descritas [aqui](https://azure.microsoft.com/documentation/articles/billing-subscription-become-disable/) para reativá-la.
   > 
   > 
