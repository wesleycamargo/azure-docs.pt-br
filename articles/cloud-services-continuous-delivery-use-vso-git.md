...
3. Para serviços de nuvem, escolha o link **Configurar publicação com o Visual Studio Online**. Para sites da Web, escolha o link **Configurar a implantação do controle do código-fonte**.<br/>
![][10]
