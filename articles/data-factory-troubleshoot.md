<properties title="Troubleshoot Azure Data Factory issues" pageTitle="Solucionar problemas do Data Factory do Azure" description="Learn how to troubleshoot issues with using Azure Data Factory." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
