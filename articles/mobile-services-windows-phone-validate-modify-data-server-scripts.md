...
1.  No Visual Studio 2012 Express para Windows Phone, abra o projeto que você modificou quando concluiu o tutorial [Introdução aos dados][Introdução a dados].
...
3.  Abra o arquivo MainPage.xaml.cs e substitua o método **InsertTodoItem** existente pelo seguinte:
...
Scripts de servidor também são usados ao autorizar usuários e para enviar notificações por push. Para obter mais informações, consulte os tutoriais a seguir: [Refinar consultas com paginação][Refinar consultas com paginação].
