...
>[WACOM.NOTE]Para enviar notificações por push para um aplicativo do Windows Phone 8.1, siga a versão do [aplicativo da Windows Store](/pt-br/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-get-started-push) deste tutorial.
...
3. Adicione o seguinte ao App.xaml.cs:
	...
	>[WACOM.NOTE]Neste tutorial, o serviço móvel envia uma notificação de toast. Ao enviar uma notificação de bloco, você deve chamar o método **BindToShellTile** no canal.
...
[Configurar um serviço web autenticado para enviar notificações por push para Windows Phone]: http://msdn.microsoft.com/pt-br/library/windowsphone/develop/ff941099(v=vs.105).aspx
