...
- Se você ainda não concluiu o primeiro tutorial de Gerenciamento de Custos, leia-o em [Examinar o uso e os custos](https://docs.microsoft.com/azure/cost-management/tutorial-review-usage).
