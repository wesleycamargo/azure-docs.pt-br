...
description: Use as informações do Parceiro CSP registrar-se com o Cloudyn.
...
2. Em **Visão geral**, clique em **Cloudyn**  
    ![Página do Cloudyn](./media/quick-register-csp/cost-mgt-billing-service.png)
