...
3. Na guia **Configurações Comuns**, verifique se que o nome do serviço de nuvem que você está implantando, o **Ambiente**, a **Configuração da Compilação** e a **Configuração do Serviço** estão todos corretos.
