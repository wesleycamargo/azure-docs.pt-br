...
> [AZURE.NOTE] Se estiver tentando alterar ou remover um cartão existente, saiba como [gerenciar as informações de pagamento](billing-how-to-change-credit-card.md).
