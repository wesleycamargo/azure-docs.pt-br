<properties
	pageTitle="Se seu cartão de crédito ou débito é recusado na inscrição | Microsoft Azure"
...
- [Os provedores de cartão de crédito e débito aceitos variam de acordo com seu país](#credit-or-debit-card-details). Na lista suspensa para escolher um cartão de crédito, você verá somente as opções que aceitas no país selecionado.
...
- Se está usando um cartão de crédito ou débito válido, verifique se o cartão está ativo e se seu banco não está bloqueando as transações online devido a suas políticas de segurança. Entre em contato com seu banco para resolver o problema.
...
- O cartão de crédito ou débito que você está usando deve constar na lista suspensa para o país que escolher. Se não estiver listado, ele não é uma opção disponível para o seu país. Consulte [países e moedas com suporte](billing-countries-and-currencies.md).
...
Se suas informações do cartão de crédito ou débito estiverem desatualizadas, você poderá [atualizar suas informações de pagamento](billing-how-to-change-credit-card.md).
