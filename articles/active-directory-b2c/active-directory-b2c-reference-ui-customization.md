---
title: Personalização da UI (interface do usuário) no Azure Active Directory B2C | Microsoft Docs
description: Um tópico sobre os recursos de personalização da UI (interface do usuário) no Azure Active Directory B2C.
