<properties
	pageTitle="Azure Active Directory B2C: configuração do LinkedIn | Microsoft Azure"
...
# Azure Active Directory B2C: fornecer inscrição e entrada aos consumidores com contas do LinkedIn
