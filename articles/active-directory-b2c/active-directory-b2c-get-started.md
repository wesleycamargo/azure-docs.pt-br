...
Este Guia de início rápido ajuda a criar um locatário do Microsoft Azure Active Directory (Azure AD) B2C em poucos minutos. Quando você terminar, terá um locatário B2C a ser usado para registrar aplicativos B2C.
