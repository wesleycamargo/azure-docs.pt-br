...
1. Abra o novo arquivo e atualize o atributo `PolicyId` de `<TrustFrameworkPolicy>` com um valor exclusivo (ex. SignUpOrSignInWithAAD). Esse será o nome da política (por exemplo, B2C\_1A\_SignUpOrSignInWithAAD).
