---
title: Proteger uma API Web usando o Node.js no Azure Active Directory B2C | Microsoft Docs
description: Como criar uma API Web Node.js que aceita tokens de um locatário B2C.
