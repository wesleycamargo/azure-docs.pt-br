...
4. Insira `https://login.microsoftonline.com/te/{tenant}/{policyId}/oauth1/authresp` em **URLs de retorno de chamada**. Substitua **{tenant}** pelo nome do locatário (por exemplo, contosob2c.onmicrosoft.com) e **{policyId}** por sua ID de política (por exemplo, b2c_1_policy). Você deve adicionar uma URL de retorno de chamada para todas as políticas que usam a conta do Twitter. Certifique-se de usar `b2clogin.com` em vez de ` login.microsoftonline.com` se você estiver usando ele em seu aplicativo.
