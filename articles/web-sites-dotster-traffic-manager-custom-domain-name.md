<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Dotster" pageTitle="Configurar um nome de domínio Dotster para um site do Azure utilizando o Gerenciador de Tráfego" metaKeywords="do Microsoft Azure, Sites do Microsoft Azure, Dotster, Gerenciador de Tráfego" description="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Dotster" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
