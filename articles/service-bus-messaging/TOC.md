# Visão geral
## [O que são as mensagens do Barramento de Serviço?](service-bus-queues-topics-subscriptions.md)
...
## [Gerar Assinaturas de Acesso Compartilhado](service-bus-sas-overview.md)
...
### [Usar AMQP com a API .NET](service-bus-dotnet-advanced-message-queuing.md)
### [Usar AMQP com filas e tópicos particionados](service-bus-partitioned-queues-and-topics-amqp-overview.md)
...
## [Referência de API .NET](https://msdn.microsoft.com/library/azure/jj933424)
## [Referência da API REST](https://msdn.microsoft.com/library/azure/hh780717)
...
## [Roteiro de aprendizagem](https://azure.microsoft.com/documentation/learning-paths/service-bus/)
