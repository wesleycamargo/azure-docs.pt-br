...
O exemplo a seguir mostra como gerenciar regras de autorização de namespace usando o [New-AzServiceBusNamespaceAuthorizationRule](/powershell/module/az.servicebus/new-azservicebusnamespaceauthorizationrule), [Get-AzServiceBusNamespaceAuthorizationRule](/powershell/module/az.servicebus/get-azservicebusnamespaceauthorizationrule), [AzServiceBusNamespaceAuthorizationRule conjunto](/powershell/module/az.servicebus/set-azservicebusnamespaceauthorizationrule), e [AzServiceBusNamespaceAuthorizationRule remover cmdlets](/powershell/module/az.servicebus/remove-azservicebusnamespaceauthorizationrule).
