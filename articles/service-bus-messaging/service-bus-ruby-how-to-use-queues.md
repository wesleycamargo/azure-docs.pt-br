...
> [AZURE.NOTE] Você também poderá encontrar essa chave se efetuar logon no [portal do Azure](https://portal.azure.com/) e navegar até as informações de conexão para seu namespace do barramento de serviço.
