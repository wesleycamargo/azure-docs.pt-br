...
No namespace de camada Premium, o particionamento de entidades não é compatível. Entretanto, é possível criar filas e tópicos do Barramento de Serviço em tamanhos de 1, 2, 3, 4, 5, 10, 20, 40 ou 80 GB (o padrão é 1 GB). É possível ver o tamanho da fila ou do tópico observando sua entrada no [Portal do Azure][Azure portal], na folha **Visão Geral** da entidade em questão.
...
Para dar ao Barramento de Serviço tempo suficiente para enfileirar a mensagem em um fragmento diferente, o valor de [OperationTimeout](/dotnet/api/microsoft.azure.servicebus.queueclient.operationtimeout) especificado pelo cliente que envia a mensagem deve ser maior que 15 segundos. É recomendável que você defina a propriedade [OperationTimeout](/dotnet/api/microsoft.azure.servicebus.queueclient.operationtimeout) com o valor padrão de 60 segundos.
