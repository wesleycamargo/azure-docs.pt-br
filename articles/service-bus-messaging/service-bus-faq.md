...
#### <a name="queue/topic-size"></a>Tamanho do tópico/fila
...
#### <a name="number-of-topics/queues-per-service-namespace"></a>Número de tópicos/filas por namespace de serviço
...
#### <a name="queue/topic/subscription"></a>Fila/Tópico/Assinatura
