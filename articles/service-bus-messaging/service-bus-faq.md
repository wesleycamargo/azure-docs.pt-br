...
# Perguntas frequentes sobre o Barramento de Serviço
...
- [Solucionar problemas](#service-bus-troubleshooting)

## Perguntas gerais sobre mensagens do Barramento de Serviço do Azure

### O que é o sistema de mensagens do Barramento de Serviço do Azure?

[Mensagens do Barramento de Serviço do Azure](service-bus-messaging-overview.md) é uma plataforma de nuvem de mensagens assíncronas que permite enviar dados entre sistemas separados. A Microsoft oferece isso como um serviço, o que significa que você não precisa hospedar seu próprio hardware para usá-lo.

### O que é um namespace do Barramento de Serviço?

Um namespace fornece um contêiner de escopo para endereçar recursos do barramento de serviço dentro de seu aplicativo. A criação de um hardware é necessária para a utilização do Barramento de Serviço e será uma das primeiras etapas da introdução.
...
### O que é o serviço de retransmissão do Barramento de Serviço do Azure?
...
Tenha em mente que não é garantida a ordenação ao usar o particionamento de entidades. Se uma partição não estiver disponível, você poderá enviar e receber mensagens de outras partições.

## Práticas recomendadas do Barramento de Serviço
...
###O que devo saber antes de criar entidades de mensagens?   
...
#### Número de ouvintes simultâneos em uma retransmissão
...
#### Número de ouvintes de retransmissão simultâneos por namespace
...
#### Número de tópicos/filas por namespace de serviço
...
**Filtros de número de correlação por tópico** – o número máximo de filtros de correlação por tópico é limitado a 100.000. Se essa cota for atingida, as solicitações subsequentes de criação de filtros adicionais para o tópico serão rejeitadas e uma exceção será recebida pelo código de chamada.
...
## Solução de problemas do Barramento de Serviço

[Visão geral sobre exceções][]

### Quais são algumas das exceções geradas pelas APIs de mensagens do Barramento de Serviço do Azure e suas ações sugeridas?
...
O artigo [Exceções de mensagens do Barramento de Serviço][Exceptions overview] descreve algumas exceções com as ações sugeridas.
...
[Práticas recomendadas para isolar aplicativos contra interrupções de serviço e desastres do Barramento de Serviço]: ../service-bus/service-bus-outages-disasters.md
[Pricing overview]: https://azure.microsoft.com/pricing/details/service-bus/
[Visão geral sobre cotas]: ../service-bus/service-bus-quotas.md
[aqui]: ../service-bus/service-bus-powershell-how-to-provision.md#migrate-a-namespace-to-another-azure-subscription
[Exceptions overview]: ../service-bus/service-bus-messaging-exceptions.md
[Visão geral sobre exceções]: ../service-bus/service-bus-messaging-exceptions.md
[Assinaturas de Acesso Compartilhado]: ../service-bus/service-bus-sas-overview.md
