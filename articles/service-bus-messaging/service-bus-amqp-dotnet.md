...
Em que `[namespace]` e `SharedAccessKey` são obtidos no [Portal do Azure][Portal do Azure]. Para saber mais, consulte [Introdução às filas do Barramento de Serviço][Introdução às filas do Barramento de Serviço].
