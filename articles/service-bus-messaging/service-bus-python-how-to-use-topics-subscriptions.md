---
title: "Como usar os tópicos do Barramento de Serviço com o Python | Microsoft Docs"
...
É possível obter os valores do nome e do valor da chave SAS do [Portal do Azure][Portal do Azure].
...
> [!NOTE]
> Como o filtro padrão é aplicado automaticamente em todas as assinaturas novas, você deve primeiro remover o filtro padrão, senão o filtro **MatchAll** substituirá todos os outros filtros que você possa especificar. Você pode remover a regra padrão usando o método **delete\_rule** do objeto **ServiceBusService**.
> 
> 
...
Para enviar uma mensagem a um tópico do Barramento de Serviço, seu aplicativo deve usar o método **send\_topic\_message** do objeto **ServiceBusService**.
...
Os tópicos e as assinaturas são persistentes e devem ser explicitamente excluídos por meio do [Portal do Azure][Portal do Azure] ou de forma programática. O seguinte exemplo mostra como excluir o tópico chamado `mytopic`:
