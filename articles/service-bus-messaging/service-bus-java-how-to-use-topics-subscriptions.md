...
- Crie um tópico usando o portal do Azure
- Crie três assinaturas para o tópico usando o portal do Azure
- Escrever o código Java para enviar mensagens para o tópico
- Escrever o código Java para receber mensagens de assinaturas
...
- [SDK do Azure para Java][Azure SDK for Java]. 
...
Um namespace de mensagens do Barramento de Serviço fornece um contêiner de escopo exclusivo, referenciado pelo [nome de domínio totalmente qualificado](https://wikipedia.org/wiki/Fully_qualified_domain_name), em que você cria uma ou mais filas, tópicos e assinaturas. O exemplo a seguir cria um namespace de mensagens do Barramento de Serviço em um [grupo de recursos](/azure/azure-resource-manager/resource-group-portal):
...
5. No campo **Grupo de Recursos**, escolha um grupo de recursos existente no qual o namespace reside, ou então crie um novo.      
...
4. Insira **BasicTopic** para o tópico **nome**e deixe os outros valores com os padrões.
5. Na parte inferior da janela, clique em **Criar**.


## <a name="create-subscriptions-for-the-topic"></a>Criar assinaturas do tópico
1. Selecione o **tópico** você criou.
2. Clique em **+ Subscription**, insira o nome da assinatura **Subscription1** e deixe todos os outros valores com seus padrões.
3. Repita anterior etapa duas vezes mais, criando assinaturas denominadas **Subscription2** e **Subscription3**.
...
> [!NOTE] 
> - Substitua `<NameOfServiceBusNamespace>` pelo nome do seu namespace do Service Bus. 
