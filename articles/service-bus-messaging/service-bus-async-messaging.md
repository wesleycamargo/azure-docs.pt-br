...
-   *messagingFactory*: a instância de [MessagingFactory][] para o namespace secundário. O objeto [MessagingFactory][] é usado para enviar e, se a propriedade [EnableSyphon][] estiver definida como **true**, receber mensagens de filas de lista de pendências.
...
Agora que você aprendeu os conceitos básicos sobre mensagens assíncronas no Barramento de Serviço, leia mais detalhes sobre [namespaces emparelhados][].
