...
- Usa o namespace e a chave SAS [(Assinatura de Acesso Compartilhado)](../service-bus/service-bus-sas-overview.md) para acessar os recursos de namespace do Barramento de Serviço.
