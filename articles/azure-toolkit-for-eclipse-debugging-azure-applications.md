...
1. Defina um ponto de interrupção em index.jsp:
    1. No Gerenciador de Projetos do Eclipse, expanda **MyHelloWorld**, expanda **WebContent** e clique duas vezes em **index.jsp**.
    1. No index.jsp, clique com o botão direito na barra azul à esquerda do código Java e clique em **Ativar/Desativar Pontos de Interrupção**, conforme exibido a seguir: ![][ic551537] Um ponto de interrupção será definido se você vir um ícone de ponto de interrupção dentro da barra azul à esquerda do código Java.
