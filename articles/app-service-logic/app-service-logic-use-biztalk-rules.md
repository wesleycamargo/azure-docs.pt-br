---
title: Saiba mais e crie um aplicativo de API de regras do BizTalk no seu aplicativo lógico | Microsoft Docs
...
## Conceitos de regras
## Vocabulário
Um *vocabulário* é uma coleção de definições que consiste de nomes amigáveis para os objetos de computação usados em ações e condições de regra. Definições de vocabulário facilitam a leitura, compreensão e compartilhamento das regras pelas pessoas em um domínio de negócios específico.
...
4. Selecione o botão *Criar* 
   ![Alt text][3]
5. Na nova lâmina que será aberta, insira as seguintes informações:
   1. Nome – dê um nome para seu Aplicativo de API de Regras
   2. Plano do Serviço de Aplicativo – selecione ou crie um novo Plano do Serviço de Aplicativo
   3. Camada de preços – escolha a camada de preço na qual deseja posicionar esse aplicativo
   4. Grupo de recursos - selecione ou crie um grupo de recursos onde o aplicativo deve residir
   5. Assinatura - Selecione a assinatura que deseja usar
   6. Local - escolha a região geográfica onde você quer que o aplicativo seja implantado.
6. Selecione *Criar*. Seu Aplicativo de API do de Regras do BizTalk seria criado em alguns minutos.
...
1. Selecione “Adicionar” para começar a adicionar novas definições de vocabulário.
