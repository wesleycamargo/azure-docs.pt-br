...
O Codificador JSON do BizTalk pode ser usado como uma ação. Ele não tem gatilhos.
...
- Clique em ->
	...
	![Lista de ações][4]
- O Codificador JSON do BizTalk oferece suporte a apenas uma ação. Selecione *Xml para JSON*
