...
Para o modelo completo, consulte [Modelo de Aplicativo Lógico com aplicativo de API](https://github.com/tfitzmac/AppServiceTemplates/blob/master/LogicAppAndAPIApp.json).
