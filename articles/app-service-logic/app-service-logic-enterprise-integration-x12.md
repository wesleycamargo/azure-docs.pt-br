---
title: Visão geral do X12 e do Enterprise Integration Pack | Microsoft Docs
...
1. Digite *integração* na caixa de pesquisa do filtro e selecione **Contas de Integração** na lista de resultados ![](./media/app-service-logic-enterprise-integration-x12/x12-1-3.png)
...
3. Selecione o bloco **Contratos**. Se você não vir o bloco de contratos, adicione-o primeiro. ![](./media/app-service-logic-enterprise-integration-x12/x12-1-5.png)
...
5. Insira um **Nome** para seu contrato, selecione **Tipo de Contrato**, **Parceiro Host**, **Identidade do Host** e **Parceiro Convidado**, **Identidade do Convidado** na folha Contratos que se abre. ![](./media/app-service-logic-enterprise-integration-x12/x12-1.png)
6. Depois de definir as propriedades das configurações de recebimento, selecione o botão **OK**. Continuando:
...
1. Selecione o bloco **Contratos** na folha da Conta de Integração e você verá o contrato recém-adicionado listado. ![](./media/app-service-logic-enterprise-integration-x12/x12-7.png)
