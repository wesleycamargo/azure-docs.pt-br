...
> [!NOTE]
> Esta página cobre os recursos de X12 dos Aplicativos Lógicos. Para obter informações sobre X12 clique [aqui](app-service-logic-enterprise-integration-edifact.md).
> 
> 
...
Depois que você ter [criado uma conta de integração](app-service-logic-enterprise-integration-accounts.md) e [adicionado parceiros](app-service-logic-enterprise-integration-partners.md), poderá criar um contrato X12 seguindo estas etapas:  
