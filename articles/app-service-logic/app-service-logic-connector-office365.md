---
title: Usando o Conector do Office 365 em Aplicativos Lógicos | Microsoft Docs
...
5. A conexão com o Office 365 exige que você autorize o aplicativo lógico a ser capaz de acessar sua conta. Clique em “Autorizar” para fornecer as credenciais de logon do Office 365: ![][5]
6. Você será redirecionado à página de entrada do Office 365 e poderá se autenticar com as credenciais da sua conta do Office 365: ![][6] ![][7]
7. Quando a autorização for concluída, os gatilhos do Office 365 serão exibidos: ![][8]
8. Selecione o gatilho “Novo Email” e os parâmetros de entrada serão exibidos.
9. Altere a frequência do gatilho para ‘Minutos’ e clique em ✓: ![][9]
10. O gatilho ‘Novo Email’ do Office 365 é configurado e você pode ver que os parâmetros de saída também são exibidos: ![][10]
11. Selecione "Conector do Office 365" na seção “Usados Recentemente” da galeria e uma nova ação do "Office 365" é adicionada.
12. Selecione ‘Evento de Envio’ na lista de ações e os parâmetros de entrada da ação ‘Evento de Envio’ serão exibidos: ![][11]
13. Especifique os detalhes do evento e clique em ✓: ![][12]
14. Selecione "Conector do Office 365" na seção “Usados Recentemente” da galeria e uma nova ação do "Office 365" é adicionada.
15. Selecione ‘Adicionar Contato’ na lista de ações e os parâmetros de entrada da ação ‘Adicionar Contato’ serão exibidos: ![][13]
16. Clique em '+' ao lado do campo ‘Endereço de Email’ e selecione o valor do campo de saída do gatilho: ![][14]
17. Clique em ✓ e a configuração da ação será concluída: ![][15]
18. Selecione "Conector do Office 365" na seção “Usados Recentemente” da galeria e uma nova ação do "Office 365" é adicionada.
19. Selecione ‘Enviar Email’ na lista de ações e os parâmetros de entrada da ação 'Enviar Email' serão exibidos: ![][19]
20. Forneça os detalhes necessários para enviar o email. Você pode criar uma mensagem digitando algo como o que está abaixo. Uma vez que a ação estiver configurada, clique em ✓:
    
     Body - @concat('You got a new sales enquiry from',triggers().output.body.From)
    
    ![][20]
21. Selecione "Conector do Office 365" na seção “Usados Recentemente” da galeria e uma nova ação do "Office 365" é adicionada.
22. Selecione ‘Responder’ na lista de ações e os parâmetros de entrada da ação ‘Responder’ serão exibidos: ![][16]
23. Clique em '+' ao lado do campo e selecione o valor da ID da mensagem de saída do gatilho e clique em ✓: ![][17]
24. Clique em OK na tela do editor do aplicativo lógico e clique em “Criar”. Serão necessários cerca de 30 segundos para a conclusão da criação.
25. Envie um email para a conta em que você configurou o gatilho e verá um email na sua conta de email pessoal e um evento de calendário e contato em sua conta de email profissional. Além disso, você deve obter uma resposta confirmando que a consulta de venda será respondida em breve.
