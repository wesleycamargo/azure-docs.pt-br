---
title: "Usar recursos de aplicativo lógico | Microsoft Docs"
...
1. Clique no botão **Visualização do código** na barra de comandos.
    ...
    ![Visualização do código](./media/app-service-logic-use-logic-app-features/codeview.png)
