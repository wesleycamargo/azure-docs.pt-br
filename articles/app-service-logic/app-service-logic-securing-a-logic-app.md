---
title: "Proteger um Aplicativo Lógico do Azure | Microsoft Docs"
description: "Proteja as entradas, acesso e controle de um aplicativo lógico"
services: logic-apps
...
Se você estiver usando um [modelo de implantação](app-service-logic-create-deploy-template.md) para automatizar suas implantações, as configurações de intervalo IP podem ser configuradas no modelo de recurso.  
...
[Criar um modelo de implantação](app-service-logic-create-deploy-template.md)  
[Manipulação de exceção](app-service-logic-exception-handling.md)  
[Monitorar seus aplicativos lógicos](app-service-logic-monitor-your-logic-apps.md)  
[Diagnosticando falhas e problemas nos aplicativos lógicos](app-service-logic-diagnosing-failures.md)  
