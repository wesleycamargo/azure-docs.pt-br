---
title: Uso do Gerenciador de Conexão Híbrida | Microsoft Docs
...
> [!NOTE]
> O Gerenciador de Conexão Híbrida será necessário apenas se você estiver se conectando a um recurso local por trás do firewall. Se não estiver se conectando a um sistema local, você não precisará do Gerenciador de Conexão Híbrida.
> 
> 
...
> [!NOTE]
> Para alternar para a cadeia de conexão secundária, execute novamente a configuração de conexão híbrida e insira a **cadeia de configuração secundária**.
> 
> 
