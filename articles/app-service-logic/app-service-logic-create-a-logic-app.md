...
Primeiro, você precisa criar os dois conectores que usará: **Conector do Dropbox** e **Conector do Twitter**. Para criá-los:

1. Clique em **Marketplace** na tela inicial e pesquise pelo **Twitter**. 

2. Selecione o Conector do Twitter e clique no botão Criar. Você obterá uma folha com todas as suas configurações. Você pode deixar o nome como **Conector do Twitter**.
...
7. Escolha o **Local** onde o aplicativo lógico será executado.
	...
	![Criar folha de aplicativo de API](./media/app-service-logic-create-a-logic-app/gallery.png)
...
1. Clique no botão **+Novo** na parte inferior esquerda da tela, expanda **Web + Móvel** e clique em **Aplicativo Lógico**. 
 	...
 	Isso exibe a folha Criar aplicativo lógico, em que você fornece algumas configurações básicas para começar.

	![Criar folha de aplicativo lógico](./media/app-service-logic-create-a-logic-app/createlogicapp.png)
...
1. Ainda na folha **Criar aplicativo lógico**, clique em **Gatilhos e ações**. 
