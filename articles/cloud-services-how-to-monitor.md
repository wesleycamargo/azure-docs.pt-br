<properties linkid="manage-services-how-to-monitor-a-cloud-service" urlDisplayName="Como monitorar" pageTitle="Como monitorar um serviço de nuvem - Azure" metaKeywords="Monitoramento dos serviços de nuvem do Azure, Portal de gerenciamento Azure de serviços de nuvem" description="Saiba como monitorar os serviços de nuvem usando o Portal de Gerenciamento do Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Como monitorar serviços de nuvem" authors=""  solutions="" writer="ryanwi" manager="" editor=""  />
...
##Sumário##
* [Conceitos](#concepts)
* [Tutorial: Configurar o monitoramento para serviços de nuvem](#verbose)
* [Tutorial: Receber alertas para métricas dos serviços de nuvem](#receivealerts)
* [Tutorial: Adicionar métricas à tabela de métricas](#addmetrics)
* [Tutorial: Personalizar o gráfico de métricas](#customizechart)
* [Tutorial: Acessar dados do monitoramento detalhado fora do Portal de Gerenciamento](#accessverbose)
...
<h2><a id="verbose"></a>Tutorial: Configurar o monitoramento para serviços de nuvem</h2>
...
- Habilite o Diagnóstico do Azure para suas funções do serviço de nuvem. <br /><br />Você deve atualizar o arquivo da definição do serviço de nuvem (.csdef) e o arquivo de configuração do serviço de nuvem (.cscfg). Para obter mais informações, consulte [Configurando o diagnóstico no Azure](http://msdn.microsoft.com/pt-br/library/windowsazure/dn186185.aspx).
...
<h2><a id="receivealerts"></a>Tutorial: Receber alertas para métricas dos serviços de nuvem</h2>
...
<h2><a id="addmetrics"></a>Tutorial: Adicionar métricas à tabela de métricas</h2>
...
2. Para adicionar métricas à tabela de métricas:
	...
	a. Clique em **Adicionar Métricas** para abrir **Escolher Métricas**, conforme mostrado abaixo.
...
<h2><a id="customizechart"></a>Tutorial: Personalizar o gráfico de métricas</h2>
...
<h2><a id="accessverbose"></a>Tutorial: Acessar dados do monitoramento detalhado fora do Portal de Gerenciamento</h2>
...
Por exemplo, as tabelas a seguir armazenariam os dados agregados do monitoramento detalhado em intervalos de 1 hora:
	...
	WAD8b7c4233802442b494d0cc9eb9d8dd9fPT1HRTable (agregações por hora para a função)

	WAD8b7c4233802442b494d0cc9eb9d8dd9fPT1HRITable (agregações por hora para instâncias de função)
