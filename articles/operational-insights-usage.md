...
Você pode exibir seu uso usando o bloco **Servidores e Uso** painel **Visão Geral** no Insights Operacionais.

![imagem do bloco Servidores e Uso](./media/operational-insights-usage/overview-servers-usage.png)

Se você tiver excedido o limite de uso diário, ou se estiver próximo do limite, você também pode remover um pacote de inteligência para reduzir a quantidade de dados enviados para o serviço do Insights Operacionais. Para obter mais informações sobre a remoção de pacotes de inteligência, consulte [Usar a Galeria para adicionar ou remover pacotes de inteligência](operational-insights-add-intelligence-packs.md).
...
- Uso de dados para cada pacote de inteligência para hoje
...
3. Se houver dados sobre um pacote de inteligência que esteja desnecessariamente usando muito da cota alocada, convém remover esse pacote de inteligência.
