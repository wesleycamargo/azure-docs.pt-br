<properties linkid="mobile-services-monitor-new-relic" urlDisplayName="Usar o New Relic para monitorar serviços móveis" pageTitle="Armazenar scripts de servidor no controle de origem - Serviços Móveis do Azure" metaKeywords="" description="Saiba como usar o complemento New Relic para monitorar seus serviços móveis." metaCanonical="" disqusComments="1" umbracoNaviHide="0" documentationCenter="Mobile" title="Usar o New Relic para monitorar serviços móveis" authors="" />
...
+ Para obter informações sobre preços, consulte a [página do New Relic na Azure Store] (a página pode estar em inglês).
+ Para obter mais informações sobre como usar o New Relic, consulte [Visão geral de aplicativos] (a página pode estar em inglês) na documentação do New Relic. 
...
<!-- URLs. -->
[Controle de origem]: http://msdn.microsoft.com/pt-br/library/windowsazure/c25aaede-c1f0-4004-8b78-113708761643
...
[Página do New Relic na Azure Store]: /pt-br/gallery/store/new-relic/new-relic/
