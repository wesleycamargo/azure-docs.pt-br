<properties urlDisplayName="Deliver Streaming Content from Media Services" pageTitle="Como fornecer conte&uacute;do de streaming dos Servi&ccedil;os de M&iacute;dia - Azure" metaKeywords="" description="Saiba como fornecer conte&uacute;do de streaming dos Servi&ccedil;os de M&iacute;dia usando uma URL direta. Os exemplos de c&oacute;digo s&atilde;o escritos em C# e usam a SDK dos Servi&ccedil;os de M&iacute;dia para .NET." metaCanonical="" disqusComments="1" umbracoNaviHide="0" title="Como: Fornecer conte&uacute;do de streaming" authors="juliako" manager="dwrede" />

<tags ms.service="media-services" ms.workload="media" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="01/01/1900" ms.author="juliako" />

# Como: Fornecer conteúdo de streaming

Este artigo faz parte de uma série de introdução à programação dos Serviços de Mídia do Azure. O tópico anterior era [Como: Fornecer um ativo por download][Como: Fornecer um ativo por download].
...
Até agora, explicamos como fornecer mídia baixando do Armazenamento do Azure e usando smooth streaming. O próximo tópico [Como fornecer conteúdo HLS][Como fornecer conteúdo HLS] explica como fornecer conteúdo de streaming usando HTTP Live Streaming (HLS) da Apple.

  [Como: Fornecer um ativo por download]: ../media-services-deliver-asset-download/
  ...
  [Como fornecer conteúdo HLS]: ../media-services-deliver-http-live-streaming-content/
