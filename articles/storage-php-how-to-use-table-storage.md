<properties linkid="develop-php-table-service" urlDisplayName="Tabela de serviço" pageTitle="Como usar o armazenamento de tabela (PHP) | Microsoft Azure" metaKeywords="Serviço de tabela do Azure PHP, criar tabela Azure, excluir tabela Azure, inserir tabela Azure, tabela de consulta Azure" description="Aprenda a usar o serviço Tabela do PHP para criar e excluir uma tabela e inserir, excluir e consultar a tabela." metaCanonical="" services="storage" documentationCenter="PHP" title="Como usar o serviço Tabela do PHP" authors="" solutions="" manager="" editor="" />

# Como usar o serviço Tabela do PHP

Este guia mostrará como executar cenários comuns usando o serviço Tabela do Azure. Os exemplos são gravados no PHP e usam o [SDK do Azure para PHP][download]. Os cenários abrangidos incluem **criar e excluir uma tabela, e inserir, excluir e consultar entidades em uma tabela**. Para obter mais informações sobre o serviço Tabela do Azure, consulte a seção [Próximas etapas](#NextSteps).
...
* [Como colocar operações de tabela em lotes](#BatchOperations)
...
1. Fazer referência ao arquivo de carregador automático usando a instrução [exigir_uma vez][require_once] e
...
> [WACOM.NOTE]
> Este exemplo (e outros exemplos neste artigo) consideram que você instalou as Bibliotecas do Cliente PHP para o Azure por meio do Composer. Se você instalou as bibliotecas manualmente ou como um pacote PEAR, você precisará fazer referência ao arquivo de carregador automático <code>WindowsAzure.php</code>.
...
As consultas de entidades são construídas usando filtros (para obter mais informações, consulte [Consultar tabelas e entidades][filters]). Para recuperar todas as entidades na partição, use o filtro "eq PartitionKey *nome_da_partição*". O exemplo a seguir mostra como recuperar todas as entidades na partição `tasksSeattle` passando um filtro para o método **queryEntities**.
...
##<a id="BatchOperations"></a>Como colocar operações de tabela em lotes
...
Agora que você aprendeu os conceitos básicos do Serviço de Tabela dp Azure, siga estes links para saber como executar tarefas de armazenamento mais complexas.
...
[baixe o]: http://go.microsoft.com/fwlink/?LinkID=252473
[Armazenando e acessando dados no Azure]: http://msdn.microsoft.com/pt-br/library/windowsazure/gg433040.aspx
[require_once]: http://php.net/require_once
[tempo limite do serviço Tabela]: http://msdn.microsoft.com/pt-br/library/windowsazure/dd894042.aspx

[modelo de dados de tabela]: http://msdn.microsoft.com/pt-br/library/windowsazure/dd179338.aspx
[filtros]: http://msdn.microsoft.com/pt-br/library/windowsazure/dd894031.aspx
[transações de grupo de entidade]: http://msdn.microsoft.com/pt-br/library/windowsazure/dd894038.aspx
