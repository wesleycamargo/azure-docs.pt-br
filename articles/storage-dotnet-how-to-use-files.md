...
##<a name="what-is-file-storage"></a>O que é o armazenamento de arquivos do Azure?
...
##<a name="mount-share"></a>Montar o compartilhamento por meio de uma máquina virtual do Azure
...
1. Primeiramente, crie uma nova máquina virtual do Azure seguindo as instruções em [Criar uma máquina virtual executando o Windows Server](/pt-br/documentation/articles/virtual-machines-windows-tutorial/).
2. Em seguida, acesse remotamente a máquina virtual seguindo as instruções em [Como fazer logon em uma máquina virtual executando o Windows Server](/pt-br/documentation/articles/virtual-machines-log-on-windows-server/).
...
##<a name="create-console-app"></a>Criar um aplicativo local para trabalhar com o armazenamento de arquivos
