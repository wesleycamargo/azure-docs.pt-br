...
* Para saber mais sobre a migração de recursos do clássico para ARM, veja [Migrar do Clássico para o Azure Resource Manager](resource-manager-deployment-model.md#migrate-from-classic-to-resource-manager)
