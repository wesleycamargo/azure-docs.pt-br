...
5. Selecione a assinatura na lista com a ID correta.
    ...
    ![Filhos](media/management-groups/add_context_sub.png)
1. Selecione "Salvar"
...
2. Selecione **Todos os serviços** > **Grupos de gerenciamento**
3. Selecione o grupo de gerenciamento o qual planeja que seja o pai.
5. Na parte superior da página, selecione **Adicionar grupo de gerenciamento**.
6. No menu que será aberto, selecione se deseja usar um grupo de gerenciamento novo ou existente.
