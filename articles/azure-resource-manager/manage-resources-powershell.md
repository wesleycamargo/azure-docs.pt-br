...
Para percorrer um tutorial, veja [Tutorial: Mover recursos do Azure para outro grupo de recursos ou assinatura](./resource-manager-tutorial-move-resources.md). 
