...
Os exemplos neste artigo exigem a versão 6.0 ou posterior do Azure PowerShell. Se você não tiver a versão 6.0 ou posterior, [atualize sua versão](/powershell/azure/azurerm/install-azurerm-ps).
