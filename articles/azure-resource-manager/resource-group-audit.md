---
title: "Auditar operações com o Resource Manager | Microsoft Docs"
...
---
# <a name="audit-operations-with-resource-manager"></a>Operações de auditoria com o Gerenciador de Recursos
...
## <a name="portal-to-view-activity-logs"></a>Portal para exibir os logs de atividade
1. Para exibir os logs de atividade por meio do portal, escolha **Mais Serviços** e **Logs de Atividades**.
...
## <a name="powershell-to-view-activity-logs"></a>PowerShell para exibir os logs de atividade
...
2. Dependendo da hora de início que você especificar, os comandos anteriores poderão retornar uma longa lista de operações para o grupo de recursos. Você pode, pelo fornecimento de critérios de pesquisa, filtrar os resultados para o que você está procurando. Por exemplo, se estiver tentando pesquisar como um aplicativo Web foi interrompido, você poderá executar o comando a seguir.  
    ...
    Que, para este exemplo, mostra que a ação de parada foi executada por nome@contoso.com. 
...
## <a name="azure-cli-to-view-activity-logs"></a>CLI do Azure para exibir os logs de atividade
...
## <a name="rest-api-to-view-audit-logs"></a>API REST para exibir os logs de auditoria
