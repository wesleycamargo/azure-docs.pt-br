<properties 
	pageTitle="Gerenciar o Gerenciador de Tráfego do Azure usando a Automação do Azure" 
...
#Gerenciando o Gerenciador de Tráfego do Azure usando a Automação do Azure
 
Este guia apresentará o serviço de Automação do Azure e como ele pode ser usado para simplificar o gerenciamento do Gerenciador de Tráfego do Azure.
...
## Como a Automação do Azure ajuda a gerenciar o Gerenciador de Tráfego do Azure?
 
O Gerenciador de Tráfego pode ser gerenciado na Automação do Azure usando os cmdlets do PowerShell disponíveis nas [Ferramentas PowerShell do Azure](https://msdn.microsoft.com/library/azure/jj156055.aspx). A Automação do Azure pode chamar esses cmdlets do PowerShell para que você possa executar todas as tarefas de gerenciamento do Gerenciador de Tráfego no serviço. Você também pode combinar esses cmdlets na automação do Azure com os cmdlets para outros serviços do Azure para automatizar tarefas complexas em serviços do Azure e sistemas de terceiros.
 
 
## Próximas etapas
 
Agora que você aprendeu os fundamentos de Automação do Azure e como ela pode ser usada para gerenciar o Gerenciador de Tráfego do Azure, siga estes links para saber mais sobre a Automação do Azure.
