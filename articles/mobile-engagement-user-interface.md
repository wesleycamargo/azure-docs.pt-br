...
Depois que você integrou o [SDK] do Mobile Engagement do Azure[Link 5] ao seu aplicativo e compreendeu os [Conceitos] básicos do Mobile Engagement do Azure[Link 6], há duas maneiras de interagir com o Mobile Engagement do Azure para seu aplicativo: os usuários padrão podem usar a [Interface do usuário][Link 1] e usuários desenvolvedores podem usar a REST HTTP com base em [APIs][Link 4]. Para obter uma explicação passo a passo das atividades comuns, consulte os [Guias de como fazer][Link 3]. Se você tiver alguma dificuldade, consulte os [Guias de solução de problemas] do Mobile Engagement do Azure[Link 2].
