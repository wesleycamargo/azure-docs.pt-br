...
1. Clique o **Volumes** folha e, em seguida, selecione o volume para o qual você deseja montar. 
2. Clique em **instruções de montagem** do volume selecionado e, em seguida, siga as instruções para montar o volume. 
