...
<properties 
    pageTitle="Avalie o RemoteApp no seu dispositivo em 3 minutos ou menos"
    description="Avalie a funcionalidade do RemoteApp sem instalar o serviço." 
    services="remoteapp" 
...
# Avalie o RemoteApp no seu dispositivo em 3 minutos ou menos

Deseja ver o RemoteApp em seu dispositivo? Você pode acessar nossa implantação de demonstração por 10 minutos, desde que tenha uma conta da Microsoft. Temos o Office e alguns outros aplicativos disponíveis. Essa é uma ótima maneira de avaliar a experiência do usuário para o RemoteApp em menos de 3 minutos.
...
Agora você pode acessar aplicativos em execução em tempo real no RemoteApp. 
