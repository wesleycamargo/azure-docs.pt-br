<properties
   pageTitle="Atualize sua coleção de RemoteApp do Azure"
...
2. [Carregue](remoteapp-uploadimage.md) ou [importe](remoteapp-image-on-azurevm) essa imagem para o RemoteApp.
