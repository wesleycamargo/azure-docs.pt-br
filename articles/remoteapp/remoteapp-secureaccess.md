...
---
title: Proteger o acesso ao RemoteApp do Azure e além | Microsoft Docs
...
3. Na lista de relatórios, escolha **Uso do aplicativo** em **Aplicativos integrados**.
   ...
   Você verá algumas estatísticas agregadas para o Azure RemoteApp. ![Estatísticas de acesso agregadas do RemoteApp do Azure](./media/remoteapp-secureaccess/ra-accessstats.png)
4. Clique no aplicativo para mostrar as informações sobre os usuários que acessam o Azure RemoteApp.![Estatísticas de acesso do usuário para o RemoteApp do Azure](./media/remoteapp-secureaccess/ra-userstats.png)
