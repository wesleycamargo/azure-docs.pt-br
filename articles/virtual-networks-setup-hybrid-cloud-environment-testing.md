...
Use as instruções na seção "Etapas para configurar a sub-rede Corpnet" do [Guia do laboratório de teste: configuração básica para Windows Server 2012 R2](http://www.microsoft.com/download/details.aspx?id=39638) para configurar os computadores DC1, APP1 e CLIENT1 em uma sub-rede chamada Corpnet. **Essa sub-rede deve ser isolada da rede da sua organização, porque ela será conectada diretamente à Internet através do computador RRAS1.** 
...
Primeiro, faça logon no [Portal de Gerenciamento do Azure](https://manage.windowsazure.com/microsoft.onmicrosoft.com#Workspaces/All/dashboard) com as credenciais de assinatura do Azure e crie uma rede virtual chamada TestVNET.
