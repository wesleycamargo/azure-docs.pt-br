<properties linkid="develop-java-how-to-guides-view-saml-returned-by-acs" urlDisplayName="Exibir o SAML do ACS" pageTitle="Exibir o SAML retornado pelo Serviço de Controle de Acesso (Java)" metaKeywords="" description="Saiba como exibir o SAML retornado pelo Serviço de Controle de Acesso em aplicativos Java hospedados no Azure." metaCanonical="" services="" documentationCenter="Java" title="Como exibir o SAML retornado pelo Serviço de Controle de Acesso do Azure" authors="waltpo" videoId="" scriptId="" solutions="" manager="" editor="mollybos" />
