...
4.  Na guia Detalhes do Cluster, digite ou selecione os valores a seguir:
    ...
    <tr><td> <strong>Versão do HDInsight</strong> </td><td> Selecione <strong>3.1</strong> para criar um cluster do Hadoop 2.4 no HDInsight. </td></tr>
...
**Para abrir o painel do cluster HDInsight**
...
4.  Clique em **GERENCIAR CLUSTER** na parte inferior da página para abrir o painel do cluster do HDInsight. Ele abre uma página da Web em uma guia diferente do navegador.
...
1.  No painel do cluster do HDInsight, clique em **Editor do Hive** na parte superior.
...
1.  No painel do cluster HDInsight, clique em **Arquivos** na parte superior.
...
-   [Desenvolver programas Java MapReduce para HDInsight][Desenvolver programas Java MapReduce para HDInsight]
  ...
  [Hadoop 2.2]: ../hdinsight-get-started "Introdução ao uso do Hadoop 2.2 no HDInsight"
  [Hadoop 2.4]: ../hdinsight-get-started-31 "Introdução ao uso do Hadoop 2.4 no HDInsight"
  [Hadoop 1.2]: ../hdinsight-get-started-21 "Introdução ao uso do Hadoop 1.2 no HDInsight"
