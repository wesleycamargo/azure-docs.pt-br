<properties title="Introdu&ccedil;&atilde;o &agrave; Pesquisa do Azure" pageTitle="Introdu&ccedil;&atilde;o &agrave; Pesquisa do Azure" description="Introdu&ccedil;&atilde;o &agrave; Pesquisa do Azure" metaKeywords="" services="Azure Search" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
...
A Pesquisa do Microsoft Azure (Visualização pública) é um novo serviço que permite que você incorpore a funcionalidade de pesquisa em aplicativos personalizados. Ela fornece mecanismo de pesquisa e armazenamento para seus dados, os quais você acessa e gerencia usando uma API REST. Para ler mais sobre por que você usaria a Pesquisa do Azure, consulte [Recursos e cenários da Pesquisa do Azure][Recursos e cenários da Pesquisa do Azure].
...
-   [Explorar o painel do serviço de Pesquisa][Explorar o painel do serviço de Pesquisa]
...
1.  Entre no [Portal de Visualização do Azure][Portal de Visualização do Azure] usando sua assinatura existente. Observe que esta URL leva você até o Portal de Visualização. O uso do Portal de Visualização é um requisito.
...
1.  Especifique o cabeçalho da solicitação, substituindo o host e a chave da API por valores que sejam válidos para seu serviço.
...
-   [Criar um exemplo de Pesquisa Geoespacial na Pesquisa do Azure][Criar um exemplo de Pesquisa Geoespacial na Pesquisa do Azure]
...
-   [Vídeo do Channel 9: Introdução à Pesquisa do Azure][Vídeo do Channel 9: Introdução à Pesquisa do Azure]

-   [Vídeo do Channel 9: Pesquisa do Azure e Dados Geoespaciais][Vídeo do Channel 9: Pesquisa do Azure e Dados Geoespaciais]
...
<!--Link references-->
  ...
  [Criar um exemplo de Pesquisa Geoespacial na Pesquisa do Azure]: ../search-create-geospatial/
  ...
  [Vídeo do Channel 9: Introdução à Pesquisa do Azure]: http://channel9.msdn.com/Shows/Data-Exposed/Introduction-To-Azure-Search
