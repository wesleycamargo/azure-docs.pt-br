...
Se você precisar criar uma conta de armazenamento do Azure em uma região diferente, consulte [Sobre Contas de Armazenamento do Azure](storage-create-storage-account.md) para obter instruções passo a passo.
