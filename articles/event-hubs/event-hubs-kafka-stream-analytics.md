---
title: Processar Apache Kafka para eventos de Hubs de Eventos usando Azure Stream Analytics | Microsoft Docs
...
* Uma **conta do Armazenamento do Azure**. Se não tiver, [crie uma](../storage/common/storage-create-storage-account.md#create-a-storage-account) antes de prosseguir. O trabalho do Stream Analytics neste passo a passo armazena os dados de saída em um armazenamento de Blobs do Azure. 
...
1. Clone o [repositório de Hubs de Eventos do Azure](https://github.com/Azure/azure-event-hubs) no computador.
2. Navegue até a pasta: `azure-event-hubs/samples/kafka/quickstart/producer`. 
...
5. Navegue até `azure-event-hubs/samples/kafka/quickstart/producer/src/main/java/com/example/app` e abra o arquivo **TestDataReporter.java** em um editor de sua escolha. 
...
7. **Execute o produtor** e transmita para Hubs de Eventos habilitados para Kafka. Em um computador Windows, ao usar um **prompt de comando Node.js**, alterne para a pasta `azure-event-hubs/samples/kafka/quickstart/producer` antes de executar esses comandos. 
...
Nesta seção, você cria um trabalho do Azure Stream Analytics. O cliente Kafka envia eventos para o hub de eventos. Você cria um trabalho do Stream Analytics que recebe dados do evento como entrada e os envia para um armazenamento de Blobs do Azure. Se não tiver uma **conta de Armazenamento do Microsoft Azure**, [crie uma](../storage/common/storage-create-storage-account.md#create-a-storage-account).
