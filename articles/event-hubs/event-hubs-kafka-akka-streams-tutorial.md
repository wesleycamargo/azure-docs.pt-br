---
title: Usar o Akka Streams com Hubs de Eventos do Azure para o Apache Kafka | Microsoft Docs
...
* Leia o artigo [Hubs de Eventos do Apache Kafka](event-hubs-for-kafka-ecosystem-overview.md). 
