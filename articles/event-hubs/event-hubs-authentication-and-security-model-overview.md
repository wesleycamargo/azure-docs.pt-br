<properties 
   pageTitle="Visão geral do modelo de autenticação e segurança dos Hubs de Eventos"
...
### Criando identidades de serviço, terceiras partes confiáveis e regras no ACS

O ACS dá suporte a várias maneiras de criar identidades de serviço, terceiras partes confiáveis e regras, mas a maneira mais fácil de fazer isso é usando o [SBAZTool](http://code.msdn.microsoft.com/windowsazure/Authorization-SBAzTool-6fd76d93). Por exemplo:
