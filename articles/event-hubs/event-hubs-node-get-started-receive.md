---
title: Receber eventos de Hubs de Eventos do Azure usando o Node.js | Microsoft Docs
description: Saiba como receber eventos de Hubs de Eventos usando o Node.js.
services: event-hubs
...
> [!NOTE]
>  Para enviar eventos para Hubs de Eventos usando o Node.js, confira este artigo: [Send events to Azure Event Hubs using Node.js](event-hubs-node-get-started-send.md) (Enviar eventos para Hubs de Eventos do Azure usando o Node.js). 
...
* [Enviar eventos usando o Node.js](event-hubs-go-get-started-send.md)
* [Exemplos de Hubs de Eventos](https://github.com/Azure/azure-event-hubs-node/tree/master/processor/examples/)
* [Capturar eventos para o Armazenamento do Azure ou o Data Lake Storage](event-hubs-capture-overview.md)
