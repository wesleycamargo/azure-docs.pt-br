...
-   Para obter mais informações sobre como usar o SendGrid no Java, consulte [Como enviar email usando o SendGrid do Java][].
  ...
  [Como enviar email usando o SendGrid do Java]: ../store-sendgrid-java-how-to-send-email
  [Criando um aplicativo Hello World para o Azure no Eclipse]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh690944
  [Resultado de envio de email]: ./media/store-sendgrid-java-how-to-send-email-example/SendGridJavaResult.jpg
  ...
  [Usando o Banco de Dados SQL no Java]: http://www.windowsazure.com/pt-br/develop/java/how-to-guides/using-sql-azure-in-java/
  [Usando a biblioteca de tempo de execução de serviço do Azure no JSP]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh690948
