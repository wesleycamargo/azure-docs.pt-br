...
7. [Atualizar o aplicativo para usar Serviços Móveis]
...
+ Visual Studio 2013 (você pode obter o [Visual Studio Express for Web](http://go.microsoft.com/p/?linkid=9832232) gratuitamente).
