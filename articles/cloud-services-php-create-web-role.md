<properties linkid="develop-php-common-tasks-create-web-and-worker-roles" urlDisplayName="Criar funções Web e de trabalho" pageTitle="Criar funções Web e de trabalho" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="PHP" title="Como criar funções Web e de trabalho do PHP" authors="bswan" solutions="" manager="paulettm" editor="mollybos" />
...
* [Como criar um projeto de Serviços de Nuvem](#CreateProject)
* [Como adicionar funções Web e de trabalho do PHP](#AddRole)
...
##<a name="CreateProject"></a>Como criar um projeto de Serviços de Nuvem
...
##<a name="AddRole"></a>Como adicionar funções Web ou de trabalho do PHP
...
3. Adicione um arquivo `php.ini` à pasta `php`. Habilite todas as extensões personalizadas e defina todas as diretivas do PHP nesse arquivo. Por exemplo, se você desejar ativar `display_errors` e habilitar a extensão `php_mongo.dll`, o conteúdo de seu arquivo `php.ini` será o seguinte:
...
<div class="dev-callout"> 
<b>Observação</b> 
<p>Todas as configurações que você não definir explicitamente no arquivo <code>php.ini</code> que você fornecer serão definidas automaticamente para seus valores padrão. No entanto, lembre-se de que você pode adicionar um <code>php.ini</code> completo. </p> 
</div>
...
1. Crie um projeto de Serviço do Azure e adicione uma função Web do PHP, conforme descrito nas seções [Como criar um projeto de serviços de nuvem](#CreateProject) e [Como adicionar funções Web ou de trabalho do PHP](#AddRole) acima.
...
6. Publique o aplicativo conforme descrito na seção [Como publicar seu aplicativo](#Publish) a seguir.
...
1. Crie um projeto de Serviço do Azure e adicione uma função de trabalho do PHP, conforme descrito nas seções [Como criar um projeto de serviços de nuvem](#CreateProject) e [Como adicionar funções Web ou de trabalho do PHP](#AddRole) acima.
...
Os Emuladores de Computação e de Armazenamento do Azure fornecem um ambiente local no qual você pode testar seu aplicativo do Azure antes de implantá-lo na nuvem. Existem algumas diferenças entre os emuladores e o ambiente do Azure. Para compreender melhor isso, consulte [Diferenças entre o Emulador de Computação e o Azure (a página pode estar em inglês)](http://msdn.microsoft.com/pt-br/library/windowsazure/gg432960.aspx) e [Diferenças entre o Emulador de Armazenamento e os Serviços de Armazenamento do Azure (a página pode estar em inglês)](http://msdn.microsoft.com/pt-br/library/windowsazure/gg433135.aspx).
...
##<a name="Publish"></a>Com publicar seu aplicativo
...
[Como importar as configurações de publicação]: /pt-br/develop/php/how-to-guides/powershell-cmdlets/#ImportPubSettings
