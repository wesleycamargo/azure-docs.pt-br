<properties
   pageTitle="Considerações sobre a implementação de um plano de teste JMeter para o Elasticsearch | Microsoft Azure"
...
Você pode incorporar um código complexo em um plano de teste JMeter criando um ou mais testes JUnit. Você pode escrever um teste JUnit usando um Java IDE, como o Eclipse. O documento Como criar e implantar uma amostra de JMeter JUnit para teste de desempenho do Elasticsearch fornece informações sobre como configurar um ambiente de desenvolvimento apropriado.
