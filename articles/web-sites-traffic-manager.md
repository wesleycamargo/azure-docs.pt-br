...
Para obter informações detalhadas sobre o balanceamento de carga no Gerenciador de Tráfego do Azure, consulte [Sobre métodos de balanceamento de carga do Gerenciador de Tráfego][Sobre métodos de balanceamento de carga do Gerenciador de Tráfego].
...
-   Os nomes de domínio personalizados funcionarão conforme esperado, mas além de adicioná-los a seus sites, você deve configurar o mapa DNS a fim de apontar para a URL do Gerenciador de Tráfego. Para obter informações sobre como configurar um domínio personalizado para um site do Azure, consulte [Configurando um nome de domínio personalizado para um site do Azure][Configurando um nome de domínio personalizado para um site do Azure].

-   Você só pode adicionar sites que estejam no modo Padrão para um perfil do Gerenciador de Tráfego do Azure.

## Próximas etapas

Para obter uma visão geral conceitual e técnica do Gerenciador de Tráfego do Azure, consulte [Visão geral do Gerenciador de Tráfego][Visão geral do Gerenciador de Tráfego].

Para obter informações sobre como configurar o Gerenciador de Tráfego do Azure, inclusive para usar sites do Azure, consulte [Tarefas de configuração do Gerenciador de Tráfego][Tarefas de configuração do Gerenciador de Tráfego].

Para obter informações detalhadas sobre o balanceamento de carga no Gerenciador de Tráfego do Azure, consulte [Sobre métodos de balanceamento de carga do Gerenciador de Tráfego][Sobre métodos de balanceamento de carga do Gerenciador de Tráfego].

Para obter mais informações sobre usar o Gerenciador de Tráfego com os sites do Azure, consulte as postagens do blog
[Usar o Gerenciador de Tráfego do Azure com WAWS][Usar o Gerenciador de Tráfego do Azure com WAWS] e [O Gerenciador de Tráfego do Azure agora pode se integrar com os sites do Azure][O Gerenciador de Tráfego do Azure agora pode se integrar com os sites do Azure].

  [Sobre métodos de balanceamento de carga do Gerenciador de Tráfego]: http://msdn.microsoft.com/pt-br/library/windowsazure/dn339010.aspx
  [Configurando um nome de domínio personalizado para um site do Azure]: https://www.windowsazure.com/pt-br/documentation/articles/web-sites-custom-domain-name/
  [Visão geral do Gerenciador de Tráfego]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh744833.aspx
  [Tarefas de configuração do Gerenciador de Tráfego]: http://msdn.microsoft.com/pt-br/library/windowsazure/hh744830.aspx
  [Usar o Gerenciador de Tráfego do Azure com WAWS]: http://blogs.msdn.com/b/waws/archive/2014/03/18/using-windows-azure-traffic-manager-with-waws.aspx
  [O Gerenciador de Tráfego do Azure agora pode se integrar com os sites do Azure]: http://azure.microsoft.com/blog/2014/03/27/azure-traffic-manager-can-now-integrate-with-azure-web-sites/
