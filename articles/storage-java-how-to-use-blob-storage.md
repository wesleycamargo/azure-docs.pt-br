...
* [Configurar seu aplicativo para acessar o Armazenamento de Blob](#ConfigureStorage)
...
Por fim, para excluir um contêiner de blob, obtenha uma referência do blob echame **deleteIfExists**.
