...
### <a name="watch-an-overview-of-the-azure-status-page-azure-service-health-and-azure-resource-health"></a>Assista a uma visão geral da página Status do Azure, Integridade do Serviço do Azure e Azure Resource Health
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre o status do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre a Integridade do Serviço</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ser notificado a próxima vez que o recurso do Azure ficar indisponível</h3>
                    </div>
                </div>
            </div>
        </div>
