...
Além disso, o Serviço de Aplicativo do Azure tem um novo recurso de visualização para APIs REST: aplicativos de API. Para obter mais informações sobre aplicativos de API, consulte [O que são aplicativos de API](app-service-api-apps-why-best-platform.md).
