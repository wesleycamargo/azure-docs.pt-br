---
title: Reiniciar o banco de dados do Azure para servidor do MariaDB usando a CLI do Azure
description: Este artigo descreve como você pode reiniciar um banco de dados do Azure para MariaDB usando a CLI do Azure.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "58623072"
---
# <a name="restart-azure-database-for-mariadb-server-using-the-azure-cli"></a>Reiniciar o banco de dados do Azure para servidor do MariaDB usando a CLI do Azure
