...
1. Selecione o botão **Criar um recurso** (+) no canto superior esquerdo do portal. Digite **Banco de Dados do Azure para MariaDB** na caixa de pesquisa para localizar rapidamente o serviço.
