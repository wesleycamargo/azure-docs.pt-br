...
## <a name="log-in-to-azure-and-list-your-azure-database-for-mariadb-servers"></a>Fazer logon no Azure e listar os servidores de Banco de Dados do Azure para MariaDB
