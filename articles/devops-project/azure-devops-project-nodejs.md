---
title: Criar um pipeline de CI/CD para Node.js com o Projeto de DevOps do Azure | Início Rápido
...
ms.locfileid: "47410078"
---
# <a name="create-a-cicd-pipeline-for-nodejs-with-the-azure-devops-project"></a>Criar um pipeline de CI/CD para Node.js com o Projeto de DevOps do Azure

O Azure DevOps Project apresenta uma experiência simplificada que cria recursos do Azure e configura um pipeline de integração contínua (CI) e entrega contínua (CD) para seu aplicativo Node.js no Azure DevOps Services.  
...
1. **Aplicativo Web no Windows** é o destino de implantação padrão.  A estrutura do aplicativo, escolhida nas etapas anteriores, determina o tipo de destino de implantação do serviço do Azure disponível aqui.  Mantenha o serviço padrão e selecione **Avançar**.
...
O Azure DevOps Project configura automaticamente um build de CI e libera o gatilho.  Agora você está pronto para colaborar com uma equipe em um aplicativo Node.js com um processo de CI/CD que implanta automaticamente o trabalho mais recente em seu site da Web.
...
1. À esquerda do navegador, vá para o arquivo **views/index.pug**.
