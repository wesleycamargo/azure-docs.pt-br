<properties
   pageTitle="Criar uma implantação de várias VMs usando a CLI x-plat do Azure | Azure"
   description="Saiba como criar uma implantação de VM múltipla usando a CLI x-plat do Azure"
...
# Criar uma implantação de várias VMs usando a CLI x-plat do Azure | Azure

O script a seguir mostra como configurar uma implantação de serviço de várias nuvens e VMs em uma VNET usando a Interface de Linha de Comando entre Plataformas do Azure (xplat-cli).
