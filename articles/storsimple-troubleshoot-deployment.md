...
5. Verifique a conectividade do serviço de nuvem. Se o serviço lançar uma exceção da Web, talvez você veja os seguintes erros:
  ...
  Se ele não lançar uma exceção da Web, verifique o seguinte: - ErrorCode.CiSApplianceSaasServiceError – isso indica um problema com o serviço Gerenciador do StorSimple.
