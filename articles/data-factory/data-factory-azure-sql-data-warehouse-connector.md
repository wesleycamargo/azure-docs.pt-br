...
4.  Um [conjunto de dados](data-factory-create-datasets.md) de saída do tipo [AzureSqlDWTable](#azure-sql-data-warehouse-dataset-type-properties).
...
## <a name="azure-sql-data-warehouse-linked-service-properties"></a>Propriedades do serviço vinculado do SQL Data Warehouse do Azure
...
## <a name="azure-sql-data-warehouse-dataset-type-properties"></a>Propriedades de tipo do conjunto de dados do SQL Data Warehouse do Azure
...
## <a name="azure-sql-data-warehouse-copy-activity-type-properties"></a>Propriedades de tipo de atividade de cópia do SQL Data Warehouse do Azure
