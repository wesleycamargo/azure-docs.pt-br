<properties 
	pageTitle="Conector do MySQL: mover dados do MySQL" 
	description="Saiba mais sobre o conector do MySQL para o serviço da Data Factory que permite mover dados do banco de dados MySQL" 
...
# Conector do MySQL: mover dados do MySQL
...
1.	Um serviço vinculado do tipo OnPremisesMySql.
...
4.	Um pipeline com atividade de cópia que usa RelationalSource e BlobSink.
...
Conforme mencionado no artigo sobre [atividades de movimentação de dados](data-factory-data-movement-activities.md), a atividade de cópia executa conversões de tipo automáticas de tipos de fonte para tipos de coletor, com a abordagem em duas etapas descrita a seguir:
