...
> * [Versão 1 – já disponível](data-factory-azure-sql-connector.md)
> * [Versão 2 – Versão prévia](../connector-azure-sql-database.md)

> [!NOTE]
> Este artigo se aplica à versão 1 do Data Factory, que está com GA (disponibilidade geral). Se você estiver usando a versão 2 do serviço do Data Factory, que está em versão prévia, consulte [Azure SQL Database connector in V2](../connector-azure-sql-database.md) (Conector do Banco de Dados SQL do Azure na V2).
