...
> * [Versão 1 – já disponível](data-factory-sap-business-warehouse-connector.md)
> * [Versão 2 – Versão prévia](../connector-sap-business-warehouse.md)

> [!NOTE]
> Este artigo se aplica à versão 1 do Data Factory, que está com GA (disponibilidade geral). Se você estiver usando a versão 2 do serviço do Data Factory, que está em versão prévia, consulte [SAP Business Warehouse connector in V2](../connector-sap-business-warehouse.md) (Conector do SAP Business Warehouse na V2).
