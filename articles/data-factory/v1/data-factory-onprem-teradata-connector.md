...
> * [Versão 1 – já disponível](data-factory-onprem-teradata-connector.md)
> * [Versão 2 – Versão prévia](../connector-teradata.md)

> [!NOTE]
> Este artigo se aplica à versão 1 do Data Factory, que está com GA (disponibilidade geral). Se você estiver usando a versão 2 do serviço do Data Factory, que está em versão prévia, consulte [Teradata connector in V2](../connector-teradata.md) (Conector do Teradata na V2).
