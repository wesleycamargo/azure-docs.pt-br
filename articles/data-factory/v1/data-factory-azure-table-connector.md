...
> * [Versão 1 – já disponível](data-factory-azure-table-connector.md)
> * [Versão 2 – Versão prévia](../connector-azure-table-storage.md)

> [!NOTE]
> Este artigo se aplica à versão 1 do Data Factory, que está com GA (disponibilidade geral). Se você estiver usando a versão 2 do serviço do Data Factory, que está em versão prévia, consulte [Azure Table Storage connector in V2](../connector-azure-table-storage.md) (Conector do Armazenamento de Tabelas do Azure na V2).
