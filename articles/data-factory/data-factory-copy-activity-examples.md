...
- **type** é definido como **AzureStorage**.
...
Consulte [Propriedades de tipo SQL locais](https://msdn.microsoft.com/library/mt185722.aspx#OnPremSQL) para obter detalhes sobre os elementos JSON para definir uma tabela do Data Factory que faz referência a uma tabela do SQL Server.
...
Consulte [Propriedades de tipo de blob do Azure](https://msdn.microsoft.com/library/mt185722.aspx#AzureBlob) para obter detalhes sobre os elementos JSON para definir uma tabela do Data Factory que faz referência a um blob do Azure.
...
Consulte [Propriedades de tipo de Sistema de Arquivos local](https://msdn.microsoft.com/library/mt185722.aspx#OnPremFileSystem) para obter detalhes sobre os elementos JSON para definir uma tabela do Data Factory que faz referência a um sistema de arquivos local.
...
### Criar um serviço vinculado para o blob de destino do Azure
O JSON de exemplo a seguir pode ser usado para criar um serviço vinculado denominado **MyAzureStorage** do tipo **AzureStorage**.
...
Consulte [Propriedades de tipo do Oracle local](https://msdn.microsoft.com/library/mt185722.aspx#Oracle) para obter detalhes sobre os elementos JSON para definir uma tabela do Data Factory que faz referência a uma tabela em um banco de dados Oracle local.
