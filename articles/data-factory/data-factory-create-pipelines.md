...
linkedServiceName | Nome do serviço vinculado usado pela atividade. <br/><br/>Uma atividade pode exigir que você especifique o vinculado de serviço que se vincula ao ambiente de computação necessário. | Sim para Atividade HDInsight e Atividade de Pontuação de Lote de Aprendizado de Máquina do Azure <br/><br/>Não para todos os outros typeProperties |
