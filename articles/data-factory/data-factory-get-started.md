...
Neste tutorial, você criará um data factory com um pipeline para copiar dados do Armazenamento de Blobs para o banco de dados SQL.
...
3. Utilize o script SQL a seguir para criar a tabela **emp** no seu Banco de Dados SQL do Azure.
	...
	**Se você tiver o SQL Server 2012/2014 instalado no computador:** siga as instruções da [Etapa 2: conectar-se ao banco de dados SQL do artigo Gerenciando o Banco de Dados SQL do Azure usando o SQL Server Management Studio][sql-management-studio] para se conectar ao seu SQL server do Azure e executar o script SQL. Observe que este artigo usa o [Portal do Azure](http://manage.windowsazure.com), e não o [Portal do Azure](https://portal.azure.com), para configurar o firewall para um servidor SQL do Azure.
