<properties
	pageTitle="Criar seu primeiro data factory (portal do Azure) | Microsoft Azure"
...
# Criar seu primeiro data factory do Azure usando o Editor do Portal/Data Factory do Azure
> [AZURE.SELECTOR]
...
1. Leia o artigo [Visão geral do tutorial](data-factory-build-your-first-pipeline.md) e concluir as etapas de pré-requisito antes de continuar.
...
2.	Na folha **Novo data factory**, insira **GetStartedDF** como o Nome.
	...
	> [AZURE.IMPORTANT] O nome da data factory do Azure deve ser globalmente exclusivo. Se você receber o erro: **O nome do data factory "GetStartedDF" não está disponível**. Altere o nome do data factory (por exemplo, seunomeGetStartedDF) e tente criar novamente. Consulte o tópico [Data Factory - regras de nomenclatura](data-factory-naming-rules.md) para ver as regras de nomenclatura para artefatos de Data Factory.
	> 
...
4.	Selecione um **grupo de recursos** existente ou crie um grupo de recursos. Para o tutorial, crie um grupo de recursos chamado: **ADFGetStartedRG**.
5.	Clique em **Criar** na folha **Novo data factory**.
6.	Você verá o data factory que está sendo criado no **Quadro inicial** do portal do Azure da seguinte maneira:
...
7. Parabéns! Você criou com êxito sua primeira data factory. Após o data factory ter sido criado com êxito, você verá a página do data factory, que exibe seu conteúdo.
...
2. Copie e cole o trecho abaixo na janela de **Rascunho-1**. O trecho JSON descreve as propriedades usadas para criar o cluster do HDInsight sob demanda.
...
12. Na **Exibição de Diagrama**, clique duas vezes no conjunto de dados **AzureBlobOutput**. Você verá a fatia que está sendo processada.
