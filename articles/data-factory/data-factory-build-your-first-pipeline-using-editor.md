<properties
	pageTitle="Introdução ao Azure Data Factory (Portal do Azure)"
...
# Introdução ao Azure Data Factory (Editor do Data Factory)
> [AZURE.SELECTOR]
...
1. No **Editor do Data Factory**, clique em **Reticências (...)** e em **Novo pipeline**.
