---
title: Mover dados de e para o Banco de Dados SQL do Azure | Microsoft Docs
...
---
# <a name="move-data-to-and-from-azure-sql-database-using-azure-data-factory"></a>Mover dados de e para o Banco de Dados SQL do Azure usando o Azure Data Factory
...
## <a name="sample-copy-data-from-azure-sql-database-to-azure-blob"></a>Exemplo: Copiar dados do Banco de Dados SQL do Azure para o Blob do Azure
...
## <a name="sample-copy-data-from-azure-blob-to-azure-sql-database"></a>Exemplo: Copiar dados do Blob do Azure para o Banco de Dados SQL do Azure
...
5. Um [pipeline](data-factory-create-pipelines.md) com a atividade de Cópia que usa [BlobSource](data-factory-azure-blob-connector.md#azure-blob-copy-activity-type-properties) e [SqlSink](data-factory-azure-sql-connector.md#azure-sql-copy-activity-type-properties).
...
A amostra copia dados para uma tabela chamada “MyOutputTable” no SQL do Azure. Crie a tabela no SQL Azure com o mesmo número de colunas que você espera que o arquivo CSV de Blob contenha. Novas linhas são adicionadas à tabela a cada hora.
...
```
Consulte a seção [Sql Sink](#sqlsink) e [BlobSource](data-factory-azure-blob-connector.md#azure-blob-copy-activity-type-properties) para obter a lista de propriedades com o suporte de SqlSink e de BlobSource.

## <a name="azure-sql-linked-service-properties"></a>Propriedades do serviço vinculado do SQL do Azure
...
## <a name="azure-sql-dataset-type-properties"></a>Propriedades do tipo de conjunto de dados do SQL Azure
...
## <a name="azure-sql-copy-activity-type-properties"></a>Propriedades de tipo de atividade de cópia do SQL do Azure
...
### <a name="type-mapping-for-sql-server--azure-sql-database"></a>Mapeamento de tipo para SQL Server e Banco de Dados SQL do Azure
