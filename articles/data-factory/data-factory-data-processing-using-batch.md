...
2. Inicie o **Windows Explorer** e navegue até a pasta **bin\\debug** ou **bin\\release** dependendo do tipo de build.
...
2. No script JSON:
   ...
   4. Digite o URI do lote para a propriedade JSON **batchUri** . 
      ...
      > [!IMPORTANT]
      > A **URL** da **folha da conta do Lote do Azure** está no seguinte formato: \<accountname\>.\<region\>.batch.azure.com. Para a propriedade **batchUri** em JSON, você precisará **remover "accountname."**  da URL. Exemplo: `"batchUri": "https://eastus.batch.azure.com"`.
      > 
      > 
