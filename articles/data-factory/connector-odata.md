...
- Cópia de dados usando uma das seguintes autenticações: **Anônima**, **Básica**, **Windows**, **Entidade de Serviço do AAD** e **Identidade de Serviço Gerenciada**.
