...
5. Na página **Configurar data factory**, faça o seguinte:
   ...
   6. Clique em **Avançar**.
6. Na página **Configurar armazenamentos de dados**, especifique um **Banco de dados SQL do Azure** e **Conta de armazenamento do Azure** (ou) crie novos e clique em Avançar.
...
13. Na página **Configurar data factory**, faça o seguinte:
