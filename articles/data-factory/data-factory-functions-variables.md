...
1.	Especificando consultas de seleção de dados (veja os artigos sobre o conector referenciados no artigo [Atividades de movimentação de dados](data-factory-data-movement-activities.md).
	...
	A sintaxe para invocar uma função do Data Factory é: **$$<função>** para consultas de seleção de dados e outras propriedades na atividade e nos conjuntos de dados.
...
-------- | -------- | ---------- | ----------- 
Hora | AddHours(X,Y) | X: DateTime <br/><br/>Y: int | Adiciona Y horas até o momento X determinado. <br/><br/>Exemplo: 5/9/2013 12:00:00 + 2 horas = 5/9/2013 14:00:00
...
Data | DayOfYear(X) | X: DateTime | Obtém o dia do ano que representa o componente de ano de X.<br/><br/>Exemplos:<br/>1/12/2015: dia 335 de 2015<br/>31/12/2015: dia 365 de 2015<br/>31/12/2016: dia 366 de 2016 (ano bissexto)
...
Data | EndOfMonth(X) | X: DateTime | Obtém o final do mês representado pelo componente de mês de parâmetro X. <br/><br/>Exemplo: EndOfMonth de 15/9/2013 17:09:23 é 30/9/2013 23:59:59 (data e hora que representam o final do mês de setembro)
