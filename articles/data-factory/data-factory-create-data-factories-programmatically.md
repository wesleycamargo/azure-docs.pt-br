---
title: Criar, monitorar e gerenciar data factories do Azure usando o SDK da Data Factory | Microsoft Docs
...
8. Adicione o seguinte código que cria um **serviço vinculado** no método **Principal**.
   ...
   > [!NOTE]
   > Use o **nome da conta** e a **chave de conta** da sua conta de armazenamento do Azure para **ConnectionString**.
   > 
   > 
