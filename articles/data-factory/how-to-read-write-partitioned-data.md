...
Para ver um passo a passo completo sobre como criar um data factory contendo um pipeline, confira [Início Rápido: criar um data factory](quickstart-create-data-factory-powershell.md). 
