...
> [AZURE.NOTE] Atualmente, o Gateway de Gerenciamento de Dados dá suporte apenas à atividade de cópia e à atividade de procedimento armazenado no Data Factory. Não é possível usar o gateway de uma atividade personalizada para acessar fontes de dados locais.
...
10. Use o [Portal do Azure][azure-preview-portal] ou cmdlets do Azure PowerShell para monitorar seu data factory, pipelines e conjuntos de dados. Você pode ver as mensagens de **ActivityLogger** no código da atividade personalizada nos logs (especificamente, user-0.log) que você pode baixar do portal ou usando cmdlets.
...
## <a name="copy/move-data"></a>Copiar/mover dados 
