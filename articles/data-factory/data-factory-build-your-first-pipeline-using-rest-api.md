...
5. Execute o comando usando **Invoke-Command**.
        ...
        $results = Invoke-Command -scriptblock $cmd;
6. Exiba os resultados. Se o conjunto de dados tiver sido criado com êxito, você verá o JSON do conjunto de dados nos **resultados**. Caso contrário, verá uma mensagem de erro.
