...
# Mover dados de e para o Azure Cosmos DB usando o Azure Data Factory
...
## Importar/Exportar documentos JSON
...
## Exemplo: copiar dados do Azure Cosmos DB para o Blob do Azure
...
## Exemplo: copiar dados do Blob do Azure para o Azure Cosmos DB 
O exemplo a seguir mostra:
...
1. **Pergunta:**
   ...
   : não.
2. **Pergunta:**
    como uma nova tentativa de uma cópia para o Azure Cosmos DB lida com os registros já copiados?
...
3. **Pergunta:**
    o Data Factory oferece suporte a [intervalo ou particionamento de dados com base em hash](../documentdb/documentdb-partition-data.md)?

    **Resposta**
   : não.
4. **Pergunta:**
    posso especificar mais de uma coleção do Azure Cosmos DB para uma tabela?
