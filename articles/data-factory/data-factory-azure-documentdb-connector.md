...
Esse conector do DocumentDB dá suporte à cópia de dados bidirecional na coleção de partição única e coleção particionada do DocumentDB. [DocDB para MongoDB](../documentdb/documentdb-protocol-mongodb.md) não tem suporte.
...
1. Um serviço vinculado do tipo [Banco de Dados de Documentos](#linked-service-properties).
