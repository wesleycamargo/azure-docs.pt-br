...
## <a name="json-example-copy-data-from-ftp-server-to-azure-blob-storage"></a>Exemplo de JSON: copiar dados do servidor FTP para o Armazenamento de Blobs do Azure
