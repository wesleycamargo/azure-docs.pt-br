...
---
# <a name="tutorial-build-your-first-pipeline-to-process-data-using-hadoop-cluster"></a>Tutorial: Criar seu primeiro pipeline para processar dados usando cluster Hadoop
...
## <a name="whats-covered-in-this-tutorial"></a>O que é abordado neste tutorial?
...
### <a name="upload-files-to-azure-storage-for-the-tutorial"></a>Carregar arquivos no Armazenamento do Azure para seguir o tutorial
...
1. Carregue o HQL (arquivo de consulta do Hive) na pasta **script** do contêiner de blobs **adfgetstarted**.
2. Carregue o arquivo de entrada na pasta **inputdata** do contêiner de blobs **adfgetstarted**. 

#### <a name="create-hql-script-file"></a>Criar arquivo de script HQL
Inicie o **Bloco de Notas** e cole o script HQL a seguir. Esse script do Hive cria duas tabelas: **WebLogsRaw** e **WebLogsPartitioned**. Clique em **Arquivo** no menu e selecione **Salvar como**. Alterne para a pasta **C:\adfgettingstarted** no disco rígido. Selecione **Todos os Arquivos (*.*)** para o campo **Salvar como tipo**. Insira **partitionweblogs.hql** para o **Nome do arquivo**. Confirme se o campo **Codificação** na parte inferior da caixa de diálogo está definido como **ANSI**. Se não, defina como **ANSI**.  
...
No tempo de execução, a Atividade do Hive no pipeline do Data Factory passa valores para os parâmetros **inputtable** e **partitionedtable**, conforme mostrado no trecho de código abaixo:  
...
#### <a name="upload-input-file-and-hql-file-to-your-azure-blob-storage"></a>Carregar o arquivo de entrada e o arquivo HQL no Armazenamento de Blobs do Azure
...
2. Navegue até a pasta c:\adfgetstarted e execute o comando a seguir: 
    ...
    ```   
    Este comando carrega o arquivo **input.log** para a conta de armazenamento (contêiner **adfgetstarted** e pasta **inputdata**). Substitua **storageaccountname** pelo nome de sua conta de armazenamento e **storageaccesskey** pela chave de acesso de armazenamento.
