...
> [AZURE.NOTE] Este artigo não fornece uma visão geral conceitual do Azure Data Factory. Para obter uma visão geral conceitual do serviço, confira [Introdução ao Azure Data Factory](data-factory-introduction.md). Confira o [Roteiro de aprendizagem do Data Factory](https://azure.microsoft.com/documentation/learning-paths/data-factory/) para ver uma maneira recomendada de navegar pelo nosso conteúdo para saber mais sobre o Data Factory.
