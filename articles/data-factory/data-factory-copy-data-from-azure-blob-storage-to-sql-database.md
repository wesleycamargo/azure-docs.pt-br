...
3. Em seguida, na folha do **Banco de dados SQL**, clique em **Propriedades** em **CONFIGURAÇÕES**.
...
1. Clique no hub **Mais serviços** à esquerda e clique em **SQL servers**.
