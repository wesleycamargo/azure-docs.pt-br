...
Este artigo explica as atividades de transformação de dados no Azure Data Factory para que você saiba como o Azure Data Factory transforma e processa os dados brutos em previsões e ideias. A atividade de transformação é executada em um ambiente de cálculo, como um cluster do Azure HDInsight ou um Lote do Azure. Links para artigos que mostram como usar atividades de transformação específica são incluídas também.
