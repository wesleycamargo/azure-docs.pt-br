---
title: Transformação de classificação de fluxo de dados do Azure Data Factory
description: Transformação de junção de classificação de dados do Azure Data Factory
author: kromerm
ms.author: makromer
...
ms.locfileid: "56270912"
---
# <a name="azure-data-factory-data-sort-transformations"></a>Transformações de classificação de dados do Azure Data Factory
