...
| CatalogPricingTier | O tipo de preço do SSISDB hospedado por seu servidor existente de Banco de dados SQL do Azure.  Não se aplica à Instância Gerenciada de SQL do Azure que hospeda o SSISDB. |
