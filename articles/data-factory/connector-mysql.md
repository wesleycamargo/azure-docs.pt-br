...
- Instalar o [MySQL Connector/Net para o Microsoft Windows](https://dev.mysql.com/downloads/connector/net/) versão 6.6.5 ou superior no computador do Integration Runtime.
