...
A partir da semana de 6 de novembro de 2015, os seguintes recursos foram adicionados ao **Catálogo de Dados do Azure**:

- Suporte visualização para fontes de dados Teradata. Ao registrar as tabelas Teradata e exibições, os usuários podem optar por incluir registros de instantâneo com os metadados extraídos da fonte de dados.
...
- Suporte para consultas “tem” ao pesquisar **Catálogo de Dados do Azure**, para habilitar a descoberta de ativos de dados registrados que têm metadados específicos. A sintase de consulta do **Catálogo de Dados do Azure** inclui:
...
| tem: columnsDataProfiles | Localiza os ativos de dados com informações de perfil de dados de nível de coluna |
