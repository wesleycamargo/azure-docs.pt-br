...
A partir de semana de 28 de agosto de 2015, os seguintes recursos foram acrescentados ao **Catálogo de Dados do Azure**:
...
A partir de semana de 21 de agosto de 2015, os seguintes recursos foram acrescentados ao **Catálogo de Dados do Azure**:
...
- Adicionamos um novo botão "Usuário" e o menu à nossa barra de navegação superior. Esse menu permite que o usuário veja a conta usada para fazer logon no **Catálogo de Dados do Azure**, e para sair, se desejar. Esse menu também exibe o nome do catálogo, que é importante para os desenvolvedores que usam o API REST do **Catálogo de Dados do Azure**.
- Standard Edition somente: ao adicionar proprietários para ativos de dados, o **Catálogo de Dados do Azure** agora oferece suporte a contas de usuário e grupos de segurança como proprietários. Para adicionar um grupo de segurança como um proprietário de ativos de dados selecionados, você pode inserir o nome para exibição do grupo ou o endereço de email do UPN do grupo, se houver.
