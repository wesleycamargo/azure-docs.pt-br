...
- Adicionamos um novo botão "Usuário" e o menu à nossa barra de navegação superior. Este menu permite que o usuário veja a conta usada para fazer o logon no **Catálogo de Dados do Azure** e para sair, caso desejar. Esse menu também exibe o nome do catálogo, que é importante para os desenvolvedores que usam a API REST do **Catálogo de Dados do Azure**.
