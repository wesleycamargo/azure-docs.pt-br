...
## <a name="q-does-azure-data-catalog-work-with-this-other-data-source-im-interested-in"></a>P.: O Catálogo de Dados do Azure funciona com essa outra fonte de dados na qual estou interessado?
...
## <a name="q-my-question-isnt-answered-here--what-should-i-do"></a>P.: Minha dúvida não foi respondida aqui. O que devo fazer?
