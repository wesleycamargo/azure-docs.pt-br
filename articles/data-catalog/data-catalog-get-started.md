...
4.	De **SQL Server Management Studio**, na barra de ferramentas **Standard**, clique em **Nova Consulta**.
...
Nesse exercício, você instalou o banco de dados de amostra do Adventure Works que é usado nos exercícios restantes. No exercício, pode aprender como registrar fontes de dados do **Catálogo de Dados do Azure** de tabelas no banco de dados de amostra do Adventure Works.
...
7.	Você poderá registrar os metadados da fonte de dados na próxima página. Nesse exemplo, você deve registrar os objetos **Produção/Produto** do namespace de produção do AdventureWorks. Veja como fazê-lo:
    ...
    g. Para ver seus objetos de fonte de dados registrados, clique em **Exibir Portal**. No portal do **Catálogo de Dados do Azure**, é possível exibir objetos de fontes de dados em **Blocos** ou em uma **Lista**.
...
Neste exercício, você usou o portal do **Catálogo de Dados do Azure** para descobrir e exibir os ativos de dados do Adventure Works registrados no catálogo.
...
4. Insira uma **Descrição** que ajudará outros usuários a descobrirem e entenderem porque e como usar o ativo de dados selecionado. Digite, por exemplo: "Imagens do produto". Você também pode adicionar mais marcas e exibir colunas.
...
Neste exercício, você usará os recursos de gerenciamento do **Catálogo de Dados do Azure** para se apropriar de ativos de dados e para controlar quais usuários poderão descobrir e como podem gerenciar os ativos.
