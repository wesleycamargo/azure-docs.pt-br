...
- [Limites de visualização de lote](#batchlimits)
...
- [Limites do Active Directory](#adlimits)
...
<sup>3</sup>GRS significa [armazenamento geograficamente redundante][georedundantstorage]. LRS significa [armazenamento com redundância local][locallyredundantstorage]. Observe que o GRS também possui redundância local.

##<a name="batchlimits"></a>Limites de visualização de lote
...
##<a name="adlimits"></a>Limites do Active Directory
