<properties urlDisplayName="Download for Mac" pageTitle="Baixar o SDK do Azure para Java (Mac)" metaKeywords="Azure SDK Java, Azure Java Maven, Azure Maven, Azure plugin for Eclipse, Azure Eclipse Java" description="Baixe o SDK do Azure para Java. Código será fornecido se você está pronto para usar o Maven para compilação." metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="" documentationCenter="Java" title="Download the Azure SDK for Java" authors="robmcm" solutions="" manager="wpickett" editor="mollybos" scriptId="" videoId="" />
