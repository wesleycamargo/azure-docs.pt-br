<properties 
	pageTitle="Detecção proativa no Application Insights | Microsoft Azure" 
...
* **Você recebe um email** do Application Insights. Aqui está um exemplo típico:
    ...
    ![Alerta de email](./media/app-insights-proactive-detection/03.png)
...
![Exibir detecções recentes](./media/app-insights-proactive-detection/04.png)
