...
1. No Visual Studio, edite os pacotes NuGet de seu projeto de aplicativo Web.
    ...
    ![Clique com o botão direito no projeto e selecione Gerenciar Pacotes Nuget](./media/app-insights-asp-net-manual/03-nuget.png)
...
![Usar o Visual Studio para publicar seu aplicativo](./media/app-insights-asp-net-manual/15-publish.png)
...
## Adicionar acompanhamento de dependência (e contadores de desempenho de IIS)
...
![Em seu aplicativo Web, Configurações, Extensões, Adicionar, Application Insights](./media/app-insights-asp-net-manual/05-extend.png)
...
![Em seu aplicativo Web, abra Início Rápido e clique em 'Obter código para monitorar as minhas páginas da web'](./media/app-insights-asp-net-manual/02-monitor-web-page.png)
...
![Escolher Adicionar Application Insights](./media/app-insights-asp-net-manual/appinsights-03-addExisting.png)
...
![Clique com o botão direito do mouse no seu projeto e abra o portal do Azure.](./media/app-insights-asp-net-manual/appinsights-04-openPortal.png)
