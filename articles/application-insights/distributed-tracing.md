...
Para adicionar recursos de rastreamento distribuído a um aplicativo com OpenCensus, primeiro [instale e configure o Encaminhador Local do Application Insights](./opencensus-local-forwarder.md). A partir daí, configure o OpenCensus para rotear os dados de rastreamento distribuído pelo Encaminhador Local. Há suporte para [Python](./opencensus-python.md) e [Go](./opencensus-go.md).
