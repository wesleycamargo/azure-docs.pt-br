...
Se ainda não tiver feito isso, adicione o [Application Insights ao seu projeto de aplicativo][platforms] e republique-o.
...
![No gráfico de falhas, clique em Regras de Alerta e, em seguida, em Adicionar Alerta](./media/app-insights-crashes/appinsights-d023-alert.png)
