...
O [Stream Analytics](https://azure.microsoft.com/services/stream-analytics/) é um serviço do Azure que funciona como um adaptador, processando continuamente os dados exportados do Application Insights.
