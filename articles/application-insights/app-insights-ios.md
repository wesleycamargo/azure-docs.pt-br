<properties
    pageTitle="Application Insights para aplicativos do iOS | Microsoft Azure"
...
4. Adicione esse script de execução às suas fases de compilação: [Adicionar Fase de Script de Execução](http://hockeyapp.net/help/runscriptbuildphase/).
...
Quando `[MSAIApplicationInsights start]` é chamado, o SDK começa a acompanhar sessões, exibições de página e qualquer exceção sem tratamento ou falha.
