...
ms.locfileid: "46963638"
---
# <a name="collect-distributed-traces-from-python-preview"></a>Coletar rastreamentos distribuídos do Python (Versão Prévia)

Agora o Application Insights dá suporte ao rastreamento distribuído de aplicativos Python por meio da integração com o [OpenCensus](https://opencensus.io) e nosso novo [encaminhador local](./opencensus-local-forwarder.md). Este artigo orientará você passo a passo durante o processo de configuração do OpenCensus para Python e obtenção dos dados de rastreamento para o Application Insights.
