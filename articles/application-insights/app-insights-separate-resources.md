...
* Vários componentes ou funções de um aplicativo de negócios – use um [único recurso compartilhado](app-insights-app-map.md) para todos os aplicativos componentes. A telemetria pode ser filtrada ou segmentada pela propriedade cloud_RoleName.
...
Se usar o Azure DevOps, você poderá [obter um marcador de anotação](app-insights-annotations.md) adicionado a seus gráficos sempre que lançar uma nova versão. A imagem a seguir mostra como esse marcador é exibido.

![Captura de tela de anotação de versão de exemplo em um gráfico](media/app-insights-separate-resources/release-annotation.png)
