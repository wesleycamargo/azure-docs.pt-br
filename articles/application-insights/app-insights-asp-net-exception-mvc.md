...
![Selecione as Falhas](./media/app-insights-asp-net-exception-mvc/012-start.png)
...
![Selecione uma instância de uma solicitação com falha e, em detalhes da exceção, obtenha a instâncias da exceção.](./media/app-insights-asp-net-exception-mvc/030-req-drill.png)
