---
title: Criar recursos, alertas e testes de disponibilidade do Azure Application Insights no PowerShell | Microsoft Docs
description: Automatize o gerenciamento de recursos do Application Insights usando um modelo do Azure Resource Manager.
...
## <a name="enterprise-price-plan"></a>Plano de preço Enterprise
...
* Se você quiser usar o plano de preço Básico, você poderá omitir o recurso de plano de preço do modelo.


## <a name="to-get-the-instrumentation-key"></a>Para obter a chave de instrumentação
Depois de criar um recurso de aplicativo, você desejará o iKey: 
