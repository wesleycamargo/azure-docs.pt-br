<properties 
	pageTitle="Uso de rastreamento e eventos em seu aplicativo web com a API do Application Insights" 
	description="Insira algumas linhas de código para controlar o uso e diagnosticar problemas." 
