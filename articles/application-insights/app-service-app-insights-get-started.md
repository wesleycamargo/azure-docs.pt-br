...
![A instrumentação do Application Insights em seu aplicativo envia telemetria ao recurso do Application Insights no portal do Azure.](./media/app-service-app-insights-get-started/01-scheme.png)
...
> [AZURE.NOTE]  Você deve estar querendo apenas prosseguir e experimentar. Mas se quiser ver o que o Application Insights pode fazer, continue lendo...
...
![A folha de visão geral](./media/app-service-app-insights-get-started/01-find.png)
...
![Folha de servidores](./media/app-service-app-insights-get-started/04.png)
...
![editar o gráfico](./media/app-service-app-insights-get-started/05.png)
...
![Pesquisar instâncias](./media/app-service-app-insights-get-started/06.png)

Use filtros para se concentrar em tipos específicos de eventos e nos valores de propriedade escolhidos:

![Filtrar pelas propriedades](./media/app-service-app-insights-get-started/07.png)
...
![Itens relacionados e detalhes de propriedade](./media/app-service-app-insights-get-started/08.png)
...
![Criar um item de trabalho](./media/app-service-app-insights-get-started/09.png)
...
![Análise](./media/app-service-app-insights-get-started/10.png)
...
![Análise](./media/app-service-app-insights-get-started/11.png)
...
![Painéis](./media/app-service-app-insights-get-started/12.png)
...
[![Introdução animada](./media/app-service-app-insights-get-started/video-front-1.png)](https://www.youtube.com/watch?v=fX2NtGrh-Y0)
