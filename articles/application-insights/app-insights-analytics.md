...
* [Filtre](app-insights-analytics-queries.md) a telemetria bruta do aplicativo por qualquer campo, incluindo suas métricas e propriedades personalizadas.
* [Una](app-insights-analytics-queries.md#join-operator) várias tabelas – correlacione solicitações com exibições de página, chamadas de dependência, exceções e rastreamentos de log.
* [Agregações](app-insights-analytics-aggregations.md) estatísticas avançadas.
