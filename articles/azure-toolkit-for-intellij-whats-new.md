...
## Lançamentos do Kit de Ferramentas do Azure para IntelliJ
...
* **Integração de Ferramentas HDInsight**. As Ferramentas de HDInsight do Azure agora estão incluídas no Kit de Ferramentas do Azure para IntelliJ.
