...
* Outras tarefas de execução longa que você deseja executar em um thread em segundo plano, como [enviar emails](https://github.com/victorhurdugaci/AzureWebJobsSamples/tree/master/SendEmailOnFailure). 
...
* Para obter mais informações, consulte [Como chamar manualmente uma função](../websites-dotnet-webjobs-sdk-storage-queues-how-to/#manual) e [Como escrever logs](../websites-dotnet-webjobs-sdk-storage-queues-how-to/#logs) 
