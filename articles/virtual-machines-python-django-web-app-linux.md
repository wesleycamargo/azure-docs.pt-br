...
**Observação:** Se você precisar instalar o Python ou quiser usar as bibliotecas de cliente, consulte o [Guia de instalação do Python][Guia de instalação do Python].
...
2.  Digite o seguinte comando para conectar-se à sua MV do Azure.
