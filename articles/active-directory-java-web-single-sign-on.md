<properties linkid="develop-java-how-to-guides-web-sso" urlDisplayName="SSO da Web" pageTitle="Logon único com o Active Directory do Azure (Java)" metaKeywords="Aplicativo da web Java do Azure, logon único do Azure, Active Directory Java do Azure" description="Saiba como criar um aplicativo da web Java que usa logon único com o Active Directory do Azure." metaCanonical="" services="active-directory" documentationCenter="Java" title="Logon único da web com Java e o Active Directory do Azure" authors="" solutions="" manager="" editor="" />
...
* [Código de exemplo de Java para o Active Directory do Azure]
* [Java Runtime Environment 1.6]
* [JBoss Application Server versão 7.1.1.Final]
* [IDE do JBoss Developer Studio]
...
<h2><a name="createapp"></a>Etapa 1: Criar um aplicativo Java</h2>
...
3. Na caixa de diálogo **Novo Projeto**, expanda a pasta **Maven**, clique em **Projeto Maven** e, em seguida, clique em **Avançar**.
...
10. Clique com o botão direito do mouse no projeto **exemplo**, clique em **Novo** e, em seguida, clique em **Arquivo JSP**. 

11. Na caixa de diálogo **Novo Arquivo JSP**, altere o caminho para o novo arquivo para *sample/src/main/webapp*. Em seguida, nomeie o arquivo **index.jsp** e clique em **Concluir**.

12. O novo arquivo **index.jsp** será aberto automaticamente. Substitua o código gerado automaticamente pelo seguinte e salve o arquivo.
...
13. Clique com botão direito do mouse no projeto **exemplo** e clique em **Executar como**, em seguida, clique em **Executar no Servidor**.

14. Na caixa de diálogo **Executar no Servidor**, verifique se **JBoss Enterprise Application Platform 6. x** está selecionado e clique em **Concluído**.
...
Essa etapa retornará informações semelhantes às seguintes:
		...
		Usage                 : Verify 
	> [WACOM.NOTE]
    > Você deve salvar essa saída, principalmente a chave simétrica gerada. Essa chave só é revelada para você durante a criação da Entidade de Serviço, e você não pode recuperá-la no futuro. Os outros valores são necessários para usar a Graph API para ler e gravar informações no diretório.

6. A etapa final define a URL de resposta para seu aplicativo. A URL de resposta é para onde as respostas são enviadas após tentativas de autenticação. Digite os comandos a seguir e pressione enter:
...
2. Na caixa de diálogo **Importar**, expanda a pasta **Maven**, clique em **Projetos Maven Existentes** e, em seguida, clique em **Avançar**.
...
5. No arquivo **pom.xml**, adicione o seguinte XML na seção *&lt;project&gt;* e salve o arquivo:
...
6. Clique com botão direito do mouse no projeto **exemplo**, clique em **Maven** e, em seguida, clique em **Atualizar Projeto**. Na caixa de diálogo **Atualizar Projeto Maven**, clique em **OK**. Essa etapa irá atualizar seu projeto com as alterações em **pom.xml**.

7. Clique com o botão direito do mouse no projeto **exemplo**, clique em **Novo** e, em seguida, clique em **Filtrar**.

8. Na caixa de diálogo **Criar Filtro**, digite *FederationFilter* na entrada **Nome da classe** e clique em **Concluir**.
...
10. No **Explorador de Projeto**, expanda o **src**, em seguida, **principal** e, em seguida, pastas **webapp**. Clique com o botão direito do mouse no arquivo **web.xml**, clique em **Abrir com** e clique no **Editor de Texto**.

11. No arquivo **web.xml**, você irá adicionar um filtro para manipular páginas seguras e não seguras, e ele também irá redirecionar usuários não autenticados para a página de logon (especificada como o filtro **login-page-url**). No entanto, se uma URL corresponder à regex especificada no parâmetro do filtro **allowed-regex**, ela não será filtrada. Adicione o seguinte XML na seção *&lt;web-app&gt;* e, em seguida, salve o arquivo **web.xml**.  
...
14. O novo arquivo **login.jsp** será aberto automaticamente. Substitua o código gerado automaticamente pelo seguinte e salve o arquivo.
...
17. Na caixa de diálogo **Novas Propriedades de Arquivo**, nomeie o arquivo **federação** e, em seguida, clique em **Concluir**.
...
24. No arquivo **web.xml**, substitua a configuração **/FederationServlet** na seção *&lt;url-pattern&gt;* por **/ws-saml**. Por exemplo:
...
25. No **Explorador de Projeto**, expanda a pasta **src/main/webapp**. Clique com o botão direito do mouse no arquivo **index.jsp**, clique em **Abrir com** e clique no **Editor de Texto**.
...
[Resumo]: #summary
[Desenvolvendo aplicativos em nuvem de vários locatários com o Active Directory do Azure]: http://g.microsoftonline.com/0AX00en/121
