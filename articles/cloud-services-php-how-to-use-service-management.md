...
Nos exemplos de código que seguem, os locais são passados para métodos como cadeias de caracteres. No entanto, você também pode passar locais como enumerações usando a classe <code>WindowsAzure\\ServiceManagement\\Models\\Locations</code>. Por exemplo, em vez de passar "Oeste dos EUA" para um método que aceita um local, você pode passar <code>Locations::WEST\_US</code>.
