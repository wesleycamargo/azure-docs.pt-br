...
# Entendendo os relatórios de pagamento do Azure Marketplace

## Acessando o relatório de pagamento
...
Alguns dos seus relatórios de pagamento estarão disponíveis em https://publish.windowsazure.com. Os relatórios estarão disponíveis 45 dias após o encerramento do trimestre e serão calculados após quaisquer reembolsos.
  ...
  1. Navegue até a publicação do Portal de Publicação em https://publish.windowsazure.com
...
## Lendo o relatório de pagamento

O relatório de pagamento para cada trimestre registra todas as transações que ocorrem dentro desse trimestre.

- Se você estiver procurando por entradas do razão relacionadas a um trimestre específico, selecione o relatório de pagamento por trimestre no menu suspenso; Por exemplo, se você estiver interessado em entradas da razão para abril a 15 de junho, selecione abril a 15 de Jun no menu suspenso;
- Se você estiver procurando por detalhes de pagamentos relacionados a um trimestre específico, selecione o relatório de pagamento para o trimestre subsequente; Por exemplo, se você estiver interessado nos pagamentos de abril a 15 de junho, essas quantidades aparecerão no relatório de pagamento de julho a 15 de setembro.
...
## Próximas etapas: outras etapas de suporte
