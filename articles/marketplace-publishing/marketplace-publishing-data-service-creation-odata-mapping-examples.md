...
## <a name="example-functionimport-using-delete"></a>Exemplo: FunctionImport usando "EXCLUIR"
...
## <a name="example-functionimport-using-post"></a>Exemplo: FunctionImport usando "POST"
...
## <a name="example-functionimport-using-put"></a>Exemplo: FunctionImport usando "PUT"
...
## <a name="example-functionimport-for-raw-data-returned-using-get"></a>Exemplo: FunctionImport para dados “Brutos” retornados usando "GET"
...
## <a name="example-functionimport-for-paging-through-returned-data"></a>Exemplo: FunctionImport para "Paginação" através de dados retornados
Use implementar paginação RESTful atraves de seus dados com GET.  Paginação padrão é definida como 100 linhas por página de dados.
