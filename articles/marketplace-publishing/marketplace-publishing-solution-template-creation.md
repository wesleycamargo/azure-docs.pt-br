...
* Extensões de VM: [Visão geral sobre Agente de VM](https://msdn.microsoft.com/library/azure/dn832621.aspx) e [Extensões de VM e Extensões de VM e recursos do Azure](https://docs.microsoft.com/azure/virtual-machines/extensions/features-windows)
