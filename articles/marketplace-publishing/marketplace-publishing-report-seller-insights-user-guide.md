...
5. Para o Portal do Seller Insights, ao selecionar **Conta corporativa ou de estudante**, verifique se você está usando a combinação de conta organizacional/senha e não uma combinação de LiveID/senha.
