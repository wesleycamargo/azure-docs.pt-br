...
Neste ponto, o site do Tomcat deve ser visível de um navegador externo usando uma URL no formato **http://*your_DNS_name*.cloudapp.net**, em que ***your_DNS_name*** é o nome DNS que você especificou ao criar a máquina virtual.
