...
1. Use o [procedimento para fazer logon em uma máquina virtual com uma conexão de Área de Trabalho Remota](virtual-machines-windows-ps-sp-intranet-ph2.md#logon) para efetuar logon usando as credenciais da conta de administrador local.

2. Use o [procedimento para inicializar um disco vazio](virtual-machines-windows-ps-sp-intranet-ph2.md#datadisk) duas vezes, uma vez para cada SQL Server, para adicionar o disco de dados adicional.
...
Use o [procedimento para fazer logon em uma máquina virtual com uma conexão de Área de Trabalho Remota](virtual-machines-windows-ps-sp-intranet-ph2.md#logon) para que o nó principal do cluster efetue logon usando as credenciais de uma conta do domínio.

No nó principal do cluster, use o [procedimento para testar a conectividade](virtual-machines-windows-ps-sp-intranet-ph2.md#testconn) para testar a conectividade para os locais na rede da sua organização.
