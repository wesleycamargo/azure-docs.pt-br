...
> ![Escolha a imagem Ubuntu do Docker na faixa](./media/virtual-machines-linux-classic-docker-quickstart/CreateNewDockerBanner.png)

2. Se não, pesquise-a na Galeria de Imagens:

> ![Localize a imagem na Galeria de Imagens](./media/virtual-machines-linux-classic-docker-quickstart/DockerOnUbuntuServerMSOpenTech.png)
...
> ![Configure a instância da VM](./media/virtual-machines-linux-classic-docker-quickstart/CreateVMDockerUbuntuPwd.png)

4. E aguarde até que ela esteja sendo executada. Isso não deve demorar.

> ![A imagem do docker em execução no portal](./media/virtual-machines-linux-classic-docker-quickstart/DockerUbuntuRunning.png)
...
> ![Conectando com o SSH](./media/virtual-machines-linux-classic-docker-quickstart/SSHToDockerUbuntu.png)

e começar a usar comandos do Docker, lembrando que, nesta VM do Azure, a configuração padrão requer **`sudo`**:

> ![Extraindo imagens](./media/virtual-machines-linux-classic-docker-quickstart/DockerPullSmallImages.png)
