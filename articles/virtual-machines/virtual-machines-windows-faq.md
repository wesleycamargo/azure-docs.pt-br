...
Este artigo trata de algumas das perguntas mais comuns feitas pelos usuários sobre as máquinas virtuais do Windows criadas no Azure com o modelo de implantação do Resource Manager. Para a versão deste tópico para o Linux, veja [Perguntas frequentes sobre Máquinas Virtuais Linux](virtual-machines-linux-faq.md)
...
Se você tiver um aplicativo que precise usar a letra de unidade D:, poderá reatribuir as letras de unidade para que o disco temporário use algo diferente de D:. Para obter instruções, veja [Alterar a letra da unidade do disco temporário do Windows](virtual-machines-windows-classic-change-drive-letter.md).
