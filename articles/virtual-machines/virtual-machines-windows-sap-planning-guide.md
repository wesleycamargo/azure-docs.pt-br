---
title: SAP NetWeaver em VMs (máquinas virtuais) do Windows — guia de planejamento e implementação | Microsoft Docs
...
* Definir a assinatura de seu contexto com *Set-AzureRmContext* e o parâmetro SubscriptionId ou SubscriptionName – consulte <https://msdn.microsoft.com/library/mt619263.aspx>
* Carregue o VHD com *Add-AzureRmVhd* para uma Conta de Armazenamento do Azure – consulte <https://msdn.microsoft.com/library/mt603554.aspx>
* Definir o disco do SO de uma nova configuração da VM para o VHD com *Set-AzureRmVMOSDisk* – consulte <https://msdn.microsoft.com/library/mt603746.aspx>
* Criar uma nova VM com base na configuração da VM com *New-AzureRmVM* – consulte <https://msdn.microsoft.com/library/mt603754.aspx>
* Adicionar um disco de dados a uma nova VM com *Add-AzureRmVMDataDisk* – consulte <https://msdn.microsoft.com/library/mt603673.aspx>
...
* Carregar o VHD com o *upload do Azure Storage Blob* – consulte [Usando a CLI do Azure com o Armazenamento do Azure][storage-azure-cli]
...
* Definir a assinatura de seu contexto com *Set-AzureRmContext* e o parâmetro SubscriptionId ou SubscriptionName – consulte <https://msdn.microsoft.com/library/mt619263.aspx>
* Carregue o VHD com *Add-AzureRmVhd* para uma Conta de Armazenamento do Azure – consulte <https://msdn.microsoft.com/library/mt603554.aspx>
* Definir o disco do SO de uma nova configuração da VM para o VHD com *Set-AzureRmVMOSDisk -SourceImageUri -CreateOption fromImage* – consulte <https://msdn.microsoft.com/library/mt603746.aspx>
* Criar uma nova VM com base na configuração da VM com *New-AzureRmVM* – consulte <https://msdn.microsoft.com/library/mt603754.aspx>
