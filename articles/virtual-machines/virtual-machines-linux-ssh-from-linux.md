...
Leia as sugestões em [Solucionando problemas de conexões SSH](virtual-machines-linux-troubleshoot-ssh-connection.md) para ver se elas podem ajudar a resolver a situação.
