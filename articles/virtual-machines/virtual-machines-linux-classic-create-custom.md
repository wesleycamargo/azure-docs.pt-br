---
title: Criar uma VM do Linux | Microsoft Docs
...
Este tópico descreve como criar uma VM (máquina virtual) personalizada com a CLI do Azure usando o modelo de implantação clássico. Vamos usar uma imagem do Linux das **IMAGENS** disponíveis no Azure. Os comandos da CLI do Azure oferecem as seguintes opções de configuração, entre outras:
