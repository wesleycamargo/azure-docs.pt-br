...
Para ver configurações de exemplo para extensões do Windows, veja [exemplos de extensões do Windows](virtual-machines-windows-extensions-configuration-samples.md).
