...
> [AZURE.IMPORTANT] Essas métricas conduzem os gráficos de monitoramento e alertas no portal do Azure.  O nó **Métricas** com *resourceID* e **MetricAggregation** deve ser incluído na configuração de diagnóstico de sua VM se você quiser ver os dados de monitoramento da VM no portal do Azure. 
...
- Implante o modelo do gerenciador de recursos usando o [Azure PowerShell](virtual-machines-windows-ps-manage.md) ou a [Linha de Comando do Azure](virtual-machines-linux-cli-deploy-templates.md)
