...
## <a name="export-the-vhd-from-aws"></a>Exportar o VHD do AWS
...
Você precisa fazer logon no Azure, criar uma conta de armazenamento e carregar o VHD para a conta de armazenamento antes de poder criar a imagem. 
...
Se estiver usando o VHD para criar um disco gerenciado para uma VM, o local da conta de armazenamento deverá ser o mesmo local em que você criará a VM.
...
-   [Referência de API REST do Serviço de Importação/Exportação do Armazenamento](https://msdn.microsoft.com/library/dn529096.aspx)
    ...
    A Importação/Exportação pode ser usada para copiar para a conta de armazenamento standard. Para usar o Armazenamento Premium, você precisa copiar do armazenamento Standard para uma a conta de armazenamento Premium usando uma ferramenta como o AzCopy.
...
## <a name="create-vm-from-image"></a>Criar uma VM com base em uma imagem
...
### <a name="create-a-public-ip-and-nic"></a>Criar um IP público e uma NIC
...
### <a name="create-network-variables"></a>Criar variáveis de rede
...
### <a name="get-the-credentials"></a>Obter as credenciais 

O cmdlet a seguir abre uma janela na qual você insere um novo nome de usuário e senha para usar como a conta de administrador local para acessar remotamente a VM. 

```powershell
$cred = Get-Credential
```

### <a name="set-vm-variables"></a>Definir variáveis da VM 
...
### <a name="set-the-vm-image"></a>Definir a imagem da VM 
...
### <a name="set-the-os-configuration"></a>Selecionar a configuração do sistema operacional 
