---
title: Solucionar problemas de erros de exclusão de recursos de armazenamento em uma implantação do Azure Resource Manager em VMs do Windows | Microsoft Docs
...
Em determinados cenários, você pode encontrar um dos seguintes erros que ocorrem quando você está tentando excluir uma conta de armazenamento, contêiner ou blob do Azure em uma implantação do Azure Resource Manager:
...
Repetição da exclusão de conta de armazenamento, contêiner ou blob após a conclusão dessas etapas.
