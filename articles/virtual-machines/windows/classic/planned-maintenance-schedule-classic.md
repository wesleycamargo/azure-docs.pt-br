...
ms.locfileid: "30913096"
---
# <a name="how-to-schedule-planned-maintenance-on-azure-vms"></a>Como agendar a manutenção planejada em VMs do Azure
> [!IMPORTANT]
> O Azure tem dois modelos de implantação diferentes para criar e trabalhar com recursos: [Gerenciador de Recursos e Clássico](../../../resource-manager-deployment-model.md). Este artigo aborda o uso do modelo de implantação Clássica. A Microsoft recomenda que a maioria das implantações novas use o modelo do Gerenciador de Recursos. Para obter informações sobre a manutenção planejada no modelo do Resource Manager, consulte [aqui](../planned-maintenance.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
