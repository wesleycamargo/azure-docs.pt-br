...
Veja [Como anexar um disco de dados a uma máquina virtual do Windows](../attach-disk-portal.md) e siga as instruções para anexar um disco vazio. Defina a configuração de cache de host como **Nenhum** ou **Somente leitura**.
