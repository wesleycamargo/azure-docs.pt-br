...
Se você ainda não tiver uma VM que executa o Windows Server 2012 R2, você pode usar este [tutorial](tutorial.md) para criar a máquina virtual. 
...
Veja [Como anexar um disco de dados a uma máquina virtual do Windows](attach-disk.md) e siga as instruções para anexar um disco vazio. Defina a configuração de cache de host como **Nenhum** ou **Somente leitura**.
