...
# Introdução
## [Criar uma VM usando o Portal do Azure](tutorial-classic.md)
## [Fazer logon em uma VM](connect-logon-classic.md)
...
### [Conectar VMs com uma VNet ou Serviço de Nuvem](connect-vms-classic.md)
...
### [Redimensionar uma VM do Windows criada no modelo de implantação clássico](resize-vm-classic.md)
