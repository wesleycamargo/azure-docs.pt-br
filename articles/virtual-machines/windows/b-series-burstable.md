---
title: "Tamanhos da série B de VM Windows do Azure | Microsoft Docs"
...
# <a name="b-series-burstable-virtual-machine-sizes-preview"></a>Tamanhos expansíveis da série B de máquina virtual (versão prévia)
