...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - Opt memória + armazenamento Premium (isolado)
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa de Base do Tam. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - com otimização de memória (isolada)
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa de Base do Tam. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - habilitado para GPU
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa de Base do Tam. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="ncsv2---gpu-enabled"></a>NCSv2 - habilitado para GPU
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa de Base do Tam. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
...
## <a name="nc---gpu-enabled"></a>NC - habilitado para GPU
| Tamanho | vCPUs | Nós NUMA | CPU | Execuções | Taxa de Base do Tam. | StdDev | 
| ---- | ----: | ---------: | --- | ---: | ------------: | -----: | 
