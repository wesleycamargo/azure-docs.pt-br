...
description: Neste tutorial, você aprenderá como criar um pipeline do Visual Studio Team Services para integração e entrega contínuas que implanta um aplicativo Web do IIS em uma VM do Windows no Azure.
