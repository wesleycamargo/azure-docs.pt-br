...
Para obter mais informações sobre como escolher entre esses métodos de programação, confira [Aplicativos Web, Serviços de Nuvem e VMs do Azure: quando usar qual?](../../../app-service/overview-compare.md).
