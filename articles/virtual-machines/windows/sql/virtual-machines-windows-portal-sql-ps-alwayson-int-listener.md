---
title: "Configurar Ouvintes de Grupos de Disponibilidade AlwaysOn – Microsoft Azure"
...
## <a name="a-nameadd-ipa-example-script-add-an-ip-address-to-an-existing-load-balancer-with-powershell"></a><a name="Add-IP"></a> Script de exemplo: adicionar um endereço IP a um balanceador de carga existente com o PowerShell
