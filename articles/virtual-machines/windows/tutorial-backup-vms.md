...
5. No computador local, abra uma nova guia e acesse o [portal do Azure](https://portal.azure.com).
...
12. No computador local, abra o **Explorador de Arquivos** e navegue até a pasta **Downloads** e copie o arquivo .exe baixado. O nome do arquivo é prefixado com o nome da VM. 
13. Na sua VM (sobre a conexão RDP), cole o arquivo .exe na Área de Trabalho da VM. 
14. Navegue até a área de trabalho da sua VM e clique duas vezes no .exe. Isso inicia um prompt de comando e, em seguida, monta o ponto de recuperação como um compartilhamento de arquivos que você pode acessar. Quando a criação do compartilhamento for concluída, digite **p** para fechar o prompt de comando.
