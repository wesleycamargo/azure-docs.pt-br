---
title: Solução de problemas de falhas de alocação de VM do Windows no Azure em modelo de implantação clássica | Microsoft Docs
description: Solucionar problemas de falhas de alocação ao criar, reiniciar ou redimensionar uma VM clássica do Windows no Azure
