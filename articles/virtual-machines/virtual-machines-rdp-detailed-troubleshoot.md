...
> [AZURE.IMPORTANT]Para eliminar os erros mais comuns da Área de Trabalho Remota, leia [a solução de problemas básica para a Área de Trabalho Remota](virtual-machines-troubleshoot-remote-desktop-connections.md) antes de continuar.
...
Em algumas ocasiões, talvez você veja esta mensagem de erro na janela de mensagem de Conexão de Área de Trabalho Remota: _A Área de Trabalho Remota não pode se conectar ao computador remoto por um destes motivos..._
...
Para saber mais, consulte [O que é um NSG (Grupo de Segurança de Rede)?](../virtual-network/virtual-networks-nsg.md).
