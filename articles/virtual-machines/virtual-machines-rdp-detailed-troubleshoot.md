...
- Execute as [etapas de correção rápida para erros comuns de RDP no guia básico de solução de problemas](virtual-machines-troubleshoot-remote-desktop-connections.md#quickfixrdp)
...
Use o [pacote de diagnóstico do Azure IaaS (Windows)](https://home.diagnostics.support.microsoft.com/SelfHelp?knowledgebaseArticleFilter=2976864) para ver se a falha ocorreu devido à própria máquina virtual do Azure. Se você não conseguir resolver o problema de **conectividade RDP a uma VM do Azure (Reinicialização Necessária)** com este pacote de diagnóstico, siga as instruções [neste artigo](virtual-machines-windows-reset-password.md) para redefinir o serviço de Área de Trabalho Remota na máquina virtual. Isso vai:
