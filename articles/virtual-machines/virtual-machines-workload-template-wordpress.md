<properties
	...
	description="Implante facilmente um único servidor WordPress executando o Ubuntu usando um modelo do Gerenciador de recursos e o portal de visualização do Azure, Azure PowerShell, ou a CLI do Azure."
