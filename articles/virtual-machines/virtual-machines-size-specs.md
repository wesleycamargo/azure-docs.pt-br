...
Observação: para obter informações e ver considerações sobre o uso desses tamanhos, confira [Sobre as instâncias A8, A9, A10 e A11 com uso intensivo de computação](virtual-machines-a8-a9-a10-a11-specs.md).

|Tamanho |Núcleos de CPU|Memória|NICs (Máx.)|Tamanho máximo do disco|Máx. de discos de dados (1023 GB cada)|Máx. IOPS (500 por disco)|
|---|---|---|---|---|---|---|
|Standard\_A8|8|56 GB|2| Temporário = 382 GB |16|16 x 500|
|Standard\_A9|16|112 GB|4| Temporário = 382 GB |16|16 x 500|
|Standard\_A10|8|56 GB|2| Temporário = 382 GB |16|16 x 500|
|Standard\_A11|16|112 GB|4| Temporário = 382 GB |16|16 x 500|
