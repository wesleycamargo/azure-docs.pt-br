...
Conclua esta fase antes de passar para a [Fase 4](virtual-machines-windows-ps-lob-ph4.md). Consulte [Implantar um aplicativo de linha de negócios de alta disponibilidade no Azure](virtual-machines-windows-lob-overview.md) para todas as fases.
...
9.	Em **Nome de logon**, digite *domínio*\\sqladmin (em que *domínio* é o nome do domínio no qual a conta sqladmin foi criada na [Fase 2](virtual-machines-windows-ps-lob-ph2.md)). 
...
1.	Faça logon na máquina virtual primária do SQL Server com a conta sqladmin criada na [Fase 2](virtual-machines-windows-ps-lob-ph2.md).
