...
[VMSS (Conjuntos de Escala de Máquina Virtual)](../virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md) podem ser usado com o manipulador de extensão [DSC (Configuração de Estado Desejado) do Azure](virtual-machines-windows-extensions-dsc-overview.md). VMSS fornece uma maneira de implantar e gerenciar uma grande quantidade de máquinas virtuais, e pode ser dimensionado de forma elástica em resposta ao carregamento. O DSC é usado para configurar as VMs quando elas ficam online, para que executem o software de produção.
...
Saiba como a [extensão DSC manipula com segurança as credenciais](virtual-machines-windows-extensions-dsc-credentials.md).
