<properties
   ...
   description="Saiba como criar uma identidade corporativo ou de estudante no Active Directory do Azure para usá-la com os modelos do Gerenciador de Recursos e de implantação clássicos."
...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-include.md)]Este artigo aborda como criar uma identidade do AAD que será necessária para o modelo de implantação do Gerenciador de Recursos e o modelo de implantação clássico.
