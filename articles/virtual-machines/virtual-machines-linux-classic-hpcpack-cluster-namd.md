...
5. Clique em **Editar Tarefas** na navegação esquerda e clique em **Adicionar** para adicionar uma tarefa ao trabalho.


6. Na página **Detalhes da Tarefa e Redirecionamento de E/S**, defina os valores a seguir.
