...
> [AZURE.NOTE] Consulte o arquivo [LEIA-ME](https://github.com/Azure/WALinuxAgent/blob/master/README.md) do agente Linux do Azure para obter mais detalhes.
...
> [AZURE.NOTE] Essa lista pode ser diferente da lista oficial de sistemas com suporte na plataforma Microsoft Azure, conforme descrito aqui: [http://support.microsoft.com/kb/2805216](http://support.microsoft.com/kb/2805216)
...
> [AZURE.WARNING] O desprovisionamento não garante que a imagem estará livre de todas as informações confidenciais e adequada para redistribuição.
...
> [AZURE.NOTE] O parâmetro `Provisioning.Enabled` segue o padrão "n" do Ubuntu Cloud Images, que usa cloud-init para provisionamento.
