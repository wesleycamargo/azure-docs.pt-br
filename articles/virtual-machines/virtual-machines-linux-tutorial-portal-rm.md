...
4. Em seguida, clique em ![botão criar](media/virtual-machines-linux-tutorial-portal-rm/createbutton.png).
	...
	![alterar para a pilha de computação do gerenciador de recursos](media/virtual-machines-linux-tutorial-portal-rm/changetoresourcestack.png)
