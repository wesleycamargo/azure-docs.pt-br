...
Saiba como [executar estas etapas usando o modelo do Resource Manager](virtual-machines-linux-capture-image.md).
...
O Azure armazena a imagem em **Imagens**, juntamente com quaisquer imagens carregadas. Para saber mais sobre imagens, confira [Sobre imagens da máquina virtual no Azure][Sobre imagens da máquina virtual no Azure].
