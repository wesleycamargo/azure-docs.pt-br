<properties
	...
	description="Descreve o Docker e contêineres, as extensões de Máquinas virtuais do Azure, além de indicar mais recursos para criar contêineres Docker por meio da CLI do Azure e do portal do Azure."
