...
Chef é um sistema cliente/servidor. Para conhecer suas opções de uso de um servidor do Chef, consulte [Escolher a instalação](http://www.getchef.com/chef/choose-your-version/). Você precisará de informações sobre o servidor Chef para configurar o cliente.

Para instalar o cliente Chef em uma máquina virtual do Azure, você tem estas opções:

- Use o Portal do Azure para instalar o cliente Chef ao criar uma máquina virtual na qual o Windows Server 2012 ou o Windows Server 2012 R2 está em execução. Para obter instruções, consulte [Portal do Azure](https://docs.chef.io/azure_portal.html).
