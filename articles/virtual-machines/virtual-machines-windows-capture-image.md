...
> [!WARNING]
> Você não pode fazer logon na VM por RDP depois que ela for generalizada, pois o processo remove todas as contas de usuário. As alterações são irreversíveis.
> 
> 
...
> [!NOTE]
> A VM precisa estar na mesma conta de armazenamento que o VHD original.
> 
> 
