...
7.	Na página Ponto de Acesso para Administrar o Cluster, na caixa de texto **Nome de Cluster**, digite o nome para o cluster e clique em **Avançar**.
...
17.	Para adicionar os nós restantes ao cluster, clique o nome do cluster no painel esquerdo e, em seguida, clique em **Adicionar Nó**.
