<properties 
  pageTitle="Implantando seu próprio Registro do Docker privado no Azure | Microsoft Azure"
...
## <a name="configuring-docker-registry-to-use-azure-blob-storage"></a>Configuração do Registro do Docker para uso do Armazenamento de Blob do Azure

(Recomenda-se a leitura de [Documentação do Registro do Docker 2.0][registry-docs] antes de continuar).

Você pode [configurar][registry-config] o Registro do Docker de duas maneiras diferentes.
Você pode:
...
>
> Leia a documentação [Configuring Docker Registry][registry-config] (Configurando o Registro do Docker) para saber como proteger a instância do Registro e suas imagens.
