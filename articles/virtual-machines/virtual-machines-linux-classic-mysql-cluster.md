...
Depois de alguns segundos, e usando `sudo crm_mon –L`, verifique se um dos nós se tornou o mestre do cluster e se ele está executando todos os recursos. Você pode usar montar e verificar se os recursos estão em execução.
