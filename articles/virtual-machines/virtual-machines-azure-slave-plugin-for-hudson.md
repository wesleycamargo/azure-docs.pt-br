...
4. Clique em **Pesquisar** e digite **Azure** para limitar a lista de plug-ins relevantes.
...
2. Clique em **Configure System**.
3. Role a página para encontrar a seção **Cloud**.
4. Dentro da seção **Cloud**, encontre **Add Azure Virtual Machine Template** e clique no botão **Add**.
