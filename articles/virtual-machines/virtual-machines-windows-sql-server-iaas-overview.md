...
- [Configurar os Grupos de Disponibilidade AlwaysOn no Azure (GUI)](virtual-machines-windows-classic-portal-sql-alwayson-availability-groups.md)
...
|Grupos de disponibilidade AlwaysOn|Disponível no SQL Server 2012 ou posterior. Exige [configuração adicional](virtual-machines-windows-sql-high-availability-dr.md)
