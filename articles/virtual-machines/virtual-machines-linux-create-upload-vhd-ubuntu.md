...
4. As imagens do Ubuntu do Azure agora seguem o kernel *HWE* (Habilitação de HardWare). Atualize o sistema operacional para o kernel mais recente, executando os seguintes comandos:
