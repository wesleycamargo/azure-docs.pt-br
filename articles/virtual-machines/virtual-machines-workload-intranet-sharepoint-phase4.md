<properties
	...
	description="Nesta quarta fase da implantação de um farm do SharePoint 2013 apenas de intranet, você cria máquinas virtuais do SharePoint server e um novo farm do SharePoint."
	documentationCenter=""
