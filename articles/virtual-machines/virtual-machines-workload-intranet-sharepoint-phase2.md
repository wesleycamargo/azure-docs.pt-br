...
Lembre-se de que você definiu as Tabelas V, S, ST e A na [Fase 1: Configurar o Azure](virtual-machines-workload-intranet-sharepoint-phase1.md).
...
2.	No painel **Configurações**, clique em **Servidores DNS**.
...
5.	No **Painel de máquinas virtuais**, clique no nome do seu primeiro controlador de domínio (Tabela M – Item 1 - coluna Nome de Máquina Virtual).
6.	No painel da máquina virtual, clique em **Reiniciar**.
7.	Quando o primeiro controlador de domínio é iniciado, clique no nome do seu segundo controlador de domínio no painel **Máquinas virtuais** (Tabela M – Item 2 - Coluna nome de máquina virtual).
...
- Use a [Fase 3](virtual-machines-workload-intranet-sharepoint-phase3.md) para continuar com a configuração desta carga de trabalho.
