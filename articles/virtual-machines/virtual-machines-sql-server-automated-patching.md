...
Um recurso relacionado para VMs do SQL Server no Azure é o [Backup Automatizado para o SQL Server em Máquinas Virtuais do Azure](virtual-machines-sql-server-automated-backup.md).
