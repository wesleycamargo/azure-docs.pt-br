...
- Obter a mídia de instalação OpenFrame do TmaxSoft. Se você for um cliente existente do TmaxSoft, entre em contato com seu representante de TmaxSoft de uma cópia licenciada. Caso contrário, solicite uma versão de avaliação [TmaxSoft](https://www.tmaxsoft.com/contact/).
...
1. Vá para o portal do Azure em <https://portal.azure.com> e entrar em sua conta.
