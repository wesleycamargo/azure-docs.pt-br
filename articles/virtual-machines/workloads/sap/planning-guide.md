...
> ![Linux][Logo_Linux] Linux
>
> [Como capturar uma máquina virtual Linux para usar como um modelo do Resource Manager][/linux/capture-image.md#step-2-create-vm-image]
>
>
...
* Utilize *sysprep* no Windows ou *waagent -deprovision* no Linux para generalizar sua VM - consulte [Referência técnica Sysprep](https://technet.microsoft.com/library/cc766049.aspx) para Windows ou [Como capturar uma máquina virtual Linux para usar como um modelo do Resource Managers][/linux/capture-image.md#step-2-create-vm-image] para Linux
* Fazer logon na assinatura com *Login-AzureRmAccount*
* Definir a assinatura de seu contexto com *Set-AzureRmContext* e o parâmetro SubscriptionId ou SubscriptionName - confira <https://msdn.microsoft.com/library/mt619263.aspx>
* Carregue o VHD com *Add-AzureRmVhd* para uma Conta de Armazenamento do Azure - confira <https://msdn.microsoft.com/library/mt603554.aspx>
