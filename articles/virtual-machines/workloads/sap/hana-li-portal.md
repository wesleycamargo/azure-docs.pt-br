...
ms.locfileid: "58763088"
---
# <a name="azure-hana-large-instances-control-through-azure-portal"></a>Controle de instâncias grandes do HANA do Azure por meio do portal do Azure
...
Ao enviar uma solicitação de implantação de instância grande do HANA, você será solicitado para especificar a assinatura do Azure que você se conectar a instâncias grandes HANA também. É recomendável usar a mesma assinatura que você está usando para implantar a camada de aplicativo SAP que funciona com as unidades de instância grande do HANA.
