...
Para obter mais informações sobre o CLI e o Azure Resource Manager, consulte [Usar a CLI do Azure para Mac, Linux e Windows com o Azure Resource Manager](../../../xplat-cli-azure-resource-manager.md).
