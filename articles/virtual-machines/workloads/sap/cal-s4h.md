...
![Captura de tela da janela Soluções da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic-1b.jpg)
...
![Captura de tela da janela Contas da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic-2.jpg)
...
![Captura de tela da janela Contas da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic3b.jpg)
...
![Captura de tela do portal clássico do Azure](./media/cal-s4h/s4h-pic4b.jpg)
...
![Captura de tela do portal clássico do Azure, guia Certificados de Gerenciamento](./media/cal-s4h/s4h-pic5.jpg)

Uma caixa de diálogo é exibida para que você selecione o arquivo de certificado baixado.

![Captura de tela da caixa de diálogo Carregar um certificado de gerenciamento](./media/cal-s4h/s4h-pic8.jpg)
...
![Captura de tela da janela Contas do SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic9.jpg)
...
![Captura de tela da janela Soluções da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic10.jpg)
...
![Captura de tela da janela Instâncias da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic11.jpg)
...
![Captura de tela da janela Instâncias da SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic12.jpg)
...
![Captura de tela que mostra três máquinas virtuais no portal clássico do Azure](./media/cal-s4h/s4h-pic13.jpg)
...
![Captura de tela da caixa de diálogo Conectar à Instância](./media/cal-s4h/s4h-pic14b.jpg)

Outra opção é fazer logon na VM Windows cliente e iniciar, por exemplo, a GUI pré-configurada do SAP.

![Captura de tela da GUI pré-configurada do SAP](./media/cal-s4h/s4h-pic15.jpg)
