...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver em máquinas virtuais do Azure – Guia de implantação do DBMS
...
* Ferramentas de terceiros – para obter uma discussão mais completa sobre Backup e SAP no Azure, consulte o [Guia de Backup de SAP](sap-hana-backup-guide.md) para obter mais informações.
...
Como alternativa, você pode usar o LVM (Gerenciador de Volume Lógico) ou o MDADM, conforme descrito no capítulo [RAID de Software][dbms-guide-2.2] deste documento para criar um dispositivo lógico grande em vários discos VHD montados.
