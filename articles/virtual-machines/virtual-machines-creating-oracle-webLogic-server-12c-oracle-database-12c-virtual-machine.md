...
#Criando uma Máquina Virtual Oracle WebLogic Server 12c e Oracle Database 12c no Azure
O exemplo a seguir mostra como você pode criar uma Máquina Virtual baseada em uma imagem Oracle WebLogic Server 12c e Oracle Database 12c fornecida pela Microsoft em execução no Windows Server 2012 no Azure.
...
8. Defina a Configuração Opcional conforme necessário com estas considerações:
...
Siga as instruções em [Criação de uma Máquina Virtual do Oracle Database 12c no Azure](virtual-machines-creating-oracle-database-virtual-machine.md), na seção **Criar o banco de dados usando a Máquina Virtual Oracle Database 12c no Azure**.

##Para configurar o Oracle WebLogic Server 12c hospedado nesta Máquina Virtual
Siga as instruções em [Criar uma Máquina Virtual do Oracle WebLogic Server 12c no Azure](virtual-machines-creating-oracle-webLogic-server-12c-virtual-machine.md), começando com a seção **Configurar a Máquina Virtual do Oracle WebLogic Server 12c no Azure**. Se você quiser configurar um cluster de servidor WebLogic, consulte também [Criando um cluster do Oracle WebLogic Server 12c no Azure](virtual-machines-creating-oracle-webLogic-server-12c-cluster.md).

##Recursos adicionais
[Imagens de Máquinas Virtuais Oracle – diversas considerações](miscellaneous-considerations-for-oracle-virtual-machine-images-new-article.md)
