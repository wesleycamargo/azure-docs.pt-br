...
- Interface de Linha de Comando (CLI) do Azure. Você também precisará [instalar a CLI do Azure](../xplat-cli-install.md) e [se conectar à sua assinatura](../xplat-cli-connect.md) para usar recursos do Azure associados à sua conta.
...
## Usar o comando azure vm extension set

Com a CLI do Azure, você poderá usar o comando **azure vm extension set** na sua interface de linha de comando (Bash, Terminal, prompt de comando) para acessar comandos. Execute **azure help vm extension set** para um uso detalhado da extensão.
