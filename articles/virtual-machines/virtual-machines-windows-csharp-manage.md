...
Para interagir com o Azure Resource Manager, verifique se você tem acesso a uma [entidade de serviço do Active Directory](../azure-resource-manager/resource-group-authenticate-service-principal.md). Na entidade de serviço, você adquire um token para autenticar as solicitações para o Azure Resource Manager.
...
- Se houver problemas com a implantação, leia [Solucionar problemas de erros de implantação comuns do Azure com o Azure Resource Manager](../azure-resource-manager/resource-manager-common-deployment-errors.md).
