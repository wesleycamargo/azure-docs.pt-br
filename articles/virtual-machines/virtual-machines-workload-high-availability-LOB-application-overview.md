...
- [Fase 4: configurar os servidores Web](virtual-machines-workload-high-availability-LOB-application-phase4.md). Crie e configure as duas máquinas virtuais do servidor Web.
