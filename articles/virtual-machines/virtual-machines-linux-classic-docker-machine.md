...
2. Carregar arquivo .cer do certificado no Azure. No [portal clássico do Azure](https://manage.windowsazure.com), clique em **Configurações** na parte inferior esquerda da área de serviço (mostrada abaixo)
...
## Próximas etapas
Vá para o [guia do usuário Docker](https://docs.docker.com/userguide/) e crie alguns aplicativos no Microsoft Azure. Outra opção é experimentar o [Docker Swarm no Azure] e ver como o [Swarm](https://github.com/docker/swarm) pode ser usado com o Docker e o Azure.
...
[Docker Swarm no Azure]: virtual-machines-linux-docker-swarm.md
