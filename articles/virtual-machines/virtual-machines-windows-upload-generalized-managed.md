...
> [!IMPORTANT]
> Examine [Planejar a migração para Discos Gerenciados](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks) antes de iniciar a migração para [Discos Gerenciados](../storage/storage-managed-disks-overview.md).
>
