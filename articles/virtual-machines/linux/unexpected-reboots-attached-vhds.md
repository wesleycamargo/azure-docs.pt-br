---
title: Solucionar problemas de reinicializações inesperadas de VMs com VHDs anexados em VMs Linux do Azure | Microsoft Docs
description: Como solucionar problemas de reinicializações inesperadas de VMs do Linux.
