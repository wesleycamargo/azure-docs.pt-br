...
> [!NOTE]
Para criar uma VM usando a CLI do Azure 2.0, consulte [Criar uma VM com a CLI do Azure](../windows/quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
