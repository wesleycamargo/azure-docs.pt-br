...
---
# <a name="using-the-docker-vm-extension-with-the-azure-portal"></a>Utilizando a Extensão de VM do Docker com o Portal do Azure
> [!IMPORTANT] 
...
Você está pronto para conferir o [Guia do usuário do Docker] e usar sua máquina virtual Docker. Se quiser automatizar a criação hosts de Docker em VMs do Azure por meio da interface de linha de comando, confira [Como usar a extensão de máquina virtual do Docker na interface de linha de comando (CLI do Azure)]
