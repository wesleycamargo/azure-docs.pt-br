...
Se você deseja usar outra ferramenta SSH para Windows, os clientes SSH comuns do Windows que você pode instalar localmente estão incluídos nos seguintes pacotes:
