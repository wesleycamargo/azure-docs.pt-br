...
A tabela abaixo descreve as propriedades da Máquina Virtual que podem ser usadas como campos na definição de política. Para saber mais sobre campos da política, consulte [Usar a política para gerenciar os recursos e controlar o acesso](../../resource-manager-policy.md).
...
Uma política pode ser criada facilmente usando a API REST diretamente ou os cmdlets do PowerShell. Leia mais sobre [Como criar e atribuir uma política](../../resource-manager-policy.md).

## <a name="apply-the-policy"></a>Aplicar a política
Depois de criar a política, você precisará aplicá-la a um escopo definido. O escopo pode ser uma assinatura, um grupo de recursos ou até mesmo um recurso. Leia mais sobre [Como criar e atribuir uma política](../../resource-manager-policy.md).
