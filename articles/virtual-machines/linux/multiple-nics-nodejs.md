...
Você pode ler mais detalhes sobre a [implantação de várias NICs usando a CLI do Azure](../../virtual-machines/linux/multiple-nics.md), incluindo o script do processo de loop para criar todas as NICs.
