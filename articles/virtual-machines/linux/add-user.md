---
title: "Adicionar um usuário a uma VM Linux no Azure | Microsoft Docs"
...
Os pré-requisitos são: [uma conta do Azure](https://azure.microsoft.com/pricing/free-trial/), [chaves pública e privada SSH](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json), um grupo de recursos do Azure e a CLI do Azure instalada e alternada para o modo Azure Resource Manager usando `azure config mode arm`.
...
#### <a name="add-the-user"></a>Adicionar o usuário
```bash
...
### <a name="add-your-ssh-public-key-to-the-new-user-account"></a>Adicionar chave pública SSH à nova conta de usuário
...
### <a name="using-visudo-to-allow-sudo-usage-without-a-password"></a>Utilização do visudo para permitir o uso do sudo sem uma senha
...
### <a name="verify-the-user-ssh-keys-and-sudo"></a>Verificar o usuário, as chaves ssh e o sudo
```bash
# Verify the SSH keys & User account
