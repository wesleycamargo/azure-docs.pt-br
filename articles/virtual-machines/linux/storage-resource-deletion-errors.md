---
title: Solucionar problemas de erros de exclusão de recursos de armazenamento em uma implantação do Azure Resource Manager em VMs do Linux | Microsoft Docs
