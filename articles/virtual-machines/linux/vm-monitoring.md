...
Para obter mais detalhes sobre como configurar as métricas de monitoramento e exemplos, acesse o documento que descreve **[Como usar a extensão de diagnóstico do Linux para monitorar dados de desempenho e diagnóstico da VM Linux](classic/diagnostic-extension.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json).
