...
* [Criar uma VM do Linux na CLI do Azure para desenvolvimento e teste](quick-create-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Criar uma VM do Linux protegida usando um modelo do Azure](create-ssh-secured-vm-from-template.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
  ...
  * O exemplo a seguir cria uma VM usando um modelo armazenado no GitHub:
    ...
    ```
* [Criar um ambiente Linux completo usando a CLI do Azure](create-cli-complete-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Carregar e criar uma VM Linux com base em uma imagem de disco personalizada](upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
