---
title: "Documentação das Máquinas Virtuais do Azure Linux - Tutoriais, Referência de API | Microsoft Docs"
...
<div class="content">
    ...
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>As Máquinas Virtuais Linux do Azure fornecem infraestrutura sob demanda, de alta escala, segura e virtualizada usando Red Hat, Ubuntu ou a distribuição do Linux de sua escolha. Aprenda a criar, configurar, gerenciar e dimensionar as VMs do Linux com nossos guias de início rápido, tutoriais e exemplos.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-linux-virtual-machine/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Criar uma Máquina Virtual Linux. (4:11)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 0px; margin-bottom: 0px;">Guia de início rápido de 5 minutos</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Saiba como implantar um servidor Web NGINX em uma Máquina Virtual executando o Ubuntu:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Aprenda a implantar, gerenciar e dimensionar as VMs do Linux no Azure</p>
<ol>
    <li><a href="/azure/virtual-machines/linux/tutorial-manage-vm">Criar e gerenciar as VMs Linux</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-manage-disks">Criar e gerenciar discos de VM</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-automate-vm-deployment">Automatizar a configuração da VM</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-custom-images">Criar imagens de VM personalizada</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-availability-sets">Criar VMs altamente disponíveis</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-create-vmss">Criar um conjunto de dimensionamento da VM</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-load-balancer">VMs de balanceamento de carga</a></li>
    <li><a href="/azure/virtual-machines/linux/tutorial-virtual-network">Gerenciar rede de VM</a></li>
</ol>
                ...
                <div class="cardPadding">
                    <div class="card">
                       <div class="cardImageOuter">
                        ...
                        <div class="cardText">
                            <p>Introdução ao Monitoramento de IaaS</p>
                        </div>
                    </div>
                </div>
            </div>
