...
As etapas a seguir mostram como criar o RAID no Azure usando o portal do Azure. Você também pode definir o RAID usando scripts do Windows PowerShell. Neste exemplo, configuraremos o RAID 0 com 4 discos.

####Etapa 1: adicionar um disco de dados à sua máquina virtual  

Na página de máquinas virtuais do portal do Azure, clique na máquina virtual a qual você deseja adicionar um disco de dados. Neste exemplo, a máquina virtual é mysqlnode1.
