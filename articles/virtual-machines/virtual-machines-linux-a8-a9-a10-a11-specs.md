<properties
 pageTitle="Sobre VMs de computação intensiva com Linux | Microsoft Azure"
...
* **Distribuições** – Você deve implantar as VMs de imagens HPC com base em OpenLogic CentOS ou SLES (SUSE Linux Enterprise Server) compatíveis com RDMA no Azure Marketplace. Somente as seguintes imagens do Marketplace dão suporte aos drivers de RDMA do Linux necessários:
    ...
    * HPC 6.5 baseado em CentOS
    ...
    >[AZURE.NOTE]Para VMs da série H, recomendamos o SLES 12 SP1 para imagem do HPC ou imagem do HPC 7.1 baseado em CentOS.
    >
...
>[AZURE.IMPORTANT]Esta etapa é **necessária** para implantações de VM do HPC SLES 12 em todas as regiões do Azure. Essa etapa não será necessária se você implantar um SLES 12 SP1 para HPC, HPC 7.1 baseado em CentOS ou uma VM do HPC 6.5 baseado em CentOS.
...
>[AZURE.NOTE]A instalação dos drivers pode levar algum tempo e o comando retorna sem saída. Após a atualização, a VM será reiniciada e deve estar pronta para uso em alguns minutos.
