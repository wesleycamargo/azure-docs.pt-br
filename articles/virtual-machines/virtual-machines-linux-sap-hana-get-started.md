...
Para saber mais, confira [como anexar discos a uma VM Linux](virtual-machines-linux-add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
* [Configurar o LVM em uma VM Linux no Azure](virtual-machines-linux-configure-lvm.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
![Janela Discos do servidor de aplicativo SAP HANA exibindo dois discos de dados e seus tamanhos](./media/virtual-machines-linux-sap-hana-get-started/image003.jpg)
...
![Janela Discos do servidor de aplicativo SAP HANA exibindo quatro discos de dados e seus tamanhos](./media/virtual-machines-linux-sap-hana-get-started/image004.jpg)
...
![Configurações de kernel alteradas no arquivo de configuração e compiladas usando grub2 mkconfig](./media/virtual-machines-linux-sap-hana-get-started/image006.jpg)
...
![A guia de configurações Parâmetros de Kernel no carregador de inicialização do YaST](./media/virtual-machines-linux-sap-hana-get-started/image007.jpg)
...
![Dois sistemas de arquivos criados na VM do servidor de aplicativos SAP](./media/virtual-machines-linux-sap-hana-get-started/image008.jpg)
...
![Mensagem pop-up informando que não há espaço de troca suficiente](./media/virtual-machines-linux-sap-hana-get-started/image010.jpg)
...
![Nomes de host e endereços IP das VMs SAP listados no arquivo /etc/hosts](./media/virtual-machines-linux-sap-hana-get-started/image011.jpg)
...
![Mensagem de erro indicando a falta do plug-in de navegador Java](./media/virtual-machines-linux-sap-hana-get-started/image013.jpg)
...
![Usando o YaST para instalar o plug-in ausente](./media/virtual-machines-linux-sap-hana-get-started/image014.jpg)
...
![Instâncias ASCS e de servidor de aplicativos principal instaladas usando a opção "Sistema Distribuído"](./media/virtual-machines-linux-sap-hana-get-started/image012.jpg)
...
![SAP Management Console mostrando a instância do ASCS instalada na VM do servidor de aplicativos e definida como "verde"](./media/virtual-machines-linux-sap-hana-get-started/image016.jpg)
...
![Compartilhamento do diretório /sapmnt por meio de NFS usando as opções "rw" e "no_root_squash"](./media/virtual-machines-linux-sap-hana-get-started/image017b.jpg)
...
![O compartilhamento de /sapmnt configurado usando o "Cliente NFS"](./media/virtual-machines-linux-sap-hana-get-started/image018b.jpg)
...
![Instalação de uma instância de banco de dados entrando na VM do servidor de banco de dados do SAP HANA e iniciando o SWPM](./media/virtual-machines-linux-sap-hana-get-started/image019.jpg)
...
![A página de entrada do Administrador de Sistema de Banco de Dados do SAP HANA](./media/virtual-machines-linux-sap-hana-get-started/image035b.jpg)

Insira a senha para o esquema DBACOCKPIT.

![A caixa de entrada de senha para o esquema DBACOCKPIT](./media/virtual-machines-linux-sap-hana-get-started/image036b.jpg)

Insira uma pergunta para a senha do esquema SAPABAP1.

![Insira uma pergunta para a senha do esquema SAPABAP1](./media/virtual-machines-linux-sap-hana-get-started/image037b.jpg)
...
![Janela de tarefa concluída com mensagem de confirmação](./media/virtual-machines-linux-sap-hana-get-started/image023.jpg)
...
![Janela do SAP Management Console com lista de processos do SAP HANA](./media/virtual-machines-linux-sap-hana-get-started/image024.jpg)
...
![A estrutura de arquivo /hana/shared criada durante a instalação do HANA](./media/virtual-machines-linux-sap-hana-get-started/image025.jpg)

Esta captura de tela mostra a estrutura de arquivos do diretório /usr/sap.

![A estrutura de arquivo de diretório /usr/sap](./media/virtual-machines-linux-sap-hana-get-started/image026.jpg)

A última etapa da instalação ABAP distribuída é a "Instância Primária do Servidor de Aplicativos".

![Instalação ABAP mostrando a Instância Primária do Servidor de Aplicativos como a etapa final](./media/virtual-machines-linux-sap-hana-get-started/image027b.jpg)
...
![Janela DBA Cockpit confirmando a instalação bem-sucedida](./media/virtual-machines-linux-sap-hana-get-started/image028b.jpg)
...
![Instalando o SAP HANA Studio na VM do servidor de aplicativos SAP](./media/virtual-machines-linux-sap-hana-get-started/image038b.jpg)
...
![Grupo novo "sapsys" definido usando a ID de grupo 1001](./media/virtual-machines-linux-sap-hana-get-started/image030.jpg)
...
![Opção "Instalar o novo sistema" na janela de início do hdblcm](./media/virtual-machines-linux-sap-hana-get-started/image031.jpg)
...
![Lista de todos os principais componentes do SAP HANA selecionados anteriormente](./media/virtual-machines-linux-sap-hana-get-started/image032.jpg)
...
![Detalhes do usuário administrador do HANA \<HANA SID\> listados em /etc/passwd](./media/virtual-machines-linux-sap-hana-get-started/image033.jpg)
...
![Estrutura de arquivos do SAP HANA no SAP HANA Studio](./media/virtual-machines-linux-sap-hana-get-started/image034.jpg)
...
![Uma instalação distribuída realizada pelo SWPM](./media/virtual-machines-linux-sap-hana-get-started/image035b.jpg)

A captura de tela a seguir mostra a etapa de instalação do SWPM onde você insere dados sobre o esquema DBACOCKPIT.

![A etapa de instalação do SWPM onde são inseridos os dados do esquema DBACOCKPIT](./media/virtual-machines-linux-sap-hana-get-started/image036b.jpg)

Insira dados sobre o esquema SAPABAP1.

![Inserir dados sobre o esquema SAPABAP1](./media/virtual-machines-linux-sap-hana-get-started/image037b.jpg)

Após a conclusão da instalação da instância do banco de dados SWPM, você poderá ver o esquema SAPABAP1 no HANA Studio.

![O esquema SAPABAP1 no SAP HANA Studio](./media/virtual-machines-linux-sap-hana-get-started/image038b.jpg)
...
![A instância de banco de dados do HANA verificada com transação "dbacockpit"](./media/virtual-machines-linux-sap-hana-get-started/image039b.jpg)
...
* Informações gerais do SAP Azure sobre como executar o SAP no Azure com o sistema operacional Windows no modo clássico: [usando o SAP em máquinas virtuais Windows no Azure](windows/classic/sap-get-started.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json).
...
* Informações gerais do SAP Azure sobre como executar o SAP no Azure com o sistema operacional Linux no modelo do Azure Resource Manager: [usando SAP em VMs (máquinas virtuais) Linux](virtual-machines-linux-sap-get-started.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
* Comparação dos modelos de implantação do Azure Resource Manager e clássica: [Implantação do Azure Resource Manager versus clássica: compreenda os modelos de implantação e o estado de seus recursos](../azure-resource-manager/resource-manager-deployment-model.md).
...
* Baixar o NetWeaver 7.5 para Linux/HANA:
 ...
 ![Janela Instalação e Atualização do Serviço SAP para baixar o NetWeaver 7.5](./media/virtual-machines-linux-sap-hana-get-started/image001.jpg)
