...
- Você definiu os nomes da Máquina Virtual como "MachineGG1" para o Site A e "MachineGG2" para o Site B no portal do Azure.
...
Primeiro, crie a área de trabalho remota para o Site A e Site B por meio do portal do Azure. Abra um prompt de comando do Windows e crie um diretório inicial para os arquivos de instalação do Oracle GoldenGate:
...
Você precisa criar processos Extrair e Bomba de dados no Site A e no Site B. Criar a área de trabalho remota ao Site A e ao Site B por meio do portal do Azure. Abra a janela do interpretador de comando GGSCI. Execute os seguintes comandos no Site A:
