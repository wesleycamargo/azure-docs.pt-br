...
---
# <a name="create-a-linux-vm-on-azure-by-using-the-cli"></a>Criar uma VM do Linux no Azure usando a CLI
...
Você também pode [usar o driver do Azure `docker-machine` com vários comandos para criar rapidamente uma VM do Linux como um host do docker](virtual-machines-linux-docker-machine.md).
