...
- [Adicione uma nova máquina virtual](virtual-machines-windows-create-powershell.md) à sub-rede Corpnet, como uma que executa o Microsoft SQL Server.
