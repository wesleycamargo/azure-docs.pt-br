<properties
	pageTitle="Configurar grupos de disponibilidade AlwaysOn em uma VM do Azure | Microsoft Azure"
...
# Configurar grupos de disponibilidade AlwaysOn em VMs do Azure (PowerShell)
