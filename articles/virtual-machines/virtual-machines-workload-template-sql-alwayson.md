<properties 
	...
	description="Implante facilmente cinco servidores compatíveis com o SQL Server AlwaysOn com um modelo do Gerenciador de Recursos e o Portal de Visualização do Azure, Azure PowerShell ou Azure CLI." 
