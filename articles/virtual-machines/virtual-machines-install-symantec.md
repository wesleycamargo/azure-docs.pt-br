...
O [portal do Azure][Portal] permite instalar o agente de VM e a extensão de segurança Symantec quando você usar a opção **da galeria** para criar a máquina virtual. Usar essa abordagem é uma maneira fácil de adicionar proteção da Symantec caso você esteja criando uma única máquina virtual.
