...
- Saiba mais sobre os [eventosagendados](virtual-machines-scheduled-events.md) API **na visualização pública** fornecida pelo serviço de metadados de instância.
