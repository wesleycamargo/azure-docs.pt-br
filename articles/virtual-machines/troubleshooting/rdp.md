---
title: Solucionar problemas com RDP para VMs do Windows no Azure | Microsoft Docs
description: Solucione problemas com RDP em VMs do Windows no Azure.
...
ms.locfileid: "60306995"
---
# <a name="troubleshoot-rdp-issues"></a>Solucionar problemas com RDP

Os seguintes problemas com a criação de um RDP para conexão a uma VM são abordados nesta seção:
...
- [Solucionar erro de RDP por causa da configuração de NSG](troubleshoot-rdp-nsg-problem.md)
...
- [Solucionar um erro interno](Troubleshoot-rdp-internal-error.md)
- [Solucionar problemas de desconexão frequente](troubleshoot-rdp-intermittent-connectivity.md)
- [Solucionar um erro geral](troubleshoot-rdp-general-error.md)
- [Solucionar os erros de autenticação](troubleshoot-authentication-error-rdp-vm.md)
...
- [Habilitar ou desabilitar uma regra de firewall em um SO convidado](enable-disable-firewall-rule-guest-os.md)
