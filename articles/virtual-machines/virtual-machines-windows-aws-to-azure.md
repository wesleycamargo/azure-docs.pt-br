...
Antes de iniciar esse processo, não se esqueça de ler [Plan for the migration to Managed Disks](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks) (Planejar para a migração no Managed Disks).
...
Se você ainda não tiver a versão do PowerShell instalada, leia [How to install and configure Azure PowerShell](/powershell/azureps-cmdlets-docs) (Como instalar e configurar o Azure PowerShell).
