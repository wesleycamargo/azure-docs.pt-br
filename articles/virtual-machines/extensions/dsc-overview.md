...
- **Versão**: Especifica a versão da extensão DSC para instalar. Para informações sobre as versões, veja [histórico de versão da extensão DSC](/powershell/dsc/azuredscexthistory).
