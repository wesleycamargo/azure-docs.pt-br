...
2. Atualize o tamanho do disco do sistema operacional usando o comando `azure vm set`. O seguinte exemplo atualiza a VM chamada `myVM` no grupo de recursos chamado `myResourceGroup` para `50` GB:
