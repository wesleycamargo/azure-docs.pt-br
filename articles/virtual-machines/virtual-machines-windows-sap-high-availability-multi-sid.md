...
---
title: "Criar uma configuração multi-SID do SAP | Microsoft Docs"
...
# <a name="create-an-sap-multi-sid-configuration"></a>Criar uma configuração multi-SID do SAP
...
5. [Instalar o segundo nó do cluster][sap-ha-guide-9.3].  
