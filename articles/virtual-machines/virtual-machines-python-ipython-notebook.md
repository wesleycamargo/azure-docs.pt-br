...
![Captura de tela](./media/virtual-machines-python-ipython-notebook/ipy-notebook-spectral.png) Usando os pacotes SciPy e Matplotlib para analisar a estrutura de uma gravação.
...
#### Instalações de Anaconda para Linux
<table>
  <th>Python 3.4</th>
  <th>Python 2,7</th>
  <tr>
...
![Captura de tela](./media/virtual-machines-python-ipython-notebook/anaconda-install.png)
...
![Captura de tela](./media/virtual-machines-python-ipython-notebook/jupyter-tree-view.png)

### Usando o Bloco de Anotações do Jupyter

Se você clicar no botão **Novo**, você verá a seguinte página de abertura.

![Captura de tela](./media/virtual-machines-python-ipython-notebook/jupyter-untitled-notebook.png)
...
![Captura de tela](./media/virtual-machines-python-ipython-notebook/jupyter-editing-experience.png)
