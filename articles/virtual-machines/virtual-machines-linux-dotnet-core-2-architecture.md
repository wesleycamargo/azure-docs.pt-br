<properties
   pageTitle="Implantar recursos de computação com os modelos do Azure Resource Manager | Microsoft Azure"
...
# Arquitetura de aplicativos com modelos do Azure Resource Manager
