...
> [AZURE.SELECTOR]
- [CLI do Azure](virtual-machines-linux-cli-create.md)
...
Para ver o tópico complementar sobre máquinas virtuais baseadas em Windows, confira [Usar o Azure PowerShell para criar máquinas virtuais baseadas em Windows](virtual-machines-windows-classic-create-powershell.md).
...
Para saber mais, confira [Como usar o SSH com o Linux no Azure](virtual-machines-linux-ssh-from-linux.md).
...
Após a criação da máquina virtual, confira [Como fazer logon em uma máquina virtual com Linux](virtual-machines-linux-classic-log-on.md).
...
[Como fazer logon em uma máquina virtual que executa o Linux](virtual-machines-linux-classic-log-on.md)

[Usar o Azure PowerShell para criar e pré-configurar máquinas virtuais baseadas em Windows](virtual-machines-windows-classic-create-powershell.md)
