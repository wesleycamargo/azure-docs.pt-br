...
- [Implantação clássica]: [Como carregar sua própria imagem de distribuição](virtual-machines-linux-classic-create-upload-vhd.md) (além de instruções com o uso de uma [Distribuição endossada pelo Azure](virtual-machines-linux-endorsed-distros.md))
- [Observações: requisitos gerais de Linux para execução no Azure](virtual-machines-linux-create-upload-generic.md)
- [Implantação clássica]: [Observações: introdução geral ao Linux no Azure](virtual-machines-linux-intro-on-azure.md)
...
1. [Como carregar sua própria imagem do Ubuntu](virtual-machines-linux-create-upload-ubuntu.md)
2. [Como usar a pilha LAMP do Ubuntu](virtual-machines-linux-install-lamp-stack.md)
3. [Implantação clássica]: [Como usar clusters MySQL](virtual-machines-linux-classic-mysql-cluster.md)
4. [Implantação clássica]: [Como usar o Node.js e o Cassandra](virtual-machines-linux-classic-cassandra-nodejs.md)
5. [Implantação do Gerenciador de Recursos]: [Como usar o IPython Notebook](virtual-machines-linux-jupyter-notebook.md)
...
3. [Como preparar uma VM personalizada baseada em CentOS para o Azure](virtual-machines-linux-create-upload-centos.md)
4. [Implantação clássica]: [Blog: Como implantar uma imagem da VM do CentOS por meio do OpenLogic](https://azure.microsoft.com/blog/2013/01/11/deploying-openlogic-centos-images-on-windows-azure-virtual-machines/)
6. [Implantação clássica]: [Como instalar o Apache Qpid Proton-C para o AMQP e o Barramento de Serviço](../service-bus/service-bus-amqp-apache.md/)
...
11. [Implantação clássica]: [Como instalar e executar o MySQL](virtual-machines-linux-classic-mysql-on-opensuse.md)
12. [Como preparar uma VM SLES ou openSUSE personalizada](virtual-machines-linux-suse-create-upload-vhd.md)  
...
11. [Implantação clássica]: [Como usar o CoreOS no Azure](virtual-machines-linux-classic-coreos-howto.md)
12. [Implantação clássica]: [Como começar a usar o Fleet e o Docker no CoreOS no Azure](virtual-machines-linux-classic-coreos-fleet-get-started.md)


#### [Oracle Linux](https://azure.microsoft.com/marketplace/?term=Oracle+Linux)
  2. [Preparar uma máquina virtual Oracle Linux para o Azure](virtual-machines-linux-oracle-create-upload-vhd.md)
...
6. [Implantação clássica]: [Noções básicas: fazer logon em uma VM do Linux usando o portal clássico do Azure](virtual-machines-linux-classic-log-on.md)
7. [Noções básicas: SSH](virtual-machines-linux-ssh-from-linux.md)
8. [Implantação clássica]: [Noções básicas: como redefinir uma senha ou propriedades SSH para o Linux](virtual-machines-linux-classic-reset-access.md)
9. [Noções básicas: usando Root](virtual-machines-linux-use-root-privileges.md)
10. [Implantação clássica]: [Noções básicas: anexando um disco de dados a uma VM do Linux](virtual-machines-linux-classic-attach-disk.md)
11. [Implantação clássica]: [Noções básicas: desanexando um disco de dados de uma VM do Linux](virtual-machines-linux-classic-detach-disk.md)
...
14. [Implantação clássica]: [Noções básicas: capturando uma VM do Linux para criar um modelo](virtual-machines-linux-classic-capture-image.md)
...
17. [Implantação clássica]: [Noções básicas: injetando dados personalizados em uma VM para usar com o Cloud-init](virtual-machines-windows-classic-inject-custom-data.md)
18. [Implantação clássica]: [Noções básicas de blogs: compilando o Linux altamente disponível no Azure em 12 etapas](http://blogs.technet.com/b/keithmayer/archive/2014/10/03/quick-start-guide-building-highly-available-linux-servers-in-the-cloud-on-microsoft-azure.aspx)
19. [Implantação clássica]: [Noções básicas de blogs: automatizar o provisionamento do Linux no Azure com a CLI do Azure, o node.js e o jhawk](http://blogs.technet.com/b/keithmayer/archive/2014/11/24/step-by-step-automated-provisioning-for-linux-in-the-cloud-with-microsoft-azure-xplat-cli-json-and-node-js-part-1.aspx)
20. [Noções básicas: extensão Docker Azure da VM](virtual-machines-linux-dockerextension.md)
23. [Implantação clássica]: Referência da [API REST do Gerenciamento de Serviços do Azure](https://msdn.microsoft.com/library/azure/ee460799.aspx)
...
3. [Como configurar Tomcat7 no Linux usando o portal clássico do Azure](virtual-machines-linux-classic-setup-tomcat.md)
...
5. [SDK de Gerenciamento de Serviços do Azure: Ruby](https://github.com/MSOpenTech/azure-sdk-for-ruby)
    - [Como instalar o Ruby on Rails](virtual-machines-linux-classic-ruby-rails-web-app.md)
6. [SDK de Gerenciamento de Serviços do Azure: Python](https://github.com/Azure/azure-sdk-for-python)
    - [Como usar o aplicativo Web Django Hello World (Mac-Linux)](virtual-machines-linux-python-django-web-app.md)
...
10. Chef
	- [Chef e máquinas virtuais](virtual-machines-windows-chef-automation.md)
