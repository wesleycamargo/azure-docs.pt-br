...
Para instalar e configurar o MongoDB usando o modelo de implantação do Gerenciador de Recursos, consulte [este artigo](virtual-machines-windows-classic-install-mongodb.md).
