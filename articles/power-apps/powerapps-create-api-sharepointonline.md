...
# Crie uma nova API do SharePoint Online no ambiente de serviço de aplicativo da sua organização
...
3. Selecione o nome do locatário da sua organização: ![Iniciar o Active Directory do Azure][6]
...
7. Após a conclusão bem-sucedida, você será redirecionado para o novo aplicativo do AAD. Selecione **Configurar**: ![Aplicativo Contoso AAD][10]
...
9. Na janela **Permissões para outros aplicativos**, selecione **Office 365 Exchange Online** e, então, selecione **OK**: ![Delegado do aplicativo Contoso][12]
...
11. Selecione **Permissões delegadas** para o _Office 365 Exchange Online_ e selecione as seguintes permissões:
	...
	![Permissões de delegado do aplicativo Contoso][13]
