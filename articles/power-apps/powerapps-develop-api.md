...
Para saber como personalizar a definição da API Swagger 2.0 em geral, consulte [Personalizar definições de API gerada por Swashbuckle](../app-service-api-dotnet-swashbuckle-customize.md).
