...
3. Na lista, você pode usar a barra de rolagem para localizar o PowerApps ou digitar *powerapps*: ![][2]
...
3. Selecione o nome do locatário da sua organização: ![Iniciar o Active Directory do Azure][7]
...
7. Após a conclusão bem-sucedida, você será redirecionado para o novo aplicativo do AAD. Selecione **Configurar**: ![Aplicativo Contoso AAD][11]
