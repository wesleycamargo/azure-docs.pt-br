...
2. Selecione **Procurar** na barra de tarefas: ![][1]

3. Na lista, você pode rolar a tela para localizar PowerApps ou digite *powerapps*: ![][2]

4. Em **PowerApps**, selecione **Gerenciar APIs**: ![Navegue até as APIs registradas][3]

5. Em **Gerenciar APIs**, selecione **Adicionar** para adicionar a nova API: ![Adicionar API][4]

6. Insira um **nome** descritivo para sua API.

7. Em **Fonte**, selecione as **APIs disponíveis** para selecionar as APIs criadas previamente e selecione **Dynamics CRM Online**: ![Selecione a API online do Dynamics CRM][5]

8. Selecione **Configurações - definir as configurações necessárias**: ![Defina as configurações de API online do Dynamics CRM][6]
...
3. Selecione o nome do locatário da sua instituição: ![Iniciar o Active Directory do Azure][7]

4. Selecione a guia **Aplicativos** e selecione **Adicionar**: ![Aplicativos de locatário do AAD][8]
...
7. Após a conclusão bem-sucedida, você será redirecionado para o novo aplicativo do AAD. Selecione **Configurar**: ![Aplicativo Contoso do AAD][11]

8. Defina a **URL de resposta** na seção _OAuth 2_ para a URL de redirecionamento que você recebeu quando adicionou a nova API do Dynamics CRM Online no Portal do Azure (neste tópico): ![Configure o aplicativo Contoso do AAD][12]
...
Referência da [API REST do Dynamics CRM Online](../connectors/connectors-create-api-crmonline.md).
