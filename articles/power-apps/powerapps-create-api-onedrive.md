...
# Crie uma nova API do OneDrive no ambiente de serviço de aplicativo da sua organização
...
3. Na página de configurações:
	...
	a) Selecione **Configurações da API**. b) Defina a URL de redirecionamento para a URL de redirecionamento que você recebeu quando adicionou a nova API do OneDrive no Portal do Azure (neste tópico). c) Selecione **Salvar**.
