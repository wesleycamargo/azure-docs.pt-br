...
-   a configuração appId é substituída por uma configuração de cadeia de conexão
...
Remova todas as chamadas de `CapptainAgent.configure` já que `EngagementAgent.init` substitui esse método.
