...
---
# <a name="data-partitioning-guidance"></a>Diretrizes de particionamento de dados
...
> O termo *particionamento* usado neste guia refere-se ao processo de dividir fisicamente os dados em armazenamentos de dados separados. Isso não é o mesmo que o particionamento de tabela do SQL Server, que é um conceito diferente.
>
>
...
## <a name="partitioning-strategies-for-azure-documentdb-databases"></a>Estratégias de particionamento para os bancos de dados do Banco de Dados de Documentos do Azure
...
[Cotas do Barramento de Serviço]: ./service-bus-messaging/service-bus-quotas.md
