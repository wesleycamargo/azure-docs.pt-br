<properties linkid="dev-net-service-bus-amqp-overview" urlDisplayName="Hubs de Notificação do Azure" pageTitle="Hubs de notificação do Azure" metaKeywords="notificações por push Azure, hubs de notificação do Azure, mensagens do Azure" description="Saiba como usar notificações por push Azure. Amostras de código escritas em C# usando a API do .NET." metaCanonical="" disqusComments="1" umbracoNaviHide="0" title="Hubs de Notificação do Azure" authors="" />
...
<h2><span class="short-header">O que são notificações por push?</span>O que são notificações por push?</h2>
...
<h2><span class="short-header">Como as notificações por push funcionam</span>Como as notificações por push funcionam</h2>
...
<h2><span class="short-header">Desafios das notificações por push</span>Desafios das notificações por push</h2>
...
<h2><span class="short-header">Por que usar Hubs de Notificação?</span>Por que usar Hubs de Notificação?</h2>
