...
Envie seu aplicativo para a Microsoft Store e, em seguida, configure o projeto de servidor para integração com o WNS (Windows Notification Services) para enviar notificações por push.
