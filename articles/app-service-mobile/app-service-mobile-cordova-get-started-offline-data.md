...
Para saber mais sobre o recurso de sincronização offline, confira o tópico [Sincronização de Dados Offline em Aplicativos Móveis do Azure]. Para obter detalhes sobre o uso da API, confira o arquivo [README] no plug-in.
