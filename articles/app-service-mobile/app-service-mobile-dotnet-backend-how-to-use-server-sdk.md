---
title: Como trabalhar com o servidor .NET back-end do SDK para Aplicativos Móveis | Microsoft Docs
...
3. Se solicitado a selecionar um destino de publicação, clique em **Serviço de Aplicativo do Microsoft Azure** > **Próximo** e (se necessário) entre com suas credenciais do Azure. O Visual Studio baixa e armazena suas configurações de publicação com segurança diretamente do Azure.
...
5. No arquivo App\_Start/Startup.MobileApp.cs, adicione uma chamada ao método de extensão **MapApiControllers**, como no seguinte exemplo:
