...
2. Clique em **Configurações**, **Autenticação de usuário**, e, em seguida, clique em **Facebook**. Em seguida, copie o **URI de redirecionamento** da folha do Facebook. Você a usará com seu aplicativo do Facebook.
