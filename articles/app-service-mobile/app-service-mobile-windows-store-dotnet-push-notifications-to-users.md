...
<!-- URLs. -->
[Introdução à autenticação]: app-service-mobile-windows-store-dotnet-get-started-users.md
[Introdução às notificações por push]: app-service-mobile-windows-store-dotnet-get-started-push.md
