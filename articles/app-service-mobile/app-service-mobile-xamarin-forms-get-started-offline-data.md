...
1. No Gerenciador de Soluções, abra o arquivo de projeto Constants.cs do projeto **Portable** e altere o valor de `ApplicationURL` para apontar para uma URL inválida, como a seguir:
