...
* Uma [associação ao programa de desenvolvedores da Apple](https://developer.apple.com/programs/ios/), necessária para registrar com o APNS (Apple Push Notification Service).
