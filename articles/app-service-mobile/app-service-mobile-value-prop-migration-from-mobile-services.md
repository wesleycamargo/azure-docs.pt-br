...
- Inclua os pacotes e bibliotecas que desejar. Em .NET, os assemblies que você implanta são os assemblies usados em tempo de execução; nunca há um conflito com as versões no ambiente de hospedagem.
