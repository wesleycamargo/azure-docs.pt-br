...
3. Visualize os conteúdos da tabela *TodoItem* do Azure com uma ferramenta SQL, como o *SQL Server Management Studio*, ou então com um cliente REST, como o *Fiddler* ou *Postman*. Confirme que os novos itens *não* foram sincronizados com o servidor
