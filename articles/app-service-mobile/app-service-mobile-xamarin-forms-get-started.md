...
* É mais fácil de executar o projeto do iOS de sua solução em um Mac. Você pode usar o Visual Studio no computador com o Windows se quiser, mas é um pouco mais complicado porque você precisa se conectar a um Mac em rede. Se estiver interessado em fazer isso, consulte [Instalando o Xamarin.iOS no Windows].
...
Com isso em mente, vamos continuar.
 ...
 2. Em **Baixar e executar seu projeto Xamarin.Forms**, clique no botão **Baixar**.
...
1. Clique com o botão direito do mouse do projeto do Android e clique em **Definir como Projeto de Inicialização**.
