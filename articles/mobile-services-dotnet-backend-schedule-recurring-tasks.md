<properties  pageTitle="Agendar tarefas de back-end com o Agendador - Mobile Services" metaKeywords="" description="Usar o Agendador dos Serviços Móveis do Windows Azure para agendar trabalhos para seu aplicativo móvel." metaCanonical="" services="" documentationCenter="Mobile" title="Agendar trabalhos recorrentes nos Serviços Móveis" authors=""  solutions="" writer="" manager="" editor=""  />
...
+ [Baixar e instalar o LINQ para a biblioteca do Twitter]
+ [Criar a nova tabela Updates]
...
2. Copie a URL do serviço móvel da janela do navegador aberta, acrescente o caminho `/tables/samplejob` à URL e, em seguida, execute uma nova solicitação POST para essa URL usando um utilitário HTTP, como o Fiddler.

	O método **ExecuteAsync* *é iniciado no computador local.
...
3. Republique o projeto do serviço móvel no Azure.
