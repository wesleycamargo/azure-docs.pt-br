<properties urlDisplayName="Upload an Ubuntu Linux VHD" pageTitle="Criar e carregar um VHD do Ubuntu Linux no Azure" metaKeywords="Azure VHD, uploading Linux VHD, Ubuntu" description="Saiba como criar e carregar um disco r&iacute;gido virtual (VHD) do Azure que cont&eacute;m o sistema operacional Ubuntu Linux." metaCanonical="" services="virtual-machines" documentationCenter="" title="Criando e carregando um disco r&iacute;gido virtual que cont&eacute;m o sistema operacional Ubuntu Linux" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
7.  Confira se o servidor SSH está instalado e configurado para iniciar no tempo de inicialização. Geralmente, esse é o padrão.

8.  Instale o Agente Linux do Azure:
