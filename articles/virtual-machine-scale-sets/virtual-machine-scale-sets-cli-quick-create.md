---
title: "Criação rápida de CLI de conjuntos de dimensionamento | Microsoft Azure"
description: "Implante conjuntos de escala usando a criação rápida da CLI."
...
---
# <a name="quickly-create-a-scale-set-using-the-azure-cli"></a>Criar rapidamente um conjunto de escala usando a CLI do Azure
