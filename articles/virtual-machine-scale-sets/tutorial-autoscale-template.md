...
Para obter mais exemplos de máquina virtual conjuntos de dimensionamento em ação, consulte os seguintes scripts de exemplo de CLI do Azure de exemplo:
