...
Considere restringir o acesso ao conteúdo CDN por país. O CDN do Azure permite filtrar solicitações com base no país de origem e restringir o conteúdo fornecido. Para obter mais informações, consulte [Restringir o acesso ao seu conteúdo por país](cdn/cdn-restrict-access-by-country.md).
