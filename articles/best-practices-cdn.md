...
|City |Tempo até o Primeiro Byte (Origem) |Tempo até o Primeiro Byte (CDN) | % mais rápido para CDN|
|---|---|---|---|
...
|Cingapura<sub>1</sub> |214 |74 |189%|
|Tóquio, JP<sub>1</sub> |163 |48 |240%|
|Seul, Coreia do Sul |190 |190 |0%|

Tem um nó do CDN do Azure na mesma cidade.<sub>1</sub>Tem um nó do CDN do Azure em uma cidade vizinha.<sub>2</sub>
