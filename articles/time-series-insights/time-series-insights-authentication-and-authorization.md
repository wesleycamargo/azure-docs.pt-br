---
title: Autenticação do Azure Time Series Insights – Como autenticar e autorizar pela API no Azure Time Series Insights | Microsoft Docs
...
> [Criar uma entidade de serviço](../active-directory/develop/howto-create-service-principal-portal.md)
