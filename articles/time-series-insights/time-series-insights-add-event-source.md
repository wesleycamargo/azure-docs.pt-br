...
3.    Selecione o seu ambiente de Análise de Séries Temporais.
  ...
  ![Criar origem de evento da Análise de Séries Temporais](media/add-event-source/getstarted-create-eventsource1.png)

4.    Selecione "Origens de Evento", clique em "+ Adicionar".

  ![Criar origem de evento da Análise de Séries Temporais - detalhes](media/add-event-source/getstarted-create-eventsource2.png)
...
6.    Selecione um hub de eventos da lista de recursos do Hub de Eventos na assinatura atual ou escolha a opção de importação "Definir configurações do Hub de Eventos manualmente" para especificar um hub de eventos localizado em outra assinatura. Os eventos devem ser publicados no formato JSON.
