---
title: Dados da Versão Prévia do Azure Time Series Insights – entrada e armazenamento de dados na Versão Prévia do Azure Time Series Insights | Microsoft Docs
