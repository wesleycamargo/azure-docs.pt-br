---
title: Adicionar um hub de eventos do Azure Time Series Insights – A adicionar uma fonte de evento de Hubs de Eventos ao Azure Time Series Insights | Microsoft Docs
