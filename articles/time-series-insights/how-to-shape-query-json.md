---
title: Práticas recomendadas para formatar o JSON nas consultas do Azure Time Series Insights.
description: Saiba como melhorar a eficiência de consulta do Time Series Insights.
...
Para colocar essas diretrizes em prática, veja [Sintaxe de consulta do Azure Time Series Insights](/rest/api/time-series-insights/time-series-insights-reference-query-syntax) para saber mais sobre a sintaxe de consulta para os dados do TSI acessarem a API REST.