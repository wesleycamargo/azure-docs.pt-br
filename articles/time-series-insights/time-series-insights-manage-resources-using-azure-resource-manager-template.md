---
title: Gerenciamento de modelo do Azure Time Series Insights – Como gerenciar seu ambiente do Azure Time Series Insights usando modelos do Azure Resource Manager | Microsoft Docs
