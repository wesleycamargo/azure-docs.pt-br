    ...
    <div class="container">
        <ul class="pivots">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Armazenar e gerenciar imagens para todos os tipos de implantação de contêiner</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="developer">
                    <li>
                        <a href="#developer-all">todos</a>
                        <ul id="developer-all" class="cardsF">
                            <li>
                                <div class="container">
                                    <h1>Linguagens &amp; estruturas</h1>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Fluent/1.0.0-beta3">Obter o SDK do .NET</a>
                                                </h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/develop/net/">Introdução</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api">Referência de API</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://www.visualstudio.com/vs/python/">Obter o SDK do Python</a>
                                                </h3>
                                                <p>
                                                    <a href="https://www.visualstudio.com/vs/python/">Introdução</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://azure.microsoft.com/develop/nodejs/">Obter o SDK do Node.js</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="http://search.maven.org/remotecontent?filepath=com/microsoft/azure/azure-parent/1.0.0-beta3/azure-parent-1.0.0-beta3.pom">Obter o SDK do Java</a>
                                                </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
                                                    <a href="https://azure.microsoft.com/downloads/">Obter o SDK do Ruby</a>
                                                </h3>
                                                <p>
                            ...
                            <li>
                                <div class="container">
                                    <h1>Interface de Linha de Comando (CLI)</h1>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
