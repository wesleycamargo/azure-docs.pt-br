...
A próxima etapa é [implantar o aplicativo nos Aplicativos Web do Azure com o Git](app-service-web/app-service-web-get-started-php.md) (embora nem todas as informações da etapa sejam relevantes). 
