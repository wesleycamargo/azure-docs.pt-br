<properties title="How to make a phone call from Twilio (PHP) - Azure" pageTitle="Como fazer uma chamada telefônica por meio da Twilio (PHP) - Azure" metaKeywords=" Azure PHP Twilio, Azure Twilio, chamadas telefônicas do Azure, Azure twilio, Azure SMS, chamadas de voz do Azure, chamadas de voz do azure, mensagens de texto do Azure, twilio PHP do Azure" description="Saiba como fazer uma chamada telefônica e enviar uma mensagem SMS com o serviço de API do Twilio no Azure. Exemplos são para o aplicativo PHP." documentationCenter="PHP" services="" solutions="" videoId="" scriptId="" authors="MicrosoftHelp@twilio.com; robmcm" manager="twilio" editor="mollybos" />
...
2. Verifique seu número de telefone como uma ID de chamador de saída com a Twilio. Para obter informações sobre como verificar o número do seu telefone, consulte [https://www.twilio.com/user/account/phone-numbers/verified#][verify_phone]. Como alternativa ao uso de um número existente, você pode adquirir um número de telefone da Twilio.
Para o objetivo deste exemplo, use o número de telefone verificado como o valor de **From** do **callform.php** (descrito posteriormente).
...
Além de fazer a chamada, o **makecall.php** exibe alguns metadados da chamada (exemplo mostrado na captura de tela abaixo). Para obter mais informações sobre chamar metadados, consulte [https://www.twilio.com/docs/api/rest/call#instance-properties][twilio_call_properties].
...
## Consulte também
* [Como usar o Twilio para a voz e os recursos de SMS no PHP](../partner-twilio-php-how-to-use-voice-sms)
...
[howto_blob_storage_php]: http://azure.microsoft.com/pt-br/documentation/articles/storage-php-how-to-use-blobs/
[howto_sql_azure_php]: http://azure.microsoft.com/pt-br/documentation/articles/sql-database-php-how-to-use/
