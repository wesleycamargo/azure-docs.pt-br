...
1. Abra o Explorador de Arquivos e vá para a pasta que contém o código de exemplo de serviço que você clonou anteriormente. Na pasta **.build**, localize e copie **DPS.ino.bin** e **DPS.ino.map**.
