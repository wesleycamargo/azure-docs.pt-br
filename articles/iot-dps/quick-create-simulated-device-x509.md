...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service"></a>Criar e provisionar um dispositivo simulado X.509 usando o Serviço de Provisionamento de Dispositivos do Hub IoT
