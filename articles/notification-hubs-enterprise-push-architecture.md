...
1. **EnterprisePushBackendSystem**
	...
	a. Esse projeto usa o pacote do Nuget  *WindowsAzure.ServiceBus* e é baseado na [programação do Barramento de Serviço Pub/Sub]. 
	...
	c. `CreateTopic` é usado para criar o tópico do Barramento de Serviço onde podemos enviar mensagens. 
...
2. **ReceiveAndSendNotification**
	...
	a. Esse projeto usa os pacotes do Nuget  *WindowsAzure.ServiceBus* e  *Microsoft.Web.WebJobs.Publish* e é baseado na [programação do Barramento de Serviço Pub/Sub]. 

	b. Esse é outro console aplicativo em C# que podemos executar como um [WebJob do Azure] porque ele precisa ser executado continuamente para ouvir mensagens dos sistemas LoB/back-end. Isso fará parte do back-end do celular. 
	...
	f. Selecione o perfil de publicação e criar um novo site do Azure se ele ainda não existir que hospedará esse WebJob e, quando tiver o site da Web, **publicar**. 
...
3. **EnterprisePushMobileApp**
	...
	c. Certifique-se de que os seguintes códigos de registro dos Hubs de Notificação estão sendo chamados na inicialização do aplicativo (depois de substituir o  *HubName* e  *DefaultListenSharedAccessSignature*:
...
3. Execute o aplicativo de console **EnterprisePushBackendSystem** que simulará back-end do LoB e começará a enviar mensagens e você deverá ver notificações do sistema que aparecem como o seguinte: 
...
[WebJob do Azure]: http://azure.microsoft.com/documentation/articles/web-sites-create-web-jobs/
