<properties
   pageTitle="Solucionando problemas de implantações com a API REST | Microsoft Azure"
   description="Descreve como usar a API REST do Azure Resource Manager para detectar e corrigir problemas de implantação do Gerenciador de Recursos."
...
# Solucionando problemas de implantações de grupo de recursos com a API REST do Azure Resource Manager
...
Se você recebeu um erro durante a implantação de recursos no Azure, será necessário solucionar esse erro. A API REST fornece operações que permitem encontrar os erros e determinar as possíveis correções.
