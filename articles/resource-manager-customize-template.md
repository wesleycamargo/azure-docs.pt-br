---
title: Personalizar o modelo do Gerenciador de Recursos exportado | Microsoft Docs
...
1. Para implantar usando seu próprio script, use um dos procedimentos a seguir.
...
2. Se você baixou o modelo exportado e scripts, encontre o arquivo **deploy. ps1** (para o PowerShell) ou o arquivo **deploy.sh** (para a CLI do Azure).
