...
Os Grupos de Disponibilidade AlwaysOn introduzidos com o SQL Server 2012 são um recurso de alta disponibilidade e recuperação de desastres com suporte total nos serviços de infraestrutura do Azure. Informações detalhadas e o comunicado oficial de suporte para os Grupos de Disponibilidade AlwaysOn na infraestrutura de serviço do Microsoft Azure podem ser encontrados no artigo Grupos de Disponibilidade AlwaysOn.
