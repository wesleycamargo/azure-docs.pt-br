...
Você deve ter uma [Conta de API dos Serviços Cognitivos](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account) com a **APIs de Análise de Texto**. Você pode usar a **camada gratuita para 5.000 transações/mês** para concluir este guia de início rápido.
...
A API de Detecção de Idioma detecta o idioma de um texto de documento, usando o [método Detect Language](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c7).
...
4. Substitua o local em `host` (atualmente `westus`) para a região em que você se inscreveu.
