---
title: Idiomas compatíveis com a API de Análise de Texto – Serviços Cognitivos do Azure | Microsoft Docs
description: Lista de suporte a idiomas disponíveis ao público geral e suporte a idioma de versão prévia para operações da API de Análise de Texto. Aplica-se à análise de sentimento, à extração de frases-chave e à detecção de idioma.
...
---
# <a name="supported-languages-in-the-text-analytics-api"></a>Idiomas compatíveis na API de Análise de Texto
