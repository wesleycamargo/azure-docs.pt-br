...
O [código-fonte para amostras do SDK de Pesquisa de Entidade do Bing em Java](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search/BingEntitySearch) está disponível no GitHub. 

## <a name="application-dependencies"></a>Dependências de aplicativo
Obtenha uma [chave de acesso de Serviços Cognitivos](https://azure.microsoft.com/try/cognitive-services/) em **Pesquisar**. Instale as dependências do SDK de Pesquisa de Entidade do Bing usando Maven, Gradle ou outro sistema de gerenciamento de dependência. O arquivo POM Maven requer a declaração:
```
  <dependencies>
    <dependency>
...
```
Pesquise a entidade única "Satya Nadella" e imprima uma breve descrição.
```
...
```
Pesquise "William Gates" e lide com resultados de desambiguação para a consulta ambígua.
```
...
```
Pesquise um único repositório com a consulta "Microsoft Store" e imprima o número de telefone para o resultado.
```
...
```
Pesquise uma lista de restaurantes com a consulta "Restaurantes de Seattle". Imprima os nomes e os números de telefone para os resultados.
```
