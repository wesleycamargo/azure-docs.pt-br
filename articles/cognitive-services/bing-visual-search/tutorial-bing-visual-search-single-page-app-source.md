...
ms.locfileid: "35364268"
---
# <a name="tutorial-visual-search-single-page-web-app"></a>Tutorial: Aplicativo Web de uma página única de Pesquisa Visual

Esse é o código-fonte completo discutido no [tutorial de aplicativo Web de página única de Pesquisa Visual](tutorial-bing-visual-search-single-page-app.md) para a Pesquisa Visual do Bing. Para executar o aplicativo, copie o código-fonte em um Bloco de Notas ou outro editor de texto e salve-o como `bing-visual-search.html`. Abra o arquivo salvo no Microsoft Edge ou outro navegador popular.
