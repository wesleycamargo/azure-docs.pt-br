...
O código a seguir envia uma URL de imagem no parâmetro `knowledgeRequest`, junto com um filtro \"site:www.bing.com\".  Em seguida, imprime o `imageInsightsToken`, o número de marcações, o número de ações e o primeiro actionType.
