...
ms.locfileid: "53250409"
---
# <a name="quickstart-perform-a-news-search-using-c-and-the-bing-news-search-rest-api"></a>Início Rápido: Executar uma pesquisa de notícias usando C# e a API REST de Pesquisa de Notícias do Bing
...
A [API de Pesquisa de Notícias do Bing](https://docs.microsoft.com/rest/api/cognitiveservices/bing-web-api-v7-reference) retorna os resultados da pesquisa de Notícias do mecanismo de pesquisa do Bing.
