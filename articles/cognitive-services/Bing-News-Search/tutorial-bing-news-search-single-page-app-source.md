---
title: 'Tutorial: aplicativo Web de página única de Pesquisa de Notícias do Bing (código-fonte)'
titlesuffix: Azure Cognitive Services
description: Código-fonte para tutorial mostrando como usar a API de Pesquisa de Notícias do Bing em um aplicativo Web de página única.
