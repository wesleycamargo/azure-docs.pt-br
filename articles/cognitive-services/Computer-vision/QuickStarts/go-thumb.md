---
title: Início rápido de Go da API de Pesquisa Visual Computacional – criar miniatura | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Neste início rápido, você pode gerar uma miniatura de uma imagem usando a Pesquisa Visual Computacional com Go nos Serviços Cognitivos.
...
1. Crie o arquivo, por exemplo: `go build get-thumbnail.go`.
1. Execute o arquivo, por exemplo: `get-thumbnail`.
