---
title: Perguntas frequentes sobre a API da Pesquisa Visual Computacional | Microsoft Azure
description: Obtenha respostas para perguntas frequentes sobre a API da Pesquisa Visual Computacional nos Serviços Cognitivos.
