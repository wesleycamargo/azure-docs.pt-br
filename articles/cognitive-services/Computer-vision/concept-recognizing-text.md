...
O reconhecimento de texto economiza tempo e esforço. Você pode ser mais produtivo obtendo uma imagem de texto do que transcrevendo-a. O reconhecimento de texto possibilita digitalizar notas. Essa digitalização permite que você implemente uma pesquisa rápida e fácil. Também reduz a desorganização de papéis.
...
Saiba mais sobre como [extrair texto com OCR](concept-extracting-text-ocr.md).
