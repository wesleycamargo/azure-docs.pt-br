---
title: Início Rápido do C# para os Serviços Cognitivos do Azure, API de Pesquisa de Vídeo do Bing | Microsoft Docs
...
ms.locfileid: "35364410"
---
# <a name="quickstart-for-bing-video-search-api-with-c"></a>Início Rápido da API de Pesquisa de Vídeo do Bing com o C#

Este artigo mostra como usar a API de Pesquisa de Vídeo do Bing, parte dos Serviços Cognitivos da Microsoft no Azure. Embora este artigo utilize o C#, a API é um serviço Web RESTful compatível com qualquer linguagem de programação que pode fazer solicitações HTTP e analisar JSON. 
