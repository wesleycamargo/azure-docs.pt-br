...
![Projetar curva de oclusão](media/wwise-occlusion-curve.png)
...
![Curva de obstrução de projeto](media/wwise-obstruction-curve.png)
...
![Opções de plug-in do mixer do Projeto Acústico](media/mixer-plugin-global-settings.png)
...
![Configurações do mixer por som](media/per-sound-mixer-settings.png)
...
![Diretrizes de design de voz](media/voice-design-guidelines.png)
...
![Curvas de atenuação](media/atten-curve.png)
...
![Controles de espaço acústico](media/acoustics-space-controls.png)
...
![Controles de componentes de áudio](media/audio-component-controls.png)
...
![Configurar streaming](media/streaming-setup.png)
...
![Consulta de distância](media/distance-query.png)
