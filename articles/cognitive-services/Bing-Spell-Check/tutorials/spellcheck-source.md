---
title: Obter resultados de Verificação Ortográfica usando a API de Verificação Ortográfica do Bing (Serviços Cognitivos da Microsoft no Azure) | Microsoft Docs
