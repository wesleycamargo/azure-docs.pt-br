...
O aplicativo baseia-se no Pacote Maven do SDK de Fala, versão 1.4.0, bem como no Android Studio 3.3.
...
1. Na janela que for exibida, insira o nome e a versão do SDK de Fala para Android, `com.microsoft.cognitiveservices.speech:client-sdk:1.4.0`. Depois, selecione **OK**.
