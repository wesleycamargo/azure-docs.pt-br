---
title: Contrato de licença do SDK de Dispositivos de Fala | Microsoft Docs
...
ms.locfileid: "35364272"
---
# <a name="speech-devices-sdk-license-agreement"></a>Contrato de licença do SDK dos Dispositivos de Fala

## <a name="microsoft-software-license-termsbrspeech-devices-software-development-kit-sdk"></a>TERMOS DE LICENÇA DE SOFTWARE DA MICROSOFT<br>SDK (SOFTWARE DEVELOPMENT KIT) DOS DISPOSITIVOS DE FALA 
...
Estes termos de licença constituem um contrato entre você e a Microsoft Corporation (ou uma de suas afiliadas). Eles aplicam-se ao software supramencionado e a quaisquer atualizações de software ou serviços da Microsoft (salvo na medida em que esses serviços ou atualizações sejam acompanhados por termos novos ou adicionais, caso em que esses termos diferentes são aplicados prospetivamente e não alteram os seus direitos ou os da Microsoft relacionados aos serviços ou ao software pré-atualizado). **SE VOCÊ CUMPRIR ESTES TERMOS DE LICENÇA, TERÁ OS DIREITOS DESCRITOS ABAIXO.**

**1\. DIREITOS DE INSTALAÇÃO E DE UTILIZAÇÃO.**

a) Gerais. Você poderá instalar e utilizar qualquer número de cópias do software em seus dispositivos, exclusivamente para avaliá-lo e testá-lo para seus objetivos comerciais internos. Você não poderá utilizar o software em um ambiente operacional dinâmico, a menos que a Microsoft permita que você faça isso nos termos de outro contrato.

b) Aplicativos da Microsoft incluídos. O software poderá incluir outros aplicativos da Microsoft. Estes termos de licença aplicam-se a esses aplicativos incluídos, se houver, a menos que outros termos de licença sejam fornecidos com os outros aplicativos da Microsoft.

c) Componentes de terceiros. O software poderá incluir componentes de terceiros com avisos legais separados ou regidos por outros contratos, que podem ser descritos nos arquivos de Avisos de Terceiros que acompanham o software.

d) Gerenciadores de Pacotes. O software poderá incluir gerenciadores de pacotes, como o NuGet, que oferecem a opção para baixar outros pacotes de software da Microsoft e de terceiros para uso com o aplicativo. O uso desses pacotes é regido por suas próprias licenças e não por este contrato. A Microsoft não distribui, licencia nem oferece garantias para nenhum pacote de terceiros.

e) Se você for um concorrente direto e acessar ou utilizar o software para fins de avaliação de parâmetros de comparação, análise ou coleta de informações de inteligência da concorrência, você renunciará com relação à Microsoft, suas subsidiárias e suas empresas afiliadas (incluindo prospectivamente), a qualquer uso de concorrência, acesso e restrições de teste de parâmetros de comparação nos termos que regem seu software até a medida em que seus termos de uso são ou pretendem ser, mais restritivos do que os termos da Microsoft. Se você não renunciar a essas restrições pretendidas nos termos que regem o software, você não terá permissão para acessar ou usar este software e não o fará.

**2\. ESCOPO DA LICENÇA. Este software é licenciado, não vendido. A Microsoft reserva-se todos os outros direitos. A menos que a legislação aplicável lhe conceda mais direitos apesar dessa limitação, você não poderá (não terá direito a):**

a) resolver as limitações técnicas no software que permitem usá-lo apenas de determinadas maneiras;
...
e) compartilhar, publicar ou emprestar o software (exceto para qualquer código distribuível e, em seguida, sujeito aos termos aplicáveis acima), fornecer o software como uma solução autônoma hospedada para uso de outros usuários nem transferir o software ou este contrato para terceiros.
...
**16\. LIMITAÇÃO E EXCLUSÃO DE DANOS. SE TIVER QUALQUER FUNDAMENTO PARA A RECUPERAÇÃO DE DANOS, NÃO OBSTANTE A EXCLUSÃO DE GARANTIA PRECEDENTE, A MICROSOFT E SEUS FORNECEDORES RESSARCIRÃO VOCÊ ATÉ O MONTANTE DE US$ 5,00. VOCÊ NÃO PODERÁ SER RESSARCIDO POR QUAISQUER OUTROS DANOS, INCLUINDO DANOS CONSEQUENTES, LUCROS PERDIDOS, DANOS EXTRAORDINÁRIOS, DANOS INDIRETOS OU INCIDENTAIS.**

**Esta limitação aplica-se a (a) qualquer assunto relacionado ao software, aos serviços, ao conteúdo (incluindo o código) em sites da Internet de terceiros ou aplicativos de terceiros; e (b) reivindicações por violação do contrato, garantia ou condição; responsabilidade objetiva, negligência ou outro ato ilícito extracontratual; ou qualquer outra reivindicação; em cada caso, na medida do permitido pela lei aplicável.**
