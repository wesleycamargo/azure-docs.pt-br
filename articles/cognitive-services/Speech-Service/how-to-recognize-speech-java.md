...
description: Saiba como reconhecer a fala (de um arquivo, de um microfone, com um modelo personalizado, de forma contínua ou única) usando o SDK de Fala para Java.
