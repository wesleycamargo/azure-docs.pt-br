---
title: Como gravar amostras de voz para criar uma voz personalizada | Microsoft Docs
...
Uma pessoa pode preencher mais de uma função. Este guia assume que você ocupará o cargo de diretor e contratará o ator de voz e um engenheiro de gravação. Há algumas informações sobre a função de engenheiro de gravação, caso você mesmo queira fazer as gravações.

## <a name="choosing-voice-talent"></a>Escolher o ator de voz
...
Uma persona pode ter, por exemplo, uma personalidade naturalmente otimista. Então, "essa" voz poderá carregar uma nota de otimismo, mesmo ao falar de forma neutra. No entanto, esse traço de personalidade deve ser sutil e consistente. Ouça as leituras de vozes existentes para ter uma ideia do que você está procurando.
...
> [!NOTE]
> A maioria dos estúdios grava em pequenos segmentos conhecidos como *tomadas.* Cada tomada contém tipicamente de 10 a 24 enunciados. Somente anotando o número da tomada será suficiente para localizar um enunciado posteriormente. Se estiver gravando em um estúdio que prefere fazer gravações mais longas, convém anotar o código de tempo. O estúdio terá uma exibição de tempo proeminente.
...
|Obras com licença permissiva|Obras distribuídas sob licença como Creative Commons ou Licença GNU de Documentação Livre. Wikipedia usa GFDL. Algumas licenças, no entanto, podem impor restrições à performance do conteúdo licenciado que podem afetar a criação de um modelo de voz personalizada, portanto, leia a licença atentamente.|
...
### <a name="doing-it-yourself"></a>Faça você mesmo
...
Você também pode usar um microfone analógico. Muitas locadoras oferecem microfones "vintage" reconhecidos pela sua singularidade vocal. Observe que a engrenagem analógica profissional usa conectores XLR balanceados, em vez de plugue de 1/4 "usado em equipamentos de consumo. Se for analógico, também precisará de um pré-amplificador e uma interface de áudio do computador com esses conectores.

Instale o microfone em um suporte ou pedestal e instale um filtro pop na frente do microfone para eliminar o ruído de sons "plosivos" como "p" e "b." Alguns microfones vêm com uma montagem de suspensão que isola-os das vibrações no suporte, o que é útil.
...
Grave diretamente no computador usando uma interface de áudio de alta qualidade ou uma porta USB, dependendo do microfone que estiver usando. Para analógico, mantenha a cadeia de áudio simples: mic, pré-amplificador, interface de áudio, computador. Tanto [Avid Pro Tools](http://www.avid.com/en/pro-tools) como [Adobe Audition](https://www.adobe.com/products/audition.html) podem ser licenciados mensalmente a um custo razoável. Se o orçamento estiver extremamente limitado, experimente o [Audacity](https://www.audacityteam.org/) gratuito.
...
O ideal é ter pessoas diferentes nas funções de diretor, engenheiro e ator de voz. Não tente fazer tudo sozinho! Em uma situação atípica, o diretor e engenheiro podem ser uma pessoa.
...
O ator *não* deve adicionar pausas distintas entre as palavras. A frase ainda deve fluir naturalmente, mesmo quando soar um pouco formal. Talvez seja necessário treinar essa sutil distinção para acertá-la.
...
Treine o ator para respirar fundo e pausar por um momento antes de cada enunciado. Grave alguns segundos de silêncio entre os enunciados. As palavras devem ser pronunciadas da mesma forma a cada vez que aparecem, considerando o contexto: "registrar" como um verbo é pronunciado de forma diferente de "registro" como um substantivo.
...
O portal de Voz Personalizada exige que cada enunciado fornecido esteja em arquivo próprio. Os arquivos de áudio fornecidos pelo estúdio contêm vários enunciados. Portanto, a principal tarefa de pós-produção é dividir as gravações e prepará-las para envio. O engenheiro de gravação pode ter colocado marcadores no arquivo (ou fornecido uma lista cue separada) para indicar onde cada enunciado é iniciado.

Use as anotações para localizar as tomadas corretas que você quer e utilize uma ferramenta de edição de som como [Avid Pro Tools](http://www.avid.com/en/pro-tools), [Adobe Audition](https://www.adobe.com/products/audition.html) ou o [Audacity](https://www.audacityteam.org/) gratuito para copiar cada enunciado em um novo arquivo.

Deixe apenas 0,2 segundos de silêncio no início e no final de cada clipe, exceto o primeiro. Esse arquivo deve iniciar com cinco segundos completos de silêncio. Não use o editor de áudio para "zerar" partes silenciosas do arquivo. A inclusão do "tom da sala" ajudará os algoritmos da voz personalizada a compensar qualquer ruído de fundo residual.

Ouça cada arquivo atentamente. Nessa fase, é possível editar pequenos sons indesejados que não foram percebidos durante a gravação, como um leve som labial antes de uma fala, mas tenha cuidado para não remover nenhuma fala real. Se você não conseguir corrigir um arquivo, remova-o do conjunto de dados e anote que fez isso.
...
Você está pronto para enviar as gravações e criar a voz personalizada!
