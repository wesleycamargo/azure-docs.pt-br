...
|||
|-|-|
|[![Logotipo da ROOBO](media/speech-devices-sdk/roobo-logo.png)](https://ddk.roobo.com/)|ROOBO fornece inteligência completa soluções do sistema (AI) para os aparelhos domésticos elétricos, automóveis, robôs, brinquedos e outros setores. Designs de referência do ROOBO reduzem significativamente o tempo de entrega de desenvolvimento por meio da integração com os serviços de fala do Azure. [Visite ROOBO](https://ddk.roobo.com/).|
