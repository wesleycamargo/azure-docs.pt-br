---
title: Ponto de extremidade para Visualização de URL de Projeto - Serviços Cognitivos da Microsoft | Microsoft Docs
...
|safeSearch|Conteúdo adulto ilegal ou pirateado, é bloqueado com código de erro 400 e o sinalizador *isFamilyFriendly* não é retornado. <p>A seguir está o comportamento para conteúdo somente para adultos legal. O código de status retorna 200 e o sinalizador *isFamilyFriendly* é definido como false.<ul><li>safeSearch=strict: Título, descrição, URL e imagem não serão retornados.</li><li>safeSearch=moderate; Obtém o título, a URL e a descrição, mas não a imagem descritiva.</li><li>safeSearch=off; Obtém todos os elementos/objetos de resposta – título, URL, descrição e imagem.</li></ul> |Cadeia de caracteres|Não obrigatório. </br> O padrão é safeSearch=strict.| 
