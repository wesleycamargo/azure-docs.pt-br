---
title: Referência de API de Localização de Anomalias para Serviços Cognitivos da Microsoft | Microsoft Docs
description: Referência de API de Localização de Anomalias para Serviços Cognitivos da Microsoft.
