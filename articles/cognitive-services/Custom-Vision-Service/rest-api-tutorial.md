---
title: 'Tutorial: Criar, treinar e exportar um modelo com a API REST de Visão Personalizada'
...
ms.locfileid: "58351092"
---
# <a name="tutorial-create-train-and-export-a-model-with-rest"></a>Tutorial: Criar, treinar e exportar um modelo com REST
...
Para obter mais informações sobre essa solicitação, consulte [CreateProject](https://go.microsoft.com/fwlink/?linkid=865446).
