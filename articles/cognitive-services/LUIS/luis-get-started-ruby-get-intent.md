---
title: Tutorial para aprender a chamar um aplicativo de Reconhecimento Vocal (LUIS) usando Ruby | Microsoft Docs
...
ms.locfileid: "36265102"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>Tutorial: Chamar um ponto de extremidade de LUIS usando Ruby
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>Consumir um resultado de LUIS usando a API de ponto de extremidade com Ruby 
...
2. Substitua `"YOUR-SUBSCRIPTION-KEY"` pela sua chave de assinatura nesta linha de código: `subscriptionKey = "YOUR-SUBSCRIPTION-KEY"`

3. Executar o aplicativo Ruby. Ele exibe o mesmo JSON que você viu anteriormente na janela do navegador.
