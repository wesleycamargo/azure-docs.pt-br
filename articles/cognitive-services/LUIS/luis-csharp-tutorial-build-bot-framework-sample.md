...
1. No [portal do Azure](https://portal.azure.com), selecione **Criar novo recurso** no menu superior esquerdo.
    ...
    ![Criar recurso no Portal do Azure](./media/luis-tutorial-cscharp-web-bot/bot-service-creation.png)

2. Na caixa Pesquisar, procure **Bot do aplicativo Web**. 

    ![Selecione o bot do aplicativo Web como tipo de recurso](./media/luis-tutorial-cscharp-web-bot/bot-service-selection.png)
...
> 
> [!WARNING]
> Se você excluir sua chave de ID ou LUIS do aplicativo, o bot deixará de funcionar.
...
Se o bot não estiver funcionando, baixe o projeto para seu computador local e continue com a [depuração](https://docs.microsoft.com/bot-framework/bot-service-debug-bot). 
