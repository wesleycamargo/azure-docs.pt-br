...
O LUIS oferece [entidades predefinidas](Pre-builtEntities.md) para tipos comuns como `Number`, que você pode usar para o número de tíquetes em uma ordem de tíquetes.
