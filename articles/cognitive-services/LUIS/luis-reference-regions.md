...
|LUIS|Região global|Criação de região no Azure|
|--|--|--|
...
Você pode usar a região de criação para interagir com o serviço LUIS implantado em uma região diferente da publicação do Azure.  
