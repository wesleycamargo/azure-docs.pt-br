...
Também é possível corrigir erros de ortografia no painel **Testar** [inserindo a chave](interactive-test.md#view-bing-spell-check-corrections-in-test-panel). A chave é mantida como uma variável de sessão no navegador para o painel Testar. Adicione a chave ao painel Testar em cada sessão do navegador para a qual você deseja corrigir a ortografia. 
...
|--|--|
|`spellCheck`|booleano|
|`bing-spell-check-subscription-key`|Chave de assinatura da [API de Verificação Ortográfica do Bing V7](https://azure.microsoft.com/services/cognitive-services/spell-check/)|
