---
title: Tutorial para aprender a chamar um aplicativo de Reconhecimento Vocal (LUIS) usando Node.js | Microsoft Docs
...
ms.locfileid: "36265397"
---
# <a name="tutorial-call-a-luis-endpoint-using-javascript"></a>Tutorial: Chamar um ponto de extremidade de LUIS usando JavaScript
...
4. Acesse o site do [LUIS](luis-reference-regions.md) e faça logon usando sua conta do Azure. 
    ...
    [![](media/luis-get-started-node-get-intent/app-list.png "Captura de tela da lista para Criar aplicativos")](media/luis-get-started-node-get-intent/app-list.png)
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-javascript"></a>Consumir um resultado de LUIS usando a API de ponto de extremidade com JavaScript 
...
2. Substitua `"YOUR SUBSCRIPTION KEY"` pela sua chave de assinatura nesta linha de código: `xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key","YOUR SUBSCRIPTION KEY");`

3. Abra o arquivo que você salvou usando um navegador da Web.  Uma janela de alerta deve ser exibida informando que `Detected the following intent: TurnOn`.

![Janela pop-up que diz TurnOn](./media/luis-get-started-node-get-intent/popup-turn-on.png)
