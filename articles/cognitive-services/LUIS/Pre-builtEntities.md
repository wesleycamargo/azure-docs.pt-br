...
1. Adicione uma entidade de **número** ao seu aplicativo e, em seguida, [Treine](interactive-test.md) e [Publique](PublishApp.md) o aplicativo.
...
1. Adicione uma entidade **datetimeV2** ao seu aplicativo e, em seguida, [Treine](interactive-test.md) e [publique](PublishApp.md) o aplicativo.
2. Clique na URL do ponto de extremidade na página **Publicar Aplicativo** para abrir o ponto de extremidade LUIS em um navegador da Web. 
