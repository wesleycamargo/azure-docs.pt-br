---
title: Início Rápido do PHP – prever a intenção – LUIS
...
ms.locfileid: "47036888"
---
# <a name="quickstart-get-intent-using-php"></a>Início Rápido: Obter a intenção usando o PHP
