---
title: Chamar um aplicativo de Reconhecimento Vocal (LUIS) usando PHP | Microsoft Docs
...
ms.locfileid: "36265119"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Tutorial: Chamar um ponto de extremidade de LUIS usando PHP
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>Consumir um resultado de LUIS usando a API de ponto de extremidade com PHP 
...
3. Executar o aplicativo PHP. Ele exibe o mesmo JSON que você viu anteriormente na janela do navegador.
