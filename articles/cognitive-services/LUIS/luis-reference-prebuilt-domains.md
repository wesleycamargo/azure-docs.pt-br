...
| Editar | Solicitação para alterar uma reunião existente ou a entrada do calendário.| Mova minha reunião de 9: 00 às 10 horas.<br/><br/>Desejo atualizar minha agenda.<br/><br/>Reschdule minha reunião com Ryan.|
...
| messageType | O nome de um destinatário de mensagem ou contato.| Texto<br/>Email|
...
| Nome do método | DESCRIÇÃO | Exemplos |
| ---------------- |-----------------------|----|
| Livro | Comprar tíquetes do filme.|Reserve-me dois ingressos para o capitão Omar e os dois mosqueteiros<br/>Eu quero comprar um ingresso para o filme de amanhã<br/>Eu quero uma passagem para o Capitão Omar Parte 2 na próxima quarta-feira|
...
| Texto | O texto de uma nota ou lembrete.|esticar antes de caminhar<br/>longo prazo amanhã|
...
|GetReviews|Peça opiniões de um lugar.|Mostrar comentários para Cheesecake Factory<br/>Leia revisões Cineplex no Yelp|
...
| Nome da entidade | DESCRIÇÃO | Exemplos |
| ---------------- |-----------------------|----|
| Texto | A descrição de texto de um lembrete.|pegar a limpeza a seco<br/>largando meu carro no centro de serviço|
...
| Texto | O texto para traduzir.|Olá Mundo<br/>Bom Dia<br/>Boa noite|
