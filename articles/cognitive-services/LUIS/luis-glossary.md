...
Um token é a menor unidade pode ser rotulada em uma entidade. A geração de tokens é baseada na [cultura](luis-supported-languages.md#tokenization) do aplicativo.
