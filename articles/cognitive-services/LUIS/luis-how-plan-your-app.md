...
Depois que o aplicativo obtiver declarações de ponto de extremidade, planeje implementar melhorias de previsão com [aprendizado ativo](luis-how-to-review-endoint-utt.md), [listas de frase](luis-concept-feature.md) e [padrões](luis-concept-patterns.md). 
