...
É possível [testar](interactive-test.md) o LUIS interativamente, uma declaração por vez ou fornecer um [lote](luis-concept-batch-test.md) de declarações. Com o teste, você compara o modelo [ativo](luis-concept-version.md#active-version) atual com o modelo publicado. 
...
O LUIS armazena todas as declarações registradas no log de consulta, disponível para download na página de lista **Aplicativos** do site do [LUIS][LUIS], além das [APIs de criação](https://aka.ms/luis-authoring-apis) do LUIS. 

Quaisquer declarações das quais o LUIS não tem certeza são listadas na página **[Examinar declarações de ponto de extremidade](label-suggested-utterances.md)** do site do [LUIS][LUIS]. 

![Examinar enunciados de ponto de extremidade](./media/luis-concept-test/review-endpoint-utterances.png)
...
* Saiba mais sobre como [testar](interactive-test.md) suas declarações.
