---
title: Dados do Application Insights no LUIS usando o C#
...
ms.locfileid: "47038945"
---
# <a name="add-luis-results-to-application-insights"></a>Adicionar os resultados do LUIS ao Application Insights
...
Todo o código neste tutorial está disponível no [repositório do github de exemplos de LUIS](https://github.com/Microsoft/LUIS-Samples/tree/master/documentation-samples/tutorial-web-app-bot-application-insights/csharp) e cada linha associada a este tutorial é comentada com `//LUIS Tutorial:`. 
