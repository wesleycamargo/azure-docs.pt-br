...
Selecione **Enviar**. Se a operação for bem-sucedida, o **status de resposta** é `200 OK`e o **conteúdo da resposta** caixa exibe aos detalhes de revisão no formato JSON, semelhante ao seguinte:
