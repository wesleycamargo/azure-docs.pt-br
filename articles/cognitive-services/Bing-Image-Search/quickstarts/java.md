...
1. Use as variáveis da última etapa para formatar uma URL de pesquisa para a solicitação da API. O termo de pesquisa deve ser codificado como URL antes de ser acrescentado à solicitação.
