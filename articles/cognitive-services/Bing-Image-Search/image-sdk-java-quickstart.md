---
title: 'Início Rápido: Solicitar e filtrar imagens usando o SDK em Java'
description: Neste início rápido, você solicita e filtra as imagens retornadas pela Pesquisa de Imagem do Bing com o uso de Java.
...
ms.locfileid: "41929905"
---
# <a name="quickstart-request-and-filter-images-using-the-sdk-and-java"></a>Início Rápido: solicitar e filtrar imagens usando SDK e Java

O SDK de Pesquisa de Imagem do Bing fornece a funcionalidade da API REST para consultas de imagem e resultados de análise. 

O [código-fonte para amostras do SDK de Pesquisa de Imagem do Bing em Java](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search/BingImageSearch) está disponível no GitHub. 

## <a name="application-dependencies"></a>Dependências de aplicativo
Obtenha uma [chave de acesso de Serviços Cognitivos](https://azure.microsoft.com/try/cognitive-services/) em **Pesquisar**. Instale as dependências do SDK de Pesquisa de Imagem do Bing usando Maven, Gradle ou outro sistema de gerenciamento de dependência. O arquivo POM Maven requer a declaração:
```
 <dependencies>
    <dependency>
...
```
Implemente o cliente **ImageSearchAPIImpl**, que requer uma instância da classe **ServiceClientCredentials**.
```
...
```
Pesquise imagens sobre as "Montanhas rochosas canadenses". Verifique o número de resultados. Imprima os valores para os parâmetros **firstImageResult**, **pivotSuggestions** e **queryExpansions**.
```
...
```
Pesquise imagens sobre "Gibraltar" e filtre para GIFs animados e taxa de proporção larga. Verifique o número de resultados. Imprima os valores para os parâmetros **insightsToken**, **thumbnailUrl** e **webUrl** para o primeiro resultado.
```
...
```
Pesquise imagens populares. Verifique os parâmetros **categorias** e **blocos**.
```
...
```
Pesquise imagens com a consulta "Degas" e, em seguida, pesquise para obter detalhes sobre o primeiro resultado de imagem. 
```
