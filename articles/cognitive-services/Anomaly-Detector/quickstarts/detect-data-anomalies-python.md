...
3. Enviar a solicitação usando `requests.post()`. Combinar a URL de detecção de anomalias e de ponto de extremidade para a URL de solicitação completa e incluir cabeçalhos e os dados da solicitação json. 

4. Se a solicitação for bem-sucedida, retorne a resposta.  
