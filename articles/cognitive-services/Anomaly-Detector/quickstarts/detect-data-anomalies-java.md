...
3. Use a solicitação `setHeader()` função para definir o `Content-Type` cabeçalho para a `application/json`e adicione sua chave de assinatura para o `Ocp-Apim-Subscription-Key` cabeçalho.
