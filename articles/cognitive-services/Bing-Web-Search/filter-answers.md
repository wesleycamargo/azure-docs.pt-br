---
title: Filtrar as respostas da Web retornadas pelo Bing | Microsoft Docs
description: Mostra como usar responseFilter para filtrar as respostas retornadas pela API de Pesquisa na Web do Bing.
