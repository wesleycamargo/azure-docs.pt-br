---
title: Aplicativo Web de página única de Pesquisa na Web do Bing (código-fonte) | Microsoft Docs
description: Código-fonte para tutorial mostrando como usar a API de Pesquisa na Web do Bing em um aplicativo Web de página única.
