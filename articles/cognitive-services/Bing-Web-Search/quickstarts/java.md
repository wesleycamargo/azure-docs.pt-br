---
title: Chamada e resposta - Início rápido de Java para Serviços Cognitivos do Azure, API de Pesquisa na Web do Bing | Microsoft Docs
...
ms.locfileid: "35363695"
---
# <a name="call-and-response-your-first-bing-web-search-query-in-java"></a>Chamada e resposta: a primeira consulta de Pesquisa na Web do Bing em Java
...
Este artigo inclui um aplicativo de console simples que executa uma consulta de API de Pesquisa na Web do Bing e exibe os resultados de pesquisa brutos, que estão no formato JSON. Enquanto este aplicativo é escrito em Java, a API é um serviço Web RESTful compatível com qualquer linguagem de programação que possa fazer solicitações HTTP e analisar o JSON. 
...
Para excluir esse aplicativo, siga estas etapas.
...
3. Adicione o código fornecido a um arquivo chamado `BingWebSearch.java`.
...
A seguir está uma resposta de exemplo. Para limitar o comprimento de JSON, somente um único resultado é mostrado e outras partes da resposta foram truncadas. 
...
[Obtenha uma chave de acesso de avaliação gratuita](https://azure.microsoft.com/try/cognitive-services/?api=bing-web-search-api)  
