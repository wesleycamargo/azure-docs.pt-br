---
title: Usando a classificação para exibir as respostas da Web | Microsoft Docs
description: Mostra como usar a classificação para exibir as respostas retornadas pela API de Pesquisa na Web do Bing.
