...
> [!NOTE]
> Para usar métricas offline, você deve ter carimbos de da/hora em seus dados de uso. Os dados de hora são necessários para dividir o uso corretamente entre conjuntos de dados de treinamento e teste.
> 
