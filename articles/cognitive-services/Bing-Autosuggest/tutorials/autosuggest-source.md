...
description: Código-fonte do tutorial mostrando como usar a API de Sugestão Automática do Bing em um aplicativo Web de página única.
...
ms.locfileid: "35364390"
---
# <a name="tutorial-single-page-web-app"></a>Tutorial: aplicativo Web de página única

Esse é o código-fonte completo abordado no [tutorial de aplicativo de página única](autosuggest.md) da API de Sugestão Automática do Bing. Para executar o aplicativo, copie o código-fonte em um editor de texto e salve o arquivo como `autosuggest.html`. Em seguida, abra o arquivo salvo no navegador da Web.
