---
title: 'Início Rápido: Detectar faces em uma imagem usando a API REST e o C#'
titleSuffix: Azure Cognitive Services
description: Neste início rápido, você detectará faces em uma imagem usando a API de Detecção Facial com C#.
...
ms.locfileid: "49954504"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-rest-api-and-c"></a>Início Rápido: Detectar faces em uma imagem usando a API REST e o C#
...
2. Substitua Program.cs pelo código a seguir.
...
6. No prompt, digite o caminho para uma imagem.
...
> [Tutorial: introdução à API de Detecção Facial no C#](../Tutorials/FaceAPIinCSharpTutorial.md)
