---
title: 'Início rápido: detectar faces em uma imagem – API de Detecção Facial, C#'
...
ms.locfileid: "46129362"
---
# <a name="quickstart-detect-faces-in-an-image-using-c"></a>Início rápido: detectar faces em uma imagem usando C#
