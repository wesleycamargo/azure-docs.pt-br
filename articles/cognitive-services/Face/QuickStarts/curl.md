---
title: 'Início rápido: detectar faces em uma imagem – API de Detecção Facial, cURL'
...
ms.locfileid: "49343054"
---
# <a name="quickstart-detect-faces-in-an-image-using-curl"></a>Início rápido: detectar faces em uma imagem usando cURL
