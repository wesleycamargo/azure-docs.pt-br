---
title: Detectar faces em imagens com API de Detecção Facial | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Use a API de Detecção Facial nos Serviços Cognitivos para detectar faces em imagens.
...
ms.locfileid: "35363467"
---
# <a name="how-to-detect-faces-in-image"></a>Como detectar faces em Imagem

Este guia demonstrará como detectar faces de uma imagem, com atributos faciais como sexo, idade ou pose extraídos. Os exemplos são gravados em C# usando a biblioteca clientes de API de Detecção Facial. 
...
## <a name="step2"></a> Etapa 2: fazer upload de uma imagem para o serviço e executar a detecção facial
...
## <a name="step3"></a> Etapa 3: reconhecer e usar pontos de referência facial
...
## <a name="step4"></a> Etapa 4: usar outros atributos faciais
