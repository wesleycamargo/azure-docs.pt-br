...
PersistedFace é uma estrutura de dados na API detecção Facial. PersistedFace vem com um [PersistedFace ID](#persisted-face-id), assim como outros atributos como nome e os dados de usuário.
...
Persistente Face ID é gerada quando um [PersistedFace](#persistedface) é criado com êxito. Uma cadeia de caracteres é criada para representar esta Face na [API de Detecção Facial](#face-api).
