---
title: Glossário da API de Detecção Facial | Microsoft Docs
...
#### <a name="Detection-Face-Detection"></a>Detecção/Detecção Facial
...
#### <a name="Face-Attributes-Facial-Attributes"></a>Atributos de Atributos/Atributos Faciais

Consulte [Atributos](#Attributes).

#### <a name="Face-ID"></a>ID Facial
...
#### <a name="Face-Landmarks-Facial-Landmarks"></a>Pontos de referência facial/Pontos de referência facial
...
#### <a name="Face-Rectangle"></a>Retângulo de Face
...
#### <a name="Facial-Hair-Attribute"></a>Pelo Facial (atributo)
...
#### <a name="Head-Pose-Attribute"></a>Pose da Cabeça (atributo)
...
#### <a name="Smile-Attribute"></a>Sorriso (Atributo)
...
#### <a name="Train"></a>Treinar (LargePersonGroup/LargeFaceList/PersonGroup)
...
#### <a name="UserData-User-Data"></a>UserData/Dados de Usuário
