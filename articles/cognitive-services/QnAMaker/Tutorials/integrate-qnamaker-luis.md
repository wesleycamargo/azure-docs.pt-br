...
- Faça logon no [QnA Maker](https://qnamaker.ai) e [crie as bases de dados de conhecimento]() de acordo com seu cenário.
- [Teste]() e [publique]() as bases de conhecimento.
