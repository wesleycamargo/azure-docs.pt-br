---
title: Atualizar a base de dados de conhecimento – Início Rápido do Go – Serviços Cognitivos do Azure | Microsoft Docs
...
## <a name="the-update-knowledge-base-response"></a>A resposta de atualizar a base de dados de conhecimento
