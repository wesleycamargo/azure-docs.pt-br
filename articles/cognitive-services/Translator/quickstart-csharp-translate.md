...
ms.locfileid: "52334696"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-c"></a>Início Rápido: Traduzir texto com a API REST de Tradução de Texto (C#)
...
O primeiro comando faz duas coisas. Ele cria um novo aplicativo de console .NET e cria um diretório chamado `translate-sample`. O segundo comando faz a mudança para o diretório do seu projeto.
