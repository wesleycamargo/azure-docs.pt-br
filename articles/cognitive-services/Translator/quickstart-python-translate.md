---
title: Tradução de Texto – traduzir texto com Python | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Neste início rápido, você traduz texto de um idioma para outro usando a API de Tradução de Texto com Python nos Serviços Cognitivos.
