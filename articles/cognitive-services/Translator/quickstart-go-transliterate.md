...
ms.locfileid: "49648353"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-go"></a>Início Rápido: Transliterar texto com a API REST de Tradução de Texto (Go)
