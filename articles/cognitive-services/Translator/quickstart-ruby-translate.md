---
title: 'Início Rápido: Traduzir texto, Ruby – API de Tradução de Texto'
...
ms.locfileid: "55461246"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-ruby"></a>Início Rápido: Traduzir texto com a API REST de Tradução de Texto (Ruby)
