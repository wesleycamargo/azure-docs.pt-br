...
ms.locfileid: "49645602"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-ruby"></a>Início Rápido: Traduzir texto com a API de Tradução de Texto (Ruby)
