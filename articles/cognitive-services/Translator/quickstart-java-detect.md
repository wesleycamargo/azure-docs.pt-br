...
ms.locfileid: "52890766"
---
# <a name="quickstart-use-the-translator-text-api-to-detect-text-language-using-java"></a>Início Rápido: Usar a API de Tradução de Texto para detectar o idioma usando Java
