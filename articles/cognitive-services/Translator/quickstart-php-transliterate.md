...
ms.locfileid: "55208187"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-php"></a>Início Rápido: Transliterar texto com a API REST de Tradução de Texto (PHP)
