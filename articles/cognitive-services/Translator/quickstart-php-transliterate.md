---
title: Tradução de Texto – converter script de texto com PHP | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Neste início rápido, você converter texto em um idioma de um script para outro usando a API de Tradução de Texto com PHP nos Serviços Cognitivos.
