...
O primeiro comando faz duas coisas. Ele cria um novo aplicativo de console .NET e cria um diretório chamado `languages-sample`. O segundo comando faz a mudança para o diretório do seu projeto.
