---
title: 'Início Rápido: Obter idiomas compatíveis, Node.js - API de Tradução de Texto'
...
ms.locfileid: "49646399"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-nodejs"></a>Início Rápido: Obter idiomas compatíveis com a API REST de Tradução de Texto (Node.js)
