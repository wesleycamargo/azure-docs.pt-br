...
ms.locfileid: "49648302"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-go"></a>Início Rápido: Traduzir texto com a API REST de Tradução de Texto (Go)
