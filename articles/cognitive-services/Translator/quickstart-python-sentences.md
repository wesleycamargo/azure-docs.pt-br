...
O ponto de extremidade global de Tradução de Texto é definido como o `base_url`. `path` define a rota `breaksentence` e identifica que queremos usar a versão 3 da API.
