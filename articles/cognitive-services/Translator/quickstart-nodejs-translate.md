...
ms.locfileid: "49648472"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Início Rápido: Traduzir texto com a API de Tradução de Texto (Node.js)
