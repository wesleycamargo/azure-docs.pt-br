---
title: Tradução de Texto – encontrar traduções alternativas com Go | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Neste início rápido, você encontra traduções alternativas e exemplos de termos em contexto usando a API de Tradução de Texto com Go nos Serviços Cognitivos.
