...
Este snippet de código mostra como usar a Biblioteca de Clientes para enviar sua chave de assinatura e uma URL de foto para o serviço API de Detecção de Emoções.
