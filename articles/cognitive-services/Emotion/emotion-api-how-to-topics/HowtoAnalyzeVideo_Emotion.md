---
title: Análise de vídeo em tempo real com a API de Detecção de Emoções | Microsoft Docs
description: Use a API de Detecção de Emoções dos Serviços Cognitivos para executar a análise em tempo quase real em quadros obtidos de um fluxo de vídeo ao vivo.
