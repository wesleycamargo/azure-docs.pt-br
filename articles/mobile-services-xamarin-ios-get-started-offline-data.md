<properties urlDisplayName="Using Offline Data" pageTitle="Usando dados offline em Serviços Móveis (Xamarin iOS) | Centro de desenvolvimento móvel" metaKeywords="" description="Saiba como usar serviços móveis do Azure para cache e sincronização de dados offline no aplicativo iOS Xamarin" metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Using offline data in Mobile Services" authors="donnam" editor="wesmc" manager="dwrede"/>
