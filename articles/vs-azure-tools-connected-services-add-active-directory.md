---
title: Adicionando um Active Directory do Azure usando Serviços Conectados no Visual Studio | Microsoft Docs
...
4. Na primeira página de **Configurar Autenticação do AD do Azure**, marque **Configurar Logon Único usando o AD do Azure**.
