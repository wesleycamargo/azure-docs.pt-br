...
As seguintes permissões de [controle de acesso baseado em função](../role-based-access-control/overview.md) são necessárias para usar a Visão do Desempenho de Consulta: 
