...
- O preço de um pool elástico baseia-se no número de eDTUs do pool e no número de bancos de dados do pool. O preço de um pool elástico é independente da utilização dos bancos de dados elásticos dentro dele.
