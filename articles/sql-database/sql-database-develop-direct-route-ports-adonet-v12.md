<properties 
	pageTitle="Portas além da 1433 para ADO.NET 4.5, ODBC 11 e Banco de Dados SQL V12 | Microsoft Azure"
...
# Portas além da 1433 para ADO.NET 4.5, ODBC 11 e Banco de Dados SQL V12
...
- Internamente, o ADO.NET 4.5 usa ODBC 11.
 - Estas informações se aplicam ao ADO.NET 4.5 e também ao ODBC 11.
...
#### *Dentro:* o cliente é executado em uma VM do Azure
...
- Considerações sobre a lógica de repetição: [a seção "O gateway não fornece mais a lógica de repetição na V12" do tópico "Conectar-se ao Banco de Dados SQL: links, práticas recomendadas e diretrizes de design"](sql-database-connect-central-recommendations.md#gatewaynoretry)

- O ADO.NET 4.6 foi lançado em 20 de julho de 2015. Um anúncio do blog da equipe do .NET está disponível [aqui](http://blogs.msdn.com/b/dotnet/archive/2015/07/20/announcing-net-framework-4-6.aspx).

- O ADO.NET 4.5 foi lançado em 15 de agosto de 2012. Um anúncio do blog da equipe do .NET está disponível [aqui](http://blogs.msdn.com/b/dotnet/archive/2012/08/15/announcing-the-release-of-net-framework-4-5-rtm-product-and-source-code.aspx).
