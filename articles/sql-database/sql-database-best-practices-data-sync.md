...
---
# <a name="best-practices-for-azure-sql-data-sync-preview"></a>Práticas recomendadas para a Sincronização de Dados SQL do Azure (versão prévia) 
