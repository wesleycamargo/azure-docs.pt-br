...
Para ver as camadas de serviço recomendadas para os bancos de dados obsoletos, você pode usar o [portal do Azure](https://portal.azure.com) ou o PowerShell. Para instruções passo a passo, consulte:

- [Atualização para o Banco de Dados SQL V12 (Portal do Azure)](sql-database-v12-upgrade.md)
...
O serviço de banco de dados SQL expõe as informações no Portal Clássico e nas exibições do sistema, para fornecer para você a comparação sugerida do novo serviço da camada e nível de desempenho para o seu banco de dados Web ou Business existente.
...
Use o Portal do Azure para obter uma visão geral de alto nível do uso de percentual DTU e, em seguida, analise os detalhes usando exibições do sistema.

Você também pode usar o Portal do Azure para exibir a camada de serviço recomendada para seu banco de dados Web ou Business quando atualiza um servidor para Banco de Dados SQL do Azure V12.

### Como exibir a camada de serviço recomendada no Portal do Azure
...
1. Faça o logon no [Portal do Azure](https://portal.azure.com) e navegue até um servidor que contenha um banco de dados Web ou Business.
...
1. Faça o logon no [Portal Clássico](https://manage.windowsazure.com) e navegue para um banco de dados Web ou Business existente.
...
| :---| :---|
| [Portal Clássico do Azure](https://manage.windowsazure.com) | clique na guia **ESCALA** na página do painel de seu banco de dados. |
...
Se você usou o Portal Clássico para a atualização, uma notificação também estará disponível do portal para a operação.
...
- **Alertas:** configurar “Alertas” no Portal Clássico do Azure para ser notificado quando o consumo de DTU de um banco de dados atualizado aproximar-se de certo nível elevado. Alertas de banco de dados podem ser configurados no Portal Clássico do Azure para várias métricas de desempenho como Log, CPU, E/S e DTU. 
