---
title: Saiba mais sobre Backups do Banco de Dados SQL | Microsoft Docs
...
> [!NOTE]
> Os backups locais e com redundância geográfica ocorrem automaticamente. Você não precisa fazer nada para que eles ocorram, e não há qualquer custo adicional. 
> 
> 
...
> [!NOTE]
> O Banco de Dados SQL cria automaticamente backups locais do banco de dados e backups com redundância geográfica. Você não precisa fazer nada para que isso ocorra. Não há qualquer custo adicional.
> 
> 
