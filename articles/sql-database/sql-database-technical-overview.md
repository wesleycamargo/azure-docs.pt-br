...
Este artigo é uma introdução aos principais conceitos e recursos do Banco de Dados SQL relacionados ao desempenho, escalabilidade e gerenciabilidade, com links para explorar os detalhes. Consulte estes inícios rápidos para começar:
...
Para ver vários exemplos da CLI do Azure e do PowerShell, consulte:
 - [Amostras da CLI do Azure para o banco de dados SQL do Azure](sql-database-cli-samples.md)
