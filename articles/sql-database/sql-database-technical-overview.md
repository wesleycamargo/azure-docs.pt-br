...
O Banco de Dados SQL do Azure é um DBaaS (banco-de- dados-como-um-serviço) na nuvem da Microsoft ("Azure"). Com essa oferta de plataforma-como-um-serviço, a Microsoft trata todos os patches e a atualização da base de código SQL sem interrupções e abstrai todo o gerenciamento da infraestrutura subjacente. O Banco de Dados SQL compartilha seu código-base com o [mecanismo de banco de dados do Microsoft SQL Server](https://docs.microsoft.com/sql/sql-server/sql-server-technical-documentation). 

A Microsoft está atualmente gerenciando milhões de bancos de dados de produção executando uma ampla gama de aplicativos e cargas de trabalho, de dados transacionais simples a aplicativos com grande uso de dados e críticos para a missão que exigem processamento de dados avançado em escala global. O serviço Banco de Dados SQL está atualmente 38 data centers ao redor do mundo, e mais data centers ficam online regularmente.  

O Banco de Dados SQL é um banco de dados relacional de uso geral que dá suporte a estruturas como XML, JSON, espacial e dados relacionais. Ele oferece [desempenho dinamicamente escalonável](sql-database-service-tiers.md) e fornece opções como [índices columnstore](https://docs.microsoft.com/sql/relational-databases/indexes/columnstore-indexes-overview) para análise e geração de relatórios extremas e [OLTP in-memory](sql-database-in-memory.md) para processamento transacional extremo. 
