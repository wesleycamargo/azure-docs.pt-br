---
title: "Visão geral da consulta de banco de dados elástico do Banco de Dados SQL do Azure | Microsoft Docs"
...
---
# <a name="azure-sql-database-elastic-database-query-overview-preview"></a>Visão geral da consulta de banco de dados elástico do Banco de Dados SQL do Azure (visualização)
...
## <a name="elastic-database-query-scenarios"></a>Cenários de consulta de banco de dados elástico
...
![ Consulta de banco de dados elástico usada na camada de dados escalada horizontalmente][1]
...
### <a name="topology-2-horizontal-partitioning--sharding"></a>Topologia 2: particionamento horizontal – fragmentação
...
> [!NOTE]
> O banco de dados dedicado da consulta de banco de dados elástico deve ser um banco de dados do Banco de Dados SQL v12. Não há nenhuma restrição sobre os próprios fragmentos.
> 
> 
...
## <a name="implementing-elastic-database-queries"></a>Implementando consultas do banco de dados elástico
...
Mais informações sobre as etapas necessárias para o cenário de particionamento vertical podem ser encontradas em [consulta elástica para o particionamento vertical](sql-database-elastic-query-vertical-partitioning.md).  
