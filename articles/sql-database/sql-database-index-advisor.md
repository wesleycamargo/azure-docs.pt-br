...
Recomendações para **Remover Índice** aparecem quando o serviço de Banco de Dados SQL detecta índices duplicados (atualmente em versão de visualização e aplica-se somente a índices duplicados).
