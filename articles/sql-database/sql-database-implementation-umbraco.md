...
![Logotipo da Umbraco](./media/sql-database-case-study-umbraco/umbracologo.png)
...
![A figura 1](./media/sql-database-case-study-umbraco/figure1.png)
...
2.	Utilização
    ...
    ![A figura 3](./media/sql-database-case-study-umbraco/figure3.png)
