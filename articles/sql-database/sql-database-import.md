...
- Não há suporte para a importação de um banco de dados no pool elástico. Você pode importar para um banco de dados individual e, em seguida, mover o banco de dados para um pool.
