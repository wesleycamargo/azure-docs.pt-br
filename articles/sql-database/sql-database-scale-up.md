---
title: Alterar a camada de serviço e o nível de desempenho de um banco de dados SQL do Azure
...
4. Clique no banco de dados que você deseja alterar.
5. Na folha do Banco de dados SQL, clique em **Todas as configurações** e em **Tipo de preço (DTUs de escala)**:
   
   ![Tipo de preços][1]
6. Selecione uma nova camada e clique em **Selecionar**:
...
7. Na faixa de opções à esquerda, clique em **Notificações**:
...
1. Clique em **PROCURAR TUDO**.
2. Clique em **Bancos de dados SQL**.
3. Clique no banco de dados atualizado.
4. Verifique o **Tipo de preço** e confirme se ele está definido como o tipo correto.
