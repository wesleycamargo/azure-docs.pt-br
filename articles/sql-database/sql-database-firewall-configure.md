---
title: Regras de firewall do Banco de Dados SQL e do SQL Data Warehouse do Azure | Microsoft Docs
description: Saiba como configurar um firewall do Banco de Dados SQL e do SQL Data Warehouse com regras de firewall no nível do servidor para gerenciar o acesso e configurar regras de firewall no nível do Banco de Dados SQL.
...
ms.locfileid: "55477668"
---
# <a name="azure-sql-database-and-sql-data-warehouse-firewall-rules"></a>Regras de firewall do Banco de Dados SQL e do SQL Data Warehouse do Azure
...
> [!IMPORTANT]
> Este artigo faz *não* se aplica ao **Banco de Dados de Instância Gerenciada do SQL**. Consulte o seguinte artigo sobre [Conectar-se a uma Instância Gerenciada](sql-database-managed-instance-connect-app.md) para obter mais informações sobre a configuração de rede necessária.
...
> [!IMPORTANT]
> O SQL Data Warehouse dá suporte somente às regras de firewall no nível do servidor e não dá suporte às regras de firewall no nível do banco de dados.
...
A primeira configuração de firewall no nível do servidor pode ser criada usando o [Portal do Azure](https://portal.azure.com/) ou com programação usando [Azure PowerShell](https://docs.microsoft.com/powershell/module/azurerm.sql), [CLI do Azure](/cli/azure/sql/server/firewall-rule#az-sql-server-firewall-rule-create) ou a [API REST](https://docs.microsoft.com/rest/api/sql/firewallrules/createorupdate). As regras de firewall no nível de servidor subsequentes podem ser criadas e gerenciados usando esses métodos e por meio de Transact-SQL.
...
Para definir uma regra de firewall no nível do servidor no portal do Azure, você pode acessar a página de Visão geral de seu Banco de Dados SQL do Azure ou a página de Visão geral do seu servidor de Banco de Dados SQL.
...
1. Para definir uma regra de firewall de nível de servidor da página de visão geral do banco de dados, clique em **Definir o firewall do servidor** na barra de ferramentas, conforme mostrado na imagem a seguir: A página **Configurações do firewall** do servidor de Banco de Dados SQL é aberta.
...
> [!TIP]
> Para exemplos do PowerShell no contexto de um início rápido, confira [Criar banco de dados – PowerShell](sql-database-powershell-samples.md) e [Criar um banco de dados individual e configurar uma regra de firewall de Banco de Dados SQL usando o PowerShell](scripts/sql-database-create-and-configure-database-powershell.md)

## <a name="manage-firewall-rules-using-azure-cli"></a>Gerenciar regras de firewall usando a CLI do Azure

| Cmdlet | Nível | DESCRIÇÃO |
| --- | --- | --- |
|[az sql server firewall-rule create](/cli/azure/sql/server/firewall-rule#az-sql-server-firewall-rule-create)|Servidor|Cria uma regra de firewall de servidor|
|[az sql server firewall-rule list](/cli/azure/sql/server/firewall-rule#az-sql-server-firewall-rule-list)|Servidor|Lista as regras de firewall em um servidor|
...
|[az sql server firewall-rule delete](/cli/azure/sql/server/firewall-rule#az-sql-server-firewall-rule-delete)|Servidor|Exclui uma regra de firewall|
...
> [!TIP]
> Para obter exemplos da CLI do Azure no contexto de um Início Rápido, confira [Criar DB – CLI do Azure](sql-database-cli-samples.md) e [Criar um banco de dados individual e configurar uma regra de firewall de Banco de Dados SQL usando a CLI do Azure](scripts/sql-database-create-and-configure-database-cli.md)
...
| [Obter regras de Firewall](https://docs.microsoft.com/rest/api/sql/firewallrules/get) | Servidor | Obtém as regras de firewall de nível de servidor |
