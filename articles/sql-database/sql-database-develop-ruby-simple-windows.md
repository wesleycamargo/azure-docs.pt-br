...
Este tópico apresenta um exemplo de código Ruby que é executado em um computador Windows executando Windows 8.1 para se conectar a um Banco de Dados SQL do Azure.
