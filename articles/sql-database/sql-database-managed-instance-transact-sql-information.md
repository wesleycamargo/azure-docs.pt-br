...
Há suporte para replicação na Instância Gerenciada. Para saber mais sobre a Replicação, consulte [Replicação do SQL Server](http://review.docs.microsoft.com/sql/relational-databases/replication/replication-with-sql-database-managed-instance).
