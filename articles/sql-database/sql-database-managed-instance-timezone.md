...
ms.locfileid: "64866942"
---
# <a name="time-zones-in-azure-sql-database-managed-instance-preview"></a>Fusos horários no banco de dados de instância gerenciada do SQL (versão prévia)
