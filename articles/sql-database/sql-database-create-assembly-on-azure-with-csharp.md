...
A lista acima não menciona...<br/> **execute sp\_configure 'clr enabled', 1;**<br/> ...pois não é necessário para o Banco de Dados SQL do Azure, mesmo que seja necessário para o Microsoft SQL Server.
