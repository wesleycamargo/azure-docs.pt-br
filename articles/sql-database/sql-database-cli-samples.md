...
| [Criar e gerenciar uma Instância Gerenciada](https://medium.com/azure-sqldb-managed-instance/working-with-sql-managed-instance-using-azure-cli-611795fe0b44) | Esses scripts da CLI mostram que você precisa criar e gerenciar uma Instância Gerenciada usando a CLI do Azure |
|||
