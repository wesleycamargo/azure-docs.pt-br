...
> [AZURE.IMPORTANT] A partir de **meados de junho de 2016**, no Banco de Dados SQL do Azure, o nível de compatibilidade padrão será de 130, em vez de 120 para bancos de dados **recém-criados**.
> 
