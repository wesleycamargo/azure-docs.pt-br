<properties 
	pageTitle="Gerenciamento de credenciais da Escala Elástica" 
	description="Como definir o nível certo de credenciais de administrador somente leitura para aplicativos de escala elástica." 
