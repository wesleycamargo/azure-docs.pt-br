...
Usando o Azure PowerShell, crie [grupos de failover](sql-database-auto-failover-group.md) entre o SQL Server do Azure existente e o novo SQL Server do Azure vazio em uma região do Azure e adicione o banco de dados de exemplo ao grupo de failover.
