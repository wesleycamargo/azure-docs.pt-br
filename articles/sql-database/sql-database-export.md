...
) ou a [Automação do Azure](https://github.com/Microsoft/azure-docs/blob/2461f706f8fc1150e69312098640c0676206a531/articles/automation/automation-intro.md) para arquivar bancos de dados SQL periodicamente, usando o PowerShell de acordo com um agendamento de sua escolha. Para obter uma amostra, baixe o [script de exemplo do PowerShell](https://github.com/Microsoft/sql-server-samples/tree/master/samples/manage/azure-automation-automated-export) no GitHub.
>
...
Para monitorar o progresso da operação de exportação, abra a página para o servidor de Banco de Dados SQL que contém o banco de dados que está sendo exportado. Role para baixo até **Operações** e, em seguida, clique em **Importar/Exportar histórico**.
