...
Este artigo fornece instruções para exportar seu Banco de Dados SQL Azure para um arquivo BACPAC (armazenado no armazenamento de blobs do Azure) usando o [portal do Azure](https://portal.azure.com).
