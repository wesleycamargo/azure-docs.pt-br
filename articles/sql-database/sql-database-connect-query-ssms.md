...
[!INCLUDE [Instalação do SSMS](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [Conexão SSMS](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
