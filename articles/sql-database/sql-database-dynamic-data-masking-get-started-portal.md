---
title: Introdução à Máscara de Dados Dinâmicos do Banco de Dados SQL (Portal clássico do Azure)
...
> [!NOTE]
> Para configurar a máscara de dados dinâmicos no Portal do Azure, confira [Introdução à Máscara de Dados Dinâmicos do Banco de Dados SQL (portal do Azure)](sql-database-dynamic-data-masking-get-started.md).
> 
> 
