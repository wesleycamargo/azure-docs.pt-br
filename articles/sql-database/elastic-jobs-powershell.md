...
- Instalar o módulo **AzureRM.Sql** 4.8.1-preview mais recente para obter os cmdlets de Trabalho Elástico. Execute os comandos a seguir no PowerShell com acesso administrativo.
...
- Além do módulo **AzureRM.Sql** 4.8.1-preview, este tutorial também exige o módulo *sqlserver* do PowerShell. Para obter detalhes, confira [Instalar o módulo do SQL Server PowerShell](https://docs.microsoft.com/sql/powershell/download-sql-server-ps-module).
