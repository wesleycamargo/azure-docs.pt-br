...
Instalar o módulo de versão prévia **AzureRM.Sql** mais recente para obter os cmdlets Trabalho Elástico. Execute os seguintes comandos em um prompt de comandos com privilégios elevados (executar como administrador).
