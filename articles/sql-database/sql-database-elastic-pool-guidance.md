...
Avalie se usar um pool elástico é econômico com base em padrões de uso do banco de dados e diferenças de preços entre um pool elástico e os bancos de dados individuais. Diretrizes adicionais também são fornecidas para ajudar a determinar o tamanho do pool atual necessário para um conjunto existente de Bancos de Dados SQL.  
