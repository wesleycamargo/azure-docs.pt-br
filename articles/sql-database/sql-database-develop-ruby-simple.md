---
title: Conectar-se ao Banco de Dados SQL usando Ruby | Microsoft Docs
...
---
# <a name="connect-to-sql-database-by-using-ruby"></a>Conectar-se ao Banco de Dados SQL usando o Ruby
...
* Mais informações sobre o [Microsoft Ruby Driver para SQL Server](https://docs.microsoft.com/sql/connect/ruby/ruby-driver-for-sql-server/)
