...
Este artigo mostrará como criar tudo o que você precisa para criar e configurar um pool de banco de dados elástico, exceto a assinatura do Azure. Se você precisar de uma assinatura do Azure basta clicar em **AVALIAÇÃO GRATUITA** na parte superior desta página e, em seguida, voltar para concluir este artigo.
...
Para criar um novo banco de dados diretamente dentro de um pool, use o cmdlet **New-AzureRMSqlDatabase** e defina o parâmetro **ElasticPoolName**.
...
Para mover um banco de dados existente para um pool, use o cmdlet **Set-AzureRMSqlDatabase** e defina o parâmetro **ElasticPoolName**.
