...
## <a name="a-idazuresqlaazure-sql-database-and-sql-server-on-virtual-machines"></a><a id="AzureSQL"></a>Banco de dados SQL do Azure e SQL Server em máquinas virtuais
...
## <a name="a-idodbcadata-access-technologies-odbc-and-ole-db"></a><a id="ODBC"></a>Tecnologias de acesso a dados: ODBC e OLE DB
...
## <a name="a-idcreateastep-1--creating-your-azure-sql-database"></a><a id="Create"></a>Etapa 1: Criando seu Banco de Dados SQL do Azure
...
## <a name="a-idconnectionstringastep-2--get-connection-string"></a><a id="ConnectionString"></a>Etapa 2: Obter a cadeia de conexão
...
## <a name="a-idfirewallastep-3--add-your-ip-to-the-firewall"></a><a id="Firewall"></a>Etapa 3: Adicionar o IP do firewall
...
## <a name="a-idwindowsastep-4-connecting-from-a-windows-cc-application"></a><a id="Windows"></a>Etapa 4: Conectando de um aplicativo Windows C/C++
...
## <a name="a-idlinuxastep-5-connecting-from-a-linux-cc-application"></a><a id="Linux"></a>Etapa 5: Conectando de um aplicativo Linux C/C++
...
Inicie o Visual Studio 2015. Em Ferramentas -> Opções -> várias plataformas -> C++ -> Gerenciador de conexões, adicione uma conexão à sua caixa do Linux: 
...
## <a name="a-idgetsolutionaget-the-complete-cc-tutorial-solution"></a><a id="GetSolution"></a>Obter a solução completa do tutorial de C/C++
...
* Mais informações na [Referência da API ODBC](https://msdn.microsoft.com/library/ms714562\(v=vs.85\).aspx)
