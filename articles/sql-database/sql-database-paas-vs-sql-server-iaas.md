...
|  | Bancos de dados de até 100 TB. | Mesmo que o Banco de Dados SQL. | Instâncias do SQL Server com até 64 TB de armazenamento. A instância pode suportar quantos bancos de dados forem necessários. |
...
| **Recursos:** | Você não deseja empregar recursos de TI para configuração e gerenciamento da infraestrutura subjacente, mas deseja se concentrar na camada de aplicativos. | Mesmo que o Banco de Dados SQL. | Você tem alguns recursos de TI para a configuração e o gerenciamento. Alguns recursos automatizados fornecidos simplificam muito isso. |
