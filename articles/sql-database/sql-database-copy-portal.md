...
6. Depois de escolher o **Servidor de destino**, o **Pool de banco de dados elástico** e o **Tipo de preço** as opções serão habilitadas. Se o servidor tiver um pool, você poderá copiar o banco de dados nele.
