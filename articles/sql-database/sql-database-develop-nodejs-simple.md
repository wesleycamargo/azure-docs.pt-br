---
title: Conectar-se ao Banco de Dados SQL usando Node.js | Microsoft Docs
...
---
# <a name="connect-to-sql-database-by-using-nodejs"></a>Conectar-se ao Banco de Dados SQL usando Node.js
