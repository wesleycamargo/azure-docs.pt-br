...
## <a name="a-idsubheading-8ablobtable-differences-in-server-auditing-policy-inheritance"></a><a id="subheading-8"></a>Blob/tabela diferenças na herança de diretiva de auditoria do servidor

###<a name="ablob-auditinga"></a><a>Auditoria de blob</a>
