...
# Como se conectar a um Banco de Dados SQL do Azure com o SSMS

Estas são as etapas para conectar-se ao Banco de Dados SQL do Microsoft Azure usando o SQL Server Management Studio.
