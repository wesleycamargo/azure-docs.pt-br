...
Observe o seguinte no script *DeployReferenceData.sql*:
...
No SSMS, procure o banco de dados de locatários no servidor *tenants1-mt-&lt;user&gt;* e consulte a tabela *VenueTypes* para confirmar se *Motorcycle Racing* e *Swimming Club* agora foram **adicionados* à tabela.
...
Observe o seguinte no script *OnlineReindex.sql*:
