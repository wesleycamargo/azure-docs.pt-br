<properties
	pageTitle="Como configurar um firewall do SQL Server | Microsoft Azure"
...
# Como configurar um firewall do SQL Server usando o Portal do Azure
