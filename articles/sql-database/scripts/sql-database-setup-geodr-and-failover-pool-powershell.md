...
| [Set-AzureRmSqlDatabaseSecondary](/powershell/module/azurerm.sql/set-azurermsqldatabasesecondary)| Define um banco de dados secundário como primário para iniciar o failover.|
