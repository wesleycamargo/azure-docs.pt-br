...
# <a name="use-powershell-to-import-a-pacpac-file-into-an-azure-sql-database"></a>Use o PowerShell para importar um arquivo PACPAC para um banco de dados SQL do Azure
