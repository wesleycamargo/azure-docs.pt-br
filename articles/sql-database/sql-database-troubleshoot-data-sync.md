...
## <a name="troubleshooting-sync"></a>Sincronizar solução de problemas
...
## <a name="troubleshooting-the-client-agent"></a>O agente cliente de solução de problemas
...
**O agente de cliente e groupo de sincronização estão em diferentes data centers**
...
-   Crie um novo agente no mesmo data center do grupo de sincronização. Em seguida, registre o banco de dados nesse agente.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Solução de problemas de configuração e manutenção
...
3. Adicione a conta de usuário à caixa de diálogo de **Fazer logon como serviço** **Propriedades**.
...
Se você restaurar um banco de dados perdido ou corrompido de um backup, pode haver não convergência de dados no grupo de sincronização ao qual pertence o banco de dados.
