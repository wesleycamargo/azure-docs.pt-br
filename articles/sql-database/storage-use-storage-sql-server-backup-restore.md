...
Para obter mais informações sobre os serviços de armazenamento de blobs do Azure, consulte [Como usar o serviço de armazenamento de blobs do Azure](http://azure.microsoft.com/develop/net/how-to-guides/blob-storage/)
...
Para obter mais informações sobre blobs, consulte [Noções básicas sobre blobs de bloco e de página](http://msdn.microsoft.com/library/azure/ee691964.aspx)
