<properties urlDisplayName="How to create and provision" pageTitle="Introdu&ccedil;&atilde;o ao Banco de Dados SQL - Azure" metaKeywords="" description="Introdu&ccedil;&atilde;o &agrave; cria&ccedil;&atilde;o e ao gerenciamento de Bancos de Dados SQL no Azure." metaCanonical="" services="sql-database" documentationCenter="" title="Introdu&ccedil;&atilde;o ao banco de dados SQL do Azure" authors="loclar"  solutions="" writer="" manager="jeffreyg" editor="tysonn"  />
...
1.  Abra um navegador da web e navegue para <http://azure.microsoft.com>.
...
**Observação:**Os valores de esquema e de dados são obtidos deste [MSDN][MSDN] e foram modificados para funcionar com o Banco de Dados SQL.
