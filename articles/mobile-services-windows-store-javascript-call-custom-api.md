<properties urlDisplayName="Call a custom API from the client" pageTitle="Chamar uma API personalizada de um cliente JS da Windows Store - Serviços móveis" metaKeywords ="" description="Saiba como definir um API personalizado e, em seguida, chamá-lo a partir de um aplicativo da Windows Store que usa os Serviços Móveis do Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Call a custom API from the client" authors="glenga" solutions="" manager="dwrede" editor="" />
