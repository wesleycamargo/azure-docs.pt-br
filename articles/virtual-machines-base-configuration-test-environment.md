...
- O [ambiente de nuvem híbrida simulada](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md).
...
Sua configuração de base no Azure agora está pronta para desenvolvimento e teste de aplicativos ou para ambientes de teste adicionais, como o [ambiente de nuvem híbrida simulada](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md).

## Recursos adicionais

[Ambientes de teste de nuvem híbrida](virtual-networks-setup-hybrid-cloud-environment-testing.md)
