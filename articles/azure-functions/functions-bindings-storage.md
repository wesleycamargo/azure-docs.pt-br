---
title: "Gatilhos e associações de Azure Functions para Armazenamento do Azure | Microsoft Docs"
...
---
# <a name="azure-functions-triggers-and-bindings-for-azure-storage"></a>Gatilhos e associações de Azure Functions para Armazenamento do Azure
...
## <a name="a-idstoragequeuetriggera-azure-storage-queue-trigger"></a><a id="storagequeuetrigger"></a> Gatilho de fila do Armazenamento do Azure
#### <a name="functionjson-for-storage-queue-trigger"></a>function.json para um gatilho de fila de armazenamento
...
#### <a name="queue-trigger-supported-types"></a>Tipos de gatilho de fila com suporte
...
## <a name="a-idstoragequeueoutputa-azure-storage-queue-output-binding"></a><a id="storagequeueoutput"></a> Associação de saída de fila do Armazenamento do Azure
#### <a name="functionjson-for-storage-queue-output-binding"></a>function.json de uma associação de saída de fila de armazenamento
O arquivo *function.json* especifica as propriedades a seguir.
...
#### <a name="queue-output-binding-supported-types"></a>Tipos de associação de saída de fila com suporte
...
#### <a name="queue-output-binding-code-examples"></a>Exemplos de código de associação de saída de fila
...
## <a name="a-idstorageblobtriggera-azure-storage-blob-trigger"></a><a id="storageblobtrigger"></a> Gatilho de blob do Armazenamento do Azure
#### <a name="functionjson-for-storage-blob-trigger"></a>function.json para um gatilho de blob de armazenamento
O arquivo *function.json* especifica as propriedades a seguir.
...
#### <a name="blob-trigger-supported-types"></a>Tipos de gatilho de blob com suporte
...
#### <a name="blob-trigger-c-code-example"></a>Exemplo de código C# de gatilho de blob
...
#### <a name="blob-trigger-name-patterns"></a>Padrões de nome do gatilho de blob
...
## <a name="a-idstorageblobbindingsa-azure-storage-blob-input-and-output-bindings"></a><a id="storageblobbindings"></a> Associações de entrada e de saída de blob do Armazenamento do Azure
#### <a name="functionjson-for-a-storage-blob-input-or-output-binding"></a>function.json de uma associação de entrada ou de saída de blobs de armazenamento
O arquivo *function.json* especifica as propriedades a seguir.
...
#### <a name="blob-input-and-output-supported-types"></a>Tipos de entrada e de saída de blob com suporte
...
#### <a name="blob-output-c-code-example"></a>Exemplo de código C# de saída de blob
...
## <a name="a-idstoragetablesbindingsa-azure-storage-tables-input-and-output-bindings"></a><a id="storagetablesbindings"></a> Associações de entrada e de saída de tabelas do Armazenamento do Azure
...
#### <a name="storage-tables-input-and-output-supported-types"></a>Tipos de entrada e de saída de tabelas de armazenamento com suporte
...
#### <a name="storage-tables-binding-scenarios"></a>Cenários de associação de tabelas de armazenamento
...
#### <a name="storage-tables-example-read-a-single-table-entity-in-c-or-node"></a>Exemplo de tabelas de armazenamento: ler uma única entidade de tabela em C# ou em Node
...
#### <a name="storage-tables-example-create-a-table-entity-in-node"></a>Exemplo de tabelas de armazenamento: criar uma entidade de tabela em Node
