...
* Siga as instruções em "Instalar as ferramentas básicas do Azure Functions" em [Codificar e testar o Azure Functions localmente](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local)
