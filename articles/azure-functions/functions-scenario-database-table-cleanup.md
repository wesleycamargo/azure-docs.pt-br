...
> [!IMPORTANT]
> Os exemplos neste documento são aplicáveis ao tempo de execução 1.x. Informações de como criar um aplicativo de funções 1.x [podem ser encontradas aqui](./functions-versions.md#creating-1x-apps).
