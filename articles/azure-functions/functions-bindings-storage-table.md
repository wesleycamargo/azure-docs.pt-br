...
Este artigo explica como configurar e codificar gatilhos e associações das tabelas de Armazenamento do Azure no Azure Functions. O Azure Functions dá suporte a associações de entrada e saída para tabelas do Armazenamento do Azure.
