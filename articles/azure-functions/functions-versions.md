...
As associações experimentais com as quais o tempo de execução 1.x é compatível não estão disponíveis no 2.x. Para obter informações sobre o suporte a associações e outras lacunas funcionais no 2.x, consulte [Problemas conhecidos do tempo de execução 2.0](https://github.com/Azure/azure-webjobs-sdk-script/wiki/Azure-Functions-runtime-2.0-known-issues).
