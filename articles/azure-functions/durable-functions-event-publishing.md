...
* Instale a [CLI do Azure 2.0](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest) ou use o [Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview)
