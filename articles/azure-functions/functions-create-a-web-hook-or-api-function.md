...
## <a name="create-a-webhooktriggered-function-from-the-template"></a>Criar uma função disparada por webhook por meio do modelo
...
1. Copie a **URL de Função** e os valores do **Segredo do GitHub**. Você precisará deles ao criar o webhook no GitHub. 
2. Role para baixo até **Executar**, observe o corpo JSON predefinido de um comentário do problema no corpo da Solicitação e clique em **Executar**. 
