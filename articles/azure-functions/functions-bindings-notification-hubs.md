...
* [C#script - parâmetro out](#c-script-template-example---out-parameter)
...
|**Nome** |n/d| Nome da variável usada no código de função para a mensagem do hub de notificação. |
