...
### [Criar uma definição de OpenAPI (visualização)](functions-api-definition-getting-started.md)
#### [OpenAPI 2.0 na referência de Funções](functions-api-definition.md)
