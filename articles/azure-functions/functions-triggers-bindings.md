...
| [Hubs de Evento](functions-bindings-event-hubs.md) | [Hubs de Notificação](functions-bindings-notification-hubs.md) | [SendGrid](functions-bindings-sendgrid.md) | [Twilio](functions-bindings-twilio.md) |   
| | | | |  
