...
O Azure Functions em execução no serviço do Plano do Serviço de Aplicativo estão em execução no mesmo serviço de aplicativos web, portanto, toda documentação para Aplicativos Web se aplicará às Funções dedicadas.
