---
title: 'Preview dos Serviços de Domínio do Azure Active Directory: Guia de Administração | Microsoft Docs'
...
2. **Instalar o sssd:** o pacote realmd depende do sssd para executar as operações de ingresso no domínio. No terminal do PuTTY, digite o comando a seguir.
...
3. **Instalar o kerberos:** no terminal do PuTTY, digite o comando a seguir.
