...
Não, atualmente não é possível habilitar os Serviços de Domínio do Azure AD usando um modelo. Em vez disso, use o PowerShell, veja [como habilitar os Serviços de Domínio do Azure AD usando o PowerShell](active-directory-ds-enable-using-powershell.md).
