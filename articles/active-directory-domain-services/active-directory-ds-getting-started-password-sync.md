...
## <a name="task-5-enable-password-synchronization-to-aad-domain-services-for-a-cloudonly-azure-ad-tenant"></a>Tarefa 5: habilitar a sincronização de senhas para os Serviços de Domínio do AAD para um locatário do Azure AD somente na nuvem
...
### <a name="enable-ntlm-and-kerberos-credential-hash-generation-for-a-cloudonly-azure-ad-tenant"></a>Habilitar a geração de hashes de credencial Kerberos e NTLM para um locatário do Azure AD somente na nuvem
