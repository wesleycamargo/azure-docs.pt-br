...
# Introdução
## [Criar um grupo administrativo](active-directory-ds-getting-started-create-group.md)
...
## [Atualizar as configurações de DNS](active-directory-ds-getting-started-update-dns.md)
