...
> [!NOTE]
> **Implante os Serviços de Domínio do Azure AD em uma sub-rede separada dedicada em sua rede virtual do Azure. Não aplique o NSG à sub-rede dedicada. Não habilite os Serviços de Domínio do Azure AD na sub-rede do gateway da sua rede virtual.**
> 
> 
