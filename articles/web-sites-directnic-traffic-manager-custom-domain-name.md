<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Directnic" pageTitle="Configure um nome de domínio Directnic para um site do Azure utilizando o Gerenciador de Tráfego" metaKeywords="do Microsoft Azure, Sites do Microsoft Azure, Directnic, Gerenciador de Tráfego" description="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Directnic" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
