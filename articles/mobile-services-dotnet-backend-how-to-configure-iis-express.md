<properties pageTitle="Configurar o IIS Express para teste local de Serviço Móvel" metaKeywords="Serviços Móveis do Azure, back-end do .NET, IIS Express" description="Saiba como configurar o IIS Express para permitir conexões a um projeto de serviço móvel local para teste." authors="glenga" title="Configurar o servidor web local para permitir conexões a um Serviço Móvel local" />
