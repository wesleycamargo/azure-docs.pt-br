<properties linkid="manage-services-how-to-monitor-a-storage-account" urlDisplayName="Como monitorar" pageTitle="Como monitorar uma conta de armazenamento | Microsoft Azure" metaKeywords="Azure monitora contas de armazenamento, portal de gerenciamento da conta de armazenamento, painel da conta de armazenamento, tabela de métricas de armazenamento, gráfico de métricas de armazenamento" description="Saiba como monitorar uma conta de armazenamento no Azure usando o Portal de Gerenciamento." metaCanonical="" services="storage" documentationCenter="" title="Como monitorar uma conta de armazenamento" authors="tamram" solutions="" manager="mbaldwin" editor="cgronlun" />





<h1><a id="createstorageaccount"></a>Como monitorar uma conta de armazenamento</h1>
...
<b>Observação</b> 
<p>Lembre-se de que há custos adicionais associados ao exame de dados de monitoramento no Portal de Gerenciamento. Para obter mais informações, consulte <a href="http://msdn.microsoft.com/pt-br/library/windowsazure/hh360997.aspx">Analítica e Cobrança de Armazenamento</a>.</p> 
</div>
...
* [Como configurar o log](#configurelogging)


<h2><a id="configurestoragemonitoring"></a>Como configurar o monitoramento para uma conta de armazenamento</h2>

1. No [Portal de Gerenciamento](https://manage.windowsazure.com/), clique em **Armazenamento** e depois clique no nome da conta de armazenamento para abrir o painel.
...
- Para adicionar uma nova métrica ao gráfico, marque a caixa de seleção próxima ao cabeçalho da métrica. Em uma exibição estreita, clique em**** mais** para acessar cabeçalhos que não podem ser exibidos na área do cabeçalho.

- Para ocultar uma métrica que seja traçada no gráfico, desmarque a caixa de seleção próxima ao cabeçalho da métrica.

	![Monitoramento_e mais](./media/storage-monitor-storage-account/storage_Monitoring_nmore.png)
...
2. Clique em **Monitoramento**
	...
	<div class="dev-callout"> 
	<b>Observação</b> 
	<p>Considere os custos ao selecionar as métricas. Existem transações e custos de saída associados à atualização das exibições do monitoramento. Para obter mais informações, consulte <a href="http://msdn.microsoft.com/pt-br/library/windowsazure/hh360997.aspx">Analítica e Cobrança de Armazenamento</a>.</p> 
</div>
...
4. Passe o mouse por cima do lado direito da caixa de diálogo para exibir uma barra de rolagem que você pode arrastar para rolar métricas adicionais no modo de exibição.
...
<h2><a id="configurelogging"></a>Como configurar o log</h2>
...
3. Para cada um dos serviços (Blob, Tabela e Fila), configure o seguinte:
	...
	- O número de dias que os dados registrados serão mantidos. Se não desejar definir uma política de retenção, digite zero. Se você não definir uma política de retenção, cabe a você excluir os registros.
