...
1.  Abra a janela **Console do Gerenciador de Pacotes NuGet**. No menu **Ferramentas**, selecione **Gerenciador de Pacotes da Biblioteca** e **Console do Gerenciador de Pacotes**.
...
2.  Na guia **Aplicativo** da janela Propriedades, defina a estrutura de Destino como **.NET Framework 4**.
