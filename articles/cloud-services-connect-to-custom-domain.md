...
1.	Este tutorial usa o Powershell, portanto, certifique-se de que o Powershell do Azure esteja instalado e pronto. Para obter ajuda na configuração do Powershell do Azure, consulte [Como instalar e configurar o PowerShell do Azure](install-configure-powershell.md).
