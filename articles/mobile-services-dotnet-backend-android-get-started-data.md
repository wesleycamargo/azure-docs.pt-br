<properties urlDisplayName="Get Started with Data" pageTitle="Introdução aos dados (Android) | Mobile Dev Center" metaKeywords="" description="Saiba como começar a usar os serviços móveis para utilizar dados em seu aplicativo Android." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Get started with data in Mobile Services" authors="ricksal" solutions="" manager="dwrede" editor="" />
...
[Testar o aplicativo do Android no serviço hospedado no Azure]: #test-azure-hosted
