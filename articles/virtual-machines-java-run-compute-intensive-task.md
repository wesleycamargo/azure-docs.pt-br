...
5.  Depois de verificar se o nome do namespace está disponível, escolha o
    ...
    O namespace que você criou aparece no Portal de Gerenciamento e
     demora algum tempo para ser ativado. Aguarde até que o status esteja **Ativo** para passar à próxima etapa.
...
novo namespace, você precisar obter as credenciais de gerenciamento para o
namespace.
...
Para os aplicativos solver e de cliente, é possível pressionar **Ctrl+C** para sair se você quiser encerrar antes da conclusão normal.
  ...
  [Solucionador de problemas do Caixeiro Viajante]: ./media/virtual-machines-java-run-compute-intensive-task/WA_JavaTSPSolver.png
  [Cliente de problemas do Caixeiro Viajante]: ./media/virtual-machines-java-run-compute-intensive-task/WA_JavaTSPClient.png
  [Portal de Gerenciamento do Azure]: https://manage.windowsazure.com
  [Adicionar um certificado no armazenamento de certificados de autoridade de certificação Java]: ../java-add-certificate-ca-store
  [Service Bus Node screenshot]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_02_SvcBusNode.jpg
  [Criar uma captura de tela do novo Namespace]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_03_CreateNewSvcNamespace.jpg
  [Captura de tela de namespaces disponíveis]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_04_SvcBusNode_AvailNamespaces.jpg
  [Captura de tela da lista de namespaces]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_05_NamespaceList.jpg
  [Captura de tela do painel Propriedades]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_06_PropertiesPane.jpg
  [Captura de tela da chave padrão]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_07_DefaultKey.jpg
  [Azure SDK para Java]: http://www.windowsazure.com/pt-br/develop/java/
