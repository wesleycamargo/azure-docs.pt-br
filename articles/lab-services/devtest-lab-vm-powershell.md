...
- [Instalar o Azure PowerShell](/powershell/azure/azurerm/other-install) ou usar o Azure Cloud Shell que é integrado ao portal do Azure. 

## <a name="powershell-script"></a>Script do PowerShell
O script de exemplo nesta seção usa o [Invoke-AzureRmResourceAction](/powershell/module/azurerm.resources/invoke-azurermresourceaction) cmdlet.  Esse cmdlet usa a ID do recurso do laboratório, nome da ação para executar (`createEnvironment`), e os parâmetros necessários executam essa ação. Os parâmetros estão em uma tabela de hash que contém todas as propriedades de descrição da máquina virtual. 
