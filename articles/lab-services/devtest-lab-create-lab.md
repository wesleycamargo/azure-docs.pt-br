...
1. No menu principal à esquerda, selecione **Todos os Serviços** (na parte superior da lista).

    ![Opção do menu Todos os serviços](./media/devtest-lab-create-lab/more-services-menu-option.png)
