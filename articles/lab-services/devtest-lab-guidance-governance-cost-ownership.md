...
Para saber mais, confira a documentação do [Andaime empresarial do Azure – governança de assinatura prescritiva](/architecture/cloud-adoption/appendix/azure-scaffold).
