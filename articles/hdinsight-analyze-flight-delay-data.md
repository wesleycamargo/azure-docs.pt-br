...
Os clusters do Hadoop no HDInsight usam o armazenamento de Blob do Azure para armazenamento de dados. Para obter mais informações, consulte [Usar o Armazenamento de Blob do Azure com o HDInsight][hdinsight-storage].
