<properties 
	...
	description="O tópico também fornece links para estruturas de Player e plug-ins que você pode usar para desenvolver seus próprios aplicativos de cliente que podem consumir mídia de streaming dos Serviços de Mídia." 
	authors="Juliako" 
	manager="dwrede" 
	editor="" 
...
##Reproduzir seu conteúdo com players existentes
...
Para obter mais informações, consulte [Azure Media Player](aka.ms/ampdocs).
