...
Publicador|Nome da imagem|Descrição|Tamanho do disco
---|---|---|---
Barracuda Networks, Inc.|Barracuda Web Application Firewall (WAF) 7.8 PatchLevel 4|Observação: esse utilitário é administrado por meio de uma interface da Web e TCP/8000 precisa ser encaminhado para fazer isso. Consulte o LEIAME de implantação https://cloudvm.cudasvc.com/azure/deployment-readme-waf.html para obter...|Linux|50 GB
Barracuda Networks, Inc.|Barracuda NG Firewall 5.4.3-182 PatchLevel 4|Observação: este dispositivo é gerenciado por meio de um aplicativo cliente e TCP/807 precisa ser encaminhado para fazer isso. Consulte o LEIAME de implantação https://cloudvm.cudasvc.com/azure/deployment-readme-ng.html para...|Linux|80 GB
...
Grupo do Microsoft SQL Server|SQL Server 2012 SP2 Standard no Windows Server 2012|Alguns componentes do SQL Server exigem instalações e configurações adicionais antes do uso. É recomendável que você use uma máquina virtual, tamanho de A2 ou superior. Esta imagem foi pré-configurada para o Azure...|Windows|127 GB
Grupo do Microsoft SQL Server|SQL Server 2014 RTM Standard no Windows Server 2012 R2|Esta imagem contém a versão completa do SQL Server. É recomendável que você use uma máquina virtual, tamanho de A2 ou superior. Esta imagem foi pré-configurada para o Azure, incluindo a habilitação do Programa de Aperfeiçoamento da Experiência do Usuário que...|Windows|127 GB
Grupo do Microsoft Windows Server|Windows Server 2012 R2 Datacenter, junho de 2014|O cerne da visão do Microsoft Cloud OS, o Windows Server 2012 R2 traz a experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura. Oferece desempenho de classe empresarial...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 Datacenter, junho de 2014|O Windows Server 2012 incorpora a experiência da Microsoft em criar e operar nuvens públicas, resultando em uma plataforma de servidor dinâmica e altamente disponível. Oferece escalonável, dinâmica e multi-locatário...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2008 R2 SP1, junho de 2014|O Windows Server 2008 R2 é um servidor multiuso projetado para aumentar a confiabilidade e flexibilidade de seu servidor ou infraestrutura de nuvem privada, ajudando você a economizar tempo e reduzir os custos. Profissionais de TI...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2008 R2 SP1, setembro de 2014|O Windows Server 2008 R2 é um servidor multiuso projetado para aumentar a confiabilidade e flexibilidade de seu servidor ou infraestrutura de nuvem privada, ajudando você a economizar tempo e reduzir os custos. Profissionais de TI...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2008 R2 SP1, outubro de 2014|O Windows Server 2008 R2 é um servidor multiuso projetado para aumentar a confiabilidade e flexibilidade de seu servidor ou infraestrutura de nuvem privada, ajudando você a economizar tempo e reduzir os custos. Profissionais de TI...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2008 R2 SP1, novembro de 2014|O Windows Server 2008 R2 é um servidor multiuso projetado para aumentar a confiabilidade e flexibilidade de seu servidor ou infraestrutura de nuvem privada, ajudando você a economizar tempo e reduzir os custos. Profissionais de TI...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2008 R2 SP1, abril de 2015|O Windows Server 2008 R2 é um servidor multiuso projetado para aumentar a confiabilidade e flexibilidade de seu servidor ou infraestrutura de nuvem privada, ajudando você a economizar tempo e reduzir os custos. Profissionais de TI...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 Datacenter, setembro de 2014|O Windows Server 2012 incorpora a experiência da Microsoft em criar e operar nuvens públicas, resultando em uma plataforma de servidor dinâmica e altamente disponível. Oferece escalonável, dinâmica e multi-locatário...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 Datacenter, novembro de 2014|O Windows Server 2012 incorpora a experiência da Microsoft em criar e operar nuvens públicas, resultando em uma plataforma de servidor dinâmica e altamente disponível. Oferece escalonável, dinâmica e multi-locatário...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 Datacenter, outubro de 2014|O Windows Server 2012 incorpora a experiência da Microsoft em criar e operar nuvens públicas, resultando em uma plataforma de servidor dinâmica e altamente disponível. Oferece escalonável, dinâmica e multi-locatário...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 R2 Datacenter, setembro de 2014|O cerne da visão do Microsoft Cloud OS, o Windows Server 2012 R2 traz a experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura. Oferece desempenho de classe empresarial...|Windows|128 GB
Grupo do Microsoft Windows Server|O Windows Server 2012 R2 Datacenter, outubro de 2014|O cerne da visão do Microsoft Cloud OS, o Windows Server 2012 R2 traz a experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura. Oferece desempenho de classe empresarial...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 R2 Datacenter, novembro de 2014|O cerne da visão do Microsoft Cloud OS, o Windows Server 2012 R2 traz a experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura. Oferece desempenho de classe empresarial...|Windows|128 GB
Grupo do Microsoft Windows Server|Datacenter Windows Server 2012 R2, abril de 2015|O cerne da visão do Microsoft Cloud OS, o Windows Server 2012 R2 traz a experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura. Oferece desempenho de classe empresarial...|Windows|128 GB
Grupo do Microsoft Windows Server|Visualização técnica do Windows Server|Cerne da visão da plataforma Microsoft Cloud, o Windows Server traz a amplitude e profundidade da experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura de datacenter. Windows S...|Windows|128 GB
Grupo do Microsoft Windows Server|Windows Server 2012 Datacenter, abril de 2015|O Windows Server 2012 incorpora a experiência da Microsoft em criar e operar nuvens públicas, resultando em uma plataforma de servidor dinâmica e altamente disponível. Oferece escalonável, dinâmica e multi-locatário...|Windows|128 GB
...
SUSE|SUSE Linux Enterprise Server 11 SP3|Execute com segurança suas cargas de trabalho de produção no SUSE Linux Enterprise Server no Microsoft Azure, sabendo que seus níveis de serviço são garantidos e que ajuda dos engenheiros SUSE e da Microsoft, se você...|Linux|30 GB
SUSE|SUSE Linux Enterprise Server 11 SP3 (Premium Image)|Execute com segurança suas cargas de trabalho de produção no SUSE Linux Enterprise Server no Microsoft Azure, sabendo que seus níveis de serviço são garantidos e que ajuda dos engenheiros SUSE e da Microsoft, se você...|Linux|30 GB
SUSE|SUSE Linux Enterprise Server 12 (Premium Image)|Execute com segurança suas cargas de trabalho de produção no SUSE Linux Enterprise Server no Microsoft Azure, sabendo que seus níveis de serviço são garantidos e que ajuda dos engenheiros SUSE e da Microsoft, se você...|Linux|30 GB
SUSE|SUSE Linux Enterprise Server 12|Execute com segurança suas cargas de trabalho de produção no SUSE Linux Enterprise Server no Microsoft Azure, sabendo que seus níveis de serviço são garantidos e que ajuda dos engenheiros SUSE e da Microsoft, se você...|Linux|30 GB
