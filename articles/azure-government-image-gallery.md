...
---|---|---|---|---
Barracuda Networks, Inc.|Barracuda NextGen Firewall F-Series 6.2.1-057|– observação: este dispositivo é gerenciado por meio de um aplicativo cliente e a porta TCP/807 precisa ser encaminhada para fazer isso. Confira o Leiame de implantação https://techlib.barracuda.com/NG61/DeployAzure...|Linux|80 GB
...
Canônico|Ubuntu Server 12.04.5-LTS|Ubuntu Server 12.04.5-LTS (amd64 20160315) para Microsoft Azure. O Ubuntu Server é a distribuição do Linux mais popular do mundo para ambientes em nuvem. As atualizações e patches para o Ubuntu 12.04.5-LTS estarão disponíveis até...|Linux|30 GB
...
credativ|Debian 7 Wheezy|Debian 7 Wheezy (20160405.0) para o Microsoft Azure. O Debian GNU/Linux é uma das distribuições mais populares do Linux. |Linux|30 GB
credativ|Debian 8 Jessie|Debian 8 Jessie (20160405.0) para o Microsoft Azure. O Debian GNU/Linux é uma das distribuições mais populares do Linux. |Linux|30 GB
...
Grupo do Microsoft Windows Server|Windows Server 2016 Core with Containers Tech Preview 4|O Server traz a amplitude e profundidade da experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura de datacenter. Windows Server 2016 Core with Containers Technical Preview 4 tod...|Windows|127 GB
Grupo do Microsoft Windows Server|Windows Server 2016 Technical Preview 4|O cerne da visão do Microsoft Cloud OS, o Windows Server traz a amplitude e profundidade da experiência da Microsoft oferecendo serviços de nuvem em escala global para sua infraestrutura de datacenter. Windows...|Windows|128 GB
