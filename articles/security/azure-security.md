...
## <a name="20-summary-azure-security-capabilities"></a>2.0 Resumo dos recursos da Segurança do Azure
...
### <a name="21-security-features-implemented-to-secure-the-azure-platform"></a>2.1 Recursos de segurança implementados para proteger a plataforma do Azure:
...
### <a name="22-security-features-offered-by-azure-to-secure-data-and-application"></a>2.2 Recursos de segurança oferecidos pelo Azure para proteger dados e aplicativos
...
## <a name="30-operations"></a>3.0 Operações
...
### <a name="31-operations-management-suite-security-and-audit-dashboard"></a>3.1 Painel de Segurança e Auditoria do Operations Management Suite
...
### <a name="36-azure-advisor"></a>3.6 Assistente do Azure
...
### <a name="37-azure-security-center"></a>3.7 Central de Segurança do Azure
...
## <a name="40-applications"></a>4.0 Aplicativos
...
### <a name="41-web-application-vulnerability-scanning"></a>4.1 Verificação de vulnerabilidades de aplicativos Web
...
### <a name="42-penetration-testing"></a>4.2 Teste de penetração
...
### <a name="43-web-application-firewall"></a>4.3 Firewall do aplicativo Web
...
### <a name="44-authentication-and-authorization-in-azure-app-service"></a>4.4 Autenticação e autorização no Serviço de Aplicativo do Azure
...
### <a name="45-layered-security-architecture"></a>4.5 Arquitetura de segurança em camadas
...
### <a name="46-web-server-diagnostics-and-application-diagnostics"></a>4.6 Diagnóstico de servidor Web e diagnóstico de aplicativos
...
#### <a name="461-web-server-diagnostics"></a>4.6.1 Diagnóstico de servidor Web
...
#### <a name="462-application-diagnostics"></a>4.6.2 Diagnóstico de aplicativos
...
## <a name="50-storage"></a>5.0 Armazenamento
...
### <a name="51-role-based-access-control-rbac"></a>5.1 RBAC (Controle de Acesso Baseado em Função)
...
### <a name="52-shared-access-signature"></a>5.2 Assinatura de acesso compartilhado
...
### <a name="53-encryption-in-transit"></a>5.3 Criptografia em trânsito
...
### <a name="54-encryption-at-rest"></a>5.4 Criptografia em repouso
...
### <a name="55-storage-analytics"></a>5.5 Análise de Armazenamento
...
### <a name="56-enabling-browser-based-clients-using-cors"></a>5.6 Habilitar clientes com base no navegador usando CORS
...
## <a name="60-networking"></a>6.0 Rede
...
### <a name="61-network-layer-controls"></a>6.1 Controles de camada de rede
...
#### <a name="611-network-security-groups"></a>6.1.1 Grupos de segurança de rede
...
#### <a name="612-route-control-and-forced-tunneling"></a>6.1.2 Controle de rota e túnel forçado
...
#### <a name="613-virtual-network-security-appliances"></a>6.1.3 Dispositivos de segurança de rede virtual
...
### <a name="62-azure-virtual-network"></a>6.2 Rede virtual do Azure
...
### <a name="63-vpn-gateway"></a>6.3 Gateway de VPN
...
### <a name="64-express-route"></a>6.4 Rota Expressa
...
Com a Rota Expressa, você pode estabelecer conexões com os serviços de nuvem da Microsoft, como o Microsoft Azure, o Office 365 e o CRM Online. A conectividade pode ocorrer de uma rede “qualquer para qualquer” (VPN IP), uma rede Ethernet ponto a ponto ou uma conexão cruzada virtual por meio de um provedor de conectividade em uma colocalização.
...
### <a name="66-web-application-firewall"></a>6.6 Firewall do aplicativo Web
...
### <a name="67-traffic-manager"></a>6.7 Gerenciador de Tráfego
...
### <a name="610-azure-dns"></a>6.10 DNS do Azure
...
### <a name="611-log-analytics-nsgs"></a>6.11 NSGs do Log Analytics
...
### <a name="612-azure-security-center"></a>6.12 Central de Segurança do Azure
...
### <a name="72-hardware-security-module"></a>7.2 Módulo de segurança de hardware
...
### <a name="73-virtual-machine-backup"></a>7.3 Backup de máquinas virtuais
...
### <a name="75-sql-vm-tde"></a>7.5 TDE de VM do SQL
...
### <a name="76-vm-disk-encryption"></a>7.6 Criptografia de disco da VM
...
### <a name="77-virtual-networking"></a>7.7 Rede virtual
...
### <a name="78-patch-updates"></a>7.8 Atualizações de patch
...
### <a name="79-security-policy-management-and-reporting"></a>7.9 Gerenciamento de política de segurança e emissão de relatórios
...
### <a name="710-azure-security-center"></a>7.10 Central de Segurança do Azure
...
## <a name="80-identify-and-access-management"></a>8.0 Gerenciamento de identidade e de acesso
...
### <a name="81-secure-identity"></a>8.1 Proteção da identidade
...
### <a name="82-secure-apps-and-data"></a>8.2 Aplicativos e dados seguros
