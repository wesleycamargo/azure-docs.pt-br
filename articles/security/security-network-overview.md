...
Você pode saber mais sobre as Redes Virtuais do Azure lendo o artigo [Visão geral da Rede Virtual](../virtual-network/virtual-networks-overview.md).
...
Caso você precise de um controle de acesso no nível de rede básico (baseado no endereço IP e nos protocolos TCP ou UDP), é possível usar os Grupos de Segurança de Rede. Um NSG (Grupo de Segurança de Rede) é um firewall básico de filtragem de pacotes com estado e permite o controle do acesso baseado em [5 tuplas](https://www.techopedia.com/definition/28190/5-tuple). Os NSGs não fornecem inspeção da camada de aplicativo nem controles de acesso autenticado.

Saiba mais sobre os **Grupos de Segurança de Rede** lendo o artigo [Grupos de Segurança de Rede](../virtual-network/virtual-networks-nsg.md).
...
Para saber mais sobre as **Rotas Definidas pelo Usuário**, veja o artigo [O que são as Rotas Definidas pelo Usuário e o Encaminhamento IP](../virtual-network/virtual-networks-udr-overview.md).
...
Para saber mais sobre a conectividade **VPN ponto a site**, veja o artigo [Configurar uma conexão ponto a site a uma Rede Virtual usando o PowerShell](../vpn-gateway/vpn-gateway-howto-point-to-site-rm-ps.md).
...
Para saber mais sobre as **VPNs site a site no Azure**, veja o artigo [Criar uma Rede Virtual do Gerenciador de Recursos com uma conexão VPN site a site usando o Portal do Azure](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md).

Para saber mais sobre como planejar a conectividade **entre instalações baseada em VPN**, veja [Planejamento e design do gateway de VPN](../vpn-gateway/vpn-gateway-plan-design.md).
...
Para saber mais sobre conexões **WAN dedicadas** entre a rede local e as Redes Virtuais do Azure, leia o artigo [Visão geral técnica da Rota Expressa](../expressroute/expressroute-introduction.md).
...
Para obter mais informações sobre VPNs site a site da Rede Virtual do Azure à Rede Virtual do Azure, leia o artigo [Configurar uma conexão da Rede Virtual à Rede Virtual usando o Azure Resource Manager e o PowerShell](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md).
...
Para obter mais informações sobre o Azure Application Gateway, leia o artigo [Visão geral do Application Gateway](../application-gateway/application-gateway-introduction.md).
...
Para saber mais sobre o Azure Load Balancer externo, leia o artigo [Balanceador de carga para a Internet entre várias Máquinas Virtuais ou serviços](../load-balancer/load-balancer-internet-overview.md).

Para saber mais sobre o Azure Load Balancer interno, leia o artigo [Visão geral do balanceador de carga interno](../load-balancer/load-balancer-internal-overview.md).
...
Para saber mais sobre o balanceamento de carga global com o Gerenciador de Tráfego do Azure, leia o artigo [O que é o Gerenciador de Tráfego?](../traffic-manager/traffic-manager-overview.md)
...
Para saber mais sobre o log do Grupo de Segurança de Rede, leia o artigo [Log Analytics para NSGs (Grupos de Segurança de Rede)](../virtual-network/virtual-network-nsg-manage-log.md).
...
Para saber mais sobre o **servidor DNS da Rede Virtual do Azure**, veja o artigo [Visão geral da Rede Virtual](../virtual-network/virtual-networks-overview.md).

Para saber mais sobre como usar **seus próprios servidores DNS** em uma Rede Virtual do Azure, veja o artigo [Gerenciar os servidores DNS usados por uma VNet (Rede Virtual)](../virtual-network/virtual-networks-manage-dns-in-vnet.md).
...
Para saber mais sobre o DNS do Azure, leia [Visão geral do DNS do Azure](../dns/dns-overview.md).
...
Para saber mais sobre designs de DMZ no Azure, leia o artigo [Segurança de rede e serviços em nuvem da Microsoft](../best-practices-network-security.md).
...
Para saber mais sobre a Central de Segurança do Azure, veja o artigo [Introdução à Central de Segurança do Azure](../security-center/security-center-intro.md).
