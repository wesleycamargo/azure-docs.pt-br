...
* [Visão geral da Rede Virtual](../virtual-network/virtual-networks-overview.md)
* [Gerenciar servidores DNS usados por uma rede virtual (VNet)](../virtual-network/manage-virtual-network.md#change-dns-servers)
