...
Participe desta sessão para ver a plataforma de segurança da Microsoft em ação. Julia White, Gerente Geral de Cloud & Enterprise, demonstrará os recursos de segurança do Windows 10, do Azure e do Office 365 que podem ajudar a manter sua organização segura.
...
Cada aplicativo genuíno que você implantar no Azure tem segredos críticos – cadeias de conexão, certificados, chaves. Erros, por menores que sejam, no gerenciamento desses itens levam a consequências fatais – perdas, interrupções, violações de conformidade. Como várias pesquisas recentes indicam, esses tipos de erros causam 4 vezes mais violações de dados do que os concorrentes. Nesta sessão, abordaremos algumas melhores práticas para gerenciar os segredos importantes de seu aplicativo. Podem parecer uma questão de bom senso, embora muitos desenvolvedores os negligenciem. Também mostraremos como aproveitar o Cofre de Chaves do Azure para implementar essas melhores práticas. Como vantagem adicional, seguir essas práticas também ajudará a demonstrar conformidade com padrões como SOC. Os primeiros dez minutos da sessão são temas básicos que se aplicam a qualquer aplicativo de nuvem desenvolvido em qualquer plataforma. O restante são conhecimentos de nível intermediário e ressaltam os aplicativos criados na plataforma Azure.
...
[Azure AD Privileged Identity Management: Security Wizard, Alerts, Reviews](https://channel9.msdn.com/Series/Azure-Active-Directory-Videos-Demos/Azure-AD-Privileged-Identity-Management-Security-Wizard-Alerts-Reviews) (Privileged Identity Management do Azure AD: Assistente de Segurança, Alertas, Análises) O Privileged Identity Management do Azure AD (Active Directory) é uma funcionalidade premium que permite descobrir, restringir e monitorar identidades com privilégios e seu acesso a recursos, mas também impõem acesso administrativo sob demanda, Just-In-Time, quando necessário. Saiba mais sobre como: gerenciar a proteção para funções administrativas específicas da carga de trabalho do Office 365; configurar o MFA (Azure Multi-Factor Authentication) para ativações de função com privilégios; medir e melhorar sua postura de segurança de locatário; monitorar e corrigir as descobertas de segurança; examinar quem precisa permanecer em funções com privilégios para fluxos de trabalho de nova certificação periódica.

[Azure Key Vault with Amit Bapat](https://channel9.msdn.com/Shows/Azure-Friday/Azure-Key-Vault-with-Amit-Bapat) (Cofre de Chaves do Azure com Amit Bapat)
