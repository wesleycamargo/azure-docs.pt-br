...
description: " Compreenda as vantagens de segurança de PaaS em comparação com outros modelos de serviço de nuvem e aprenda as práticas recomendadas para proteger a sua implantação do PaaS do Azure. "
services: security
