...
| **Atributos**              | N/D  |
| **Referências**              | [Como evitar scripts entre sites no ASP.NET](http://msdn.microsoft.com/library/ms998274.aspx), [Scripts entre sites](http://cwe.mitre.org/data/definitions/79.html), [Folha de consulta de prevenção de XSS (Cross Site Scripting)](https://www.owasp.org/index.php/XSS_(Cross_Site_Scripting)_Prevention_Cheat_Sheet) |
