...
| **Manter um <br/>Programa de Gerenciamento de** Vulnerabilidades | 5. [Proteger todos os sistemas contra malware e atualizar regularmente softwares ou programas antivírus](pci-dss-requirement-5-malware.md)<br/><br/> 6. [Desenvolver e manter os aplicativos e sistemas protegidos](pci-dss-requirement-6-secure-system.md) |
...
| **Monitorar e <br/>Testar Regularmente as Redes** | 10. [Controlar e monitorar todo o acesso aos recursos da rede e aos dados do titular do cartão](pci-dss-requirement-10-monitoring.md) <br/><br/> 11. [Testar regularmente os sistemas e processos de segurança](pci-dss-requirement-11-testing.md) |
