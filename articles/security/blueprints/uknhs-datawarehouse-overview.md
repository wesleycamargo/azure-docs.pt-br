...
**SQL Data Warehouse**: [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is) é um Data Warehouse corporativo que aproveita o processamento paralelo para executar rapidamente consultas complexas em petabytes de dados, permitindo que os usuários a identificar com eficiência dados de saúde. Os usuários podem usar consultas T-SQL PolyBase simples para importar Big Data no SQL Data Warehouse e utilizar o poder do processamento paralelo massivo para executar análises de alto desempenho.
