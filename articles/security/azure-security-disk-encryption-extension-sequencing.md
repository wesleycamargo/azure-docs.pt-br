...
* Aplique a extensão Azure Disk Encryption após um script de shell personalizado que formata o suporte técnico (Linux): [deploy-extseq-linux-ADE-after-customscript.json](https://github.com/Azure-Samples/compute-automation-configurations/blob/master/ade-vmss/deploy-extseq-linux-ADE-after-customscript.json)
