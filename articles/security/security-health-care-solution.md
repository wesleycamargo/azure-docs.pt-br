...
Novas empresas do setor de saúde, SIs (integradores de sistemas), ISVs (fornecedores independentes de software) e organizações de serviços de saúde que estão considerando a migração para o Azure buscam orientação para projetar e operar soluções que incorporam controles de segurança para ajudá-los a atender às suas obrigações de conformidade.
...
Esperamos que o [Guia prático para criar soluções de serviços de saúde seguras](https://aka.ms/azureindustrysecurity) seja útil para você. Avise-nos se tiver dúvidas ou sugestões, deixando um comentário abaixo.
