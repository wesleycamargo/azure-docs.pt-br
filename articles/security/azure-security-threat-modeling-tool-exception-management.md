...
| API Web | <ul><li>[Verificar se o tratamento de exceções adequado é feito na API Web ASP.NET ](#exception)</li></ul> |
...
## <a name="a-idservicedebugawcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug"></a>WCF - não inclui o nó serviceDebug no arquivo de configuração
...
## <a name="a-idservicemetadataawcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata"></a>WCF - não inclui o nó serviceMetadata no arquivo de configuração
...
## <a name="a-idexceptionaensure-that-proper-exception-handling-is-done-in-aspnet-web-api"></a><a id="exception"></a>Verificar se o tratamento de exceções adequado é feito na API Web ASP.NET
...
# <a name="by-action"></a>por ação
# <a name="by-controller"></a>pelo controlador
...
## <a name="a-idmessagesado-not-expose-security-details-in-error-messages"></a><a id="messages"></a>Não expor os detalhes da segurança nas mensagens de erro
...
## <a name="a-iddefaultaimplement-default-error-handling-page"></a><a id="default"></a>Implementar a página de tratamento de erros Padrão
...
## <a name="a-iddeploymentaset-deployment-method-to-retail-in-iis"></a><a id="deployment"></a>Definir o Método de Implantação para o Varejo no IIS
...
## <a name="a-idfailaexceptions-should-fail-safely"></a><a id="fail"></a>As exceções devem falhar com segurança
