<properties urlDisplayName="Mobile Services Overview" pageTitle="Visão geral dos Serviços Móveis | Mobile Dev Center" metaKeywords="" description="Saiba mais sobre os serviços móveis." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Mobile Services Overview" authors="mahender"  manager="dwrede" services="mobile-services"/>
