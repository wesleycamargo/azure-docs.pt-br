...
6. No Solution Explorer, expanda **Propriedades**, abra o arquivo WMAppManifest.xml, clique na guia **Recursos** e certifique-se de que a **ID___CAP___PUSH_NOTIFICATION** funcionalidade tenha sido marcado.
...
[Usar hubs de notificação para enviar notícias recentes]: notification-hubs-windows-phone-send-breaking-news.md
