<properties 
	pageTitle="Comece a usar as ferramentas do HDInsight para o Visual Studio | Azure" 
...
- Uma estação de trabalho com o seguinte
	...
	>[AZURE.NOTE] Atualmente, as ferramentas são fornecidas apenas com a versão em inglês. 
...
- [Usar o Hive com Hadoop no HDInsight][hdinsight.hive]
