...
- **Ferramentas PowerShell do Azure** - o  `Add-AzureVhd` cmdlet também pode ser usado para carregar o VHD. Acesse a página de [downloads do Azure](http://azure.microsoft.com/pt-br/downloads/) para baixar os cmdlets do PowerShell do Azure. Para obter informações de referência, consulte [Add-AzureVhd (a página pode estar em inglês)](http://msdn.microsoft.com/library/windowsazure/dn495173.aspx).
