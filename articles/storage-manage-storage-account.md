<properties 
	pageTitle="Como gerenciar contas de armazenamento | Microsoft Azure" 
	description="Saiba como gerenciar contas de armazenamento no Azure usando o Portal de Gerenciamento." 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="adinah" 
...
> [AZURE.WARNING] Não é possível restaurar o conteúdo de uma conta de armazenamento excluída. Certifique-se de fazer backup de todas as informações que você deseja salvar antes de excluir a conta.
> 
