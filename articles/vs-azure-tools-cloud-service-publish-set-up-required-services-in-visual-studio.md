...
4. No **Serviços de nuvem** escolha **Criar novo**. A caixa de diálogo **Criar serviços do Azure** é exibida.
...
9. No **Nome da conta** digite o nome da sua conta de armazenamento.
   ...
   > 
   > 
10. No caixa **Chave de conta**, digite sua chave primária ou copie e cole-a do [Portal Clássico do Azure](http://go.microsoft.com/fwlink/?LinkID=213885). Para copiar essa chave:
