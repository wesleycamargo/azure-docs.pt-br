...
1.  [Baixar o projeto do aplicativo Android][Baixar o projeto do aplicativo Android]
...
Este tutorial requer o [SDK para Android de Serviços Móveis][SDK para Android de Serviços Móveis]; o [SDK para Android][SDK para Android] que inclui o IDE (ambiente de desenvolvimento integrado) Eclipse e o plug-in Android Developer Tools (ADT); e o Android 4.2 ou a versão mais recente.
