...
Os programas MapReduce também podem ser executados de forma programática usando a API do Microsoft .NET para HDInsight. Para obter mais informações sobre como usar as APIs do HDInsight para envio de trabalhos, consulte [Enviar trabalhos Hadoop programaticamente][hdinsight-submit-jobs].
...
- [**O exemplo WordCount**][hdinsight-sample-pi-estimator] Este tutorial mostra como usar um cluster HDInsight para executar um programa MapReduce que conta todas as ocorrências de palavras em um arquivo de texto.
