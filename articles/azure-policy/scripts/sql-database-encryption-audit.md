---
title: Amostra de json do Azure Policy – Auditar a Transparent Data Encryption do Banco de Dados SQL | Microsoft Docs
description: Essa política de exemplo de json audita se o banco de dados SQL não tem a Transparent Data Encryption habilitada.
