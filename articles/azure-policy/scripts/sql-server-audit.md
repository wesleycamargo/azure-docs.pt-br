---
title: Amostra de json do Azure Policy – Auditar as configurações de auditoria do SQL Server | Microsoft Docs
description: Essa política de exemplo json audita as configurações de auditoria do SQL Server.
