---
title: Exemplo de json de Azure Policy - Auditar nenhum administrador do Azure AD | Microsoft Docs
description: Essa política de exemplo json audita quando não há nenhum administrador do Azure Active Directory atribuído ao SQL server.
