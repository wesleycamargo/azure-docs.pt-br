---
title: Exemplo de json do Azure Policy – Exigir SQL Server versão 12.0 | Microsoft Docs
description: Esta política de exemplo de json requer que os servidores SQL usem a versão 12.0.
