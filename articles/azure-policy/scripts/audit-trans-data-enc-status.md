---
title: Exemplo de json do Azure Policy – Auditar o status da Transparent Data Encryption | Microsoft Docs
description: Essa política de exemplo de json audita a Transparent Data Encryption do banco de dados SQL se ela não estiver habilitada.
...
ms.locfileid: "34602271"
---
# <a name="audit-transparent-data-encryption-status"></a>Auditar o status da Transparent Data Encryption

Essa política audita a Transparent Data Encryption do banco de dados SQL se ela não estiver habilitada.
