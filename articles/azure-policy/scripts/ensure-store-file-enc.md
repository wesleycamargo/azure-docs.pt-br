---
title: Exemplo de json do Azure Policy – Assegurar criptografia de arquivo de armazenamento | Microsoft Docs
description: Essa política de exemplo de json requer que a criptografia de arquivo esteja habilitada para contas de armazenamento.
