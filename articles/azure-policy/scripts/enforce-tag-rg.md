---
title: Exemplo de json do Azure Policy – Impor marca e seu valor em grupos de recursos | Microsoft Docs
description: Esta política de exemplo de json exige uma marca e valor em um grupo de recursos.
