---
title: Exemplo de json do Azure Policy – Exigir criptografia de conta de armazenamento | Microsoft Docs
description: Essa política de exemplo de json exige que contas de armazenamento usem criptografia de blobs.
