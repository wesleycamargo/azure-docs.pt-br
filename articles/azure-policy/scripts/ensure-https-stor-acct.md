---
title: Exemplo de json do Azure Policy – Assegurar tráfego https somente para contas de armazenamento | Microsoft Docs
description: Esta política de exemplo de json exige que contas de armazenamento usem tráfego HTTPS.
