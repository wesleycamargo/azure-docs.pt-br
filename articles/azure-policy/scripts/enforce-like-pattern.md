---
title: Amostra de JSON do Azure Policy – impor padrão de semelhança | Microsoft Docs
description: Esta política de exemplo de JSON exige que os recursos atendam ao padrão de semelhança das convenções de nomenclatura.
...
ms.locfileid: "34601761"
---
# <a name="enforce-like-pattern-for-naming-conventions"></a>Impor padrão de semelhança das convenções de nomenclatura
