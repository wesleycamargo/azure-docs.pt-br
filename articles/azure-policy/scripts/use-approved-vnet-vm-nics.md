---
title: Exemplo de json do Azure Policy – Usar vNet aprovada para adaptadores de rede de VM | Microsoft Docs
description: Essa política de exemplo de json requer que os adaptadores de rede usem uma rede virtual aprovada.
