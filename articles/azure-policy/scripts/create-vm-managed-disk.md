---
title: Exemplo de json do Azure Policy - Auditar VM sem usar disco gerenciado | Microsoft Docs
description: Esse exemplo de json audita quando uma máquina virtual é criada e não usa discos gerenciados.
...
ms.locfileid: "34601200"
---
# <a name="audit-when-vm-does-not-use-managed-disk"></a>Auditar quando a VM não usa um disco gerenciado

Audita quando é criada uma máquina virtual e não usa discos gerenciados.
