---
title: Exemplo de json do Azure Policy - vários padrões de nome | Microsoft Docs
description: Essa política de exemplo json requer que um dos padrões de nome fornecido corresponda com um dos recursos.
