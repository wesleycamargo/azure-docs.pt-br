---
title: Exemplo de json do Azure Policy – Largura de banda de Express Route permitida | Microsoft Docs
description: Essa política de exemplo de json requer que as rotas expressas usem um conjunto de larguras de bandas aprovado.
...
ms.locfileid: "34600860"
---
# <a name="allowed-express-route-bandwidth"></a>Largura de banda do Express Route permitida

Essa política requer que as rotas expressas usem um conjunto de larguras de bandas aprovado. Especifique uma matriz de SKUs que podem ser definidas para o Express Route.
