---
title: Exemplo de json do Azure Policy – Negar benefícios de uso híbrido | Microsoft Docs
description: Essa política de exemplo de json proíbe o uso do AHUB (Benefício Híbrido do Azure).
