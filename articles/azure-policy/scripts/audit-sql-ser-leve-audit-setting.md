---
title: Exemplo de json do Azure Policy – Auditar a configuração de auditoria no nível do SQL Server | Microsoft Docs
description: Essa política de exemplo de json audita as configurações de auditoria do SQL Server se elas não corresponderem a uma configuração especificada.
