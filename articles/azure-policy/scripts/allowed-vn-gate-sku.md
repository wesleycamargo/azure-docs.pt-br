---
title: Exemplo de json do Azure Policy – SKUs de gateway de rede virtual permitidos | Microsoft Docs
description: Essa política de exemplo de json requer que os gateways de rede virtual usem um tipo de SKU e gateway aprovado.
