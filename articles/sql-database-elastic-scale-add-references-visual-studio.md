<properties title="Add Azure SQL DB Elastic Scale References to a Visual Studio Project" pageTitle="Adicionar referências de Elastic Scale do banco de dados SQL do Azure a um projeto do Visual Studio" description="Como adicionar referências do .NET a APIs de escala elástica para projetos do Visual Studio usando o Nuget." metaKeywords="Azure SQL Database, elastic scale, Nuget references" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
