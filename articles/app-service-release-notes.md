<properties 
   ...
   description="Notas de versão do SDK do Azure para .NET" 
...
# Notas de versão do SDK do Azure para .NET

Este documento contém as notas de versão do SDK do Azure para a versão do .NET 2.5.1. 

##SDK do Azure para notas de versão .NET 2.5.1
...
- Novo recursos\cenários relacionados a **Ferramentas HDInsight** no Visual Studio estão habilitados nesta versão. 
	...
	- (Visualização pública) Suporte a preenchimento automático de palavra-chave e IntelliSense para Hive.  Para ajudar a criar scripts do Hive, as ferramentas HDInsight para Visual Studio adicionaram suporte para preenchimento automático de palavra-chave e IntelliSense para Hive.
...
- Intermitentemente, ícones do Gerenciador de Servidor são exibidos na forma bidimensional.  Reiniciar o VS resolve esse problema. 
