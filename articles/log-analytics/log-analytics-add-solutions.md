...
| Recuperação de Site                                                                                | <ul><li>Insight and Analytics</li></ul>                                     | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)                                                                            | Requer um cofre clássico do Site Recovery.<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
