...
| Integridade do agente                                                                              | <ul><li>Insight&nbsp;e&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)   | Dados não sujeitos ao limite da camada gratuita<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
...
| Backup                                                                                    | <ul><li>Insight and Analytics</li></ul>                                   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)                                                                       | Requer um cofre de Backup clássico.<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
...
| [Conector de Gerenciamento do Serviço de TI](log-analytics-itsmc-overview.md)<br>(Visualização)                                               | <ul><li>Insight&nbsp;e&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Grátis<br> Por&nbsp;Nó&nbsp;(OMS)     | |
...
| Aplicativos Lógicos B2B                    | <ul><li>Insight&nbsp;e&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)   | Não disponível para adicionar do Portal do Azure/Marketplace. |
...
| [Mapa do Serviço](../operations-management-suite/operations-management-suite-service-map.md) <br>(Visualização)| <ul><li>Insight and Analytics</li></ul>                       | Grátis<br> Por&nbsp;Nó&nbsp;(OMS)                                                                         | Disponível no Leste dos EUA, na Europa Ocidental e no EUA Central    |
| Site Recovery                                                                             | <ul><li>Insight and Analytics</li></ul>                                   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)                                                                       | Requer um cofre clássico do Site Recovery.<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
...
| [Conformidade para atualização](https://technet.microsoft.com/en-us/itpro/windows/manage/update-compliance-get-started) <br>(Visualização)                                                             | <ul><li>Insight&nbsp;e&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)   | Sem encargos para dados ou nós<br>Dados não sujeitos ao limite da camada gratuita.<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
| [Preparação para atualização](https://technet.microsoft.com/itpro/windows/deploy/manage-windows-upgrades-with-upgrade-readiness)                                                            | <ul><li>Insight&nbsp;e&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Grátis<br> Standard<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(Autônomo)<br> Por&nbsp;Nó&nbsp;(OMS)   | Sem encargos para dados ou nós<br>Dados não sujeitos ao limite da camada gratuita.<br> Não disponível para adicionar do Portal do Azure/Marketplace. |
...
| Dados durante a transmissão 2.0<br>(Visualização)                                                                | <ul><li>Insight and Analytics</li></ul>                                   | Grátis<br> Por&nbsp;Nó&nbsp;(OMS)                                                                         | Disponível no Leste dos EUA, na Europa Ocidental e no EUA Central |
...
| Gerenciamento de Capacidade |Windows |![Sim](./media/log-analytics-add-solutions/oms-bullet-green.png) |![Sim](./media/log-analytics-add-solutions/oms-bullet-green.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Sim](./media/log-analytics-add-solutions/oms-bullet-green.png) |na chegada |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Logs de atividade do Azure |Windows |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |após a notificação |
| Logs de Diagnóstico do Azure |Windows |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |após a notificação |
| Métricas de Diagnóstico do Azure |Windows |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Não](./media/log-analytics-add-solutions/oms-bullet-red.png) |após a notificação |
