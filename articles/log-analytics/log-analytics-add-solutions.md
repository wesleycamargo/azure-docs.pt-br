---
title: Adicionar soluções do Log Analytics por meio da Galeria de Soluções | Microsoft Docs
...
> [!NOTE]
> O Log Analytics inclui a funcionalidade Pesquisa de Log, por isso não é necessário instalar uma solução para habilitá-la. No entanto, você pode obter visualizações de dados, pesquisas sugeridas e insights adicionando soluções de Galeria de Soluções.
> 
> 
