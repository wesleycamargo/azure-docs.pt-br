...
> [!NOTE]
> Você deve especificar permissões para o OMS do Configuration Manager. Caso contrário, você receberá uma mensagem de erro ao usar o assistente de configuração do Configuration Manager.
> 
> 
...
> [!NOTE]
> Você deve conectar o OMS ao site de nível superior na hierarquia. Se você conectar o OMS a um site primário autônomo e, em seguida, adicionar um site de administração central ao seu ambiente, precisará excluir e recriar a conexão do OMS na nova hierarquia.
> 
> 
