<properties
    pageTitle="Monitorar Surface Hubs com o Log Analytics | Microsoft Azure"
...
6. Na caixa de diálogo Configurações do OMS, digite a **ID do espaço de trabalho** e digite a **Chave do espaço de trabalho**.  
