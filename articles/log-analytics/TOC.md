...
#### [Dados de desempenho coletados](log-analytics-data-sources-collectd.md)
...
#### [Desempenho do aplicativo Linux](log-analytics-data-sources-linux-applications.md)
...
## Criar alertas
### [Entendendo os alertas](log-analytics-alerts.md)
...
### [Amostra de ação do Webhook](log-analytics-alerts-webhooks.md)
...
#### [Service Fabric com Azure Resource Manager](log-analytics-service-fabric-azure-resource-manager.md)
...
### Análise do Windows
#### [Conformidade para atualização](https://technet.microsoft.com/itpro/windows/manage/update-compliance-get-started)
#### [Preparação para atualização](https://technet.microsoft.com/itpro/windows/deploy/upgrade-readiness-get-started)
