...
Permite criar campos de tempo de execução em consultas. Também será possível usar o comando measure após o comando extend se você desejar executar a agregação.
