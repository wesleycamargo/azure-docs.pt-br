<properties
    pageTitle="Solução de Monitor de Desempenho de Rede de OMS | Microsoft Azure"
...
>[AZURE.NOTE] O script EnableRules.ps1 configura regras de firewall do Windows somente no computador em que o script é executado. Se tiver um firewall de rede, você deverá verificar se ele permite o tráfego destinado à porta TCP usada pelo Monitor de Desempenho de Rede.
