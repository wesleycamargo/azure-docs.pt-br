<properties 
   pageTitle="Logs de eventos do Windows no Log Analytics | Microsoft Azure"
...
# Fontes de dados de log de eventos do Windows no Log Analytics
...
## Pesquisas de log com eventos do Windows
