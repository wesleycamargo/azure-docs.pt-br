...
>[AZURE.NOTE] Se você estiver usando o agente direto do OMS em vez do agente do SCOM, o pacote de gerenciamento será sempre executado no contexto de segurança da conta de Sistema Local. Ignore as etapas 1 a 5 abaixo e execute o exemplo do T-SQL ou Powershell, especificando NT AUTHORITY\SYSTEM como o nome de usuário.
