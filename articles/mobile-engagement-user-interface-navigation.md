<properties 
   pageTitle="Mobile Engagement do Azure - Interface do usuário - Navegação" 
   description="Visão geral da interface de usuário para a seção de navegação do Mobile Engagement do Azure" 
...
O Portal de front-end de interface do usuário em: https://YourApp.portal.mobileengagementwindows.net/ contém os seguintes elementos de navegação: um cabeçalho, um rodapé, uma barra lateral, navegação de trilha do cookie e uma faixa de opções específicas do aplicativo.
 
![Navigation1][1] 

## Cabeçalho:
- **Mobile Engagement do Azure (logotipo)** - a página inicial do seu aplicativo Mobile Engagement do Azure
- **Seu nome** - meu perfil de conta
- **Documentação** - [documentação do Mobile Engagement do Azure][Link 10]
- **Sair** - saia do Mobile Engagement do Azure
 
## Rodapé:
- **Termos de serviço** [http://azure.microsoft.com/support/legal/](http://azure.microsoft.com/support/legal/)
- **Privacidade**[http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx](http://www.microsoft.com/privacystatement/OnlineServices/Default.aspx)
 
## Trilha de cookie:
- Navegar rapidamente para páginas anteriores que levam ao seu local atual.
 
## Faixa de opções:
- [Análise][Link 15]
- [Monitoramento][Link 16]
- [Reach][Link 17]
- [Segmentos][Link 18]
- [Painel][Link 19]
    - + (Adicionar um painel de controle):
- [Configurações][Link 20]
