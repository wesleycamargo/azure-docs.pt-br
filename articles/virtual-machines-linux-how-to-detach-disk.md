<properties urlDisplayName="Detach a Disk" pageTitle="Desanexar um disco de uma máquina virtual do Linux no Azure" metaKeywords="Azure detaching disk, VM detached disk" description="Learn how to detach a data disk from an Azure virtual machine." metaCanonical="http://www.windowsazure.com/pt-br/manage/windows/how-to-guides/detach-a-disk/" services="virtual-machines" documentationCenter="" title="" authors="kathydav" solutions="" manager="timlt" editor="" />
