...
Esse script usa os comandos a seguir para exportar um repositório de configurações de aplicativo. Cada comando da tabela é vinculado à documentação específica do comando.
