<properties linkid="manage-services-storage-net-shared-access-signature-part-2" urlDisplayName="" pageTitle="Criar e usar uma SAS com o serviço Blob | Microsoft Azure" metaKeywords="blob do Azure, assinaturas de acesso compartilhado, política de acesso armazenado" description="Explorar a geração e o uso de assinaturas de acesso compartilhado com o serviço Blob" metaCanonical="" services="storage" documentationCenter="" title="Parte 2: Criar e usar uma SAS com o serviço Blob" authors="tamram" solutions="" manager="mbaldwin" editor="cgronlun" />




# Assinaturas de acesso compartilhado, Parte 2: Criar e usar uma SAS com o serviço Blob
...
- Criar uma política de acesso armazenado para gerenciar assinaturas nos recursos de um contêiner
- Testar as assinaturas de acesso compartilhado de um aplicativo cliente
...
Na parte inferior do método **Main()**, adicione as linhas a seguir para chamar **GetBlobSasUri()**, antes da chamada de **Console.ReadLine()**, e grave o URI da assinatura de acesso compartilhado na janela do console:    
...
No corpo do método **Main()**, adicione as seguintes constantes e atualize seus valores para as assinaturas de acesso compartilhado que você gerou na Parte 1 do tutorial.
