...
Este guia fornece exemplos de código c# que mostram como disparar um processo quando um blob do Azure é criado ou atualizado. Os exemplos de código usam o [SDK WebJobs](../websites-dotnet-webjobs-sdk/) versão 1.x.

O guia pressupõe que você saiba [como criar um projeto WebJob no Visual Studio com cadeias de conexão que apontam para sua conta de armazenamento](../websites-dotnet-webjobs-sdk-get-started/).
