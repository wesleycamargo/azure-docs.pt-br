...
**Observação:** se você estiver criando uma mensagem da fila em um aplicativo que não usa o SDK WebJobs, certifique-se de definir [BrokeredMessage.ContentType](http://msdn.microsoft.com/pt-br/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) para "text/plain".
