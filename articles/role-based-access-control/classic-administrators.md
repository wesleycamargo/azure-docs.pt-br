...
> [!TIP]
> Será necessário adicionar um Coadministrador, somente se o usuário precisar gerenciar implantações clássicas do Azure. É recomendável usar o RBAC para todas as outras finalidades.
