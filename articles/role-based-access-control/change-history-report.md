...
![PowerShell Get-AzureRMAuthorizationChangeLog - captura de tela](./media/change-history-report/access-change-history.png)
...
![Log de alteração exibido como planilha - captura de tela](./media/change-history-report/change-history-spreadsheet.png)

## <a name="next-steps"></a>Próximas etapas
* Trabalhe com [Funções personalizadas no RBAC do Azure](custom-roles.md)
* Saiba como gerenciar o [RBAC do Azure com o PowerShell](role-assignments-powershell.md)
