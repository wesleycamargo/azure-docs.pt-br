...
- Examine as [funções RBAC incorporadas](built-in-roles.md).
- Saiba como gerenciar atribuições de acesso [por usuário](role-assignments-users.md) ou [por recurso](role-assignments-portal.md) 
