...
3. Você possui um computador host no qual você pode instalar a ferramenta de desbloqueio do Disco do Data Box. O computador host deve
    ...
    - [Instale o .NET Framework 4.5.1](https://www.microsoft.com/download/details.aspx?id=30653).
    - [Habilite o BitLocker](https://docs.microsoft.com/windows/security/information-protection/bitlocker/bitlocker-how-to-deploy-on-windows-server).
    - [Instale o Windows Management Framework 4](https://www.microsoft.com/en-us/download/details.aspx?id=40855). 
