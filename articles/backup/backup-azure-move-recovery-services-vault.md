...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>Registrar a assinatura para Mover seu cofre dos Serviços de Recuperação

Para registrar a assinatura para **Mover** seu Cofre dos Serviços de Recuperação, execute os seguintes cmdlets do terminal do PowerShell:
