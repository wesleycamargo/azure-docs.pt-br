...
**Como verificar se os dados de relatório começaram a fluir para uma conta de armazenamento?**
...
**Qual é a frequência de push de dados para uma conta de armazenamento e para o pacote de conteúdo de Backup do Azure no Power BI?**
...
**Por quanto tempo é possível reter os relatórios?**

   Quando configura uma conta de armazenamento, você pode selecionar um período de retenção para dados de relatório na conta de armazenamento. Siga a etapa 6 na seção anterior, "Configurar a conta de armazenamento para relatórios". Além disso, você pode [analisar relatórios no excel](https://powerbi.microsoft.com/documentation/powerbi-service-analyze-in-excel/) e salvá-los por um período de retenção mais longo, de acordo com as suas necessidades.

**Todos os meus dados em relatórios serão exibidos depois de eu configurar a conta de armazenamento?**
...
**Se eu já configurei a conta de armazenamento para exibir relatórios, posso alterar a configuração para usar outra conta de armazenamento?**
...
**Posso exibir relatórios entre cofres e assinaturas?**
