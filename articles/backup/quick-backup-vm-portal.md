...
3. Na seção **Configurações**, escolha **Backup**. A janela **Habilitar backup** será aberta.
...
6. Na lista, escolha o grupo de recursos. Se você tiver usado os comandos de início rápido de VM de exemplo, o grupo de recursos é denominado *myResourceGroup*.
