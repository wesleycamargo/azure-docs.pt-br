---
title: "Backup de um Windows Server ou cliente para o Azure usando o modelo de implantação clássico | Microsoft Docs"
...
---
# <a name="back-up-a-windows-server-or-client-to-azure-using-the-classic-deployment-model"></a>Fazer backup de um Windows Server ou Client para o Azure usando o modelo de implantação clássico
...
## <a name="step-1-create-a-backup-vault"></a>Etapa 1: criar um cofre de backup
...
### <a name="to-create-a-backup-vault"></a>Para criar um cofre de backup
1. Entre no [portal clássico](https://manage.windowsazure.com/).
2. Clique em **Novo** > **Serviços de Dados** > **Serviços de Recuperação** > **Cofre de Backup**, em seguida, escolha **Criação Rápida**.
...
5. Clique em **Criar cofre**.
    ...
    Depois que o cofre de backup tiver sido criado, você verá uma mensagem que informará que o cofre foi criado com êxito. Também aparece como **Ativo** na lista de recursos **Serviços de Recuperação**.
...
6. Selecione a opção de redundância de armazenamento seguindo as etapas descritas aqui.
    ...
    **Para selecionar a opção de redundância de armazenamento.**
    ...
    Se você selecionar **Redundante Localmente**, precisará clicar em **Salvar** (porque a **Redundância Geográfica** é a opção padrão).
