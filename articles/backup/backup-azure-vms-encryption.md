...
- [Erros comuns de](backup-azure-vms-troubleshoot.md#troubleshoot-backup-of-encrypted-vms) quando fazendo backup e restaurando VMs do Azure criptografadas.
