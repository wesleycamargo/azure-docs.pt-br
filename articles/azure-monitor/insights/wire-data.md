...
2. Baixe o agente de dependência do Windows usando o link na seção anterior e, em seguida, executá-lo usando o seguinte comando: `InstallDependencyAgent-Windows.exe`
