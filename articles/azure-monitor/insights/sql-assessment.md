...
* [Pesquise os logs](../../log-analytics/log-analytics-queries.md) para aprender como analisar os dados de Verificação da Integridade do SQL detalhados e as recomendações.
