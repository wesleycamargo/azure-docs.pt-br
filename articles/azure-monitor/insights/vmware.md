...
* Adicionar a solução de monitoramento do VMware à sua assinatura usando o processo descrito em [instalar uma solução de gerenciamento](../insights/solutions.md#install-a-management-solution).
