...
- Power BI: exporte os resultados para o Power BI. Ver [dados de importação do Azure Log Analytics no Power BI](../../azure-monitor/platform/powerbi.md) para obter detalhes.
