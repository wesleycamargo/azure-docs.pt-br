---
title: Redefinição de marca do Azure Monitor| Microsoft Docs
description: Descreve a marca recente e as alterações de nome feitas recentemente para serviços de gerenciamento do Azure.
author: bwren
manager: carmonm
editor: tysonn
...
## <a name="consolidation-of-monitoring-services-into-azure-monitor"></a>Consolidação de serviços de monitoramento no Azure Monitor
...
O Log Analytics desempenha uma função central no gerenciamento do Azure ao coletar a telemetria e outros dados de diversas fontes e fornecer um mecanismo de linguagem de consulta e de análise que fornece insights sobre a operação de seus aplicativos e recursos. Ele continuará a desempenhar essa função crítica como um recurso do Azure Monitor. Outros recursos que foram considerados parte do Log Analytics, como agentes e soluções, serão reposicionados como recursos do Azure Monitor. Sua funcionalidade não mudou para além de possíveis aprimoramentos em sua experiência no portal do Azure.

## <a name="retirement-of-operations-management-suite-brand"></a>Desativação da marca do Operations Management Suite
