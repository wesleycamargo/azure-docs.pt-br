...
* Caso você esteja vendo consistentemente a mesma fração, isso provavelmente se deve à [amostragem](../../application-insights/app-insights-sampling.md)adaptável. Para confirmar isso, abra a Pesquisa (na folha de visão geral) e examine uma instância de uma Solicitação ou outro evento. Na parte inferior da seção de propriedades, clique em "…" para obter detalhes completos da propriedade. Se Contagem de solicitações for > 1, a amostragem estará em operação. 
...
* Veja [Solução de problemas do Monitor de Status](../../azure-monitor/app/monitor-performance-live-website-now.md#troubleshooting-runtime-configuration-of-application-insights). 
...
* Nem todos os tipos de projeto do .NET têm suporte das ferramentas. Há suporte para projetos Web e WCF. Para outros tipos de projeto, como aplicativos de área de trabalho ou de serviço, você ainda pode [adicionar manualmente um SDK do Application Insights ao seu projeto](../../application-insights/app-insights-windows-desktop.md).
...
* Você tem apenas [acesso de leitura para a assinatura ou grupo em que está tentando criar o novo recurso](../../application-insights/app-insights-resources-roles-access-control.md).
...
* Se ainda não estiver funcionando, siga o [procedimento manual](../../application-insights/app-insights-windows-services.md) para adicionar um recurso no portal e, em seguida, adicione o SDK ao seu projeto. 
...
* Alguém adicionou o Application Insights ao projeto e esqueceu-se de dar [acesso ao grupo de recursos](../../application-insights/app-insights-resources-roles-access-control.md) no qual ele foi criado. 
...
Haverá dados de desempenho (CPU, taxa de E/S, etc.) disponíveis para [serviços Web Java](../../azure-monitor/app/java-collectd.md), [aplicativos da área de trabalho do Windows](../../application-insights/app-insights-windows-desktop.md), [aplicativos Web e serviços do IIS se você instalar o Status Monitor](../../azure-monitor/app/monitor-performance-live-website-now.md) e os [Serviços de Nuvem do Azure](../../application-insights/app-insights-overview.md). Encontre-os em Configurações, Servidores.
...
Se o aplicativo enviar muitos dados e se você estiver usando o SDK do Application Insights para o ASP.NET versão 2.0.0-beta3 ou posterior, o recurso de [amostragem adaptável](../../application-insights/app-insights-sampling.md) poderá operar e enviar apenas um percentual de sua telemetria. 
