...
**Aplicativos J2EE** adicionam o seguinte à tag `<TelemetryModules>` dentro de ApplicationInsights.xml
...
Os **aplicativos Spring Boot** adicionam as seguintes propriedades:
...
Verifique se ambas as **configurações de entrada e saídas são exatamente as mesmas**.
