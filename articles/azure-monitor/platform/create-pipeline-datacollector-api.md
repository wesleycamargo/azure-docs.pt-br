...
Saiba mais sobre a [API do Coletor de Dados](../../azure-monitor/platform/data-collector-api.md) para gravar dados no Log Analytics por meio de qualquer cliente de API REST.
