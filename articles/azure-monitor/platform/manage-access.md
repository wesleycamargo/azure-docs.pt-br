...
2. No painel de inscrições do Log Analytics, clique em **Adicionar**.  
    ...
    ![lista de workspaces](./media/manage-access/workspace-link-existing-01.png)
...
4. Clique em **Salvar**.  
    ...
    ![planos de assinatura e seus dados](./media/manage-access/subscription-tab.png)

Seu novo plano de dados é exibido na faixa de opções do portal do OMS, na parte superior da página da Web.

![faixa de opções do OMS](./media/manage-access/data-plan-changed.png)
