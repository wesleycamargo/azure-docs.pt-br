...
![Coleta de dados do Log Analytics](./media/agent-data-sources/overview.png)

As fontes de dados são diferentes das [soluções de gerenciamento](../../azure-monitor/insights/solutions.md), que também coletam dados das fontes conectadas e criam registros no Log Analytics.  Além de coletar dados, as soluções geralmente incluem pesquisas de log e exibições para ajudá-lo a analisar a operação de um determinado aplicativo ou serviço.
...
* Saiba mais sobre [soluções](../../azure-monitor/insights/solutions.md) que adicionam funcionalidades ao Log Analytics e também coletam dados no workspace.
