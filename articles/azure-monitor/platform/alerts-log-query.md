...
As [consultas no Log Analytics](../log-query/log-query-overview.md) começam com uma tabela ou um operador de [pesquisa](/azure/kusto/query/searchoperator) ou [união](/azure/kusto/query/unionoperator).
