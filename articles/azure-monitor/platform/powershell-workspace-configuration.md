...
## <a name="configuring-log-analytics-to-collect-azure-diagnostics-from-storage"></a>Configuração do Log Analytics para coletar o diagnóstico do Azure do armazenamento
