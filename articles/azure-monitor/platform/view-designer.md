...
| Análise | Abre o [portal do Advanced Analytics](../../log-analytics/log-analytics-log-search-portals.md) para analisar dados com consultas de log. |
