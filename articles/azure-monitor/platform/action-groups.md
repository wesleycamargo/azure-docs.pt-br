...
Para receber atualizações sobre as alterações para esses endereços IP, é recomendável que você configure um [alerta de Integridade do Serviço do Azure](./../../monitoring-and-diagnostics/monitoring-service-notifications.md) que monitora notificações informativas sobre o serviço de grupos de ação.
