...
7. Clicando no ícone Adicionar Métrica ![ícone de métrica](./media/metrics-charts/icon001.png) e repetindo as etapas 3 a 6, você pode adicionar mais métricas ao mesmo gráfico.
...
1. Clique no ícone Adicionar Filtro ![ícone de filtro](./media/metrics-charts/icon002.png) acima do gráfico
...
1. Clique no ícone Adicionar Agrupamento  ![imagem de métrica](./media/metrics-charts/icon003.png) acima do gráfico.
