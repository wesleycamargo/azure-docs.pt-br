<properties linkid="develop-java-how-to-twilio-sms-service" urlDisplayName="Serviço de voz/SMS Twilio" pageTitle="Como usar Twilio para voz e SMS (Java) - Azure" metaKeywords="Twilio, API do Twilio API, chamadas telefônicas, mensagem SMS, respostas de TwiML, Azure Twilio Java" description="Saiba como fazer uma chamada telefônica e enviar uma mensagem SMS com o serviço de API do Twilio API no Azure. Exemplos de código escritos no Java." metaCanonical="" services="" videoId="" scriptId="" documentationCenter="Java" title="Como usar o Twilio para a voz e os recursos do SMS no Java" authors="waltpo" solutions="" manager="bjsmith" editor="mollybos" />
...
# Como usar o Twilio para a voz e os recursos de SMS no Java
...
Como uma alternativa para usar um número existente para seus aplicativos, você pode adquirir um número de telefone Twilio. Para obter informações sobre como adquirir um número de telefone Twilio, consulte [Ajuda de números de telefone de Twilio](https://www.twilio.com/help/faq/phone-numbers)
...
Para obter mais informações sobre os parâmetros passados para o método **SmsFactory**, consulte [http://www.twilio.com/docs/api/rest/sending-sms][twilio_rest_sending_sms].
...
Em vez de confiar na URL fornecida pelo Twilio, você pode criar seu próprio site na URL que retorna respostas HTTP. Você pode criar o site em qualquer linguagem que retorna respostas HTTP; este tópico pressupõe que você hospedará a URL em uma página JSP.
