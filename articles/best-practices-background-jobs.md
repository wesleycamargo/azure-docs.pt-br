...
* [Recursos recomendados dos Azure WebJobs](app-service-web/websites-webjobs-resources.md) listam muitos recursos, downloads e exemplos de WebJobs.

## <a name="azure-cloud-services-web-and-worker-roles"></a>Funções de web e de trabalho dos Serviços de Nuvem do Azure
...
### <a name="running-background-tasks-in-the-web-role"></a>Executando tarefas em segundo plano na função web
