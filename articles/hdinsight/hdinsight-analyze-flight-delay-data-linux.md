...
- __CLI do Azure__. Se você não tiver instalado a CLI do Azure, confira [Instalar e configurar a CLI do Azure](../xplat-cli-install.md) para ver mais etapas.
...
Se você já tiver um Banco de Dados SQL, deverá obter o nome do servidor. Você pode encontrá-lo no [Portal do Azure](https://portal.azure.com) selecionando __Bancos de Dados SQL__e filtrando o nome do banco de dados que você deseja usar. O nome do servidor está listado na coluna __SERVIDOR__ .
...
8. Para sair do utilitário tsql, insira `exit` at the `1>` .
