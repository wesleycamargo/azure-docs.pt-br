...
## <a name="add-repositories"></a>Adicionar repositórios

Como HDInsight se baseia no HDP (Hortonworks Data Platform), é recomendável usar o repositório Hortonworks para baixar dependências de seus projetos do HDInsight. No arquivo __pom.xml__, adicione o seguinte após a linha `<url>http://maven.apache.org</url>`:
...
1. Use o seguinte para compilar e executar a topologia do Flux usando o Maven:
    ...
    > [!WARNING]
    > Este comando falhará se a topologia usar bits do Storm 1.0.1. Isso é causado por [https://issues.apache.org/jira/browse/STORM-2055](https://issues.apache.org/jira/browse/STORM-2055). Em vez disso, [instale o Storm no ambiente de desenvolvimento](http://storm.apache.org/releases/0.10.0/Setting-up-development-environment.html) e use as informações a seguir.
