---
title: Consultar dados do armazenamento de blob compatível com o HDFS | Microsoft Docs
...
> [!NOTE]
> Em versões do HDInsight anteriores à versão 3.0, o `asv://` era usado em vez do `wasb://`. O `asv://` não deve ser usado com clusters HDInsight 3.0 ou posteriores, pois isso resultará em erro.
> 
> 
