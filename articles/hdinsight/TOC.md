...
## [Visualização do HDInsight unido a domínio](hdinsight-domain-joined-introduction.md)
## [Visualização do Kafka](hdinsight-apache-kafka-introduction.md)
...
### [Use o Caffe para uma aprendizagem aprofundada](hdinsight-apache-spark-use-with-data-lake-store.md)
...
### [Desenvolver aplicativos usando o Eclipse](hdinsight-apache-spark-eclipse-tool-plugin.md)
...
## Usar visualização do HDInsight unido a domínio
