...
# Introdução
## [Planejar capacidade do cluster HDInsight](hdinsight-capacity-planning.md)
...
## [Iniciar com a Consulta Interativa](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Usar o Azure PowerShell](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Usar o Azure PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
...
#### [Usar o Azure PowerShell](hdinsight-hadoop-use-pig-powershell.md)
...
#### [Executar uma Spark Shell interativo](hdinsight-spark-shell.md)
...
### [O que é Spark Streaming?](hdinsight-spark-streaming-overview.md)
...
## Usar HDInsight ingressado no domínio (Versão Prévia)
...
## Usar Consulta Interativa
### [Usar Zeppelin para executar consultas do Hive](hdinsight-connect-hive-zeppelin.md)
## Desenvolver
...
### [Usar a ferramenta VSCode do HDInsight](hdinsight-for-vscode.md)
## Analisar big data
### [Analisar usando Power Query](hdinsight-connect-excel-power-query.md)
### [Conectar o Power BI ao Hadoop](hdinsight-connect-hive-power-bi.md)
...
### [Autorizar usuários para Exibições do Ambari](hdinsight-authorize-users-to-ambari.md)
### [Gerenciar permissões de usuário nos níveis de arquivo e de pasta](hdinsight-add-acls-at-file-folder-levels.md)
## Gerenciar
...
#### [Executar usando o Azure PowerShell](hdinsight-hadoop-use-sqoop-powershell.md)
...
## [PowerShell do Azure](/powershell/module/azurerm.hdinsight)
