...
Você pode usar a [CLI do Azure para Mac, Linux e Windows](../cli-install-nodejs.md) para criar um novo cluster usando o comando `azure hdinsight cluster create`.
