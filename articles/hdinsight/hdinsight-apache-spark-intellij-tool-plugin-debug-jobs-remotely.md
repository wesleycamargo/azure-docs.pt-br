...
---
# <a name="use-azure-toolkit-for-intellij-to-debug-applications-remotely-on-hdinsight-spark"></a>Kit de ferramentas do Azure para IntelliJ para depurar aplicativos remotamente no HDInsight Spark
