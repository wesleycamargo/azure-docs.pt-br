...
9. Na caixa de diálogo **Criar Nova Classe do Scala**, forneça um nome, para **Tipo** escolha **Objeto** e clique em **OK**.
...
4. Na caixa de diálogo, forneça um nome para a configuração e selecione o **Tipo de teste** como **Nome do teste**. Deixe todos os outros valores como padrão, clique em **Aplicar** e clique em **OK**.
