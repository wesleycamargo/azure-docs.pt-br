<properties
   pageTitle="Usar o Beeline para trabalhar com o Hive no HDInsight (Hadoop) | Microsoft Azure"
...
##<a name="<a-id="ssh"></a>connect-with-ssh"></a><a id="ssh"></a>Conexão com o SSH
...
###<a name="putty-(windows-based-clients)"></a>PuTTY (clientes baseados no Windows)
...
##<a name="<a-id="beeline"></a>use-the-beeline-command"></a><a id="beeline"></a>Usar o comando Beeline
...
##<a name="<a-id="file"></a>run-a-hiveql-file"></a><a id="file"></a>Executar um arquivo HiveQL
...
3. Para salvar o arquivo, use __Ctrl__+___X__, insira __Y__ e, por fim, __Enter__.
...
Se você tiver o Beeline instalado em um cliente fora do cluster, é possível se conectar usando o comando a seguir. Substitua __CLUSTERNAME__ pelo nome do seu cluster HDInsight. Substitua __PASSWORD__ pela senha da conta de administrador (logon HTTP).
...
##<a name="<a-id="summary"></a><a-id="nextsteps"></a>next-steps"></a><a id="summary"></a><a id="nextsteps"></a>Próximas etapas
