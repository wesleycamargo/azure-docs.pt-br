...
1. Quando você provisionar um cluster HDInsight no portal de visualização, clique em **Configuração Opcional** e clique em **Ações de Script**.
