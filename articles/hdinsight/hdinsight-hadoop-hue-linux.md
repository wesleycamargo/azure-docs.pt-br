...
1. Inicie o provisionamento de um cluster usando as etapas em [Provisionar clusters HDInsight em Linux](hdinsight-provision-linux-clusters.md#portal), mas não conclua o provisionamento.
...
2. Na folha **Configuração Opcional**, selecione **Ações de Script** e forneça as informações a seguir:
	...
	* __PARÂMETROS__: o script espera a senha do administrador de cluster como um parâmetro. Especifique a senha entre aspas simples.
...
4. Continue o provisionamento do cluster, conforme descrito em [Provisionar clusters do HDInsight em Linux](hdinsight-provision-linux-clusters.md#portal).
