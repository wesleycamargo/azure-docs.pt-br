...
As etapas neste documento fornecem uma orientação durante o processo de criação de um novo cluster HDInsight usando a CLI do Azure e um modelo:
...
Siga as etapas documentadas em [Conectar a uma assinatura Interface de Linha de Comando do Azure (Azure CLI)](xplat-cli-connect.md) e conectar a sua assinatura usando o método de __logon__.
...
5. Use o seguinte para criar um grupo de recursos vazio. Substitua __RESOURCEGROUPNAME__ pelo nome que você deseja usar para esse grupo. Substitua __local__ com o Centro de dados que você deseja criar o HDInsight cluster em:
