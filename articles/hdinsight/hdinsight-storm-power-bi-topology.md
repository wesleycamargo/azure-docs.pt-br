...
2. Abra o exemplo no Visual Studio. No **Gerenciador de Soluções**, abra o arquivo **App.config** e localize a seguinte entrada:
    ...
    Substitua o valor **##TOBEFILLED##** valor pela cadeia de conexão de banco de dados copiada na etapa anterior. Substitua **{your\_username}** e **{your\_password}** por nome de usuário e a senha para o banco de dados.
...
3. Selecione **Banco de Dados SQL do Azure**, e, em seguida, selecione **Conectar**.
...
6. De **Campos**, expanda a entrada **IISLOGS**. Selecione a caixa de seleção para **URISTEM**. Isso criará um novo relatório que lista os troncos URI (/foo, /bar, etc.) registrados no banco de dados.
