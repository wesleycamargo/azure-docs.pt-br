...
* Pode ser **persistente** ou **ad hoc**.
    ...
    Os scripts **persistentes** são scripts aplicados aos nós de trabalho e serão executados automaticamente nos novos nós criados ao escalar verticalmente um cluster.
  ...
  > 
    ...
    Os scripts **ad hoc** não são persistentes, no entanto, você pode promover posteriormente um script ad hoc a um script persistente ou rebaixar um script persistente a um script ad hoc.
