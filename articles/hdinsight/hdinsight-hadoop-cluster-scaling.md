<properties
   pageTitle="Dimensionar clusters Hadoop, HBase ou Apache Storm no HDInsight | Microsoft Azure"
   description="Altere o número de nós de dados em um cluster Hadoop, Apache Storm ou HBase que esteja sendo executado no HDInsight, sem precisar excluir e recriar o cluster."
   services="hdinsight"
   documentationCenter=""
   authors="mumian"
   manager="paulettm"
