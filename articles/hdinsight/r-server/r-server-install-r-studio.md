...
* Um cluster Azure HDInsight com R Server instalado. Para obter instruções, confira [Introdução ao Servidor R nos clusters HDInsight](r-server-get-started.md).
...
10. Será solicitado que você insira o nome de usuário e a senha do SSH para se conectar ao cluster. Se você usou uma chave SSH ao criar o cluster, deverá inserir a senha criada na etapa 5.
    ...
    ![Conectar-se ao Studio R](./media/r-server-install-r-studio/connecttostudio.png "Criar um túnel SSH")
...
* [Opções de contexto de computação para o R Server em clusters HDInsight](r-server-compute-contexts.md)
