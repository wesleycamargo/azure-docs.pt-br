...
> [!NOTE]
> Esse comando requer um ambiente de desenvolvimento local do Storm. Para obter mais informações, consulte [Configurar um ambiente de desenvolvimento](http://storm.apache.org/releases/1.0.6/Setting-up-development-environment.html)
...
* [Como usar o Python para trabalhos de MapReduce de streaming](../hadoop/apache-hadoop-streaming-python.md)
* [Como usar UDF (Funções Definidas pelo Usuário) do Python no Pig e Hive](../hadoop/python-udf-hdinsight.md)
