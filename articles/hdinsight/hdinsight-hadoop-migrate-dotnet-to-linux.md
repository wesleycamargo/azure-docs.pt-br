...
# Migrar soluções .NET do HDInsight baseado em Windows para o HDInsight baseado em Linux
...
## Compatibilidade de Mono com .NET
...
## Análise automatizada de portabilidade
...
## Análise de portabilidade manual
