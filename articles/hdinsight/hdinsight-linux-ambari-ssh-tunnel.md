...
4. Clique na guia **Padrões de URL** e selecione **Adicionar Novo Padrão**. Use o seguinte para definir o padrão e clique em **OK**:
    ...
    * __Padrão de URL__ - \*headnodehost\*
...
4. Você verá uma página semelhante à seguinte:
    ...
    > [AZURE.NOTE] Observe a URL da página; ela deve ser semelhante a __http://hn1-CLUSTERNAME.randomcharacters.cx.internal.cloudapp.net:8088/cluster__. Ela está usando o nome de domínio totalmente qualificado (FQDN) interno do nó e não pode ser acessada sem a utilização de um túnel SSH.
