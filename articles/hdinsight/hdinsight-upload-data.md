...
1. Execute o Azure Storage Explorer. Se esta for a primeira vez que você executou o Explorador de Armazenamento, deverá inserir o ***Nome da conta de armazenamento*\_ e a __Chave da conta de armazenamento**. Se você tiver o antes, use botão *_Adicionar\*\_ para adicionar um novo nome de conta de armazenamento e chave.
   
    Insira o nome e a chave da conta de armazenamento usada para o seu cluster HDinsight e selecione **Salvar & Abrir**.
...
4. Especifique um arquivo para carregar e **Abrir**. Quando solicitado, selecione **Carregar** para carregar o arquivo para a raiz do contêiner de armazenamento. Se você deseja carregar o arquivo em um caminho específico, digite o caminho no campo **Destino** e, em seguida, selecione **Carregar**.
