...
- Para obter informações sobre o R Server no HDInsight, consulte [Visão geral do R Server no Azure HDInsight](r-server/r-server-overview.md) e [R Server no Azure HDInsight](r-server/r-server-get-started.md).
