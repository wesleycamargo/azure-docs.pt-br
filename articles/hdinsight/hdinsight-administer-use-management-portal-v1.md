---
title: Gerenciar clusters Hadoop no HDInsight usando o Portal Clássico do Azure | Microsoft Docs
...
> [!WARNING]
> As versões mais recentes do Azure PowerShell ou a CLI do Azure padrão usando o Azure Resource Manager. Clusters do HDInsight criados usando esse modo não podem ser gerenciados usando o Portal Clássico do Azure.
> 
> 
...
[!INCLUDE [lista do centro de dados](../../includes/hdinsight-pricing-data-centers-clusters.md)]
...
> 
> Depois que o RDP for habilitado para um cluster, você deverá atualizar a página antes de conectar-se ao cluster.
> 
> 
...
6. Clique em **Abrir**.
7. Digite suas credenciais e **OK**. Use o nome de usuário e a senha que você configurou quando criou o cluster.
8. Clique em **Sim**.
