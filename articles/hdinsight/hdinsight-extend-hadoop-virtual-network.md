...
* Azure PowerShell: para obter mais informações, consulte [Install and Configure Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview) (Instalar e configurar o Azure PowerShell).
