...
3. Após a criação das regras, use o seguinte para aplicar o novo grupo de segurança de rede a uma sub-rede. Substitua **RESOURCEGROUPNAME** pelo nome do grupo de recursos que contém a Rede Virtual do Azure. Substitua **VNETNAME** e **SUBNETNAME** pelo nome da Rede Virtual do Azure e pela sub-rede que será usada durante a instalação do HDInsight.
