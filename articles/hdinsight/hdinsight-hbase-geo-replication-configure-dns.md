...
8. Clique em **Próximo**.
9. Selecione **Instalação baseada em função ou recurso** e clique em **Avançar**.
10. Selecione sua máquina virtual DNS (ela já deve estar realçada) e, em seguida, clique em **Próximo**.
11. Marque **Servidor DNS**.
12. Clique em **Adicionar recursos** e, em seguida, clique em **Continuar**.
13. Clique em **Próximo** três vezes e, em seguida, clique em **Instalar**.
