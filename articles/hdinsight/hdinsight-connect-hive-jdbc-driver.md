...
3. Nos ícones na parte superior do diálogo **Drivers**, selecione o ícone **+** ícone para criar um novo driver.
...
4. No diálogo Adicionar Driver, adicione as informações a seguir.
   ...
   * **Nome**: Hive
   * **URL de Exemplo**: jdbc:hive2://localhost:443/default;ssl=true?hive.server2.transport.mode=http;hive.server2.thrift.http.path=/hive2
...
6. Use os valores a seguir para o diálogo **Adicionar Alias**.
   ...
   * **URL**: jdbc:hive2://NOMEDOCLUSTER.azurehdinsight.net:443/default;ssl=true?hive.server2.transport.mode=http;hive.server2.thrift.http.path=/hive2
