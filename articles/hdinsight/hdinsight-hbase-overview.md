...
---
# <a name="what-is-hbase-in-hdinsight-a-nosql-database-that-provides-bigtablelike-capabilities-for-hadoop"></a>O que é HBase em HDInsight: um banco de dados NoSQL que fornece capacidades semelhantes a BigTable para Hadoop
...
## <a name="a-namenextstepsanext-steps"></a><a name="next-steps"></a>Próximas etapas
...
## <a name="a-nameseealsoasee-also"></a><a name="see-also"></a>Consulte também
