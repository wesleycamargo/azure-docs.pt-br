...
* Para aprender sobre o Apache Hadoop MapReduce, uma maneira de escrever programas que processam dados no Hadoop, consulte [Use o Apache Hadoop MapReduce com o HDInsight](../hdinsight-use-mapreduce.md).
