...
Versão do HDInsight|Versão do HDP|Alta Disponibilidade|Data do lançamento|Disponível no Portal Clássico do Azure|Data de validade do suporte|Data de reprovação
---|---|---|---|---|---|---
