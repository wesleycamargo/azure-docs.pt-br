---
title: Use a ação de Script no HDInsight para instalar o Spark em um cluster do Hadoop | Microsoft Docs
...
1. Na pasta **SimpleScalaApp**, crie uma estrutura de diretório **\\src\\main\\scala** e cole o programa Scala (**SimpleApp.scala**) que você criou anteriormente na pasta \\src\\main\\scala.
