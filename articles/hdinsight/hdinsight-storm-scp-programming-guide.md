...
<properties
pageTitle="Guia de programação do SCP.NET | Azure"
...
O `Logger` é fornecido para fins de obtenção de log.
...
A Especificação da Topologia do SCP é uma linguagem específica do domínio para descrever e configurar topologias do SCP. Baseia-se no Clojure DSL do Storm (<http://storm.incubator.apache.org/documentation/Clojure-DSL.html>) e é estendida pelo SCP.
...
|**scp-tx-spout**|exec-name<br />args<br />fields|Defina um spout transacional. Ele executará o aplicativo com ***exec-name*** usando ***args***.<br /><br />***Fields*** são os Campos de Saída do spout|
|**scp-tx-batch-bolt**|exec-name<br />args<br />fields|Defina um bolt em lote transacional. Ele executará o aplicativo com ***exec-name*** usando ***args.***<br /><br />Os Fields são os Campos de Saída do bolt.|
|**scp-tx-commit-bolt**|exec-name<br />args<br />fields|Defina um bolt confirmador transacional. Ele executará o aplicativo com ***exec-name*** usando ***args***.<br /><br />Os ***Fields*** são os Campos de Saída do bolt|
...
|**scp-spout**|exec-name<br />args<br />fields<br />parameters|Defina um spout não transacional. Ele executará o aplicativo com ***exec-name*** usando ***args***.<br /><br />Os ***Fields*** são os Campos de Saída do spout.<br /><br />Os ***Parameters*** são opcionais, usados para especificar alguns parâmetros como "nontransactional.ack.enabled".|
|**scp-bolt**|exec-name<br />args<br />fields<br />parameters|Defina um bolt não transacional. Ele executará o aplicativo com ***exec-name*** usando ***args***.<br /><br />Os ***Fields*** são os Campos de Saída do bolt.<br /><br />Os ***Parameters*** são opcionais, usados para especificar alguns parâmetros como "nontransactional.ack.enabled".|
...
Se quiser enviar uma topologia contendo Spouts ou Bolts do Java, será necessário primeiro compilar os Spouts ou Bolts do Java e obter os arquivos Jar. Depois, você deve especificar o caminho de classe do Java que contém os arquivos Jar ao enviar a topologia. Aqui está um exemplo:
...
2.  **Serialização no lado do C# e desserialização no lado do Java**
	...
	O usuário também pode usar um plug-in para sua própria implementação de serializador de C# e desserializador de Java. Essa é a interface para o serializador C#:
