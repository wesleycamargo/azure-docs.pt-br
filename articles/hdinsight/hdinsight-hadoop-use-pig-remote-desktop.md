...
## <a name="<a-id="connect"></a>connect-with-remote-desktop"></a><a id="connect"></a>Conectar com a área de trabalho remota
...
## <a name="<a-id="pig"></a>use-the-pig-command"></a><a id="pig"></a>Usar o comando Pig
