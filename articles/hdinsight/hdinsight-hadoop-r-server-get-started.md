...
5. Insira um **Nome de usuário de logon do cluster** e uma **Senha de logon do cluster**.
   ...
   * Em seguida, especifique o arquivo de chave pública (*.pub) quando atribuir credenciais de cluster HDI e, por fim, confirme seu grupo de recursos e região e selecione **Avançar**
...
Para obter mais informações sobre como usar SSH com o HDInsight baseado em Linux, examine os seguintes artigos:
