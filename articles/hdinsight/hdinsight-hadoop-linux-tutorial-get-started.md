...
---
# <a name="hadoop-tutorial-get-started-using-linuxbased-hadoop-in-hdinsight"></a>Tutorial do Hadoop: introdução ao uso do Hadoop baseado em Linux no HDInsight
...
4. Na folha **Implantação personalizada**, insira **Nome do novo grupo de recursos** para criar um novo grupo de recursos.  O grupo de recursos é um contêiner que agrupa o cluster, a conta de armazenamento dependente e outros itens. O local do grupo de recursos pode ser diferente do local do cluster.
...
1. Acesse **https://&lt;NomeDoCluster>.azurehdinsight.net**, onde &lt;NomeDoCluster> é o cluster criado na seção anterior para abrir o Ambari.
