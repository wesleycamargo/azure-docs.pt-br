<properties 
	...
	description="Obtenha as últimas informações sobre as versões mais recentes do Emulador Hadoop do HDInsight, um ambiente de área restrita do Hadoop." 
	editor="cgronlun" 
	manager="paulettm" 
	services="hdinsight" 
	authors="mumian" 
...
# Notas de versão: Emulador do Microsoft HDInsight para o Hadoop 
