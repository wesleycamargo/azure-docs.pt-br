...
* Um cluster HBase implantado em uma rede virtual do Azure com uma máquina virtual DNS.  Para instruções, veja [Provisionar clusters do HBase na Rede Virtual do Azure][hdinsight-hbase-provision-vnet].
