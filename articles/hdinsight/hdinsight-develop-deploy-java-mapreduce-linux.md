<properties
    pageTitle="Desenvolver programas Java MapReduce para HDInsight baseado em Linux | Microsoft Azure"
...
##<a name="<a-name="prerequisites"></a>prerequisites"></a><a name="prerequisites"></a>Pré-requisitos
...
3. Use o comando __mvn__ , que é instalado com o Maven, para gerar o scaffolding para o projeto.
    ...
    Isso criará um novo diretório no diretório atual, com o nome especificado pelo parâmetro __artifactID__ (**wordcountjava** neste exemplo). Esse diretório conterá os itens a seguir:
...
1. Vá até o diretório __wordcountjava/src/main/java/org/apache/hadoop/examples__ e renomeie o arquivo __App.java__ para __WordCount.java__.
...
##<a name="<a-id="upload"></a>upload-the-jar"></a><a id="upload"></a>Carregar o jar
...
##<a name="<a-name="run"></a>run-the-mapreduce-job"></a><a name="run"></a>Executar o trabalho MapReduce
...
2. Na sessão do SSH, use o seguinte comando para executar o aplicativo MapReduce:
    ...
    Isso usará o aplicativo WordCount do MapReduce para contar as palavras no arquivo davinci.txt e armazenará os resultados em __wasbs:///example/data/wordcountout__. Os arquivos de entrada e saída são armazenados no armazenamento padrão do cluster.
