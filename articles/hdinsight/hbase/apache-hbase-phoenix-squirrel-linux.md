...
Para obter mais informações, consulte o [manual do SQLLine](http://sqlline.sourceforge.net/#manual) e a [gramática do Apache Phoenix](http://phoenix.apache.org/language/index.html).
