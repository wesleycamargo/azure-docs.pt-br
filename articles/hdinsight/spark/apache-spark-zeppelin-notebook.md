...
* [Use o Plugin do HDInsight Tools para o IntelliJ IDEA para criar e enviar as aplicações do Apache Spark Scala](apache-spark-intellij-tool-plugin.md)
