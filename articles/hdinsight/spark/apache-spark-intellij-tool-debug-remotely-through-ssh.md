...
7. Se não quiser ver o log em execução no painel à direita, clique no botão **Desconectar**. No entanto, ele ainda estará em execução no back-end e o resultado será exibido no painel esquerdo.
