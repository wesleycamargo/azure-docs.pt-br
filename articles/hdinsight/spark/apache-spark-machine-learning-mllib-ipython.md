...
1. Crie um notebook. Clique em **Novo** e em **PySpark**.
    ...
    ![Criar um bloco de anotações do Jupyter](./media/apache-spark-machine-learning-mllib-ipython/spark-machine-learning-create-jupyter.png "Criar um novo bloco de anotações do Jupyter")
1. Um novo bloco de anotações é criado e aberto com o nome Untitled.pynb. Clique no nome do bloco de anotações na parte superior e digite um nome amigável.
    ...
    ![Fornecer um nome para o bloco de anotações](./media/apache-spark-machine-learning-mllib-ipython/spark-machine-learning-name-jupyter.png "Fornecer um nome para o bloco de anotações")
...
1. Uma rápida visualização pode nos ajudar a entender a distribuição desses resultados. Você já tem os dados em uma tabela temporária **CountResults**. Você pode executar a seguinte consulta SQL em relação à tabela para entender melhor como os resultados são distribuídos.
    ...
    Para saber mais sobre a palavra mágica `%%sql`, e outras palavras mágicas disponíveis com o kernel PySpark, confira [Kernels disponíveis em notebooks Jupyter com clusters HDInsight Spark](apache-spark-jupyter-notebook-kernels.md#parameters-supported-with-the-sql-magic).
