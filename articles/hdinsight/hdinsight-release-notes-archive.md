---
title: "Notas de versão arquivadas dos componentes do Hadoop no Azure HDInsight | Microsoft Docs"
description: "Notas de versão e versões arquivadas de componentes do Hadoop para Azure HDInsight."
services: hdinsight
documentationcenter: 
editor: cgronlun
manager: jhubbard
