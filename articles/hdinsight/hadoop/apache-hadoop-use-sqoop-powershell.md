...
* Um cluster HDInsight, Azure SQL Server e banco de dados, conforme definido na [criar o cluster e o banco de dados SQL](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).
