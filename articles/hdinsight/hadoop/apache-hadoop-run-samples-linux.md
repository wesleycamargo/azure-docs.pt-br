...
* **Um cluster HDInsight**: Consulte [Introdução ao uso do Apache Hadoop com o Apache Hive no HDInsight no Linux](apache-hadoop-linux-tutorial-get-started.md)
