...
> [!NOTE]
> O `2.2.4.9-1` no caminho é a versão do Hortonworks Data Platform para o cluster do HDInsight e pode ser alterado quando o HDInsight for atualizado.
> 
> 
...
4. Use o seguinte para contar todas as palavras nos blocos de anotações de Leonardo Da Vinci, que são fornecidos como dados de exemplo com o cluster:
    ...
    A entrada desse trabalho é lida em **wasbs:///example/data/gutenberg/davinci.txt**.
   
    A saída para esse exemplo está armazenada em **wasbs:///example/data/davinciwordcount**.
...
> [!NOTE]
> O `2.2.4.9-1` do caminho pode ser alterada conforme são feitas atualizações no cluster do HDInsight.
> 
> 
...
1. Gerar 10 GB de dados, que serão armazenados no armazenamento padrão do cluster do HDInsight em **wasbs:///example/data/10GB-sort-input**:
   
        yarn jar /usr/hdp/current/hadoop-mapreduce-client/hadoop-mapreduce-examples.jar teragen -Dmapred.map.tasks=50 100000000 /example/data/10GB-sort-input
   
    O `-Dmapred.map.tasks` informa o Hadoop quantas tarefas de mapeamento serão usadas para este trabalho. Os dois parâmetros finais instruem o trabalho a criar 10 GB de dados e armazená-los em **wasbs:///example/data/10GB-sort-input**.
