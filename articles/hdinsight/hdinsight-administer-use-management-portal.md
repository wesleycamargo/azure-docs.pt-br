...
Você também pode usar o utilitário **Procurar no sistema de arquivos** a partir da **IU do Hadoop** no console do HDInsight. Consulte [Abrir console de Consulta do HDInsight](#open-hdinsight-query-console).
