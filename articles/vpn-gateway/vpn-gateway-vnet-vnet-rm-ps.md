...
4. Crie as configurações de sub-rede para TestVNet1
	...
	O exemplo a seguir usa as variáveis que você definiu anteriormente. Neste exemplo, a sub-rede de gateway está usando um /27. Embora você possa criar uma sub-rede de gateway usando uma sub-rede tão pequena quanto a /29, nós não recomendamos fazer isso. Recomendamos usar algo maior, como uma /27 ou /26. Isso permitirá que você aproveite as configurações existentes ou futuras que possam exigir uma sub-rede de gateway maior.
