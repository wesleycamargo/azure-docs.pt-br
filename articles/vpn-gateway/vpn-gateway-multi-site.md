...
* Você precisará instalar a versão mais recente dos cmdlets do Azure PowerShell. Confira [Como instalar e configurar o Azure PowerShell](/powershell/azureps-cmdlets-docs) para saber mais sobre como instalar os cmdlets do PowerShell.
...
Exporte o arquivo de configuração de rede. O arquivo exportado será usado usado para configurar as novas definições de múltiplos sites. Se você precisar de instruções sobre como exportar um arquivo, consulte a seção neste artigo: [Como criar uma rede virtual clássica portal do Azure](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal).
...
Importe o arquivo de configuração de rede. Ao importar esse arquivo com as alterações, os novos túneis serão adicionados. Os túneis usarão o gateway dinâmico que você criou anteriormente. Se você precisar de instruções sobre como importar um arquivo, consulte a seção neste artigo: [Como criar uma rede virtual clássica portal do Azure](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal).  
