...
Nesse cenário, conectamos TestVNet1 e TestVNet5. As redes virtuais residem em assinaturas diferentes. As etapas para essa configuração adicionam outra conexão de VNet para VNet para se conectar TestVNet1 a TestVNet5.
