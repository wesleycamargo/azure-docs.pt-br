...
## Redefinir um Gateway de VPN usando o modelo de implantação do Gerenciamento de Recursos
...
## Redefinir um Gateway de VPN usando o modelo de implantação clássico
...
Consulte a [Referência de cmdlet do Gerenciamento de Serviços do PowerShell](https://msdn.microsoft.com/library/azure/mt617104.aspx) e a [Referência de cmdlet do PowerShell Resource Manager](http://go.microsoft.com/fwlink/?LinkId=828732) para obter mais informações.
