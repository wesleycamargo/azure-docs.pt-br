...
>[!NOTE]
>O IKEv2 para P2S está atualmente em versão prévia e está disponível para o modelo de implantação do Resource Manager.
>
...
>[!NOTE]
>Autenticação Atualmente, a autenticação RADIUS para P2S está em Versão Prévia.
>
