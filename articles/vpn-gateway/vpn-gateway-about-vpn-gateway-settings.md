...
## <a name="a-nameconnectiontypeaconnection-types"></a><a name="connectiontype"></a>Tipos de conexão
...
## <a name="a-namerequirementsagateway-requirements"></a><a name="requirements"></a>Requisitos do gateway
[!INCLUDE [vpn-gateway-table-requirements](../../includes/vpn-gateway-table-requirements-include.md)]

## <a name="a-namegwsubagateway-subnet"></a><a name="gwsub"></a>Sub-rede do gateway
...
## <a name="a-namelngalocal-network-gateways"></a><a name="lng"></a>Gateways de rede locais
