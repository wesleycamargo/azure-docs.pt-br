...
### <a name="<a-name="compare"></a>cross-premises-connectivity-options"></a><a name="compare"></a>Opções de conectividade entre locais
...
### <a name="<a-name="gwrequire"></a>gateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Requisitos de gateway por tipo de VPN e SKU
...
<br>
 A tabela a seguir mostra os tipos de gateway e a produtividade agregada estimada. A taxa de transferência agregada estimada pode ser um fator decisivo para seu design.
Os preços diferem entre os SKUs de gateway. Para obter informações sobre preços, veja [Preços de gateway de VPN](https://azure.microsoft.com/pricing/details/vpn-gateway/). Esta tabela aplica-se a ambos os modelos de implantação do Gerenciador de Recursos e clássico.

[!INCLUDE [vpn-gateway-table-gwtype-aggtput](../../includes/vpn-gateway-table-gwtype-aggtput-include.md)]

### <a name="<a-name="wf"></a>workflow"></a><a name="wf"></a>Fluxo de trabalho
...
### <a name="<a-name="topologies"></a>connection-topologies"></a><a name="topologies"></a>Topologias de conexão
...
### <a name="<a-name="designbasics"></a>design-basics"></a><a name="designbasics"></a>Noções básicas sobre design
...
#### <a name="<a-name="subnets"></a>about-subnets"></a><a name="subnets"></a>Sobre sub-redes
...
#### <a name="<a-name="local"></a>about-local-network-gateways"></a><a name="local"></a>Sobre gateways de rede local
...
#### <a name="<a-name="gwtype"></a>about-gateway-types"></a><a name="gwtype"></a>Sobre tipos de gateway
...
#### <a name="<a-name="connectiontype"></a>about-connection-types"></a><a name="connectiontype"></a>Sobre tipos de conexão
...
#### <a name="<a-name="vpntype"></a>about-vpn-types"></a><a name="vpntype"></a>Sobre tipos de VPN
...
### <a name="<a-name="devices"></a>vpn-devices-for-site-to-site-connections"></a><a name="devices"></a>Dispositivos de VPN e conexões Site a Site
...
### <a name="<a-name="forcedtunnel"></a>consider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>Considere a possibilidade de roteamento de túnel forçado
