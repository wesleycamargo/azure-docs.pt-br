...
---
# <a name="create-a-vpn-gateway-and-add-point-to-site-configuration-using-powershell"></a>Criar um Gateway de VPN e adicionar uma configuração ponto a site usando o PowerShell
