...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] VPNs PolicyBased só podem ser criadas para gateways usando o SKU Básico.
Para saber mais sobre os SKUs de gateway, consulte [SKUs de Gateway](vpn-gateway-about-vpn-gateway-settings.md#gwsku).
