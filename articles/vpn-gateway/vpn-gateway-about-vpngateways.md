...
## <a name="site-to-site-and-multi-site"></a>Site a Site e Vários Sites
...
![Conexão S2S](./media/vpn-gateway-about-vpngateways/demos2s.png "site a site")
...
![Conexão multissite](./media/vpn-gateway-about-vpngateways/demomulti.png "multissite")
...
![Conexão VNet a VNet](./media/vpn-gateway-about-vpngateways/demov2v.png "vnet a vnet")
...
## <a name="site-to-site-and-expressroute-coexisting-connections"></a>Conexões coexistentes Site a Site e de Rota Expressa
...
![Coexistir conexão](./media/vpn-gateway-about-vpngateways/demoer.png "expressroute-site2site")
