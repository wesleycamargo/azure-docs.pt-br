...
* [Desenvolver com a API de SQL no .NET](tutorial-develop-documentdb-dotnet.md).
* [Azure Cosmos DB: tutorial de introdução à API do SQL](documentdb-get-started.md).
