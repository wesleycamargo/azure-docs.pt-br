...
ms.locfileid: "54038595"
---
# <a name="quickstart-build-a-table-api-app-with-net-and-azure-cosmos-db"></a>Início Rápido: Compilar um aplicativo de API de Tabela com o .NET e o Azure Cosmos DB 
