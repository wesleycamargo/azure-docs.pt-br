...
ms.locfileid: "53407670"
---
# <a name="azure-cosmos-db-build-a-net-framework-or-core-application-using-the-gremlin-api"></a>O Azure Cosmos DB: Compilar um aplicativo .NET Framework ou Core usando a API do Gremlin
