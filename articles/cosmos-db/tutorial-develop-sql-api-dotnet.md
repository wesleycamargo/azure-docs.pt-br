...
description: Aprenda a desenvolver com a API do SQL do Azure Cosmos DB usando o .NET
services: cosmos-db
documentationcenter: 
author: rafats
manager: jhubbard
...
---
# <a name="azure-cosmosdb-develop-with-the-sql-api-in-net"></a>Azure Cosmos DB: Desenvolver com a API do SQL no .NET
