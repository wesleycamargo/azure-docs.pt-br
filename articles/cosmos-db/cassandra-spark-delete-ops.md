...
Este artigo descreve como excluir dados nas tabelas de API do Cassandra do Azure Cosmos DB do Spark.
...
Usaremos esse fragmento de código para gerar dados de exemplo:
...
### <a name="delete-all-the-rows-in-the-table"></a>Exclua todas as linhas na tabela
