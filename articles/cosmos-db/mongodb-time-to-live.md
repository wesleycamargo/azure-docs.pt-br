...
description: Saiba como definir o valor de vida útil para os documentos do Cosmos DB criados por meio da API do MongoDB para limpá-los automaticamente do sistema após um período de tempo.
services: cosmos-db
author: orestis-ms
ms.author: orkostak
