...
Para obter mais informações, confira a [página de preços do Cosmos DB](https://azure.microsoft.com/pricing/details/cosmos-db/) e [Entendendo sua fatura do Cosmos DB](understand-your-bill.md).

O modelo de preços do Azure Cosmos DB é consistente em todas as APIs. Para saber mais, confira [Como o modelo de preços do Cosmos DB é econômico para os clientes](total-cost-ownership.md). Há uma taxa de transferência mínima exigida em um banco de dados ou contêiner para garantir os SLAs, e você pode aumentar ou diminuir a taxa de transferência provisionada por US$ 6 para cada 100 RU/s.
...
* Saiba mais sobre [Entendendo sua cobrança do Cosmos DB](understand-your-bill.md)
...
* Saiba mais sobre [Capacidade reserva do Cosmos DB](cosmos-db-reserved-capacity.md)
