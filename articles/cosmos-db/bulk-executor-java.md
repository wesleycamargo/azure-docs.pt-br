...
description: Use a biblioteca Java do executor em massa do Azure Cosmos DB para importar e atualizar documentos em massa para contêineres do Azure Cosmos DB.
