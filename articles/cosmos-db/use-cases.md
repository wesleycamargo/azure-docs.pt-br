...
Para começar a usar o Azure Cosmos DB, siga nossos [inícios rápidos](create-documentdb-dotnet.md), que mostram um passo a passo para criar uma conta e começar com o Cosmos DB. 
