...
Para obter uma introdução ao Azure Cosmos DB, siga nossos [inícios rápidos](create-documentdb-dotnet.md), que mostrarão um passo a passo para criar uma conta e uma introdução ao Cosmos DB. 
