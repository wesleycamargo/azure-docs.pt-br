...
Se sua conta do Cosmos for distribuída entre N regiões do Azure, haverá pelo menos N x 4 cópias de todos os seus dados. Além de fornecer acesso aos dados de baixa latência e dimensionar a taxa de transferência de gravação/leitura entre as regiões associadas à sua conta do Cosmos, ter mais regiões (N maior) também melhora a disponibilidade.  

## <a name="slas-for-availability"></a>SLAs de disponibilidade   

Como um banco de dados distribuído globalmente, o Cosmos DB fornece SLAs abrangentes que englobam a taxa de transferência, a latência no 99º percentil, a coerência e a alta disponibilidade. Na tabela a seguir, descrevemos as garantias referentes à alta disponibilidade fornecida pelo Cosmos DB para contas de uma única região e de várias regiões. Para alta disponibilidade, configure suas contas do Cosmos para que tenham várias regiões de gravação.
...
* [Dimensionar a taxa de transferência provisionada globalmente](scaling-throughput.md)
