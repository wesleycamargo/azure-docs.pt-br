---
title: 'Azure Cosmos DB: criar um aplicativo do Node.js usando o SDK do JavaScript para gerenciar os dados da API do SQL do Azure Cosmos DB | Microsoft Docs'
