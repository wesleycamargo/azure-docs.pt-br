...
1. `T x N RU/s` Se sua conta do Cosmos do Azure é configurada com uma região de gravação única. 

1. `T x (N+1) RU/s` Se sua conta do Cosmos do Azure é configurada com todas as regiões capazes de processar gravações. 
