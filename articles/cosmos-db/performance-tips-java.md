...
1. **Modo de Conexão: usar DirectHttps**
   ...
   1. [Gateway (padrão)](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb._connection_mode)
