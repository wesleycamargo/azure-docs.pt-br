...
ms.locfileid: "53073407"
---
# <a name="azure-cosmos-db-build-a-nodejs-application-by-using-gremlin-api"></a>O Azure Cosmos DB: Criar um aplicativo Node.js usando a API do Gremlin
