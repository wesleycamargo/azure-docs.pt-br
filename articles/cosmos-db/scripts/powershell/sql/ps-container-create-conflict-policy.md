---
title: O Azure PowerShell script - criar um contêiner com a política de resolução de conflito em uma conta do Azure Cosmos
description: Script do Azure PowerShell de exemplo - criar um contêiner com a política de resolução de conflito em uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078319"
---
# <a name="create-a-container-with-conflict-resolution-policy-in-an-azure-cosmos-account-using-powershell"></a>Criar um contêiner com a política de resolução de conflito em uma conta de Cosmos do Azure usando o PowerShell
