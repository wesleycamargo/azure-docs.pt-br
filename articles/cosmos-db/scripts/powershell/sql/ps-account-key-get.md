---
title: Script do PowerShell do Azure – obter chaves para uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure – obter chaves para uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078394"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>Obter chaves para uma conta de Cosmos do Azure usando o PowerShell
