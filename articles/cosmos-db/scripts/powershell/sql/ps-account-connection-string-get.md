---
title: Script do Azure PowerShell - Get cadeias de caracteres de conexão para uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure - cadeias de caracteres de conexão de Get para uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078439"
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>Obter cadeias de caracteres de conexão para uma conta de Cosmos do Azure usando o PowerShell
