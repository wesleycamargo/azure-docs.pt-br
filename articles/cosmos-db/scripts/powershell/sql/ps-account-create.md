---
title: O Azure PowerShell script - criar uma conta do Azure Cosmos para núcleo (API do SQL)
description: Script do Azure PowerShell de exemplo - criar uma conta do Azure Cosmos para núcleo (API do SQL)
author: markjbrown
...
ms.locfileid: "65078424"
---
# <a name="create-an-azure-cosmos-account-for-core-sql-api-account-using-powershell"></a>Criar uma conta de Cosmos do Azure para a conta de API do SQL (núcleo) usando o PowerShell
