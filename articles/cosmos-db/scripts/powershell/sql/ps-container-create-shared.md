---
title: O Azure PowerShell script - criar um contêiner com taxa de transferência compartilhada em uma conta do Azure Cosmos
description: Script do Azure PowerShell de exemplo - criar um contêiner com taxa de transferência compartilhada em uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078259"
---
# <a name="create-a-container-with-shared-throughput-in-an-azure-cosmos-account-using-powershell"></a>Criar um contêiner com taxa de transferência compartilhada em uma conta de Cosmos do Azure usando o PowerShell
