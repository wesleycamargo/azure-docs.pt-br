---
title: Script do PowerShell do Azure - marcas de atualização para uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure - marcas de atualização para uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078334"
---
# <a name="update-tags-for-an-azure-cosmos-account-using-powershell"></a>Atualizar as marcas para uma conta de Cosmos do Azure usando o PowerShell
