---
title: O Azure PowerShell script - criar um contêiner em uma conta do Azure Cosmos
description: Script do Azure PowerShell de exemplo - criar um contêiner em uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078229"
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>Criar um contêiner em uma conta de Cosmos do Azure usando o PowerShell
