---
title: Script do PowerShell do Azure – excluir um contêiner em uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure – excluir um contêiner em uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078214"
---
# <a name="delete-a-container-in-an-azure-cosmos-account-using-powershell"></a>Excluir um contêiner em uma conta de Cosmos do Azure usando o PowerShell
