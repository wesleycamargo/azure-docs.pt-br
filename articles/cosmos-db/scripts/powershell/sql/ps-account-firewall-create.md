---
title: Script do PowerShell do Azure – configurar o Firewall de IP para uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure - configurar o Firewall de IP para uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078364"
---
# <a name="configure-ip-firewall-for-an-azure-cosmos-account-using-powershell"></a>Configurar o Firewall de IP para uma conta de Cosmos do Azure usando o PowerShell
