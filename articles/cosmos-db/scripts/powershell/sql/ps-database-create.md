---
title: O Azure PowerShell script - criar um banco de dados Cosmos do Azure
description: Script do Azure PowerShell de exemplo - criar um banco de dados Cosmos do Azure
author: markjbrown
...
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>Criar um banco de dados Cosmos do Azure usando o PowerShell
