---
title: Script do PowerShell do Azure – regenerar chaves para uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure – regenerar chaves para uma conta do Azure Cosmos
author: markjbrown
...
---
# <a name="regenerate-keys-for-an-azure-cosmos-account-using-powershell"></a>Regenerar chaves para uma conta de Cosmos do Azure usando o PowerShell
