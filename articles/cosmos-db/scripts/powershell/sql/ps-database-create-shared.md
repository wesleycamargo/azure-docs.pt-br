---
title: O Azure PowerShell script - criar um banco de dados Cosmos do Azure com taxa de transferência compartilhada
description: Script do Azure PowerShell de exemplo - criar um banco de dados Cosmos do Azure com taxa de transferência compartilhada
author: markjbrown
...
ms.locfileid: "65077704"
---
# <a name="create-an-azure-cosmos-database-with-shared-throughput-using-powershell"></a>Criar um banco de dados Cosmos do Azure com taxa de transferência compartilhada usando o PowerShell
