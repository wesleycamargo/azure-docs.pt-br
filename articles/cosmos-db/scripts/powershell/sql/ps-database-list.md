---
title: Script do PowerShell do Azure – lista todos os bancos de dados em uma conta do Azure Cosmos
description: Exemplo de script do PowerShell do Azure – lista todos os bancos de dados em uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65077674"
---
# <a name="list-all-databases-in-an-azure-cosmos-account-using-powershell"></a>Listar todos os bancos de dados em uma conta de Cosmos do Azure usando o PowerShell
