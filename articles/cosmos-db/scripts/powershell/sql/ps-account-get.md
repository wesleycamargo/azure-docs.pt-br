---
title: Script do PowerShell do Azure – obter uma conta do Azure Cosmos
description: Exemplo de script de PowerShell do Azure – obter uma conta do Azure Cosmos
author: markjbrown
...
ms.locfileid: "65078379"
---
# <a name="get-the-properties-for-an-azure-cosmos-account-using-powershell"></a>Obter as propriedades para uma conta de Cosmos do Azure usando o PowerShell
