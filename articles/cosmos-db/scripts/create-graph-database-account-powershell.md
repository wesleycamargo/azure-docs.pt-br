---
title: Script do Azure PowerShell – Criar uma conta de API do Gremlin do Azure Cosmos DB | Microsoft Docs
...
ms.locfileid: "41919358"
---
# <a name="azure-cosmos-db-create-a-gremlin-api-account-using-powershell"></a>Azure Cosmos DB: Criar uma conta de API do Gremlin usando PowerShell
