---
title: Script do Azure PowerShell – Criar uma conta de API do Cassandra do Azure Cosmos DB | Microsoft Docs
...
ms.locfileid: "41919472"
---
# <a name="azure-cosmos-db-create-a-cassandra-api-account-using-powershell"></a>Azure Cosmos DB: criar uma conta de API do Cassandra usando PowerShell
