---
title: Script do Azure PowerShell – Criar uma conta de API do MongoDB do Azure Cosmos DB | Microsoft Docs
description: Exemplo de script do Azure PowerShell – Criar uma conta de API do MongoDB do Azure Cosmos DB
services: cosmos-db
...
ms.locfileid: "34795679"
---
# <a name="azure-cosmos-db-create-a-mongodb-api-account-using-powershell"></a>Azure Cosmos DB: Criar uma conta de API do MongoDB usando PowerShell

Este exemplo de script do PowerShell cria uma conta de API do MongoDB do Azure Cosmos DB. 
