...
[!code-powershell[main](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "Criar um firewall para o Banco de Dados Cosmos do Azure")]
