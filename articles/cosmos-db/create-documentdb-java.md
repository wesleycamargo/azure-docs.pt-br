...
---
# <a name="azure-cosmos-db-build-a-documentdb-api-app-with-java-and-the-azure-portal"></a>Azure Cosmos DB: compilar um aplicativo de API do DocumentDB com Java e com o Portal do Azure
...
4. Em seguida, copie o valor da CHAVE PRIMÁRIA do portal e transforme-o no valor da chave mestra para o construtor DocumentClient em 'Program.java'. Agora, você atualizou o aplicativo com todas as informações necessárias para se comunicar com o Azure Cosmos DB. 
