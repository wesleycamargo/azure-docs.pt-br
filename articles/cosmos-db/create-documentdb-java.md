...
Este início rápido demonstra como criar uma conta do BD Cosmos do Azure, um banco de dados de documento e uma coleção usando o Portal do Azure. Em seguida, você compilará e executará um aplicativo de console compilado na [API do Java do DocumentDB](../documentdb/documentdb-sdk-java.md).
