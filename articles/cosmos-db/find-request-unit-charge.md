...
Ao usar o [driver oficial do Java do MongoDB](https://mongodb.github.io/mongo-java-driver/) (confira [este Início Rápido](create-mongodb-java.md) sobre seu uso), os comandos podem ser executados por meio da chamada do método `runCommand` em um objeto `MongoDatabase`.
