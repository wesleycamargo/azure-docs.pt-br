<properties
    pageTitle="Criar um namespace de Barramento de Serviço com fila | Microsoft Azure"
    description="Criar um namespace e fila de Barramento de Serviço usando um modelo ARM"
...
Filas oferecem entrega de mensagem do tipo PEPS (primeiro a entrar, primeiro a sair) para um ou mais consumidores concorrentes.

[Saiba mais sobre filas de Barramento de Serviço](service-bus-queues-topics-subscriptions.md).

Para executar a implantação automaticamente, clique no seguinte botão:

[![Implantar no Azure](./media/service-bus-arm-namespace-queue/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-queue%2Fazuredeploy.json)
