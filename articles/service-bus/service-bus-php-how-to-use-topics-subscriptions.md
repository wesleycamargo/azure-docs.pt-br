...
O exemplo a seguir cria uma assinatura denominada **HighMessages** com um **SqlFilter** que seleciona apenas as mensagens com uma propriedade **MessageNumber** personalizada maior do que 3 (confira [Como enviar mensagens para um tópico](#SendMessage) para saber mais sobre como adicionar propriedades personalizadas a mensagens):
