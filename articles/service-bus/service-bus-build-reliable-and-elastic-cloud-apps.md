<properties 
	pageTitle="Compilar aplicativos da nuvem confiáveis e elásticos com o sistema de mensagens | Microsoft Azure" 
...
- [Conceitos básicos do Barramento de Serviço do Microsoft Azure](service-bus-fundamentals-hybrid-solutions.md)
...
- [Relatos de clientes](https://customers.microsoft.com/Pages/Home.aspx)
...
- [Aplicativo multicamadas com o Barramento de Serviço do Azure](service-bus-dotnet-multi-tier-app-using-service-bus-queues.md)
