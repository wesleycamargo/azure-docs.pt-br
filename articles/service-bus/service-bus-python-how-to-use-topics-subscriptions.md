...
As mensagens são excluídas da assinatura conforme elas são lidas quando o parâmetro **peek_lock** é definido como **False**. Você pode ler (peek) e bloquear a mensagem sem excluí-la da fila definindo o parâmetro **peek\_lock** como **True**.
