---
title: Integração do SDK para iOS do Engajamento Móvel do Azure | Microsoft Docs
...
> [!NOTE]
> A estrutura AdSupport pode ser removida. O Engagement precisa dessa estrutura para coletar o IDFA. No entanto, a coleção de IDFA pode ser desabilitada < ios-sdk-contrato-idfa > de acordo com a nova política Apple em relação a essa ID.
> 
> 
...
> [!IMPORTANT]
> O SDK do iOS chama automaticamente o `endActivity()` método quando o aplicativo é fechado. Portanto, é *ALTAMENTE* recomendado chamar o método `startActivity` sempre que a atividade do usuário for alterada e *NUNCA* chamar o método `endActivity`, visto que chamar esse método força o encerramento da sessão atual.
> 
> 
