...
## <a name="realtime-actionable-analytics-to-maximize-return-on-investment"></a>Análise acionável em tempo real para maximizar o retorno do investimento
...
## <a name="valueadded-push-and-communications-platform"></a>Plataformas de push e de comunicações de valor agregado
