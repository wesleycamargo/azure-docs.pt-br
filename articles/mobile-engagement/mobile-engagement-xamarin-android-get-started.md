...
Como alternativa, se você não puder herdar de `EngagementActivity`, você deverá adicionar os métodos `.StartActivity` e `.EndActivity` no `OnResume` e `OnPause`, respectivamente.
