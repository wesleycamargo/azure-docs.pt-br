<properties
	pageTitle="Criar uma conta do Mobile Engagement do Azure e começar a gerenciar seus aplicativos | Microsoft Azure"
	description="Descreve como criar uma nova conta do Mobile Engagement no Azure e começar a gerenciar seus aplicativos com o portal do Mobile Engagement."
...
# Criar uma conta do Mobile Engagement do Azure e começar a gerenciar seus aplicativos

Este artigo mostra como usar o método **Criação Rápida** para criar uma nova conta do **Mobile Engagement do Azure**. O artigo também mostra como navegar até o portal do **Mobile Engagement** para iniciar o monitoramento e o gerenciamento de seus aplicativos.
