<properties 
	pageTitle="Sites Python com garrafa - tutorial do Azure" 
...
Você criará um aplicativo usando a estrutura de web garrafa (Consulte versões alternativas deste tutorial para [Django](web-sites-python-create-deploy-django-app.md) e [bulbo](web-sites-python-create-deploy-flask-app.md)).  Você criará o site a partir da Galeria do Azure, configurará a implantação do Git e clonará o repositório localmente.  Em seguida, você executará o aplicativo localmente, fará alterações, as confirmará e as enviará para o Azure.  O tutorial mostra como fazer isso no Windows ou Mac/Linux.
...
Para Git, recomendamos [Git para Windows](http://msysgit.github.io/) ou [GitHub para Windows](https://windows.github.com/).  Se você usar o Visual Studio, você pode usar o suporte Git integrado.
...
Uma janela será exibida, listando os aplicativos disponíveis na Galeria. Clique na categoria **ESTRUTURAS DO APLICATIVO** à esquerda e selecione **Garrafa**.
...
O site será rapidamente configurado. Você pode clicar no botão **PROCURAR** a partir da barra de ferramentas inferior e verá o novo aplicativo Garrafa em execução no Azure.
...
Seu aplicativo pode ter dependências além de Python e Garrafa.
...
Siga estes links para saber mais sobre as ferramentas de Garrafa e Python para Visual Studio: 
...
<!--Link references-->
[Bottle e MongoDB no Azure com Python Tools 2.1 for Visual Studio]: ../web-sites-python-ptvs-bottle-table-storage
[Bottle e Armazenamento de Tabela do Azure com Python Tools 2.1 para Visual Studio]: ../web-sites-python-ptvs-bottle-mongodb
