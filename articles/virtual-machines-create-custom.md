...
Uma máquina virtual *personalizada* é simplesmente a uma máquina virtual que você criou da opção **de Galeria** porque isso lhe dá mais opções de configuração do que a opção **Criação Rápida**.Essas opções incluem:
