...
Para saber mais sobre DMZs e como implantá-las no Azure, leia o artigo [Segurança de rede e serviços de nuvem da Microsoft](best-practices-network-security.md).
...
Para saber mais sobre como funciona o Balanceador de Carga Externo do Azure e sobre como você pode implantá-lo, leia o artigo [Introdução à criação de um balanceador de carga voltado para Internet no Resource Manager usando o PowerShell](./load-balancer/load-balancer-get-started-internet-arm-ps.md).
