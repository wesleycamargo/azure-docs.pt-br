<properties linkid="develop-media-services-how-to-guides-deliver-apple-live-streaming" urlDisplayName="Como fornecer o HTTP Live Streaming (HLS) da Apple" pageTitle="Como fornecer o HTTP Live Streaming (HLS) da Apple - Azure" metaKeywords="" description="Saiba como criar um localizador para conteúdo HTTP Live Streaming (HLS) da Apple no servidor de origem dos Serviços de Mídia. Os exemplos de código são escritos em C# e usam o SDK dos Serviços de Mídia para .NET." metaCanonical="" services="media-services" documentationCenter="" title="Como fornecer conteúdo de Streaming HLS da Apple" authors="migree" solutions="" manager="" editor="" />





<h1>Como fornecer conteúdo de Streaming HLS da Apple</h1>

Este artigo faz parte de uma série de introdução à programação dos Serviços de Mídia do Azure. O tópico anterior foi [Como fornecer conteúdo de streaming](http://go.microsoft.com/fwlink/?LinkID=301942&clcid=0x409)
...
Para criar um localizador para conteúdo de streaming HLS da Apple:
   ...
   3. Crie o localizador de origem chamando o CreateLocator
...
-	[Como monitorar uma conta de Serviços de Mídia](http://www.windowsazure.com/pt-br/manage/services/media-services/how-to-monitor-a-media-services-account/)
-	[Como gerenciar conteúdo nos Serviços de Mídia](http://www.windowsazure.com/pt-br/manage/services/media-services/how-to-manage-content-in-media-services/)
