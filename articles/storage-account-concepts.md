...
Também é possível configurar um nome de domínio para usar com a conta de armazenamento. Consulte[ Configurar um nome de domínio personalizado para dados de blob em uma conta de armazenamento](http://azure.microsoft.com/pt-br/documentation/articles/storage-custom-domain-name/) para obter detalhes.
