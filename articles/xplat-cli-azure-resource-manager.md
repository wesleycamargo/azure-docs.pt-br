<properties linkid="script-xplat-intro" urlDisplayName="Interface de linha de comando da plataforma cruzada do Microsoft Azure" pageTitle="Usando a interface de linha de comando da plataforma cruzada do Microsoft Azure com o Gerenciador de Recursos" title="Usando a interface de linha de comando da plataforma cruzada do Microsoft Azure com o Gerenciador de Recursos" metaKeywords="windows azure plataforma cruzada interface de linha de comando Gerenciador de Recursos, windows azure linha de comando gerenciador de recursos, azure linha de comando gerenciador de recursos, azure cli gerenciador de recursos" description="Usar a interface de linha de comando da plataforma cruzada do Microsoft Azure com o Gerenciador de Recursos" metaCanonical="http://www.windowsazure.com/pt-br/script/xplat-cli-intro" umbracoNaviHide="0" disqusComments="1" editor="mollybos" manager="paulettm" documentationCenter="" solutions="" authors="larryfr" services="" />
...
>[WACOM.NOTE] O Gerenciador de Recursos está em visualização no momento e não oferece o mesmo nível de recursos de gerenciamento, como Gerenciamento de Serviços do Azure.

>[WACOM.NOTE] Se você ainda não tiver instalado e configurado xplat cli, consulte [Instalar e configurar a interface de linha de comando da plataforma cruzada do Microsoft Azure][xplatsetup] para obter mais etapas sobre como instalar, configurar e usar o xplat-cli.

##Gerenciador de Recursos

O Gerenciador de Recursos permite gerenciar um grupo de _recursos_ (entidades gerenciadas pelo usuário, como um servidor de banco de dados, um banco de dados ou um site) como uma unidade lógica única ou um _grupo de recursos_. Por exemplo, um grupo de recursos pode conter um site e recursos de banco de dados SQL.
...
Atualmente, o trabalho com o Gerenciador de Recursos por meio do xplat-cli exige que você se autentique no Microsoft Azure usando uma conta organizacional. A autenticação usando-se uma conta da Microsoft ou um certificado instalado por meio de um arquivo .publishsettings não funcionará.

Para obter mais informações sobre como se autenticar usando uma conta organizacional, consulte [[Instalar e configurar a interface de linha de comando da plataforma cruzada do Microsoft Azure][xplatsetup].
...
> [WACOM.NOTE] Usando os comandos `azure resource` que não sejam o comando `list`, você deve especificar a versão da API do recurso com que está trabalhando usando o parâmetro `-o`. Se você não tiver certeza sobre a versão da API a ser usada, consulte o arquivo de modelo e localize o campo **apiVersion** do recurso.
...
* Para obter mais informações sobre como usar a interface de linha de comando da plataforma cruzada do Azure, consulte [Instalar e configurar a interface de linha de comando da plataforma cruzada do Microsoft Azure][xplatsetup].
* Para obter informações sobre como trabalhar com o Gerenciador de Recursos usando o Windows Azure PowerShell, consulte [Guia de introdução usando o Windows PowerShell com o Gerenciador de Recursos][psrm]
