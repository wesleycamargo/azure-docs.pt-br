...
Na visualização, SDKs estão disponíveis para .NET, Python, Node.js e JavaScript.  Desenvolvimentos também podem aproveitar as APIs de HTTP RESTful para interagir com os recursos do Banco de Dados de Documentos de uma variedade de plataformas e idiomas. Para obter detalhes sobre como usar esses SDKs, consulte a seção Desenvolvimento na [página de documentação do Banco de Dados de Documentos](http://go.microsoft.com/fwlink/p/?LinkID=402319).

###O Banco de Dados de Documentos dá suporte ao SQL?
A linguagem de consulta SQL do Banco de Dados de Documentos, a qual oferece operadores hierárquicos e relacionais sofisticados e extensibilidade por UDFs (funções definidas por usuários) baseadas em JavaScript. A gramática JSON permite modelar documentos JSON como árvores com rótulos como os nós da árvore - isso é explorado pelas técnicas de indexação automática do Banco de Dados de Documentos, bem como pelo dialeto de consulta SQL do Banco de Dados de Documentos.  Para obter detalhes de como usar nossa gramática SQL, consulte o artigo [Consultar usando SQL do Banco de Dados de Documentos][].
...
###O Banco de Dados de Documentos tem suporte para cache de link de recursos?
