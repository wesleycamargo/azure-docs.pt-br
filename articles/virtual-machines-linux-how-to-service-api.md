<properties linkid="manage-linux-howto-service-management-api" urlDisplayName="API do Gerenciamento de Serviços" pageTitle="Como usar a API de gerenciamento de serviços para VMs - Azure" metaKeywords="" description="Saiba como usar a API de Gerenciamento de Serviços do Azure para uma máquina virtual do Linux." metaCanonical="" services="virtual-machines" documentationCenter="" title="Como usar a API de Gerenciamento de Serviços" authors="" solutions="" manager="" editor="" />
...
- serviceOptions é um objeto opcional. Ele pode conter essas propriedades
	...
	- Location - padrão para 'Azure Preview' - alteração de TODO quando liberada.
-	callback é obrigatório.
...
Esta seção esboça as propriedades do objeto.
Implantação
