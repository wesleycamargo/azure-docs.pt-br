...
* [AzureMLBatchScoring](https://msdn.microsoft.com/library/azure/dn894009.aspx) , que chama o experimento do Aprendizado de Máquina do Azure, que faz com que os resultados sejam colocados em um único blob de Armazenamento do Azure.
