...
A tabela a seguir fornece uma lista de várias operações de bancos de dados e unidades de solicitação disponíveis por CU. A tabela ajuda você a planejar como um determinado banco de dados consome a taxa de transferência provisionada associa a uma CU. Supomos que o tamanho do documento seja 1 KB consistindo de 10 valores de propriedade exclusivos com o nível de consistência padrão definido como “Session” e todos os documentos indexados automaticamente pelo Banco de Dados de Documentos.

| Operações de bancos de dados                                                     | Número de operações por segundo por CU |
|----------------------------------------------------------------------------------|----------------------------------------|
