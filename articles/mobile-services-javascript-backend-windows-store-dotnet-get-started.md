...
<!-- URLs. -->
[Introdução aos dados]: mobile-services-javascript-backend-windows-universal-dotnet-get-started-data.md
[Introdução aos dados]: mobile-services-windows-store-dotnet-get-started-data.md
