...
6. Para configurar o logon único no lado do **Degreed**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Degreed](mailTo:admin@degreed.com). Eles definem essa configuração para ter a conexão de SSO do SAML definida corretamente em ambos os lados.
