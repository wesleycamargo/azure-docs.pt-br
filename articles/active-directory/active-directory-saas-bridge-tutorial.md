...
Nesta seção, você habilita o logon único do Azure AD no portal clássico e configura o logon único no aplicativo Bridge.
...
Nesta seção, você permite que Brenda Fernandes use o logon único do Azure, concedendo a ela acesso ao Bridge.
