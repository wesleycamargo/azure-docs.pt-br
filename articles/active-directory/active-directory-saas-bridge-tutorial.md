...
4. Na caixa de pesquisa, digite **Bridge**.

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_search.png)

5. No painel de resultados, selecione **Bridge** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criando um usuário de teste do Bridge](#creating-a-bridge-test-user)** – para ter um equivalente de Brenda Fernandes no Bridge que esteja vinculado à representação de usuário do Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_samlbase.png)

3. Na seção **Domínio e URLs do Bridge**, realize as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Bruto)** e, em seguida, salve o arquivo de certificado no computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Bridge**, clique em **Configurar o Bridge** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_configure.png) 

7. Para configurar o logon único no lado do **Bridge**, é necessário enviar o **Certificado (Bruto)** baixado e a **ID da Entidade SAML, URL do Serviço de Logon Único SAML e URL de Saída** para a [equipe de suporte do Bridge](https://community.bridgeapp.com/community/help). 
...
2. Na lista de aplicativos, selecione **Bridge**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-bridge-tutorial/tutorial_bridge_app.png) 
