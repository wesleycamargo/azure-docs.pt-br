<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao Predictix Ordering | Microsoft Azure"
...
# Tutorial: Integração do Azure Active Directory com o Predictix Ordering
...
## Adição do Predictix Ordering da galeria
...
Essa relação de vínculo é estabelecida atribuindo o valor de **nome de usuário** no Azure AD como sendo o valor de **Nome de usuário** no Predictix Ordering.
...
3. **[Criar um usuário de teste Predictix Ordering](#creating-a-predictix-price-reporting-test-user)** – para ter um equivalente de Brenda Fernandes no Predictix Ordering vinculado à representação dela do Azure AD.
...
1. No portal clássico, na página de integração de aplicativos do **Predictix Ordering**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**.
...
3. Na página de diálogo **Definir Configurações de Aplicativo**, execute as seguintes etapas:
    ...
    a. Na caixa de texto **URL de Logon**, digite a URL usada pelos usuários para fazer logon em seu aplicativo Predictix Ordering usando o seguinte padrão: **https://\<nome da empresa-preço>.predictix.com/sso/request**.
...
5. Na página do diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas: ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-predictix-ordering-tutorial/create_aaduser_05.png)
...
6.  Na página de diálogo **Perfil do Usuário**, execute as seguintes etapas: ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-predictix-ordering-tutorial/create_aaduser_06.png)
...
### Criação de um usuário de teste do Predictix Ordering
