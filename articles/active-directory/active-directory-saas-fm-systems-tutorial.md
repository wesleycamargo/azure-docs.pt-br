---
title: 'Tutorial: integração do Active Directory do Azure ao FM:Systems | Microsoft Docs'
...
5. Envie o arquivo de metadados baixado para a equipe de suporte do FM:Systems.
   ...
   > [!NOTE]
   > A equipe de suporte do FM:Systems precisa fazer a configuração real do SSO. Você receberá uma notificação quando o SSO tiver sido habilitado para sua assinatura.
   > 
   > 
...
> [!NOTE]
> É possível usar qualquer outra ferramenta de criação da conta de usuário do FM:Systems ou as APIs fornecidas pelo FM:Systems para provisionar as contas de usuário do AAD.
> 
> 
