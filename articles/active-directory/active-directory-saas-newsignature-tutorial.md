...
3. **[Criar um usuário de teste do Cloud Management Portal for Microsoft Azure](#creating-a-newsignature-test-user)** - para ter um equivalente de Brenda Fernandes no Cloud Management Portal for Microsoft Azure vinculado à representação dela no Azure AD.
...
> [!NOTE]
> Se precisar criar um usuário manualmente, entre em contato com a equipe de suporte do Cloud Management Portal for Microsoft Azure.
> 
> 
