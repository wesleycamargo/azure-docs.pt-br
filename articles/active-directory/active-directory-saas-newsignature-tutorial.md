...
O objetivo deste tutorial é mostrar como integrar o  Cloud Management Portal for Microsoft Azure ao Azure AD (Azure Active Directory).  
...
Essa relação de vínculo é estabelecida atribuindo o valor de **nome de usuário** no Azure AD ao valor de **Nome de Usuário** no Cloud Management Portal for Microsoft Azure.
...
3. **[Criação de um usuário de teste do Cloud Management Portal for Microsoft Azure](#creating-a-newsignature-test-user)** - para ter um equivalente de Brenda Fernandes no Cloud Management Portal for Microsoft Azure vinculado à representação dela no Azure AD.
...
1. No portal clássico do Azure, na página de integração do aplicativo **Cloud Management Portal for Microsoft Azure**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**.
...
2. Na página **Como você deseja que os usuários façam logon no Cloud Management Portal for Microsoft Azure**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-newsignature-tutorial/tutorial_newsignature_03.png) 
3. Na página do diálogo **Definir Configurações do Aplicativo** , realize as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-newsignature-tutorial/tutorial_newsignature_04.png) 
...
4. Na página **Configurar o logon único no Cloud Management Portal for Microsoft Azure** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-newsignature-tutorial/tutorial_newsignature_05.png) 
...
2. Na lista de aplicativos, selecione **Cloud Management Portal for Microsoft Azure**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-newsignature-tutorial/tutorial_newsignature_50.png) 
