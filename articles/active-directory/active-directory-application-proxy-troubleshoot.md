...
Se alterar o caminho para incluir o conteúdo referenciado, mas ainda precisar que os usuários cheguem a um link mais profundo, confira a postagem de blog [Definir o link certo para que aplicativos de Proxy de Aplicativo no Azure AD acessem o painel e o inicializador de aplicativos do Office 365](https://blogs.technet.microsoft.com/applicationproxyblog/2016/04/06/setting-the-right-link-for-application-proxy-applications-in-the-azure-ad-access-panel-and-office-365-app-launcher/).
...
Se o registro falhar durante a instalação do assistente de Conector, você poderá exibir o motivo da falha examinando o log de eventos em Applications and Services Logs\\Microsoft\\AadApplicationProxy\\Connector\\Admin ou executando o comando do Windows PowerShell a seguir.
