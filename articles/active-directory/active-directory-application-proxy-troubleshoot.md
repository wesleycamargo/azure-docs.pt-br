...
![Captura de tela das propriedades do conector de proxy de aplicativo do AD do Microsoft Azure ][connectorproperties.png]
...
![Captura de tela do log da sessão do conector de proxy de aplicativo][sessionlog.png]
