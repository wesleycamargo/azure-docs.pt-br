...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspoint_samlbase.png)

3. Na seção **Domínio e URLs do EPIM (EthicsPoint Incident Management)**, realize as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspoint_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **EthicsPoint Incident Management (EPIM)**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-ethicspoint-incident-management-tutorial/tutorial_ethicspoint_app.png) 
