...
3. **[Criar um usuário de teste do Boxcryptor](#create-a-boxcryptor-test-user)** – para ter um equivalente de Brenda Fernandes no Boxcryptor vinculado à representação do usuário no Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-boxcryptor-tutorial/tutorial_boxcryptor_samlbase.png)

3. Na seção **Domínio e URLs do Boxcryptor**, realize as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do Boxcryptor](./media/active-directory-saas-boxcryptor-tutorial/tutorial_boxcryptor_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-boxcryptor-tutorial/tutorial_boxcryptor_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-boxcryptor-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Boxcryptor**, clique em **Configurar Boxcryptor** para abrir a janela **Configurar logon**. Copie a **URL do Serviço de Logon Único SAML** e **a ID da Entidade SAML**da **seção de Referência Rápida.**

    ![Configuração de Andromeda SCM](./media/active-directory-saas-boxcryptor-tutorial/tutorial_boxcryptor_configure.png)

7. Para configurar o logon único no lado do **Boxcryptor**, é necessário enviar o **Certificado (Base64)** baixado, a **URL do Serviço de Logon Único SAML** e a **ID da Entidade SAML** para a [equipe de suporte do Boxcryptor](mailto:support@boxcryptor.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-boxcryptor-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-boxcryptor-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-boxcryptor-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-boxcryptor-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Boxcryptor**.
    ...
    ![O link do Boxclyptor na lista de Aplicativos](./media/active-directory-saas-boxcryptor-tutorial/tutorial_boxcryptor_app.png)  
