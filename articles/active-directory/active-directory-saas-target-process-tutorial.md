---
title: 'Tutorial: integração do Active Directory do Azure ao TargetProcess | Microsoft Docs'
...
3. **[Criação de um usuário de teste do TargetProcess](#creating-a-targetprocess-test-user)**: para ter um equivalente de Brenda Fernandes no TargetProcess que esteja vinculado à representação dela no Azure AD.
