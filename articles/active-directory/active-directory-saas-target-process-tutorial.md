...
1. No portal clássico do Azure AD, na página de integração de aplicativos **TargetProcess**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**. <br><br> ![Configurar o logon único][6] <br>
