...
2. Na caixa de diálogo **Plataformas com Suporte**, selecione as plataformas que serão provisionadas com esse perfil do Windows Hello para Empresas e, em seguida, clique em **Próximo**.
...
2. Na caixa de diálogo de **Resumo**, clique em **Avançar**.
