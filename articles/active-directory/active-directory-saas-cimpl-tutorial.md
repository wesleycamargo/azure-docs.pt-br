...
O objetivo deste tutorial é mostrar como integrar o Cimpl ao Azure AD (Azure Active Directory). A integração do Cimpl ao Azure AD oferece os seguintes benefícios:
...
7. No painel de resultados, selecione **Cimpl** e clique em **Concluir** para adicionar o aplicativo.
...
4. **[Criação de um usuário de teste do Cimpl](#creating-a-cimpl-test-user)**: para ter um equivalente de Brenda Fernandes no Cimpl que esteja vinculado à representação dela no Azure AD.
...
1. No Portal Clássico do Azure, na página de integração de aplicativos do **Cimpl**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
