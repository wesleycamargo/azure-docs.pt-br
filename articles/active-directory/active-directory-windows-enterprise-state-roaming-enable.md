...
4.	Role para baixo a página e selecione **OS USUÁRIOS PODEM SINCRONIZAR CONFIGURAÇÕES E DADOS CORPORATIVOS DO APLICATIVO** e clique em **Salvar**. ![](./media/active-directory-enterprise-state-roaming/active-directory-enterprise-state-roaming-select-all-sync-settings.png)
