...
2. Selecione **Azure Active Directory** &gt; **Dispositivos** &gt; **Enterprise State Roaming**.
...
2. Selecione **Azure Active Directory** &gt; **usuários** &gt; **todos os usuários**.
