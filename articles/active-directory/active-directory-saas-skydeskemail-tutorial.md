...
3. Na página de diálogo **Autenticação SAML**, realize as seguintes etapas:
   ...
   > [!NOTE]
   > Para usar a autenticação baseada em SAML, primeiro, você deve configurar um **domínio verificado** ou uma **URL de portal**. Você pode definir a URL de portal com o nome exclusivo.
   > 
   > 
