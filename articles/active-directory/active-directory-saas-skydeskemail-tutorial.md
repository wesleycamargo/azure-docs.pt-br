...
## <a name="adding-skydesk-email-from-the-gallery"></a>Adicionando o Skydesk Email a partir da galeria
...
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
    ...
    a. Na caixa de texto da URL de Entrada, digite a URL usada pelos usuários para fazer logon no seu aplicativo Skydesk Email usando o seguinte padrão: **“https://mail.skydesk.jp/portal/\<company name\>”**.

    b. Clique em **Próximo**.


1. Na página **Configurar logon único no Skydesk Email** , realize as seguintes etapas:
    ...
    b. Clique em **Próximo**.
2. Para habilitar o SSO no **Skydesk Email**, execute as seguintes etapas:
...
3. Na página de diálogo **Autenticação SAML** , realize as seguintes etapas:
   ...
   > 
    ...
    a. No portal clássico do Azure AD, copie o valor da **URL de SSO de SAML** e cole-o na caixa de texto **URL de Entrada**.

    b. No portal clássico do Azure AD, copie o valor da **URL do Serviço de Saída Única** e cole-o na caixa de texto URL de **Logoff**.

    c. A **URL de Alteração de Senha** é opcional, portanto, deixe-a em branco.

    d. Clique em **Obter Chave de Arquivo** para selecionar o certificado baixado do Skydesk Email e, em seguida, clique em **Abrir** para carregar o certificado.
...
### <a name="creating-a-skydesk-email-test-user"></a>Criando um usuário de teste do Skydesk Email
