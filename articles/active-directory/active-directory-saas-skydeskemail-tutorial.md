...
* Você pode habilitar seus usuários, com as respectivas contas do Azure AD, a fazer logon automaticamente no SkyDesk Email via SSO (logon único)
...
## <a name="add-skydesk-email-from-the-gallery"></a>Adicionar o SkyDesk Email por meio da galeria
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Azure AD com o SkyDesk Email, com base em um usuário de teste chamado "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário do SkyDesk Email é equivalente a um determinado usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no SkyDesk Email.
...
Para configurar e testar o SSO do Azure AD com o SkyDesk Email, você precisa concluir os seguintes blocos de construção:
...
O objetivo desta seção é habilitar o SSO do Azure AD no Portal Clássico do Azure e configurar o logon único em seu aplicativo SkyDesk Email.
...
4. Na página **Configurar logon único no SkyDesk Email**, execute estas etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-skydeskemail-tutorial/tutorial_skydeskemail_05.png) 
...
### <a name="create-a-skydesk-email-test-user"></a>Criar um usuário de teste do SkyDesk Email
