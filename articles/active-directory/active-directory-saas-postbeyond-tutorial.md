...
3. **[Criação de um usuário de teste do PostBeyond](#creating-a-PostBeyond-test-user)** - para ter um equivalente de Brenda Fernandes no PostBeyond que esteja vinculado à representação dela no Azure AD.
