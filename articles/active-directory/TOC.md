...
##### [Conceder aos usuários locais acesso aos aplicativos de nuvem](active-directory-b2b-hybrid-on-premises-to-cloud.md)
...
#### [Permissões de usuário padrão](users-default-permissions.md)
