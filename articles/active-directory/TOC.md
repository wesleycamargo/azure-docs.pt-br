...
#### [Atribuir administradores locais para dispositivos ingressados no Azure AD](devices/assign-local-admin.md)
...
#### Guia de início rápido
##### [Configurar cada aplicativo de nuvem MFA](conditional-access/app-based-mfa.md)
