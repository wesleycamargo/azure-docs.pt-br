...
8. Para configurar o logon único no lado do **eKincare**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do eKincare](mailto:tech@ekincare.com). Eles definem essa configuração para ter a conexão de SSO do SAML definida corretamente em ambos os lados.
