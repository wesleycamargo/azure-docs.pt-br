...
4. **[Criando um usuário de teste do Pluralsight](#creating-a-pluralsight-test-user)** - para ter um equivalente de Brenda Fernandes no Pluralsight que esteja vinculado à representação dela no Azure AD.
...
4. Na página **Configurar logon único no Pluralsight**, realize as seguintes etapas: ![Configurar o logon único](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_05.png)
