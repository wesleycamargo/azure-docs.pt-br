...
8.  Na página do diálogo **Fazer logon usando o SAML**, realize as seguintes etapas e clique em **Salvar Alterações**:
    ...
    2.  No portal clássico do Azure, na página de diálogo **Configurar logon único no Samanage**, copie o valor da **ID do Provedor de Identidade** e cole-o na caixa de texto **URL do Provedor de Identidade**.
