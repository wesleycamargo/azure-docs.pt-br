...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_samlbase.png)
...
3. Na seção **Domínio e URLs do Convercent**, se você quiser configurar o aplicativo em **Modo iniciado pelo IDP**, execute a seguinte etapa:
    ...
    ![Configurar o logon único](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_url.png)
...
4. Se você quiser configurar o aplicativo em **Modo iniciado pelo SP**, na seção **Domínio e URLs do Convercent**, execute as seguintes etapas:
    ...
    ![Configurar o logon único](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_url1.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo XML em seu computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-convercent-tutorial/tutorial_convercent_certificate.png) 

6. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/active-directory-saas-convercent-tutorial/tutorial_general_400.png)
