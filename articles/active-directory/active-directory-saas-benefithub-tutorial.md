...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_benefithub_samlbase.png)

3. Na seção **Domínio e URLs do BenefitHub**, realize as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_benefithub_url1.png)
...
4. O aplicativo BenefitHub espera as declarações do SAML em um formato específico, o que exige a adição de mapeamentos de atributo personalizados para a configuração de atributos do token SAML. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo. 
    ...
    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_benefithub_attribute.png)
...
5. Na seção **Atributos de Usuário** da caixa de diálogo **Logon único**, configure o atributo do token SAML, conforme mostrado na imagem anterior e realize as seguintes etapas:
    ...
    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_attribute_05.png)
...
7. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_general_400.png)

8. Para configurar o logon único no lado do **BenefitHub**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do BenefitHub](https://www.benefithub.com/Home/ContactUs). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
2. Na lista de aplicativos, selecione **BenefitHub**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-benefithub-tutorial/tutorial_benefithub_app.png) 
