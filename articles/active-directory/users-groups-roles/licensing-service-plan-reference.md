---
title: Nomes de produto e identificadores de plano de serviço para licenciamento – Azure AD | Microsoft Docs
description: Mapa de identificador para gerenciar o licenciamento do Active Directory do Azure no portal do Azure, o Centro de administração do Microsoft 365, PowerShell ou o Microsoft Graph
...
Ao gerenciar licenças no [portal do Azure](https://portal.azure.com/#blade/Microsoft_AAD_IAM/LicensesMenuBlade/Products) ou o [Centro de administração do Microsoft 365](https://admin.microsoft.com), você ver os nomes de produto que algo parecido com *Office 365 Enterprise E3*. Ao usar os cmdlets do PowerShell v1.0, o mesmo produto é identificado usando um nome específico, mas menos amigável: *ENTERPRISEPACK*. Ao usar cmdlets do PowerShell v2.0 ou o Microsoft Graph, o mesmo produto é identificado usando um valor de GUID: *6fd2c87f-b296-42f0-b197-1e91e994b900*. A tabela a seguir lista os produtos mais frequentemente usados do serviço online da Microsoft e fornece os vários valores de ID desses produtos. Essas tabelas são para fins de referência e são precisas apenas a partir da data em que este artigo foi atualizado pela última vez. A Microsoft não planeja atualizá-las periodicamente para os serviços adicionados recentemente.
...
- **GUID**: GUID usado pelo Azure AD Graph e pelo Microsoft Graph
...
>[!NOTE]
>Essas informações são precisas a partir de 17 de agosto de 2018.
...
| PROTEÇÃO DE INFORMAÇÕES DO AZURE PLANO 1   | RIGHTSMANAGEMENT  | c52ea49f-fe5d-4e95-93ba-1de91d380f89  | RMS_S_ENTERPRISE (bea4c11e-220a-4e6d-8eb8-8ea15d019f90)<br/>RMS_S_PREMIUM (6c57d4b6-3b23-47a5-9bc9-69f17b4947b3) |
...
| ARQUIVAMENTO DO EXCHANGE ONLINE PARA EXCHANGE ONLINE | EXCHANGEARCHIVE_ADDON | ee02fd1b-340e-4a4b-b355-4a514e4c8943  | EXCHANGE_S_ARCHIVE_ADDON (176a09a6-7ec5-4039-ac02-b2791c6ba793) |
| ARQUIVAMENTO DO EXCHANGE ONLINE PARA EXCHANGE SERVER | EXCHANGEARCHIVE   | 90b5e015-709a-4b8b-b08e-3200f994494c  | EXCHANGE_S_ARCHIVE (da040e0a-b393-4bea-bb76-928b3fa1cf5a) |
...
| QUIOSQUE DO EXCHANGE ONLINE | EXCHANGEDESKLESS  | 80b2d799-d2ba-4d2a-8842-fb0d0f3a4b82  | EXCHANGE_S_DESKLESS (4a82b400-a79f-41a4-b4e2-e94f5787b113) |
...
| ONEDRIVE FOR BUSINESS (PLANO 1)    | WACONEDRIVESTANDARD   | e6778190-713e-4e4f-9119-8b8238de25df  | FORMS_PLAN_E1 (159f4cd6-e380-449f-a816-af1a9ef76344)<br/>ONEDRIVESTANDARD (13696edf-5a08-49f6-8134-03083ed8ba30)<br/>SHAREPOINTWAC (e95bec33-7c88-4a70-8e19-b10bd9d0c014)<br/>SWAY (a23b959c-7ce8-4e57-9140-b90eb88a9e97) |
| ONEDRIVE FOR BUSINESS (PLANO 2)    | WACONEDRIVEENTERPRISE | ed01faf2-1d88-4947-ae91-45ca18703a96  | ONEDRIVEENTERPRISE (afcafa6a-d966-4462-918c-ec0b4e0fe642)<br/>SHAREPOINTWAC (e95bec33-7c88-4a70-8e19-b10bd9d0c014) |
| COMPLEMENTO POWER BI PARA OFFICE 365    | POWER_BI_ADDON    | 45bc2c81-6072-436a-9b0b-3b12eefbc402  | BI_AZURE_P1 (2125cfd7-2110-4567-83c4-c1cd5275163d)<br/>SQL_IS_SSIM (fc0a60aa-feee-4746-a0e3-aecfe81a38dd) |
| POWER BI PRO  | POWER_BI_PRO  | f8a1db68-be16-40ed-86d5-cb42ce701560  | BI_AZURE_P2 (70d33638-9c74-4d01-bfd3-562de28bd4ba) |
| PROJECT PARA O OFFICE 365    | PROJECTCLIENT | a10d5e58-74da-4312-95c8-76be4e5b75a0  | PROJECT_CLIENT_SUBSCRIPTION (fafd7243-e5c1-4a3a-9e40-495efcb1d3c3) |
...
| SKYPE FOR BUSINESS ONLINE (PLANO 1)    | MCOIMP    | b8b749f8-a4ef-4887-9539-c95b1eaa5db7  | MCOIMP (afc06cb0-b4f4-4473-8286-d644f70d8faf) |
| SKYPE FOR BUSINESS ONLINE (PLANO 2)    | MCOSTANDARD   | d42c793f-6c78-4f43-92ca-e8f6a02b035f  | MCOSTANDARD (0feaeb32-d00e-4d66-bd5a-43b5b83db82c) |
| CONFERÊNCIA PSTN DO SKYPE FOR BUSINESS  | MCOMEETADV    | 0c266dff-15dd-4b49-8397-2bb16070ed52  | MCOMEETADV (3e26ee1f-8a5f-4d52-aee2-b81ce45c8f40) |
| CHAMADAS PSTN DOMÉSTICAS E INTERNACIONAIS DO SKYPE FOR BUSINESS    | MCOPSTN2  | d3b4fe1f-9992-4930-8acb-ca6ec609365e  | MCOPSTN2 (5a10155d-f5c1-411a-a8ec-e99aae125390) |
| CHAMADAS PSTN DOMÉSTICAS DO SKYPE FOR BUSINESS  | MCOPSTN1  | 0dab259f-bf13-4952-b7f8-7db8f131b28d  | MCOPSTN1 (4ed3ff63-69d7-4fb7-b984-5aec7f605ca8) |
...
Ao usar o licenciamento baseado em grupo, você enfrenta [esta condição de erro](licensing-groups-resolve-problems.md#conflicting-service-plans). Ao usar o PowerShell, você verá o erro *MutuallyExclusiveViolation*.

Esta seção lista os planos de serviço mais comuns que são mutuamente exclusivos, agrupados por tipo de serviço. Você pode usar essas informações para planejar a implantação de licença e evitar erros de atribuição. Essas tabelas são para fins de referência e são precisas apenas a partir da data em que este artigo foi atualizado pela última vez. A Microsoft não planeja atualizá-las periodicamente para os serviços adicionados recentemente.

### <a name="service-azure-active-directory"></a>Serviço: *Azure Active Directory*

>[!NOTE]
>Todos os planos de serviço relacionados ao Azure Active Directory agora podem ser atribuídos juntos, ao mesmo usuário. Isso simplifica certos cenários de gerenciamento de licença, tais como mover os usuários do Azure AD Basic para o Azure AD Premium P1.
...
### <a name="service-skype-for-business"></a>Serviço: *Skype for Business*
...
* [Exemplos do PowerShell para licenciamento baseado em grupo no Azure AD](licensing-ps-examples.md)
