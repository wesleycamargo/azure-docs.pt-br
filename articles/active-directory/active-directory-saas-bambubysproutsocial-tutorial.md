...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo XML em seu computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-bambubysproutsocial-tutorial/tutorial_bambubysproutsocial_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/active-directory-saas-bambubysproutsocial-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, escolha **Bambu by Sprout Social**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-bambubysproutsocial-tutorial/tutorial_bambubysproutsocial_app.png) 
