...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-cs-stars-tutorial/tutorial_csstars_samlbase.png)

3. Na seção **URLs e Domínio do CS Stars**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-cs-stars-tutorial/tutorial_csstars_url.png)
...
2. Na lista de aplicativos, selecione **CS Stars**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-cs-stars-tutorial/tutorial_csstars_app.png) 
