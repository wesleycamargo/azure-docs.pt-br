...
3. Selecione **Todos os usuários**.
   ...
   ![Abrindo o grupo Todos os usuários](./media/active-directory-users-profile-azure-portal/create-users-open-users-blade.png)
1. Selecione um usuário na lista.
2. Para o usuário selecionado, escolha **Perfil**.
