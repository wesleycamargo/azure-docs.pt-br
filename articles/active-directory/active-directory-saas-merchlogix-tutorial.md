...
3. **[Criar um usuário de teste do Merchlogix](#create-a-merchlogix-test-user)** – para ter um equivalente de Brenda Fernandes no Merchlogix que esteja vinculado à representação de usuário do Azure AD.
...
3. Na seção **URLs e Domínio do Merchlogix**, execute as seguintes etapas:
...
7. Para configurar o logon único no lado do **Merchlogix**, é necessário enviar o **Certificado (Base64)** baixado, a **URL de Saída, a ID da Entidade SAML e a URL do Serviço de Logon Único do SAML** para a [equipe de suporte do Merchlogix](http://www.merchlogix.com/contact/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
