...
* Você pode permitir que seus usuários entrem automaticamente no Aravo por meio do logon único (SSO) usando suas contas do Azure AD
...
* Uma assinatura com SSO do Aravo habilitado
...
## <a name="add-aravo-from-the-gallery"></a>Adicionar o Aravo da galeria
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Microsoft Azure AD com o Aravo, com base em um usuário de teste chamado “Brenda Fernandes”.

Para que o SSO funcione, o Azure AD precisa saber qual usuário do Aravo é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Aravo.
...
Para configurar e testar o logon único (SSO) do Microsoft Azure AD com o Aravo, você precisará concluir os seguintes blocos de construção:
...
Nesta seção, você habilitará o SSO do Microsoft Azure AD no portal clássico e configurará o logon único em seu aplicativo Aravo.

**Para configurar o SSO do Microsoft Azure AD com o Aravo, execute as seguintes etapas:**
...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
  ...
  1. Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão: `https://<company name>.aravo.com`
  2. Na caixa de texto **URL de resposta**, digite uma URL no seguinte padrão: `https://<company name>.aravo.com/aems/login.do`
  3. Clique em **Próximo**.
...
### <a name="create-a-aravo-test-user"></a>Criar um usuário de teste do Aravo
...
O objetivo desta seção é permitir que Brenda Fernandes use o SSO do Azure, concedendo a ela acesso ao Aravo.
