...
8.  Siga em frente com as seguintes etapas:
    ...
    4.  No portal do Azure, na página do diálogo **Configurar logon único no BlueJeans**, copie o valor da **URL de Logoff Remoto** e cole-o na caixa de texto **URL de Logoff**.
