...
* Você pode permitir que seus usuários façam logon automaticamente no RightScale usando SSO (logon único) com as contas do Azure AD
...
* Uma assinatura do RightScale habilitada para SSO (logon único)
...
## <a name="add-rightscale-from-the-gallery"></a>Adicionar o RightScale da galeria
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Azure AD com o RightScale, com base em um usuário de teste chamado "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário do RightScale é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do RightScale.  
...
O objetivo desta seção é habilitar o SSO do Azure AD no Portal Clássico do Azure e configurar o SSO em seu aplicativo RightScale.
...
3. Na página de diálogo **Definir Configurações de Aplicativo**, se quiser configurar o aplicativo no **modo iniciado pelo IDP**, execute as seguintes etapas e clique em **Avançar**:
  ...
  1. Na caixa de texto URL de Resposta, digite a URL no seguinte padrão: `https://login.rightscale.com/login/saml2/consume`
  2. Clique em **Próximo**.
...
1. Se quiser configurar o aplicativo no **modo iniciado pelo SP**, na página de diálogo **Definir Configurações do Aplicativo**, clique em **"Mostrar configurações avançadas (opcional)"**, insira a **URL de Logon** e clique em **Avançar**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-rightscale-tutorial/tutorial_rightscale_06.png) 
  1. Na caixa de texto URL de Logon, digite a URL usada pelos usuários para fazer logon em seu aplicativo do RightScale usando o seguinte padrão: `https://login.rightscale.com/`
  2. Clique em **Próximo**.
...
3. Para configurar o SSO para o aplicativo, você precisa entrar no locatário do RightScale como administrador.
  1. No menu na parte superior, clique na guia **Configurações** e selecione **Logon Único**.
   
    ![Configurar o logon único](./media/active-directory-saas-rightscale-tutorial/tutorial_rightscale_001.png) 
  2. Clique no botão "**novo**" para adicionar **Seus Provedores de Identidade do SAML**.
   
    ![Configurar o logon único](./media/active-directory-saas-rightscale-tutorial/tutorial_rightscale_002.png)  
  3. Na caixa de texto do **Nome de Exibição**, insira o nome da sua empresa.
   
    ![Configurar Logon Único](./media/active-directory-saas-rightscale-tutorial/tutorial_rightscale_003.png) 
  4. Selecione **Permitir o SSO iniciado pelo RightScale usando uma dica de descoberta** e insira seu **nome de domínio** na caixa de texto abaixo.
   
    ![Configurar o logon único](./media/active-directory-saas-rightscale-tutorial/tutorial_rightscale_004.png)
  5. Copie a URL de SSO do SAML do Azure AD para o **Ponto de Extremidade do SSO do SAML** no RightScale.
  ...
  6. Copie a ID da Entidade do Azure AD para **EntityID do SAML** no RightScale.
  ...
  7. Clique no botão **Navegador** para carregar o certificado que você baixou na etapa 4.
...
### <a name="create-a-rightscale-test-user"></a>Criar um usuário de teste do RightScale
...
O objetivo desta seção é permitir que Brenda Fernandes use o SSO do Azure, concedendo a ela acesso ao RightScale.
