...
| **Banda larga móvel avançada**: nome de rede de compartilhamento de conexão com a Internet (habilita a detecção automática de hotspots Wi-Fi móveis via Bluetooth)|sync |sync |Senhas |
...
|**Prompt de comando**: todas as configurações do prompt de comando |sync| |X |Outros
...
|**Data, Hora e Região**: relógio de 24 horas|sync |sync |idioma|
...
|**Personalização da área de trabalho**: tema da área de trabalho (plano de fundo, cor do sistema, sons do sistema padrão, proteção de tela) |sync |X |Tema|
...
|**Personalização da área de trabalho**: iniciar o layout da tela |sync |backup ||
|**Dispositivos**: impressoras compartilhadas às quais você se conectou |sync | X |outros |
...
|**Idioma**: CHS QWERTY - habilitar a classificação c&idate dinâmica|sync |X |Linguagem|
...
|**Idioma**: CHS WUBI - mostrar a codificação restante do c&idate |sync |X |Linguagem|
...
|**Lupa**: ativada ou desativada (alternância mestre)|X |backup |Facilidade de acesso|
...
|**Magnifier**: iniciar quando o usuário entra (desativado por padrão)|sync |X |Facilidade de acesso|
...
|**Facilidade de acesso**: remover as imagens do plano de fundo (desativado por padrão)|sync |X |Facilidade de acesso|
