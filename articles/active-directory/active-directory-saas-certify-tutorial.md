---
title: 'Tutorial: Integração do Active Directory do Azure ao Certify | Microsoft Docs'
...
O objetivo deste tutorial é mostrar como integrar o Certify ao Azure AD (Azure Active Directory). A integração do Certify ao Azure AD oferece os seguintes benefícios:
...
7. No painel de resultados, selecione **Certify** e clique em **Concluir** para adicionar o aplicativo.
...
3. **[Criação de um usuário de teste do Certify](#creating-a-certify-test-user)**: para ter um equivalente de Brenda Fernandes no Certify que esteja vinculado à representação dela no Azure AD.
...
1. No portal clássico do Azure AD, na página de integração do aplicativo **Certify**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
3. Na página do diálogo **Definir Configurações do Aplicativo**, realize as seguintes etapas:
    ...
    ![Configurar o logon único](./media/active-directory-saas-certify-tutorial/tutorial_certify_04.png)
...
2. Na lista de aplicativos, selecione **Certify**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-certify-tutorial/tutorial_certify_50.png)
...
O objetivo desta seção é testar sua configuração de logon único do Azure AD usando o Painel de Acesso. Ao clicar no bloco do Certify no Painel de Acesso, você deverá ser conectado automaticamente a seu aplicativo do Certify.
