...
- [Práticas recomendadas para acesso condicional no Active Directory do Azure](conditional-access/best-practices.md) para obter orientação sobre como implantar o acesso condicional em sua organização.

- [ Exija o MFA para aplicativos específicos com acesso condicional do Azure Active Directory ](conditional-access/app-based-mfa.md) para se familiarizar com a interface do usuário no portal do Azure.
...
- Se você quiser saber como configurar uma política de acesso condicional, consulte [GRuem o MFA para aplicativos específicos com acesso condicional do Active Directory do Azure](conditional-access/app-based-mfa.md).
