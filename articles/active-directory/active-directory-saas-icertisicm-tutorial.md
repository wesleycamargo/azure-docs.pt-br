<properties
	pageTitle="Tutorial: integração do Azure Active Directory ao Icertis Contract Management Platform | Microsoft Azure"
...
# Tutorial: integração do Azure Active Directory com o Icertis Contract Management Platform
...
- Uma assinatura com logon único habilitado do Icertis Contract Management Platform
...
## Adicionar a Plataforma de Gerenciamento de Contratos Icertis da galeria
...
O objetivo desta seção é mostrar como configurar e testar logon único do Azure AD com o Icertis Contract Management Platform, com base em uma usuária de teste chamada "Brenda Fernandes".

Para que o logon único funcione, o Azure AD precisa saber qual usuário do Icertis Contract Management Platform é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Icertis Contract Management Platform.

Essa relação de vínculo é estabelecida atribuindo o valor de **nome de usuário** ao Azure AD como sendo o valor de **nome de usuário** no Icertis Contract Management Platform.
...
Nesta seção, você habilitará o logon único do Azure AD no portal clássico e configurará o logon único em seu aplicativo do Icertis Contract Management Platform.
...
3. Na página de caixa de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
	...
	> [AZURE.NOTE] Observe que esses não são os valores reais. Você precisa atualizar esses valores com a URL de Entrada real. Para obter esses valores, entre em contato com o Icertis Contract Management Platform.

4. Na página **Configurar logon único no Icertis Contract Management Platform**, execute as seguintes etapas e clique em **Avançar**:
...
5. Para que o SSO seja configurado para seu aplicativo, entre em contato com a equipe de suporte do Icertis Contract Management Platform e forneça o seguinte:
...
### Criar um usuário de teste do Icertis Contract Management Platform
...
O objetivo desta seção é permitir que Brenda Fernandes use o logon único do Azure, concedendo a ela acesso ao Icertis Contract Management Platform.
