...
description: "Saiba como usar o Wikispaces com o Active Directory do Azure para habilitar o logon único, o provisionamento automatizado e muito mais."
...
O objetivo deste tutorial é mostrar a integração do Azure com o Wikispaces.  
...
### <a name="to-enable-the-application-integration-for-wikispaces-perform-the-following-steps"></a>Para habilitar a integração de aplicativos para o Wikispaces, execute as seguintes etapas:
...
5. Envie o metadatafile para a equipe de suporte do Wikispaces.
    ...
    > [!NOTE]
    > A configuração de logon único deve ser executada pela equipe de suporte do Wikispaces. Assim que a configuração for concluída, você receberá uma notificação.
    > 
    > 
...
No caso do Wikispaces, o provisionamento é uma tarefa manual.
...
### <a name="to-assign-users-to-wikispaces-perform-the-following-steps"></a>Para atribuir usuários ao Wikispaces, execute as seguintes etapas:
