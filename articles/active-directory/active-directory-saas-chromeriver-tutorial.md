...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-chromeriver-tutorial/tutorial_chromeriver_samlbase.png)

3. Na seção **Domínio e URLs do Chromeriver**, realize as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-chromeriver-tutorial/tutorial_chromeriver_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-chromeriver-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **Chromeriver**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-chromeriver-tutorial/tutorial_chromeriver_app.png) 
