...
---
# <a name="configure-automatic-device-registration-for-windows-81-domain-joined-devices"></a>Configurar o registro automático de dispositivo para dispositivos ingressados no domínio do Windows 8.1
...
## <a name="configure-the-group-policy-for-your-windows-81-domain-joined-devices"></a>Configurar a Política de Grupo para dispositivos ingressados no domínio do Windows 8.1
...
## <a name="unregistering-your-windows-81-domain-joined-devices"></a>Cancelando o registro dos dispositivos ingressados no domínio do Windows 8.1
