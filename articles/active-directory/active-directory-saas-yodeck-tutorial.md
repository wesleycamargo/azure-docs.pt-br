...
3. **[Criar de um usuário de teste do Yodeck](#create-a-yodeck-test-user)** : para ter um equivalente de Brenda Fernandes no Yodeck que esteja vinculado à representação de usuário no Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_samlbase.png)

3. Na seção **Domínio e URLs do Yodeck**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IdP**:

    ![Informações de logon único de Domínio e URLs do Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url.png)
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url1.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique no botão copiar para copiar a **URL de metadados de federação do aplicativo** e cole-a no bloco de notas.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_certificate.png)

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-yodeck-tutorial/tutorial_general_400.png)
    
7. Em outra janela do navegador da Web, faça logon em seu site de empresa do Yodeck como administrador.

8. Clique no formulário de opções **Configurações do usuário** no canto superior direito da página e selecione **Configurações da conta**.

    ![Configuração do Yodeck](./media/active-directory-saas-yodeck-tutorial/configure1.png)

9. Selecione **SAML** e execute as seguintes etapas:

    ![Configuração do Yodeck](./media/active-directory-saas-yodeck-tutorial/configure2.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-yodeck-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-yodeck-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-yodeck-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. Clique no formulário de opções **Configurações do usuário** no canto superior direito da página e selecione **Usuários**.
    ...
    ![Adicionar Funcionário](./media/active-directory-saas-yodeck-tutorial/user1.png)

3. Clique em **+Usuário** para abrir a guia **Detalhes do usuário**.

    ![Adicionar Funcionário](./media/active-directory-saas-yodeck-tutorial/user2.png)

4. Na página do diálogo **Detalhes do Usuário** , realize as seguintes etapas:

    ![Adicionar Funcionário](./media/active-directory-saas-yodeck-tutorial/user3.png)
...
2. Na lista de aplicativos, selecione **Yodeck**.
    ...
    ![O link do Yodeck na lista de Aplicativos](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  
