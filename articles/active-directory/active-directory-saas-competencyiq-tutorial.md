...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_samlbase.png)

3. Na seção **URLs e Domínio do CompetencyIQ**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_url1.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-competencyiq-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do CompetencyIQ**, clique em **Configurar o CompetencyIQ** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML** e a **URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**
    ...
    ![Configurar o logon único](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_configure.png) 
...
2. Na lista de aplicativos, selecione **CompetencyIQ**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_app.png) 
