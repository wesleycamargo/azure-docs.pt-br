...
O objetivo deste tutorial é mostrar a você como integrar o Ultipro ao AD do Azure (Azure Active Directory).<br>A integração do Ultipro ao AD do Azure oferece os seguintes benefícios:
...
6. Na caixa de pesquisa, digite **Ultipro**.<br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_01.png)<br>
7. No painel de resultados, selecione **Ultipro** e clique em **Concluir** para adicionar o aplicativo. <br><br>
...
Para que o logon único funcione, o AD do Azure precisa saber qual usuário do Ultipro é equivalente a um usuário do AD do Azure. Em outras palavras, é necessário estabelecer uma relação de vinculação entre um usuário do AD do Azure e o usuário relacionado no Ultipro.<br> Essa relação de vinculação é estabelecida atribuindo o valor de **nome de usuário** no AD do Azure como o valor de **Nome de usuário** no Ultipro.
...
4. **[Criação de um usuário de teste do Ultipro](#creating-a-ultipro-test-user)**: para ter um equivalente de Brenda Fernandes no Ultipro que esteja vinculado à representação dela no AD do Azure.
...
1. No portal clássico do Azure, na página de integração de aplicativos do **Ultipro**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**. <br><br> ![Configurar o logon único][6] <br>

2. Na página **Como você deseja que os usuários façam logon no Ultipro**, selecione **Logon Único do AD do Azure** e clique em **Avançar**. <br><br> ![Configurar o logon único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_03.png) <br>

3. Na página da caixa de diálogo **Definir Configurações de Aplicativo**, execute as seguintes etapas: <br><br>![Configurar o logon único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_04.png) <br>


    a. Na caixa de texto da URL de Entrada, digite a URL usada pelos usuários para fazer logon em seu aplicativo do Ultipro usando o seguinte padrão: **“https://<nome da empresa>.ultipro.com/”**.

    b. Clique em **Próximo**.

4. Na página **Configurar logon único no Ultipro**, execute as seguintes etapas:<br><br>![Configurar o logon único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_05.png) <br>
...
1. No **portal clássico do Azure**, no painel de navegação à esquerda, clique em **Active Directory**. <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_09.png) <br>

2. Na lista **Diretório**, selecione o diretório para o qual você deseja habilitar a integração de diretórios.

3. Para exibir a lista de usuários, no menu na parte superior, clique em **Usuários**. <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_03.png) <br>

4. Para abrir a caixa de diálogo **Adicionar Usuário**, na barra de ferramentas na parte inferior, clique em **Adicionar Usuário**. <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_04.png) <br>

5. Na página do diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas: <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_05.png) <br>
...
6.  Na página da caixa de diálogo **Perfil do Usuário**, execute as seguintes etapas: <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_06.png) <br>
...
7. Na página da caixa de diálogo **Obter senha temporária**, clique em **criar**. <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_07.png) <br>

8. Na página da caixa de diálogo **Obter senha temporária**, execute as seguintes etapas: <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-ultipro-tutorial/create_aaduser_08.png) <br>
...
2. Na lista de aplicativos, selecione **Ultipro**. <br><br>![Configurar o logon único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_50.png) <br>
...
O objetivo desta seção é testar sua configuração de logon único do Azure AD usando o Painel de Acesso.<br> Quando você clicar no bloco Ultipro no Painel de Acesso, deverá ser conectado automaticamente ao seu aplicativo Ultipro.
