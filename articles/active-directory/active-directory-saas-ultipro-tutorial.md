...
3. **[Criação de um usuário de teste do Ultipro](#creating-a-ultipro-test-user)** - para ter um equivalente de Brenda Fernandes no Ultipro que esteja vinculado à representação dela no Azure AD.
