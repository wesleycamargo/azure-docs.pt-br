...
O objetivo deste tutorial é mostrar como integrar o UltiPro ao Azure AD (Azure Active Directory).  
...
O objetivo desta seção é mostrar como configurar e testar o logon único do Azure AD com o UltiPro, com base em um usuário de teste chamado “Brenda Fernandes”.
...
Essa relação de vinculação é estabelecida atribuindo o valor de **nome de usuário** no Azure AD como o valor de **Nome de usuário** no UltiPro.
...
3. **[Criando um usuário de teste do UltiPro](#creating-a-ultipro-test-user)**: para ter um equivalente de Brenda Fernandes no UltiPro que esteja vinculado à representação dela no Azure AD.
...
O objetivo desta seção é habilitar o logon único do Azure AD no Portal clássico do Azure e configurar o logon único em seu aplicativo UltiPro.

**Para configurar o logon único do Azure AD com o UltiPro, execute as seguintes etapas:**

1. No Portal clássico do Azure, na página de integração de aplicativos do **UltiPro**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
   
    ![Configurar Logon Único][6] 
2. Na página **Como você deseja que os usuários entrem no UltiPro**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
   
    ![Configurar Logon Único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_03.png) 
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_04.png) 

    a. Na caixa de texto URL de Entrada, digite a URL usada pelos usuários para entrar no aplicativo Ultipro usando o seguinte padrão: **"https://\<nome da empresa\>.ultipro.com/"**.

    b. Clique em **Próximo**.

1. Na página **Configurar logon único no UltiPro**, execute as seguintes etapas:
    ...
    b. Clique em **Avançar**.
2. Para que o SSO seja configurado para seu aplicativo, entre em contato com o Gerente de Conta do UltiPro e forneça o seguinte:
...
> [!NOTE]
> Se precisar criar um usuário manualmente, entre em contato com a equipe de suporte do UltiPro.
> 
> 

### <a name="assigning-the-azure-ad-test-user"></a>Atribuição do usuário de teste do AD do Azure
O objetivo desta seção é permitir que Brenda Fernandes use o logon único do Azure concedendo a ela acesso ao UltiPro.
...
2. Na lista de aplicativos, selecione **UltiPro**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-ultipro-tutorial/tutorial_ultipro_50.png) 
