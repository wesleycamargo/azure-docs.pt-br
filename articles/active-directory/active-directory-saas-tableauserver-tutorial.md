<properties
	pageTitle="Tutorial: integração do Azure Active Directory ao Tableau Server | Microsoft Azure"
...
4. **[Criação de um usuário de teste do Tableau Server](#creating-a-tableauserver-test-user)** - para ter um equivalente de Brenda Fernandes no Tableau Server que esteja vinculado à representação dela no Azure AD.
...
2. Na página **Como você deseja que os usuários façam logon no Tableau Server**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
...
4. Na página **Configurar logon único no Tableau Server**, execute as seguintes etapas e clique em **Avançar**:
...
6. Para configurar o SSO para o aplicativo, você precisa entrar no locatário Tableau Server como administrador.
	...
	c. Localize o arquivo de Metadados de Federação baixado do Portal de Gerenciamento do Azure e carregue-o no **arquivo de metadados do Idp SAML**.
...
> [AZURE.NOTE] Se precisar criar um usuário manualmente, entre em contato com o administrador do Tableau Server em sua organização.
