...
4. Na caixa de pesquisa, digite **Asana**.

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-asana-tutorial/tutorial_asana_search.png)

5. No painel de resultados, selecione **Asana** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criando um usuário de teste do Asana](#creating-an-asana-test-user)** – para ter um equivalente de Brenda Fernandes no Asana que esteja vinculado à representação de usuário do Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-asana-tutorial/tutorial_asana_samlbase.png)

3. Na seção **Domínio e URLs do Asana**, realize as seguintes etapas:

    ![Configurar Logon Único](./media/active-directory-saas-asana-tutorial/tutorial_asana_url.png)

    Na caixa de texto **URL de Logon**, digite uma URL: `https://app.asana.com`
 
4. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.

    ![Configurar o logon único](./media/active-directory-saas-asana-tutorial/tutorial_asana_certificate.png)
    
5. Clique no botão **Salvar** .

    ![Configurar Logon Único](./media/active-directory-saas-asana-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do Asana**, clique em **Configurar o Asana** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**
    ...
    ![Configurar Logon Único](./media/active-directory-saas-asana-tutorial/tutorial_asana_configure.png) 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-asana-tutorial/create_aaduser_01.png) 

2. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-asana-tutorial/create_aaduser_02.png) 
...
2. Na lista de aplicativos, escolha **Asana**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-asana-tutorial/tutorial_asana_app.png) 
