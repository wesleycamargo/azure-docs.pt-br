...
4. **[Criação de um usuário de teste do Yardi eLearning](#creating-a-yardi-elearning-test-user)** - para ter um equivalente de Brenda Fernandes no Yardi eLearning vinculado à representação dela no Azure AD.
