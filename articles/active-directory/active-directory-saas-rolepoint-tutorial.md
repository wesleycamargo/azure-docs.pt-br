...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-rolepoint-tutorial/tutorial_rolepoint_samlbase.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-rolepoint-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, escolha **RolePoint**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-rolepoint-tutorial/tutorial_rolepoint_app.png) 
