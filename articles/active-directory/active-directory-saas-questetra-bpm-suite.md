...
4. **[Criação de um usuário de teste do Questetra BPM Suite](#creating-a-halogen-software-test-user)** - para ter um equivalente de Britta Simon no Questetra BPM Suite que esteja vinculado à representação dela no AD do Azure.
...
6. No portal do Azure, na página da caixa de diálogo **Definir Configurações de Aplicativo**, execute as seguintes etapas: <br><br>![Definir configurações de aplicativo][13]
    ...
    b. No seu site da empresa **Questetra BPM Suite**, na seção de Informações de SP, copie a **ID da Entidade** e cole-a na caixas de texto **URL do Emissor** e **URL de Resposta**.

    c. No seu site da empresa **Questetra BPM Suite**, na seção de Informações de SP, copie a **ID da Entidade** e cole-a na caixas de texto **URL de Resposta** e **URL de Resposta**.

    d. Clique em **Próximo**.

 
7. Na página **Configurar logon único no Questetra BPM Suite**, clique em **Baixar certificado** e, em seguida, salve o arquivo de certificado em seu computador.<br><br>![Configurar o logon único][14]
...
8. No seu site da empresa **Questetra BPM Suite**, execute as seguintes etapas: <br><br>![Configurar o logon único][15]
    ...
    b. No portal do Azure, copie o valor de **URL do Emissor** e, em seguida, cole-o no campo **ID da Entidade**.
    ...
    d. No portal do Azure, copie o valor de **URL do Serviço de Logon Único** e, em seguida, cole-o na caixa de texto **URL da página de Saída**.
...
9. No portal do AD do Azure, selecione a confirmação da configuração de logon único e clique em **Avançar**. <br><br>![O que é o Azure AD Connect][17]
...
5. Na página de caixa de diálogo **Conte-nos sobre este usuário**, execute as seguintes etapas: <br><br>![Criar um usuário de teste do AD do Azure][103]
    ...
    c. Clique em Avançar.
6.  Na página de caixa de diálogo **Perfil do Usuário**, execute as seguintes etapas: <br><br>![Criar um usuário de teste do AD do Azure][104] 
...
7. Na página de caixa de diálogo **Obter senha temporária**, clique em **criar**. <br><br>![Criar um usuário de teste do AD do Azure][105]

8. Na página de caixa de diálogo **Obter senha temporária**, execute as seguintes etapas: <br><br>![Criar um usuário de teste do AD do Azure][106]
...
3.	Na caixa de diálogo Novo Usuário, execute as seguintes etapas: <br><br>![Criar um usuário de teste][300] 
    ...
    a. Na caixa de texto **Nome**, digite o nome de usuário Britta no AD do Azure.

    b. Na caixa de texto **Email**, digite o nome de usuário Britta no AD do Azure.
...
1. No portal do Azure, para abrir a exibição de aplicativos, na exibição de diretório, clique em **Aplicativos** no menu principal.<br><br>![O que é o Azure AD Connect][201]
...
1. Na lista Usuários, selecione **Britta Simon**. <br><br>![O que é o Azure AD Connect][203]
...
O objetivo desta seção é testar sua configuração de logon único do AD do Azure usando o Painel de Acesso.<br> Quando clica no bloco Questetra BPM Suite no Painel de Acesso, você deve fazer logon automaticamente no seu aplicativo Questetra BPM Suite.
