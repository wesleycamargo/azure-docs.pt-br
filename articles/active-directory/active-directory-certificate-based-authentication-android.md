<properties 
    pageTitle="Introdução à autenticação baseada em certificado no Android | Microsoft Azure" 
...
# Introdução à autenticação baseada em certificado no Android — Visualização Pública  
