...
3. **[Criação de um usuário de teste do Ceridian Dayforce HCM](#creating-a-ceridian-dayforce-hcm-test-user)** – para ter um equivalente de Brenda Fernandes no Ceridian Dayforce HCM que esteja vinculado à representação dela no Azure AD.
