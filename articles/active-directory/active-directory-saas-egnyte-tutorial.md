...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_samlbase.png)

3. Na seção **URLs e Domínio do Egnyte**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-egnyte-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Egnyte**, clique em **Configurar Egnyte** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**

    ![Configurar o logon único](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_configure.png) 
...
2. Na lista de aplicativos, selecione **Egnyte**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_app.png) 
