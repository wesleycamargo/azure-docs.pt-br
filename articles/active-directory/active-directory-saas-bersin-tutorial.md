...
3. **[Criar um usuário de teste do Bersin](#create-a-bersin-test-user)** - para ter um equivalente de Brenda Fernandes no Bersin vinculado à representação do usuário no Microsoft Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-bersin-tutorial/tutorial_bersin_samlbase.png)

3. Na seção **Domínio e URLs do Bersin**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único de Domínio e URLs do Bersin](./media/active-directory-saas-bersin-tutorial/tutorial_bersin_url.png)
...
4. Se quiser configurar o aplicativo no modo iniciado pelo **SP**, realize as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Bersin](./media/active-directory-saas-bersin-tutorial/tutorial_bersin_url1.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-bersin-tutorial/tutorial_bersin_certificate.png) 

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-bersin-tutorial/tutorial_general_400.png)
    
7. Para configurar o logon único no lado do **Bersin**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Bersin](mailto:USBersinServiceClient@deloitte.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-bersin-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-bersin-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-bersin-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-bersin-tutorial/create_aaduser_04.png)
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Bersin. Trabalhe com a [equipe de suporte do Bersin](mailto:USBersinServiceClient@deloitte.com) para adicionar os usuários na plataforma Bersin ou o domínio que é necessário para estar na lista de permissões na plataforma Bersin. Se o domínio for adicionado pela equipe, os usuários serão automaticamente provisionados à plataforma Bersin. Os usuários devem ser criados e ativados antes de usar o logon único.
...
2. Na lista de aplicativos, escolha **Bersin**.
    ...
    ![O link do Bersin na lista de Aplicativos](./media/active-directory-saas-bersin-tutorial/tutorial_bersin_app.png)  
