...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_samlbase.png)

3. Na seção **URLs e Domínio do Jostle**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-jostle-tutorial/tutorial_general_400.png)

7. Para configurar o logon único no lado do Jostle, é necessário enviar o XML de metadados baixado para a [equipe de suporte Fuze](mailto:support@jostle.me). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados. 
...
2. Na lista de aplicativos, escolha **Jostle**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-jostle-tutorial/tutorial_jostle_app.png) 
