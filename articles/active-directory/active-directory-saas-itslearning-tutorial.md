...
6. Para configurar o lado do **itslearning** de logon único, você precisa enviar o **XML de Metadados** baixado para [a equipe de suporte do itslearning](mailto:support@itslearning.com). Eles definem essa configuração para ter a conexão de SSO do SAML definida corretamente em ambos os lados.
