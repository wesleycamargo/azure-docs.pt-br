...
## Impor políticas de acesso condicional para dispositivos móveis registrados
O registro de dispositivos do AD do Azure provisiona dispositivos com uma identidade que é usada para autenticar o dispositivo quando o usuário se conecta. O dispositivo autenticado e os atributos desse dispositivo podem, em seguida, ser usados para impor políticas de acesso condicional para aplicativos locais e hospedados em nuvem. [Saber mais sobre o registro de dispositivos do AD do Azure](active-directory-conditional-access.md).
