...
4. Na caixa de pesquisa, digite **Qumu Cloud**, selecione **Qumu Cloud** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Qumu Cloud na lista de resultados](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_addfromgallery.png)
...
3. **[Criar um usuário de teste do Qumu Cloud](#create-a-qumu-cloud-test-user)** – para ter um equivalente de Brenda Fernandes no Qumu Cloud que esteja vinculado à sua representação no Microsoft Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_samlbase.png)

3. Na seção **URLs e Domínio do Qumu Cloud**, se desejar configurar o aplicativo em modo iniciado pelo **IDP**, siga as etapas abaixo:

    ![Informações de logon único em Domínio e URLs do Qumu Cloud](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_url.png)
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Qumu Cloud](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_url1.png)
...
4. O aplicativo Qumu Cloud espera que as declarações SAML estejam em um formato específico. Configure as seguintes declarações para o aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar o logon único](./media/active-directory-saas-qumucloud-tutorial/attribute.png)
...
5. Clique na caixa de seleção **Exibir e editar todos os outros atributos de usuário** na seção **Atributos de Usuário** para expandir os atributos. Realize as seguintes etapas em cada um dos atributos exibidos:
    ...
    ![Configurar o logon único](./media/active-directory-saas-qumucloud-tutorial/tutorial_attribute_04.png)

    b. Na caixa de texto **Nome** , digite o nome do atributo mostrado para essa linha.

    ![Configurar o logon único](./media/active-directory-saas-qumucloud-tutorial/tutorial_attribute_05.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_certificate.png) 

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-qumucloud-tutorial/tutorial_general_400.png)
    
7. Para configurar o logon único no lado do **Qumu Cloud**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Qumu Cloud](mailto:support@qumu.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-qumucloud-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-qumucloud-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-qumucloud-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-qumucloud-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Qumu Cloud**.
    ...
    ![O link do Qumu Cloud na lista de aplicativos](./media/active-directory-saas-qumucloud-tutorial/tutorial_qumucloud_app.png)  
