...
---
# <a name="securing-angularjs-single-page-apps-with-azure-ad"></a>Protegendo aplicativos de página única AngularJS com o AD do Azure
...
2. Escolha seu locatário do Azure AD clicando em sua conta no canto superior direito da página.
3. No painel de navegação à esquerda, clique em **Azure Active Directory**.
4. Clique em **Registros do Aplicativo** e clique em **Adicionar**.
5. Insira um nome amigável para o aplicativo, por exemplo, "TodoListService", selecione “Aplicativo Web e/ou API da Web” como o Tipo de Aplicativo.
6. Para a URL de logon, insira a URL base para o exemplo, por exemplo, `https://localhost:8080`.
7. Depois de concluir o registro, o Azure AD atribuirá a seu aplicativo um identificador de cliente único, a ID do Aplicativo. Você precisará desse valor nas próximas seções, então copie-o da página do aplicativo.
8. Na página de configurações, configure a **URL de resposta**, que é o local no qual o AAD retornará tokens. O local padrão para esse exemplo é `https://localhost:44326/`
...
* A adal.js usa o fluxo de OAuth implícito para se comunicar com o AD do Azure.  Você deve habilitar o fluxo implícito para seu aplicativo:
  * Clique em **Manifesto** na página do aplicativo para abrir o editor de manifesto e localize a propriedade `oauth2AllowImplicitFlow`. Defina seu valor como `true`.
  * Salve o manifesto.

## <a name="2-install-adal--configure-the-spa"></a>*2. Instalar a ADAL e configurar o SPA*
...
* Comece adicionando a adal.js ao projeto TodoSPA usando o console do gerenciador de pacotes:
  ...
  * Carregue cada script antes do final do `</body>` in `index.html`:
...
## <a name="3----use-adal-to-secure-pages-in-the-spa"></a>*3.    Usar a ADAL para proteger as páginas no SPA*
