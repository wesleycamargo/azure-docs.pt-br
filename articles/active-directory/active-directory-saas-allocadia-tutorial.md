---
title: 'Tutorial: Integração do Azure Active Directory ao Allocadia | Microsoft Docs'
...
2. Na página **How would you like users to sign on to Allocadia (Como você deseja que os usuários façam logon no Allocadia)**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
...
5. Para configurar o SSO para seu aplicativo, entre em contato com a equipe de [Suporte do Allocadia](mailTo:support@allocadia.com) e ela auxiliará na configuração do SSO. Observe que você precisa enviar o email e anexar o arquivo de metadados baixado para configurar o SSO no lado do Allocadia.
   ...
   > [!NOTE]
   > Certifique-se de que a equipe do Allocadia definida o valor do identificador no ambiente de teste como **"https://na2standby.allocadia.com"** e para o ambiente de produção, deve ser: **"https://na2.allocadia.com"**
   > 
   > 
