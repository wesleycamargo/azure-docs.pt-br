---
title: 'Tutorial: integração do Active Directory do Azure ao Moxtra | Microsoft Docs'
...
3. **[Criando um usuário de teste do Moxtra](#creating-a-moxtra-test-user)** - para ter um equivalente de Brenda Fernandes no Moxtra que esteja vinculado à representação dela no Azure AD.
...
6. Na barra de ferramentas à esquerda, clique em **Console do Administrador > Logon Único do SAML** e, então, em **Novo**.
...
3. Para adicionar mapeamentos de atributo personalizados para a sua configuração de atributos de token SAML, na parte superior do menu, clique em **Atributos** para abrir a caixa de diálogo **Atributos de Token SAML**.
