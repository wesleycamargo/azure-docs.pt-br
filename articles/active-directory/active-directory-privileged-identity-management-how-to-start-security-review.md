...
![Iniciar uma análise de acesso – captura de tela](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_start_review.png)
...
![Configurar a análise – captura de tela](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_configure.png)
...
1. Navegue até **Analisar associação de função**
    ...
    ![Examinar a associação de função – captura de tela](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_role.png)
...
1. Navegue até **Selecionar revisores**
    ...
    ![Selecionar revisores – captura de tela](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_reviewers.png)
