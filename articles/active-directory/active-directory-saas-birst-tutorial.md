...
4. Na caixa de pesquisa, digite **Birst Agile Business Analytics**.

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-birst-tutorial/tutorial_birst_search.png)

5. No painel de resultados, selecione **Birst Agile Business Analytics** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criando um usuário de teste do Birst Agile Business Analytics](#creating-a-birst-agile-business-analytics-test-user)** – para ter um equivalente de Brenda Fernandes no Birst Agile Business Analytics que esteja vinculado à representação de usuário do Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_birst_samlbase.png)

3. Na seção **Domínio e URLs do Birst Agile Business Analytics**, realize as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_birst_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_birst_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Birst Agile Business Analytics**, clique em **Configurar o Birst Agile Business Analytics** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_birst_configure.png) 

7. Para configurar o logon único no lado do **Birst Agile Business Analytics**, é necessário enviar o **Certificado (Base64)** baixado, a **URL de Saída, ID da Entidade SAML e URL do Serviço de Logon Único SAML** para a [equipe de suporte do Birst Agile Business Analytics](mailto:info@birst.com). 
...
2. Na lista de aplicativos, escolha **Birst Agile Business Analytics**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-birst-tutorial/tutorial_birst_app.png) 
