...
###Quais alterações adicionais foram feitas ao meu projeto porque eu marquei *Ler dados do diretório*?
...
Seu aplicativo Active Directory do Azure foi atualizado para incluir a permissão *Ler dados do diretório* e uma chave extra foi criada e, em seguida, utilizada como *ClientSecret* no arquivo `web.config`.
