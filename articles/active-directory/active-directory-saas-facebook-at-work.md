...
5.	Depois de concluído, retorne para as janelas de navegador mostrando o portal clássico do Azure, clique na caixa de seleção para confirmar que você concluiu o procedimento e clique em **Avançar** e em **Concluir**.
