...
Quando uma análise de acesso é iniciada, o Azure AD enviará automaticamente aos revisores um email solicitando que examinem o acesso. Se um usuário não tiver recebido um email, você poderá enviar a ele as instruções de como [analisar o acesso](perform-access-review.md). 
