...
7.  Quando você cria um objeto de entidade de serviço usando o [Módulo do PowerShell do Azure AD](https://docs.microsoft.com/powershell/azuread/v2/azureactivedirectory).
