---
title: 'Tutorial: Integração do Active Directory do Azure com o Mozy Enterprise | Microsoft Docs'
...
2. Clique em **Usuários** e em **Adicionar Novo Usuário**.
   ...
   > [!NOTE]
   > A opção **Adicionar Novo Usuário** só será exibida se **Mozy** estiver selecionado como o provedor em **Política de autenticação**. Se a autenticação SAML for configurada, os usuários serão adicionados automaticamente em seu primeiro logon por meio do Logon único.
   > 
   > 
