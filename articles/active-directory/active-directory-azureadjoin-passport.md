---
title: Autenticando identidades sem senhas por meio do Microsoft Passport | Microsoft Docs
...
---
# <a name="authenticating-identities-without-passwords-through-microsoft-passport"></a>Autenticando identidades sem senhas com o Microsoft Passport
...
## <a name="why-enterprises-should-adopt-microsoft-passport"></a>Por que as empresas devem adotar o Microsoft Passport
...
4. Em seguida, o IDP valida e emite o token de autenticação que permite ao usuário e ao dispositivo acessar recursos protegidos. Os IDPs podem gravar em aplicativos multiplataforma ou usar o suporte ao navegador por meio de APIs JavaScript/Webcrypto para criar e usar as credenciais do Microsoft Passport para seus usuários.
