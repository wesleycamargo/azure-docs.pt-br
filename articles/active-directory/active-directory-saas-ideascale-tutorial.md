...
Depois de concluir este tutorial, os usuários do Azure AD que você atribuiu ao IdeaScale poderão fazer um logon único no aplicativo usando a [Introdução ao Painel de Acesso](https://msdn.microsoft.com/library/dn308586)
...
1.  No portal do Azure AD, na página de integração de aplicativos do **IdeaScale**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
3.  Na página **Configurar URL do Aplicativo**, na caixa de texto **URL de Logon do IdeaScale**, digite a URL usada pelos seus usuários para fazer logon em seu aplicativo IdeaScale (por exemplo: “ **https://company.IdeaScale.com*") e clique em **Avançar**:
...
9.  Na caixa de diálogo **Configurações de Logon Único**, execute as seguintes etapas:
    ...
    1.  No portal do Azure, na caixa de diálogo **Configurar logon único no IdeaScale**, copie o valor de **ID de Entidade** e cole-o na caixa de texto **ID de Entidade do IdP de SAML**.
    2.  Abra o arquivo de metadados baixado, copie o conteúdo e cole-o na caixa de texto **Metadados de IdP de SAML**.
    3.  No portal do Azure, na página da caixa de diálogo **Configurar logon único no IdeaScale**, copie o valor da **URL de Logoff Remoto** e cole-o na caixa de texto **URL de Êxito de Logoff**.
...
2.  Acesse **Configurações da Comunidade**.

    ![Configurações da Comunidade](./media/active-directory-saas-ideascale-tutorial/IC790847.png "Configurações da Comunidade")

3.  Acesse **Configurações Básicas > Gerenciamento de Membros**.
