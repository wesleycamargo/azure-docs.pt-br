...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_samlbase.png)

3. Na seção **URLs e Domínio do IdeaScale**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-ideascale-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do IdeaScale**, clique em **Configurar IdeaScale** para abrir a janela **Configurar logon**. Copie o **URL de logout e a ID da Entidade do SAML** da **seção de Referência Rápida**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_configure.png) 
...
2. Na lista de aplicativos, selecione **IdeaScale**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_app.png) 
