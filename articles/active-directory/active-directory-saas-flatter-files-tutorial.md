---
title: 'Tutorial: Integração do Active Directory do Azure ao Flatter Files | Microsoft Docs'
...
1. No painel de resultados, escolha **Flatter Files** e clique em **Concluir** para adicionar o aplicativo.
...
3. **[Criando um usuário de teste do Flatter Files](#creating-a-halogen-software-test-user)**: para ter um equivalente de Brenda Fernandes no Flatter Files que esteja vinculado à representação dela no AD do Azure.
...
7. Clique em **Configurações** e execute as seguintes etapas na guia **Empresa**:
