...
1. No painel de resultados, selecione **Flatter Files**, em seguida, clique em **Concluir** para adicionar o aplicativo.
...
Para que o logon único funcione, o AD do Azure precisa saber qual usuário do Flatter Files é equivalente a um usuário do AD do Azure. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Flatter Files.  
...
4. Na página **Configurar logon único no Flatter Files** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-flatter-files-tutorial/tutorial_flatter_files_04.png)  
