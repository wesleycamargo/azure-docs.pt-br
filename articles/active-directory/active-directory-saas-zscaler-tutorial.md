...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_samlbase.png)

3. Na seção **URLs e Domínio do Zscaler**, siga as etapas abaixo:

    ![Configurar o logon único](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-zscaler-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do Zscaler**, clique em **Configurar o Zscaler** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**
    ...
    ![Configurar o logon único](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_configure.png) 
...
2. Na lista de aplicativos, selecione **Zscaler**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-zscaler-tutorial/tutorial_zscaler_app.png) 
