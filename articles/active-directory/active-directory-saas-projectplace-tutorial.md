...
3.  Na página **Configurar URL do Aplicativo**, a caixa de texto **URL de Logon do Projectplace**, digite a URL de locatário do Projectplace (por exemplo: "**http://company.projectplace.com*")) e clique em **Avançar**.
