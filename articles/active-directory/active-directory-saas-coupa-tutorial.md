<properties 
    pageTitle="Tutorial: integração do Active Directory do Azure ao Coupa | Microsoft Azure" 
...
7.  Na página **Configurar URL do Aplicativo**, realize as seguintes etapas:
