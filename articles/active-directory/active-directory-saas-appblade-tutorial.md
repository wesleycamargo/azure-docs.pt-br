...
O objetivo desse tutorial é mostrar como integrar o AppBlade ao Azure AD (Azure Active Directory).  
...
Essa relação de vínculo é estabelecida atribuindo o valor do **nome de usuário** no Azure AD ao valor de **Nome de usuário** no AppBlade.
...
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-appblade-tutorial/tutorial_appblade_04.png) 
...
1. Na página **Configurar logon único no AppBlade** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-appblade-tutorial/tutorial_appblade_05.png) 
...
### <a name="creating-a-appblade-test-user"></a>Criação de um usuário de teste do AppBlade
...
2. Na lista de aplicativos, escolha **AppBlade**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-appblade-tutorial/tutorial_appblade_50.png) 
