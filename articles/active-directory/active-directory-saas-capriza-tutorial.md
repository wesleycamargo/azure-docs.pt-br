---
title: "Tutorial: Integração do Azure Active Directory com o Capriza | Microsoft Docs"
...
---
# <a name="tutorial-azure-active-directory-integration-with-capriza"></a>Tutorial: Integração do Active Directory do Azure ao Capriza
O objetivo deste tutorial é mostrar como integrar o Capriza ao Azure AD (Azure Active Directory).  
A integração do Capriza ao Azure AD oferece os seguintes benefícios:
...
## <a name="adding-capriza-from-the-gallery"></a>Adição do Capriza da galeria
...
7. No painel de resultados, selecione **Capriza**, em seguida, clique em **Concluir** para adicionar o aplicativo.
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do Capriza é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Capriza.  
Essa relação de vínculo é estabelecida atribuindo o valor do **nome de usuário** no Azure AD como o valor do **Username** no Capriza.
...
1. No portal clássico do Azure, na página de integração de aplicativos **Capriza**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
   
    ![Configurar Logon Único][6] 
2. Na página **Como você gostaria que os usuários fizessem logon no Capriza**, selecione **Logon Único do Azure AD**, em seguida, clique em **Próximo**.
   
    ![Configurar Logon Único](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_03.png) 
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_04.png) 
...
1. Na página **Configurar logon único no Capriza** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_05.png) 
...
### <a name="creating-a-capriza-test-user"></a>Criação de um usuário de teste do Capriza
...
2. Na lista de aplicativos, selecione **Capriza**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-capriza-tutorial/tutorial_capriza_50.png) 
...
Ao clicar no bloco do Capriza no Painel de Acesso, você deverá ser conectado automaticamente a seu aplicativo do Capriza.
