...
2. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
    ...
    a. Na caixa de texto URL de Logon, digite a URL usada pelos usuários para fazer logon no seu aplicativo Banco de Ativos usando o seguinte padrão: **“https://\<nome empresa\>.assetbank-server.com”**.
...
### <a name="creating-a-asset-bank-test-user"></a>Criando um usuário de teste do Asset Bank
