...
- Usando o Portal do Azure, conceda acesso a uma MSI do conjunto de dimensionamento de máquinas virtuais do Azure [a outro recurso do Azure](msi-howto-assign-access-portal.md).
