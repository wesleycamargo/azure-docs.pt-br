...
## <a name="scenarios-enabled-by-azure-active-directory-device-registration"></a>Cenários habilitados por registro de dispositivos do Active Directory do Azure
...
Você precisa habilitar o Registro do Dispositivo do Azure AD no Portal do Azure para que os dispositivos móveis possam descobrir o serviço procurando registros DNS conhecidos. Você deve configurar o DNS da sua empresa para que os dispositivos Windows 10, Windows 8.1, Windows 7, Android e iOS possam descobrir e usar o serviço.
...
### <a name="enable-azure-active-directory-device-registration-service"></a>Habilitar o serviço Registro de Dispositivos do Azure Active Directory
