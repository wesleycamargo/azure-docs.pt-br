...
## <a name="enable-the-application-integration-for-adaptive-suite"></a>Habilitar a integração de aplicativos para o Adaptive Suite
...
Configurar o logon único para o Adaptive Suite exige que você recupere um valor de impressão digital de um certificado. Se você não estiver familiarizado com este procedimento, consulte [Como recuperar o valor de impressão digital do certificado](http://youtu.be/YKQF266SAxI).
...
8. Na página **Configurações de SSO do SAML** , realize as seguintes etapas:
  ...
  6. Selecione as seguintes opções para:
