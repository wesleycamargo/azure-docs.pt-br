---
title: 'Tutorial: Integração do Active Directory do Azure ao Onit | Microsoft Docs'
...
2. Em seu navegador, clique em **Voltar** para abrir a caixa de diálogo o**Início rápido** novamente.
...
4. Na página **Como você deseja que os usuários façam logon no Onit**, selecione **Logon Único do AD do Microsoft Azure** e clique em **Avançar**.
