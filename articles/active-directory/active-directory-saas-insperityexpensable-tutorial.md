...
3. **[Criando um usuário de teste Insperity ExpensAble](#creating-a-insperityexpensable-test-user)** – para ter um equivalente de Brenda Fernandes no Insperity ExpensAble vinculado à representação dela no Azure AD.
