...
## [Usando o Azure AD Connect Health com o AD FS](active-directory-aadconnect-health-adds.md)
...
# Recursos
##[Perguntas frequentes do Azure AD Connect](active-directory-aadconnect-health-faq.md)
