...
* Você pode habilitar seus usuários a entrar automaticamente em Yonyx Interactive Guides usando SSO (logon único) com suas contas do Azure AD
...
* Uma assinatura do Yonyx Interactive Guides habilitada para SSO
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Azure AD com Yonyx Interactive Guides com base em um usuário de teste chamado "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário nos Yonyx Interactive Guides é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no Yonyx Interactive Guides.
...
Para configurar e testar o SSO do Azure AD com Yonyx Interactive Guides, você precisará concluir os seguintes blocos de construção:
...
Nesta seção, você habilitará o SSO do Azure AD no portal clássico e configurará o logon único em seu aplicativo Yonyx Interactive Guides.

**Para configurar o SSO do Azure AD com Yonyx Interactive Guides, execute as seguintes etapas:**
...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
  ...
  1. Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<company name>.yonyx.com/y/conversation/?id=<guid number>`. 
  2. Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão: `https://<company name>.yonyx.com`.
  3. Clique em **Próximo**.
...
O objetivo desta seção é habilitar Brenda Fernandes a usar o SSO do Azure concedendo a ela acesso ao Yonyx Interactive Guides.
