...
# Visualização do modelo de aplicativo v2.0: adicionar entrada para um aplicativo de página única AngularJS

O tutorial de início rápido para aplicativos AngularJS ainda não está totalmente pronto... Volte em breve e verifique se há atualizações do @AzureAD no Twitter.
