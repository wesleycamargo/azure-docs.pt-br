...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-elium-tutorial/tutorial_elium_samlbase.png)
...
3. Na seção **Domínio e URLs do Elium**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:
    ...
    ![Informações de logon único de Domínio e URLs do Elium](./media/active-directory-saas-elium-tutorial/tutorial_elium_url.png)
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do Elium](./media/active-directory-saas-elium-tutorial/tutorial_elium_url1.png)
...
5. O aplicativo Elium espera as declarações do SAML em um formato específico, o que exige que você adicione mapeamentos de atributo personalizados de acordo com a sua configuração de atributos do token SAML. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo.
    ...
    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/tutorial_attribute.png)
...
6. Na seção **Atributos de Usuário** da caixa de diálogo **Logon único**, configure o atributo do token SAML, conforme mostrado na imagem anterior e realize as seguintes etapas:
    ...
    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/tutorial_attribute_04.png)

    b. Na caixa de texto **Nome** , digite o nome do atributo mostrado para essa linha.

    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/tutorial_attribute_05.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-elium-tutorial/tutorial_elium_certificate.png) 

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-elium-tutorial/tutorial_general_400.png)
...
8. Clique no **Perfil de usuário** no canto superior direito e selecione **Administração**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/user1.png)

9. Selecione a guia **Segurança**.

    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/user2.png)

10. Role até a seção **Logon único (SSO)** e execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/user3.png)
    ...
    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/user4.png)
    ...
    ![Configurar o logon único](./media/active-directory-saas-elium-tutorial/user5.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-elium-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-elium-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-elium-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-elium-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Elium**.
    ...
    ![O link do Elium na lista de Aplicativos](./media/active-directory-saas-elium-tutorial/tutorial_elium_app.png)  
