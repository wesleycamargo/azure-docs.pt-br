...
- [Propriedades de um usuário de colaboração B2B do Azure Active Directory](../../active-directory/b2b/user-properties.md#key-properties-of-the-azure-ad-b2b-collaboration-user)
