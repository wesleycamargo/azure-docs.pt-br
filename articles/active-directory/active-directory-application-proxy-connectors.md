...
Após a criação dos grupos de Conectores, mova os Conectores para o grupo apropriado. Em **Proxy de Aplicativo**, clique em **Gerenciar Conectores** e em **Grupo**, selecione o grupo desejado para cada Conector. Observe que podem ser necessários até 10 minutos para que os Conectores fiquem ativos no novo grupo. ![](./media/active-directory-application-proxy-connectors/app_proxy_connectors_connectorlist.png)
