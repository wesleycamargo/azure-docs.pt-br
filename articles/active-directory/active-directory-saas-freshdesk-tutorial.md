<properties pageTitle="Tutorial: integração do Active Directory do Azure ao Freshdesk | Microsoft Azure" description="Saiba como usar o Freshdesk com o Active Directory do Azure para habilitar o logon único, o provisionamento automatizado e muito mais!" services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: integração do Active Directory do Azure ao Freshdesk
>[AZURE.TIP]Para ver comentários, clique [aqui](http://go.microsoft.com/fwlink/?LinkId=524323).
...
Depois de concluir este tutorial, os usuários do Azure AD que você atribuiu ao Freshdesk poderão fazer um logon único no aplicativo do site da sua empresa do Freshdesk (logon iniciado pelo provedor de serviços) ou usando a [Introdução ao Painel de Acesso](https://msdn.microsoft.com/library/dn308586)
...
1.  No portal do Azure AD, na página de integração do aplicativo **Freshdesk **, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único **.
...
3.  Na página **Configurar URL do Aplicativo**, na caixa de texto **URL de Entrada do Freshdesk**, digite sua URL usando o seguinte padrão "*https://\<nome do locatário>.Freshdesk.com*" e clique em **Avançar**.
...
4.  Na página **Configurar logon único no Freshdesk**, clique em **Baixar certificado** e salve o arquivo do certificado em seu computador como **c:\\Freshdesk.cer**.
...
8.  Na seção **Segurança**, execute as seguintes etapas:
    ...
    1.  Para **Logon Único (SSO)**, selecione **Ativado**.
    2.  Selecione **SSO de SAML**.
    3.  No portal do Azure, na caixa de diálogo **Configurar logon único no Freshdesk**, copie o valor de **URL de Logon Remoto** e cole-o na caixa de texto **URL de Logon do SAML**.
    4.  No portal do Azure, na caixa de diálogo **Configurar logon único no Freshdesk**, copie o valor de **URL de Logoff Remoto** e cole-o na caixa de texto **URL de Logoff do SAML**.
