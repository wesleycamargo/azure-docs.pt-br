...
# Tutorial: Integração do Azure Active Directory com o 360° Online
...
## Adição de 360° Online da galeria
...
4. **[Criação de um usuário de teste do 360° Online](#creating-a-360-online-test-user)** – para ter um equivalente de Brenda Fernandes no 360° Online que esteja vinculado à representação dela no Azure AD.
...
3. Na página de diálogo **Configurar URL do Aplicativo**, realize as etapas a seguir e clique em **Avançar**.

	![Configurar o logon único](./media/active-directory-saas-360online-tutorial/tutorial_360online_04.png)

    a. Na caixa de texto **URL de Entrada**, digite a URL usada pelos usuários para fazer logon em seu aplicativo do 360° Online usando o seguinte padrão: `https://<company name>.public360online.com`

    b. Clique em **Próximo**.

4. Na página de diálogo **Configurar URL do Aplicativo**, realize as etapas a seguir e clique em **Avançar**.
...
### Criar um usuário de teste do 360° Online
