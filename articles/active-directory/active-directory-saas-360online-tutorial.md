...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-360online-tutorial/tutorial_360online_samlbase.png)

3. Na seção **URLs e Domínio do 360 Online**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-360online-tutorial/tutorial_360online_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-360online-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **360 Video**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-360online-tutorial/tutorial_360online_app.png) 
