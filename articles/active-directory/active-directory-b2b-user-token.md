---
title: "Noções básicas sobre tokens de usuário na colaboração B2B do Azure Active Directory | Microsoft Docs"
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>Noções básicas sobre tokens de usuário na colaboração B2B do Azure Active Directory

Se você estiver interessado em saber qual é a aparência do token para um usuário de colaboração B2B, aqui estão os detalhes do token de portador e o conteúdo do token para Convidado do AAD MSA Convidado no locatário de recursos (para tenantid:04dcc6ab-388a-4559-b527-fbec656300ea). Você pode usar [https://jwt.io/](https://jwt.io/) ou [http://calebb.net](http://calebb.net/) para ver o conteúdo do token JWT.

## <a name="azure-ad-guest-user-token"></a>Token de usuário convidado do Azure AD
```
...
## <a name="microsoft-account-guest"></a>Conta convidada da Microsoft
```
