...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_samlbase.png)

3. Na seção **URLs e Domínio do Spacio**, execute as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do Spacio](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_url.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-spacio-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-spacio-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-spacio-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-spacio-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Spacio**.
    ...
    ![O link do Spacio na lista Aplicativos](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_app.png)  
