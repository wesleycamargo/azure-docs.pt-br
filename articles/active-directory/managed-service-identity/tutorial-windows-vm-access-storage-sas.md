...
Um MSI de máquina virtual permite obter tokens de acesso do Azure AD sem a necessidade de colocar as credenciais no seu código. Nos bastidores, ao habilitar MSI em uma VM, faz duas coisas: registra sua VM com o Microsoft Azure Active Directory para criar sua identidade gerenciada e configura a identidade na VM.
...
- Para saber como executar este mesmo tutorial usando uma chave de conta de armazenamento, consulte [Usar uma Identidade de Serviço Gerenciada da VM do Windows para acessar o Armazenamento do Azure](tutorial-windows-vm-access-storage.md)
