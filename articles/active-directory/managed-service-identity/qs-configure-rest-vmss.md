...
As identidades gerenciadas dos recursos do Azure fornecem aos serviços do Azure uma identidade de sistema gerenciada automaticamente no Azure Active Directory. Você pode usar essa identidade para autenticar em qualquer serviço que dá suporte à autenticação do Azure AD, incluindo o Key Vault, sem ter as credenciais no seu código. 
...
- Se você estiver usando o console local da CLI do Azure, entre no Azure usando `az login` com uma conta associada à assinatura do Azure que você quer gerenciar as identidades gerenciadas atribuídas ao sistema ou ao usuário.
...
3. Para habilitar a identidade gerenciada atribuída ao sistema em um conjunto de dimensionamento de máquinas virtuais com identidades gerenciadas atribuídas ao usuário existentes, é necessário adicionar `SystemAssigned` ao valor `type`.  
   ...
   A versão da API `2018-06-01`armazena identidades gerenciadas atribuídas ao usuário no valor`userAssignedIdentities` em um formato de dicionário, em oposição ao valor `identityIds`em um formato de matriz usado na versão da API`2017-12-01` e em versões anteriores.
...
4. Crie uma identidade gerenciada atribuída ao usuário usando as instruções encontradas aqui: [Criar uma identidade gerenciada atribuída ao usuário](how-to-manage-ua-identity-rest.md#create-a-user-assigned-managed-identity).
...
### <a name="assign-a-user-assigned-managed-identity-to-an-existing-azure-virtual-machine-scale-set"></a>Atribuir uma identidade gerenciada atribuída ao usuário a um conjunto de dimensionamento de máquinas virtuais do Azure existente
...
5. Se você tiver uma identidade gerenciada atribuída ao usuário ou atribuída ao sistema atribuída ao conjunto de dimensionamento de máquinas virtuais:
   ...
   **API DE 2018 VERSÃO-06-01**
   ...
   Adicione a identidade gerenciada atribuída ao usuário ao valor do dicionário `userAssignedIdentities`.
   ...
   **API versão 2017-12-01 e versões anteriores**
   ...
   Retenha as identidades gerenciadas atribuídas ao usuário que você quer de manter no valor da matriz `identityIds` ao adicionar a nova identidade gerenciada atribuída ao usuário.
...
2. Para garantir que você não exclua nenhuma identidade gerenciada atribuída ao usuário que gostaria de manter atribuída ao conjunto de dimensionamento de máquinas virtuais nem remover a identidade gerenciada atribuída ao sistema, é necessário listar as identidades gerenciadas usando os seguintes comandos CURL: 
   ...
   **API DE 2018 VERSÃO-06-01**
   ...
   Adicione `null` à identidade gerenciada atribuída ao usuário que você quer remover:
   ...
   **API versão 2017-12-01 e versões anteriores**
   ...
   Retenha apenas as identidades gerenciadas atribuídas ao usuário que você quer manter na matriz `identityIds`:   
...
Para obter informações sobre como criar, listar ou excluir identidades gerenciadas atribuídas ao usuário usando REST, consulte:
