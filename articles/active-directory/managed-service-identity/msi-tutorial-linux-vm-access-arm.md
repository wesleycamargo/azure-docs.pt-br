...
ms.locfileid: "33931390"
---
# <a name="use-a-user-assigned-identity-on-a-linux-vm-to-access-azure-resource-manager"></a>Usar uma identidade atribuída pelo usuário em uma VM do Linux para acessar o Azure Resource Manager
