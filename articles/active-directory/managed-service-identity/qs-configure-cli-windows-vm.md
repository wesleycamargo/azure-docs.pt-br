...
2. Use o comando [az vm identity assign](/cli/azure/vm/identity/#az_vm_identity_assign) com o comando `identity assign` para adicionar um MSI a uma VM existente:
