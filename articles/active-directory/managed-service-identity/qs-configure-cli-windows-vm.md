...
- Adicionar e remover uma identidade gerenciada atribuída ao usuário em uma VM do Azure
...
Para remover a extensão da VM de recursos de identidade gerenciada do Azure, o usuário `-n ManagedIdentityExtensionForWindows` ou a opção `-n ManagedIdentityExtensionForLinux` (dependendo do tipo de VM) com [az vm extension delete](https://docs.microsoft.com/cli/azure/vm/#assign-identity):
...
### <a name="assign-a-user-assigned-managed-identity-to-an-existing-azure-vm"></a>Atribuir uma identidade gerenciada atribuída ao usuário a uma VM do Azure existente
