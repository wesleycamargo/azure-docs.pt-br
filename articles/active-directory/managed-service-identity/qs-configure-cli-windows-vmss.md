...
Para remover as identidades gerenciadas da extensão da VM dos recursos do Azure, use o comando [az vmss identity remove](/cli/azure/vmss/identity/#az-vmss-remove-identity) para remover a identidade gerenciada atribuída ao sistema de um VMSS:
