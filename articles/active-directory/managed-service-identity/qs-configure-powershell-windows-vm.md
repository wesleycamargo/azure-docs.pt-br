...
## <a name="disable-system-assigned-managed-identity-from-an-azure-vm"></a>Desabilitar identidade gerenciada atribuída ao sistema de uma VM do Azure
