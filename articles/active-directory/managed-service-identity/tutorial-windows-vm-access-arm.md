...
description: Um tutorial que orienta você durante o processo de uso de uma Identidade de Serviço Gerenciada de VM do Windows para acessar o Azure Resource Manager.
