...
1.  No portal do Azure AD, na página de integração de aplicativos do **Clarizen**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**.
...
7.  No diálogo **Autenticação Federada**, realize as seguintes etapas:
    ...
    2.  No portal do Azure, na página do diálogo **Configurar logon único no Clarizen**, copie o valor da **URL do Serviço de Logon Único** e cole-o na caixa de texto **URL de Entrada**.
    3.  No portal do Azure, na página do diálogo **Configurar logon único no Clarizen**, copie o valor da **URL do Serviço de Saída** e cole-o na caixa de texto **URL de Saída**.
