...
6. Na **caixa de pesquisa**, digite **Salesforce**. Em seguida, selecione **Salesforce** nos resultados e clique em **Concluir** para adicionar o aplicativo.
...
3. Uma caixa de diálogo será aberta e você verá uma tela que pergunta "Como você gostaria que os usuários fizessem logon no Salesforce?" Selecione **Logon Único do AD do Azure** e, em seguida, clique em **Avançar**.
...
11. Na página **Edição de Configuração de Logon Único do SAML**, realize as seguintes configurações:
 ...
 - No AD do Azure, copie o valor **URL do Emissor** e, em seguida, cole-o no campo **Emissor** no Salesforce.
 ...
 - No AD do Azure, copie o valor da **URL de Logon Remoto** e, em seguida, cole-o no campo **URL de Logon do Provedor de Identidade** no Salesforce.
...
##Etapa 4: Atribuir usuários ao Salesforce
