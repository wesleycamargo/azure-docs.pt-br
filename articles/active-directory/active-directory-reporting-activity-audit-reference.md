...
- Relatórios, confira os [Relatórios do Azure Active Directory](active-directory-reporting-azure-portal.md).

- Relatórios de atividade de auditoria, confira [Relatórios de atividade de auditoria no portal do Azure Active Directory](active-directory-reporting-activity-audit-logs.md). 
