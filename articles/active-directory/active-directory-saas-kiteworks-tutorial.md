---
title: 'Tutorial: Integração do Active Directory do Azure com o Kiteworks | Microsoft Docs'
...
3. **[Criação de um usuário de teste do Kiteworks](#creating-a-kiteworks-test-user)**: para ter um equivalente de Brenda Fernandes no Kiteworks que esteja vinculado à representação dela no AD do Azure.
