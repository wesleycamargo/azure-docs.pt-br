...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-tivitz-tutorial/tutorial_tivitz_samlbase.png)

3. Na seção **URLs e Domínio do TiViTz**, siga as etapas abaixo:

    ![Configurar o logon único](./media/active-directory-saas-tivitz-tutorial/tutorial_tivitz_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-tivitz-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **TiViTz**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-tivitz-tutorial/tutorial_tivitz_app.png) 
