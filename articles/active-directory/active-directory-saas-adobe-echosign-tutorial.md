---
title: 'Tutorial: Integração do Active Directory do Azure ao Adobe EchoSign | Microsoft Docs'
...
2. Na página de integração do aplicativo **Adobe EchoSign**, clique em **Atribuir usuários**.
