<properties pageTitle="Tutorial: Integração do Active Directory do Azure com o Tinfoil Security | Microsoft Azure" description="Saiba como usar o Tinfoil Security com o Active Directory do Azure para habilitar logon único, provisionamento automatizado e muito mais!" services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Integração do Active Directory do Azure com o Tinfoil Security
>[AZURE.TIP]Para ver comentários, clique [aqui](http://go.microsoft.com/fwlink/?LinkId=613055).
...
-   Uma assinatura do Tinfoil Security com logon único habilitado
  
Depois de concluir este tutorial, os usuários do AD do Azure que você atribuiu ao Tinfoil Security poderão fazer logon único no aplicativo em seu site de empresa Tinfoil Security (logon iniciado pelo provedor de identidade) ou usando a [Introdução ao Painel de Acesso](https://msdn.microsoft.com/library/dn308586)
...
1.  No portal do Azure AD, na página de integração do aplicativo **Tinfoil Security**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar logon único**.
...
3.  Na página **Configurar URL do aplicativo**, a caixa de texto **URL de resposta do Tinfoil Security**, digite sua URL do ACS (Serviço de Declaração do Consumidor) do Tinfoil Security (por exemplo, "**https://www.tinfoilsecurity.com/saml/consume*"e, em seguida, clique em **Avançar**.
...
8.  Na página de configuração **Logon Único**, execute as seguintes etapas:
    ...
    3.  No portal do Azure, na página de diálogo **Configurar logon único no Tinfoil Security**, copie o valor da **URL de SAML SSO**, em seguida, cole-o na caixa de texto **URL de SAML Post**.
    4.  Copie o valor de **Impressão Digital** do certificado exportado e cole-o na caixa de texto **Impressão Digital de Certificado SAML**.  
...
10. No menu, na parte superior, clique em **Atributos** para abrir a caixa de diálogo **Atributos de Token SAML**.
