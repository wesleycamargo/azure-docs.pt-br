...
8. Na página de configuração **Logon Único** , realize as seguintes etapas:
   ...
   3. No portal clássico do Azure, na página do diálogo **Configurar logon único no Tinfoil Security**, copie o valor da **URL de SSO do SAML** e cole-o na caixa de texto **URL da Postagem do SAML**.
