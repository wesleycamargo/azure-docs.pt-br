...
description: "Saiba como usar o Nexonia com o Azure Active Directory para habilitar o logon único, provisionamento automatizado e muito mais!"
...
6. Na caixa de pesquisa, digite **Nexonia**.

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_01.png)

7. No painel de resultados, selecione **Nexonia** e clique em **Concluir** para adicionar o aplicativo.
    
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_02.png)
...
Essa relação de vinculação é estabelecida por meio da atribuição do valor do **nome de usuário** no Azure AD como o valor do **Nome de Usuário** no Nexonia.
...
3. **[Criar um usuário de teste do Nexonia](#creating-a-nexonia-test-user)** - para ter um equivalente de Brenda Fernandes no Nexonia que esteja vinculado à representação dela no Azure AD.
...
Nesta seção, você habilitará o logon único do Azure AD no portal clássico e configurará o logon único em seu aplicativo Nexonia.


**Para configurar o logon único do Azure AD com o Nexonia, execute as seguintes etapas:**

1. No portal clássico do Azure, na página de integração de aplicativos do **Nexonia**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**.
     
    ![Configurar Logon Único][6] 

2. Na página **Como você deseja que os usuários entrem no Nexonia**, selecione **Logon Único do Azure AD** e clique em **Avançar**.

    ![Configurar Logon Único](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_03.png) 

3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:

    ![Configurar Logon Único](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_04.png) 

    a. Na caixa de texto **URL de resposta**, digite a URL com o seguinte padrão: `https://system.nexonia.com/assistant/saml.do?orgCode=<organizationcode>`
    
    b. Clique em **Avançar**
 
4. Na página **Configurar logon único no Nexonia**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_05.png)
...
5. Para que o SSO seja configurado para seu aplicativo, entre em contato com a equipe de suporte do Nexonia e forneça o seguinte:
...
1. No **portal clássico do Azure**, no painel de navegação à esquerda, clique em **Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/create_aaduser_09.png) 
...
5. Na página de diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas:  ![criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/create_aaduser_05.png) 
...
6.  Na caixa de diálogo **perfil de usuário**, realize as etapas a seguir: ![criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/create_aaduser_06.png) 
...
7. Na página de diálogo **Obter senha temporária**, clique em **criar**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/create_aaduser_07.png) 

8. Na página de caixa de diálogo **Obter senha temporária** , execute as seguintes etapas:

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-nexonia-tutorial/create_aaduser_08.png) 
...
### <a name="creating-an-nexonia-test-user"></a>Criar um usuário de teste do Nexonia

Nesta seção, você criará um usuário chamado Brenda Fernandes no Nexonia. Trabalhe com a equipe de suporte do Nexonia para adicionar os usuários na plataforma do Nexonia. Os usuários devem ser criados e ativados antes de usar o logon único.


### <a name="assigning-the-azure-ad-test-user"></a>Atribuição do usuário de teste do AD do Azure

Nesta seção, você permitirá que Brenda Fernandes use o logon único do Azure concedendo a ela acesso ao Nexonia.
...
2. Na lista de aplicativos, selecione **Nexonia**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_50.png) 
