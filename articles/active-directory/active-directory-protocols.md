...
- [Concessão de código de autorização de OAuth 2.0](active-directory-protocols-oauth-code.md): Saiba mais sobre a concessão de autorização do "código de autorização" de OAuth2.0 e sua implementação no Azure AD.
- [Concessão implícita do OAuth 2.0](active-directory-dev-understanding-oauth2-implicit-grant.md): saiba mais sobre a concessão de autorização “implícita” do OAuth 2.0 e se ela é adequada para seu aplicativo.
- [Open ID Connect 1.0](active-directory-protocols-openid-connect-code.md): saiba como usar o protocolo de autenticação OpenID Connect no Azure AD.
