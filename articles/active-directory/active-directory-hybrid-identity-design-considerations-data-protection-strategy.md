...
>[AZURE.TIP]É importante mencionar que AD do Azure não possui Política de Grupo como o AD DS. Para aplicar a política de dispositivos, você precisará de uma solução de gerenciamento de dispositivo móvel, como o [Microsoft Intune](https://technet.microsoft.com/library/jj676587.aspx).
