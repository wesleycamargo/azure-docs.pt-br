...
3.  Na página **Configurar URL do Aplicativo**, na caixa de texto **URL de Logon**, digite a URL usada pelos usuários para fazer logon no aplicativo SCC LifeCycle usando o padrão "**https://bs1.scc.com/lc7/welcome/customer/PICTtest.aspx*" e clique em **Avançar**.
