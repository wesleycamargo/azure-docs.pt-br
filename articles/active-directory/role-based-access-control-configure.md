<properties
	...
	description="Introdução ao gerenciamento de acesso com o Controle de Acesso Baseado em Função no Portal do Azure. Use as atribuições de função para atribuir permissões em seu diretório."
...
# Use as atribuições de função para gerenciar o acesso aos recursos do Azure Active Directory
