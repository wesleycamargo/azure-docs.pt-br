...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e, em seguida, clique em **Avançar**:
    ...
    a. Na caixa de texto **URL de Logon**, digite a URL utilizada pelos usuários para fazer logon em seu aplicativo SECURE DELIVER usando o seguinte padrão: **"https://i-securedeliver.jp/sd/\<nome da empresa\>/jsf/login/sso"**.
