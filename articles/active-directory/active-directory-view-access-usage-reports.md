...
Este relatório inclui o sinal a assinatura em *todos* os aplicativos que o diretório tiver acesso, incluindo aplicativos previamente integrados da Microsoft.
...
> Observação: Para reduzir a quantidade de ruído no relatório, as entradas pelo [Assistente de Conexão do Microsoft Online Services](http://community.office365.com/pt-BR/w/sso/534.aspx) não são mostradas.
> 
> 
