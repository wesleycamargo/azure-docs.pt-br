...
* Depois de concluir o registro, navegue até a guia **Configurar** e localize o campo **URI da ID do Aplicativo**.  Insira um identificador específico do locatário para esse valor, por exemplo, `https://contoso.onmicrosoft.com/TodoListService`
