<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao Anaplan | Microsoft Azure"
...
# Tutorial: Integração do Azure Active Directory ao Anaplan
...
3. **[Criando um usuário de teste do Anaplan](#creating-a-anaplan-test-user)** - para ter um equivalente de Brenda Fernandes no Anaplan que esteja vinculado à representação dela no Azure AD.
