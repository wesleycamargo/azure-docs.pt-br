---
title: Gerenciar dispositivos conectados no portal Meu Perfil (versão prévia) – Azure Active Directory | Microsoft Docs
description: Uma visão geral sobre a página Dispositivos do portal Meu Perfil.
...
1. Selecione **Desabilitar** no dispositivo que deseja remover.

    ![Página Dispositivo, com link para desabilitar em destaque](media/myprofile-portal/myprofile-portal-devices-disable.png)
