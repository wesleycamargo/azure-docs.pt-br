...
- **Windows Phone.** Em seu Windows Phone, acesse a Microsoft Store para [baixar e instalar o aplicativo Microsoft Authenticator](https://app.adjust.com/e3rxkc_7lfdtm?fallback=https%3A%2F%2Fwww.microsoft.com%2Fen-us%2Fp%2Fmicrosoft-authenticator%2F9nblgggzmcj6).

    >[!Note]
    >Não é possível usar o processo de entrada com telefone em dispositivos Windows Phone. É necessário usar o processo de verificação padrão, conforme descrito no artigo [Configurar a verificação em duas etapas](multi-factor-authentication-end-user-first-time.md).

## <a name="next-steps"></a>Próximas etapas

- Depois de baixar e instalar o aplicativo, você precisará adicionar suas várias contas. Para obter mais informações, confira [Adicionar suas contas](microsoft-authenticator-app-add-accounts-overview.md).
