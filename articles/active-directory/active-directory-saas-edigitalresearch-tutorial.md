<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao eDigitalResearch | Microsoft Azure"
...
# Tutorial: integração do Azure Active Directory ao eDigitalResearch
...
## Adicionando o eDigitalResearch da galeria
...
O objetivo desta seção é mostrar como configurar e testar logon único do Azure AD com o eDigitalResearch, com base em uma usuária de teste chamada "Brenda Fernandes".
...
Essa relação de vínculo é estabelecida atribuindo o valor do **nome de usuário** no Azure AD ao valor do **Nome de Usuário** no eDigitalResearch.
...
3. **[Criação de um usuário de teste do eDigitalResearch](#creating-a-edigitalresearch-test-user)**: para ter um equivalente de Brenda Fernandes no eDigitalResearch que esteja vinculado à representação dela no Azure AD.
4. **[Atribuição do usuário de teste do AD do Azure](#assigning-the-azure-ad-test-user)**: para permitir que Brenda Fernandes use o logon único do AD do Azure.
5. **[Teste do logon único](#testing-single-sign-on)**: para verificar se a configuração funciona.

### Configuração do logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure AD no portal clássico e configurará o logon único em seu aplicativo eDigitalResearch.
...
2. Na página **Como você deseja que os usuários façam logon no eDigitalResearch**, selecione **Logon Único do Azure AD** e clique em **Avançar**.

	![Configurar o logon único](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_03.png)
...
3. Na página de caixa de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
	...
	> [AZURE.NOTE] O valor para a URL de resposta neste tutorial é apenas um espaço reservado. Para obter o valor real de seu ambiente, entre em contato com a eDigitalResearch.

4. Na página **Configurar logon único no eDigitalResearch**, execute as seguintes etapas e clique em **Avançar**:

	![Configurar o logon único](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_05.png)
...
### Criar um usuário de teste eDigitalResearch
...
2. Na lista de aplicativos, selecione **eDigitalResearch**.
	...
	![Configurar o logon único](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_50.png)
