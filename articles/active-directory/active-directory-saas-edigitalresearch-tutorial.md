...
* Você pode permitir que seus usuários façam logon automaticamente no eDigitalResearch com SSO (logon único) com as contas do Azure AD
...
* Uma assinatura de eDigitalResearch com SSO habilitado
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Microsoft Azure AD com o eDigitalResearch, com base em uma usuária de teste chamada "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário do eDigitalResearch é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vinculação entre um usuário do Azure AD e o usuário relacionado no eDigitalResearch.
...
Para configurar e testar o SSO do Microsoft Azure AD com o eDigitalResearch, você precisará executar as seguintes etapas básicas:
...
Nesta seção, você habilita o SSO do Microsoft Azure AD no portal clássico e configura o SSO no aplicativo eDigitalResearch.
...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
  ...
  1. Na caixa de texto **URL de resposta**, digite uma URL no seguinte padrão: `https://<company name>.edigitalresearch.com/login/consume` 
  2. Clique em **Próximo**.
...
O objetivo desta seção é permitir que Brenda Fernandes use o SSO do Azure, concedendo a ela acesso ao eDigitalResearch.
