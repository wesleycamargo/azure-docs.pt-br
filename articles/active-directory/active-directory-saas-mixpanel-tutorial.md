...
8. Na página de diálogo **Alterar seu certificado**, clique em **Escolher arquivo** para carregar o certificado baixado e, em seguida, clique em **Avançar**.

    ![Configurações do Mixpanel](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png) 

9. No portal clássico do Azure, na página de diálogo **Configurar logon único no Mixpanel**, copie o valor de **URL de Serviço de Logon Único**, cole-o na caixa de texto da URL de autenticação na página de diálogo **Alterar a URL de autenticação** e clique em **Avançar**.
