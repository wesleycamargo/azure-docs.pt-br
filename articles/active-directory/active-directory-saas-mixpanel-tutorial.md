...
* Você pode permitir que os usuários façam logon automaticamente no Mixpanel usando SSO (logon único) com suas contas do Azure AD
...
* Uma assinatura do Mixpanel habilitada para SSO (logon único)
...
## <a name="add-mixpanel-from-the-gallery"></a>Adicionar o Mixpanel da galeria
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Azure AD com o Mixpanel, com base em um usuário de teste chamado "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário do Mixpanel é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Mixpanel.
...
O objetivo desta seção é habilitar o SSO do Azure AD no Portal Clássico do Azure e configurar o SSO em seu aplicativo Mixpanel.
...
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
  ...
  1. Na caixa de texto **URL de Logon**, digite a URL usada pelos usuários para fazer logon em seu aplicativo do Mixpanel usando o seguinte padrão: **“https://mixpanel.com/login/”**.
...
### <a name="create-a-mixpanel-test-user"></a>Criar um usuário de teste do Mixpanel
...
O objetivo desta seção é permitir que Brenda Fernandes use o SSO do Azure, concedendo a ela acesso ao Mixpanel.
