---
title: Diretrizes de segurança para a Autenticação Multifator do Azure
...
* [A experiência de registro de verificação em duas etapas](end-user/current/multi-factor-authentication-end-user-first-time.md)
