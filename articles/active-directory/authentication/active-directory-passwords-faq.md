...
* **P: posso definir dados de redefinição de senha em nome dos meus usuários?**
  ...
  > **R:** sim, você pode fazer isso com o Azure AD Connect, PowerShell, o [portal do Azure](https://portal.azure.com) ou o centro de Administração do Office 365. Para obter mais informações, consulte [Dados usados pelo autoatendimento de redefinição de senha do Azure AD](howto-sspr-authenticationdata.md).
  >
  >
