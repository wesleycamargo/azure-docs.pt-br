...
* [Configurar o write-back de senha](howto-sspr-writeback.md#configure-password-writeback) para gravar senhas do Azure AD de volta ao seu diretório local
...
[Policy]: ./media/quickstart-sspr/password-policy.png "Política de Grupo de senha local definida para 0 dias"
