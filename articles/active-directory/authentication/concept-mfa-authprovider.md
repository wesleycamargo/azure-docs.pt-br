...
> [!IMPORTANT]
> A reprovação do SDK (Software Development Kit) da Autenticação Multifator do Azure foi anunciada. Não há mais suporte para esse recurso para novos clientes. Os clientes atuais podem continuar usando o SDK até 14 de novembro de 2018. Após essa data, as chamadas para o SDK falharão.
