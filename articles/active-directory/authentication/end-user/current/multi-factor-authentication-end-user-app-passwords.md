...
- Experimente o [aplicativo Autenticador Microsoft](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) para verificar suas conexões com notificações de aplicativo, em vez de receber mensagens ou ligações.
