...
Aprenda a [Gerenciar suas configurações de verificação em duas etapas](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md).

Descubra como [Começar a usar o aplicativo Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) para poder entrar usando notificações, em vez de textos e chamadas telefônicas.
