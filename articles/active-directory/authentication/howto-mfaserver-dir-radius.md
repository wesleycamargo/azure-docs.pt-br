---
title: Autenticação RADIUS e servidor Azure MFA - Azure Active Directory
...
![Autenticação de RADIUS no servidor MFA](./media/howto-mfaserver-dir-radius/radius.png)
