...
3. **[Criação de um usuário de teste do Weekdone](#creating-a-weekdone-test-user)**: para ter um equivalente de Brenda Fernandes no Weekdone que esteja vinculado à representação dela no Azure AD.
