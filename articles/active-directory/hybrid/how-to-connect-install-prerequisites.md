...
* [As contas são Active Directory](reference-connect-accounts-permissions.md) se você usar o caminho de instalação de configurações personalizadas.
