...
* Uma assinatura da Aha! habilitada para SSO (logon único)
...
## <a name="enable-the-application-integration-for-aha"></a>Habilitar a integração de aplicativos para o Aha!
...
2. Na página de integração de aplicativos **Aha!**, clique em **Atribuir usuários**.
