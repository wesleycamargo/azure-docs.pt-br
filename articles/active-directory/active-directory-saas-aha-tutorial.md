...
O objetivo deste tutorial é mostrar a integração do Azure ao Aha!  
...
### <a name="to-enable-the-application-integration-for-aha-perform-the-following-steps"></a>Para habilitar a integração de aplicativos para o Aha!, execute as seguintes etapas:
...
Para permitir que os usuários do AD do Azure façam logon no Aha!, eles devem ser provisionados no Aha!.  
No caso do Aha!, o provisionamento é uma tarefa automatizada.  
...
### <a name="to-assign-users-to-aha-perform-the-following-steps"></a>Para atribuir usuários ao Aha!, execute as seguintes etapas:
