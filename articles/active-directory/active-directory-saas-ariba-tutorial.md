...
1. Na página **Configurar logon único no Ariba** , execute as seguintes etapas:
    ...
    b. Clique em **Próximo**.
2. Para ter o SSO configurado para seu aplicativo, entre em contato com a equipe de suporte do Ariba pelo telefone **1-866-218-2155**.
