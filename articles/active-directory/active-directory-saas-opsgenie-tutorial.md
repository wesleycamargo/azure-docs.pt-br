...
Essa relação de vínculo é estabelecida atribuindo o valor de **nome de usuário** ao AD do Azure como sendo o valor de **nome de usuário** no OpsGenie.
...
1. No portal clássico do Azure, na página de integração do aplicativo **OpsGenie**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
6. Clique em **Configurações** e, em seguida, clique na guia **Logon único**.
...
9. Na página de diálogo Azure Active Directory, execute as seguintes etapas:
    ...
    a. No portal clássico do Azure, na página de diálogo **Configurar logon único no OpsGenie**, copie o valor da **URL do Serviço de Logon Único** e cole-o na caixa de texto **Ponto de Extremidade SAML 2.0**.
