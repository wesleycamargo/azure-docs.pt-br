...
4. **[Criação de um usuário de teste para OpsGenie](#creating-a-opsgenie-test-user)** : para ter um equivalente de Brenda Fernandes no OpsGenie que esteja vinculado à representação dela no Azure AD.
