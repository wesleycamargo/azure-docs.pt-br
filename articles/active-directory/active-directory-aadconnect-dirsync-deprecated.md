...
Solução | Cenário
----- | -----
[Atualização do DirSync](./aad-connect/active-directory-aadconnect-dirsync-upgrade-get-started.md) | <li>Se você tiver um servidor DirSync existente já em execução.</li>
