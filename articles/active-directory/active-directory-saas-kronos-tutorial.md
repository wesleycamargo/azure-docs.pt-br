...
3. **[Criar um usuário de teste do Kronos](#creating-an-kronos-test-user)**: para ter um equivalente de Brenda Fernandes no Kronos que esteja vinculado à representação dela no Azure AD.
