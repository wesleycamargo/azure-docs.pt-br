...
4. Na caixa de pesquisa, digite **LINE WORKS**, selecione **LINE WORKS** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![LINE WORKS na lista de resultados](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_addfromgallery.png)
...
No LINE WORKS, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vinculação.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_samlbase.png)

3. Na seção **URLs e Domínio do LINE WORKS**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do LINE WORKS](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_url.png)
    ...
    b. Na caixa de texto **Identificador**, digite o valor: `worksmobile.com`

    > [!NOTE] 
    > Esse valor não é real. Atualize esse valor com a URL de Logon real. Entre em contato com a [Equipe de suporte ao cliente do LINE WORKS](mailto:dl_ssoinfo@worksmobile.com) para obter esse valor.
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Bruto)** e, em seguida, salve o arquivo de certificado no computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-lineworks-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do LINE WORKS**, clique em **Configurar LINE WORKS** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do LINE WORKS](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_configure.png) 

7. Para configurar o logon único no lado do **LINE WORKS**, é necessário enviar **o arquivo Certificado, a URL de Saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** baixados para a [Equipe de suporte do LINE WORKS](mailto:dl_ssoinfo@worksmobile.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-lineworks-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-lineworks-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-lineworks-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-lineworks-tutorial/create_aaduser_04.png)
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no LINE WORKS. Trabalhe com a [Equipe de suporte do LINE WORKS](mailto:dl_ssoinfo@worksmobile.com) para adicionar os usuários na plataforma do LINE WORKS.
...
**Para atribuir Brenda Fernandes ao LINE WORKS, execute as seguintes etapas:**
...
2. Na lista de aplicativos, escolha **LINE WORKS**.
    ...
    ![O link do LINE WORKS na Lista de aplicativos](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_app.png)  
