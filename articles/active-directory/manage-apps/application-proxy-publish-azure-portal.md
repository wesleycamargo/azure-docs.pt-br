...
Siga estas etapas para publicar seus aplicativos com Proxy de Aplicativo. Se você já não tiver baixado e configurado um conector para sua organização, vá para [Introdução ao Proxy de Aplicativo e instale o conector](application-proxy-enable.md) primeiro e, em seguida, publique seu aplicativo.
...
4. Forneça as seguintes informações sobre o aplicativo:
   ...
   - **URL externa**: o endereço que seus usuários usam para acessar o aplicativo de fora da sua rede. Se você não quiser usar o domínio padrão de Proxy de Aplicativo, leia sobre [domínios personalizados no Proxy de Aplicativo do Azure AD](application-proxy-configure-custom-domain.md).
...
- [Baixe conectores](application-proxy-enable.md) e [crie grupos de conectores](application-proxy-connector-groups.md) para publicar aplicativos em redes e locais separados.

- [Configurar o logon único](application-proxy-configure-single-sign-on-password-vaulting.md) para seu aplicativo recém-publicado
