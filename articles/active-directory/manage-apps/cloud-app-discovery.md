...
1. [Configurar relatórios de instantâneo](cloud-app-discovery-create-snapshot-reports.md) para conferir seu formato de log e verificar se os logs fornecem informações úteis ao Cloud App Discovery. Eles também podem fornecer visibilidade ad hoc nos logs de tráfego que você carrega manualmente dos seus firewalls e servidores proxy.
...
2.  O formato do log corresponde ao formato padrão esperado. Isso é verificado no momento do upload. Para otimizar o formato de log, consulte [Criar relatórios de instantâneo do Cloud App Discovery](cloud-app-discovery-create-snapshot-reports.md).
...
* [Criar relatórios de instantâneo](cloud-app-discovery-create-snapshot-reports.md)
