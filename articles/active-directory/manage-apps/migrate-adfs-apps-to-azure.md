...
|-----|-----|-----|-----|-----|
|URL de logon do aplicativo|URL da página de entrada do aplicativo. É aqui que o usuário vai para entrar no aplicativo em um fluxo de SAML iniciado por SP.|Não aplicável|No Azure AD, a URL de logon está configurada no portal do Azure, nas propriedades de **Logon único** do aplicativo, como a URL de logon.</br></br>(Talvez você precise clicar em **Mostrar configurações de URL avançadas** para ver a URL de logon.)|Não aplicável|
