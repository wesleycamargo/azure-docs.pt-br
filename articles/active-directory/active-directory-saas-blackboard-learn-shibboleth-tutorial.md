<properties
	pageTitle="Tutorial: integração do Azure Active Directory ao Blackboard Learn - Shibboleth | Microsoft Azure"
...
3. Na página de diálogo **Definir Configurações de Aplicativo**, execute as seguintes etapas:
	...
	> [AZURE.NOTE] Você poderá localizar todos esses valores no documento de Metadados de Federação fornecido por seu parceiro do Blackboard Learn.
