...
4. Na caixa de pesquisa, digite **Zwayam**, selecione **Zwayam** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criar um usuário de teste do Zwayam](#create-a-zwayam-test-user)** – para ter um equivalente de Brenda Fernandes no Zwayam vinculado à representação do usuário no Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_samlbase.png)

3. Na seção **URLs e Domínio do Zwayam**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Zwayam](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-zwayam-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Zwayam**, clique em **Configurar Zwayam** para abrir a janela **Configurar logon**. Copie a **ID de Entidade SAML** da **seção Referência Rápida** e cole o valor da **ID de Entidade SAML** na caixa de texto **URL de logon** na seção  **Domínio e URLs do Zwayam**.

    ![Configuração do Zwayam](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_configure.png) 

7. Para configurar o logon único no lado do **Zwayam**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Zwayam](mailto:opendoors@zwayam.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-zwayam-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-zwayam-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-zwayam-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-zwayam-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Zwayam**.

    ![O link do Zwayam na lista de Aplicativos](./media/active-directory-saas-zwayam-tutorial/tutorial_Zwayam_app.png)  
