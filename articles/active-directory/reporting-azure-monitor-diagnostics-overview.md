...
* Arquivar logs de auditoria de uma conta de armazenamento do Azure, o que permite manter os dados por um longo tempo.
...
* Integre os logs de auditoria às suas próprias soluções de log personalizadas transmitindo-as para um hub de eventos.
