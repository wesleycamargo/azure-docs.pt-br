...
**10:** Para testar a experiência do usuário final, entre no painel de acesso do AD do Azure de sua organização em https://myapps.microsoft.com, preferencialmente usando uma conta diferente que não seja a de um aprovador de aplicativo. 
