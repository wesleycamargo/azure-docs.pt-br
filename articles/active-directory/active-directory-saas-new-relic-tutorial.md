...
* Uma assinatura do New Relic com SSO (logon único) habilitado

Depois de concluir este tutorial, os usuários do Azure Active Directory que você atribuiu ao New Relic poderão usar SSO usando o Painel de Acesso do AAD.
...
1. No Portal Clássico do Azure, na página de integração de aplicativos do **New Relic**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
