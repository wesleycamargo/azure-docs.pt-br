...
|Para o AD FS, a auditoria do AD FS deve ser ativada para usar a Análise de uso| Se você planeja usar a Análise de Uso com o AD FS, a auditoria do AD FS deve ser habilitada. </br></br>Confira [Habilitar a auditoria do AD FS.](active-directory-aadconnect-health-agent-install-adfs.md#enable-auditing-for-ad-fs)
