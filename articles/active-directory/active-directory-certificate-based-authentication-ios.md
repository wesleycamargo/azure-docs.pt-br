---
title: "Introdução à autenticação baseada em certificados no iOS | Microsoft Docs"
...
---
# <a name="get-started-with-certificate-based-authentication-on-ios---public-preview"></a>Introdução à autenticação baseada em certificado no iOS — Visualização Pública
...
### <a name="testing-eas-client-applications-on-ios"></a>Testando os aplicativos cliente do EAS no iOS
