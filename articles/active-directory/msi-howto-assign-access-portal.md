...
Após habilitar a MSI em um recurso do Azure, como uma [VM do Azure](msi-qs-configure-portal-windows-vm.md) ou [VMSS do Azure ](msi-qs-configure-portal-windows-vmss.md):
...
- Para habilitar a MSI em uma máquina virtual do Azure, consulte [Configurar uma MSI (Identidade de Serviço Gerenciada) da VM do Azure usando o Portal do Azure](msi-qs-configure-portal-windows-vm.md).
