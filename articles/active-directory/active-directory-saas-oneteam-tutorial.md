...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_samlbase.png)

3. Na seção **Domínio e URLs do Oneteam**, se você desejar configurar o aplicativo em modo iniciado pelo **IDP**:

    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_url.png)
...
4. Marque **Mostrar configurações avançadas de URL**, se quiser configurar o aplicativo no modo iniciado em **SP**:
    ...
    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_url1.png)
...
6. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **Oneteam**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_app.png) 
