...
- Você pode habilitar seus usuários a fazerem logon automaticamente no Oneteam usando SSO (Logon Único) com suas contas do Azure AD
...
- Uma assinatura do Oneteam habilitada para SSO
...
## <a name="add-oneteam-from-the-gallery"></a>Adicionar o Oneteam da galeria
...
Nesta seção, você configurará e testará o SSO do Azure AD com o Oneteam com base em um usuário de teste chamado “Brenda Fernandes”.

Para que o SSO funcione, o Azure AD precisa saber qual usuário do Oneteam é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Oneteam.
...
Para configurar e testar o SSO do Azure AD com o Oneteam, você precisa concluir os seguintes blocos de construção:
...
Nesta seção, você habilitará o SSO do Azure AD no Portal Clássico e configurará o logon único em seu aplicativo Oneteam.
...
3. Na página de diálogo **Definir Configurações de Aplicativo**, se quiser configurar o aplicativo no **modo iniciado pelo IDP**, execute as seguintes etapas e clique em **Avançar**:
    ...
    ![Configurar o logon único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_03.png)
  1. Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão: `https://api.one-team.io/teams/<team name>/auth/saml/issuer`.
  2. Na caixa de texto **URL de resposta**, digite uma URL no seguinte padrão: `https://api.one-team.io/teams/<team name>/auth/saml/callback`.
  3. Clique em **Próximo**.
...
4. Se quiser configurar o aplicativo no **modo iniciado pelo SP**, na página de diálogo **Definir Configurações do Aplicativo**, clique em **"Mostrar configurações avançadas (opcional)"**, insira a **URL de Logon** e clique em **Avançar**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_04.png)
  1. Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<team name>.one-team.io/`.
  2. Clique em **Próximo**.
...
### <a name="create-a-oneteam-test-user"></a>Criar um usuário de teste do Oneteam
