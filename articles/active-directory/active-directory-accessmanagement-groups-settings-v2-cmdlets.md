...
Instruções adicionais do gerente de programa da Microsoft, Rob de Jong, estão disponíveis no [Rob's Groups Blog](http://robsgroupsblog.com/blog/configuring-settings-for-office-365-groups-in-azure-ad).
