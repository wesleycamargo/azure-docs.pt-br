<properties
	pageTitle="Adicionar ou alterar informações de trabalho de um usuário na visualização do Azure Active Directory | Microsoft Azure"
...
# Adicionar ou alterar informações de trabalho de um usuário na visualização do Azure Active Directory

Este artigo explica como adicionar ou alterar informações de trabalho, como números de telefone ou um nome de departamento, para um usuário na visualização do Azure AD (Azure Active Directory). [O que há na visualização?](active-directory-preview-explainer.md) Para saber mais sobre como adicionar novos usuários à sua organização, confira [Add new users to Azure Active Directory](active-directory-users-create-external-azure-portal.md) (Adicionar novos usuários ao Azure Active Directory).

## Como alterar informações de trabalho
...
3.  Na folha **Usuários e grupos**, escolha **Usuários**.
    ...
    ![Abrindo a folha Usuários](./media/active-directory-users-work-info-azure-portal/create-users-oppt-BRers-blade.png)
...
6. Adicione ou altere as informações de trabalho e, em seguida, na barra de comandos, escolha **Salvar**.
