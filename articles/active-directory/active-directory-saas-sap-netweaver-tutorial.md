<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao SAP NetWeaver | Microsoft Azure"
...
3. Na página de diálogo **Definir Configurações de Aplicativo**, execute as seguintes etapas:
	...
	> [AZURE.NOTE] Você poderá localizar todos esses valores no documento de Metadados de Federação fornecido por seu parceiro do SAP NetWeaver.
...
6.  Na página de diálogo **Perfil do Usuário**, execute as seguintes etapas: ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-sap-netweaver-tutorial/create_aaduser_06.png)
