...
O objetivo desse tutorial é mostrar como integrar o Small Improvements ao Azure AD (Azure Active Directory).  
...
* Você pode permitir que os usuários façam logon automaticamente no Small Improvements usando SSO (logon único) com suas contas do Azure AD
...
* Uma assinatura do Small Improvements habilitada para SSO
...
7. No painel de resultados, selecione **Small Improvements** e clique em **Concluir** para adicionar o aplicativo.
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Azure AD com o Small Improvements com base em um usuário de teste chamado "Brenda Fernandes".

Para que o SSO funcione, o Azure AD precisa saber qual usuário do Small Improvements é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Small Improvements.  

Essa relação de vínculo é estabelecida atribuindo o valor do **nome de usuário** ao Azure AD como o valor do **Nome de usuário** no Small Improvements.

Para configurar e testar o SSO do Azure AD com o Small Improvements, você precisará concluir os seguintes blocos de construção:
...
3. **[Criar um usuário de teste para Small Improvements](#creating-a-small-improvements-test-user)** : para ter um equivalente de Brenda Fernandes no Small Improvements que esteja vinculado à representação dela no Azure AD.
...
O objetivo desta seção é habilitar o SSO do Azure AD no Portal Clássico do Azure e configurar o SSO em seu aplicativo Small Improvements.

**Para configurar o SSO do Azure AD com o Small Improvements, execute as seguintes etapas:**

1. No portal clássico do Azure, na página de integração de aplicativos do **Small Improvements**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
   
    ![Configurar Logon Único][6] 
2. Na página **Como você deseja que os usuários façam logon no Small Improvements**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
   
    ![Configurar Logon Único](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_03.png) 
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_04.png) 
   
     >[!NOTE]
     >Entre em contato com a equipe do Small Improvements no endereço [Support@small-improvements.com](mailto:support@small-improvements.com) para configurar um nome de domínio para sua conta. Isso é necessário para o SSO funcionar.
     >  

  1. Na caixa de texto **URL de Entrada**, digite a URL usada pelos usuários para se conectar ao aplicativo Small Improvements.  
  2. Clique em **Próximo**.
4. Na página **Configurar logon único no Small Improvements** , execute as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_05.png) 
 1. Clique em **Baixar certificado**e salve o arquivo em seu computador.  
 2. Clique em **Próximo**.
2. Em outra janela do navegador, entre em seu site de empresa do Small Improvements como administrador.
3. Na página do painel principal, clique no botão **Administração** à esquerda.
   
    ![Configurar Logon Único](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_06.png) 
4. Clique no botão **SSO de SAML** na seção **Integrações**.
...
5. Na página Instalação do SSO, execute as seguintes etapas:
 ...
 1. No portal clássico do Azure, na página da caixa de diálogo **Configurar logon único no Small Improvements**, copie o valor da **URL de SSO de SAML** e cole-o na caixa de texto **Ponto de Extremidade HTTP**.  
 2. Abra seu certificado baixado no Bloco de Notas, copie o conteúdo e cole-o na caixa de texto **Certificado x509** . 
 3. Se você quiser disponibilizar a opção de autenticação de formulário SSO e Logon para os usuários, marque a opção **Habilitar o acesso por meio de logon/senha também** .  
 4. Insira o valor apropriado para o botão Nomear o Login SSO na caixa de texto **Prompt de SAML** .  
 5. Clique em **Salvar**.
...
### <a name="create-a-small-improvements-test-user"></a>Criar um usuário de teste para o Small Improvements
O objetivo desta seção é criar um usuário chamado Brenda Fernandes no Small Improvements.

Você já habilitou isso em [Configurar o logon único do AD do Azure](#configuring-azure-ad-single-single-sign-on).
...
5. Digite o **Nome**, **Sobrenome** e **Endereço de Email** de um usuário válido que você deseja provisionar nas caixas de texto relacionadas. 
...
6. Você também pode optar por inserir a mensagem pessoal na caixa **Enviar email de notificação** . Se você não quiser enviar a notificação, desmarque essa caixa de seleção.
7. Clique em **Criar Usuários**.

### <a name="assign-the-azure-ad-test-user"></a>Atribuir o usuário de teste do Azure AD
O objetivo desta seção é permitir que Brenda Fernandes use o SSO do Azure, concedendo a ela acesso ao Small Improvements.
...
2. Na lista de aplicativos, selecione **Small Improvements**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_50.png) 
