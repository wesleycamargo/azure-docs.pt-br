---
title: 'Tutorial: integração do Active Directory do Azure com o SilkRoad Life Suite | Microsoft Docs'
...
6. Na página **Configurar logon único no SilkRoad Life Suite**, execute as seguintes etapas:
    ...
    b. Clique em **Avançar**.
7. Em seu aplicativo **SilkRoad**, clique em **Fontes de Autenticação**.
