...
4. Na caixa de pesquisa, digite **SpaceIQ**, selecione **SpaceIQ** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criar um usuário de teste do SpaceIQ](#create-a-spaceiq-test-user)** – para ter um equivalente de Brenda Fernandes no SpaceIQ que esteja vinculado à representação de usuário no Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_samlbase.png)

3. Na seção **URLs e Domínio do SpaceIQ**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do SpaceIQ](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **(Certificado Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-spaceiq-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do SpaceIQ**, clique em **Configurar o SpaceIQ** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML** da **seção Referência Rápida.**

    ![Configuração do SpaceIQ](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_configure.png) 

7.  Abra uma nova janela do navegador e conecte-se ao ambiente do SpaceIQ como administrador.

8. Depois que estiver conectado, clique no sinal de quebra-cabeça no canto superior direito e clique em **"Integrações"**

    ![Configurações da conta](./media/active-directory-saas-spaceiq-tutorial/setting1.png) 

9. Em **TODOS OS PROVISIONAMENTOS E SSO**, clique no bloco **Azure** para adicionar uma instância do Azure como IDP.

    ![Ícone SAML](./media/active-directory-saas-spaceiq-tutorial/setting2.png)

10. Na caixa de diálogo **SSO**, execute as seguintes etapas:

    ![Configurações de Autenticação SAML](./media/active-directory-saas-spaceiq-tutorial/setting3.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **SpaceIQ**.
    ...
    ![O link do SpaceIQ na lista Aplicativos](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_app.png)  
