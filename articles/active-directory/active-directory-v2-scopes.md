---
title: Escopos, permissões e consentimento do Azure AD v2.0 | Microsoft Docs
...
---
# <a name="scopes,-permissions,-&-consent-in-the-v2.0-endpoint"></a>Escopos, permissões e consentimento no ponto de extremidade v2.0
...
## <a name="scopes-&-permissions"></a>Escopos e permissões
...
| redirect_uri |obrigatório |O redirect_uri onde você deseja que a resposta seja enviada para ser tratada pelo aplicativo.  Ele deve corresponder exatamente a um dos redirect_uris que você registrou no portal. |
