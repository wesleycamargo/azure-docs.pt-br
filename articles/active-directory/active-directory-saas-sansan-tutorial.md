...
* Você pode permitir que seus usuários entrem automaticamente no SanSan usando SSO (logon único) com suas contas do Azure AD
...
* Uma assinatura do SanSan habilitada para SSO (logon único)
...
## <a name="add-sansan-from-the-gallery"></a>Adicionar o SanSan da galeria
...
## <a name="configure-and-test-microsoft-azure-ad-single-sign-on"></a>Configurar e testar o SSO (logon único) do Microsoft Azure AD
Nesta seção, você configurará e testará o SSO do Microsoft Azure AD com o SanSan com base em um usuário de teste chamado “Brenda Fernandes”.

Para que o SSO funcione, o Azure AD precisa saber qual usuário do SanSan é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do SanSan.
...
Para configurar e testar o SSO (logon único) do Microsoft Azure AD com o SanSan, você precisará concluir os seguintes blocos de construção:
...
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
  ...
  1. Na caixa de texto **URL de Logon** , digite a URL no seguinte padrão:
...
### <a name="create-an-sansan-test-user"></a>Criar um usuário de teste do SanSan
...
Nesta seção, você testará sua configuração de SSO do Microsoft Azure AD usando o Painel de Acesso.
