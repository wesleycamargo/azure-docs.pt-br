...
1. Consulte um dos guias de início rápido de VM do Azure a seguir, concluindo apenas as seções necessárias ("Fazer logon no Azure", "Criar o grupo de recursos", "Criar grupo de rede", "Criar a máquina virtual"). 
   ...
   - [Crie uma Máquina Virtual do Windows usando o PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md)
   - [Crie uma Máquina Virtual do Linux usando o PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md)
...
- Para os guias de início rápido completos sobre VM do Azure, consulte:
  ...
  - [Crie uma máquina virtual Windows com o PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md) 
  - [Crie uma máquina virtual Linux com o PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md) 
