...
6. Clique na função que você deseja ativar.
7. Clique em **Ativar**. A folha **Solicitar ativação de função** será exibida.
8. Insira o motivo para a solicitação de ativação no campo de texto.
