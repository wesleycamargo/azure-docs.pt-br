...
title: Exemplos do PowerShell para licenciamento baseado em grupo no Azure AD | Microsoft Docs
...
Este script executa as funções de cada usuário no locatário, usando a ID do SKU como entrada:
```
