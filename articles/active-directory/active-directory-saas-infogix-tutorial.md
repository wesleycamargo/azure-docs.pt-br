...
4. Na caixa de pesquisa, digite **Infogix Data3Sixty Govern**, selecione **Infogix Data3Sixty Govern** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Infogix Data3Sixty Govern na lista de resultados](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_addfromgallery.png)
...
3. **[Criar um usuário de teste do Infogix Data3Sixty Govern](#create-an-infogix-data3sixty-govern-test-user)** – para ter um equivalente de Brenda Fernandes no Infogix Data3Sixty Govern vinculado à representação do usuário no Microsoft Azure Active Directory.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_samlbase.png)

3. Na seção **Domínio e URLs do Infogix Data3Sixty Govern**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único em Domínio e URLs do Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_url.png)
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_url1.png)
...
5. O aplicativo Infogix Data3Sixty Govern espera que as declarações SAML estejam em um formato específico. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção **Atributos de Usuário** na página de integração de aplicativos. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar logon único attb](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_attribute.png)
...
6. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar logon único Add](./media/active-directory-saas-infogix-tutorial/tutorial_attribute_04.png)

    ![Configurar logon único Addattb](./media/active-directory-saas-infogix-tutorial/tutorial_attribute_05.png)
...
7. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Bruto)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_certificate.png)

8. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-infogix-tutorial/tutorial_general_400.png)
    
9. Na seção **Infogix Data3Sixty Govern**, clique em **Configurar Infogix Data3Sixty Govern** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_configure.png) 

10. Para configurar o logon único no lado do **Infogix Data3Sixty Govern**, é necessário enviar **o Certificado (bruto) baixado, a URL de Saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** para a [equipe de suporte do Infogix Data3Sixty Govern](mailto:data3sixtysupport@infogix.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-infogix-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-infogix-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-infogix-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-infogix-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Infogix Data3Sixty Govern**.
    ...
    ![O link do Infogix Data3Sixty Govern na lista de aplicativos](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_app.png)  
