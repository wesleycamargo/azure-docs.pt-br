...
### Link direto para a folha de Auditoria de Usuário
...
### Funções de Diretório podem ler relatórios
...
## Como exibir relatórios de gerenciamento de senhas no portal clássico
...
## Exibir atividade de registro de redefinição de senha no portal clássico
