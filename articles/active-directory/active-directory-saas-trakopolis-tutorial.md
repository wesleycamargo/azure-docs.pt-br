...
O objetivo desse tutorial é mostrar como integrar o Trakopolis ao Azure Active Directory (Azure AD). A integração do Trakopolis ao Azure AD oferece os seguintes benefícios:
...
3. **[Criação de um usuário de teste do Trakopolis](#creating-a-trakopolis-test-user)** – para ter um equivalente de Brenda Fernandes no Trakopolis que esteja vinculado à representação dela no Azure AD.
...
1. Na página **Configurar logon único no Trakopolis**, execute as seguintes etapas:
    ...
    b. Clique em **Avançar**.
2. Para configurar o SSO para seu aplicativo, entre em contato com a equipe de suporte do Trakopolis pelo email [support@cantelematics.com](mailto:support@cantelematics.com), anexe o certificado baixado e forneça a eles a **URL do Emissor**, a **URL de SSO SAML** e a **URL de Saída**.
...
O objetivo desta seção é criar um usuário chamado Brenda Fernandes no Trakopolis. Trabalhe com a equipe de suporte do Trakopolis para adicionar os usuários ao Trakopolis.
...
O objetivo desta seção é testar sua configuração de logon único do Azure AD usando o Painel de Acesso. Quando você clicar no bloco Trakopolis no Painel de Acesso, deverá fazer logon automaticamente no seu aplicativo Trakopolis.
