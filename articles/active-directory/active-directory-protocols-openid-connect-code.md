...
| scope | obrigatório | Uma lista de escopos separados por espaços. Para o OpenID Connect, ela deve incluir o escopo `openid`, que é traduzido para a permissão "Conectar" na interface de usuário de consentimento. Você também pode incluir outros escopos nesta solicitação para solicitar o consentimento. |
