...
- Você pode permitir que seus usuários façam logon automaticamente no MobileIron (Logon Único) com as respectivas contas do Azure AD.
...
- Uma assinatura habilitada para logon único do MobileIron
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do MobileIron é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado em MobileIron.

No MobileIron, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
3. **[Criar um usuário de teste do MobileIron](#create-a-mobileiron-test-user)** – para ter um equivalente de Brenda Fernandes no MobileIron que esteja vinculado à representação de usuário no Azure AD.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no portal do Azure e configura o logon único no aplicativo MobileIron.

**Para configurar o logon único do Azure AD com o MobileIron, execute as seguintes etapas:**

1. No Portal do Azure, na página de integração de aplicativos do **MobileIron**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_samlbase.png)

3. Na seção **Domínio e URLs do MobileIron**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único em Domínio e URLs do MobileIron](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_url.png)
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Logon único em Domínio e URLs do MobileIron](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_url1.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_certificate.png) 

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/active-directory-saas-mobileiron-tutorial/tutorial_general_400.png)

7. Em outra janela do navegador da Web, faça logon em seu site de empresa do MobileIron como administrador.

8. Vá para **Admin** > **Identidade**.

   * Selecione a opção **AAD** no campo **Informações sobre a Configuração de IDP de Nuvem**.

    ![Botão Configurar administrador de logon único](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_admin.png)

9. Copie os valores de **Chave** e **Host** e cole-os para concluir as URLs na seção **Domínio e URLs do MobileIron** no portal do Azure.

    ![Botão Configurar administrador de logon único](./media/active-directory-saas-mobileiron-tutorial/key.png)

10. Em **Exportar arquivo de metadados do AAD e importar para o Campo de Nuvem MobileIron**, clique **Escolher Arquivo** para carregar os metadados baixados do portal do Azure. Clique em **Concluído** depois de carregar.
 
    ![Botão Configurar metadados do administrador de Logon Único](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_adminmetadata.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-mobileiron-tutorial/create_aaduser_04.png)
...
2. Vá para **Usuários** e clique em **Adicionar** > **Usuário Único**.
    ...
    ![Botão Configurar usuário do Logon Único](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_user.png)

3. Na página do diálogo **“Usuário Único”**, execute as seguintes etapas:

    ![Botão Configurar adicionar usuário de Logon Único](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_useradd.png)
...
2. Na lista de aplicativos, selecione **MobileIron**.
    ...
    ![O link do MobileIron na lista de Aplicativos](./media/active-directory-saas-mobileiron-tutorial/tutorial_mobileiron_app.png)  
