---
title: 'Tutorial: Integração do Active Directory do Azure com o Workday | Microsoft Docs'
...
3. Na página **Configurar URL do Aplicativo**, realize as etapas a seguir e clique em **Avançar**.
   ...
   > [!NOTE]
   > Sua URL de resposta deve ter um subdomínio (por exemplo: www, wd2, wd3, wd3-impl, wd5, wd5-impl). Usar algo como "*http://www.myworkday.com*" funciona, mas "*http://myworkday.com*", não.
   > 
   > 
