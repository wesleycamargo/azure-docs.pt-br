...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_samlbase.png)

3. Na seção **URLs e Domínio do Jobbadmin**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-jobbadmin-tutorial/tutorial_general_400.png)
...
2. Na lista de aplicativos, selecione **Jobbadmin**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-jobbadmin-tutorial/tutorial_jobbadmin_app.png) 
