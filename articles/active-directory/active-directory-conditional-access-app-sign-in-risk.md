...
- **Proteção de identidade** -o cenário neste início rápido requer a proteção de identidade a ser habilitado. Se você não sabe como habilitar a proteção de identidade, confira [Habilitando o Azure Active Directory Identity Protection](active-directory-identityprotection-enable.md).

- **Tor Browser** - o [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) foi projetado para ajudá-lo a preservar sua privacidade online. Identity Protection detecta uma entrada de um Tor Browser como **entradas de endereços IP anônimos**, que tem um nível de risco médio. Para saber mais, veja [Eventos de risco do Azure Active Directory](active-directory-reporting-risk-events.md).  
...
5. Na página **Novo**, na caixa de texto **nome**, digite **bloquear o acesso de nível de risco médio**.

    ![NOME](./media/active-directory-conditional-access-app-sign-in-risk/104.png)

6. Na seção **Atribuição**, clique em **Usuários e Grupos**.

    ![Usuários e grupos](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Na página **Usuários e grupos**:
    ...
    c. Na página **Selecionar**, selecione **Alain Charon** e, em seguida, clique em **Selecionar**.

    d. Na página **Usuários e grupos**, clique em **Concluído**.

8. Clique em **Aplicativos de nuvem**.

    ![Aplicativos na nuvem](./media/active-directory-conditional-access-app-sign-in-risk/08.png)

9. Na página de **aplicativos de nuvem**:
...
10. Na seção **Controles de acesso**, clique em **Conceder**.
    ...
    ![Controles de acesso](./media/active-directory-conditional-access-app-sign-in-risk/10.png)
...
12. Na seção **Habilitar política**, clique em **Ativar**.
    ...
    ![Habilitar política](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Usuário](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Clique em **usuário**, selecione **Alan Charon** sobre o **usuários** página e, em seguida, clique em **selecione**.

    ![Usuário](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Em **Logue risco**, selecione **Médio**.

    ![Usuário](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
![Autenticação multifator](./media/active-directory-conditional-access-app-sign-in-risk/118.png)
...
- Para excluir sua política, selecione-a e clique em **Excluir** na barra de ferramentas de acesso rápido.
    ...
    ![Autenticação multifator](./media/active-directory-conditional-access-app-sign-in-risk/33.png)
...
> [exigir MFA para aplicativos específicos](./active-directory-conditional-access-app-based-mfa.md)
