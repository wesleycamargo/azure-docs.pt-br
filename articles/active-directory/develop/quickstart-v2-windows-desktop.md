...
1. Edite **App.Xaml.cs** e substitua a linha que começa com `private static string ClientId` pelo valor da **ID do aplicativo (cliente)** que você acabou de registrar:
