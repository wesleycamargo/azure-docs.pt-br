---
title: Tipos de aplicativos para a v2.0 | Azure
...
Para obter detalhes, saiba como [registrar um aplicativo](quickstart-v2-register-an-app.md).
...
Para ver esse cenário em ação, experimente um destes exemplos de código de aplicativo de página única na seção de [Introdução à v.2.0](v2-overview.md#getting-started).
...
![Fluxo de autenticação do aplicativo Web](./media/v2-app-types/convergence_scenarios_webapp.png)
...
Para ver esse cenário em ação, experimente um destes exemplos de código de conexão de aplicativo Web na seção [Introdução à v2.0](v2-overview.md#getting-started).
...
![Fluxo de autenticação do aplicativo nativo](./media/v2-app-types/convergence_scenarios_native.png)
