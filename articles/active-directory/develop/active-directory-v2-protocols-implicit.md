...
Para obter mais informações sobre as declarações presentes no token de acesso, consulte a [referência de token de ponto de extremidade v2.0](active-directory-v2-tokens.md)
