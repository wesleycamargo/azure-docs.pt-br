...
- Provisionar seu aplicativo usando o portal herdado para o Azure AD (Azure Active Directory). Para obter mais informações, consulte [registrar um aplicativo](quickstart-register-app.md)
