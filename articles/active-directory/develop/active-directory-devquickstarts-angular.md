...
7. A adal.js usa o fluxo de OAuth implícito para se comunicar com o AD do Azure.  Você deve habilitar o fluxo implícito para seu aplicativo:
  * Clique no aplicativo e escolha **Manifesto** para abrir o editor de manifesto embutido.
  * Localize a propriedade `oauth2AllowImplicitFlow`. Defina seu valor como `true`.
  * Clique em **Salvar** para salvar o manifesto.
