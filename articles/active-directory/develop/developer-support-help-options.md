...
| [Analisador do código de erro](https://apps.dev.microsoft.com/portal/tools/errors)| Cole um código de erro recebido durante a conexão ou páginas de consentimento para ver as possíveis causas e resoluções. |
