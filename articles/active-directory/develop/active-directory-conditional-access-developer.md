...
O Azure Active Directory (Azure AD) oferece várias maneiras de proteger seu aplicativo e um serviço. Um desses recursos exclusivos é o acesso condicional. O acesso condicional permite que desenvolvedores e clientes corporativos protejam serviços de diversas maneiras, incluindo:
