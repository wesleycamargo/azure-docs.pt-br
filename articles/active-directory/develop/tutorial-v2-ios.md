---
title: Introdução ao iOS no Azure AD v2.0 | Microsoft Docs
description: Como aplicativos iOS (Swift) podem chamar uma API que exige tokens de acesso pelo ponto de extremidade do Azure Active Directory v2.0
