...
[Introdução à escrita de código](azure-ad-developers-guide.md#get-started).

[Conectar usuários usando o AD do Azure](authentication-scenarios.md)
