...
description: Como os aplicativos da UWP (Plataforma Universal do Windows) podem chamar uma API que exige tokens de acesso pelo ponto de extremidade do Azure Active Directory v2
