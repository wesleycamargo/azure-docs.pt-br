...
5.  Na seção **implantar e gerenciar** , siga as etapas 1 a 3 para integrar o Azure Active Directory ao diretório local.
  ...
  2.    Instalar e executar o Azure AD Connect: instale o Azure AD Connect usando as instruções a seguir, [Instalação personalizada do Azure AD Connect](./aad-connect/active-directory-aadconnect-get-started-custom.md).
