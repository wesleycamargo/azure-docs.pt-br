...
> [!TIP]
> Se usar o Azure AD Connect é uma opção para você, consulte [Selecionar o cenário](hybrid-azuread-join-plan.md#select-your-scenario). Usando o Azure AD Connect, é possível simplificar a configuração de ingresso no Azure AD híbrido.
...
![Lista de domínios da empresa](./media/hybrid-azuread-join-manual-steps/01.png)
...
![O botão Tudo que permite que os usuários registrem dispositivos](./media/hybrid-azuread-join-manual-steps/23.png)
