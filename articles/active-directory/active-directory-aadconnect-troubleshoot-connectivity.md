...
| **. verisign.com | HTTP/80 | Usada para baixar as listas CRL. | | *. windows.net | HTTPS/443 | Usada para fazer logon no AD do Azure. | | *. microsoftonline.com | HTTPS/443 | Usada para configurar o diretório do AD do Azure e importar/exportar dados. |
