...
1. Na caixa de pesquisa, digite **Encompass**, selecione **Encompass** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Encompass](#create-a-encompass-test-user)** – para ter um equivalente de Brenda Fernandes no Encompass vinculado à representação do usuário no Azure AD.
...
1. Na seção **URLs e Domínio do Encompass**, execute as seguintes etapas:
...
1. Na seção **Configuração do Encompass**, clique em **Configurar Encompass** para abrir a janela **Configurar logon**. Copie a **URL de Saída e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**
...
1. Na lista de aplicativos, escolha **Encompass**.
