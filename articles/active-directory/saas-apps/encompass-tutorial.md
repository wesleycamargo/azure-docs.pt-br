...
- Você pode permitir que os usuários façam logon automaticamente no Encompass (Logon Único) com suas contas do Azure AD.
...
- Uma assinatura habilitada para logon único do Encompass
...
4. Na caixa de pesquisa, digite **Encompass**, selecione **Encompass** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Encompass na lista de resultados](./media/encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do Encompass é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Encompass.

No Encompass, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
3. **[Criar um usuário de teste do Encompass](#create-a-encompass-test-user)** – para ter um equivalente de Brenda Fernandes no Encompass vinculado à representação do usuário no Azure AD.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no Portal do Azure e configura o logon único no aplicativo Encompass.

**Para configurar o logon único do Azure AD com o Encompass, execute as seguintes etapas:**

1. No portal do Azure, na página de integração do aplicativos **Encompass**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/encompass-tutorial/tutorial_encompass_samlbase.png)

3. Na seção **URLs e Domínio do Encompass**, execute as seguintes etapas:
...
4. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/encompass-tutorial/tutorial_general_400.png)

6. Na seção **Configuração do Encompass**, clique em **Configurar Encompass** para abrir a janela **Configurar logon**. Copie a **URL de Saída e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**

    ![Configuração do Encompass](./media/encompass-tutorial/tutorial_encompass_configure.png) 

7. Para configurar o logon único no lado do **Encompass**, é necessário enviar o **Certificado (Base64) baixado, URL de Saída e URL do Serviço de Logon Único SAML** para a [equipe de suporte do Encompass](http://www.voxmobile.com/contact/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/encompass-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/encompass-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/encompass-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/encompass-tutorial/create_aaduser_04.png)
...
**Para atribuir Brenda Fernandes ao Encompass, execute as seguintes etapas:**
...
2. Na lista de aplicativos, escolha **Encompass**.
    ...
    ![O link do Encompass na lista Aplicativos](./media/encompass-tutorial/tutorial_encompass_app.png)  
