...
1. Na caixa de pesquisa, digite **Greenhouse**, selecione **Greenhouse** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Greenhouse](#create-a-greenhouse-test-user)** – para ter um equivalente de Brenda Fernandes no Greenhouse que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

1. Na seção **Domínio e URLs do Greenhouse**, realize as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do Greenhouse](./media/greenhouse-tutorial/tutorial_greenhouse_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/greenhouse-tutorial/tutorial_greenhouse_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/greenhouse-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Greenhouse**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Greenhouse](https://www.greenhouse.io/contact).
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/greenhouse-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/greenhouse-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/greenhouse-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/greenhouse-tutorial/create_aaduser_04.png)
...
1. No menu na parte superior, clique em **Configurar**, em seguida, clique em **Usuários**.
   
   ![Usuários](./media/greenhouse-tutorial/ic790791.png "Usuários")

1. Clique em **Novos Usuários**.
...
1. Na lista de aplicativos, selecione **Greenhouse**.
    ...
    ![O link do Greenhouse na lista de Aplicativos](./media/greenhouse-tutorial/tutorial_greenhouse_app.png)  
