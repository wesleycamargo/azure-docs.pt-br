...
1. Na caixa de pesquisa, digite **Proofpoint on Demand**, selecione **Proofpoint on Demand** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Proofpoint on Demand na lista de resultados](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)
...
No Proofpoint on Demand, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
1. **[Criar um usuário de teste do Proofpoint on Demand](#create-a-proofpoint-on-demand-test-user)**: para ter um equivalente de Brenda Fernandes no Proofpoint on Demand que seja vinculado à representação no Azure AD do usuário.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_samlbase.png)

1. Na seção **URLs e Domínio do Proofpoint on Demand**, execute as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do Proofpoint on Demand](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com o Identificador real, a URL de Resposta e a URL de Entrada. Contate a [equipe de suporte do cliente Proofpoint on Demand](https://www.proofpoint.com/us/support-services) para obter esses valores.
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/proofpoint-ondemand-tutorial/tutorial_general_400.png)
    
1. Na seção **Configuração do Proofpoint on Demand**, clique em **Configurar Proofpoint on Demand** para abrir a janela **Configurar Logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Proofpoint on Demand](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_configure.png) 

1. Para configurar o logon único no lado do **Proofpoint on Demand**, é necessário enviar o **Certificado (Base64)** baixado, a **URL de Saída, ID da Entidade do SAML e a URL do Serviço de Logon Único do SAML** para a [equipe de suporte do Proofpoint on Demand](https://www.proofpoint.com/us/support-services). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/proofpoint-ondemand-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/proofpoint-ondemand-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/proofpoint-ondemand-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/proofpoint-ondemand-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Proofpoint on Demand**.
    ...
    ![O link do Proofpoint on Demand na lista Aplicativos](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
