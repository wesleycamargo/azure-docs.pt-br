...
1. Na caixa de pesquisa, digite **Evidence.com**, selecione **Evidence.com** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Evidence.com](#create-a-evidencecom-test-user)** – para ter um equivalente de Brenda Fernandes no Evidence.com vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/evidence-tutorial/tutorial_evidence.com_samlbase.png)

1. Na seção **Domínio e URLs do Evidence.com**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Evidence.com](./media/evidence-tutorial/tutorial_evidence.com_url.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/evidence-tutorial/tutorial_evidence.com_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/evidence-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Evidence.com**, clique em **Configurar o Evidence.com** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Evidence.com](./media/evidence-tutorial/tutorial_evidence.com_configure.png) 
...
1. Clique em **Logon Único de Agência**

1. Escolha **Logon Único Baseado em SAML**

1. Copie os valores de **ID da Entidade do SAML**, **URL do Serviço de Logon Único do SAML** e **URL de Saída** mostrados no Portal do Azure para os campos correspondentes no Evidence.com.

1. Abra o arquivo de Certificado (Base64) baixado no bloco de notas, copie o conteúdo dele para a área de transferência e, depois, cole-o na caixa **Certificado de Segurança**. 

1. Salve a configuração no Evidence.com.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/evidence-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/evidence-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/evidence-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/evidence-tutorial/create_aaduser_04.png)
...
1. Navegue até a guia **Administrador** .
...
1. Na lista de aplicativos, selecione **Evidence.com**.
    ...
    ![O link do Evidence.com na lista de Aplicativos](./media/evidence-tutorial/tutorial_evidence.com_app.png)  
