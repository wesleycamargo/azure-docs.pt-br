...
- Você pode habilitar seus usuários a fazerem logon automaticamente no Skills Base (Logon Único) usando suas contas do Azure AD.
...
4. Na caixa de pesquisa, digite **Skills Base**, selecione **Skills Base** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Skills Base na lista de resultados](./media/skillsbase-tutorial/tutorial_skillsbase_addfromgallery.png)
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do Skills Base é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Skills Base.
...
3. **[Criar um usuário de teste do Skills Base](#create-a-skills-base-test-user)** – para ter um equivalente de Brenda Fernandes no Skills Base que esteja vinculado à representação do usuário do Azure AD.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no portal do Azure e configura o logon único no aplicativo Skills Base.

**Para configurar o logon único do Azure AD com o Skills Base, execute as seguintes etapas:**

1. No portal do Azure, na página de integração do aplicativo **Skills Base**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/skillsbase-tutorial/tutorial_skillsbase_samlbase.png)

3. Na seção **Domínio e URLs do Skills Base**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Skills Base](./media/skillsbase-tutorial/tutorial_skillsbase_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/skillsbase-tutorial/tutorial_skillsbase_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/skillsbase-tutorial/tutorial_general_400.png)

6. Em uma janela diferente do navegador da Web, faça logon no Skills Base como Administrador de Segurança.

7. No lado esquerdo do menu, em **ADMIN**, clique em **Autenticação**.

    ![O administrador](./media/skillsbase-tutorial/tutorial_skillsbase_auth.png)

8. Na página **Autenticação**, selecione Logon Único como **SAML 2**.

    ![Único](./media/skillsbase-tutorial/tutorial_skillsbase_single.png)

9. Na página **Autenticação**, execute as seguintes etapas:
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/skillsbase-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/skillsbase-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/skillsbase-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/skillsbase-tutorial/create_aaduser_04.png)
...
### <a name="create-a-skills-base-test-user"></a>Crie um usuário de teste do Skills Base
...
**Para atribuir Brenda Fernandes ao Skills Base, realize as seguintes etapas:**
...
2. Na lista de aplicativos, selecione **Skills Base**.
    ...
    ![O link do Skills Base na lista de Aplicativos](./media/skillsbase-tutorial/tutorial_skillsbase_app.png)  
