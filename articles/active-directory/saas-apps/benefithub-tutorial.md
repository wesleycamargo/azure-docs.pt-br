...
* Você pode permitir que seus usuários entrem automaticamente no BenefitHub (Logon Único) usando suas contas do Azure AD.
...
* Assinatura do BenefitHub habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O BenefitHub é compatível com o SSO iniciado por **IDP**
...
4. Na caixa de pesquisa, digite **BenefitHub**, selecione **BenefitHub** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do BenefitHub.
...
2. **[Configurar o Logon Único do BenefitHub](#configure-benefithub-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do BenefitHub](#create-benefithub-test-user)** – para ter um equivalente de Brenda Fernandes no BenefitHub que esteja vinculado à representação de usuário do Azure AD.
...
Para configurar o logon único do Azure AD com o BenefitHub, execute as seguintes etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **BenefitHub**, selecione **Logon único**.
...
8. Na seção **Configurar o BenefitHub**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-benefithub-single-sign-on"></a>Configurar o logon único do BenefitHub

Para configurar o logon único no lado do **BenefitHub**, é necessário enviar o **XML de metadados de federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do BenefitHub](https://www.benefithub.com/Home/ContactUs). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **BenefitHub**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **BenefitHub**.

    ![O link do BenefitHub na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-benefithub-test-user"></a>Criar um usuário de teste do BenefitHub
...
Ao clicar no bloco do BenefitHub no Painel de Acesso, você deve ser conectado automaticamente ao BenefitHub para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
