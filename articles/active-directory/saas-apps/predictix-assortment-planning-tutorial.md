...
1. Para configurar o logon único no lado do **Predictix Assortment Planning**, é necessário enviar o **Certificado (Base64)** baixado, a **ID da Entidade SAML** e a **URL do Serviço de Logon Único do SAML** e a **URL de Logoff** da [equipe de suporte do Predictix Assortment Planning](http://www.infor.com/support). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
