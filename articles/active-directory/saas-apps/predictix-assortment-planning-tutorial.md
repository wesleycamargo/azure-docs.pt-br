...
* Você pode permitir que seus usuários sejam automaticamente conectados ao Predictix Assortment Planning (Logon Único) usando logon único com suas contas do Azure AD.
...
* Uma assinatura do Azure AD. Se não tiver um ambiente do Azure AD, você poderá criar uma [conta gratuita](https://azure.microsoft.com/pricing/free-trial/).
* Assinatura habilitada do Predictix Assortment Planning com logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Predictix Assortment Planning é compatível com SSO iniciado por **SP**
...
4. Na caixa de pesquisa, digite **Predictix Assortment Planning**, selecione **Predictix Assortment Planning** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
     ...
     ![Predictix Assortment Planning na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Predictix Assortment Planning precisa ser estabelecido.
...
2. **[Configurar o logon único do Predictix Assortment Planning](#configure-predictix-assortment-planning-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do Predictix Assortment Planning](#create-predictix-assortment-planning-test-user)** – para ter um equivalente de Brenda Fernandes no Predictix Assortment Planning que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **Predictix Assortment Planning**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Predictix Assortment Planning](common/sp-identifier.png)
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Entre em contato com a [equipe de suporte ao cliente do Predictix Assortment Planning](https://www.infor.com/support) para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.

5. Na página **Configurar logon único com SAML**, na seção **Certificado de Autenticação SAML**, clique em **Fazer o download** para fazer o download do **Certificado (Base64)** usando as opções fornecidas de acordo com seus requisitos e salve-o no computador.

    ![O link de download do Certificado](common/certificatebase64.png)

6. Na seção **Configurar Predictix Assortment Planning**, copie a URL apropriada de acordo com suas necessidades.
...
Para configurar o logon único no lado do **Predictix Assortment Planning**, é necessário enviar o **Certificado (Base64)** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Predictix Assortment Planning](https://www.infor.com/support). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
2. Na lista de aplicativos, selecione **Predictix Assortment Planning**.
    ...
    ![O link do Predictix Assortment Planning na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-predictix-assortment-planning-test-user"></a>Criar usuário de teste do Predictix Assortment Planning

Nesta seção, você criará um usuário chamado Brenda Fernandes no Predictix Assortment Planning. Trabalhe com a  [equipe de suporte do Predictix Assortment Planning](https://www.infor.com/support) para adicionar os usuários à plataforma Predictix Assortment Planning. Os usuários devem ser criados e ativados antes de usar o logon único.
...
Quando você clica no bloco Predictix Assortment Planning no Painel de Acesso, deverá ser conectado automaticamente ao Predictix Assortment Planning para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
