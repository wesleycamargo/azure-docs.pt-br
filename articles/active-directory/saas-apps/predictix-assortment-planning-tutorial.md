...
1. Na caixa de pesquisa, digite **Predictix Assortment Planning**, selecione **Predictix Assortment Planning** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Predictix Assortment Planning na lista de resultados](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_addfromgallery.png)
...
1. **[Criar um usuário de teste do Predictix Assortment Planning](#create-a-predictix-assortment-planning-test-user)** – para ter um equivalente de Brenda Fernandes no Predictix Assortment Planning que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_samlbase.png)

1. Na seção **Domínio e URLs do Predictix Assortment Planning**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Predictix Assortment Planning](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_url.png)
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Entre em contato com a [equipe de suporte ao cliente do Predictix Assortment Planning](https://www.infor.com/support) para obter esses valores. 
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/predictix-assortment-planning-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Predictix Assortment Planning**, clique em **Configurar Predictix Assortment Planning** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Predictix Assortment Planning](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_configure.png) 

1. Para configurar o logon único no lado do **Predictix Assortment Planning**, é necessário enviar o **Certificado (Base64)** baixado, a **ID da Entidade SAML** e a **URL do Serviço de Logon Único do SAML** e a **URL de Logoff** da [equipe de suporte do Predictix Assortment Planning](https://www.infor.com/support). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/predictix-assortment-planning-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/predictix-assortment-planning-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/predictix-assortment-planning-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/predictix-assortment-planning-tutorial/create_aaduser_04.png)
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no Predictix Assortment Planning. Trabalhe com a [equipe de suporte do Predictix Assortment Planning](https://www.infor.com/contact/) para adicionar os usuários à plataforma PredictixAssortment Planning.
 > [!NOTE]
...
1. Na lista de aplicativos, selecione **Predictix Assortment Planning**.

    ![O link do Predictix Assortment Planning na lista de Aplicativos](./media/predictix-assortment-planning-tutorial/tutorial_predictixassortmentplanning_app.png)  
