...
3. **[Criar um usuário de teste do Nexonia](#create-a-nexonia-test-user)** – para ter um equivalente de Brenda Fernandes no Nexonia que esteja vinculado à representação do usuário no Azure AD.
