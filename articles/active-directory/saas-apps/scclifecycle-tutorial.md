...
1. Na caixa de pesquisa, digite **SCC LifeCycle**.

    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/tutorial_scclifecycle_search.png)

1. No painel de resultados, selecione **SCC LifeCycle** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/tutorial_scclifecycle_addfromgallery.png)
...
1. **[Criando um usuário de teste do SCC LifeCycle](#creating-an-scc-lifecycle-test-user)** – para ter um equivalente de Brenda Fernandes no SCC LifeCycle que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/scclifecycle-tutorial/tutorial_scclifecycle_samlbase.png)

1. Na seção **Domínio e URLs do SCC LifeCycle**, realize as seguintes etapas:

    ![Configurar o logon único](./media/scclifecycle-tutorial/tutorial_scclifecycle_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/scclifecycle-tutorial/tutorial_scclifecycle_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/scclifecycle-tutorial/tutorial_general_400.png)
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/scclifecycle-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **SCC LifeCycle**.

    ![Configurar o logon único](./media/scclifecycle-tutorial/tutorial_scclifecycle_app.png) 
