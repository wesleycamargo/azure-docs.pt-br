...
1. Na caixa de pesquisa, digite **XaitPorter**, selecione **XaitPorter** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do XaitPorter](#create-a-xaitporter-test-user)** – para ter um equivalente de Brenda Fernandes no XaitPorter que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

1. Na seção **Domínio e URLs do XaitPorter**, realize as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique no botão copiar para copiar a **URL de metadados de federação do aplicativo** e cole-a no bloco de notas. 
    ...
    ![O link de download do Certificado](./media/xaitporter-tutorial/tutorial_xaitporter_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/xaitporter-tutorial/tutorial_general_400.png)
...
1. Em outra janela do navegador da Web, faça logon em seu site de empresa do XaitPorter como um administrador.

1. Clique em **Admin**.

    ![Configurar o logon único](./media/xaitporter-tutorial/user1.png)

1. Selecione **Gerenciar Logon Único** na lista suspensa **Configuração do Sistema**.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/xaitporter-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/xaitporter-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/xaitporter-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/xaitporter-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, escolha **XaitPorter**.

    ![O link do XaitPorter na lista de Aplicativos](./media/xaitporter-tutorial/tutorial_xaitporter_app.png)  
