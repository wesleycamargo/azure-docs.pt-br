...
1. Na caixa de pesquisa, digite **SAP Business ByDesign**, selecione **SAP Business ByDesign** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do SAP Business ByDesign](#create-an-sap-business-bydesign-test-user)** – para ter um equivalente de Brenda Fernandes no SAP Business ByDesign vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_samlbase.png)

1. Na seção **Domínio e URLs do SAP Business ByDesign**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do SAP Business ByDesign](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_url.png)
...
1. Na seção **Atributos de Usuário**, realize as seguintes etapas:
    ...
    ![Seção Atributo do SAP Business ByDesign](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_attribute.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/sapbusinessbydesign-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do SAP Business ByDesign** do Portal do Azure, clique em **Configurar o SAP Business ByDesign** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configuração do SAP Business ByDesign](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_configure.png) 

1. Para que o SSO seja configurado para o aplicativo, execute as seguintes etapas:
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/sapbusinessbydesign-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/sapbusinessbydesign-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/sapbusinessbydesign-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/sapbusinessbydesign-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **SAP Business ByDesign**.
    ...
    ![O link do SAP Business ByDesign na lista de Aplicativos](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_app.png)  
