...
3. Para adicionar o Zscaler One, clique o **novo aplicativo** botão na parte superior da caixa de diálogo.

    ![O botão Novo aplicativo][3]

4. Na caixa de pesquisa, digite **Zscaler One**.

    ![Provisionamento do Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. No painel de resultados, selecione **Zscaler One**e, em seguida, clique no **Add** botão para adicionar o Zscaler One à sua lista de aplicativos SaaS.

    ![Provisionamento do Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Provisionamento do Zscaler One](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Selecione o Zscaler One da sua lista de aplicativos SaaS.

    ![Provisionamento do Zscaler One](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
