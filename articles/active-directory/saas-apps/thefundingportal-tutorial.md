...
1. Na caixa de pesquisa, digite **The Funding Portal**.

    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/tutorial_thefundingportal_search.png)

1. No painel de resultados, selecione **The Funding Portal** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/tutorial_thefundingportal_addfromgallery.png)
...
1. **[Criação do usuário de teste do The Funding Portal](#creating-the-funding-portal-test-user)** – para ter um equivalente de Brenda Fernandes no The Funding Portal que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_thefundingportal_samlbase.png)

1. Na seção **URLs e Domínio do The Funding Portal**, siga as etapas abaixo:

    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_thefundingportal_url.png)
...
1. O aplicativo The Funding Portal espera que as asserções de SAML contenham um atributo chamado "externalId1". O valor de "externalId1" deve ser uma studentID reconhecida. Configure a declaração "externalId1" para esse aplicativo. É possível gerenciar os valores desses atributos na em **Atributos de Usuário** do aplicativo. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_thefundingportal_attribute.png)
...
1. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_attribute_04.png)

    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_attribute_05.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_thefundingportal_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **The Funding Portal**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do The Funding Portal](mailto:info@regenteducation.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/thefundingportal-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **The Funding Portal**.
    ...
    ![Configurar o logon único](./media/thefundingportal-tutorial/tutorial_thefundingportal_app.png) 
...
Ao clicar no bloco The Funding Portal no Painel de Acesso, você entrará automaticamente no aplicativo The Funding Portal.
