...
1. Na caixa de pesquisa, digite **Wingspan eTMF**.

    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_search.png)

1. No painel de resultados, selecione **Wingspan eTMF** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_addfromgallery.png)
...
1. **[Criar um usuário de teste do Wingspan eTMF](#creating-a-wingspan-etmf-test-user)** – para ter um equivalente de Brenda Fernandes no Wingspan eTMF que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_samlbase.png)

1. Na seção **URLs e Domínio do Wingspan eTMF**, execute as seguintes etapas:

    ![Configurar o logon único](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_url11.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/wingspanetmf-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Wingspan eTMF**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Wingspan eTMF](http://www.wingspan.com/contact-us/). Eles configuram isso para terem a conexão de SSO do SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/wingspanetmf-tutorial/create_aaduser_04.png) 
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Wingspan eTMF. Trabalhe com o  [suporte do Wingspan eTMF](http://www.wingspan.com/contact-us/) para adicionar os usuários no aplicativo Wingspan eTMF. Os usuários devem ser criados e ativados antes de usar o logon único.
...
1. Na lista de aplicativos, escolha **Wingspan eTMF**.

    ![Configurar o logon único](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_app.png) 
