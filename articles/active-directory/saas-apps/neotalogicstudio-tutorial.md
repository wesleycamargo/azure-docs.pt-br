...
1. Na caixa de pesquisa, digite **Neota Logic Studio**.

    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_search.png)

1. No painel de resultados, selecione **Neota Logic Studio** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_addfromgallery.png)
...
1. **[Criar um usuário de teste do Neota Logic Studio](#creating-a-neota-logic-studio-test-user)** – para ter um equivalente de Brenda Fernandes no Neota Logic Studio que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_samlbase.png)

1. Na seção **URLs e Domínio do Neota Logic Studio**, execute as seguintes etapas:

    ![Configurar o logon único](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/neotalogicstudio-tutorial/tutorial_general_400.png)

1. Para configurar o SSO para o seu aplicativo, entre em contato com a [equipe de suporte do Neota Logic Studio](https://www.neotalogic.com/contact-us/) e forneça o arquivo**XML de Metadados** baixado.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/neotalogicstudio-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, escolha **Neota Logic Studio**.

    ![Configurar o logon único](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_app.png) 
