...
- Você pode permitir que os usuários façam logon automaticamente no EasyTerritory (logon único) com as respectivas contas do Azure AD.
...
1. Na caixa de pesquisa, digite **EasyTerritory**, selecione **EasyTerritory** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
No EasyTerritory, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
1. **[Criar de um usuário de teste do EasyTerritory](#create-a-easyterritory-test-user)** – para ter um equivalente de Brenda Fernandes no EasyTerritory vinculado à representação do usuário no Azure AD.
1. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
1. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure AD no Portal do Azure e configurará o logon único no aplicativo EasyTerritory.

**Para configurar o logon único do Azure AD com o EasyTerritory, execute as seguintes etapas:**

1. No Portal do Azure, na página de integração de aplicativos do **EasyTerritory**, clique em **Logon único**.

    ![Link Configurar logon único][4]

1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/easyterritory-tutorial/tutorial_easyterritory_samlbase.png)

1. Na seção **Domínio e URLs do EasyTerritory**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo IdP:

    ![Informações de logon único de Domínio e URLs do EasyTerritory](./media/easyterritory-tutorial/tutorial_easyterritory_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do EasyTerritory](./media/easyterritory-tutorial/tutorial_easyterritory_url1.png)

    Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<company name>.easyterritory.com/`
     
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com o Identificador real, a URL de Resposta e a URL de Entrada. Contate a [equipe de suporte ao cliente do EasyTerritory](mailto:sales@easyterritory.com) para obter esses valores. 

1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/easyterritory-tutorial/tutorial_easyterritory_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/easyterritory-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **EasyTerritory**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do EasyTerritory](mailto:sales@easyterritory.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/easyterritory-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/easyterritory-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/easyterritory-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/easyterritory-tutorial/create_aaduser_04.png)
...
Nesta seção, você permitirá que Brenda Fernandes use o logon único do Azure concedendo-lhe acesso ao EasyTerritory.
...
1. Na lista de aplicativos, escolha **EasyTerritory**.

    ![O link do EasyTerritory na lista de Aplicativos](./media/easyterritory-tutorial/tutorial_easyterritory_app.png)  
