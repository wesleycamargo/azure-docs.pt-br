...
Quando você clicar no bloco Datahug no Painel de Acesso, você deverá fazer logon automaticamente no seu aplicativo Datahug. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../active-directory-saas-access-panel-introduction.md). 
