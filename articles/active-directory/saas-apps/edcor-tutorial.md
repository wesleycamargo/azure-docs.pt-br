...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/edcor-tutorial/tutorial_edcor_samlbase.png)

3. Na seção **URLs e Domínio do Edcor**, execute as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do Edcor](./media/edcor-tutorial/tutorial_edcor_url1.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/edcor-tutorial/tutorial_edcor_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/edcor-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do Edcor**, clique em **Configurar Edcor** para abrir a janela **Configurar logon**. Copie a **URL de Logoff e a ID da Entidade do SAML** da **seção Referência Rápida.**
    ...
    ![Configuração do Edcor](./media/edcor-tutorial/tutorial_edcor_configure.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/edcor-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/edcor-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/edcor-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/edcor-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Edcor**.
    ...
    ![O link do Edcor na lista de Aplicativos](./media/edcor-tutorial/tutorial_edcor_app.png)  
