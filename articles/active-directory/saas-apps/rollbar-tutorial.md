...
1. Na caixa de pesquisa, digite **Rollbar**, selecione **Rollbar** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Rollbar](#create-a-rollbar-test-user)** – para ter um equivalente de Brenda Fernandes no Rollbar que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/rollbar-tutorial/tutorial_rollbar_samlbase.png)

1. Na seção **Domínio e URLs do Rollbar**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Rollbar](./media/rollbar-tutorial/tutorial_rollbar_url1.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/rollbar-tutorial/tutorial_rollbar_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/rollbar-tutorial/tutorial_general_400.png)
    
1. Em outra janela do navegador da Web, faça logon em seu site empresarial do Rollbar como um administrador.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/rollbar-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/rollbar-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/rollbar-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/rollbar-tutorial/create_aaduser_04.png)
...
1. Na caixa de texto, digite o nome do usuário, como **brittasimon@contoso.com** e clique em **Adicionar/Convidar**.
...
1. Na lista de aplicativos, selecione **Rollbar**.

    ![O link do Rollbar na Lista de aplicativos](./media/rollbar-tutorial/tutorial_rollbar_app.png)  
