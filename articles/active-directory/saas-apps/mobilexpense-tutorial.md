...
1. Na caixa de pesquisa, digite **Mobile Xpense**, selecione **Mobile Xpense** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Mobile Xpense](#create-a-mobile-xpense-test-user)** – para ter um equivalente de Brenda Fernandes no Mobile Xpense que esteja vinculado à representação de usuário no Azure AD.
...
1. Na seção **Domínio e URLs do Mobile Xpense**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado por IDP:
...
1. Na lista de aplicativos, selecione **Mobile Xpense**.
