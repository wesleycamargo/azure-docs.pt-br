...
1. Na caixa de pesquisa, digite **TiViTz**.

    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/tutorial_tivitz_search.png)

1. No painel de resultados, selecione **TiViTz** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/tutorial_tivitz_addfromgallery.png)
...
1. **[Criação de um usuário de teste do TiViTz](#creating-a-tivitz-test-user)** – para ter um equivalente de Brenda Fernandes no TiViTz que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/tivitz-tutorial/tutorial_tivitz_samlbase.png)

1. Na seção **URLs e Domínio do TiViTz**, siga as etapas abaixo:

    ![Configurar o logon único](./media/tivitz-tutorial/tutorial_tivitz_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/tivitz-tutorial/tutorial_tivitz_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/tivitz-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **TiViTz**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do TiViTz](mailto:info@tivitz.com).
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/tivitz-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **TiViTz**.

    ![Configurar o logon único](./media/tivitz-tutorial/tutorial_tivitz_app.png) 
