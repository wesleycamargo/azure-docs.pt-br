...
1. Na caixa de pesquisa, digite **Zscaler**.

    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/tutorial_zscaler_search.png)

1. No painel de resultados, selecione **Zscaler** e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/tutorial_zscaler_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Zscaler](#creating-a-zscaler-test-user)** – para ter um equivalente de Brenda Fernandes no Zscaler que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/zscaler-tutorial/tutorial_zscaler_samlbase.png)

1. Na seção **URLs e Domínio do Zscaler**, siga as etapas abaixo:

    ![Configurar o logon único](./media/zscaler-tutorial/tutorial_zscaler_url.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![Configurar o logon único](./media/zscaler-tutorial/tutorial_zscaler_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/zscaler-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Zscaler**, clique em **Configurar o Zscaler** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/zscaler-tutorial/tutorial_zscaler_configure.png) 

1. Em uma janela diferente do navegador da Web, faça logon no site da sua empresa Zscaler como administrador.
...
1. Em **Gerenciar Administradores e Funções**, clique em **Gerenciar Usuários e Autenticação**.   
    ...
    ![Gerenciar usuários e autenticação](./media/zscaler-tutorial/ic800207.png "Gerenciar usuários e autenticação")
...
1. Na página da caixa de diálogo **Configurar Parâmetros de Logon Único do SAML**, execute as seguintes etapas e, em seguida, clique em **Concluído**
    ...
    ![Logon Único](./media/zscaler-tutorial/ic800209.png "Logon Único")
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/zscaler-tutorial/create_aaduser_04.png) 
...
1. Na seção Adicionar Usuário, execute as seguintes etapas:
    ...
    ![Adicionar Usuário](./media/zscaler-tutorial/ic781038.png "Adicionar Usuário")
