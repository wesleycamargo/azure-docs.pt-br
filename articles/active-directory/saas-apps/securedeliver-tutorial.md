...
1. Na caixa de pesquisa, digite **SECURE DELIVER**.

    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/tutorial_securedeliver_search.png)

1. No painel de resultados, selecione **SECURE DELIVER** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/tutorial_securedeliver_addfromgallery.png)
...
1. **[Criando um usuário de teste do SECURE DELIVER](#creating-a-secure-deliver-test-user)** – para ter um equivalente de Brenda Fernandes no SECURE DELIVER que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_securedeliver_samlbase.png)

1. Na seção **Domínio e URLs do SECURE DELIVER**, realize as seguintes etapas:

    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_securedeliver_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_securedeliver_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do SECURE DELIVER**, clique em **Configurar o SECURE DELIVER** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_securedeliver_configure.png) 

1. Para configurar o logon único no lado do **SECURE DELIVER**, é necessário enviar o **Certificado (Base64)** baixado, a **URL de Saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** para a [equipe de suporte do SECURE DELIVER](mailto:iw-sd-support@fujifilm.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/securedeliver-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, escolha **SECURE DELIVER**.

    ![Configurar o logon único](./media/securedeliver-tutorial/tutorial_securedeliver_app.png) 
