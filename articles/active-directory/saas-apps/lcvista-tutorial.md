...
1. Na caixa de pesquisa, digite **LCVista**.

    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/tutorial_lcvista_search.png)

1. No painel de resultados, selecione **LCVista** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/tutorial_lcvista_addfromgallery.png)
...
1. **[Criação de um usuário de teste do LCVista](#creating-a-lcvista-test-user)** – para ter um equivalente de Brenda Fernandes no LCVista que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_lcvista_samlbase.png)

1. Na seção **Domínio e URLs do LCVista**, execute as seguintes etapas:

    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_lcvista_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_lcvista_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_general_400.png)
    
1. Na seção **Configuração do LCVista**, clique em **Configurar o LCVista** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML** e a **URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

1.  Entre no seu aplicativo LCVista como um administrador.

1. Na seção **Configuração de SAML**, marque **Habilitar logon de SAML** e digite os detalhes como mencionado na imagem abaixo. 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/lcvista-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, escolha **LCVista**.

    ![Configurar o logon único](./media/lcvista-tutorial/tutorial_lcvista_app.png) 
