...
1. Na caixa de pesquisa, digite **Yardi eLearning**.

    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/tutorial_yardielearning_search.png)

1. No painel de resultados, selecione **Yardi eLearning** e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/tutorial_yardielearning_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Yardi eLearning](#creating-a-yardi-elearning-test-user)** – para ter um equivalente de Brenda Fernandes no Yardi eLearning vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/yardielearning-tutorial/tutorial_yardielearning_samlbase.png)

1. Na seção **URLs e Domínio do Yardi eLearning**, realize as seguintes etapas:

    ![Configurar o logon único](./media/yardielearning-tutorial/tutorial_yardielearning_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/yardielearning-tutorial/tutorial_yardielearning_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/yardielearning-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Yardi eLearning**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Yardi eLearning](mailto:elearning@yardi.com). 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/yardielearning-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Yardi eLearning**.

    ![Configurar o logon único](./media/yardielearning-tutorial/tutorial_yardielearning_app.png) 
