...
1. Na caixa de pesquisa, digite **SSO do SAML para Bitbucket da Resolution GmbH**, selecione **SSO do SAML para Bitbucket da Resolution GmbH** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.

    ![SSO do SAML para Bitbucket da Resolution GmbH na lista de resultados](./media/bitbucket-tutorial/tutorial_bitbucket_addfromgallery.png)
...
1. **[Criar um usuário de teste de SSO do SAML para Bitbucket da Resolution GmbH](#create-a-saml-sso-for-bitbucket-by-resolution-gmbh-test-user)**  – para ter um equivalente de Brenda Fernandes no SSO do SAML para Bitbucket da Resolution GmbH vinculado à representação do usuário do AD do Azure.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/bitbucket-tutorial/tutorial_bitbucket_samlbase.png)

1. Na seção **Domínio e URLs do SSO do SAML para Bitbucket da Resolution GmbH**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo IdP:

    ![Informações de logon único de domínio e URLs do SSO do SAML para Bitbucket da Resolution GmbH](./media/bitbucket-tutorial/tutorial_bitbucket_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de domínio e URLs do SSO do SAML para Bitbucket da Resolution GmbH](./media/bitbucket-tutorial/tutorial_bitbucket_url1.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/bitbucket-tutorial/tutorial_bitbucket_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/bitbucket-tutorial/tutorial_general_400.png)
    
1. Faça logon no site da empresa do SAML SSO para Bitbucket da Resolution GmbH como administrador.

1. No lado direito da barra de ferramentas principal, clique em **configurações**.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/bitbucket-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/bitbucket-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/bitbucket-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/bitbucket-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **SSO do SAML para Bitbucket da Resolution GmbH**.
    ...
    ![O SSO do SAML para Bitbucket da Resolution GmbH, link na lista de Aplicativos](./media/bitbucket-tutorial/tutorial_bitbucket_app.png)  
