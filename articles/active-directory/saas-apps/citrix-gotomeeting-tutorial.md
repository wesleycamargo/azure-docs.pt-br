...
1. Adicionar o GoToMeeting da galeria
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do GoToMeeting é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do GoToMeeting.

No GoToMeeting, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
3. **[Criação de um usuário de teste do GoToMeeting](#create-a-gotomeeting-test-user)** – para ter um equivalente de Brenda Fernandes no GoToMeeting que esteja vinculado à sua representação no Azure AD.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure AD no portal do Azure e configurará o logon único no aplicativo GoToMeeting.

**Para configurar o logon único do Azure AD com o GoToMeeting, execute as seguintes etapas:**

1. No portal do Azure, na página de integração de aplicativo do **GoToMeeting**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_samlbase.png)

3. Na seção **URLs e Domínio do GoToMeeting**, execute as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do GoToMeeting](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Botão Salvar em Configurar Logon Único](./media/citrix-gotomeeting-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/citrix-gotomeeting-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/citrix-gotomeeting-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/citrix-gotomeeting-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/citrix-gotomeeting-tutorial/create_aaduser_04.png)
...
### <a name="create-a-gotomeeting-test-user"></a>Criar um usuário de teste do GoToMeeting
...
**Para atribuir Brenda Fernandes ao GoToMeeting, execute as seguintes etapas:**
...
2. Na lista de aplicativos, selecione **GoToMeeting**.
    ...
    ![O link do GoToMeeting na lista de Aplicativos](./media/citrix-gotomeeting-tutorial/tutorial_gotomeeting_app.png)  
...
Ao clicar no bloco GoToMeeting no Painel de Acesso, você deverá ser conectado automaticamente ao seu aplicativo GoToMeeting.
