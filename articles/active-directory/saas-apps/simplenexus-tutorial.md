...
1. Na caixa de pesquisa, digite **SimpleNexus**.

    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/tutorial_simplenexus_search.png)

1. No painel de resultados, selecione **SimpleNexus** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/tutorial_simplenexus_addfromgallery.png)
...
1. **[Criando um usuário de teste do SimpleNexus](#creating-a-simplenexus-test-user)** – para ter um equivalente de Brenda Fernandes no SimpleNexus que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/simplenexus-tutorial/tutorial_simplenexus_samlbase.png)

1. Na seção **Domínio e URLs do SimpleNexus**, realize as seguintes etapas:

    ![Configurar o logon único](./media/simplenexus-tutorial/tutorial_simplenexus_url.png)
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte ao Cliente do SimpleNexus](https://simplenexus.com/sn/contact-us/) para obter esses valores. 
 
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![Configurar o logon único](./media/simplenexus-tutorial/tutorial_simplenexus_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/simplenexus-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **SimpleNexus**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do SimpleNexus](https://simplenexus.com/sn/contact-us/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/simplenexus-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **SimpleNexus**.

    ![Configurar o logon único](./media/simplenexus-tutorial/tutorial_simplenexus_app.png) 
