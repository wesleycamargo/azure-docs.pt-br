...
1. Na caixa de pesquisa, digite **Clear Review**, selecione **Clear Review** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Clear Review na lista de resultados](./media/clearreview-tutorial/tutorial_clearreview_addfromgallery.png)
...
1. **[Criar um usuário de teste do Clear Review](#create-a-clear-review-test-user)** – para ter um equivalente de Britta Simon no Clear Review vinculado à representação do usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/clearreview-tutorial/tutorial_clearreview_samlbase.png)

1. Na seção **Domínio e URLs do Clear Review**, realize as seguintes etapas se desejar configurar o aplicativo no modo **iniciado pelo IDP**:
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Clear Review](./media/clearreview-tutorial/tutorial_clearreview_url_sp.png)
...
1. O aplicativo Clear Review espera o valor exclusivo do identificador de usuário na declaração do Identificador de Nome. Você deve mapear o valor do identificador de usuário para **user.mail**.

    ![A Seção de Atributo](./media/clearreview-tutorial/attribute.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/clearreview-tutorial/tutorial_clearreview_certificate.png)

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/clearreview-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Clear Review**, clique em **Configurar o Clear Review** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Clear Review](./media/clearreview-tutorial/tutorial_clearreview_configure.png) 

1. Para configurar o logon único no **Clear Review**, abra o portal **Clear Review** com credenciais de administrador.

1. Selecione **Admin** do painel de navegação esquerdo.

    ![Botão Salvar em Configurar Logon Único](./media/clearreview-tutorial/tutorial_clearreview_app_admin1.png)

1. Na parte inferior da página, selecione **Mudar**.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/clearreview-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/clearreview-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/clearreview-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/clearreview-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Clear Review**.

    ![O link do Clear Review na lista de Aplicativos](./media/clearreview-tutorial/tutorial_clearreview_app.png)  
