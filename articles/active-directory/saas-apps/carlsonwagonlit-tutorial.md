...
4. Na caixa de pesquisa, digite **Carlson Wagonlit Travel**, selecione **Carlson Wagonlit Travel** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Carlson Wagonlit Travel na lista de resultados](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_addfromgallery.png)
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_samlbase.png)

3. Na seção **URLs e Domínio do Carlson Wagonlit Travel**, siga as etapas abaixo:

    ![Informações de logon único em Domínio e URLs do Carlson Wagonlit Travel](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_url.png)

    Na caixa de texto **Identificador**, digite o valor: `cwt-stage`

4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/carlsonwagonlit-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/carlsonwagonlit-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/carlsonwagonlit-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/carlsonwagonlit-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/carlsonwagonlit-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Carlson Wagonlit Travel**.
    ...
    ![O link Carlson Wagonlit Travel na lista de aplicativos](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_app.png)  
