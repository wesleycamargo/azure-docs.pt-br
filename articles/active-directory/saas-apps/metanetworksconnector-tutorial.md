...
3. **[Crie um usuário de teste do Meta Networks Connector](#create-a-meta-networks-connector-test-user)** - para ter um equivalente de Britta Simon no Meta Networks Connector que esteja vinculado à representação de usuário do Azure AD.
...
3. Sobre o **Meta redes conector do domínio e URLs** , realize as seguintes etapas se desejar configurar o aplicativo no **IDP** modo iniciado pelo:
    ...
    b. Na caixa de texto **URL de resposta**, digite uma URL no seguinte padrão: `https://login.nsof.io/v1/<ORGANIZATION-SHORT-NAME>/sso/saml`
...
8. Na seção **Configuração do conector Meta Networks**, clique em **Configurar conector Meta Networks** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**
...
10. Abra uma nova guia no seu navegador e faça login na sua conta de administrador do Meta Networks Connector.
...
15. Sobre o **geral** guia execute as seguintes etapas:

    ![Configurar o logon único](./media/metanetworksconnector-tutorial/configure5.png)

    a. No **URL de Logon Único do Provedor de Identidade**, cole o **URL do Serviço de Logon Único do SAML** que você copiou do portal do Azure.

    b. No **emissor do provedor de identidade**, cole o **ID da entidade SAML** valor que você copiou do portal do Azure.
