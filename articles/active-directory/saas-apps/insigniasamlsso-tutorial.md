...
1. Na caixa de pesquisa, digite **Insignia SAML SSO**, selecione **Insignia SAML SSO** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Insignia SAML SSO](#create-an-insignia-saml-sso-test-user)** – para ter um equivalente de Brenda Fernandes no Insignia SAML SSO que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_samlbase.png)

1. Na seção **URLs e Domínio do Insignia SAML SSO**, execute as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/insigniasamlsso-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Insignia SAML SSO**, clique em **Configurar Insignia SAML SSO** para abrir a janela **Configurar logon**. Copie a **URL de Saída e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/insigniasamlsso-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/insigniasamlsso-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/insigniasamlsso-tutorial/create_aaduser_03.png)
...
1. Na lista de aplicativos, selecione **Insignia SAML SSO**.

    ![O link do Insignia SAML SSO na lista de Aplicativos](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_app.png)  
