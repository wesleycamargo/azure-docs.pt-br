...
1. Na caixa de pesquisa, digite **Trakstar**.

    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/tutorial_trakstar_search.png)

1. No painel de resultados, selecione **Trakstar** e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/tutorial_trakstar_addfromgallery.png)
...
1. **[Criando um usuário de teste do Trakstar](#creating-a-trakstar-test-user)** – para ter um equivalente de Brenda Fernandes no Trakstar que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_trakstar_samlbase.png)

1. Na seção **Domínio e URLs do Trakstar**, realize as seguintes etapas:

    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_trakstar_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_trakstar_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Trakstar**, clique em **Configurar Trakstar** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_trakstar_configure.png) 

1. Para configurar o logon único no lado do **Trakstar**, é necessário fazer logon como Administrador e inserir **Certificado (Base64)**, **URL de Saída, ID da Entidade SAML e URL do Serviço de Logon Único SAML**. 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/trakstar-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Trakstar**.

    ![Configurar o logon único](./media/trakstar-tutorial/tutorial_trakstar_app.png) 
