...
1. Para configurar o logon único no lado do **Kontiki**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte Kontiki](http://customersupport.kontiki.com/enterprise/contactsupport.html). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
