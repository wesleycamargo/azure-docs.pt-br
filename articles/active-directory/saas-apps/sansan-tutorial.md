...
4. Na caixa de pesquisa, digite **Sansan**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/sansan-tutorial/tutorial_sansan_search.png)

5. No painel de resultados, selecione **Sansan** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/sansan-tutorial/tutorial_sansan_addfromgallery.png)
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/sansan-tutorial/tutorial_sansan_samlbase.png)

3. Na seção **Domínio e URLs do Sansan**, realize as seguintes etapas:

    ![Configurar o logon único](./media/sansan-tutorial/tutorial_sansan_url.png)
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com o URL de login real. Contate a [equipe de suporte ao Cliente do Sansan](https://www.sansan.com/form/contact) para obter esses valores. 
     
4. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.

    ![Configurar o logon único](./media/sansan-tutorial/tutorial_sansan_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/sansan-tutorial/tutorial_general_400.png)
...
9. Na seção **Configuração do Sansan**, clique em **Configurar o Sansan** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/sansan-tutorial/tutorial_sansan_configure.png) 

10. Para configurar o logon único no lado do **Sansan**, é necessário enviar o **Certificado** baixado, a **URL de Saída**, a **ID da Entidade SAML** e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do Sansan](https://www.sansan.com/form/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/sansan-tutorial/create_aaduser_01.png) 

2. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/sansan-tutorial/create_aaduser_02.png) 

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/sansan-tutorial/create_aaduser_03.png) 
...
2. Na lista de aplicativos, selecione **Sansan**.
    ...
    ![Configurar o logon único](./media/sansan-tutorial/tutorial_sansan_app.png) 
