...
5. Se quiser configurar o aplicativo no modo iniciado pelo **SP**, realize as seguintes etapas:
    ...
    Na caixa de texto **URL de login**, digite um URL usando o seguinte padrão: `https://fsso.springer.com/saml/login?idp=<entityID>&targetUrl=https://link.springer.com`
