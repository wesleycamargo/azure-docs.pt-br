...
1. Na caixa de pesquisa, digite **Springer Link**, selecione **Springer Link** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Springer Link na lista de resultados](./media/springerlink-tutorial/tutorial_springerlink_addfromgallery.png)
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/springerlink-tutorial/tutorial_springerlink_samlbase.png)

1. Na seção **Domínio e URLs do Springer**, se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único em Domínio e URLs do Springer Link](./media/springerlink-tutorial/tutorial_springerlink_url1.png)
...
1. Marque **Mostrar configurações de URL avançadas**. Se quiser configurar o aplicativo no modo iniciado em **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Springer Link](./media/springerlink-tutorial/tutorial_springerlink_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique no botão copiar para copiar a **URL de metadados de federação do aplicativo** e cole-a no bloco de notas. 
    ...
    ![O link de download do Certificado](./media/springerlink-tutorial/tutorial_springerlink_certificate.png)    

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/springerlink-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Springer Link**, é necessário enviar a **URL de metadados de federação do aplicativo** para a [equipe de suporte do Springer Link](mailto:identity@springernature.com).
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/springerlink-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/springerlink-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/springerlink-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/springerlink-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Springer Link**.
    ...
    ![O link do Springer Link na lista de Aplicativos](./media/springerlink-tutorial/tutorial_springerlink_app.png)  
