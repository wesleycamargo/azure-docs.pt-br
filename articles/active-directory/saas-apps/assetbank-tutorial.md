...
1. Na caixa de pesquisa, digite **Asset Bank**.

    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/tutorial_assetbank_search.png)

1. No painel de resultados, selecione **Asset Bank** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/tutorial_assetbank_addfromgallery.png)
...
1. **[Criando um usuário de teste do Asset Bank](#creating-an-asset-bank-test-user)** – para ter um equivalente de Brenda Fernandes no Asset Bank que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/assetbank-tutorial/tutorial_assetbank_samlbase.png)

1. Na seção **Domínio e URLs do Asset Bank**, realize as seguintes etapas:

    ![Configurar o logon único](./media/assetbank-tutorial/tutorial_assetbank_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/assetbank-tutorial/tutorial_assetbank_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/assetbank-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Asset Bank**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Asset Bank](mailto:support@assetbank.co.uk). 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/assetbank-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Asset Bank**.

    ![Configurar o logon único](./media/assetbank-tutorial/tutorial_assetbank_app.png) 
