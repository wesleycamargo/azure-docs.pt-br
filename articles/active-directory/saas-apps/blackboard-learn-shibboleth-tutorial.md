...
* Você pode permitir que os usuários sejam conectados automaticamente ao Blackboard Learn – Shibboleth (Logon Único) com suas contas do Azure AD.
...
* Assinatura do Blackboard Learn – Shibboleth habilitada para logon único
...
4. Na caixa de pesquisa, digite **Blackboard Learn – Shibboleth**, selecione **Blackboard Learn – Shibboleth** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Blackboard Learn – Shibboleth na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Blackboard Learn – Shibboleth.
...
2. **[Configurar o Logon Único do Blackboard Learn – Shibboleth](#configure-blackboard-learn---shibboleth-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Blackboard Learn – Shibboleth](#create-blackboard-learn---shibboleth-test-user)** – para ter um equivalente de Brenda Fernandes no Blackboard Learn – Shibboleth que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo do **Blackboard Learn – Shibboleth**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Blackboard Learn – Shibboleth](common/sp-identifier-reply.png)
...
### <a name="configure-blackboard-learn---shibboleth-single-sign-on"></a>Configurar o logon único do Blackboard Learn – Shibboleth
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Blackboard Learn – Shibboleth**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Blackboard Learn - Shibboleth**.

    ![O link do Blackboard Learn – Shibboleth na lista de aplicativos](common/all-applications.png)
...
Nesta seção, você deve criar um usuário chamado Brenda Fernandes no Blackboard Learn - Shibboleth. Trabalhe com a [equipe de suporte do Blackboard Learn – Shibboleth](https://www.blackboard.com/forms/contact-us_form.aspx) para adicionar os usuários à plataforma Blackboard Learn – Shibboleth. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Blackboard Learn – Shibboleth no Painel de Acesso, você deve ser conectado automaticamente ao Blackboard Learn – Shibboleth para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
