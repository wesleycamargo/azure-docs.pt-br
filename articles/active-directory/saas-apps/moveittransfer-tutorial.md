---
title: 'Tutorial: Integração do Azure Active Directory ao MOVEit Transfer – Integração do Azure Active Directory | Microsoft Docs'
...
1. Na caixa de pesquisa, digite **MOVEit Transfer - Azure AD integration**, selecione **MOVEit Transfer - Azure AD integration** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.

    ![MOVEit Transfer - Azure AD integration na lista de resultados](./media/moveittransfer-tutorial/tutorial_moveittransfer_addfromgallery.png)
...
1. **[Criar um usuário de teste do MOVEit Transfer - Azure AD integration](#create-a-moveit-transfer---azure-ad-integration-test-user)** para ter um equivalente de Brenda Fernandes no MOVEit Transfer - Azure AD integration que seja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/moveittransfer-tutorial/tutorial_moveittransfer_samlbase.png)

1. Na seção **Domínio e URLs do MOVEit Transfer - Azure AD integration**, execute as seguintes etapas:

    ![Configurar o logon único](./media/moveittransfer-tutorial/tutorial_moveittransfer_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/moveittransfer-tutorial/tutorial_moveittransfer_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/moveittransfer-tutorial/tutorial_general_400.png)
...
1. No painel de navegação esquerdo, clique em **Configurações**.
    ...
    ![Seção Configurações no lado do aplicativo](./media/moveittransfer-tutorial/tutorial_moveittransfer_000.png)

1. Clique no link **Logon Único** que está em **Políticas de Segurança -> Autenticação de Usuário**.

    ![Políticas de segurança no lado do aplicativo](./media/moveittransfer-tutorial/tutorial_moveittransfer_001.png)

1. Clique no link de URL de Metadados para baixar o documento de metadados.

    ![URL de metadados do provedor de serviço](./media/moveittransfer-tutorial/tutorial_moveittransfer_002.png)
    ...
    * Verifique se a URL de local **AssertionConsumerService** corresponde à **URL DE RESPOSTA** na seção **Domínio e URLs do MOVEit Transfer - Azure AD integration**.
    ...
    ![Configurar o logon único no lado do aplicativo](./media/moveittransfer-tutorial/tutorial_moveittransfer_007.png)

1. Clique no botão **Adicionar Provedor de Identidade** para adicionar um novo Provedor de Identidade Federada.

    ![Adicionar Provedor de Identidade](./media/moveittransfer-tutorial/tutorial_moveittransfer_003.png)

1. Clique em **Procurar...** para selecionar o arquivo de metadados que você baixou do portal do Azure e clique em **Adicionar Provedor de Identidade** para carregar o arquivo baixado.

    ![Provedor de identidade SAML](./media/moveittransfer-tutorial/tutorial_moveittransfer_004.png)

1. Selecione "**Sim**" como **Habilitado** na página **Editar Provedor de Identidade Federado...** e clique em **Salvar**.

    ![Configurações de Provedor de Identidade Federado](./media/moveittransfer-tutorial/tutorial_moveittransfer_005.png)

1. Na página **Editar Configurações de usuário de Provedor de Identidade Federado**, realize as ações a seguir:
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/moveittransfer-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/moveittransfer-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/moveittransfer-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/moveittransfer-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **MOVEit Transfer - Azure AD integration**.
    ...
    ![Link do MOVEit Transfer - Azure AD integration na lista de aplicativos](./media/moveittransfer-tutorial/tutorial_moveittransfer_app.png)  
