...
1. Na caixa de pesquisa, digite **Learningpool Act**.

    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/tutorial_Learningpoolact_search.png)

1. No painel de resultados, selecione **Learningpool Act** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/tutorial_Learningpoolact_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Learningpool Act](#creating-a-learningpool-act-test-user)**: para ter um equivalente de Brenda Fernandes no Learningpool Act que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_Learningpoolact_samlbase.png)

1. Na seção **Domínio e URLs do Learningpool Act**, execute as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_Learningpoolact_certificate.png) 

1. O aplicativo Learningpool Act espera que as declarações SAML estejam em um formato específico. Configure as seguintes declarações para o aplicativo. Você pode gerenciar o valor dos atributos na guia **"Atributo"** do aplicativo. A captura de tela a seguir mostra um exemplo disso. 

    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_Learningpoolact_attribute.png) 
...
1. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_attribute_05.png)
...
1. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_general_400.png)
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/learningpool-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Learningpool Act**.

    ![Configurar o logon único](./media/learningpool-tutorial/tutorial_Learningpoolact_app.png) 
