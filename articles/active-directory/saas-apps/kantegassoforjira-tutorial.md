...
1. Na caixa de pesquisa, digite **SSO do Kantega para o JIRA**.

    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforjira-tutorial/tutorial_kantegassoforjira_search.png)

1. No painel de resultados, selecione **SSO do Kantega para o JIRA** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criando um usuário de teste do SSO do Kantega para o JIRA](#creating-a-kantega-sso-for-jira-test-user)** – para ter um equivalente de Brenda Fernandes no SSO do Kantega para o JIRA que esteja vinculado à representação de usuário do Azure AD.
...
1. No modo iniciado pelo **IDP**, na seção **Domínio e URLs do SSO do Kantega para o JIRA**, realize a seguinte etapa:
...
1. Em outra janela do navegador da Web, faça logon no servidor local do JIRA como administrador.
...
1. Na lista de aplicativos, selecione **SSO do Kantega para o JIRA**.
