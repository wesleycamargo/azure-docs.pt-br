...
8. Para configurar o logon único o lado de **Inovação Colaborativa**, você precisa enviar o **XML de Metadados** baixado para a [equipe de suporte da Inovação Colaborativa](https://www.unilever.com/contact/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
