...
1. Na caixa de pesquisa, digite **Wikispaces**.

    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/tutorial_wikispaces_search.png)

1. No painel de resultados, selecione **Wikispaces** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/tutorial_wikispaces_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Wikispaces](#creating-a-wikispaces-test-user)** – para ter um equivalente de Brenda Fernandes no Wikispaces que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/wikispaces-tutorial/tutorial_wikispaces_samlbase.png)

1. Na seção **URLs e Domínio do Wikispaces**, siga as etapas abaixo:

    ![Configurar o logon único](./media/wikispaces-tutorial/tutorial_wikispaces_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/wikispaces-tutorial/tutorial_wikispaces_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/wikispaces-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Wikispaces**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Wikispaces](https://www.wikispaces.com/site/help). Assim que a configuração for concluída, você receberá uma notificação.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/wikispaces-tutorial/create_aaduser_04.png) 
...
1. Clique em **Convidar Pessoas**.
   
    ![Convidar Pessoas](./media/wikispaces-tutorial/ic787194.png "Convidar Pessoas")

1. Na seção **Convidar Pessoas** , realize as seguintes etapas:
...
1. Na lista de aplicativos, selecione **Wikispaces**.

    ![Configurar o logon único](./media/wikispaces-tutorial/tutorial_wikispaces_app.png) 
