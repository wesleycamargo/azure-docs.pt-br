...
1. Na caixa de pesquisa, digite **Benefitsolver**, selecione **Benefitsolver** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Benefitsolver](#create-a-benefitsolver-test-user)** – para ter um equivalente de Brenda Fernandes no Benefitsolver que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

1. Na seção **Domínio e URLs do Benefitsolver**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Benefitsolver](./media/benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
1. Seu aplicativo Benefitsolver espera as declarações do SAML em um formato específico, o que exige a adição de mapeamentos de atributo personalizados de acordo com a sua configuração de **atributos do token SAML** .

    ![Seção de atributo do Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute.png)
...
1. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Seção de atributo do Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute_04.png)
    
    ![Seção de atributo do Benefitsolver](./media/benefitsolver-tutorial/tutorial_attribute_05.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/benefitsolver-tutorial/tutorial_benefitsolver_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/benefitsolver-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no **Benefitsolver**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Benefitsolver](https://www.businessolver.com/contact).
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/benefitsolver-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/benefitsolver-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/benefitsolver-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/benefitsolver-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, escolha **Benefitsolver**.

    ![O link do Benefitsolver na lista de Aplicativos](./media/benefitsolver-tutorial/tutorial_benefitsolver_app.png)  
