...
1. Na caixa de pesquisa, digite **Convercent**.

    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/tutorial_convercent_search.png)

1. No painel de resultados, selecione **Convercent** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/tutorial_convercent_addfromgallery.png)
...
1. **[Como criar um usuário de teste do Convercent](#creating-a-convercent-test-user)** – para ter um equivalente de Brenda Fernandes no Convercent que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/convercent-tutorial/tutorial_convercent_samlbase.png)

1. Na seção **Domínio e URLs do Convercent**, se você quiser configurar o aplicativo em **Modo iniciado pelo IDP**, execute a seguinte etapa:

    ![Configurar o logon único](./media/convercent-tutorial/tutorial_convercent_url.png)

    Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão: `https://<instancename>.convercent.com/`
 
1. Se você quiser configurar o aplicativo em **Modo iniciado pelo SP**, na seção **Domínio e URLs do Convercent**, execute as seguintes etapas:
    
    ![Configurar o logon único](./media/convercent-tutorial/tutorial_convercent_url1.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo XML em seu computador.
    ...
    ![Configurar o logon único](./media/convercent-tutorial/tutorial_convercent_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/convercent-tutorial/tutorial_general_400.png)

1. Para que o SSO seja configurado para seu aplicativo, entre em contato com a [equipe de suporte do Convercent](mailto:support@convercent.com) e forneça o **XML de metadados** baixado.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/convercent-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Convercent**.

    ![Configurar o logon único](./media/convercent-tutorial/tutorial_convercent_app.png) 
