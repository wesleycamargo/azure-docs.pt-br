...
4. Na caixa de pesquisa, digite **Allocadia**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/tutorial_allocadia_search.png)

5. No painel de resultados, selecione **Allocadia** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/tutorial_allocadia_addfromgallery.png)
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_allocadia_samlbase.png)

3. Na seção **Domínio e URLs do Allocadia**, realize as seguintes etapas:

    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_allocadia_url.png)
...
4. O aplicativo Allocadia espera que as declarações SAML estejam em um formato específico. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo. A captura de tela a seguir mostra um exemplo dessa configuração. 
    ...
    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_allocadia_attributes.png)
...
5. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_attribute_04.png)

    b. Na caixa de texto **Nome** , digite o nome do atributo mostrado para essa linha.

    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_attribute_05.png)
...
6. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_allocadia_certificate.png) 


7. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_general_400.png)

8. Para configurar o logon único no lado do **Allocadia**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Allocadia](mailTo:support@allocadia.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/create_aaduser_01.png) 

2. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/create_aaduser_02.png) 

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/create_aaduser_03.png) 

4. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/allocadia-tutorial/create_aaduser_04.png) 
...
2. Na lista de aplicativos, selecione **Allocadia**.
    ...
    ![Configurar o logon único](./media/allocadia-tutorial/tutorial_allocadia_app.png) 
