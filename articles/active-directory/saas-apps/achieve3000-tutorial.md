...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/achieve3000-tutorial/tutorial_achieve3000_samlbase.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/achieve3000-tutorial/tutorial_achieve3000_certificate.png) 
...
5. O aplicativo Achieve3000 espera o valor exclusivo **studentID** na declaração do Identificador de Nome. O cliente pode mapear o valor correto para a declaração do Identificador de Nome. Nesse caso, mapeamos o **user.mail** do usuário para fins demonstrativos. Porém, você deverá mapear o valor correto de acordo com seu identificador exclusivo.   
    ...
    ![Configurar logon único attb](./media/achieve3000-tutorial/tutorial_achieve3000_attribute.png)
...
6. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar logon único Addattb](./media/achieve3000-tutorial/tutorial_attribute_05.png)
...
7. Clique no botão **Salvar** .
    ...
    ![Botão Salvar em Configurar Logon Único](./media/achieve3000-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/achieve3000-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/achieve3000-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/achieve3000-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/achieve3000-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Achieve3000**.
    ...
    ![O link do Achieve3000 na Lista de aplicativos](./media/achieve3000-tutorial/tutorial_achieve3000_app.png)  
