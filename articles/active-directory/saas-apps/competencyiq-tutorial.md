...
* Você pode permitir que seus usuários entrem automaticamente no CompetencyIQ (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do CompetencyIQ

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O CompetencyIQ dá suporte a SSO iniciado pelo **SP**
...
4. Na caixa de pesquisa, digite **CompetencyIQ**, selecione **CompetencyIQ** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do CompetencyIQ.
...
2. **[Configurar o Logon Único do CompetencyIQ](#configure-competencyiq-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do CompetencyIQ](#create-competencyiq-test-user)** – para ter um equivalente de Brenda Fernandes no CompetencyIQ que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **CompetencyIQ**, selecione **Logon único**.
...
6. Na seção **Configurar o CompetencyIQ**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-competencyiq-single-sign-on"></a>Configurar o logon único do CompetencyIQ

Para configurar o logon único no lado do **CompetencyIQ**, é necessário enviar o **XML de Metadados de Federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do CompetencyIQ](https://www.competencyiq.com/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, escolha **Aplicativos Empresariais**, escolha **Todos os aplicativos** e, em seguida, escolha **CompetencyIQ**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **CompetencyIQ**.

    ![O link do CompetencyIQ na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-competencyiq-test-user"></a>Criar um usuário de teste do CompetencyIQ

Nesta seção, você criará uma usuária chamado Brenda Fernandes no CompetencyIQ. Trabalhe com a  [Equipe de suporte do CompetencyIQ](https://www.competencyiq.com/) para adicionar os usuários na plataforma do CompetencyIQ. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do CompetencyIQ no Painel de Acesso, você deverá ser conectado automaticamente ao CompetencyIQ, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
