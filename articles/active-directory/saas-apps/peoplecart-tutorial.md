...
1. Na caixa de pesquisa, digite **Peoplecart**, selecione **Peoplecart** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Peoplecart](#create-a-peoplecart-test-user)** – para ter um equivalente de Brenda Fernandes no Peoplecart que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/peoplecart-tutorial/tutorial_peoplecart_samlbase.png)

1. Na seção **URLs e Domínio do Peoplecart**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/peoplecart-tutorial/tutorial_peoplecart_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/peoplecart-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Peoplecart**, clique em **Configurar o Peoplecart** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configuração do Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_configure.png) 

1. Para configurar o logon único no lado do **Peoplecart**, é necessário enviar o **XML de Metadados** baixado e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do Peoplecart](https://peoplecart.com/ContactUs.aspx). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/peoplecart-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/peoplecart-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![O botão Adicionar](./media/peoplecart-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![A caixa de diálogo Usuário](./media/peoplecart-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Peoplecart**.

    ![O link do Peoplecart na lista Aplicativos](./media/peoplecart-tutorial/tutorial_peoplecart_app.png) 
