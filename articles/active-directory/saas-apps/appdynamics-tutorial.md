...
4. Na caixa de pesquisa, digite **AppDynamics**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. No painel de resultados, selecione **AppDynamics** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
3. Na seção **Domínio e URLs do AppDynamics**, realize as seguintes etapas:
    ...
    ![Configurar o logon único](./media/appdynamics-tutorial/tutorial_appdynamics_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/appdynamics-tutorial/tutorial_general_400.png)
