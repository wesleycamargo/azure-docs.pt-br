...
1. Na caixa de pesquisa, digite **New Relic**, selecione **New Relic** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do New Relic](#create-a-new-relic-test-user)** – para ter um equivalente de Brenda Fernandes no New Relic que esteja vinculado à representação desse usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/new-relic-tutorial/tutorial_new-relic_samlbase.png)

1. Na seção **URLs e Domínio do New Relic**, execute as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/new-relic-tutorial/tutorial_new-relic_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/new-relic-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do New Relic**, clique em **Configurar o New Relic** para abrir a janela **Configurar logon**. Copie a **URL de Saída e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**

    ![Configuração do New Relic](./media/new-relic-tutorial/tutorial_new-relic_configure.png) 

1. Em outra janela do navegador da Web, entre em seu site de empresa do **New Relic** como administrador.
...
1. Clique na guia **Segurança e autenticação** e na guia **Logon único**.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/new-relic-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/new-relic-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/new-relic-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/new-relic-tutorial/create_aaduser_04.png)
...
1. No painel **Conta** no lado esquerdo, clique em **Resumo** e em **Adicionar usuário**.
   
    ![Configurações de Conta](./media/new-relic-tutorial/ic797041.png "Configurações de Conta")

1. No diálogo **Usuários ativos** , realize as seguintes etapas:
...
1. Na lista de aplicativos, selecione **New Relic**.

    ![O link do New Relic na lista Aplicativos](./media/new-relic-tutorial/tutorial_new-relic_app.png)  
