...
* Você pode permitir que os usuários sejam conectados automaticamente ao New Relic (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do New Relic

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O New Relic dá suporte ao SSO iniciado por **SP**
...
4. Na caixa de pesquisa, digite **New Relic**, selecione **New Relic** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![New Relic na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do New Relic.
...
2. **[Configurar o logon único do New Relic](#configure-new-relic-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do New Relic](#create-new-relic-test-user)** – para ter um equivalente de Brenda Fernandes no New Relic que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **New Relic**, clique em **Logon único**.
...
6. Na seção **Configurar o New Relic**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-new-relic-single-sign-on"></a>Configurar o logon único do New Relic
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **New Relic**.
...
### <a name="create-new-relic-test-user"></a>Criar um usuário de teste do New Relic
...
Ao clicar no bloco do New Relic no Painel de Acesso, você deverá ser conectado automaticamente ao New Relic, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
