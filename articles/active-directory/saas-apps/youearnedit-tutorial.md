...
1. Na caixa de pesquisa, digite **YouEarnedt**, selecione  **YouEarnedt**  do painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do YouEarnedIt](#create-a-youearnedit-test-user)**: para ter um equivalente de Brenda Fernandes no YouEarnedIt que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

1. Na seção **Domínio e URLs do YouEarnedIt**, execute as seguintes etapas:

    ![Informações de logon único de URLs e Domínio do YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/youearnedit-tutorial/tutorial_youearnedit_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/youearnedit-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do YouEarnedIt**, clique em **Configurar o YouEarnedIt** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configuração de YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Para configurar o logon único no lado do **YouEarnedIt**, é necessário enviar o **Certificado (Base64)** baixado e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do YouEarnedIt](https://youearnedit.freshdesk.com/support/tickets/new). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/youearnedit-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/youearnedit-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/youearnedit-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/youearnedit-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **YouEarnedIt**.

    ![O link YouEarnedIt na lista de aplicativos](./media/youearnedit-tutorial/tutorial_youearnedit_app.png)  
