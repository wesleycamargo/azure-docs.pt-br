...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Real Links. Trabalhe com a [equipe de suporte do Real Links](mailto:support@reallinks.io) para adicionar os usuários na plataforma Real Links. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do Real Links no Painel de Acesso, você deverá ser conectado automaticamente ao Real Links para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
