...
1. Na caixa de pesquisa, digite **Bime**.

    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/tutorial_bime_search.png)

1. No painel de resultados, selecione **Bime** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/tutorial_bime_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Bime](#creating-a-bime-test-user)** – para ter um equivalente de Brenda Fernandes no Bime que esteja vinculado à sua representação no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/bime-tutorial/tutorial_bime_samlbase.png)

1. Na seção **URLs e Domínio do Bime**, execute as seguintes etapas:

    ![Configurar o logon único](./media/bime-tutorial/tutorial_bime_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, copie o valor da **IMPRESSÃO DIGITAL** do certificado.
    ...
    ![Configurar o logon único](./media/bime-tutorial/tutorial_bime_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/bime-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Bime**, clique em **Configurar Bime** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/bime-tutorial/tutorial_bime_configure.png) 

1. Em outra janela do navegador da Web, faça logon em seu site de empresa Bime como um administrador.

1. Na barra de ferramentas, clique em **Administrador** e em **Conta**.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/bime-tutorial/create_aaduser_04.png) 
...
1. Na barra de ferramentas, clique em **Administrador** e em **Usuários**.
   
    ![Admin](./media/bime-tutorial/ic775561.png "Admin")

1. Na **Lista de Usuários**, clique em **Adicionar Novo Usuário** (“+”).
...
1. Na lista de aplicativos, selecione o **Bime**.

    ![Configurar o logon único](./media/bime-tutorial/tutorial_bime_app.png) 
