...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/apptio-tutorial/tutorial_apptio_samlbase.png)
...
3. Na seção **Domínio e URLs do Apptio**, execute as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo IDP:
    ...
    ![Informações de logon único em Domínio e URLs do Apptio](./media/apptio-tutorial/tutorial_apptio_url.png)

    Na caixa de texto **Identificador**, digite o valor: `urn:federation:apptio`

4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/apptio-tutorial/tutorial_apptio_certificate.png) 
...
5. O aplicativo Apptio Software espera que as declarações SAML estejam em um formato específico. Configure as seguintes declarações para o aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo. Observe que o **Identificador de Usuário** é mapeado com **user.mail**. Há outros três atributos – **fullname, mail e role**, que precisam ser configurados. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar o logon único](./media/apptio-tutorial/tutorial_apptio_attributes.png)     
...
6. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar o logon único](./media/apptio-tutorial/tutorial_attribute_04.png)

    ![Configurar o logon único](./media/apptio-tutorial/tutorial_attribute_05.png)
...
8. Clique no botão **Salvar** .
    ...
    ![Botão Salvar em Configurar Logon Único](./media/apptio-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/apptio-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/apptio-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/apptio-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/apptio-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Apptio**.
    ...
    ![O link do Apptio na lista de Aplicativos](./media/apptio-tutorial/tutorial_apptio_app.png)  
