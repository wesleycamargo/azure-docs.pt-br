...
7. Para configurar o logon único no lado do **Capriza Platform**, é necessário enviar o **Certificado** baixado, a **URL de Saída**, **a ID da Entidade SAML** e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do Capriza Platform](mailTo:support@capriza.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
