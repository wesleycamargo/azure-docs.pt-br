...
1. Na caixa de pesquisa, digite **Capriza Platform**.

    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/tutorial_caprizaplatform_search.png)

1. No painel de resultados, selecione **Capriza Platform** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/tutorial_caprizaplatform_addfromgallery.png)
...
1. **[Criando um usuário de teste do Capriza Platform](#creating-a-capriza-platform-test-user)** – para ter um equivalente de Brenda Fernandes no Capriza Platform que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/capriza-tutorial/tutorial_caprizaplatform_samlbase.png)

1. Na seção **Domínio e URLs do Capriza Platform**, realize as seguintes etapas:

    ![Configurar o logon único](./media/capriza-tutorial/tutorial_caprizaplatform_url.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![Configurar o logon único](./media/capriza-tutorial/tutorial_caprizaplatform_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/capriza-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Capriza Platform**, clique em **Configurar o Capriza Platform** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/capriza-tutorial/tutorial_caprizaplatform_configure.png) 

1. Para configurar o logon único no lado do **Capriza Platform**, é necessário enviar o **Certificado** baixado, a **URL de Saída**, **a ID da Entidade SAML** e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do Capriza Platform](mailTo:support@capriza.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/capriza-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Capriza Platform**.

    ![Configurar o logon único](./media/capriza-tutorial/tutorial_caprizaplatform_app.png) 
...
Quando você clicar no bloco Capriza Platform no Painel de Acesso, deverá ser automaticamente conectado ao aplicativo Capriza Platform. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](../user-help/active-directory-saas-access-panel-introduction.md). 
