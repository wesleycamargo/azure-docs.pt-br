...
* Você pode permitir que seus usuários entrem automaticamente no Mindflash (Logon Único) usando suas contas do Azure AD.
...
* Assinatura do Mindflash com logon único habilitado

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Mindflash dá suporte ao SSO iniciado por **SP**
...
4. Na caixa de pesquisa, digite **Mindflash**, selecione **Mindflash** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Mindflash.
...
1. No [Portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Mindflash**, selecione **Logon único**.
...
6. Na seção **Configurar o Mindflash**, copie a URL apropriada de acordo com suas necessidades.
...
### <a name="configure-mindflash-single-sign-on"></a>Configurar o logon único do Mindflash

Para configurar o logon único no lado do **Mindflash**, é necessário enviar o **XML de metadados de federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Mindflash](https://www.mindflash.com/contact/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Mindflash**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Mindflash**.

    ![O link do Mindflash na lista de aplicativos](common/all-applications.png)
...
### <a name="create-mindflash-test-user"></a>Criar um usuário de teste do Mindflash
...
1. Na seção **Adicionar Novos Usuários**, execute as seguintes etapas de uma conta do Azure AD válida que deseja provisionar:
    ...
    c. Na caixa de texto **Email**, digite o **Endereço de Email** do usuário como **BrendaFernandes\@contoso.com**.
...
Quando clicar no bloco do Mindflash no Painel de Acesso, você deverá ser conectado automaticamente ao Mindflash, para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
