...
* Você pode controlar no Azure AD quem tem acesso ao Learning at Work.
* Você pode permitir que os usuários sejam conectados automaticamente no Learning at Work (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Learning at Work
...
**Para adicionar o Learning at Work por meio da galeria, execute as seguintes etapas:**
...
4. Na caixa de pesquisa, digite **Learning at Work**, selecione **Learning at Work** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Learning at Work na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o Learning at Work, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Learning at Work.
...
2. **[Configurar o logon único do Learning at Work](#configure-learning-at-work-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Learning at Work](#create-learning-at-work-test-user)** – para ter um equivalente de Brenda Fernandes no Learning at Work que esteja vinculado à representação de usuário do Azure AD.
...
Para configurar o logon único do Azure AD com o Learning at Work, execute as seguintes etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Learning at Work**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Learning at Work](common/sp-identifier.png)
...
6. Na seção **Configurar o Learning at Work**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-learning-at-work-single-sign-on"></a>Configurar o logon único do Learning at Work
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Learning at Work**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Learning at Work**.

    ![O link do Learning at Work na lista Aplicativos](common/all-applications.png)
...
Nesta seção, você deve criar uma usuária chamada Brenda Fernandes no Learning at Work. Trabalhe com a [equipe de suporte do Learning at Work](https://www.learninga-z.com/site/contact/support) para adicionar os usuários à plataforma Learning at Work. Os usuários devem ser criados e ativados antes de usar o logon único.
