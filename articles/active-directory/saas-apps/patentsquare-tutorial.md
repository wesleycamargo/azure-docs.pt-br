...
1. Na caixa de pesquisa, digite **PatentSQUARE**, selecione **PatentSQUARE** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste PatentSQUARE](#create-a-patentsquare-test-user)**  - para ter um equivalente de Britta Simon no PatentSQUARE que está vinculado à representação do usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/patentsquare-tutorial/tutorial_patentsquare_samlbase.png)

1. Na seção **URLs e domínio PatentSQUARE** , execute as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/patentsquare-tutorial/tutorial_patentsquare_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/patentsquare-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/patentsquare-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/patentsquare-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/patentsquare-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/patentsquare-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **PatentSQUARE**.

    ![O link PatentSQUARE na lista de aplicativos](./media/patentsquare-tutorial/tutorial_patentsquare_app.png)  
