...
3. **[Criar um usuário de teste do Nomadic](#create-a-nomadic-test-user)** – para ter um equivalente de Brenda Fernandes no Nomadic vinculado à representação do usuário no Azure AD.
...
3. Na seção **Domínio e URLs do Nomadic**, execute as seguintes etapas:
...
6.  Para que o SSO seja configurado para o aplicativo, entre em contato com a [equipe de suporte do Nomadic](mailto:help@nomadic.fm) e forneça os **metadados** baixados.
