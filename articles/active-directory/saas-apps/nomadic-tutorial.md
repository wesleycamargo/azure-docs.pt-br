...
- Você pode permitir que os usuários façam logon automaticamente no Nomadic (Logon Único) com as respectivas contas do Azure AD.
...
1. Adicionar o Nomadic por meio da galeria
...
1. Na caixa de pesquisa, digite **Nomadic**, selecione **Nomadic** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
No Nomadic, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
1. **[Criar um usuário de teste do Nomadic](#create-a-nomadic-test-user)** – para ter um equivalente de Brenda Fernandes no Nomadic vinculado à representação do usuário no Azure AD.
1. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
1. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure AD no Portal do Azure e configurará o logon único no aplicativo Nomadic.

**Para configurar o logon único do Azure AD com o Nomadic, execute as seguintes etapas:**

1. No Portal do Azure, na página de integração de aplicativos do **Nomadic**, clique em **Logon único**.

    ![Link Configurar logon único][4]

1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/nomadic-tutorial/tutorial_nomadic_samlbase.png)

1. Na seção **Domínio e URLs do Nomadic**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Nomadic](./media/nomadic-tutorial/tutorial_nomadic_url.png)

     a. Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<company name>.nomadic.fm/signin`

    b. Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão:`https://<company name>.nomadic.fm/auth/saml2/sp`, `https://<company name>.staging.nomadic.fm/auth/saml2/sp`

    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte ao cliente do Nomadic](mailto:help@nomadic.fm) para obter esses valores. 
 


1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/nomadic-tutorial/tutorial_nomadic_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/nomadic-tutorial/tutorial_general_400.png)

1.  Para que o SSO seja configurado para o aplicativo, entre em contato com a [equipe de suporte do Nomadic](mailto:help@nomadic.fm) e forneça os **metadados** baixados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/nomadic-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/nomadic-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/nomadic-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/nomadic-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Nomadic**.

    ![O link do Nomadic na lista de Aplicativos](./media/nomadic-tutorial/tutorial_nomadic_app.png)  
