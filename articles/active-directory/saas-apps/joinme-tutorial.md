...
* Você pode permitir que os usuários sejam conectados automaticamente ao join.me (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do join.me

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O join.me dá suporte ao SSO iniciado por **IDP**
...
4. Na caixa de pesquisa, digite **join.me**, selecione **join.me** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
     ...
     ![join.me na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o join.me, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do join.me.
...
2. **[Configurar o logon único do join.me](#configure-joinme-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do join.me](#create-joinme-test-user)** – para ter um equivalente de Brenda Fernandes no join.me que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **join.me**, selecione **Logon único**.
...
4. Na seção **Configuração Básica do SAML**, o usuário não precisa executar nenhuma etapa, pois o aplicativo já está pré-integrado ao Azure.
    ...
    ![Informações de logon único de Domínio e URLs do join.me](common/preintegrated.png)
...
### <a name="configure-joinme-single-sign-on"></a>Configurar o logon único do join.me

Para configurar o logon único no lado do **join.me**, é necessário enviar a **URL de Metadados de Federação do Aplicativo** para a [equipe de suporte do join.me](https://help.join.me/s/?language). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **join.me**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **join.me**.

    ![O link do join.me na lista Aplicativos](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>Criar um usuário de teste do join.me
...
Ao clicar no bloco do join.me no Painel de Acesso, você deverá ser conectado automaticamente ao join.me, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
