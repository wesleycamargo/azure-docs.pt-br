...
1. Na caixa de pesquisa, digite **SciQuest Spend Director**, selecione **SciQuest Spend Director** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![SciQuest Spend Director na lista de resultados](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_addfromgallery.png)
...
1. **[Criar um usuário de teste do SciQuest Spend Director](#create-a-sciquest-spend-director-test-user)** - para ter um equivalente de Brenda Fernandes no SciQuest Spend Director vinculado a sua representação Microsoft Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_samlbase.png)

1. Na seção **Domínio e URLs do SciQuest Spend Director**, execute as seguintes etapas:

    ![Informações de logon único em Domínio e URLs do SciQuest Spend Director](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/sciquest-spend-director-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **SciQuest Spend Director**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do SciQuest Spend Director](https://www.jaggaer.com/contact-us/).
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/sciquest-spend-director-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/sciquest-spend-director-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/sciquest-spend-director-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/sciquest-spend-director-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **SciQuest Spend Director**.

    ![O link do SciQuest Spend Director na lista de aplicativos](./media/sciquest-spend-director-tutorial/tutorial_sciquestspenddirector_app.png)  
