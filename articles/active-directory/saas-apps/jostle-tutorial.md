...
4. Na caixa de pesquisa, digite **Jostle**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/jostle-tutorial/tutorial_jostle_search.png)
...
3. Na seção **URLs e Domínio do Jostle**, execute as seguintes etapas:
    ...
    ![Configurar o logon único](./media/jostle-tutorial/tutorial_jostle_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/jostle-tutorial/tutorial_jostle_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/jostle-tutorial/tutorial_general_400.png)
