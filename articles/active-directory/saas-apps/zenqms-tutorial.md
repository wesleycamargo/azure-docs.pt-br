...
- Você pode permitir que seus usuários entrem automaticamente no ZenQMS (Logon Único) com suas contas do Azure Active Directory.
...
Nesta seção, você configurará e testará o logon único do Azure Active Directory com o ZenQMS, com base em um usuário de teste chamado “Brenda Fernandes”.

Para que o logon único funcione, o Azure Active Directory precisa saber qual usuário do ZenQMS é equivalente a um usuário do Azure Active Directory. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure Active Directory e o usuário relacionado no ZenQMS.
...
3. **[Criar um usuário de teste do ZenQMS](#create-a-zenqms-test-user)** – para ter um equivalente de Brenda Fernandes no ZenQMS vinculado à representação do usuário no Azure Active Directory.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure Active Directory no Portal do Azure e configurará o logon único no aplicativo ZenQMS.

**Para configurar o logon único do Azure Active Directory com o ZenQMS, execute as seguintes etapas:**

1. No Portal do Azure, na página de integração de aplicativos do **ZenQMS**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.

    ![Caixa de diálogo Logon único](./media/zenqms-tutorial/tutorial_zenqms_samlbase.png)

3. Na seção **Domínio e URLs do ZenQMS**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IdP**:
...
4. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do ZenQMS](./media/zenqms-tutorial/tutorial_zenqms_url1.png)
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com o Identificador real, a URL de Resposta e a URL de Entrada. Contate a [equipe de suporte ao Cliente do ZenQMS](mailto:help@zenqms.com) para obter esses valores.
...
5. Na seção **Certificado de Autenticação SAML**, clique no botão copiar para copiar a **URL de metadados de federação do aplicativo** e cole-a no Bloco de Notas.
    ...
    ![O link de download do Certificado](./media/zenqms-tutorial/tutorial_zenqms_certificate.png) 

6. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/zenqms-tutorial/tutorial_general_400.png)

7. Para configurar o logon único no lado do **ZenQMS**, é necessário enviar a **URL de metadados de Federação do Aplicativo** para a [equipe de suporte do ZenQMS](mailto:help@zenqms.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/zenqms-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/zenqms-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/zenqms-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/zenqms-tutorial/create_aaduser_04.png)
...
**Para atribuir Brenda Fernandes ao ZenQMS, execute as seguintes etapas:**
...
2. Na lista de aplicativos, selecione **ZenQMS**.
    ...
    ![O link do ZenQMS na lista de Aplicativos](./media/zenqms-tutorial/tutorial_zenqms_app.png)  
