...
* É possível permitir que seus usuários entrem automaticamente no PlanMyLeave (logon único) com suas contas do Azure AD.
...
* Uma assinatura do PlanMyLeave habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O PlanMyLeave é compatível com o SSO iniciado por **SP**

* O PlanMyLeave é compatível com o provisionamento de usuário **Just-In-Time**
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do PlanMyLeave.
...
2. **[Configurar logon único do PlanMyLeave](#configure-planmyleave-single-sign-on)** – para configurar as definições de Logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do PlanMyLeave](#create-planmyleave-test-user)** – para ter um equivalente de Brenda Fernandes no PlanMyLeave que esteja vinculado à representação do usuário no Azure AD.
...
### <a name="configure-planmyleave-single-sign-on"></a>Configurar logon único do PlanMyLeave
...
2. Na lista de aplicativos, selecione **PlanMyLeave**.
    ...
    ![O link do PlanMyLeave na lista de Aplicativos](common/all-applications.png)
...
Nesta seção, um usuário chamado Brenda Fernandes será criado no PlanMyLeave. O PlanMyLeave dá suporte ao provisionamento de usuário just-in-time, que está habilitado por padrão. Não há itens de ação para você nesta seção. Se um usuário ainda não existir no PlanMyLeave, um novo será criado após a autenticação.
...
Ao clicar no bloco do PlanMyLeave no Painel de Acesso, você deverá entrar automaticamente no PlanMyLeave no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
