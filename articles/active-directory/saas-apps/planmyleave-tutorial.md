---
title: 'Tutorial: Integração do Azure Active Directory com o PlanMyLeave | Microsoft Docs'
...
1. Na caixa de pesquisa, digite **PlanMyLeave**, selecione **PlanMyLeave** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste PlanMyLeave](#create-a-planmyleave-test-user)** – para ter um equivalente de Brenda Fernandes no PlanMyLeave que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/planmyleave-tutorial/tutorial_planmyleave_samlbase.png)

1. Na seção **URLs e Domínio do PlanMyLeave**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do PlanMyLeave](./media/planmyleave-tutorial/tutorial_planmyleave_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/planmyleave-tutorial/tutorial_planmyleave_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/planmyleave-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do PlanMyLeave**, clique em **Configurar PlanMyLeave** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configuração do PlanMyLeave](./media/planmyleave-tutorial/tutorial_planmyleave_configure.png) 
1. Em outra janela do navegador da Web, faça logon no locatário do PlanMyLeave como administrador.

1. Acesse **Configuração do Sistema**. Em seguida, na seção **Gerenciamento de Segurança**, clique em **Configurações do SAML da Empresa**.

    ![Configurar o logon único no lado do aplicativo](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

1. Na seção **Configurações de SAML**, clique no ícone do editor.

    ![Configurar o logon único no lado do aplicativo](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)

1. Na seção **Atualizar Configuração do SAML**, execute as seguintes etapas:
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/planmyleave-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/planmyleave-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/planmyleave-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/planmyleave-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **PlanMyLeave**.

    ![O link do PlanMyLeave na lista de Aplicativos](./media/planmyleave-tutorial/tutorial_planmyleave_app.png)  
