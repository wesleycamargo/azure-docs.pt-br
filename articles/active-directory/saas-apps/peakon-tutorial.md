---
title: 'Tutorial: Integração do Active Directory do Azure com o Peakon|Microsoft Docs'
...
3. Na página de diálogo **Novo funcionário**, execute as seguintes etapas:
    ...
    b. No **E-mail** caixa de texto, digite o endereço de e-mail, como **Brittasimon@contoso.com**.
