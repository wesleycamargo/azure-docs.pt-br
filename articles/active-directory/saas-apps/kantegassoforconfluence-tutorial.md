...
1. Na caixa de pesquisa, digite **SSO do Kantega para o Confluence**.
...
1. No painel de resultados, selecione **SSO do Kantega para o Confluence** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criando um usuário de teste do SSO do Kantega para o Confluence](#creating-a-kantega-sso-for-confluence-test-user)** – para ter um equivalente de Brenda Fernandes no SSO do Kantega para o Confluence que esteja vinculado à representação de usuário do Azure AD.
...
1. No modo iniciado pelo **IDP**, na seção **Domínio e URLs do SSO do Kantega para o Confluence**, realize a seguinte etapa:
...
1. Na lista de aplicativos, selecione **SSO do Kantega para o Confluence**.
