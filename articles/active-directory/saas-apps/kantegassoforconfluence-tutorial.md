---
title: 'Tutorial: Integração do Azure Active Directory ao SSO do Kantega para o Confluence | Microsoft Docs'
...
ms.locfileid: "36219414"
---
# <a name="tutorial-azure-active-directory-integration-with-kantega-sso-for-confluence"></a>Tutorial: Integração do Azure Active Directory ao SSO do Kantega para o Confluence
...
- É possível permitir que os usuários se conectem automaticamente ao SSO do Kantega para o Confluence (Logon Único) com suas contas do Azure AD
...
- Uma assinatura habilitada para logon único do SSO do Kantega para o Confluence
...
1. Adicionando o SSO do Kantega para o Confluence por meio da galeria
...
4. Na caixa de pesquisa, digite **SSO do Kantega para o Confluence**.

    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_search.png)

5. No painel de resultados, selecione **SSO do Kantega para o Confluence** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_addfromgallery.png)
...
Para que o logon único funcione, o Azure AD precisa saber qual usuário do SSO do Kantega para o Confluence é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do SSO do Kantega para o Confluence.

No SSO do Kantega para o Confluence, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
3. **[Criando um usuário de teste do SSO do Kantega para o Confluence](#creating-a-kantega-sso-for-confluence-test-user)** – para ter um equivalente de Brenda Fernandes no SSO do Kantega para o Confluence que esteja vinculado à representação de usuário do Azure AD.
4. **[Atribuição do usuário de teste do AD do Azure](#assigning-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do AD do Azure.
5. **[Teste do logon único](#testing-single-sign-on)** : para verificar se a configuração funciona.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuração do logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no portal do Azure e configura o logon único no aplicativo SSO do Kantega para o Confluence.

**Para configurar o logon único do Azure AD com o SSO do Kantega para o Confluence, realize as seguintes etapas:**

1. No portal do Azure, na página de integração do aplicativo **SSO do Kantega para o Confluence**, clique em **Logon único**.

    ![Configurar o logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_samlbase.png)

3. No modo iniciado pelo **IDP**, na seção **Domínio e URLs do SSO do Kantega para o Confluence**, realize a seguinte etapa:

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_url1.png)
...
4. No modo iniciado pelo **SP**, marque a opção **Mostrar configurações de URL avançadas** e realize a seguinte etapa:
    ...
    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_url2.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_certificate.png) 

6. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_general_400.png)
    
7. Em outra janela do navegador da Web, faça logon no **portal de administração do Confluence** como administrador.
...
9. Na guia **ATLASSIAN MARKETPLACE**, clique em **Localizar novos complementos**. 

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon.png)

10. Pesquise **SSO do Kantega para o Confluence SAML e Kerberos** e clique no botão **Instalar** para instalar o novo plug-in do SAML.
...
15. Este novo plug-in também pode ser encontrado na guia **USUÁRIOS E SEGURANÇA**.

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon36.png)
    
16. Na seção **SAML**. Selecione **Azure AD (Azure Active Directory)** na lista suspensa **Adicionar provedor de identidade**.

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon4.png)

17. Selecione o nível de assinatura como **Básico**.

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon5.png)     

18. Na seção **Propriedades do aplicativo**, realize as seguintes etapas: 

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon6.png)

    a. Copie o valor da **URI da ID do Aplicativo** e use-o como **o Identificador, a URL de Resposta e a URL de Logon** na seção **Domínio e URLs do SSO do Kantega para o Confluence** do portal do Azure.

    b. Clique em **Próximo**.

19. Na seção **Importação de metadados**, realize as seguintes etapas: 
...
20. Na seção **Nome e localização de SSO**, realize as seguintes etapas:
...
21. Verifique o Certificado de autenticação e clique em **Avançar**.

    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/addon9.png)

22. Na seção **Contas de usuário do Confluence**, realize as seguintes etapas:
...
24. Na seção **Domínios conhecidos do Azure AD**, realize as seguintes etapas: 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/create_aaduser_01.png) 

2. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/create_aaduser_02.png) 

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/create_aaduser_03.png) 

4. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforconfluence-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-kantega-sso-for-confluence-test-user"></a>Criando um usuário de teste do SSO do Kantega para o Confluence
...
**Para atribuir Brenda Fernandes ao SSO do Kantega para o Confluence, realize as seguintes etapas:**
...
2. Na lista de aplicativos, selecione **SSO do Kantega para o Confluence**.
    ...
    ![Configurar o logon único](./media/kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_app.png) 
...
Quando você clicar no bloco do SSO do Kantega para o Confluence no Painel de Acesso, deverá ser conectado automaticamente ao aplicativo SSO do Kantega para o Confluence.
