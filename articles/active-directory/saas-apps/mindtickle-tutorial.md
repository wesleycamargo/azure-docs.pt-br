---
title: 'Tutorial: Integração do Azure Active Directory com MindTickle | Microsoft Docs'
...
Ao clicar no bloco do MindTickle no Painel de Acesso, você deverá ser conectado automaticamente ao MindTickle no qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
