...
6. Para configurar o logon único no lado do **Moxi Engage**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Moxi Engage](mailto:support@moxiworks.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
