...
3. **[Criar um usuário de testes do Proxyclick](#create-a-proxyclick-test-user)**: para ter um equivalente de Brenda Fernandes no Proxyclick que esteja vinculado à representação do usuário no Azure AD.
...
3. Na seção **Domínio e URLs do Proxyclick**, execute as seguintes etapas se desejar configurar o aplicativo no modo iniciado **IDP**:
...
7. Na seção **Configuração do Proxyclick**, clique em **Configurar o Proxyclick** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Proxyclick](./media/proxyclick-tutorial/tutorial_proxyclick_configure.png)

8. Em outra janela do navegador da Web, faça logon no site de empresa do Proxyclick como administrador.

9. Selecione **Conta e configurações**.

    ![Configuração do Proxyclick](./media/proxyclick-tutorial/configure1.png)

10. Role para baixo até **INTEGRAÇÕES** e selecione **SAML**.

    ![Configuração do Proxyclick](./media/proxyclick-tutorial/configure2.png)

11. Na seção **SAML**, execute as seguintes etapas:
...
4. Na seção **Adicionar um colega**, execute as seguintes etapas:
