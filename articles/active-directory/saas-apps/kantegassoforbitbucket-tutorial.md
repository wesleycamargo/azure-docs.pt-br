...
1. Na caixa de pesquisa, digite **SSO do Kantega para o Bitbucket**.

    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_search.png)

1. No painel de resultados, selecione **SSO do Kantega para o Bitbucket** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_addfromgallery.png)
...
1. **[Criando um usuário de teste do SSO do Kantega para o Bitbucket](#creating-a-kantega-sso-for-bitbucket-test-user)** – para ter um equivalente de Brenda Fernandes no SSO do Kantega para o Bitbucket que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_samlbase.png)

1. No modo iniciado pelo **IDP**, na seção **Domínio e URLs do SSO do Kantega para o Bitbucket**, realize a seguinte etapa:

    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_url1.png)
...
1. No modo iniciado pelo **SP**, marque a opção **Mostrar configurações de URL avançadas** e realize a seguinte etapa:
    ...
    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_url2.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_general_400.png)
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/kantegassoforbitbucket-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **SSO do Kantega para o Bitbucket**.

    ![Configurar o logon único](./media/kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_app.png) 
