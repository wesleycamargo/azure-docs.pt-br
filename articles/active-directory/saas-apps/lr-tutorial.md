...
1. Na caixa de pesquisa, digite **LoginRadius**, selecione **LoginRadius** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do LoginRadius](#create-a-loginradius-test-user)** - para ter um equivalente de Brenda Fernandes no LoginRadius que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/lr-tutorial/tutorial_LoginRadius_samlbase.png)

1. Na seção **Domínio e URLs do LoginRadius**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do LoginRadius](./media/lr-tutorial/tutorial_LoginRadius_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/lr-tutorial/tutorial_LoginRadius_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/lr-tutorial/tutorial_general_400.png)
    
1. Para configurar o logon único no lado do **LoginRadius**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do LoginRadius](mailto:support@loginradius.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/lr-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/lr-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/lr-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/lr-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **LoginRadius**.

    ![O link do LoginRadius na lista de Aplicativos](./media/lr-tutorial/tutorial_LoginRadius_app.png)  
