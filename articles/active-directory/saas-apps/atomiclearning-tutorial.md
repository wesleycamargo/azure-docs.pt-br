...
1. Na caixa de pesquisa, digite **Atomic Learning**.

    ![Criação de um usuário de teste do AD do Azure](./media/atomiclearning-tutorial/tutorial_atomiclearning_search.png)

1. No painel de resultados, selecione **Atomic Learning** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criando um usuário de teste do Atomic Learning](#creating-an-atomic-learning-test-user)** – para ter um equivalente de Brenda Fernandes no Atomic Learning que esteja vinculado à representação de usuário do Azure AD.
...
1. Na seção **Domínio e URLs do Atomic Learning**, realize as seguintes etapas:
...
1. Para configurar o logon único no lado do **Atomic Learning**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Atomic Learning](mailto:cs@atomiclearning.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. Na lista de aplicativos, selecione **Atomic Learning**.
