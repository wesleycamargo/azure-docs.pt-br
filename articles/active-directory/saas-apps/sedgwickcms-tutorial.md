...
1. Na caixa de pesquisa, digite **Sedgwick CMS**, selecione **Sedgwick CMS** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Sedgwick CMS](#create-a-sedgwick-cms-test-user)** – para ter um equivalente de Brenda Fernandes no Sedgwick CMS vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_samlbase.png)

1. Na seção **Domínio e URLs do Sedgwick CMS**, execute as seguintes etapas:
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com o Identificador e a URL de Resposta reais. Entre em contato com a [equipe de suporte do Sedgwick CMS](https://www.sedgwick.com/help) para obter esses valores.
 

1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_certificate.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/sedgwickcms-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/sedgwickcms-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/sedgwickcms-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/sedgwickcms-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Sedgwick CMS**.

    ![O link do Sedgwick CMS na lista de Aplicativos](./media/sedgwickcms-tutorial/tutorial_sedgwickcms_app.png)  
