...
3. Para adicionar o Zscaler ZSCloud, clique o **novo aplicativo** botão na parte superior da caixa de diálogo.

    ![O botão Novo aplicativo][3]

4. Na caixa de pesquisa, digite **Zscaler ZSCloud**.

    ![Provisionamento do Zscaler ZSCloud](./media/zscaler-zscloud-provisioning-tutorial/appsearch.png)

5. No painel de resultados, selecione **Zscaler ZSCloud**e, em seguida, clique no **Add** botão para adicionar o Zscaler ZSCloud à sua lista de aplicativos SaaS.

    ![Provisionamento do Zscaler ZSCloud](./media/zscaler-zscloud-provisioning-tutorial/appsearchresults.png)

    ![Provisionamento do Zscaler ZSCloud](./media/zscaler-zscloud-provisioning-tutorial/appcreation.png)
...
2. Selecione o Zscaler ZSCloud da sua lista de aplicativos SaaS.

    ![Provisionamento do Zscaler ZSCloud](./media/zscaler-zscloud-provisioning-tutorial/appinstancesearch.png)
