...
Nesta seção, você deve criar uma usuária chamada Brenda Fernandes no EthicsPoint Incident Management (EPIM). Trabalhe com a [equipe de suporte do EPIM (EthicsPoint Incident Management)](https://www.navexglobal.com/company/contact-us) para adicionar os usuários à plataforma EPIM (EthicsPoint Incident Management). Os usuários devem ser criados e ativados antes de usar o logon único.
