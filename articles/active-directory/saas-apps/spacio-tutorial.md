...
1. Na caixa de pesquisa, digite **Spacio**, selecione **Spacio** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Spacio](#create-a-spacio-test-user)** – para ter um equivalente de Brenda Fernandes no Spacio que esteja vinculado à representação de usuário no Microsoft Azure Active Directory.
...
1. Na seção **URLs e Domínio do Spacio**, execute as seguintes etapas:
...
1. Para configurar o logon único no lado do **Spacio**, é necessário enviar a **URL de metadados de federação do aplicativo** para a [equipe de suporte do Spacio](mailto:support@spac.io). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Spacio. Trabalhe com a  [equipe de suporte do Spacio](mailto:support@spac.io) para adicionar os usuários à plataforma do Spacio. Os usuários devem ser criados e ativados antes de você usar o logon único
...
1. Na lista de aplicativos, escolha **Spacio**.
