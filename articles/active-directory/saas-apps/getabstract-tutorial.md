...
1. Na caixa de pesquisa, digite **Getabstract**, selecione **Getabstract** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar de um usuário de teste do Getabstract](#create-a-getabstract-test-user)**: para ter um equivalente de Brenda Fernandes no Getabstract que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/getabstract-tutorial/tutorial_getabstract_samlbase.png)

1. Na seção **Domínio e URLs do Getabstract**, execute as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único de Domínio e URLs do Getabstract](./media/getabstract-tutorial/tutorial_getabstract_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do Getabstract](./media/getabstract-tutorial/tutorial_getabstract_url1.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/getabstract-tutorial/tutorial_getabstract_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/getabstract-tutorial/tutorial_general_400.png)
    
1. Para configurar o logon único no lado do **Getabstract**, é necessário enviar o download do **XML de metadados** para a [equipe de suporte do Getabstract](https://www.getabstract.com/en/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/getabstract-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/getabstract-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/getabstract-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/getabstract-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **Getabstract**.
    ...
    ![O link do Getabstract na lista de Aplicativos](./media/getabstract-tutorial/tutorial_getabstract_app.png)  
