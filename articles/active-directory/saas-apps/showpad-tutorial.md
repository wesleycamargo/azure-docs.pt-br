---
title: 'Tutorial: Integração do Azure Active Directory ao Showpad | Microsoft Docs'
...
Neste tutorial, você aprende a integrar o Showpad ao Azure AD (Azure Active Directory).
...
1. Na caixa de pesquisa, digite **Showpad**.

    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/tutorial_showpad_search.png)

1. No painel de resultados, selecione **Showpad** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/tutorial_showpad_addfromgallery.png)
...
No Showpad, atribua o valor do **nome de usuário** no Azure AD como o valor do **Nome de usuário** para estabelecer a relação de vínculo.
...
1. **[Criando um usuário de teste do Showpad](#creating-a-showpad-test-user)** – para ter um equivalente de Brenda Fernandes no Showpad que esteja vinculado à representação de usuário do Azure AD.
1. **[Atribuição do usuário de teste do AD do Azure](#assigning-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do AD do Azure.
1. **[Teste do logon único](#testing-single-sign-on)** : para verificar se a configuração funciona.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuração do logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no portal do Azure e configura o logon único no aplicativo Showpad.

**Para configurar o logon único do Azure AD com o Showpad, execute as seguintes etapas:**

1. No portal do Azure, na página de integração do aplicativo **Showpad**, clique em **Logon único**.

    ![Configurar o logon único][4]

1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Configurar o logon único](./media/showpad-tutorial/tutorial_showpad_samlbase.png)

1. Na seção **Domínio e URLs do Showpad**, realize as seguintes etapas:

    ![Configurar o logon único](./media/showpad-tutorial/tutorial_showpad_url.png)

    a. Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<comapany-name>.showpad.biz/login`

    b. Na caixa de texto **Identificador**, digite uma URL usando o seguinte padrão: `https://<company-name>.showpad.biz`

    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte do Showpad](https://help.showpad.com) para obter esses valores. 
 


1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![Configurar o logon único](./media/showpad-tutorial/tutorial_showpad_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/showpad-tutorial/tutorial_general_400.png)

1. Faça logon no seu locatário do Showpad como administrador.

1. No menu na parte superior, clique em **Configurações**.
   
    ![Configurar o logon único no lado do aplicativo](./media/showpad-tutorial/tutorial_showpad_001.png) 

1. Navegue para “**Logon Único**” e clique em “**Habilitar**”.
   
    ![Configurar o logon único no lado do aplicativo](./media/showpad-tutorial/tutorial_showpad_002.png)

1. No diálogo **Adicionar um Serviço SAML 2.0** , execute as seguintes etapas:
    ...
    c. Copie o conteúdo do arquivo XML de metadados, baixado no portal do Azure e, em seguida, cole-o na caixa de texto **XML de Metadados**.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/create_aaduser_04.png) 
...
Nesta seção, você permite que Brenda Fernandes use o logon único do Azure concedendo acesso ao Showpad.
...
1. Na lista de aplicativos, selecione **Showpad**.

    ![Configurar o logon único](./media/showpad-tutorial/tutorial_showpad_app.png) 
...
Quando você clicar no bloco do Showpad no Painel de Acesso, deverá ser conectado automaticamente ao aplicativo Showpad.
