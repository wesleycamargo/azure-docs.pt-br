...
4. Na caixa de pesquisa, digite **Showpad**.

    ![Criação de um usuário de teste do AD do Azure](./media/showpad-tutorial/tutorial_showpad_search.png)

5. No painel de resultados, selecione **Showpad** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criando um usuário de teste do Showpad](#creating-a-showpad-test-user)** – para ter um equivalente de Brenda Fernandes no Showpad que esteja vinculado à representação de usuário do Azure AD.
...
3. Na seção **Domínio e URLs do Showpad**, realize as seguintes etapas:
...
6. Faça logon no seu locatário do Showpad como administrador.
...
8. Navegue para “**Logon Único**” e clique em “**Habilitar**”.
   
    ![Configurar o logon único no lado do aplicativo](./media/showpad-tutorial/tutorial_showpad_002.png)

9. No diálogo **Adicionar um Serviço SAML 2.0** , execute as seguintes etapas:
