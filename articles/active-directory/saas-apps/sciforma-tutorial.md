...
1. Na caixa de pesquisa, digite **Sciforma**.

    ![Criação de um usuário de teste do AD do Azure](./media/sciforma-tutorial/tutorial_sciforma_search.png)

1. No painel de resultados, selecione **Sciforma** e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criação de um usuário de teste do Sciforma](#creating-a-sciforma-test-user)** – para ter um equivalente de Brenda Fernandes no Sciforma que esteja vinculado à representação do usuário no Azure AD.
...
1. Na seção **URLs e Domínio do Sciforma**, execute as seguintes etapas:
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte do Cliente Sciforma](https://www.sciforma.com/about/contact) para obter esses valores. 
...
1. Para configurar o logon único no lado do **Sciforma**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Sciforma](https://www.sciforma.com/about/contact).
...
1. Na lista de aplicativos, selecione **Sciforma**.
