...
1. Na caixa de pesquisa, digite **Trakopolis**.

    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/tutorial_trakopolis_search.png)

1. No painel de resultados, selecione **Trakopolis** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/tutorial_trakopolis_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Trakopolis](#creating-a-trakopolis-test-user)** – para ter um equivalente de Brenda Fernandes no Trakopolis que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_trakopolis_samlbase.png)

1. Na seção **URLs e Domínio do Trakopolis**, siga as etapas abaixo:

    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_trakopolis_url.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_trakopolis_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Trakopolis**, clique em **Configurar o Trakopolis** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_trakopolis_configure.png) 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/trakopolis-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Trakopolis**.

    ![Configurar o logon único](./media/trakopolis-tutorial/tutorial_trakopolis_app.png) 
