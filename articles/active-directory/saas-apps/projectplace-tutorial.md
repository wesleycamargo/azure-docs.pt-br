...
7. Para configurar o logon único no lado do **Projectplace**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Projectplace](https://success.planview.com/Projectplace/Support). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
