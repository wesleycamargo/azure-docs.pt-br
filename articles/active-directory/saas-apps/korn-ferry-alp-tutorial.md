...
Nesta seção, você criará uma usuária chamado Brenda Fernandes no Korn Ferry ALP. Trabalhe com a [equipe de suporte do Korn Ferry ALP](mailto:noreply@kornferry.com) para adicionar os usuários na plataforma Korn Ferry ALP. Os usuários devem ser criados e ativados antes de usar o logon único.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Quando você clica no bloco Korn Ferry ALP no Painel de Acesso, deve ser conectado automaticamente ao Korn Ferry ALP para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
