...
1. Na caixa de pesquisa, digite **myPolicies**.

    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/tutorial_mypolicies_search.png)

1. No painel de resultados, selecione **myPolicies** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/tutorial_mypolicies_addfromgallery.png)
...
1. **[Criando um usuário de teste do myPolicies](#creating-a-mypolicies-test-user)** – para ter um equivalente de Brenda Fernandes no myPolicies que esteja vinculado à representação de usuário do Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_samlbase.png)

1. Na seção **Domínio e URLs do myPolicies**, realize as seguintes etapas:

    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_url.png)
...
1. O aplicativo myPolicies espera que as declarações SAML estejam em um formato específico, o que exige a adição de mapeamentos de atributo personalizados para a configuração de atributos do token SAML. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção "**Atributos de Usuário**" na página de integração do aplicativo. A captura de tela a seguir mostra um exemplo disso. 
    ...
    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_attribute.png)
...
1. Clique na caixa de seleção **Exibir e editar todos os outros atributos de usuário** na seção **Atributos de Usuário** para expandir os atributos. Realize as seguintes etapas em cada um dos atributos exibidos:
    ...
    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_attribute_05.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do myPolicies**, clique em **Configurar o myPolicies** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_configure.png) 

1. Para configurar o logon único no lado do **myPolicies**, é necessário enviar o **Certificado (Base64)** baixado e a **URL do Serviço de Logon Único SAML** para a [equipe de suporte do myPolicies](mailto:support@mypolicies.com). 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/mypolicies-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **myPolicies**.

    ![Configurar o logon único](./media/mypolicies-tutorial/tutorial_mypolicies_app.png) 
