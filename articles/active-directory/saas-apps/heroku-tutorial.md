...
1. Na caixa de pesquisa, digite **Heroku**.

    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/tutorial_heroku_search.png)

1. No painel de resultados, selecione **Heroku** e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/tutorial_heroku_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Heroku](#creating-a-heroku-test-user)**: para ter um equivalente de Brenda Fernandes no Heroku que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/heroku-tutorial/tutorial_heroku_samlbase.png)

1. Na seção **URLs e Domínio do Heroku**, execute as seguintes etapas:

    ![Configurar o logon único](./media/heroku-tutorial/tutorial_heroku_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/heroku-tutorial/tutorial_heroku_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/heroku-tutorial/tutorial_general_400.png)

1. Para habilitar o SSO no Heroku, execute as seguintes etapas:
...
> [!TIP]
> É possível ler uma versão concisa dessas instruções no [Portal do Azure](https://portal.azure.com), enquanto você estiver configurando o aplicativo!  Depois de adicionar esse aplicativo da seção **Aplicativos Empresariais do Active Directory**, basta clicar na guia **Logon Único** e acessar a documentação inserida por meio da seção **Configuração** na parte inferior. Saiba mais sobre o recurso de documentação inserida aqui: [Documentação inserida do Microsoft Azure Active Directory]( https://go.microsoft.com/fwlink/?linkid=845985)
> 
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/heroku-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, escolha **Heroku**.

    ![Configurar o logon único](./media/heroku-tutorial/tutorial_heroku_app.png) 
