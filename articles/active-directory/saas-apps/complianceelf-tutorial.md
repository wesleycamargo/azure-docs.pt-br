...
4. Na caixa de pesquisa, digite **Compliance ELF**, selecione **Compliance ELF** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
    ...
    ![Compliance ELF na lista de resultados](./media/complianceelf-tutorial/tutorial_complianceelf_addfromgallery.png)
...
6. Clique no botão **Salvar** .
    ...
    ![Botão Salvar em Configurar Logon Único](./media/complianceelf-tutorial/tutorial_general_400.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/complianceelf-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/complianceelf-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/complianceelf-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/complianceelf-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, selecione **Compliance ELF**.
    ...
    ![O link do Compliance ELF na lista de Aplicativos](./media/complianceelf-tutorial/tutorial_complianceelf_app.png)  
