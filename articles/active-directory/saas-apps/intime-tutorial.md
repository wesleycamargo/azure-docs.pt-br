...
* Você pode permitir que os usuários entrem automaticamente no InTime (logon único) com a conta do Azure AD.
...
* Uma assinatura do InTime habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O InTime é compatível com o SSO iniciado por **IdP**
...
Nesta seção, você configurará e testará o logon único do Azure AD com o InTime, usando um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do InTime.
...
2. **[Configurar o Logon Único do InTime](#configure-intime-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do InTime](#create-intime-test-user)** – para que haja um equivalente de Brenda Fernandes no InTime que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **InTime**, selecione **Logon único**.
...
7. Na seção **Configurar o InTime**, copie as URLs apropriadas, de acordo com suas necessidades.
...
### <a name="configure-intime-single-sign-on"></a>Configurar o logon único do InTime

Para configurar o logon único no **InTime**, é necessário enviar o **XML de Metadados de Federação** e as URLs apropriadas copiadas do portal do Azure para [a equipe de suporte do InTime](mailto:hdollard@intimesoft.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, selecione **Todos os aplicativos** e, em seguida, selecione **InTime**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **InTime**.

    ![O link do InTime na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-intime-test-user"></a>Criar um usuário de teste do InTime
...
Ao clicar no bloco do InTime no Painel de Acesso, você será conectado automaticamente ao InTime para o qual configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
