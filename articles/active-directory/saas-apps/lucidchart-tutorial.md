...
* Você pode permitir que os usuários sejam conectados automaticamente ao Lucidchart (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Lucidchart
...
**Para adicionar o Lucidchart por meio da galeria, execute as seguintes etapas:**
...
4. Na caixa de pesquisa, digite **Lucidchart**, selecione **Lucidchart** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Lucidchart na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o Lucidchart, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Lucidchart.
...
2. **[Configurar o logon único do Lucidchart](#configure-lucidchart-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Lucidchart](#create-lucidchart-test-user)** – para ter um equivalente de Brenda Fernandes no Lucidchart que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Lucidchart**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Lucidchart](common/sp-signonurl.png)
...
### <a name="configure-lucidchart-single-sign-on"></a>Configurar o logon único do Lucidchart
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Lucidchart**.
