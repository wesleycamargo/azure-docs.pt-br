...
- Assinatura habilitada para um eDigitalResearch o logon único
...
1. Na caixa de pesquisa, digite **eDigitalResearch**, selecione **eDigitalResearch** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_samlbase.png)

1. Na seção **Domínio e URLs do eDigitalResearch**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do eDigitalResearch](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado Base(64)** e, em seguida, salve o arquivo do certificado em seu computador.

    !![O link de download do Certificado](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/edigitalresearch-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do eDigitalResearch**, clique em **Configurar o eDigitalResearch** para abrir a janela **Configurar logon**. Copie a **URL de Saída e a ID da Entidade SAML** da **seção Referência Rápida.**

    ![Configuração do eDigitalResearch](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_configure.png) 

1. Para configurar o logon único no lado do **eDigitalResearch**, é necessário enviar o **Arquivo de Certificado (Base64)** baixado, a **ID da Entidade SAML** e a **URL de Saída** para a [equipe de suporte do eDigitalResearch](https://www.maruedr.com/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/edigitalresearch-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/edigitalresearch-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/edigitalresearch-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/edigitalresearch-tutorial/create_aaduser_04.png)
...
Trabalhe com a [equipe de suporte do eDigitalResearch](https://www.maruedr.com/contact) para criar os usuários.        
...
1. Na lista de aplicativos, selecione **eDigitalResearch**.

    ![O link eDigitalResearch na lista de Aplicativos](./media/edigitalresearch-tutorial/tutorial_edigitalresearch_app.png)  
