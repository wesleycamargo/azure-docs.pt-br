...
* Você pode permitir que os usuários sejam conectados automaticamente ao eDigitalResearch (Logon Único) com suas contas do Azure AD.
...
* Assinatura do eDigitalResearch habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O eDigitalResearch é compatível com o SSO iniciado por **IDP**
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do eDigitalResearch.
...
2. **[Configurar o Logon Único do eDigitalResearch](#configure-edigitalresearch-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste eDigitalResearch](#create-edigitalresearch-test-user)** – para ter um equivalente de Brenda Fernandes no eDigitalResearch vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **eDigitalResearch**, selecione **Logon único**.
...
4. Na página **Configurar Logon Único com SAML**, execute as seguintes etapas:
    ...
    > [!NOTE]
    > Esses valores não são reais. Atualize esses valores com o Identificador e a URL de Resposta reais. Contate a [equipe de suporte ao cliente do eDigitalResearch](https://www.maruedr.com/contact) para obter esses valores. Você também pode consultar os padrões exibidos na seção **Configuração Básica de SAML** no portal do Azure.

5. Na página **Configurar logon único com SAML**, na seção **Certificado de Autenticação SAML**, clique em **Fazer o download** para fazer o download do **Certificado (Base64)** usando as opções fornecidas de acordo com seus requisitos e salve-o no computador.

    ![O link de download do Certificado](common/certificatebase64.png)

6. Na seção **Configurar o eDigitalResearch**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-edigitalresearch-single-sign-on"></a>Configurar o logon único do eDigitalResearch

Para configurar o logon único no lado do **eDigitalResearch**, é necessário enviar o **Certificado (Base64)** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do eDigitalResearch](https://www.maruedr.com/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, selecione **eDigitalResearch**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **eDigitalResearch**.

    ![O link eDigitalResearch na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-edigitalresearch-test-user"></a>Criar um usuário de teste do eDigitalResearch

Nesta seção, você criará uma usuária chamada Brenda Fernandes no eDigitalResearch. Trabalhe com [equipe de suporte do eDigitalResearch](https://www.maruedr.com/contact) para adicionar os usuários na plataforma do eDigitalResearch. Os usuários devem ser criados e ativados antes de usar o logon único.
...
Ao clicar no bloco do eDigitalResearch no Painel de Acesso, você deverá ser conectado automaticamente ao eDigitalResearch, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
