---
title: 'Tutorial: Integração do Azure Active Directory ao ContractWorks | Microsoft Docs'
...
1. Na caixa de pesquisa, digite **ContractWorks**, selecione **ContractWorks** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do ContractWorks](#create-a-contractworks-test-user)** – para ter um equivalente de Brenda Fernandes no ContractWorks vinculado à representação do usuário no Microsoft Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/contractworks-tutorial/tutorial_contractworks_samlbase.png)

1. Na seção **Domínio e URLs do ContractWorks**, execute as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único de Domínio e URLs do ContractWorks](./media/contractworks-tutorial/tutorial_contractworks_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do ContractWorks](./media/contractworks-tutorial/tutorial_contractworks_url1.png)
...
1. O aplicativo ContractWorks espera que as declarações SAML estejam em um formato específico. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção **Atributos de Usuário** na página de integração de aplicativos. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar o logon único](./media/contractworks-tutorial/tutorial_ContractWorks_attribute.png)
...
1. Na seção **Atributos do usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML na imagem acima e siga as etapas abaixo:
    ...
    ![Configurar o logon único](./media/contractworks-tutorial/tutorial_attribute_04.png)

    ![Configurar o logon único](./media/contractworks-tutorial/tutorial_attribute_05.png)
...
1. Na seção **Certificado de Autenticação SAML** , clique no botão Copiar para copiar a **URL de Metadados de Federação do Aplicativo** e cole-a no Bloco de notas.
    ...
    ![Configurar o logon único](./media/contractworks-tutorial/tutorial_metadataurl.png)
     
1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/contractworks-tutorial/tutorial_general_400.png)

1. Para configurar logon único no **ContractWorks**, é necessário enviar a **URL de metadados de federação do aplicativo** gerada para a [Equipe de suporte do ContractWorks](mailto:support@contractworks.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/contractworks-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/contractworks-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/contractworks-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/contractworks-tutorial/create_aaduser_04.png)
...
Nesta seção, você criará um usuário chamado Brenda Fernandes no ContractWorks. Trabalhe com a [equipe de suporte do ContractWorks](mailto:support@contractworks.com) para adicionar os usuários à plataforma ContractWorks. Os usuários devem ser criados e ativados antes de usar o logon único. 
...
1. Na lista de aplicativos, selecione **ContractWorks**.

    ![O link do ContractWorks na lista de Aplicativos](./media/contractworks-tutorial/tutorial_contractworks_app.png)  
