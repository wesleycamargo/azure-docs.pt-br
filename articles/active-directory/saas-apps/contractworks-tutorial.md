...
* Você pode permitir que os usuários sejam conectados automaticamente ao ContractWorks (Logon Único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do ContractWorks

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* Dá suporte a SSO iniciado por **SP** e **IDP** do ContractWorks
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do ContractWorks.
...
2. **[Configurar o Logon Único do ContractWorks](#configure-contractworks-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do ContractWorks](#create-contractworks-test-user)** – para ter um equivalente de Brenda Fernandes no ContractWorks vinculado à representação do usuário no Microsoft Azure AD.
...
1. No [Portal do Azure](https://portal.azure.com/), na página de integração do aplicativo **ContractWorks**, selecione **Logon único**.
...
4. Na seção **Configuração Básica do SAML**, execute as etapas a seguir caso deseje configurar o aplicativo no modo iniciado por **IDP**:
    ...
    ![Informações de logon único de Domínio e URLs do ContractWorks](common/idp-identifier.png)
...
### <a name="configure-contractworks-single-sign-on"></a>Configurar o Logon Único do ContractWorks

Para configurar logon único no lado do **ContractWorks**, é necessário enviar a **URL de Metadados de Federação do Aplicativo** para a [Equipe de suporte do ContractWorks](mailto:support@contractworks.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **ContractWorks**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **ContractWorks**.

    ![O link do ContractWorks na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-contractworks-test-user"></a>Criar usuário de teste do ContractWorks
...
Ao clicar no bloco do ContractWorks no Painel de Acesso, você deverá ser conectado automaticamente ao ContractWorks no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
