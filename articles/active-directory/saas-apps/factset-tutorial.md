...
* Você pode permitir que os usuários sejam conectados automaticamente ao FactSet (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do FactSet

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O FactSet dá suporte ao SSO iniciado por **SP**
...
4. Na caixa de pesquisa, digite **FactSet**, selecione **FactSet** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.

     ![FactSet na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com o FactSet, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do FactSet.
...
2. **[Configurar o logon único do FactSet](#configure-factset-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do FactSet](#create-factset-test-user)** – para ter um equivalente de Brenda Fernandes no FactSet que esteja vinculado à representação de usuário do Azure AD.
...
Para configurar o logon único do Azure AD com o FactSet, execute as seguintes etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **FactSet**, selecione **Logon único**.
...
6. Na seção **Configurar o FactSet**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **FactSet**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **FactSet**.

    ![O link do FactSet na lista de Aplicativos](common/all-applications.png)
...
Ao clicar no bloco do FactSet no Painel de Acesso, você deverá ser conectado automaticamente ao FactSet, para o qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
