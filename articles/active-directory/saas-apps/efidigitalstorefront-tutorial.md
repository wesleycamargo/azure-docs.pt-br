...
1. Na caixa de pesquisa, digite **EFI Digital StoreFront**, selecione **EFI Digital StoreFront** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.

    ![EFI Digital StoreFront na lista de resultados](./media/efidigitalstorefront-tutorial/tutorial_efidigital_addfromgallery.png)
...
1. **[Criar de um usuário de teste do EFI Digital StoreFront](#create-a-efi-digital-storefront-test-user)** – para ter um equivalente de Britta Simon no EFI Digital StoreFront vinculado à representação do Azure AD de usuário.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/efidigitalstorefront-tutorial/tutorial_efidigital_samlbase.png)

1. Na seção **Domínio e URLs do EFI Digital StoreFront**, realize as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/efidigitalstorefront-tutorial/tutorial_efidigital_certificate.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/efidigitalstorefront-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/efidigitalstorefront-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/efidigitalstorefront-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/efidigitalstorefront-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **EFI Digital StoreFront**.

    ![O link EFI Digital StoreFront na lista de aplicativos](./media/efidigitalstorefront-tutorial/tutorial_efidigital_app.png)  
