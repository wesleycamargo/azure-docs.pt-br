...
1. Na caixa de pesquisa, digite **Panopto**.

    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/tutorial_panopto_search.png)

1. No painel de resultados, selecione **Panopto** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/tutorial_panopto_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Panopto](#creating-a-panopto-test-user)** – para ter um equivalente de Brenda Fernandes no Panopto que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/panopto-tutorial/tutorial_panopto_samlbase.png)

1. Na seção **Domínio e URLs do Panopto**, execute as seguintes etapas:

    ![Configurar o logon único](./media/panopto-tutorial/tutorial_panopto_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/panopto-tutorial/tutorial_panopto_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/panopto-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Panopto**, clique em **Configurar o Panopto** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**

    ![Configurar o logon único](./media/panopto-tutorial/tutorial_panopto_configure.png) 

1. Em uma janela de navegador da Web diferente, faça logon no site de sua empresa do Panopto como administrador.

1. Na barra de ferramentas à esquerda, clique em **Sistema** e, em seguida, clique em **Provedores de Identidade**.
...
1. Na seção de provedor SAML, execute as seguintes etapas:
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/panopto-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Panopto**.

    ![Configurar o logon único](./media/panopto-tutorial/tutorial_panopto_app.png) 
