...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado no Rackspace SSO.
...
5. **[Criar usuário de teste do Rackspace SSO](#create-rackspace-sso-test-user)** – para ter um equivalente de Brenda Fernandes no Rackspace SSO que esteja vinculado à representação do usuário no Azure AD.
...
6. Na seção **Configurar Rackspace SSO**, copie as URLs apropriadas de acordo com suas necessidades.
...
Para configurar o logon único no lado do **Rackspace SSO**, é necessário enviar o **XML de Metadados de Federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Rackspace SSO](https://support.rackspace.com/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
### <a name="create-rackspace-sso-test-user"></a>Criar usuário de teste do Rackspace SSO

Nesta seção, você criará uma usuária chamada Brenda Fernandes no Rackspace SSO. Trabalhe com a  [equipe de suporte do SSO Rackspace](https://support.rackspace.com/) para adicionar os usuários à plataforma do Rackspace SSO. Os usuários devem ser criados e ativados antes de usar o logon único.
