...
1. Na caixa de pesquisa, digite **MOBI**, selecione **MOBI** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar de um usuário de teste do MOBI](#create-a-mobi-test-user)** – para ter um equivalente de Brenda Fernandes no MOBI vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/mobi-tutorial/tutorial_mobi_samlbase.png)

1. Na seção **Domínio e URLs do MOBI**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo IdP:

    ![Informações de logon único de Domínio e URLs do MOBI](./media/mobi-tutorial/tutorial_mobi_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do MOBI](./media/mobi-tutorial/tutorial_mobi_url1.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/mobi-tutorial/tutorial_mobi_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/mobi-tutorial/tutorial_general_400.png)
    
1. Para configurar o logon único no lado do **MOBI**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte MOBI](mailto:sso@mobiwm.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/mobi-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/mobi-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/mobi-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/mobi-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, escolha **MOBI**.

    ![O link do MOBI na lista de Aplicativos](./media/mobi-tutorial/tutorial_mobi_app.png)  
