...
1. Na caixa de pesquisa, digite **Klue**.

    ![Criação de um usuário de teste do AD do Azure](./media/klue-tutorial/tutorial_klue_search.png)

1. No painel de resultados, selecione **Klue** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criando um usuário de teste do Klue](#creating-a-klue-test-user)** – para ter um equivalente de Brenda Fernandes no Klue que esteja vinculado à representação de usuário do Azure AD.
...
1. Na seção **Domínio e URLs do Klue**, se desejar configurar o aplicativo no modo iniciado pelo **IDP**:
...
1. Na seção **Configuração do Klue**, clique em **Configurar o Klue** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/klue-tutorial/tutorial_klue_configure.png) 

1. Para configurar o logon único no lado do **Klue**, é necessário enviar o **Certificado (Base64) baixado, a URL do Serviço de Logon Único SAML e a ID da Entidade SAML** para a [equipe de suporte do Klue](mailto:support@klue.com).
