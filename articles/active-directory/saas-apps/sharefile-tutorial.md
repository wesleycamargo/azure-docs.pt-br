...
1. Na caixa de pesquisa, digite **Citrix ShareFile**, selecione **Citrix ShareFile** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Citrix ShareFile](#create-a-citrix-sharefile-test-user)** – para ter um equivalente de Brenda Fernandes no Citrix ShareFile que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/sharefile-tutorial/tutorial_sharefile_samlbase.png)

1. Na seção **URLs e Domínio do Citrix ShareFile**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do Citrix ShareFile](./media/sharefile-tutorial/tutorial_sharefile_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/sharefile-tutorial/tutorial_sharefile_certificate.png)

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/sharefile-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Citrix ShareFile**, clique em **Configurar Citrix ShareFile** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do Citrix ShareFile](./media/sharefile-tutorial/tutorial_sharefile_configure.png)
...
1. No painel de navegação à esquerda, selecione **Configurar Logon Único**.
   
    ![Administração de Conta](./media/sharefile-tutorial/ic773627.png "Administração de Conta")

1. Na página **Configuração de Logon Único/SAML 2.0** em **Configurações Básicas**, realize as seguintes etapas:
...
1. Clique em **Salvar** no portal de gerenciamento do Citrix ShareFile.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/sharefile-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/sharefile-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/sharefile-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/sharefile-tutorial/create_aaduser_04.png)
...
1. Clique em **Gerenciar Usuários \> Gerenciar Página Inicial dos Usuários \> + Criar Funcionário**.
   
   ![Criar Funcionário](./media/sharefile-tutorial/IC781050.png "Criar Funcionário")

1. Na seção **Informações Básicas**, execute as etapas abaixo:
...
1. Na lista de aplicativos, selecione **Citrix ShareFile**.
    ...
    ![O link do Citrix ShareFile na lista de Aplicativos](./media/sharefile-tutorial/tutorial_sharefile_app.png)  
