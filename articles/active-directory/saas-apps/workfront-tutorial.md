...
1. Na caixa de pesquisa, digite **Workfront**.

    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/tutorial_workfront_search.png)

1. No painel de resultados, selecione **Workfront** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/tutorial_workfront_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Workfront](#creating-a-workfront-test-user)** – para ter um equivalente de Brenda Fernandes no Workfront que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/workfront-tutorial/tutorial_workfront_samlbase.png)

1. Na seção **URLs e Domínio do Workfront**, execute as seguintes etapas:

    ![Configurar o logon único](./media/workfront-tutorial/tutorial_workfront_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/workfront-tutorial/tutorial_workfront_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/workfront-tutorial/tutorial_general_400.png)

1. Na seção **Configuração do Workfront**, clique em **Configurar Workfront** para abrir a janela **Configurar logon**. Copie a **URL do serviço de logon único do SAML e a URL de logoff** da **seção de Referência Rápida.**

    ![Configurar o logon único](./media/workfront-tutorial/tutorial_workfront_configure.png) 

1. Faça logon no site da empresa Workfront como administrador.

1. Vá para **Configuração de Logon Único**.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/workfront-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, escolha **Workfront**.

    ![Configurar o logon único](./media/workfront-tutorial/tutorial_workfront_app.png) 
