...
1. Na caixa de pesquisa, digite **SilkRoad Life Suite**, selecione **SilkRoad Life Suite** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

    ![SilkRoad Life Suit na lista de resultados](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_addfromgallery.png)
...
1. **[Criar um usuário de teste do SilkRoad Life Suite](#create-a-silkroad-life-suite-test-user)** - para ter um equivalente de Brenda Fernandes no SilkRoad Life Suite que esteja vinculado à representação dela no Microsoft Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_samlbase.png)

1. Na seção **URLs e Domínio do SilkRoad Life Suite**, execute as seguintes etapas:
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![O link de download do Certificado](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/silkroad-life-suite-tutorial/tutorial_general_400.png)
    
1. Na seção **Configuração do SilkRoad Life Suite**, clique em **Configurar o SilkRoad Life Suite** para abrir a janela **Configurar logon**. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**

    ![Configuração do SilkRoad Life Suite](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_configure.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/silkroad-life-suite-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/silkroad-life-suite-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/silkroad-life-suite-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/silkroad-life-suite-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, selecione **SilkRoad Life Suite**.

    ![Link do SilkRoad Life Suite na lista de aplicativos](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_app.png)  
