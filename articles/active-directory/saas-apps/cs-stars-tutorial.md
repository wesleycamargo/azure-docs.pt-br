...
1. Na caixa de pesquisa, digite **CS Stars**.

    ![Criação de um usuário de teste do AD do Azure](./media/cs-stars-tutorial/tutorial_csstars_search.png)

1. No painel de resultados, selecione **CS Stars** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/cs-stars-tutorial/tutorial_csstars_addfromgallery.png)
...
1. **[Como criar um usuário de teste do CS Stars](#creating-a-cs-stars-test-user)** – para ter um equivalente de Brenda Fernandes no CS Stars que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/cs-stars-tutorial/tutorial_csstars_samlbase.png)

1. Na seção **URLs e Domínio do CS Stars**, execute as seguintes etapas:
    ...
    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de suporte ao Cliente do CS Stars](https://www.marshclearsight.com/support/) para obter esses valores. 
 
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![Configurar o logon único](./media/cs-stars-tutorial/tutorial_csstars_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar Logon Único](./media/cs-stars-tutorial/tutorial_general_400.png) 
<CS>
1. Para configurar o logon único no lado do **CS Stars**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do CS Stars](https://www.marshclearsight.com/support/). 
<CE>
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/cs-stars-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/cs-stars-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/cs-stars-tutorial/create_aaduser_03.png) 
...
Para obter um usuário criado no CS Stars, você precisa entrar em contato com a [equipe de suporte do CS Stars](https://www.marshclearsight.com/support/).
...
1. Na lista de aplicativos, selecione **CS Stars**.

    ![Configurar o logon único](./media/cs-stars-tutorial/tutorial_csstars_app.png) 
