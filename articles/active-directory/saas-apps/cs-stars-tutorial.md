...
<CS>
1. Para configurar o logon único no lado do **CS Stars**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do CS Stars](http://www.marshclearsight.com/support/). 
<CE>
