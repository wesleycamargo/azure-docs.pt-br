...
4. Na caixa de pesquisa, digite **Aravo**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/aravo-tutorial/tutorial_aravo_search.png)

5. No painel de resultados, selecione **Aravo** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/aravo-tutorial/tutorial_aravo_addfromgallery.png)
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/aravo-tutorial/tutorial_aravo_samlbase.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/aravo-tutorial/tutorial_aravo_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/aravo-tutorial/tutorial_general_400.png)
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/aravo-tutorial/create_aaduser_01.png) 

2. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/aravo-tutorial/create_aaduser_02.png) 

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/aravo-tutorial/create_aaduser_03.png) 
...
2. Na lista de aplicativos, escolha **Aravo**.
    ...
    ![Configurar o logon único](./media/aravo-tutorial/tutorial_aravo_app.png) 
