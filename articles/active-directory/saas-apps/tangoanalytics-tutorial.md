...
1. Na caixa de pesquisa, digite **Tango Analytics**.

    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_search.png)

1. No painel de resultados, selecione **Tango Analytics** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_addfromgallery.png)
...
1. **[Criação um usuário de teste do Tango Analytics](#creating-a-tango-analytics-test-user)** – para ter um equivalente de Brenda Fernandes no Tango Analytics que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_samlbase.png)

1. Na seção **URLs e Domínio do Tango Analytics**, execute as seguintes etapas:

    ![Configurar o logon único](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.
    ...
    ![Configurar o logon único](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/tangoanalytics-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Tango Analytics**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Tango Analytics](mailto:support@tangoanalytics.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/tangoanalytics-tutorial/create_aaduser_04.png) 
...
Nesta seção, você criará uma usuária chamada Brenda Fernandes no Tango Analytics. Trabalhe em conjunto com a  [equipe de suporte do Tango Analytics](mailto:support@tangoanalytics.com)  para adicionar os usuários na plataforma Tango Analytics. Os usuários devem ser criados e ativados antes de usar o logon único.
...
1. Na lista de aplicativos, selecione **Tango Analytics**.

    ![Configurar o logon único](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_app.png) 
