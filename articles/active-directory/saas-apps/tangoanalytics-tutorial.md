...
6. Para configurar o logon único no lado do **Tango Analytics**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte do Tango Analytics](mailto:support@tangoanalytics.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
