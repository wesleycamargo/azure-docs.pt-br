...
* É possível permitir que os usuários entrem automaticamente no Tango Analytics (Logon Único) com suas contas do Azure AD.
...
* Uma assinatura do Tango Analytics habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O Tango Analytics é compatível com o SSO iniciado por **IDP**
...
4. Na caixa de pesquisa, digite **Tango Analytics**, selecione **Tango Analytics** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.

     ![Tango Analytics na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Tango Analytics.
...
2. **[Configurar o logon único do Tango Analytics](#configure-tango-analytics-single-sign-on)** – para configurar as definições de Logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do Tango Analytics](#create-tango-analytics-test-user)** – para ter um equivalente de Brenda Fernandes no Tango Analytics que esteja vinculado à representação do usuário no Azure AD.
...
Para configurar o logon único do Azure AD com o Tango Analytics, siga estas etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Tango Analytics**, selecione **Logon único**.
...
4. Na página **Configurar Logon Único com SAML**, execute as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Tango Analytics](common/idp-intiated.png)
...
6. Na seção **Configurar Tango Analytics**, copie a URL apropriada, de acordo com suas necessidades.
...
### <a name="configure-tango-analytics-single-sign-on"></a>Configurar logon único do Tango Analytics

Para configurar o logon único no lado do **Tango Analytics**, é necessário enviar o **XML de Metadados de Federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Tango Analytics](mailto:support@tangoanalytics.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, selecione **Tango Analytics**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Tango Analytics**.

    ![O link do Tango Analytics na lista de aplicativos](common/all-applications.png)
...
### <a name="create-tango-analytics-test-user"></a>Criar usuário de teste do Tango Analytics
...
Ao clicar no bloco do Tango Analytics no Painel de Acesso, você deverá entrar automaticamente no Tango Analytics no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
