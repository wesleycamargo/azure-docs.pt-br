...
1. Na caixa de pesquisa, digite **Sequr**, selecione **Sequr** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Sequr](#create-a-sequr-test-user)** – para ter um equivalente de Brenda Fernandes no Sequr que esteja vinculado à representação de usuário do Microsoft Azure Active Directory.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/sequr-tutorial/tutorial_sequr_samlbase.png)

1. Na seção **Domínio e URLs do Sequr**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IdP**:

    ![Informações de logon único em Domínio e URLs do Sequr](./media/sequr-tutorial/tutorial_sequr_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único em Domínio e URLs do Sequr](./media/sequr-tutorial/tutorial_sequr_url1.png)
...
1. Na seção **Certificado de Autenticação do SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado no computador.
    ...
    ![O link de download do Certificado](./media/sequr-tutorial/tutorial_sequr_certificate.png) 

1. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/sequr-tutorial/tutorial_general_400.png)
    
1. Na seção **Configuração do Sequr**, clique em **Configurar o Sequr** para abrir a janela **Configurar logon**. Copie a **URL de serviço de logon único SAML** da **seção de Referência Rápida.**

    ![Configuração do Sequr](./media/sequr-tutorial/tutorial_sequr_configure.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/sequr-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/sequr-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/sequr-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/sequr-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, escolha **Sequr**.

    ![O link do Sequr na lista de Aplicativos](./media/sequr-tutorial/tutorial_sequr_app.png)  
