...
4. Na caixa de pesquisa, digite **Netsuite**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. No painel de resultados, selecione **Netsuite** e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
...
11. Na página **Instalação do SAML** , realize as seguintes etapas:
    ...
    ![Configurar o logon único](./media/netsuite-tutorial/ns-sso-setup.png)
