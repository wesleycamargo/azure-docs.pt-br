...
1. Na caixa de pesquisa, digite **Settling music**, selecione **Settling music** no painel de resultados e clique no botão **Add** para adicionar o aplicativo.
...
1. **[ Crie um usuário de teste de música Estabelecedora ](#create-a-settling-music-test-user)** - para ter uma contraparte de Brenda Fernandes na organização de músicas vinculadas à representação de usuário do Azure AD.
...
1. Na seção **URLs e Domínio do Settling music**, execute as seguintes etapas:
...
1. Na seção **Configuração do Settling music**, clique em **Configurar Settling music** para abrir a janela **Configurar Logon**. Copie a **URL do serviço de logon único do SAML e a URL de logoff** da **seção de Referência Rápida.**

    ![Configuração do Settling music](./media/settlingmusic-tutorial/tutorial_settlingmusic_configure.png) 

1. Em uma janela diferente do navegador da Web, faça logon no Settling music como Administrador de segurança.

1. Na parte superior da página, clique na guia **gerenciamento**.

    ![Settling music etapa 1](./media/settlingmusic-tutorial/tutorial_settlingmusic_step1.png)

1. Clique na guia **Configuração do sistema**.

    ![Settling music etapa 2](./media/settlingmusic-tutorial/tutorial_settlingmusic_step2.png)

1. Alterne para a guia **Segurança**.
...
1. Na lista de aplicativos, escolha **Settling music**.
