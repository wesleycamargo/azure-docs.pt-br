...
* Você pode controlar no Azure Active Directory quem tem acesso ao Oneteam.
* Você pode permitir que os usuários sejam conectados automaticamente ao Oneteam (Logon Único) com suas contas do Azure Active Directory.
...
* O Oneteam dá suporte ao SSO iniciado por **SP** e **IDP**

* O Oneteam é compatível com o provisionamento de usuário **Just-In-Time**
...
4. Na caixa de pesquisa, digite **Oneteam**, selecione **Oneteam** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Oneteam na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure Active Directory com o Oneteam, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure Active Directory e o usuário relacionado do Oneteam.
...
2. **[Configurar o Logon Único do Oneteam](#configure-oneteam-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Oneteam](#create-oneteam-test-user)** – para ter um equivalente de Brenda Fernandes no Oneteam que esteja vinculado à representação desse usuário no Azure Active Directory.
...
Para configurar o logon único do Azure Active Directory com o Oneteam, execute as seguintes etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Oneteam**, selecione **Logon único**.
...
5. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    ![Informações de logon único de Domínio e URLs do Oneteam](common/metadata-upload-additional-signon.png)

    Na caixa de texto **URL de login**, digite um URL usando o seguinte padrão: `https://<team name>.one-team.io/`
...
7. Na seção **Configurar o Oneteam**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Oneteam**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Oneteam**.

    ![O link do Oneteam na lista de Aplicativos](common/all-applications.png)
...
### <a name="create-oneteam-test-user"></a>Criar um usuário de teste do Oneteam
...
Ao clicar no bloco do Oneteam no Painel de Acesso, você deverá ser conectado automaticamente ao Oneteam no qual você configurou o SSO. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
