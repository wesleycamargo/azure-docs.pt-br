...
1. Na caixa de pesquisa, digite **FloQast**, selecione **FloQast** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar de um usuário de teste do FloQast](#create-a-floqast-test-user)** - para ter um equivalente de Brenda Fernandes no FloQast que esteja vinculado à representação de usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/floqast-tutorial/tutorial_floqast_samlbase.png)

1. Na seção **Domínio e URLs do FloQast**, realize as seguintes etapas se desejar configurar o aplicativo no modo iniciado pelo **IDP**:

    ![Informações de logon único de Domínio e URLs do FloQast](./media/floqast-tutorial/tutorial_floqast_url.png)
...
1. Marque **Mostrar configurações avançadas de URL** e realize a seguinte etapa se quiser configurar o aplicativo no modo iniciado pelo **SP**:
    ...
    ![Informações de logon único de Domínio e URLs do FloQast](./media/floqast-tutorial/tutorial_floqast_url1.png)
...
1. O aplicativo FloQast espera que as declarações SAML estejam em um formato específico. Configure as declarações a seguir para este aplicativo. Você pode gerenciar os valores desses atributos da seção **Atributos de Usuário** na página de integração de aplicativos. A captura de tela a seguir mostra um exemplo disso.
    ...
    ![Configurar o atributo Logon único](./media/floqast-tutorial/tutorial_floqast_attribute.png)
...
1. Na seção **Atributos do Usuário**, na caixa de diálogo **Logon único**, configure o atributo do token SAML como mostra a imagem e execute as etapas a seguir:
    ...
    ![Configurar logon único Add](./media/floqast-tutorial/tutorial_attribute_04.png)

    ![Configurar logon único Addattb](./media/floqast-tutorial/tutorial_attribute_05.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador e realize as seguintes etapas:

    ![O link de download do Certificado](./media/floqast-tutorial/tutorial_floqast_certificate.png)
...
1. Clique no botão **Salvar** .
    ...
    ![Botão Salvar em Configurar Logon Único](./media/floqast-tutorial/tutorial_general_400.png)
    
1. Para configurar o logon único no lado do **FloQast**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do FloQast](mailto:support@floqast.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/floqast-tutorial/create_aaduser_01.png)

1. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/floqast-tutorial/create_aaduser_02.png)

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/floqast-tutorial/create_aaduser_03.png)

1. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/floqast-tutorial/create_aaduser_04.png)
...
1. Na lista de aplicativos, escolha **FloQast**.
    ...
    ![O link do FloQast na lista de Aplicativos](./media/floqast-tutorial/tutorial_floqast_app.png)  
