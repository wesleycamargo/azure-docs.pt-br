...
1. Na caixa de pesquisa, digite **Eli Onboarding**, selecione **Eli Onboarding** no painel de resultados e clique no botão **Adicionar** para adicionar o aplicativo.
...
1. **[Criar um usuário de teste do Eli Onboarding](#create-an-eli-onboarding-test-user)** – para ter um equivalente de Brenda Fernandes no Eli Onboarding que esteja vinculado à representação de usuário do Azure AD.
...
1. Na seção **URLs e Domínio do Eli Onboarding**, execute as seguintes etapas:
...
1. Para configurar o lado do **Eli Onboarding** de logon único, você precisa enviar o **XML de Metadados** baixado para [a equipe de suporte do Eli Onboarding](mailto:support@geteli.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. Na lista de aplicativos, escolha **Eli Onboarding**.
