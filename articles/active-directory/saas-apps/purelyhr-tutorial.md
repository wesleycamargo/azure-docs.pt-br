...
* Você pode permitir que seus usuários entrem automaticamente no PurelyHR (logon único) com suas contas do Azure AD.
...
* Uma assinatura do PurelyHR habilitada para logon único

## <a name="scenario-description"></a>Descrição do cenário

Neste tutorial, você configurará e testará o logon único do Azure AD em um ambiente de teste.

* O PurelyHR é compatível com SSO iniciado por **SP** e **IDP**
...
4. Na caixa de pesquisa, digite **PurelyHR**, selecione **PurelyHR** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![PurelyHR na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do PurelyHR.
...
2. **[Configurar o logon único do PurelyHR](#configure-purelyhr-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do PurelyHR](#create-purelyhr-test-user)** – para ter um equivalente de Brenda Fernandes no PurelyHR que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **PurelyHR**, selecione **Logon único**.
...
4. Na seção **Configuração Básica do SAML**, caso deseje configurar o aplicativo no modo iniciado por **IDP** execute a seguinte etapa:
    ...
    ![Informações de logon único em Domínio e URLs do PurelyHR](common/both-replyurl.png)
...
5. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    ![Informações de logon único em Domínio e URLs do PurelyHR](common/both-signonurl.png)

    Na caixa de texto **URL de login**, digite um URL usando o seguinte padrão: `https://<companyID>.purelyhr.com/sso-initiate`
...
7. Na seção **Configurar o PurelyHR**, copie as URLs apropriadas, de acordo com suas necessidades.
...
### <a name="configure-purelyhr-single-sign-on"></a>Configurar o logon único do PurelyHR

1. Para configurar o logon único no lado do **PurelyHR**, entre no site deles como um administrador.

2. Abra o **Painel** das opções na barra de ferramentas e clique em **Configurações de SSO**.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **PurelyHR**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **PurelyHR**.

    ![O link do PurelyHR na lista de Aplicativos](common/all-applications.png)
...
Para permitir que os usuários do Azure AD entrem no PurelyHR, eles devem ser provisionados no PurelyHR. No PurelyHR, o provisionamento é uma tarefa automática e nenhuma etapa manual é necessária quando o provisionamento de usuários automático está habilitado.

### <a name="test-single-sign-on"></a>Testar logon único 

Nesta seção, você testará sua configuração de logon único do Azure AD usando o Painel de Acesso.

Ao clicar no bloco do PurelyHR no Painel de Acesso, você deverá ser conectado automaticamente ao PurelyHR com SSO configurado. Para saber mais sobre o Painel de Acesso, veja [Introdução ao Painel de Acesso](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
