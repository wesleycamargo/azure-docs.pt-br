...
1. Na caixa de pesquisa, digite **Lynda.com**.

    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/tutorial_lynda.com_search.png)

1. No painel de resultados, selecione **Lynda.com** e clique no botão **Adicionar** para adicionar o aplicativo.

    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/tutorial_lynda.com_addfromgallery.png)
...
1. **[Criação de um usuário de teste do Lynda.com](#creating-a-lyndacom-test-user)** – para ter um equivalente de Brenda Fernandes no Lynda.com que esteja vinculado à representação do usuário no Azure AD.
...
1. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/lynda-tutorial/tutorial_lynda.com_samlbase.png)

1. Na seção **Domínio e URLs do Lynda.com**, execute as seguintes etapas:

    ![Configurar o logon único](./media/lynda-tutorial/tutorial_lynda.com_url.png)
...
1. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo XML em seu computador.
    ...
    ![Configurar o logon único](./media/lynda-tutorial/tutorial_lynda.com_certificate.png) 

1. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/lynda-tutorial/tutorial_general_400.png)

1. Para configurar o logon único no lado do **Lynda.com**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Lynda.com](https://www.linkedin.com/help/lynda/ask).
...
1. No **Portal do Azure**, no painel de navegação esquerdo, clique no ícone **Azure Active Directory**.
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/create_aaduser_01.png) 

1. Vá para **Usuários e grupos** e clique em **Todos os usuários** para exibir a lista de usuários.
    
    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/create_aaduser_02.png) 

1. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo.
 
    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/create_aaduser_03.png) 

1. Na página do diálogo **Usuário**, execute as seguintes etapas:
 
    ![Criação de um usuário de teste do AD do Azure](./media/lynda-tutorial/create_aaduser_04.png) 
...
1. Na lista de aplicativos, selecione **Lynda.com**.

    ![Configurar o logon único](./media/lynda-tutorial/tutorial_lynda.com_app.png) 
...
Se você quiser testar suas configurações de logon único, abra o Painel de Acesso. Para saber mais sobre o Painel de Acesso, confira  [Introdução ao Painel de Acesso](../user-help/active-directory-saas-access-panel-introduction.md). 
