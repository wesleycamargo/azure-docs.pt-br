...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/fuse-tutorial/tutorial_fuse_samlbase.png)

3. Na seção **URLs e Domínio do Fuse**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do fusível](./media/fuse-tutorial/tutorial_fuse_url.png)
    
    Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<tenant name>.fusionuniversal.com/`
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Bruto)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![O link de download do Certificado](./media/fuse-tutorial/tutorial_fuse_certificate.png) 

5. Clique no botão **Salvar** .

    ![Botão Salvar em Configurar Logon Único](./media/fuse-tutorial/tutorial_general_400.png)
...
6. No **configuração fusível** seção, clique em **configurar fusível** para abrir **logon** janela. Copie a **URL de saída, a ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção de Referência Rápida.**
    ...
    ![Configuração do Fuse](./media/fuse-tutorial/tutorial_fuse_configure.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/fuse-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/fuse-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/fuse-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/fuse-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **Fuse**.
    ...
    ![O link do Fuse na lista de Aplicativos](./media/fuse-tutorial/tutorial_fuse_app.png)  
