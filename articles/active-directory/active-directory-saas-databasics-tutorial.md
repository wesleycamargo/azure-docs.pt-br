...
- Você pode permitir que usuários se conectem automaticamente ao DATABASICS (Logon Único) com as respectivas contas do Azure AD.
...
- Uma assinatura habilitada para logon único do DATABASICS
...
1. Adicionando o DATABASICS da galeria
...
Nesta seção, você vai configurar e testar o logon único do Azure AD com o DATABASICS, com base em uma usuária de teste chamada "Brenda Fernandes".

Para que o logon único funcione, o Azure AD precisa saber qual usuário do DATABASICS é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vinculação entre um usuário do Azure AD e o usuário relacionado do DATABASICS.

No DATABASICS, atribua o valor de **nome de usuário** no Azure AD como o valor de **Nome de usuário** para estabelecer a relação de vinculação.
...
3. **[Criar um usuário de teste do DATABASICS](#create-a-databasics-test-user)** – para ter um equivalente de Brenda Fernandes no DATABASICS vinculado à representação do usuário no Azure AD.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Teste o logon único](#test-single-sign-on)** – para verificar se a configuração funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configurar o logon único do Azure AD

Nesta seção, você habilita o logon único do Azure AD no portal do Azure e configura o logon único no aplicativo DATABASICS.

**Para configurar o logon único do Azure AD com o DATABASICS, execute as seguintes etapas:**

1. No portal do Azure, na página de integração de aplicativos do **DATABASICS**, clique em **Logon único**.

    ![Link Configurar logon único][4]

2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
 
    ![Caixa de diálogo Logon único](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_samlbase.png)

3. Na seção **Domínio e URLs do DATABASICS**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do DATABASICS](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_url.png)

    a. Na caixa de texto **Identificador**, digite o valor: `DATA-BASICS_SP`
    
    b. Na caixa de texto **URL de Logon**, digite uma URL usando o seguinte padrão: `https://<sitenumber>.data-basics.net/<clientname>/saml_sso.jsp`

    > [!NOTE] 
    > Esses valores não são reais. Atualize esses valores com a URL de Entrada e o Identificador reais. Contate a [equipe de Suporte ao cliente do DATABASICS](https://www.data-basics.com/support/) para obter esses valores.

4. Na seção **Certificado de Autenticação SAML**, clique em **Metadados XML** e, em seguida, salve o arquivo de metadados em seu computador.

    ![O link de download do Certificado](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_certificate.png) 
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-databasics-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-databasics-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-databasics-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-databasics-tutorial/create_aaduser_04.png)
...
### <a name="create-a-databasics-test-user"></a>Criar um usuário de teste do DATABASICS
...
**Para atribuir Brenda Fernandes ao DATABASICS, execute as seguintes etapas:**
...
2. Na lista de aplicativos, selecione **DATABASICS**.
    ...
    ![O link do DATABASICS na lista Aplicativos](./media/active-directory-saas-databasics-tutorial/tutorial_databasics_app.png)  
...
Ao clicar no bloco DATABASICS no Painel de Acesso, você deverá ser conectado automaticamente ao seu aplicativo DATABASICS.
