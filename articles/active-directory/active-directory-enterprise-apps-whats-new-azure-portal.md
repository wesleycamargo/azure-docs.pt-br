...
---
# O que há de novo no gerenciamento de aplicativos empresariais no Azure Active Directory
...
## Melhorias à Galeria de Aplicativos do Azure Active Directory
...
## Adicionar aplicativos personalizados de um só lugar
...
### Implantação de aplicativos existentes
...
## Início rápido: Começar a usar seu novo aplicativo imediatamente
...
## Configuração de proxy de aplicativo atualizada
...
## Configuração avançada de logon único federado
...
### Parâmetro de estado de retransmissão
...
## Configurar o acesso ao aplicativo de autoatendimento
