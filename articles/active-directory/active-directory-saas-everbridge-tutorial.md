<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao Everbridge | Microsoft Azure"
...
# Tutorial: integração do Azure Active Directory ao Everbridge
...
## Adicionar Everbridge da galeria
...
3. **[Criação de um usuário de teste do Everbridge](#creating-a-everbridge-test-user)** - para ter um equivalente de Brenda Fernandes no Everbridge que esteja vinculado à representação dela no Azure AD.
...
3. Na página de caixa de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
    ...
    a. Na caixa de texto **URL de Identificador**, digite a URL no seguinte padrão: `https://sso.everbridge.net/{<company name>}`

	b. Na caixa de texto **URL de resposta**, digite a URL no seguinte padrão: `https://manager.everbridge.net/saml/SSO/{<company name>}/alias/defaultAlias`
...
6. No menu na parte superior, clique na guia **Configurações** e selecione **Logon Único** em **Segurança**.
	...
	![Configurar o logon único](./media/active-directory-saas-everbridge-tutorial/tutorial_everbridge_002.png)
