...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_samlbase.png)

3. Na seção **Domínio e URLs do Condeco**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_general_400.png)

6. Para configurar o logon único no lado do **Condeco**, é necessário enviar o **XML de metadados** baixado para a [equipe de suporte do Condeco](mailTo:supportna@condecosoftware.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
2. Na lista de aplicativos, selecione **Condeco**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_app.png) 
