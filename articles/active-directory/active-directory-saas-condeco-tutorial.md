---
title: 'Tutorial: integração do Active Directory do Azure ao Condeco | Microsoft Docs'
...
O objetivo deste tutorial é mostrar como integrar o Condeco ao Azure AD (Azure Active Directory). A integração do Condeco ao Azure AD oferece os seguintes benefícios:
...
7. No painel de resultados, selecione **Condeco** e clique em **Concluir** para adicionar o aplicativo.
...
1. No Portal Clássico do Azure, na página de integração de aplicativos do **Condeco**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
O objetivo desta seção é testar sua configuração de logon único do Azure AD usando o Painel de Acesso. Quando você clica no bloco Condeco no Painel de Acesso, deve fazer logon automaticamente no seu aplicativo do Condeco.
