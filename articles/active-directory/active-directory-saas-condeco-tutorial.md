...
**Para adicionar o Condeco a partir da galeria, realize as seguintes etapas:**
...
7. No painel de resultados, selecione **Condeco** e clique em **Concluir** para adicionar o aplicativo. <br><br>
...
O objetivo desta seção é habilitar o logon único do Azure AD no portal do Azure AD e configurar o logon único em seu aplicativo do Condeco.



**Para configurar o logon único do Azure AD com o Condeco, realize as seguintes etapas:**

1. No portal do Azure AD, na página de integração de aplicativos do **Condeco**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**. <br><br> ![Configurar o logon único][6] <br>
...
3. Na página do diálogo **Definir Configurações de Aplicativo**, realize as seguintes etapas: <br><br>![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_04.png) <br>
...
4. Na página **Configurar logon único no Condeco**, realize as seguintes etapas: <br><br>![Configurar o logon único](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_05.png) <br>
...
5. Para obter o SSO configurado para o seu aplicativo, entre em contato com sua equipe de suporte do Condesco por meio do supportna@condecosoftware.com e anexe o arquivo de metadados baixado ao seu email.
...
1. No **Portal de Gerenciamento do Azure**, no painel de navegação esquerdo, clique em **Active Directory**. <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_09.png) <br>
...
4. Para abrir a caixa de diálogo **Adicionar Usuário**, na barra de ferramentas na parte inferior, clique em **Adicionar Usuário**. <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_04.png) <br>

5. Na página do diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas: <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_05.png) <br>
...
6.  Na página do diálogo **Perfil do Usuário**, realize as seguintes etapas: <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_06.png) <br>
...
7. Na página do diálogo **Obter senha temporária**, clique em **criar**. <br><br> ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_07.png) <br>

8. Na página do diálogo **Obter senha temporária**, realize as seguintes etapas: <br><br>![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-condeco-tutorial/create_aaduser_08.png) <br>
...
Não há itens de ação para você nesta seção. Um novo usuário será criado durante uma tentativa de acessar o Condeco se ele ainda não existir. [Configurando o logon único do Azure AD](#configuring-azure-ad-single-single-sign-on).
...
O objetivo desta seção é testar sua configuração de logon único do Azure AD usando o Painel de Acesso.<br> Quando você clica no bloco Condeco no Painel de Acesso, deve fazer logon automaticamente no seu aplicativo do Condeco.
