<properties
	pageTitle="Gerenciar as configurações de um grupo na visualização do Azure Active Directory | Microsoft Azure"
...
# Gerenciar as configurações para um grupo na visualização do Azure Active Directory
