...
Após um curto período de tempo, os usuários que você selecionou poderá iniciar esses aplicativos usando os métodos descritos na seção de descrição da solução.
