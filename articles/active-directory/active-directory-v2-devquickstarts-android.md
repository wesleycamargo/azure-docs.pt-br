...
## <a name="download-the-code-from-github"></a>Baixar o código do GitHub
...
O valor `User.Read` em `oidc_scopes` permite que você leia o perfil básico do usuário conectado.
