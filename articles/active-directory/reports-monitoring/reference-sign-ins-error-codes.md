...
Como alternativa ao uso do portal do Azure para acessar os dados sobre entradas, você também pode usar a [API de relatório](concept-reporting-api.md).
...
Para obter mais informações, confira a [Introdução aos relatórios de atividade de entrada no portal do Azure Active Directory](concept-sign-ins.md).
