...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_samlbase.png)

3. Na seção **URLs e Domínio do Softeon WMS**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_url.png)
...
4. Na seção **Certificado de Autenticação SAML**, clique em **Certificado (Base64)** e, em seguida, salve o arquivo do certificado em seu computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_certificate.png) 

5. Clique no botão **Salvar** .

    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_general_400.png)
...
6. Na seção **Configuração do Softeon WMS**, clique em **Configurar Softeon WMS** para abrir a janela **Configurar logon**. Copie a **ID da Entidade SAML e a URL do Serviço de Logon Único SAML** da **seção Referência Rápida.**
    ...
    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_configure.png) 
...
2. Na lista de aplicativos, selecione **Softeon WMS**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-softeon-tutorial/tutorial_softeon_app.png) 
