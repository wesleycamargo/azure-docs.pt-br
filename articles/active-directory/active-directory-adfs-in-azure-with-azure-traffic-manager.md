<properties
	pageTitle="Implantação de alta disponibilidade entre fronteiras geográficas do AD FS no Azure com o Gerenciador de Tráfego do Azure | Microsoft Azure"
...
###Implantação do Gerenciador de Tráfego do Azure
...
##Testar o roteamento e a entrada no AD FS   
