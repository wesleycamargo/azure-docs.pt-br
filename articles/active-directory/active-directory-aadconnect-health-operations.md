...
### <a name="delete-a-server-from-azure-ad-connect-health-service"></a>Excluir um servidor do serviço de Azure AD Connect Health
...
### <a name="remove-users-and/or-groups"></a>Remover usuários e/ou grupos
