...
6. Para configurar o logon único no lado do **Innotas**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte Innotas](https://www.innotas.com/contact). Eles definem essa configuração para ter a conexão de SSO do SAML definida corretamente em ambos os lados.
