...
4. Na caixa de pesquisa, digite **Innotas**.

    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-innotas-tutorial/tutorial_innotas_search.png)

5. No painel de resultados, selecione **Innotas** e clique no botão **Adicionar** para adicionar o aplicativo.
...
3. **[Criação de um usuário de teste do Innotas](#creating-an-innotas-test-user)**: para ter um equivalente de Brenda Fernandes no Innotas, que esteja vinculado à representação do usuário no Azure AD.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-innotas-tutorial/tutorial_innotas_samlbase.png)

3. Na seção **URLs e Domínio do Innotas**, execute as seguintes etapas:

    ![Configurar o logon único](./media/active-directory-saas-innotas-tutorial/tutorial_innotas_url.png)
...
5. Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-innotas-tutorial/tutorial_general_400.png)

6. Para configurar o logon único no lado do **Innotas**, é necessário enviar o **XML de Metadados** baixado para a [equipe de suporte Innotas](https://www.innotas.com/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
2. Na lista de aplicativos, selecione **Innotas**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-innotas-tutorial/tutorial_innotas_app.png) 
