...
1. No painel de resultados, escolha **HackerOne** e clique em **Concluir** para adicionar o aplicativo.
...
5. No diálogo **Configurações de SAML**, execute as seguintes etapas:
