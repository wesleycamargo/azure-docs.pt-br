...
* Você pode permitir que seus usuários façam logon automaticamente no SSO (logon único) do HackerOne com suas contas do Azure AD
...
* Uma assinatura com SSO do HackerOne habilitado
...
## <a name="add-hackerone-from-the-gallery"></a>Adicionando o HackerOne da galeria
...
7. No painel de resultados, selecione **HackerOne** e clique em **Concluir** para adicionar o aplicativo.
...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e, em seguida, clique em **Avançar**:
    ...
    1. Na caixa de texto **URL de Logon**, digite a URL usada pelos usuários para fazer logon no seu aplicativo HackerOne usando o seguinte padrão: **“https://hackerone.com/\<nome da empresa\>/authentication”**. 
    2. Contate a equipe de suporte do HackerOne pelo email [support@hackerone.com](mailto:support@hackerone.com) para obter a URL do locatário, caso não saiba qual é.
...
4. Na página **Configurar logon único no HackerOne**, execute as seguintes etapas e clique em **Avançar**:
    ...
    2. Clique em **Próximo**.
5. Faça logon no seu locatário HackerOne como administrador.
...
7. Navegue até "**Autenticação**" e clique em "**Adicionar configurações do SAML**".
   
    ![Configurar Logon Único](./media/active-directory-saas-hackerone-tutorial/tutorial_hackerone_003.png) 
8. Na caixa de diálogo **Configurações de SAML** , execute as seguintes etapas:
   
    ![Configurar Logon Único](./media/active-directory-saas-hackerone-tutorial/tutorial_hackerone_004.png) 
    1. Na caixa de texto **Domínio de Email** , digite um domínio registrado.
    2. No portal clássico do Azure, copie a **URL do Serviço de Logon Único**e cole-a na caixa de texto URL de Logon Único.
    3. Crie um arquivo **codificado em base&64;** usando o certificado baixado.  
       ...
       >
    4. Abra seu certificado codificado de base&64; no bloco de notas, copie o conteúdo dele para a área de transferência e cole-o na caixa de texto **Certificado X509** .
    5. Clique em **Salvar**.
9. No diálogo Configurações de Autenticação, execute as seguintes etapas:
    ...
    2. Se o valor do campo **Status** for igual a **Status do último teste: criado**, contate sua equipe de suporte do HackerOne através de [support@hackerone.com](mailto:support@hackerone.com) para solicitar uma revisão da sua configuração.
...
### <a name="create-a-hackerone-test-user"></a>Criar um usuário de teste do HackerOne
