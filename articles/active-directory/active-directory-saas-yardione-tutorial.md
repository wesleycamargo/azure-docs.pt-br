...
3. **[Criar de um usuário de teste do YardiOne](#create-a-yardione-test-user)** – para ter um equivalente de Brenda Fernandes no Fuse vinculado à representação do usuário no Azure Active Directory.
...
2. Na caixa de diálogo **Logon único**, selecione **Modo** como **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Caixa de diálogo Logon único](./media/active-directory-saas-yardione-tutorial/tutorial_yardione_samlbase.png)

3. Na seção **URLs e Domínio do YardiOne**, execute as seguintes etapas:

    ![Informações de logon único de Domínio e URLs do YardiOne](./media/active-directory-saas-yardione-tutorial/tutorial_yardione_url.png)
...
1. No portal do Azure, no painel esquerdo, clique no botão **Azure Active Directory**.
    ...
    ![O botão Azure Active Directory](./media/active-directory-saas-yardione-tutorial/create_aaduser_01.png)

2. Para exibir a lista de usuários, acesse **Usuários e grupos** e, depois, clique em **Todos os usuários**.

    ![Os links “Usuários e grupos” e “Todos os usuários”](./media/active-directory-saas-yardione-tutorial/create_aaduser_02.png)

3. Para abrir a caixa de diálogo **Usuário**, clique em **Adicionar** na parte superior da caixa de diálogo **Todos os Usuários**.

    ![O botão Adicionar](./media/active-directory-saas-yardione-tutorial/create_aaduser_03.png)

4. Na caixa de diálogo **Usuário**, execute as seguintes etapas:

    ![A caixa de diálogo Usuário](./media/active-directory-saas-yardione-tutorial/create_aaduser_04.png)
...
2. Na lista de aplicativos, escolha **YardiOne**.
    ...
    ![O link do YardiOne na lista de Aplicativos](./media/active-directory-saas-yardione-tutorial/tutorial_yardione_app.png)  
