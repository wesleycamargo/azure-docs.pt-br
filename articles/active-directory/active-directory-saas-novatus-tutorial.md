...
4. **[Criar um usuário de teste do Novatus](#creating-a-Novatus-test-user)**: para ter um equivalente de Brenda Fernandes no Novatus que esteja vinculado à representação dela no Azure AD.
