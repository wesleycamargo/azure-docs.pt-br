...
> [!IMPORTANT]
> O Yammer não mostra a página de entrada com marca do Azure AD até que o usuário entre. O usuário vê primeiro a página genérica de entrada do Office 365 e então a página com marca depois.   
