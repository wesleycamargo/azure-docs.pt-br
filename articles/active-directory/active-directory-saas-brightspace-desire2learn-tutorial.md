<properties pageTitle="Tutorial: Integração do Active Directory do Azure ao Brightspace by Desire2Learn | Microsoft Azure" description="Saiba como usar o Brightspace by Desire2Learn com o Active Directory do Azure para habilitar o logon único, o provisionamento automatizado e muito mais!" services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Integração do Active Directory do Azure ao Brightspace by Desire2Learn
>[AZURE.TIP]Para ver comentários, clique [aqui](http://go.microsoft.com/fwlink/?LinkId=550977).
...
Depois de concluir este tutorial, os usuários do AD do Azure que você atribuiu ao Brightspace by Desire2Learn poderão fazer logon único no aplicativo em seu site de empresa Brightspace by Desire2Learn (logon iniciado pelo provedor de serviços) ou usando a [Introdução ao Painel de Acesso](https://msdn.microsoft.com/library/dn308586)
...
1.  No portal do AD do Azure, na página de integração de aplicativos do **Brightspace by Desire2Learn**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
