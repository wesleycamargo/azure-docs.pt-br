...
3. Siga as etapas em [cmdlets do Azure Active Directory para definir as configurações de grupo](users-groups-roles/groups-settings-cmdlets.md) para criar configurações de grupo para este locatário.
...
Para saber mais, consulte o artigo [Cmdlets do Azure Active Directory para definir as configurações de grupo](users-groups-roles/groups-settings-cmdlets.md).
...
* [Política de expiração de grupos do Office 365](users-groups-roles/groups-lifecycle.md)
