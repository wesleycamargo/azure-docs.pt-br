...
- Se você quiser saber mais sobre:
    - Condições, consulte [Condições no acesso condicional do Azure Active Directory](conditional-access/conditions.md).

    - Controles de acesso, consulte [Controles de acesso no acesso condicional do Azure Active Directory](conditional-access/controls.md).

- Se você deseja obter alguma experiência com a configuração de políticas de acesso condicional, confira [Exigir MFA para aplicativos específicos com acesso condicional do Azure Active Directory](conditional-access/app-based-mfa.md).

- Se você estiver pronto para configurar políticas de acesso condicional para seu ambiente, confira as [melhores práticas para o acesso condicional no Azure Active Directory](conditional-access/best-practices.md). 
