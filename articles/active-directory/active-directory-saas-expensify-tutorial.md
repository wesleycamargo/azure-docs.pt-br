...
3. **[Criar um usuário de teste do Expensify](#creating-an-expensify-test-user)** – para ter um equivalente de Brenda Fernandes no Expensify que esteja vinculado à representação dela no Azure AD.
...
1. Na página **Configurar logon único no Expensify**, execute as seguintes etapas:
