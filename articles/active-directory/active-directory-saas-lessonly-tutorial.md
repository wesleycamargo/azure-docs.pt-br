...
4. **[Criar um usuário de teste Lesson.ly](#creating-a-Lessonly-test-user)** - para ter um equivalente de Brenda Fernandes no Lesson.ly que esteja vinculado à representação dela no Azure AD.
