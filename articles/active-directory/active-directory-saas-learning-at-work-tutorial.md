...
1. No portal clássico, na página de integração do aplicativo **Learning at Work**, clique em **Configurar logon único** para abrir a caixa de diálogo **Configurar Logon Único**.
...
2. Na lista de aplicativos, selecione **Learning at Work**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-learning-at-work-tutorial/tutorial_learningatwork_50.png) 
