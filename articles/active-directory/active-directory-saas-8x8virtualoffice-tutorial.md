<properties
	pageTitle="Tutorial: Integração do Azure Active Directory com o 8x8 Virtual Office | Microsoft Azure"
...
# Tutorial: Integração do Azure Active Directory com o 8x8 Virtual Office
...
## Adicionando o 8x8 Virtual Office da galeria
...
O objetivo desta seção é mostrar como configurar e testar o logon único do Azure AD com o 8x8 Virtual Office, com base em uma usuária de teste chamada "Brenda Fernandes".
...
3. **[Criação de um usuário de teste do 8x8 Virtual Office](#creating-a-8x8-virtual-office-test-user)** - para ter um equivalente de Brenda Fernandes no 8x8 Virtual Office que esteja vinculado à representação dela no Azure AD.
4. **[Atribuição do usuário de teste do AD do Azure](#assigning-the-azure-ad-test-user)**: para permitir que Brenda Fernandes use o logon único do AD do Azure.
5. **[Teste do logon único](#testing-single-sign-on)**: para verificar se a configuração funciona.

### Configuração do logon único do Azure AD

Nesta seção, você habilitará o logon único do Azure AD no portal clássico e configurará o logon único no aplicativo do 8x8 Virtual Office.
...
2. Na página **Como você deseja que os usuários façam logon no 8x8 Virtual Office**, selecione **Logon Único do Azure AD** e clique em **Avançar**.
...
7. Selecione **Business** conta para gerenciar e clique no botão **Sign In**.
...
10. Selecione **Single Sign On** no método de autenticação e clique em **SAML**.

	![Configurar no lado do aplicativo](./media/active-directory-saas-8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_005.png)

11. Copie **URL SSO SAML**, **URL de Serviço de Logoff Único** e **URL do Emissor** do Azure AD para **Sign In**, **Sign Out URL** e **Issuer URL** no 8x8 Virtual Office.
...
### Criar um usuário de teste no 8x8 Virtual Office
...
> [AZURE.NOTE] Se precisar criar um usuário manualmente, entre em contato com a equipe de suporte do 8x8 Virtual Office.
