...
* Você pode permitir que seus usuários entrem automaticamente no 8x8 Virtual Office por meio do logon único (SSO) usando suas contas do Azure AD
...
* Uma assinatura do 8x8 Virtual Office com logon único (SSO) habilitado
...
O objetivo desta seção é mostrar como configurar e testar o SSO do Microsoft Azure AD com o 8x8 Virtual Office, com base em uma usuária de teste chamada "Brenda Fernandes".

Para que o logon único (SSO) funcione, o Azure AD precisa saber qual usuário do 8x8 Virtual Office é equivalente a um usuário do Azure AD. Em outras palavras, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do 8x8 Virtual Office.
...
Para configurar e testar o SSO do Microsoft Azure AD com o 8x8 Virtual Office, você precisa concluir os seguintes blocos de construção:
...
Nesta seção, você habilitará o SSO do Microsoft Azure AD no portal clássico e configurará o logon único no aplicativo do 8x8 Virtual Office.
...
3. Na página de diálogo **Definir Configurações do Aplicativo**, execute as seguintes etapas e clique em **Avançar**:
  ...
  1. Na caixa de texto **URL de Resposta**, digite: `https://sso.8x8.com/saml2`
  2. Clique em **Próximo**.
...
12. Clique no botão **Navegador** para carregar o certificado que você baixou do Azure AD e clique no botão **Salvar**.
...
### <a name="create-a-8x8-virtual-office-test-user"></a>Criar um usuário de teste no 8x8 Virtual Office
O objetivo desta seção é criar uma usuária chamada Brenda Fernandes no 8x8 Virtual Office. O&8;x8 Virtual Office dá suporte ao provisionamento just-in-time, que está habilitado por padrão.
...
O objetivo desta seção é permitir que Brenda Fernandes use o logon único (SSO) do Azure ao conceder a ela acesso ao 8x8 Virtual Office.
