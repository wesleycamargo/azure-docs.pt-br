...
# Como configurar provisionamento do usuário para um aplicativo de galeria do Azure AD
...
## Configurar um aplicativo para o provisionamento manual
...
## Configurar um aplicativo para o provisionamento automático
