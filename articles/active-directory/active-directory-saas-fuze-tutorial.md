...
2. Na caixa de diálogo **Logon único**, como **Modo**, selecione **Logon baseado em SAML** para habilitar o logon único.
    ...
    ![Configurar o logon único](./media/active-directory-saas-fuze-tutorial/tutorial_fuze_01.png)
...
4.  Clique no botão **Salvar** .
    ...
    ![Configurar o logon único](./media/active-directory-saas-fuze-tutorial/tutorial_general_400.png)
...
5. Na seção **Certificado de Autenticação SAML**, clique em **XML de metadados** e, em seguida, salve o arquivo xml em seu computador.
    ...
    ![Configurar o logon único](./media/active-directory-saas-fuze-tutorial/tutorial_fuze_05.png) 
...
2. Na lista de aplicativos, selecione **Fuze**.
    ...
    ![Configurar o logon único](./media/active-directory-saas-fuze-tutorial/tutorial_fuze_50.png) 
