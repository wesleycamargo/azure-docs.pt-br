...
1. No portal clássico do Azure, no **Central Desktop** página de integração de aplicativos, clique em **configurar logon único** para abrir o * * configurar logon único * * caixa de diálogo.
