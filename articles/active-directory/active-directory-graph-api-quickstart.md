---
title: Guia de Início Rápido para a Graph API do AD do Azure | Microsoft Docs
...
> [!IMPORTANT]
> A funcionalidade API do Azure AD Graph também está disponível por meio do [Microsoft Graph](https://graph.microsoft.io/), uma API unificada que inclui APIs de outros serviços da Microsoft, como o Outlook, o OneDrive, o OneNote, o Planner e o Office Graph, e está acessível por meio de um único ponto de extremidade e com um token de acesso único.
> 
> 
...
4. No campo diretamente abaixo do meny suspenso Post, digite o seguinte:
   ...
   > [!NOTE]
   > Substitua &lt;seu token de acesso&gt; pelo token de acesso para seu diretório do AD do Azure.
   > 
   > 
