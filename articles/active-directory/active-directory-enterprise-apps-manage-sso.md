<properties
    pageTitle="Gerenciamento de único logon para aplicativos empresariais na visualização do Azure Active Directory | Microsoft Azure"
...
#Visualização: gerenciamento de logon único para aplicativos empresariais no novo portal do Azure
...
###Certificado de assinatura de SAML
...
> [AZURE.NOTE] Para obter um exemplo completo de documentação interna, confira o aplicativo do Salesforce.com. A documentação de aplicativos adicionais está sendo adicionada continuamente durante a visualização.

![Documentos internos][3]

##Logon com base em senha
