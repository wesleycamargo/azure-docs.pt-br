...
Esse URI de Redirecionamento deve ser especificado no registro de seu aplicativo usando o [Portal Clássico do Azure](https://manage.windowsazure.com/). Para saber mais sobre o registro de aplicativo do Azure AD, confira [Integração com o Azure Active Directory](develop/active-directory-how-to-integrate.md).
