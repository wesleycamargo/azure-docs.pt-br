...
11. No portal do Azure, na página do diálogo **Configurar logon único no Zscaler One**, selecione a confirmação de configuração de logon único e clique em **Concluir**.
