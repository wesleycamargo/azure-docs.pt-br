...
- A [migração das políticas de acesso condicional](conditional-access/best-practices.md#policy-migration).
...
Se você quiser saber como configurar uma política de acesso condicional, consulte [Exigir MFA para aplicativos específicos com acesso condicional do Azure Active Directory](conditional-access/app-based-mfa.md).
