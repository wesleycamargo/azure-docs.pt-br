...
3. Na página **Configurar URL do Aplicativo** , execute as seguintes etapas:
    ...
    a. Na caixa de texto **URL de Logon do Replicon**, digite a URL do locatário do Replicon (por exemplo: *https://na2.replicon.com/company/saml2/sp-sso/post*).

    b. Na caixa de texto **URL de Resposta do Replicon**, digite a URL de **AssertionConsumerService** do Replicon (por exemplo: *https://global.replicon.com/!/saml2/company/sso/post*).  
