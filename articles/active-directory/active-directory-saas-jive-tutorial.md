---
title: 'Tutorial: Integração do Active Directory do Azure com o Jive | Microsoft Docs'
...
2. Na página **Inserir suas credenciais do Jive para habilitar o provisionamento automático de usuário**, forneça as seguintes configurações:
   ...
   3. Na caixa de texto **URL de Locatário do Jive**, digite a URL de locatário do Jive.
      ...
      > [!NOTE]
      > A URL de locatário do Jive é usada pela sua organização para efetuar logon no Jive. Normalmente, a URL tem o seguinte formato: **www.<organização>.jive.com**.
      > 
      > 
