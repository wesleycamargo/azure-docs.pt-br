...
3. **[Criar um usuário de teste Jive](#creating-a-jive-test-user)** - para ter um equivalente de Brenda Fernandes no Jive que esteja vinculado à representação dela no Azure AD.
4. **[Configurando o provisionamento de usuários](#configuring-user-provisioning)** - para descrever como habilitar o provisionamento de usuários das contas de usuário do Active Directory para o Jive.
...
3. Na página de diálogo **Definir Configurações de Aplicativo** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-jive-tutorial/tutorial_jive_04.png) 
...
4. Na página **Configurar logon único no Jive** , execute as seguintes etapas:
    ...
    ![Configurar Logon Único](./media/active-directory-saas-jive-tutorial/tutorial_jive_05.png)
...
9. No portal do Azure AD, selecione a confirmação da configuração de logon único e clique em **Avançar**.
...
5. Na página de diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas:  ![criação de um usuário de teste do AD do Azure](./media/active-directory-saas-jive-tutorial/create_aaduser_05.png) 
...
6. Na página do diálogo **Perfil do Usuário** , realize as seguintes etapas:
    ...
    ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-jive-tutorial/create_aaduser_06.png) 
...
![Configurar Provisionamento de Usuário](./media/active-directory-saas-jive-tutorial/IC698794.png "Configure User Provisioning")
...
2. Na página **Inserir suas credenciais do Jive para habilitar o provisionamento automático de usuário** , forneça as seguintes configurações:
    ...
    c. Na caixa de texto **URL de Locatário do Jive** , digite a URL de locatário do Jive.
      ...
      > [!NOTE]
      > A URL de locatário do Jive é usada pela sua organização para efetuar logon no Jive.  
    ...
    e. Clique no botão **Avançar** para abrir a página **Confirmação**.
...
2. Na lista de aplicativos, escolha **Jive**.
    ...
    ![Configurar Logon Único](./media/active-directory-saas-jive-tutorial/tutorial_jive_50.png) 
