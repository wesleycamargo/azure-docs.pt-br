...
> [!NOTE]
> Este artigo não aborda como implementar conexão, registro e gerenciamento de perfil com o Azure AD B2C.  Ele se concentra na chamada a APIs Web depois que o usuário já está autenticado.  Leia o [documento Como integrar com o Azure Active Directory](develop/active-directory-how-to-integrate.md) para saber mais sobre o básico do Azure Active Directory, caso ainda não tenha feito isso.
> 
> 
