...
| VISIO PRO PARA O OFFICE 365  | VISIOCLIENT   | c5928f49-12ba-48f7-ada3-0d743a3601d5  | VISIO_CLIENT_SUBSCRIPTION (663a804f-1c30-4ff0-9915-9db84f0d1cea)
...
Ao usar o licenciamento baseado em grupo, você enfrenta [esta condição de erro](active-directory-licensing-group-problem-resolution-azure-portal.md#conflicting-service-plans). Ao usar o PowerShell, você verá o erro *MutuallyExclusiveViolation*.

Esta seção lista os planos de serviço mais comuns que são mutuamente exclusivos, agrupados por tipo de serviço. Você pode usar essas informações para planejar a implantação de licença e evitar erros de atribuição.
...
* [Exemplos do PowerShell para licenciamento baseado em grupo no Azure AD](active-directory-licensing-ps-examples.md)
