...
7. Clique em **OK** na próxima tela. Não altere o nome do certificado da mensagem "Ingressar no local de trabalho". O aplicativo Azure Authenticator está tentando ingressar seu dispositivo na área de trabalho. Você verá a mensagem Ingresso no local de trabalho concluído na próxima tela.
...
7. Edite as linhas **Para** e **Assunto** com as informações que você recebeu do Suporte da Microsoft.
