<properties
   pageTitle="Bibliotecas v2.0 do Azure Active Directory | Microsoft Azure"
...
## Bibliotecas de middleware de servidor com suporte da Microsoft
| Plataforma| Nome da biblioteca| Baixar | Código-fonte | Amostra |
| :-: | :-: | :-: | :-: | :-: |
...
## Bibliotecas de middleware de servidor compatíveis 
Em breve


## Conteúdo relacionado
Confira a [Visão geral do modelo de aplicativo do Azure AD v2][AAD-App-Model-V2-Overview] para saber naus sobre o ponto de extremidade v2.0 do Azure AD.
