...
Este artigo explica como adicionar novos usuários em sua organização na visualização do Azure AD (Azure Active Directory). [O que está na visualização?](active-directory-preview-explainer.md)
