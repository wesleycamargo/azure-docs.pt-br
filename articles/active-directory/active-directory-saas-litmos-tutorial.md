---
title: 'Tutorial: Integração do Active Directory do Azure ao Litmos | Microsoft Docs'
...
3. **[Criar um usuário de teste do Litmos](#creating-a-halogen-software-test-user)**: para ter um equivalente de Brenda Fernandes no Litmos que esteja vinculado à representação dela no AD do Azure.
...
3. Faça logon no site da sua empresa no Litmos (por exemplo: *https://azureapptest.litmos.com/account/Login*) como administrador.
...
13. Na parte superior do menu, clique em **Atributos** para abrir o diálogo **Atributos de Token SAML**.
