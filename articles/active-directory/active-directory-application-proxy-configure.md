...
O proxy de aplicativo do Azure AD é um recurso que está disponível somente se você tiver atualizado para a edição Premium ou Basic do Azure Active Directory. Para obter mais informações, consulte [Edições do Azure Active Directory](active-directory-editions.md).
...
Para começar a usar o proxy de aplicativo, siga estas etapas: 1. [Habilite os serviços de proxy do aplicativo](active-directory-application-proxy-enable.md) 2. [Publique aplicativos com proxy de aplicativo](active-directory-application-proxy-publish.md)

## O que vem a seguir?

[Blog do Microsoft Azure](http://azure.microsoft.com/blog/) [Habilitar serviços do proxy do aplicativo](active-directory-application-proxy-enable.md) [Publicar aplicativos com proxy de aplicativo](active-directory-application-proxy-publish.md) [Solucionar problemas de proxy de aplicativo](active-directory-application-proxy-troubleshoot.md)
