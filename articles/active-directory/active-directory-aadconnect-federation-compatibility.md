...
Para saber mais sobre como usar o Azure Active Directory com o AD FS, consulte [ADFS (Serviços de Federação do Active Directory)](connect/active-directory-aadconnect-get-started-custom.md#configuring-federation-with-ad-fs)
