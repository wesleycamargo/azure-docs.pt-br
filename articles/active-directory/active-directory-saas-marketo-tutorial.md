<properties
	pageTitle="Tutorial: Integração do Azure Active Directory ao Marketo | Microsoft Azure"
...
# Tutorial: Integração do Azure Active Directory com o Marketo
...
## Adicionar o Marketo da galeria
...
Essa relação de vínculo é estabelecida atribuindo o valor de **nome de usuário** no Azure AD como sendo o valor de **Nome de Usuário** no Marketo.
...
1. No portal clássico, na página de integração de aplicativos do **Marketo**, clique em **Configurar logon único** para abrir o diálogo **Configurar Logon Único**.
...
6.	Para configurar o SSO no aplicativo, siga estas etapas:
	...
	> [AZURE.NOTE] Se o identificador de usuário não for um valor de UPN, altere o valor na guia Atributo.
...
5. Na página do diálogo **Conte-nos sobre este usuário**, realize as seguintes etapas: ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-marketo-tutorial/create_aaduser_05.png)
...
6.  Na página de diálogo **Perfil do Usuário**, execute as seguintes etapas: ![Criação de um usuário de teste do AD do Azure](./media/active-directory-saas-marketo-tutorial/create_aaduser_06.png)
...
### Criar um usuário de teste do Marketo
