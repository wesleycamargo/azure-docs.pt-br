...
Você pode usar o portal do Azure para criar um [gateway de aplicativo](overview.md) com um [firewall do aplicativo Web](waf-overview.md) (WAF). O WAF usa as regras de [OWASP](https://www.owasp.org/index.php/Category:OWASP_ModSecurity_Core_Rule_Set_Project) para proteger o seu aplicativo. Essas regras incluem proteção contra ataques, como injeção de SQL, ataques de script entre sites e sequestros de sessão.
...
![Exemplo de Firewall do aplicativo Web](./media/create-waf-portal/scenario-waf.png)
...
3. Insira esses valores para o gateway de aplicativo:
    ...
    ![Criar novo gateway de aplicativo](./media/create-waf-portal/application-gateway-create.png)
...
5. Clique em **Escolher uma rede virtual**, clique em **Criar novo** e insira esses valores para a rede virtual:
    ...
    ![Criar rede virtual](./media/create-waf-portal/application-gateway-vnet.png)
...
1. Abra o shell interativo e verifique se ele está definido como **PowerShell**.
    ...
    ![Instalar a extensão personalizada](./media/create-waf-portal/application-gateway-extension.png)
...
1. Localize o endereço IP público para o gateway do aplicativo na tela de Visão geral. Clique em **Todos os recursos** e clique em **myAGPublicIPAddress**.
    ...
    ![Registre o endereço IP público do gateway de aplicativo](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Copie o endereço IP público e cole-o na barra de endereços do seu navegador.

    ![Teste o gateway de aplicativo](./media/create-waf-portal/application-gateway-iistest.png)
