...
Depois de aprender sobre o SSL de ponta a ponta, vá e [habilite o SSL de ponta a ponta no gateway de aplicativo](tutorial-ssl-powershell.md) para criar um gateway de aplicativo usando esse SSL.
