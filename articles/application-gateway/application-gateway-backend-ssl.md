<properties
   pageTitle="Habilitando política de SSL e SSL de ponta a ponta com o Gateway de Aplicativo | Microsoft Azure"
...
Neste exemplo, as solicitações de https://contoso.com podem ser roteadas para ContosoServerPool via HTTP e https://fabrikam.com será roteada para FabrikamServerPool via HTTPS usando SSL de ponta a ponta.
...
2. A definição de uma política de SSL dá a você a opção de desabilitar qualquer um destes três protocolos: TLSv1_0, TLSv1_1, TLSv1\_2.
3. Se nenhuma política SSL for definida, todos os três (TLSv1_0, TLSv1_1, TLSv1\_2) deverão ser habilitados.
