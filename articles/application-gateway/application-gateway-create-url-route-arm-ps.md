...
A diferença entre usar o modelo de implantação clássico e o Azure Resource Manager é a ordem em que você cria o gateway de aplicativo e os itens que precisam ser configurados.
