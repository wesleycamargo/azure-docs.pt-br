...
Você pode configurar o redirecionamento para o ouvinte usando [AzApplicationGatewayRedirectConfiguration adicionar](/powershell/module/az.network/add-azapplicationgatewayredirectconfiguration). 
