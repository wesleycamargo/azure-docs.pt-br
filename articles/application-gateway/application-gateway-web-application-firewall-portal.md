...
# Criar um gateway de aplicativo com o firewall do aplicativo Web usando o portal
...
- **Modo firewall** - essa configuração é como o firewall do aplicativo Web lida com o tráfego mal-intencionado. O modo de **Detecção** só registra em log os eventos, onde o modo **Prevenção** registra os eventos e interrompe o tráfego mal-intencionado.
