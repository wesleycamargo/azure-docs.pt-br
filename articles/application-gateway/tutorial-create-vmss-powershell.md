---
title: Criar um gateway de aplicativo com um conjunto de dimensionamento de máquinas virtuais – Azure PowerShell
...
ms.locfileid: "55748737"
---
# <a name="create-an-application-gateway-and-virtual-machine-scale-set-using-azure-powershell"></a>Crie um gateway de aplicativo e um conjunto de dimensionamento de máquinas virtuais usando o Azure PowerShell.

Você pode usar o Azure PowerShell para criar um [gateway de aplicativo](application-gateway-introduction.md) que usa um [conjunto de dimensionamento da máquinas virtuais](../virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md) para servidores de back-end. Neste exemplo, o conjunto de dimensionamento contém duas instâncias de máquina virtual que são adicionadas ao pool de back-end padrão do gateway de aplicativo.
...
Um ouvinte é necessário para habilitar o gateway de aplicativo para rotear o tráfego corretamente para o pool de back-end. Neste exemplo, você cria um ouvinte básico que ouve o tráfego na URL da raiz. 
...
![Testar a URL de base no gateway de aplicativo](./media/tutorial-create-vmss-powershell/tutorial-iistest.png)
