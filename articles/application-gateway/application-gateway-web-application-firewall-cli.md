...
Para executar as etapas deste artigo, será necessário [instalar a interface de linha de comando do Azure (CLI do Azure) para Mac, Linux e Windows](https://docs.microsoft.com/cli/azure/install-az-cli2).
