...
---
title: Criar um gateway de aplicativo usando os modelos do Gerenciador de Recursos do Azure | Microsoft Docs
...
1. Verifique o conteúdo em **resources** e observe o seguinte:
...
4. Salve o arquivo em uma pasta local do computador.
5. Abra o arquivo que você salvou e edite os valores dos parâmetros. Use os valores a seguir para implantar o gateway de aplicativo descrito em nosso cenário.
...
6. Salve o arquivo. Você pode testar o modelo JSON e o modelo de parâmetro usando ferramentas de validação de JSON online, como [JSlint.com](http://www.jslint.com/).
