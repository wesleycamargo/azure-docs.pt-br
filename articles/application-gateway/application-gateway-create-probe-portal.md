---
title: Criar uma investigação personalizada para um Application Gateway usando o portal | Microsoft Docs
...
> [!IMPORTANT]
> o nome do host não é o nome do servidor. Esse é o nome do host virtual em execução no servidor de aplicativos. A investigação é enviada para http://(host name):(port from httpsetting)/urlPath
> 
> 
