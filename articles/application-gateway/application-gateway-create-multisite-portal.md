---
title: "Configurar um gateway de aplicativo existente para hospedar vários sites no portal do Azure | Microsoft Docs"
...
2. Crie um novo ouvinte para cada site que o gateway de aplicativo dará suporte.
...
É necessário um pool de back-end para cada site ao qual esse gateway de aplicativo dará suporte; neste caso, serão criados dois: um para contoso11.com e outro para fabrikam11.com.
...
Isso conclui a configuração de um gateway de aplicativo existente com suporte a multissite por meio do portal do Azure.
...
[multissite]: ./media/application-gateway-create-multisite-portal/multisite.png
