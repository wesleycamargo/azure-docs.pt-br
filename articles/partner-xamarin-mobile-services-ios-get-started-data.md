<properties linkid="develop-mobile-tutorials-get-started-with-data-xamarin-ios" urlDisplayName="Introdução a dados" pageTitle="Introdução a dados (Xamarin.iOS) - Serviços Móveis do Azure" metaKeywords="Dados Xamarin.iOS do Azure, dados dos Serviços Móveis do Azure, " description="Saiba como armazenar e acessar dados do seu aplicativo Xamarin.iOS dos Serviços Móveis do Azure." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Introdução a dados nos Serviços Móveis" authors="" />

# Começar a trabalhar com dados em serviços móveis
<div class="dev-center-tutorial-selector sublanding"> 
	<a href="/pt-br/develop/mobile/tutorials/get-started-with-data-dotnet" title="Windows Store C#">Windows Store C#</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-js" title="Windows Store JavaScript">Windows Store JavaScript</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-wp8" title="Windows Phone">Windows Phone</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-ios" title="iOS">iOS</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-android" title="Android">Android</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-html" title="HTML">HTML</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-xamarin-ios" title="Xamarin.iOS" class="current">Xamarin.iOS</a><a href="/pt-br/develop/mobile/tutorials/get-started-with-data-xamarin-android" title="Xamarin.Android">Xamarin.Android</a>
</div>	
...
Este tutorial requer [Componente dos Serviços Móveis do Azure], [XCode 5.0][Install Xcode], [Xamarin.iOS] e iOS 5.0 ou versões posteriores.
...
<h2><a name="test-app"></a><span class="short-header">Testar o aplicativo</span>Teste o aplicativo com o novo serviço móvel</h2>
...
Depois de ter concluído a série de dados, tente um destes outros tutoriais do iOS:
...
[Validar e modificar os dados com scripts]: /pt-br/develop/mobile/tutorials/validate-modify-and-augment-data-xamarin-ios
...
[SDK dos Serviços Móveis do iOS]: https://go.microsoft.com/fwLink/p/?LinkID=266533
