...
Confira uma visão geral das etapas que necessárias para criar aplicativos no Portal do Azure: ![imagem de visão geral](media/logic-apps-enterprise-integration-overview/overview-0.png)  
