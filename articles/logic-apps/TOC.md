...
### [Chamar pontos de extremidade de aplicativo lógico como gatilhos](logic-apps-http-endpoint.md)
...
## [Gatilhos e ações do fluxo de trabalho](https://docs.microsoft.com/rest/api/logic/actions-and-triggers)
