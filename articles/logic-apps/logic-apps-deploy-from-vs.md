...
Para começar a usar os Aplicativo Lógico do Azure, saiba [como criar seu primeiro aplicativo lógico no portal do Azure](quickstart-create-first-logic-app-workflow.md).
