---
title: "Visão geral da validação XML no Enterprise Integration Pack | Microsoft Docs"
...
---
# <a name="enterprise-integration-with-xml-validation"></a>Integração corporativa com a validação XML
...
1. Crie um aplicativo lógico e [vincule-o à sua conta de integração](../logic-apps/logic-apps-enterprise-integration-accounts.md "Saiba como vincular uma conta de integração a um Aplicativo lógico") que contém o esquema que você usará para validar os dados XML.
...
5. Escolha **Validação de XML   **  
   ![](./media/logic-apps-enterprise-integration-xml/xml-2.png)   
6. Escolha a caixa de texto **CONTEÚDO**  
   ![](./media/logic-apps-enterprise-integration-xml/xml-1-5.png)
7. Selecione a marca body como o conteúdo que será validado.   
   ![](./media/logic-apps-enterprise-integration-xml/xml-3.png)  
8. Escolha a caixa de listagem **NOME DO ESQUEMA** e escolha o esquema que você deseja usar para validar a entrada *conteúdo* acima     
