...
É possível criar [aplicativos lógicos](logic-apps-overview.md "Saiba mais sobre Aplicativos Lógicos") com recursos de B2B usando um contrato criado por você.
