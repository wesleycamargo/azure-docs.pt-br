...
1. Criar um aplicativo lógico em branco. No Designer de Aplicativos Lógicos, na caixa de pesquisa, escolha **Tudo**. Pesquise por "recorrência". Na lista de gatilhos, selecione este gatilho: **Recorrência – Agendamento**
...
1. No gatilho, escolha **Nova etapa**. Pesquise por "variáveis" e selecione esta ação: **Inicializar variável – Variáveis**
...
1. Compile a condição de saída do loop, selecionando a variável **Limite** e o operador **é igual**. Insira **10** como o valor da comparação.
...
1. Na caixa de pesquisa, escolha **Tudo**. Encontre e adicione uma ação que envia email, por exemplo: 
