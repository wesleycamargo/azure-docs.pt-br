...
6. Os resultados são enviados da fonte de dados para o gateway e, em seguida, para o serviço de nuvem. O serviço usa os resultados.
...
* [Criar uma conexão local com Aplicativos Lógicos](../logic-apps/logic-apps-gateway-connection.md)
