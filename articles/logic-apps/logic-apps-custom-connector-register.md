...
1. No portal do Azure, no menu principal do Azure, escolha **Criar um recurso**. Na caixa de pesquisa, digite "conector de aplicativos lógicos" como seu filtro e pressione Enter.
