<properties urlDisplayName="Notify Users xplat aspnet" pageTitle="Enviar notificações entre plataformas a usuários com Hubs de Notificação (ASP.NET)" metaKeywords="" description="Learn how to use Notification Hubs templates to send, in a single request, a platform-agnostic notification that targets all platforms." metaCanonical="" services="notification-hubs" documentationCenter="" title="Send cross-platform notifications to users with Notification Hubs" authors="glenga" solutions="" manager="dwrede" editor="" />
...
1. No Gerenciador de Soluções do Visual Studio, expanda a pasta **Controladores** e, em seguida, abra o arquivo RegisterController.cs. 

2. Localize o bloco do código no método **Post** que cria um novo registro e substitui o conteúdo de com o seguinte código:
...
+  **[Visão geral de Hubs de Notificação do Azure][Templates]**<br/>O tópico Visão geral tem informações mais detalhadas sobre os modelos.
...
<!-- URLs. -->
[Enviar por push aos usuários do ASP.NET]: /pt-br/manage/services/notification-hubs/notify-users-aspnet
[Enviar por push aos usuários dos Serviços Móveis]: /pt-br/manage/services/notification-hubs/notify-users/
...
[Instruções de Hub de Notificação para a Windows Store]: http://msdn.microsoft.com/pt-br/library/windowsazure/jj927172.aspx
