...
As Plantas usam o [conjunto de símbolos de Nuvem e Enterprise](#symbol-and-icon-sets).
...
As versões 3D das [Plantas de Arquitetura da Microsoft](http://aka.ms/azblueprints) foram criadas inicialmente em uma ferramenta que não é da Microsoft, mas um novo modelo do Visio 2013 fornecido em 5 de agosto de 2015 como parte de um [curso de certificação de Arquitetura da Microsoft está sendo distribuído no EDX.ORG](#microsoft-architecture-certification-course).
...
##Conjuntos de símbolos e ícones 
