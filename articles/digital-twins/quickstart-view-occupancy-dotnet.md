...
1. Abra um prompt de comando. Vá para a pasta onde os arquivos digital-twins-samples-csharp-master.zip foram extraídos.
...
1. Execute `dotnet restore`.
1. Edite **appsettings.json** para atualizar **DeviceConnectionString** com a `ConnectionString` anterior.
