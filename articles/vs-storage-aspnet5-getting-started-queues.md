...
Use o objeto **queueClient** para obter uma referência à fila que você deseja usar. O código tenta fazer referência a uma fila denominada "myqueue". Se não for possível localizar uma fila com esse nome, ela será criada.
...
**OBSERVAÇÃO:** Use este bloco de código completo antes do código na seções a seguir.
