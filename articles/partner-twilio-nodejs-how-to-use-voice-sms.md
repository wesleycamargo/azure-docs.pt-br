<properties linkid="dev-nodejs-how-to-twilio-voice-sms-service" urlDisplayName="Serviço de voz e SMS do Twilio" pageTitle="Usando o Twilio para voz, VoIP e as mensagens SMS no Azure" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="Node.js" title=" VoIP" authors="" solutions="" manager="" editor="" />
...
### Inserindo recursos de VoIP no código de IU (JavaScript, iOS ou Android)
...
* Adicionar o suporte de controle de código-fonte (vamos supor que você tenha usado o git)
...
Isso declara o módulo twilio como uma dependência, bem como a popular [estrutura do web express][express] e o mecanismo de modelo EJS.  Tudo bem, agora estamos prontos - vamos escrever um código!

<a id="makecall"/>
## Fazer uma chamada de saída

Vamos criar um formulário simples que fará uma chamada para um número escolhido.  Abra o server.js e insira o código a seguir.  Observe onde está "CHANGE_ME" - coloque o nome do seu site do azure nesse local:
...
Em seguida, crie um diretório denominado "views" - dentro dele, crie um arquivo denominado "index.ejs" com o seguinte conteúdo:
...
* [Votr - um aplicativo de votação de SMS em tempo real com node.js e CouchDB (três partes)][votr]
* [Programação de par no navegador com o node.js][pair]
...
[azure_new_site]: http://www.windowsazure.com/pt-br/develop/nodejs/tutorials/create-a-website-(mac)/
