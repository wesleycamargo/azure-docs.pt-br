<properties
	pageTitle="Replicar máquinas virtuais Hyper-V em nuvens VMM para o Azure | Microsoft Azure"
...
>[AZURE.NOTE] Não há suporte para máquinas virtuais Linux com um endereço IP estático.
