...
### <a name="vmware/physical-site-deployment-for-replication-between-on-premises-and-azure."></a>Implantação de site físico/VMware para replicação entre locais e o Azure.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises-site."></a>Implantação de Site do VMM para replicação no site local.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises-&-azure."></a>Implantação de Site do VMM para replicação entre o local e o Azure.
...
### <a name="hyper-v-site-deployment-for-replication-between-on-premises-&-azure"></a>Implantação de Site do Hyper-V para replicação entre o local e o Azure.
...
## <a name="monitor-replication-health-for-virtual-machine"></a>Monitorar a integridade de replicação da máquina virtual
...
Para os casos em que a replicação é pausada para a máquina virtual, clique com o botão direito do mouse em Select *Replication*->*Resume replication*
![Solucionar problemas do Hyper-V no local](media/site-recovery-monitoring-and-troubleshooting/image19.png)
...
### <a name="hyper-v-replication-logging-options"></a>Opções de log de replicação do Hyper-V
...
## <a name="reaching-out-for-microsoft-support"></a>Contatando o Suporte da Microsoft
...
## <a name="common-asr-errors-and-their-resolutions"></a>Erros de ASR comuns e suas resoluções
...
Se o botão **Conectar** no portal estiver esmaecido e você não estiver conectado ao Azure por meio de uma Rota Expressa ou de uma conexão VPN Site a Site, será necessário criar e atribuir à VM um endereço IP público antes de usar o RDP/SSH. Siga as etapas abaixo para adicionar um IP Público no adaptador de rede da máquina virtual.  
