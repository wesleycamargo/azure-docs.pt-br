...
2. Na página **Especificar Configurações do Grupo de Proteção**, especifique um nome para o grupo e em **De**, escolha o servidor de configuração no qual você deseja criar o grupo. O **Destino** é Azure.
