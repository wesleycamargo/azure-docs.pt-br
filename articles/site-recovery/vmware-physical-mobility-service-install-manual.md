...
--- | ---
Uso | /Role UnifiedAgent.exe < MS\|MT > /InstallLocation <Install Location> /Platform "VmWare" /silent.
...
**Configuração** | **Detalhes**
--- | ---
Uso | . /Install -d <Install Location> - r < MS\|MT > VmWare - q - v
