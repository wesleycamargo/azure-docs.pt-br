...
- **Preços**-Você pode [Ler mais](http://azure.microsoft.com/pricing/details/site-recovery/) sobre os preços da Recuperação de Site.
...
Consulte [este documento](site-recovery-workload.md) para obter diretrizes sobre como usar o Azure Site Recovery para diferentes cargas de trabalho.
...
Provedor do Azure Site Recovery</p><p>Usado para conexão por HTTPS à Recuperação de Site|Instalar em um servidor VMM de origem|Instalar em servidores VMM de origem e de destino|Instalar em servidores VMM de origem e de destino
Agente de Serviços de Recuperação do Azure</p><p>Usado para se conectar por HTTPS à Recuperação de Site|Instalar em servidores host Hyper-V|Não requerido|Não requerido
