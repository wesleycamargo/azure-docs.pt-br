...
- Sua máquina virtual atingiu os [limites do Azure Site Recovery para replicar taxas de alteração de dados](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-support-matrix#azure-site-recovery-limits-to-replicate-data-change-rates)
