...
![Replicação do Hyper-V para o Azure](./media/concepts-hyper-v-to-azure-architecture/arch-hyperv-azure-workflow.png)
...
4. Você pode monitorar o trabalho na guia **Trabalhos** .      ![Lista de trabalhos](media/concepts-hyper-v-to-azure-architecture/image1.png) ![Habilitar busca detalhada da proteção](media/concepts-hyper-v-to-azure-architecture/image2.png)
