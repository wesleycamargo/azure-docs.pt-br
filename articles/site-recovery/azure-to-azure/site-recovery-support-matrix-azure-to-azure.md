...
>[!NOTE]
>
> - Não há suporte para a replicação de máquinas virtuais do Azure de uma assinatura para outra em cenários de recuperação de desastre.
> - Não há suporte para migrar máquinas virtuais do Azure entre assinaturas.
> - Não há suporte para migrar máquinas virtuais do Azure dentro da mesma região.
> - Não há suporte para migrar máquinas virtuais do Azure do modelo de implantação clássico para o modelo de implantação do Resource Manager.
...
- Inicie a proteção de suas cargas de trabalho [replicando VMs do Azure](azure-to-azure-quickstart.md)
