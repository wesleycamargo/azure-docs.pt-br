...
# <a name="set-up-the-source-environment-physical-server-to-azure"></a>Configurar o ambiente de origem (Servidores Físicos para Azure)
...
Este artigo supõe que você já tenha
1. Um Cofre de Serviços de Recuperação no [Portal do Azure](http://portal.azure.com "Portal do Azure").
3. Um computador físico para instalar o servidor de configuração.
...
3. Em **Meta de proteção**, escolha **Para o Azure** e **Não virtualizado/Outro**. Em seguida, clique em **OK**.
