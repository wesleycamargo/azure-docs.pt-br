---
title: Replicar entre máquinas virtuais Hyper-V no local e o Azure (sem VMM) com o Site Recovery | Microsoft Docs
...
Após ler este artigo, publique comentários ou perguntas no final ou no [Fórum dos Serviços de Recuperação do Azure](https://social.msdn.microsoft.com/forums/azure/home?forum=hypervrecovmgr).
