---
title: Replicar máquinas virtuais VMware locais ou servidores físicos em um site secundário | Microsoft Docs
...
6. Servidor de origem (somente para Windows Server)
