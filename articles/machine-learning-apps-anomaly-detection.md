<properties 
	pageTitle="Aplicativo de Aprendizado de Máquina:  Serviço de Detecção de Anomalias | Azure " 
...
2. Aumento no intervalo dinâmico de valores:  Por exemplo, ao monitorar as exceções geradas por um serviço, qualquer aumentos de intervalo dinâmico dos valores pode indicar instabilidade na integridade do serviço, e
...
O serviço fornece a API baseada em REST sobre HTTPS que pode ser consumida de diversas maneiras, incluindo um aplicativo Web ou móvel, R, Python, Excel, etc. Temos um [aplicativo Web do Azure](http://anomalydetection-aml.azurewebsites.net/) que ajuda a executar o serviço Web da detecção de anomalias nos seus dados e visualizar os resultados. 
