<properties urlDisplayName="How to monitor" pageTitle="Como monitorar um banco de dados SQL - gerenciamento de serviços do Azure" metaKeywords="" description="Saiba como monitorar um banco de dados SQL usando o portal de gerenciamento do Azure." metaCanonical="" services="sql-database" documentationCenter="" title="How to Monitor Logical Servers and Database Instances" authors="jeffreyg" solutions="" manager="jeffreyg" editor="" />
...
<h1 id="monitor">Como Monitorar servidores lógicos e Instâncias de bancos de dados</h1>
...
[Monitorando o Banco de Dados SQL usando a Exibição de Gerenciamento Dinâmico (a página pode estar em inglês)]: http://msdn.microsoft.com/pt-br/library/windowsazure/ff394114.aspx
