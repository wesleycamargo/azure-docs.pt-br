...
O driver do Azure precisará da ID de sua assinatura. Você pode usar a [CLI do Azure](cli-install-nodejs.md) ou o [Portal do Azure](https://portal.azure.com) para recuperar sua Assinatura do Azure. 
