<properties
	pageTitle="Tutorial do Apache Storm: Experimentar amostras do Storm Starter | Microsoft Azure"
	description="Introdução à análise de big data usando o Apache Storm executando as amostras do Starter Storm no HDInsight. Saiba como usar o Apache Storm para processar dados em tempo real."
	services="hdinsight"
	documentationCenter=""
	authors="Blackmist"
	manager="paulettm"
...
# Tutorial do Apache Storm no HDInsight: Introdução à análise de big data usando as amostras do Storm Starter 
...
2. Clique em **NOVO** no canto inferior esquerdo, aponte para **SERVIÇOS DE DADOS**, aponte para **ARMAZENAMENTO** e, em seguida, clique em **CRIAÇÃO RÁPIDA**.
	...
	![Portal do Azure, onde você pode usar a Criação Rápida para configurar uma nova conta de Armazenamento.](./media/hdinsight-storm-getting-started/HDI.StorageAccount.QuickCreate.png)
...
Para obter mais informações sobre como criar contas de Armazenamento, consulte <a href="../storage-create-storage-account/" target="_blank">Como criar uma conta de armazenamento</a>.
...
3. Clique no ícone do HDInsight na segunda coluna e selecione **STORM**.
	...
	![Criação Rápida](./media/hdinsight-storm-getting-started/quickcreate.png)
...
![Link Portal do Azure com Painel do Storm](./media/hdinsight-storm-getting-started/dashboard-link.png)
...
![Painel Storm com formulário de topologia de envio](./media/hdinsight-storm-getting-started/submit.png)
...
1. Selecione **StormStarter - WordCount** na lista suspensa **Arquivo Jar**. Isso deve preencher os campos **Nome da Classe** e **Parâmetros Adicionais** com os parâmetros da amostra.
	...
	![Painel Storm com WordCount selecionado](./media/hdinsight-storm-getting-started/submit.png)
...
2. Clique no botão **Enviar**. Após alguns instantes, o campo **Resultado** exibirá o comando usado para enviar o trabalho, bem como os resultados do comando. O campo **Erro** exibe todos os erros ocorridos no envio da topologia.
	...
	![Botão Enviar e resultados](./media/hdinsight-storm-getting-started/submit-results.png)
...
1. Selecione **Interface do Usuário do Storm** na parte superior do Painel Storm. Isso exibirá informações de resumo para o cluster e todas as topologias em execução.
	...
	![interface do usuário Storm mostrando resumo da topologia](./media/hdinsight-storm-getting-started/stormui.png)
...
4. Em **Resumo da topologia**, selecione a entrada **wordcount** na coluna **Nome**. Isso exibirá mais informações sobre a topologia.
	...
	![interface do usuário do storm](./media/hdinsight-storm-getting-started/topology-summary.png)
...
5. Nessa página, selecione uma entrada da seção **Spouts** ou **Bolts**. Isso exibirá informações sobre o componente selecionado.
	...
	![interface do usuário do storm](./media/hdinsight-storm-getting-started/component-summary.png)
...
* **Ferramentas do HDInsight para Visual Studio** - as Ferramentas do HDInsight permitem que você use o Visual Studio para enviar, monitorar e gerenciar topologias Storm semelhantes ao Painel Storm mencionado anteriormente. As Ferramentas do HDInsight também oferecem a capacidade de criar topologias Storm C# e incluem topologias de amostra que você pode implantar e executar no cluster.
	...
	Para obter mais informações, consulte <a href="../hdinsight-hadoop-visual-studio-tools-get-started/" target="_blank">Introdução ao uso das Ferramentas do HDInsight para Visual Studio</a>.
