<properties
	...
	description="Um fluxo de trabalho ou roteiro para criar aplicativos de protótipo e produção integrados à Pesquisa do Azure"
	services="search"
	documentationCenter=""
	authors="HeidiSteen"
	manager="mblythe"
...
Há várias maneiras de carregar documentos, porém até o presente momento todas exigem uma API. Para a maioria dos protótipos, esta etapa pode ser a mais demorada devido a um requisito de codificação. As opções são descritas abaixo.
...
Como última etapa, examine os níveis de recursos existentes para partições e réplicas e determine se é necessário realizar ajustes. É a maneira mais fácil de ajustar a capacidade está no [Portal de Gerenciamento do Azure](https://ms.portal.azure.com/).
