---
title: API REST do Serviço de Pesquisa do Azure, Versão 2015-02-28-Preview | Microsoft Docs
...
> [!NOTE]
> Ao chamar **Sugestões** usando POST, esse parâmetro será chamado de `top`, em vez de `$top`.
> 
> 
...
> [!NOTE]
> Ao chamar **Sugestões** usando POST, esse parâmetro será chamado de `filter`, em vez de `$filter`.
> 
> 
...
> [!NOTE]
> Ao chamar **Sugestões** usando POST, esse parâmetro será chamado de `select`, em vez de `$select`.
> 
> 
