...
Para uma matriz JSON, a solicitação de indexador usa o analisador `jsonArray`. Esses são os únicos dois requisitos específicos de matriz para indexação de blobs do JSON.
