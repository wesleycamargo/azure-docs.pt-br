...
> [!IMPORTANT]
> Quando você usa o modo de análise `json`ou `jsonArray`, a Pesquisa do Azure pressupõe que todos os blobs em sua fonte de dados serão JSON. Se você precisar dar suporte a uma combinação de blobs JSON e não JSON na mesma fonte de dados, informe-nos em nosso [site UserVoice](https://feedback.azure.com/forums/263029-azure-search).
> 
> 
