---
title: Atualizar para o SDK de Gerenciamento do .NET do Azure Search versão 2 | Microsoft Docs
description: Atualizar para o SDK de Gerenciamento do .NET do Azure Search versão 2
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
