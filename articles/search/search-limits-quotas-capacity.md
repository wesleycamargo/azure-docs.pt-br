...
Unidades de pesquisa, preço e capacidade são explicados em detalhes no site da Web do Azure. Consulte [Detalhes de Preço](http://azure.microsoft.com/pricing/details/search/) para saber mais.
