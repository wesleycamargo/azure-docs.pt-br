---
title: "Introdução ao Azure Search no NodeJS | Microsoft Docs"
...
---
# <a name="get-started-with-azure-search-in-nodejs"></a>Introdução à Pesquisa do Azure no NodeJS
...
Usamos o [NodeJS](https://nodejs.org) e o NPM, o [Sublime Text 3](http://www.sublimetext.com/3) e o Windows PowerShell no Windows 8.1 para desenvolver e testar esse código.
...
## <a name="update-the-configjs-with-your-search-service-url-and-apikey"></a>Atualize o config.js. com a URL e a chave de api do serviço Pesquisa
