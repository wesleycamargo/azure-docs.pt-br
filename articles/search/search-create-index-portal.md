<properties
	pageTitle="Criar um índice de Pesquisa do Azure no portal | Microsoft Azure"
	description="Adicionar um índice ao serviço de Pesquisa do Azure, preenchendo as definições de campo no portal do Azure"
	services="search"
	documentationCenter=""
	authors="HeidiSteen"
	manager="mblythe"
