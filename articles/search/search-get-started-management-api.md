...
[Fluxo de trabalho de desenvolvimento do Azure Search]: search-workflow.md
[Criar sua primeira solução do Azure Search]: search-create-first-solution.md
[Criar um aplicativo de pesquisa geoespacial usando o Azure Search]: search-create-geospatial.md
