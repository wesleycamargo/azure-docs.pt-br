---
title: Atualizando para o SDK do .NET do Azure Search versão 3 | Microsoft Docs
description: Atualizando para o SDK do .NET do Azure Search versão 3
author: brjohnstmsft
manager: jlembicz
services: search
ms.service: search
