...
Filtros de texto são válidos para os campos de cadeia de caracteres, do qual você deseja extrair um conjunto arbitrário de documentos com base nos valores no índice de pesquisa.
