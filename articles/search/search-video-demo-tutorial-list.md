...
[O que é a Pesquisa do Azure?](https://azure.microsoft.com/documentation/videos/what-is-azure-search/)|Outubro de 2015|Você tem um minuto? Assista a este vídeo de um minuto e meio de introdução à Pesquisa do Azure.
...
[Elastic{ON} 2015: Powering real-time search at Microsoft](https://www.elastic.co/elasticon/2015/sf/powering-real-time-search-at-microsoft)|Março de 2015|16 minutos. Apresentação no Elastic{ON} 2015 por Pablo Castro explicando como a Pesquisa do Azure e outros grupos da Microsoft usam o ElasticSearch.
...
- [**exemplo de código para o passo a passo Introdução à Pesquisa do Azure em Java**](https://github.com/Azure-Samples/search-java-getting-started)
- [**exemplo de código para o tutorial Introdução à Pesquisa do Azure em Java**](https://github.com/Azure-Samples/search-dotnet-getting-started)
...
- O [**exemplo de site de trabalhos de NYC usando o ASP.NET MVC**](https://github.com/Azure-Samples/search-dotnet-asp-net-mvc-jobs) cria uma demonstração ao vivo do site de Pesquisa do Azure em dados de trabalhos de NYC.
...
- O [**exemplo de reconhecimento de fala usando Cortana para Windows Phone**](https://github.com/Azure-Samples/search-dotnet-windows-phone-cortana-speech) demonstra como usar o reconhecimento de fala de um Windows Phone para fazer pesquisas na Pesquisa do Azure.
- O [**exemplo de recomendações "Frequentemente comprados juntos"**](https://github.com/liamca/AzureSearchDemos/tree/master/Recommendations) usa o Active Data Factory, Banco de Dados SQL, armazenamento de blobs e HDInsight para implementar as recomendações de produtos com base na frequência com que os produtos são comprados em conjunto.
