---
title: Solução de problemas comuns do indexador no Azure Search | Microsoft Docs
description: Corrigir problemas comuns com indexadores no Azure Search
author: mgottein
manager: cgronlun
services: search
ms.service: search
