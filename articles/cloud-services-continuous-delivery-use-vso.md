<properties urlDisplayName="Publishing with Visual Studio Online" pageTitle="Entrega cont&iacute;nua com o Visual Studio Online no Azure" metaKeywords="" description="Saiba como configurar seus projetos de equipe do Visual Studio Online para serem compilados e implantados automaticamente em Websites ou servi&ccedil;os de nuvem do Azure." metaCanonical="" services="web-sites" documentationCenter=".NET" title="Entrega cont&iacute;nua no Azure usando o Visual Studio Online" authors="ghogen" solutions="" manager="douge" editor="" />
...
1.  No Visual Studio, abra a solução que você deseja implantar ou crie uma nova.
    ...
    Se você desejar criar uma nova solução,
    crie um novo projeto de Serviço de Nuvem do Azure ou um novo projeto ASP.NET MVC. Verifique se o projeto é direcionado para o .NET Framework 4 ou 4.5 e, se você estiver criando um projeto de serviço de nuvem, adicione uma função web e uma função de trabalho ASP.NET MVC e escolha o aplicativo da Internet para a função web. Quando solicitado, escolha **Aplicativo da Internet**.
    Se você desejar criar um site, escolha o modelo de projeto de Aplicativo Web ASP.NET e escolha MVC. Consulte [Introdução ao Azure e ao ASP.NET][Introdução ao Azure e ao ASP.NET].
...
7.  Escolha o botão Início para retornar à página inicial do Team Explorer.
    ![][17]
