...
[C# da Windows Store][C# da Windows Store] [JavaScript da Windows Store][JavaScript da Windows Store] [Windows Phone][Windows Phone]
...
-   Este tutorial baseia-se no quickstart dos Serviços Móveis. Antes de iniciar este tutorial, você deve primeiro concluir a [Introdução aos Serviços Móveis][Introdução aos Serviços Móveis] baixando a versão da linguagem JavaScript do projeto inicial.
...
1.  No Visual Studio, abra a versão da linguagem JavaScript do projeto TodoList que você baixou na [Introdução aos Serviços Móveis][Introdução aos Serviços Móveis].
...
5.  Execute o aplicativo **todolist** nas duas máquinas. Altere o `text` do TodoItem do último item na instância 2 e pressione **Enter** para que o aplicativo atualize o banco de dados.
