...
## [Aplicativo Web de implantação do Docker no Linux](https://docs.microsoft.com/azure/app-service/containers/quickstart-custom-docker-image) 
...
### [Pares chave-valor](https://docs.microsoft.com/azure/cosmos-db/table-storage-how-to-use-dotnet)
...
# Recursos
## [Limites e cotas do Azure](../../azure-subscription-service-limits.md)
