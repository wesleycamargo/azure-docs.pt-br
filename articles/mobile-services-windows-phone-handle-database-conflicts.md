...
<a href="/pt-br/documentation/articles/mobile-services-windows-store-javascript-handle-database-conflicts/" title="Windows Store JavaScript">Windows Store JavaScript</a>
...
2. No Gerenciador de Soluções do Visual Studio, abra a MainPage.xaml.cs e adicione a seguinte diretiva "using".

		using System.Threading.Tasks;


3. No Gerenciador de Soluções do Visual Studio, abra a MainPage.xaml.cs. Adicione o manipulador de eventos à MainPage para o evento "LostFocus" da TextBox, conforme mostrado abaixo.
...
9. No aplicativo do emulador correto, tente atualizar o texto do mesmo TodoItem e disparador do evento "LostFocus". Em resposta ao conflito, o script o resolveu recusando a atualização porque o item já estava concluído.  
