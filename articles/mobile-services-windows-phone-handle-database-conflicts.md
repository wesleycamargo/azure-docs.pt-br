...
2. No Gerenciador de Soluções do Visual Studio, abra MainPage.xaml e substitua a definição `phone:LongListSelector` pela ListBox mostrada abaixo, e salve a alteração.
...
2. No Gerenciador de Soluções do Visual Studio, abra o arquivo MainPage.xaml.cs e adicione a seguinte diretiva `using`.
