...
Para executar o bloco de notas, pressione **SHIFT+ENTER**. Você verá uma saída, conforme mostrado no trecho de código a seguir. Cada evento na saída é um tweet ingerido pelos Hubs de Eventos.
