...
2. Se você ainda não tiver uma conta de armazenamento, crie uma. 
   ...
   Para saber mais informações, consulte [Criar uma conta de armazenamento de Blobs do Azure](../storage/common/storage-create-storage-account.md#create-a-storage-account). 
...
5. Vamos examinar um instantâneo dos dados do JSON de exemplo para entender melhor a consulta que você executou. Cole o trecho de código a seguir em uma célula de código e pressione **SHIFT+ENTER**.
