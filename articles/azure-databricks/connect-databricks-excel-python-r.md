...
* Se você usa o RStudio para área de trabalho como seu IDE, instale também o Microsoft R Client [http://aka.ms/rclient/](https://aka.ms/rclient/). 
