...
>[AZURE.IMPORTANT] Se a mensagem a seguir for exibida na folha **Métricas do Redis**, siga as etapas na seção [Habilitar o diagnóstico de cache](#enable-cache-diagnostics) para habilitar o diagnóstico de cache.
>
