...
>[AZURE.IMPORTANT]Se a mensagem a seguir for exibida no portal de visualização, siga as etapas na seção [Habilitar o diagnóstico de cache](#enable-cache-diagnostics) para habilitar o diagnóstico de cache.
>
