...
> [!IMPORTANT]
> Aviso: nunca armazene credenciais no código-fonte. Para manter esse exemplo simples, eu estou mostrando-lhes no código-fonte. Veja [Como cadeias de caracteres de aplicativo e cadeias de caracteres de conexão funcionam][Como cadeias de caracteres de aplicativo e cadeias de caracteres de conexão funcionam] para obter informações sobre como armazenar credenciais.
> 
> 
...
* Confira a [documentação de cliente de cache StackExchange.Redis][documentação de cliente de cache StackExchange.Redis].
...
* O Cache Redis do Azure também pode ser usado com ferramentas como Redsmin e Redis Desktop Manager.
  * Para obter mais informações sobre o Redsmin, veja [Como recuperar uma cadeia de conexão do Redis do Azure e usá-la com Redsmin][Como recuperar uma cadeia de conexão do Redis do Azure e usá-la com Redsmin].
...
[Usando os grupos de recursos para gerenciar seus recursos do Azure]: ../azure-resource-manager/resource-group-overview.md
