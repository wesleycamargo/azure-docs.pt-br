...
2. O painel, selecione **+ criar um recurso**, em seguida, **segurança + identidade**, em seguida, **Cofre de chaves**.
    ...
    ![Tela de Cofre de chaves](media/azure-stack-key-vault-manage-portal/image1.png)
...
* [Implantar uma VM ao recuperar a senha armazenada no cofre de chaves](azure-stack-key-vault-deploy-vm-with-secret.md)
* [Implantar uma VM com certificado armazenado no cofre de chaves](azure-stack-key-vault-push-secret-into-vm.md)
