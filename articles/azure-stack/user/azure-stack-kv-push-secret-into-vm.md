...
>[!IMPORTANT]
>Você deve usar o `-EnabledForDeployment` parâmetro ao criar a chave falha. Esse parâmetro garante que o Cofre de chaves pode ser referenciado de modelos do Gerenciador de recursos do Azure.
