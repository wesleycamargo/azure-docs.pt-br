...
| Armazenamento de máquina virtual | Dá suporte a [discos gerenciados.](../../virtual-machines/windows/managed-disks-overview.md) | Discos gerenciados ainda não têm suporte no Azure Stack. |
