...
Para saber mais sobre o repositório do GitHub e como Contribuir com ele, consulte o [arquivo Leiame](https://github.com/Azure/AzureStack-QuickStart-Templates/blob/master/README.md). 
...
1.  Clique em **+ criar um recurso** > **personalizado** > **implantação de modelo**.
