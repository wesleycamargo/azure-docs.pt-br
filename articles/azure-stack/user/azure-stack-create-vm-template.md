...
> [!IMPORTANT]
> A imagem de VM Ubuntu (Ubuntu Server 16.04 LTS neste exemplo) deve já foram adicionada para o marketplace de pilha do Azure antes de começar a estas etapas.
