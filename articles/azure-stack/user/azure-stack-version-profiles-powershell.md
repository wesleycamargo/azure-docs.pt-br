...
O **AzureRM.Bootstrapper** módulo que está disponível por meio da Galeria do PowerShell fornece cmdlets do PowerShell que são necessárias para trabalhar com perfis de versão da API. Use o cmdlet a seguir para instalar o **AzureRM.Bootstrapper** módulo:
...
| --- | --- | --- |
| 1811 ou posterior | 2018-03-01-hybrid | 1.6.0 |
...
Para instalar e importar os módulos AzureRM selecionados de um perfil de versão de API, execute as **uso-AzureRMProfile** cmdlet com o **módulo** parâmetro:
...
Use o **Update-AzureRmProfile** cmdlet para atualizar os módulos em um perfil de versão de API para a versão mais recente dos módulos que estão disponíveis em PSGallery. É recomendável que você sempre execute as **Update-AzureRmProfile** cmdlet em uma nova sessão do PowerShell para evitar conflitos durante a importação de módulos. O **Update-AzureRmProfile** cmdlet executa as seguintes tarefas:
...
3. solicita que você instale a versão mais recente.  
