...
Conhecimento prévio do Azure e o Azure Stack é necessário. Para saber mais antes de prosseguir, comece com estes tópicos:
 ...
 -  [Guia de solução de CI/CD de híbrido do Azure Stack](/azure-stack-solution-pipeline.md)
...
1.  Nos recursos opcionais de configurações
    ...
    e.  Observação: Com o AAD habilitado e configurado para a assinatura do Azure, identidade de serviço gerenciado pode ser habilitada também.
