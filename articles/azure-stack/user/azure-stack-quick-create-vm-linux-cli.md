...
Porque essa máquina virtual será executado o servidor web do IIS, você precisará abrir a porta 80 para tráfego da Internet. Use o comando [az vm open-port](/cli/azure/vm) para abrir a porta desejada.
