...
>[!NOTE]
> Você deve estar executando a compilação do Azure Stack **1809** ou posterior para usar esse recurso.  Se você estiver executando uma compilação antes 1809, atualize o sistema do Azure Stack para a compilação mais recente antes de tentar usar esse recurso ou siga as etapas neste artigo.
