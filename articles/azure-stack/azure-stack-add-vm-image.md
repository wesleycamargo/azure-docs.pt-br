...
3. Abra o PowerShell com um prompt com privilégios elevados e execute:
  ...
  - **OSUri**  
    ...
    Para obter mais informações sobre o cmdlet Add-AzsPlatformimage, consulte o Microsoft PowerShell [documentação do módulo Azure pilha operador](https://docs.microsoft.com/powershell/module/).
