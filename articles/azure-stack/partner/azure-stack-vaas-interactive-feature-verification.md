...
Um teste para substituição do disco é um cenário comum. Neste exemplo, o teste tem cinco etapas:

1. Criar um novo **aprovação do teste** fluxo de trabalho.
2. Selecione o **teste de identificação de disco**.
3. Conclua a etapa manual quando solicitado.
4. Verifique o resultado do cenário.
5. Envie o resultado do teste para Microsoft.
