...
ms.locfileid: "57350452"
---
Certifique-se de que a atualização mensal atual foi aplicada. Para a versão mais recente, consulte a versão mais recente no [documentação do Azure Stack operador > Visão geral > Notas de versão](https://docs.microsoft.com/azure/azure-stack/).
