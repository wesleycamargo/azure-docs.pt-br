...
4.  Abra um console do ISE do PowerShell na VM ERCS usando o **CloudAdmin** conta.  Navegue até o compartilhamento de arquivos. 
...
Para girar os dois externo um segredos interno:
