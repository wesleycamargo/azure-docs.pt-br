...
Os usuários agora podem usar as fontes de implantação para itens como [implantação contínua](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-continuous-deployment), [implantação local do Git](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-local-git), e [sincronização de pastas de nuvem](https://docs.microsoft.com/en-us/azure/app-service-web/app-service-deploy-content-sync).
