...
Atualmente, o uso é relatado para os provedores de recursos de computação, rede e armazenamento.

| **Provedor de recursos** | **ID de medidor** | **Nome do medidor** | **Unidade** | **Informações adicionais** |
| --- | --- | --- | --- | --- | 
| **Rede** |F271A8A388C44D93956A063E1D2FA80B |Uso de endereço IP estático |Endereços IP|Endereços de contagem de IP usado | 
| |9E2739BA86744796B465F64674B822BA |Uso de endereço IP dinâmico |Endereços IP|Endereços de contagem de IP usado | 
...
| | 1B8C1DEC-EE42-414B-AA36-6229CF199370 |TableDataTransOut |Outgress GB |Saída de dados de serviço de tabela em GB |
...
| | 3023FEF4-ECA5-4D7B-87B3-CFBC061931E8 |BlobDataTransOut |Outgress GB |Saída de dados de serviço de blob em GB |
...
| | DD0A10BA-A5D6-4CB6-88C0-7D585CEF9FC2 |QueueDataTransOut |Outgress GB |Saída de dados de serviço de fila em GB |
| **Computação** |FAB6EB84-500B-4A09-A8CA-7358F8BBAEA5 |Horas de tamanho VM de base |Minutos de núcleo virtual | Número de vcores vezes minutos que a VM foi executada |
| |9CD92D4C-BAFD-4492-B278-BEDC2DE8232A |Horas de tamanho VM do Windows |Minutos de núcleo virtual | Número de vcores vezes minutos que a VM foi executada |
| |6DAB500F-A4FD-49C4-956D-229BB9C8C793 |Horas de tamanho VM |Horas VM |Captura de VM de Base e o Windows. Não se ajusta para vcores |
| **Cofre de Chaves** | EBF13B9F-B3EA-46FE-BF54-396E93D48AB4 |Transações de Cofre de chaves | Contagem de solicitações em 10000s| Número de solicitações da API REST recebidas pelo plano de dados do Cofre de chaves |
...
| Solicitação incorreta/400 |*SubscriberIdIsNotDirectTenant* |Uma chamada de API do provedor usado uma ID de assinatura não é um locatário válido do chamador. |
