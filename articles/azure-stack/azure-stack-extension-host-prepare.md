...
ms.locfileid: "42889922"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Preparar para o host de extensão para o Azure Stack

Você pode usar o host de extensão para ajudar a proteger Azure Stack, reduzindo o número de portas TCP/IP. Este artigo examina a preparação do Azure Stack para o host de extensão, que é habilitado automaticamente por meio de um pacote de atualização de pilha do Azure após a atualização 1808.
...
> [!Note]  
> Você pode ignorar esta etapa, dependendo de sua solicitação os certificados SSL.
...
5. Importe o certificado para o ponto de extremidade de hospedagem de administrador.
