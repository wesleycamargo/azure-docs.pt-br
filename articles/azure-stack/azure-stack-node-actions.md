...
Para saber mais sobre o módulo de administrador de malha do Azure Stack, confira [Azs.Fabric.Admin](https://docs.microsoft.com/powershell/module/azs.fabric.admin/?view=azurestackps-1.5.0).
