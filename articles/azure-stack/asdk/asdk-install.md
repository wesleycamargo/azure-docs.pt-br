...
5. Selecione o DHCP ou configuração de rede estático para a máquina virtual de BGPNAT01.
    ...
    - **Estático**: use essa opção somente se o DHCP não é possível atribuir um endereço IP válido para o Azure Stack acessar a Internet. **Um endereço IP estático deve ser especificado com o comprimento da máscara de sub-rede no formato CIDR (por exemplo, 10.0.0.5/24)**.
