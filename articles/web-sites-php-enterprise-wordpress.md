...
**Enviar email** | <a href="http://azure.microsoft.com/en-us/gallery/store/sendgrid/sendgrid-azure/">SendGrid</a> e o <a href="http://wordpress.org/plugins/sendgrid-email-delivery-simplified/">plug-in do WordPress para usar o SendGrid</a></td>
